...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class MFP_MEDIAITEM_CREATED_EVENTTests
    {
        /// <summary>Validates that the <see cref="MFP_MEDIAITEM_CREATED_EVENT" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<MFP_MEDIAITEM_CREATED_EVENT>(), Is.EqualTo(sizeof(MFP_MEDIAITEM_CREATED_EVENT)));
        }
