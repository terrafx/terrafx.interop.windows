...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class SP_ALTPLATFORM_INFO_V3Tests
    {
        /// <summary>Validates that the <see cref="SP_ALTPLATFORM_INFO_V3" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<SP_ALTPLATFORM_INFO_V3>(), Is.EqualTo(sizeof(SP_ALTPLATFORM_INFO_V3)));
        }
        ...
        {
            Assert.That(sizeof(SP_ALTPLATFORM_INFO_V3), Is.EqualTo(35));
        }
    }
}
