...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class FILE_IN_CABINET_INFO_WTests
    {
        /// <summary>Validates that the <see cref="FILE_IN_CABINET_INFO_W" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<FILE_IN_CABINET_INFO_W>(), Is.EqualTo(sizeof(FILE_IN_CABINET_INFO_W)));
        }
        ...
        public static void SizeOfTest()
        {
            ...
            {
                Assert.That(sizeof(FILE_IN_CABINET_INFO_W), Is.EqualTo(542));
            }
            else
            {
                Assert.That(sizeof(FILE_IN_CABINET_INFO_W), Is.EqualTo(538));
            }
        }
    }
}
