...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class SP_POWERMESSAGEWAKE_PARAMS_ATests
    {
        /// <summary>Validates that the <see cref="SP_POWERMESSAGEWAKE_PARAMS_A" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<SP_POWERMESSAGEWAKE_PARAMS_A>(), Is.EqualTo(sizeof(SP_POWERMESSAGEWAKE_PARAMS_A)));
        }
