...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe partial class FILE_IN_CABINET_INFO_ATests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<FILE_IN_CABINET_INFO_A>(), Is.EqualTo(sizeof(FILE_IN_CABINET_INFO_A)));
        }
        ...
        public static void SizeOfTest()
        {
            ...
            {
                Assert.That(sizeof(FILE_IN_CABINET_INFO_A), Is.EqualTo(282));
            }
            else
            {
                Assert.That(sizeof(FILE_IN_CABINET_INFO_A), Is.EqualTo(278));
            }
        }
    }
}
