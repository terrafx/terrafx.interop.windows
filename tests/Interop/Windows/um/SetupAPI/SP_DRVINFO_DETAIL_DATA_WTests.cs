...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class SP_DRVINFO_DETAIL_DATA_WTests
    {
        /// <summary>Validates that the <see cref="SP_DRVINFO_DETAIL_DATA_W" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<SP_DRVINFO_DETAIL_DATA_W>(), Is.EqualTo(sizeof(SP_DRVINFO_DETAIL_DATA_W)));
        }
        ...
        public static void SizeOfTest()
        {
            ...
            {
                Assert.That(sizeof(SP_DRVINFO_DETAIL_DATA_W), Is.EqualTo(1574));
            }
            else
            {
                Assert.That(sizeof(SP_DRVINFO_DETAIL_DATA_W), Is.EqualTo(1570));
            }
        }
    }
}
