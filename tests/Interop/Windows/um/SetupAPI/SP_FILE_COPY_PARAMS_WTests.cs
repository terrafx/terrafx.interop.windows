...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class SP_FILE_COPY_PARAMS_WTests
    {
        /// <summary>Validates that the <see cref="SP_FILE_COPY_PARAMS_W" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<SP_FILE_COPY_PARAMS_W>(), Is.EqualTo(sizeof(SP_FILE_COPY_PARAMS_W)));
        }
        ...
        public static void SizeOfTest()
        {
            ...
            {
                Assert.That(sizeof(SP_FILE_COPY_PARAMS_W), Is.EqualTo(88));
            }
            else
            {
