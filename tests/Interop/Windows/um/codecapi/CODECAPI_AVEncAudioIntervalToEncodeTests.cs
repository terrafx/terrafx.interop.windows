...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncAudioIntervalToEncodeTests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncAudioIntervalToEncode).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncAudioIntervalToEncode));
        }
