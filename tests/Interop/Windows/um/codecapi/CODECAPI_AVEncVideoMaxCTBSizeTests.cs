...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVEncVideoMaxCTBSize" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVEncVideoMaxCTBSizeTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncVideoMaxCTBSize" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncVideoMaxCTBSize).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncVideoMaxCTBSize));
        }
