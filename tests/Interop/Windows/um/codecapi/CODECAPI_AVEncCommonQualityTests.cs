...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe partial class CODECAPI_AVEncCommonQualityTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncCommonQuality" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncCommonQuality).GUID, Is.EqualTo(IID_CODECAPI_AVEncCommonQuality));
        }
