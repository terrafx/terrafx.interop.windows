...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncChromaEncodeModeTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncChromaEncodeMode" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncChromaEncodeMode).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncChromaEncodeMode));
        }
