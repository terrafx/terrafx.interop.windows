...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe partial class CODECAPI_AVEncVideoFieldSwapTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncVideoFieldSwap" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncVideoFieldSwap).GUID, Is.EqualTo(IID_CODECAPI_AVEncVideoFieldSwap));
        }
