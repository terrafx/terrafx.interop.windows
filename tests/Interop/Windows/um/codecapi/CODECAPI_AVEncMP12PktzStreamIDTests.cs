...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncMP12PktzStreamIDTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncMP12PktzStreamID" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncMP12PktzStreamID).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncMP12PktzStreamID));
        }
