...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncMPVQuantMatrixChromaNonIntraTests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncMPVQuantMatrixChromaNonIntra).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncMPVQuantMatrixChromaNonIntra));
        }
