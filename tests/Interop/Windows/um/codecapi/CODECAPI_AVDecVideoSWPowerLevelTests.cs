...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVDecVideoSWPowerLevel" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVDecVideoSWPowerLevelTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVDecVideoSWPowerLevel" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVDecVideoSWPowerLevel).GUID, Is.EqualTo(STATIC_CODECAPI_AVDecVideoSWPowerLevel));
        }
