...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncAudioMapDestChannel14Tests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncAudioMapDestChannel14).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncAudioMapDestChannel14));
        }
