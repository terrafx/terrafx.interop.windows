...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVDecVideoMaxCodedHeight" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVDecVideoMaxCodedHeightTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVDecVideoMaxCodedHeight" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVDecVideoMaxCodedHeight).GUID, Is.EqualTo(STATIC_CODECAPI_AVDecVideoMaxCodedHeight));
        }
