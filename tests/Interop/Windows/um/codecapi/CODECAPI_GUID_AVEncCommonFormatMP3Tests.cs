...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_GUID_AVEncCommonFormatMP3" /> struct.</summary>
    public static unsafe partial class CODECAPI_GUID_AVEncCommonFormatMP3Tests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_GUID_AVEncCommonFormatMP3" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_GUID_AVEncCommonFormatMP3).GUID, Is.EqualTo(STATIC_CODECAPI_GUID_AVEncCommonFormatMP3));
        }
