...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVEncVideoInverseTelecineThreshold" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVEncVideoInverseTelecineThresholdTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncVideoInverseTelecineThreshold" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncVideoInverseTelecineThreshold).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncVideoInverseTelecineThreshold));
        }
