...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncCommonMeanBitRateTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncCommonMeanBitRate" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncCommonMeanBitRate).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncCommonMeanBitRate));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<CODECAPI_AVEncCommonMeanBitRate>(), Is.EqualTo(sizeof(CODECAPI_AVEncCommonMeanBitRate)));
        }
