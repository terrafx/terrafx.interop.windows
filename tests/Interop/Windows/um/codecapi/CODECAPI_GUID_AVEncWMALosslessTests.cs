...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_GUID_AVEncWMALosslessTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_GUID_AVEncWMALossless" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_GUID_AVEncWMALossless).GUID, Is.EqualTo(STATIC_CODECAPI_GUID_AVEncWMALossless));
        }
