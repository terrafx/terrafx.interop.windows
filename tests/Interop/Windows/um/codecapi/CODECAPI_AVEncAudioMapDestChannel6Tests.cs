...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncAudioMapDestChannel6Tests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncAudioMapDestChannel6).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncAudioMapDestChannel6));
        }
