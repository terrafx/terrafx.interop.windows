...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncDDDCHighPassFilterTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncDDDCHighPassFilter" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncDDDCHighPassFilter).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncDDDCHighPassFilter));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<CODECAPI_AVEncDDDCHighPassFilter>(), Is.EqualTo(sizeof(CODECAPI_AVEncDDDCHighPassFilter)));
        }
