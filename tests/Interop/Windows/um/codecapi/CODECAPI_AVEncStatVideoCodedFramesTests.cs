...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncStatVideoCodedFramesTests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncStatVideoCodedFrames).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncStatVideoCodedFrames));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<CODECAPI_AVEncStatVideoCodedFrames>(), Is.EqualTo(sizeof(CODECAPI_AVEncStatVideoCodedFrames)));
        }
