...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncMPVGOPSizeMinTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncMPVGOPSizeMin" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncMPVGOPSizeMin).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncMPVGOPSizeMin));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<CODECAPI_AVEncMPVGOPSizeMin>(), Is.EqualTo(sizeof(CODECAPI_AVEncMPVGOPSizeMin)));
        }
