...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncAudioMapDestChannel15Tests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncAudioMapDestChannel15).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncAudioMapDestChannel15));
        }
