...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncMPVIntraVLCTableTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncMPVIntraVLCTable" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncMPVIntraVLCTable).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncMPVIntraVLCTable));
        }
