...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVEncVideoMaxNumRefFrame" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVEncVideoMaxNumRefFrameTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncVideoMaxNumRefFrame" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncVideoMaxNumRefFrame).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncVideoMaxNumRefFrame));
        }
