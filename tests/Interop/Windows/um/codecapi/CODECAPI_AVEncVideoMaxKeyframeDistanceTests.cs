...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVEncVideoMaxKeyframeDistance" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVEncVideoMaxKeyframeDistanceTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncVideoMaxKeyframeDistance" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncVideoMaxKeyframeDistance).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncVideoMaxKeyframeDistance));
        }
