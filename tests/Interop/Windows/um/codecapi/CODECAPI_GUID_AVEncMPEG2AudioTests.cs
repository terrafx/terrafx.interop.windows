...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_GUID_AVEncMPEG2AudioTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_GUID_AVEncMPEG2Audio" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_GUID_AVEncMPEG2Audio).GUID, Is.EqualTo(STATIC_CODECAPI_GUID_AVEncMPEG2Audio));
        }
