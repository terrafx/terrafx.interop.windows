...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_GUID_AVEncCommonFormatSVCDTests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_GUID_AVEncCommonFormatSVCD).GUID, Is.EqualTo(STATIC_CODECAPI_GUID_AVEncCommonFormatSVCD));
        }
