...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlusTests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlus).GUID, Is.EqualTo(STATIC_CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlus));
        }
