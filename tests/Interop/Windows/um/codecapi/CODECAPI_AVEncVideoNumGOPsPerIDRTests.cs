...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncVideoNumGOPsPerIDRTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncVideoNumGOPsPerIDR" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVEncVideoNumGOPsPerIDR).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncVideoNumGOPsPerIDR));
        }
