...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVAudioChannelConfig" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVAudioChannelConfigTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVAudioChannelConfig" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVAudioChannelConfig).GUID, Is.EqualTo(STATIC_CODECAPI_AVAudioChannelConfig));
        }
