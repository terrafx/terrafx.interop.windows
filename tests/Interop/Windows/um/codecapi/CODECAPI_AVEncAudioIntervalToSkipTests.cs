...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVEncAudioIntervalToSkip" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVEncAudioIntervalToSkipTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncAudioIntervalToSkip" /> struct is correct.</summary>
        [Test]
