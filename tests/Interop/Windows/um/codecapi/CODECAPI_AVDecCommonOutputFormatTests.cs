...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVDecCommonOutputFormat" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVDecCommonOutputFormatTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVDecCommonOutputFormat" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(CODECAPI_AVDecCommonOutputFormat).GUID, Is.EqualTo(STATIC_CODECAPI_AVDecCommonOutputFormat));
        }
