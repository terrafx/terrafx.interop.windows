...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncAudioMapDestChannel10Tests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncAudioMapDestChannel10).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncAudioMapDestChannel10));
        }
