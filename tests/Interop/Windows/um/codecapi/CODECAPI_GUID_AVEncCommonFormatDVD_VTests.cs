...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_GUID_AVEncCommonFormatDVD_VTests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_GUID_AVEncCommonFormatDVD_V).GUID, Is.EqualTo(STATIC_CODECAPI_GUID_AVEncCommonFormatDVD_V));
        }
