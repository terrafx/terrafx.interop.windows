...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CODECAPI_AVEncCommonBufferOutLevelTests
    {
        ...
        {
            Assert.That(typeof(CODECAPI_AVEncCommonBufferOutLevel).GUID, Is.EqualTo(STATIC_CODECAPI_AVEncCommonBufferOutLevel));
        }
