...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ITfContextOwnerCompositionServicesTests
    {
        ...
        {
            Assert.That(typeof(ITfContextOwnerCompositionServices).GUID, Is.EqualTo(IID_ITfContextOwnerCompositionServices));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ITfContextOwnerCompositionServices>(), Is.EqualTo(sizeof(ITfContextOwnerCompositionServices)));
        }
