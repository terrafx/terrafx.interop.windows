...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ITfTransitoryExtensionSinkTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ITfTransitoryExtensionSink" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(ITfTransitoryExtensionSink).GUID, Is.EqualTo(IID_ITfTransitoryExtensionSink));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ITfTransitoryExtensionSink>(), Is.EqualTo(sizeof(ITfTransitoryExtensionSink)));
        }
