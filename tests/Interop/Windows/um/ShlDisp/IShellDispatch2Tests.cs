...
{
    /// <summary>Provides validation of the <see cref="IShellDispatch2" /> struct.</summary>
    public static unsafe partial class IShellDispatch2Tests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IShellDispatch2" /> struct is correct.</summary>
        [Test]
