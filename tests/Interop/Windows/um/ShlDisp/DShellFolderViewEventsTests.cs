...
{
    /// <summary>Provides validation of the <see cref="DShellFolderViewEvents" /> struct.</summary>
    public static unsafe partial class DShellFolderViewEventsTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="DShellFolderViewEvents" /> struct is correct.</summary>
        [Test]
