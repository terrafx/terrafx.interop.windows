...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class MsftWriteSpeedDescriptorTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="MsftWriteSpeedDescriptor" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(MsftWriteSpeedDescriptor).GUID, Is.EqualTo(CLSID_MsftWriteSpeedDescriptor));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<MsftWriteSpeedDescriptor>(), Is.EqualTo(sizeof(MsftWriteSpeedDescriptor)));
        }
