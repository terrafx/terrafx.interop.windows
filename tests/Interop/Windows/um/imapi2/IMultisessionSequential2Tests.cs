...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IMultisessionSequential2Tests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IMultisessionSequential2" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(IMultisessionSequential2).GUID, Is.EqualTo(IID_IMultisessionSequential2));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IMultisessionSequential2>(), Is.EqualTo(sizeof(IMultisessionSequential2)));
        }
