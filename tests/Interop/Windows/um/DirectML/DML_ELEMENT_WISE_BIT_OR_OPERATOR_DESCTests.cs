...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class DML_ELEMENT_WISE_BIT_OR_OPERATOR_DESCTests
    {
        /// <summary>Validates that the <see cref="DML_ELEMENT_WISE_BIT_OR_OPERATOR_DESC" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<DML_ELEMENT_WISE_BIT_OR_OPERATOR_DESC>(), Is.EqualTo(sizeof(DML_ELEMENT_WISE_BIT_OR_OPERATOR_DESC)));
        }
