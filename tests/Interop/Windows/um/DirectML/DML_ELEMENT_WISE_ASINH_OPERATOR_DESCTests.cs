...
{
    /// <summary>Provides validation of the <see cref="DML_ELEMENT_WISE_ASINH_OPERATOR_DESC" /> struct.</summary>
    public static unsafe class DML_ELEMENT_WISE_ASINH_OPERATOR_DESCTests
    {
