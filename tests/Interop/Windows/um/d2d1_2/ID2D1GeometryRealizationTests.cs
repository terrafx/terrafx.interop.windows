...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ID2D1GeometryRealizationTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<ID2D1GeometryRealization>(), Is.EqualTo(sizeof(ID2D1GeometryRealization)));
        }
