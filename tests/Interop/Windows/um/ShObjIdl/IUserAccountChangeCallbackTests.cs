...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IUserAccountChangeCallbackTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IUserAccountChangeCallback" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(IUserAccountChangeCallback).GUID, Is.EqualTo(IID_IUserAccountChangeCallback));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IUserAccountChangeCallback>(), Is.EqualTo(sizeof(IUserAccountChangeCallback)));
        }
