...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class DEVICE_DATA_SET_SCRUB_OUTPUTTests
    {
        /// <summary>Validates that the <see cref="DEVICE_DATA_SET_SCRUB_OUTPUT" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<DEVICE_DATA_SET_SCRUB_OUTPUT>(), Is.EqualTo(sizeof(DEVICE_DATA_SET_SCRUB_OUTPUT)));
        }
