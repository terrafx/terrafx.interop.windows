...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class STARTING_VCN_INPUT_BUFFERTests
    {
        /// <summary>Validates that the <see cref="STARTING_VCN_INPUT_BUFFER" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<STARTING_VCN_INPUT_BUFFER>(), Is.EqualTo(sizeof(STARTING_VCN_INPUT_BUFFER)));
        }
