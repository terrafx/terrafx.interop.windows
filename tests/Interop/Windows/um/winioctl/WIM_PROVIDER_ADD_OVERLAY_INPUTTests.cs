...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class WIM_PROVIDER_ADD_OVERLAY_INPUTTests
    {
        /// <summary>Validates that the <see cref="WIM_PROVIDER_ADD_OVERLAY_INPUT" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<WIM_PROVIDER_ADD_OVERLAY_INPUT>(), Is.EqualTo(sizeof(WIM_PROVIDER_ADD_OVERLAY_INPUT)));
        }
