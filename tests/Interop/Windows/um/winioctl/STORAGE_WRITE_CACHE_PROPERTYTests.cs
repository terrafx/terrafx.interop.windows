...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class STORAGE_WRITE_CACHE_PROPERTYTests
    {
        /// <summary>Validates that the <see cref="STORAGE_WRITE_CACHE_PROPERTY" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<STORAGE_WRITE_CACHE_PROPERTY>(), Is.EqualTo(sizeof(STORAGE_WRITE_CACHE_PROPERTY)));
        }
