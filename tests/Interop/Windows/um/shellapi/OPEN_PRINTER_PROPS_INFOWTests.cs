...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe partial class OPEN_PRINTER_PROPS_INFOWTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<OPEN_PRINTER_PROPS_INFOW>(), Is.EqualTo(sizeof(OPEN_PRINTER_PROPS_INFOW)));
        }
        ...
        public static void SizeOfTest()
        {
            ...
            {
                Assert.That(sizeof(OPEN_PRINTER_PROPS_INFOW), Is.EqualTo(24));
            }
            else
            {
