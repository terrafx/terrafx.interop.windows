...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class OCSP_BASIC_SIGNED_RESPONSE_INFOTests
    {
        /// <summary>Validates that the <see cref="OCSP_BASIC_SIGNED_RESPONSE_INFO" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<OCSP_BASIC_SIGNED_RESPONSE_INFO>(), Is.EqualTo(sizeof(OCSP_BASIC_SIGNED_RESPONSE_INFO)));
        }
