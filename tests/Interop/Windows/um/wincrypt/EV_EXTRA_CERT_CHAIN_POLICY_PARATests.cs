...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class EV_EXTRA_CERT_CHAIN_POLICY_PARATests
    {
        /// <summary>Validates that the <see cref="EV_EXTRA_CERT_CHAIN_POLICY_PARA" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<EV_EXTRA_CERT_CHAIN_POLICY_PARA>(), Is.EqualTo(sizeof(EV_EXTRA_CERT_CHAIN_POLICY_PARA)));
        }
