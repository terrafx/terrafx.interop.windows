...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CMSG_KEY_AGREE_RECIPIENT_INFOTests
    {
        /// <summary>Validates that the <see cref="CMSG_KEY_AGREE_RECIPIENT_INFO" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<CMSG_KEY_AGREE_RECIPIENT_INFO>(), Is.EqualTo(sizeof(CMSG_KEY_AGREE_RECIPIENT_INFO)));
        }
