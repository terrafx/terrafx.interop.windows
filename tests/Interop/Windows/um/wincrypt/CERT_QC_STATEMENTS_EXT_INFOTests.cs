...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class CERT_QC_STATEMENTS_EXT_INFOTests
    {
        /// <summary>Validates that the <see cref="CERT_QC_STATEMENTS_EXT_INFO" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<CERT_QC_STATEMENTS_EXT_INFO>(), Is.EqualTo(sizeof(CERT_QC_STATEMENTS_EXT_INFO)));
        }
