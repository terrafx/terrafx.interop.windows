...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class OCSP_SIGNED_REQUEST_INFOTests
    {
        /// <summary>Validates that the <see cref="OCSP_SIGNED_REQUEST_INFO" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<OCSP_SIGNED_REQUEST_INFO>(), Is.EqualTo(sizeof(OCSP_SIGNED_REQUEST_INFO)));
        }
