...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IAppxEncryptedPackageWriter2Tests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IAppxEncryptedPackageWriter2" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(IAppxEncryptedPackageWriter2).GUID, Is.EqualTo(IID_IAppxEncryptedPackageWriter2));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IAppxEncryptedPackageWriter2>(), Is.EqualTo(sizeof(IAppxEncryptedPackageWriter2)));
        }
