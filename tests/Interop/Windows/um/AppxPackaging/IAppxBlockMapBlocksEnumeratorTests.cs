...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IAppxBlockMapBlocksEnumeratorTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IAppxBlockMapBlocksEnumerator" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(IAppxBlockMapBlocksEnumerator).GUID, Is.EqualTo(IID_IAppxBlockMapBlocksEnumerator));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IAppxBlockMapBlocksEnumerator>(), Is.EqualTo(sizeof(IAppxBlockMapBlocksEnumerator)));
        }
