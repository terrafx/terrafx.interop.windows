...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IAppxPackagingDiagnosticEventSinkManagerTests
    {
        ...
        {
            Assert.That(typeof(IAppxPackagingDiagnosticEventSinkManager).GUID, Is.EqualTo(IID_IAppxPackagingDiagnosticEventSinkManager));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IAppxPackagingDiagnosticEventSinkManager>(), Is.EqualTo(sizeof(IAppxPackagingDiagnosticEventSinkManager)));
        }
