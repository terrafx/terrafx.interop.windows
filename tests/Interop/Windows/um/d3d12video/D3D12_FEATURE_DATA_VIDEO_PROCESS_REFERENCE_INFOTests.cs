...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_FEATURE_DATA_VIDEO_PROCESS_REFERENCE_INFOTests
    {
        /// <summary>Validates that the <see cref="D3D12_FEATURE_DATA_VIDEO_PROCESS_REFERENCE_INFO" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_PROCESS_REFERENCE_INFO>(), Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_PROCESS_REFERENCE_INFO)));
        }
        ...
        {
            Assert.That(typeof(D3D12_FEATURE_DATA_VIDEO_PROCESS_REFERENCE_INFO).IsLayoutSequential, Is.True);
        }
