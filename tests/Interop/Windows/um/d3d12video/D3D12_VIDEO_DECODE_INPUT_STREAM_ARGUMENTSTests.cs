...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTSTests
    {
        /// <summary>Validates that the <see cref="D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS>(), Is.EqualTo(sizeof(D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS)));
        }
