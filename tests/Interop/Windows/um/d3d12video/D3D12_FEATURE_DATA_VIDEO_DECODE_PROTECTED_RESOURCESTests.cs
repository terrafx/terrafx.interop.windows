...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_FEATURE_DATA_VIDEO_DECODE_PROTECTED_RESOURCESTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_DECODE_PROTECTED_RESOURCES>(), Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_DECODE_PROTECTED_RESOURCES)));
        }
        ...
        {
            Assert.That(typeof(D3D12_FEATURE_DATA_VIDEO_DECODE_PROTECTED_RESOURCES).IsLayoutSequential, Is.True);
        }
