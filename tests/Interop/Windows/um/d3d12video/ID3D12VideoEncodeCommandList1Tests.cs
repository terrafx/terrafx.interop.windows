...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ID3D12VideoEncodeCommandList1Tests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ID3D12VideoEncodeCommandList1" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(ID3D12VideoEncodeCommandList1).GUID, Is.EqualTo(IID_ID3D12VideoEncodeCommandList1));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ID3D12VideoEncodeCommandList1>(), Is.EqualTo(sizeof(ID3D12VideoEncodeCommandList1)));
        }
