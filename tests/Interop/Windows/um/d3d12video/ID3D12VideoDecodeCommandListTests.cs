...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ID3D12VideoDecodeCommandListTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ID3D12VideoDecodeCommandList" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(ID3D12VideoDecodeCommandList).GUID, Is.EqualTo(IID_ID3D12VideoDecodeCommandList));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ID3D12VideoDecodeCommandList>(), Is.EqualTo(sizeof(ID3D12VideoDecodeCommandList)));
        }
