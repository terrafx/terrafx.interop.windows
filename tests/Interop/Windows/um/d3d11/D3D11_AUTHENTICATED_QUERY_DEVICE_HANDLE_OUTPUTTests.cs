...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D11_AUTHENTICATED_QUERY_DEVICE_HANDLE_OUTPUTTests
    {
        /// <summary>Validates that the <see cref="D3D11_AUTHENTICATED_QUERY_DEVICE_HANDLE_OUTPUT" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3D11_AUTHENTICATED_QUERY_DEVICE_HANDLE_OUTPUT>(), Is.EqualTo(sizeof(D3D11_AUTHENTICATED_QUERY_DEVICE_HANDLE_OUTPUT)));
        }
        ...
        {
            Assert.That(typeof(D3D11_AUTHENTICATED_QUERY_DEVICE_HANDLE_OUTPUT).IsLayoutSequential, Is.True);
        }
