...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D11_AUTHENTICATED_QUERY_INPUTTests
    {
        /// <summary>Validates that the <see cref="D3D11_AUTHENTICATED_QUERY_INPUT" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3D11_AUTHENTICATED_QUERY_INPUT>(), Is.EqualTo(sizeof(D3D11_AUTHENTICATED_QUERY_INPUT)));
        }
