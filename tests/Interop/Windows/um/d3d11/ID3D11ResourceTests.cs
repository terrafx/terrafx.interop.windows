...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ID3D11ResourceTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ID3D11Resource" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(ID3D11Resource).GUID, Is.EqualTo(IID_ID3D11Resource));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ID3D11Resource>(), Is.EqualTo(sizeof(ID3D11Resource)));
        }
        ...
        {
            Assert.That(typeof(ID3D11Resource).IsLayoutSequential, Is.True);
        }
        ...
        public static void SizeOfTest()
        {
            ...
            {
                Assert.That(sizeof(ID3D11Resource), Is.EqualTo(8));
            }
            else
            {
                Assert.That(sizeof(ID3D11Resource), Is.EqualTo(4));
            }
        }
    }
}
