...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IApplicationAssociationRegistrationTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<IApplicationAssociationRegistration>(), Is.EqualTo(sizeof(IApplicationAssociationRegistration)));
        }
