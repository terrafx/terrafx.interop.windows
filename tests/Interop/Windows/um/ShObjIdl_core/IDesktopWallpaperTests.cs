...
{
    /// <summary>Provides validation of the <see cref="IDesktopWallpaper" /> struct.</summary>
    public static unsafe partial class IDesktopWallpaperTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IDesktopWallpaper" /> struct is correct.</summary>
        [Test]
