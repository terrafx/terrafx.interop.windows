...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IDWriteNumberSubstitutionTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<IDWriteNumberSubstitution>(), Is.EqualTo(sizeof(IDWriteNumberSubstitution)));
        }
