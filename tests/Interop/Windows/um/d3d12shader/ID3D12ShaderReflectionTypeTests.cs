...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ID3D12ShaderReflectionTypeTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<ID3D12ShaderReflectionType>(), Is.EqualTo(sizeof(ID3D12ShaderReflectionType)));
        }
