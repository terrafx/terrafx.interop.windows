...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IMAGE_RESOURCE_DIRECTORY_ENTRYTests
    {
        /// <summary>Validates that the <see cref="IMAGE_RESOURCE_DIRECTORY_ENTRY" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<IMAGE_RESOURCE_DIRECTORY_ENTRY>(), Is.EqualTo(sizeof(IMAGE_RESOURCE_DIRECTORY_ENTRY)));
        }
