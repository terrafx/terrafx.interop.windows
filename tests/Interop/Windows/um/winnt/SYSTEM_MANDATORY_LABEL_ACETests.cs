...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class SYSTEM_MANDATORY_LABEL_ACETests
    {
        /// <summary>Validates that the <see cref="SYSTEM_MANDATORY_LABEL_ACE" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<SYSTEM_MANDATORY_LABEL_ACE>(), Is.EqualTo(sizeof(SYSTEM_MANDATORY_LABEL_ACE)));
        }
