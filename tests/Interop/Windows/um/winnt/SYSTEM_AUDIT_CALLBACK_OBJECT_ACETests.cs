...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class SYSTEM_AUDIT_CALLBACK_OBJECT_ACETests
    {
        /// <summary>Validates that the <see cref="SYSTEM_AUDIT_CALLBACK_OBJECT_ACE" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<SYSTEM_AUDIT_CALLBACK_OBJECT_ACE>(), Is.EqualTo(sizeof(SYSTEM_AUDIT_CALLBACK_OBJECT_ACE)));
        }
        ...
        {
            Assert.That(typeof(SYSTEM_AUDIT_CALLBACK_OBJECT_ACE).IsLayoutSequential, Is.True);
        }
        ...
        {
            Assert.That(sizeof(SYSTEM_AUDIT_CALLBACK_OBJECT_ACE), Is.EqualTo(48));
        }
    }
}
