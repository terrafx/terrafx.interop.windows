...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_DRED_PAGE_FAULT_OUTPUT2Tests
    {
        /// <summary>Validates that the <see cref="D3D12_DRED_PAGE_FAULT_OUTPUT2" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3D12_DRED_PAGE_FAULT_OUTPUT2>(), Is.EqualTo(sizeof(D3D12_DRED_PAGE_FAULT_OUTPUT2)));
        }
