...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_QUERY_DATA_PIPELINE_STATISTICSTests
    {
        /// <summary>Validates that the <see cref="D3D12_QUERY_DATA_PIPELINE_STATISTICS" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3D12_QUERY_DATA_PIPELINE_STATISTICS>(), Is.EqualTo(sizeof(D3D12_QUERY_DATA_PIPELINE_STATISTICS)));
        }
