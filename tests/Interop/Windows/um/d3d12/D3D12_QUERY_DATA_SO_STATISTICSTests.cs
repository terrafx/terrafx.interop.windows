...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_QUERY_DATA_SO_STATISTICSTests
    {
        /// <summary>Validates that the <see cref="D3D12_QUERY_DATA_SO_STATISTICS" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3D12_QUERY_DATA_SO_STATISTICS>(), Is.EqualTo(sizeof(D3D12_QUERY_DATA_SO_STATISTICS)));
        }
