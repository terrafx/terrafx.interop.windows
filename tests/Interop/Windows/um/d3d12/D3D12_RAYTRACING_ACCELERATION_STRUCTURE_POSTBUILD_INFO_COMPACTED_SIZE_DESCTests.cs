...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_COMPACTED_SIZE_DESCTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_COMPACTED_SIZE_DESC>(), Is.EqualTo(sizeof(D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_COMPACTED_SIZE_DESC)));
        }
        ...
        {
            Assert.That(typeof(D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_COMPACTED_SIZE_DESC).IsLayoutSequential, Is.True);
        }
        ...
        {
            Assert.That(sizeof(D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_COMPACTED_SIZE_DESC), Is.EqualTo(8));
        }
    }
}
