...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPE_COUNTTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPE_COUNT>(), Is.EqualTo(sizeof(D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPE_COUNT)));
        }
        ...
        {
            Assert.That(typeof(D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPE_COUNT).IsLayoutSequential, Is.True);
        }
        ...
        {
            Assert.That(sizeof(D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPE_COUNT), Is.EqualTo(8));
        }
    }
}
