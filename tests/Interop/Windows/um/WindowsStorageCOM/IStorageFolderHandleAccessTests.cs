...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IStorageFolderHandleAccessTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IStorageFolderHandleAccess" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(IStorageFolderHandleAccess).GUID, Is.EqualTo(IID_IStorageFolderHandleAccess));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IStorageFolderHandleAccess>(), Is.EqualTo(sizeof(IStorageFolderHandleAccess)));
        }
