...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIESTests
    {
        /// <summary>Validates that the <see cref="D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES>(), Is.EqualTo(sizeof(D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES)));
        }
