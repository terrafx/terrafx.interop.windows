...
// Ported from um/windows.graphics.holographic.interop.h in the Windows SDK for Windows 10.0.22000.0
...
/// <summary>Provides validation of the <see cref="IHolographicCameraRenderingParametersInterop" /> struct.</summary>
[SupportedOSPlatform("windows10.0.19041.0")]
public static unsafe partial class IHolographicCameraRenderingParametersInteropTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IHolographicCameraRenderingParametersInterop" /> struct is correct.</summary>
    [Test]
