...
public static unsafe partial class IMediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgsTests
{
    ...
    {
        Assert.That(typeof(IMediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs).GUID, Is.EqualTo(IID_IMediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs));
    }
}
