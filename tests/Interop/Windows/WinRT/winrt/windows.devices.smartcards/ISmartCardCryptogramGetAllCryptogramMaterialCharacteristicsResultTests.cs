...
public static unsafe partial class ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResultTests
{
    ...
    {
        Assert.That(typeof(ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult).GUID, Is.EqualTo(IID_ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult));
    }
}
