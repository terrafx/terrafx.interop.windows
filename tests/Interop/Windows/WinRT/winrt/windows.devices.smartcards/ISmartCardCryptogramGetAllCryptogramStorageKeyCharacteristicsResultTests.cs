...
public static unsafe partial class ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResultTests
{
    ...
    {
        Assert.That(typeof(ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult).GUID, Is.EqualTo(IID_ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult));
    }
}
