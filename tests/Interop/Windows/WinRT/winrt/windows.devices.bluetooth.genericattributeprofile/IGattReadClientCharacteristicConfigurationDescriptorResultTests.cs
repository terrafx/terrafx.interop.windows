...
public static unsafe partial class IGattReadClientCharacteristicConfigurationDescriptorResultTests
{
    ...
    {
        Assert.That(typeof(IGattReadClientCharacteristicConfigurationDescriptorResult).GUID, Is.EqualTo(IID_IGattReadClientCharacteristicConfigurationDescriptorResult));
    }
}
