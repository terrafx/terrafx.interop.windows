...
public static unsafe partial class IGattServiceProviderAdvertisementStatusChangedEventArgsTests
{
    ...
    {
        Assert.That(typeof(IGattServiceProviderAdvertisementStatusChangedEventArgs).GUID, Is.EqualTo(IID_IGattServiceProviderAdvertisementStatusChangedEventArgs));
    }
}
