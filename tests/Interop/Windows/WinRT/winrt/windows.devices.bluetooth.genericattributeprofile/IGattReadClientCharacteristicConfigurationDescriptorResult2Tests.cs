...
public static unsafe partial class IGattReadClientCharacteristicConfigurationDescriptorResult2Tests
{
    ...
    {
        Assert.That(typeof(IGattReadClientCharacteristicConfigurationDescriptorResult2).GUID, Is.EqualTo(IID_IGattReadClientCharacteristicConfigurationDescriptorResult2));
    }
}
