...
namespace TerraFX.Interop.Windows.UnitTests
{
    ...
    public static unsafe partial class DXGI_SWAP_CHAIN_DESC1Tests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<DXGI_SWAP_CHAIN_DESC1>(), Is.EqualTo(sizeof(DXGI_SWAP_CHAIN_DESC1)));
        }

        /// <summary>Validates that the <see cref="DXGI_SWAP_CHAIN_DESC1" /> struct has the right <see cref="LayoutKind" />.</summary>
        [Test]
        ...
        /// <summary>Validates that the <see cref="DXGI_SWAP_CHAIN_DESC1" /> struct has the correct size.</summary>
        [Test]
        public static void SizeOfTest()
        {
            Assert.That(sizeof(DXGI_SWAP_CHAIN_DESC1), Is.EqualTo(48));
        }
    }
}
