...
public static unsafe partial class SpatialAudioObjectRenderStreamForMetadataActivationParams2Tests
{
    ...
    {
        Assert.That(Marshal.SizeOf<SpatialAudioObjectRenderStreamForMetadataActivationParams2>(), Is.EqualTo(sizeof(SpatialAudioObjectRenderStreamForMetadataActivationParams2)));
    }
    ...
    {
        Assert.That(typeof(SpatialAudioObjectRenderStreamForMetadataActivationParams2).IsLayoutSequential, Is.True);
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(sizeof(SpatialAudioObjectRenderStreamForMetadataActivationParams2), Is.EqualTo(72));
        }
        else
        {
            Assert.That(sizeof(SpatialAudioObjectRenderStreamForMetadataActivationParams2), Is.EqualTo(56));
        }
    }
}
