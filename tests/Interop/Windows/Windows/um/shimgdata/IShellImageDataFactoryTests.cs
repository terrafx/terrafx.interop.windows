...
// Ported from um/shimgdata.h in the Windows SDK for Windows 10.0.22000.0
...
/// <summary>Provides validation of the <see cref="IShellImageDataFactory" /> struct.</summary>
public static unsafe partial class IShellImageDataFactoryTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IShellImageDataFactory" /> struct is correct.</summary>
    [Test]
