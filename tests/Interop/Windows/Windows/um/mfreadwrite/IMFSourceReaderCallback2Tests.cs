...
/// <summary>Provides validation of the <see cref="IMFSourceReaderCallback2" /> struct.</summary>
public static unsafe partial class IMFSourceReaderCallback2Tests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IMFSourceReaderCallback2" /> struct is correct.</summary>
    [Test]
