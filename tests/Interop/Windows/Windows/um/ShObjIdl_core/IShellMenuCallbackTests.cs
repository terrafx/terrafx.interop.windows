...
/// <summary>Provides validation of the <see cref="IShellMenuCallback" /> struct.</summary>
public static unsafe partial class IShellMenuCallbackTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IShellMenuCallback" /> struct is correct.</summary>
    [Test]
