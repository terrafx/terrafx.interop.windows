...
{
    /// <summary>Provides validation of the <see cref="IFileSystemBindData" /> struct.</summary>
    public static unsafe partial class IFileSystemBindDataTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IFileSystemBindData" /> struct is correct.</summary>
        [Test]
