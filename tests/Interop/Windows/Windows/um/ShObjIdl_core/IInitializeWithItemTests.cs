...
/// <summary>Provides validation of the <see cref="IInitializeWithItem" /> struct.</summary>
public static unsafe partial class IInitializeWithItemTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IInitializeWithItem" /> struct is correct.</summary>
    [Test]
