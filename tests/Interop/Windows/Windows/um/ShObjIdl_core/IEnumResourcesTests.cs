...
{
    /// <summary>Provides validation of the <see cref="IEnumResources" /> struct.</summary>
    public static unsafe partial class IEnumResourcesTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IEnumResources" /> struct is correct.</summary>
        [Test]
