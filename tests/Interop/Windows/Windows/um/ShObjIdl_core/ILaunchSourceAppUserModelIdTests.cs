...
namespace TerraFX.Interop.Windows.UnitTests
{
    ...
    public static unsafe partial class ILaunchSourceAppUserModelIdTests
    {
        ...
        {
            Assert.That(typeof(ILaunchSourceAppUserModelId).GUID, Is.EqualTo(IID_ILaunchSourceAppUserModelId));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ILaunchSourceAppUserModelId>(), Is.EqualTo(sizeof(ILaunchSourceAppUserModelId)));
        }
