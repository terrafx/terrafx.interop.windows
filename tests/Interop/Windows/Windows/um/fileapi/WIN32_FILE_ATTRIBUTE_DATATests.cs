...
// Ported from um/fileapi.h in the Windows SDK for Windows 10.0.22000.0
...
public static unsafe partial class WIN32_FILE_ATTRIBUTE_DATATests
{
    ...
    {
        Assert.That(Marshal.SizeOf<WIN32_FILE_ATTRIBUTE_DATA>(), Is.EqualTo(sizeof(WIN32_FILE_ATTRIBUTE_DATA)));
    }
