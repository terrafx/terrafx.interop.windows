...
namespace TerraFX.Interop.Windows.UnitTests
{
    ...
    public static unsafe partial class WS_REQUEST_SECURITY_TOKEN_PROPERTY_CONSTRAINTTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<WS_REQUEST_SECURITY_TOKEN_PROPERTY_CONSTRAINT>(), Is.EqualTo(sizeof(WS_REQUEST_SECURITY_TOKEN_PROPERTY_CONSTRAINT)));
        }
        ...
        {
            Assert.That(typeof(WS_REQUEST_SECURITY_TOKEN_PROPERTY_CONSTRAINT).IsLayoutSequential, Is.True);
        }
