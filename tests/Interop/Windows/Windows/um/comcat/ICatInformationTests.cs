...
/// <summary>Provides validation of the <see cref="ICatInformation" /> struct.</summary>
public static unsafe partial class ICatInformationTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ICatInformation" /> struct is correct.</summary>
    [Test]
