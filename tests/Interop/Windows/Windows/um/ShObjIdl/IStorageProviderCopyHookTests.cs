...
namespace TerraFX.Interop.Windows.UnitTests
{
    ...
    public static unsafe partial class IStorageProviderCopyHookTests
    {
        ...
        {
            Assert.That(typeof(IStorageProviderCopyHook).GUID, Is.EqualTo(IID_IStorageProviderCopyHook));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IStorageProviderCopyHook>(), Is.EqualTo(sizeof(IStorageProviderCopyHook)));
        }
