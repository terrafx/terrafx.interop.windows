...
namespace TerraFX.Interop.Windows.UnitTests
{
    ...
    public static unsafe partial class DispHTMLW3CComputedStyleTests
    {
        ...
        {
            Assert.That(typeof(DispHTMLW3CComputedStyle).GUID, Is.EqualTo(IID_DispHTMLW3CComputedStyle));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<DispHTMLW3CComputedStyle>(), Is.EqualTo(sizeof(DispHTMLW3CComputedStyle)));
        }
