...
namespace TerraFX.Interop.Windows.UnitTests
{
    ...
    public static unsafe partial class ISVGPathSegCurvetoQuadraticRelTests
    {
        ...
        {
            Assert.That(typeof(ISVGPathSegCurvetoQuadraticRel).GUID, Is.EqualTo(IID_ISVGPathSegCurvetoQuadraticRel));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ISVGPathSegCurvetoQuadraticRel>(), Is.EqualTo(sizeof(ISVGPathSegCurvetoQuadraticRel)));
        }
