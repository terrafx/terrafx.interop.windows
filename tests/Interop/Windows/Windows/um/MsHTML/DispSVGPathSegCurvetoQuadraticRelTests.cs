...
public static unsafe partial class DispSVGPathSegCurvetoQuadraticRelTests
{
    ...
    {
        Assert.That(typeof(DispSVGPathSegCurvetoQuadraticRel).GUID, Is.EqualTo(IID_DispSVGPathSegCurvetoQuadraticRel));
    }
    ...
    {
        Assert.That(Marshal.SizeOf<DispSVGPathSegCurvetoQuadraticRel>(), Is.EqualTo(sizeof(DispSVGPathSegCurvetoQuadraticRel)));
    }
