...
public static unsafe partial class DispDOMProcessingInstructionTests
{
    ...
    {
        Assert.That(typeof(DispDOMProcessingInstruction).GUID, Is.EqualTo(IID_DispDOMProcessingInstruction));
    }
    ...
    {
        Assert.That(Marshal.SizeOf<DispDOMProcessingInstruction>(), Is.EqualTo(sizeof(DispDOMProcessingInstruction)));
    }
