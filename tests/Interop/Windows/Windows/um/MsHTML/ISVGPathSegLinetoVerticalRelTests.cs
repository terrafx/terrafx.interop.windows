...
public static unsafe partial class ISVGPathSegLinetoVerticalRelTests
{
    ...
    {
        Assert.That(typeof(ISVGPathSegLinetoVerticalRel).GUID, Is.EqualTo(IID_ISVGPathSegLinetoVerticalRel));
    }
    ...
    {
        Assert.That(Marshal.SizeOf<ISVGPathSegLinetoVerticalRel>(), Is.EqualTo(sizeof(ISVGPathSegLinetoVerticalRel)));
    }
