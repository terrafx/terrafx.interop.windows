...
namespace TerraFX.Interop.Windows.UnitTests
{
    ...
    public static unsafe partial class IHTMLStyleSheetPagesCollectionTests
    {
        ...
        {
            Assert.That(typeof(IHTMLStyleSheetPagesCollection).GUID, Is.EqualTo(IID_IHTMLStyleSheetPagesCollection));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IHTMLStyleSheetPagesCollection>(), Is.EqualTo(sizeof(IHTMLStyleSheetPagesCollection)));
        }
