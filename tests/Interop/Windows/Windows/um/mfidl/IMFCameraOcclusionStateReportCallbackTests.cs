...
public static unsafe partial class IMFCameraOcclusionStateReportCallbackTests
{
    ...
    {
        Assert.That(typeof(IMFCameraOcclusionStateReportCallback).GUID, Is.EqualTo(IID_IMFCameraOcclusionStateReportCallback));
    }
    ...
    {
        Assert.That(Marshal.SizeOf<IMFCameraOcclusionStateReportCallback>(), Is.EqualTo(sizeof(IMFCameraOcclusionStateReportCallback)));
    }
