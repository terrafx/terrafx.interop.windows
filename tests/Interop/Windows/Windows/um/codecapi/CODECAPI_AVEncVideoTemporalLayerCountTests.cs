...
public static unsafe partial class CODECAPI_AVEncVideoTemporalLayerCountTests
{
    ...
    {
        Assert.That(typeof(CODECAPI_AVEncVideoTemporalLayerCount).GUID, Is.EqualTo(IID_CODECAPI_AVEncVideoTemporalLayerCount));
    }
