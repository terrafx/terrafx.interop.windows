...
public static unsafe partial class CODECAPI_AVEncMP12MuxSysFixedTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncMP12MuxSysFixed" /> struct is correct.</summary>
    [Test]
    public static void GuidOfTest()
    {
        Assert.That(typeof(CODECAPI_AVEncMP12MuxSysFixed).GUID, Is.EqualTo(IID_CODECAPI_AVEncMP12MuxSysFixed));
    }
}
