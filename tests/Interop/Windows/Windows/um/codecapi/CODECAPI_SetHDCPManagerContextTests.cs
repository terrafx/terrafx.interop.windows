...
public static unsafe partial class CODECAPI_SetHDCPManagerContextTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_SetHDCPManagerContext" /> struct is correct.</summary>
    [Test]
    public static void GuidOfTest()
    {
        Assert.That(typeof(CODECAPI_SetHDCPManagerContext).GUID, Is.EqualTo(IID_CODECAPI_SetHDCPManagerContext));
    }
