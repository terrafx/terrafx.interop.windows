...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVEncDDPreferredStereoDownMixMode" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVEncDDPreferredStereoDownMixModeTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncDDPreferredStereoDownMixMode" /> struct is correct.</summary>
        [Test]
