...
public static unsafe partial class CODECAPI_GUID_AVEncDTSHDTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_GUID_AVEncDTSHD" /> struct is correct.</summary>
    [Test]
    public static void GuidOfTest()
    {
        Assert.That(typeof(CODECAPI_GUID_AVEncDTSHD).GUID, Is.EqualTo(IID_CODECAPI_GUID_AVEncDTSHD));
    }
