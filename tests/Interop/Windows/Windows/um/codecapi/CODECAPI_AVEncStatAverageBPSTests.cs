...
/// <summary>Provides validation of the <see cref="CODECAPI_AVEncStatAverageBPS" /> struct.</summary>
public static unsafe partial class CODECAPI_AVEncStatAverageBPSTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncStatAverageBPS" /> struct is correct.</summary>
    [Test]
