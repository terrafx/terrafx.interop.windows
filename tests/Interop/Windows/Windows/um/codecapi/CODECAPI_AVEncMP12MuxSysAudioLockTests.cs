...
{
    /// <summary>Provides validation of the <see cref="CODECAPI_AVEncMP12MuxSysAudioLock" /> struct.</summary>
    public static unsafe partial class CODECAPI_AVEncMP12MuxSysAudioLockTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncMP12MuxSysAudioLock" /> struct is correct.</summary>
        [Test]
