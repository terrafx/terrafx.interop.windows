...
public static unsafe partial class CODECAPI_AVEncVideoHeaderSecondsTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncVideoHeaderSeconds" /> struct is correct.</summary>
    [Test]
    public static void GuidOfTest()
    {
        Assert.That(typeof(CODECAPI_AVEncVideoHeaderSeconds).GUID, Is.EqualTo(IID_CODECAPI_AVEncVideoHeaderSeconds));
    }
}
