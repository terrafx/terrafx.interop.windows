...
public static unsafe partial class CODECAPI_AVEncMPVGOPSizeMaxTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncMPVGOPSizeMax" /> struct is correct.</summary>
    [Test]
    public static void GuidOfTest()
    {
        Assert.That(typeof(CODECAPI_AVEncMPVGOPSizeMax).GUID, Is.EqualTo(IID_CODECAPI_AVEncMPVGOPSizeMax));
    }
