...
/// <summary>Provides validation of the <see cref="CODECAPI_AVEncWMVKeyFrameBufferLevelMarker" /> struct.</summary>
public static unsafe partial class CODECAPI_AVEncWMVKeyFrameBufferLevelMarkerTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="CODECAPI_AVEncWMVKeyFrameBufferLevelMarker" /> struct is correct.</summary>
    [Test]
