...
{
    /// <summary>Provides validation of the <see cref="IAppxManifestDriverConstraintsEnumerator" /> struct.</summary>
    public static unsafe partial class IAppxManifestDriverConstraintsEnumeratorTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IAppxManifestDriverConstraintsEnumerator" /> struct is correct.</summary>
        [Test]
