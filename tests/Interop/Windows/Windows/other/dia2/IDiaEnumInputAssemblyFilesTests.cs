...
{
    /// <summary>Provides validation of the <see cref="IDiaEnumInputAssemblyFiles" /> struct.</summary>
    public static unsafe partial class IDiaEnumInputAssemblyFilesTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IDiaEnumInputAssemblyFiles" /> struct is correct.</summary>
        [Test]
