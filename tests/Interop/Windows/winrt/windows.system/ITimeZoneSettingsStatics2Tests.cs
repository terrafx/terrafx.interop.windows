...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ITimeZoneSettingsStatics2Tests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ITimeZoneSettingsStatics2" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(ITimeZoneSettingsStatics2).GUID, Is.EqualTo(IID_ITimeZoneSettingsStatics2));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ITimeZoneSettingsStatics2>(), Is.EqualTo(sizeof(ITimeZoneSettingsStatics2)));
        }
