...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IUserAuthenticationStatusChangingEventArgsTests
    {
        ...
        {
            Assert.That(typeof(IUserAuthenticationStatusChangingEventArgs).GUID, Is.EqualTo(IID_IUserAuthenticationStatusChangingEventArgs));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IUserAuthenticationStatusChangingEventArgs>(), Is.EqualTo(sizeof(IUserAuthenticationStatusChangingEventArgs)));
        }
