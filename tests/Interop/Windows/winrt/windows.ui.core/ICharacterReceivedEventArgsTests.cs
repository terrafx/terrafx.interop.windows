...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ICharacterReceivedEventArgsTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ICharacterReceivedEventArgs" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(ICharacterReceivedEventArgs).GUID, Is.EqualTo(IID_ICharacterReceivedEventArgs));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ICharacterReceivedEventArgs>(), Is.EqualTo(sizeof(ICharacterReceivedEventArgs)));
        }
