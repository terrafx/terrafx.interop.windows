...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ICoreApplicationViewTitleBarTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="ICoreApplicationViewTitleBar" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(ICoreApplicationViewTitleBar).GUID, Is.EqualTo(IID_ICoreApplicationViewTitleBar));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<ICoreApplicationViewTitleBar>(), Is.EqualTo(sizeof(ICoreApplicationViewTitleBar)));
        }
