...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ICoreImmersiveApplicationTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<ICoreImmersiveApplication>(), Is.EqualTo(sizeof(ICoreImmersiveApplication)));
        }
