...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IRadialControllerButtonClickedEventArgs2Tests
    {
        ...
        {
            Assert.That(typeof(IRadialControllerButtonClickedEventArgs2).GUID, Is.EqualTo(IID_IRadialControllerButtonClickedEventArgs2));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IRadialControllerButtonClickedEventArgs2>(), Is.EqualTo(sizeof(IRadialControllerButtonClickedEventArgs2)));
        }
