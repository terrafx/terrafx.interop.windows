...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IRadialControllerButtonReleasedEventArgsTests
    {
        ...
        {
            Assert.That(typeof(IRadialControllerButtonReleasedEventArgs).GUID, Is.EqualTo(IID_IRadialControllerButtonReleasedEventArgs));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IRadialControllerButtonReleasedEventArgs>(), Is.EqualTo(sizeof(IRadialControllerButtonReleasedEventArgs)));
        }
