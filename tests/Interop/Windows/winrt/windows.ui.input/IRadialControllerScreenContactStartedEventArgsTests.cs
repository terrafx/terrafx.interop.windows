...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IRadialControllerScreenContactStartedEventArgsTests
    {
        ...
        {
            Assert.That(typeof(IRadialControllerScreenContactStartedEventArgs).GUID, Is.EqualTo(IID_IRadialControllerScreenContactStartedEventArgs));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IRadialControllerScreenContactStartedEventArgs>(), Is.EqualTo(sizeof(IRadialControllerScreenContactStartedEventArgs)));
        }
        ...
        {
            Assert.That(typeof(IRadialControllerScreenContactStartedEventArgs).IsLayoutSequential, Is.True);
        }
