...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IRadialControllerConfigurationStaticsTests
    {
        ...
        {
            Assert.That(typeof(IRadialControllerConfigurationStatics).GUID, Is.EqualTo(IID_IRadialControllerConfigurationStatics));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IRadialControllerConfigurationStatics>(), Is.EqualTo(sizeof(IRadialControllerConfigurationStatics)));
        }
