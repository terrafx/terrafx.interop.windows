...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class ICompositionDrawingSurfaceInteropTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<ICompositionDrawingSurfaceInterop>(), Is.EqualTo(sizeof(ICompositionDrawingSurfaceInterop)));
        }
