...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IRandomAccessStreamReferenceTests
    {
        /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IRandomAccessStreamReference" /> struct is correct.</summary>
        [Test]
        public static void GuidOfTest()
        {
            Assert.That(typeof(IRandomAccessStreamReference).GUID, Is.EqualTo(IID_IRandomAccessStreamReference));
        }
        ...
        {
            Assert.That(Marshal.SizeOf<IRandomAccessStreamReference>(), Is.EqualTo(sizeof(IRandomAccessStreamReference)));
        }
