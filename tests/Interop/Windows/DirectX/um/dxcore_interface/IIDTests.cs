...
public static partial class IIDTests
{
    ...
    {
        Assert.That(IID_IDXCoreAdapterFactory1, Is.EqualTo(new Guid(0xd5682e19, 0x6d21, 0x401c, 0x82, 0x7a, 0x9a, 0x51, 0xa4, 0xea, 0x35, 0xd7)));
    }
    ...
    {
        Assert.That(IID_IDXCoreAdapter1, Is.EqualTo(new Guid(0xa0783366, 0xcfa3, 0x43be, 0x9d, 0x79, 0x55, 0xb2, 0xda, 0x97, 0xc6, 0x3c)));
    }
}
