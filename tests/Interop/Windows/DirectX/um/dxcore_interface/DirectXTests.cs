...
// Ported from um/dxcore_interface.h in the Windows SDK for Windows 10.0.26100.0
...
public static partial class DirectXTests
{
    ...
    {
        Assert.That(DXCORE_ADAPTER_ATTRIBUTE_D3D12_GENERIC_ML, Is.EqualTo(new Guid(0xb71b0d41, 0x1088, 0x422f, 0xa2, 0x7c, 0x2, 0x50, 0xb7, 0xd3, 0xa9, 0x88)));
    }
    ...
    {
        Assert.That(DXCORE_ADAPTER_ATTRIBUTE_D3D12_GENERIC_MEDIA, Is.EqualTo(new Guid(0x8eb2c848, 0x82f6, 0x4b49, 0xaa, 0x87, 0xae, 0xcf, 0xcf, 0x1, 0x74, 0xc6)));
    }
    ...
    {
        Assert.That(DXCORE_HARDWARE_TYPE_ATTRIBUTE_GPU, Is.EqualTo(new Guid(0xb69eb219, 0x3ded, 0x4464, 0x97, 0x9f, 0xa0, 0xb, 0xd4, 0x68, 0x70, 0x6)));
    }
    ...
    {
        Assert.That(DXCORE_HARDWARE_TYPE_ATTRIBUTE_COMPUTE_ACCELERATOR, Is.EqualTo(new Guid(0xe0b195da, 0x58ef, 0x4a22, 0x90, 0xf1, 0x1f, 0x28, 0x16, 0x9c, 0xab, 0x8d)));
    }
    ...
    {
        Assert.That(DXCORE_HARDWARE_TYPE_ATTRIBUTE_NPU, Is.EqualTo(new Guid(0xd46140c4, 0xadd7, 0x451b, 0x9e, 0x56, 0x6, 0xfe, 0x8c, 0x3b, 0x58, 0xed)));
    }
    ...
    {
        Assert.That(DXCORE_HARDWARE_TYPE_ATTRIBUTE_MEDIA_ACCELERATOR, Is.EqualTo(new Guid(0x66bdb96a, 0x50b, 0x44c7, 0xa4, 0xfd, 0xd1, 0x44, 0xce, 0xa, 0xb4, 0x43)));
    }
}
