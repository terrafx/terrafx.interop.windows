...
/// <summary>Provides validation of the <see cref="IDirectInputEffect" /> struct.</summary>
public static unsafe partial class IDirectInputEffectTests
{
    /// <summary>Validates that the <see cref="Guid" /> of the <see cref="IDirectInputEffect" /> struct is correct.</summary>
    [Test]
