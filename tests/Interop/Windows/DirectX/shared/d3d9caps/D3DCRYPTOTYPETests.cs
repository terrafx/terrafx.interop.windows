...
using System;
using static TerraFX.Interop.DirectX.D3DCRYPTOTYPE;
...
public static partial class D3DCRYPTOTYPETests
{
    ...
    {
        Assert.That(D3DCRYPTOTYPE_AES128_CTR, Is.EqualTo(new Guid(0x9b6bd711, 0x4f74, 0x41c9, 0x9e, 0x7b, 0xb, 0xe2, 0xd7, 0xd9, 0x3b, 0x4f)));
    }
    ...
    {
        Assert.That(D3DCRYPTOTYPE_PROPRIETARY, Is.EqualTo(new Guid(0xab4e9afd, 0x1d1c, 0x46e6, 0xa7, 0x2f, 0x8, 0x69, 0x91, 0x7b, 0xd, 0xe8)));
    }
}
