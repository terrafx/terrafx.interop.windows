...
using System;
using static TerraFX.Interop.DirectX.D3DAUTHENTICATEDCONFIGURE;
...
public static partial class D3DAUTHENTICATEDCONFIGURETests
{
    ...
    {
        Assert.That(D3DAUTHENTICATEDCONFIGURE_INITIALIZE, Is.EqualTo(new Guid(0x6114bdb, 0x3523, 0x470a, 0x8d, 0xca, 0xfb, 0xc2, 0x84, 0x51, 0x54, 0xf0)));
    }
    ...
    {
        Assert.That(D3DAUTHENTICATEDCONFIGURE_PROTECTION, Is.EqualTo(new Guid(0x50455658, 0x3f47, 0x4362, 0xbf, 0x99, 0xbf, 0xdf, 0xcd, 0xe9, 0xed, 0x29)));
    }
    ...
    {
        Assert.That(D3DAUTHENTICATEDCONFIGURE_CRYPTOSESSION, Is.EqualTo(new Guid(0x6346cc54, 0x2cfc, 0x4ad4, 0x82, 0x24, 0xd1, 0x58, 0x37, 0xde, 0x77, 0x0)));
    }
    ...
    {
        Assert.That(D3DAUTHENTICATEDCONFIGURE_SHAREDRESOURCE, Is.EqualTo(new Guid(0x772d047, 0x1b40, 0x48e8, 0x9c, 0xa6, 0xb5, 0xf5, 0x10, 0xde, 0x9f, 0x1)));
    }
    ...
    {
        Assert.That(D3DAUTHENTICATEDCONFIGURE_ENCRYPTIONWHENACCESSIBLE, Is.EqualTo(new Guid(0x41fff286, 0x6ae0, 0x4d43, 0x9d, 0x55, 0xa4, 0x6e, 0x9e, 0xfd, 0x15, 0x8a)));
    }
}
