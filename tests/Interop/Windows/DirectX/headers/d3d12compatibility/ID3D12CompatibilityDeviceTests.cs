...
public static unsafe partial class ID3D12CompatibilityDeviceTests
{
    ...
    {
        Assert.That(typeof(ID3D12CompatibilityDevice).GUID, Is.EqualTo(IID_ID3D12CompatibilityDevice));
    }
    ...
    {
        Assert.That(Marshal.SizeOf<ID3D12CompatibilityDevice>(), Is.EqualTo(sizeof(ID3D12CompatibilityDevice)));
    }
