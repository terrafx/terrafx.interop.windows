...
public static unsafe partial class D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATATests
{
    ...
    {
        Assert.That(Marshal.SizeOf<D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA>(), Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA)));
    }
    ...
    {
        Assert.That(typeof(D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA).IsLayoutSequential, Is.True);
    }
