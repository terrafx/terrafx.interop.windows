...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12CommandQueueDownlevel
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12CommandQueueDownlevel*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12CommandQueueDownlevel*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12CommandQueueDownlevel*, uint>)(lpVtbl[1]))((ID3D12CommandQueueDownlevel*)Unsafe.AsPointer(ref this));
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12CommandQueueDownlevel*, uint>)(lpVtbl[2]))((ID3D12CommandQueueDownlevel*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12CommandQueueDownlevel*, ID3D12GraphicsCommandList*, ID3D12Resource*, IntPtr, D3D12_DOWNLEVEL_PRESENT_FLAGS, int>)(lpVtbl[3]))((ID3D12CommandQueueDownlevel*)Unsafe.AsPointer(ref this), pOpenCommandList, pSourceTex2D, hWindow, Flags);
        }
    }
}
