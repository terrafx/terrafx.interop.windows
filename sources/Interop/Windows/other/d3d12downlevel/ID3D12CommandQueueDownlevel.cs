...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12CommandQueueDownlevel
    {
        ...
        [VtblIndex(3)]
        [return: NativeTypeName("HRESULT")]
        public int Present(ID3D12GraphicsCommandList* pOpenCommandList, ID3D12Resource* pSourceTex2D, [NativeTypeName("HWND")] IntPtr hWindow, D3D12_DOWNLEVEL_PRESENT_FLAGS Flags)
        {
