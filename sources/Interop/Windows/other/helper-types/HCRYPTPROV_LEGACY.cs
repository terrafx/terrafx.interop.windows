...
namespace TerraFX.Interop
{
    public unsafe partial struct HCRYPTPROV_LEGACY : IComparable, IComparable<HCRYPTPROV_LEGACY>, IEquatable<HCRYPTPROV_LEGACY>, IFormattable
    {
        ...
        public static HCRYPTPROV_LEGACY INVALID_VALUE => new HCRYPTPROV_LEGACY(-1);
        ...
        public int CompareTo(object? obj)
        {
            ...
            return (obj is null) ? 1 : throw new ArgumentException("obj is not an instance of HCRYPTPROV_LEGACY.");
        }

        public int CompareTo(HCRYPTPROV_LEGACY other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is HCRYPTPROV_LEGACY other) && Equals(other);

        public bool Equals(HCRYPTPROV_LEGACY other) => Value.Equals(other.Value);
