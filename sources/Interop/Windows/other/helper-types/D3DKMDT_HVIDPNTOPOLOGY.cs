...
namespace TerraFX.Interop
{
    public unsafe partial struct D3DKMDT_HVIDPNTOPOLOGY : IComparable, IComparable<D3DKMDT_HVIDPNTOPOLOGY>, IEquatable<D3DKMDT_HVIDPNTOPOLOGY>, IFormattable
    {
        ...
        public static implicit operator long(D3DKMDT_HVIDPNTOPOLOGY value) => value.Value;

        public static explicit operator D3DKMDT_HVIDPNTOPOLOGY(nint value) => new D3DKMDT_HVIDPNTOPOLOGY((nint)(value));

        public static implicit operator nint(D3DKMDT_HVIDPNTOPOLOGY value) => value.Value;
        ...
        public int CompareTo(D3DKMDT_HVIDPNTOPOLOGY other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is D3DKMDT_HVIDPNTOPOLOGY other) && Equals(other);

        public bool Equals(D3DKMDT_HVIDPNTOPOLOGY other) => Value.Equals(other.Value);
