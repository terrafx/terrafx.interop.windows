...
{
    public unsafe partial struct HFILTER : IEquatable<HFILTER>
    {
        ...
        public static HFILTER INVALID_HANDLE_VALUE => new HFILTER(-1);
        ...
        public bool Equals(HFILTER other) => (this == other);
