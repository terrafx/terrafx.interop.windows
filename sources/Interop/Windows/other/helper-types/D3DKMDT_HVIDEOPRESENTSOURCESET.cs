...
namespace TerraFX.Interop
{
    public unsafe partial struct D3DKMDT_HVIDEOPRESENTSOURCESET : IComparable, IComparable<D3DKMDT_HVIDEOPRESENTSOURCESET>, IEquatable<D3DKMDT_HVIDEOPRESENTSOURCESET>, IFormattable
    {
        ...
        public static D3DKMDT_HVIDEOPRESENTSOURCESET INVALID_VALUE => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(-1));

        public static D3DKMDT_HVIDEOPRESENTSOURCESET NULL => new D3DKMDT_HVIDEOPRESENTSOURCESET(null);
        ...
        public static implicit operator void*(D3DKMDT_HVIDEOPRESENTSOURCESET value) => value.Value;
        ...
        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(byte value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator byte(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (byte)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(short value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator short(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (short)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(int value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator int(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (int)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(long value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator long(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (long)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(nint value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static implicit operator nint(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (nint)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(sbyte value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator sbyte(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (sbyte)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(ushort value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator ushort(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (ushort)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(uint value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator uint(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (uint)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(ulong value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));

        public static explicit operator ulong(D3DKMDT_HVIDEOPRESENTSOURCESET value) => (ulong)(value.Value);

        public static explicit operator D3DKMDT_HVIDEOPRESENTSOURCESET(nuint value) => new D3DKMDT_HVIDEOPRESENTSOURCESET((void*)(value));
        ...
        public int CompareTo(D3DKMDT_HVIDEOPRESENTSOURCESET other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

        public override bool Equals(object? obj) => (obj is D3DKMDT_HVIDEOPRESENTSOURCESET other) && Equals(other);

        public bool Equals(D3DKMDT_HVIDEOPRESENTSOURCESET other) => ((nuint)(Value)).Equals((nuint)(other.Value));
