...
namespace TerraFX.Interop
{
    public unsafe partial struct LPM_HANDLE : IComparable, IComparable<LPM_HANDLE>, IEquatable<LPM_HANDLE>, IFormattable
    {
        ...
        public static implicit operator long(LPM_HANDLE value) => value.Value;

        public static explicit operator LPM_HANDLE(nint value) => new LPM_HANDLE((nint)(value));

        public static implicit operator nint(LPM_HANDLE value) => value.Value;
        ...
        public int CompareTo(LPM_HANDLE other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is LPM_HANDLE other) && Equals(other);

        public bool Equals(LPM_HANDLE other) => Value.Equals(other.Value);
