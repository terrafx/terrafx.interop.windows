...
namespace TerraFX.Interop
{
    public unsafe partial struct PEERDIST_CONTENTINFO_HANDLE : IComparable, IComparable<PEERDIST_CONTENTINFO_HANDLE>, IEquatable<PEERDIST_CONTENTINFO_HANDLE>, IFormattable
    {
        ...
        public static implicit operator long(PEERDIST_CONTENTINFO_HANDLE value) => value.Value;

        public static explicit operator PEERDIST_CONTENTINFO_HANDLE(nint value) => new PEERDIST_CONTENTINFO_HANDLE((nint)(value));

        public static implicit operator nint(PEERDIST_CONTENTINFO_HANDLE value) => value.Value;
