...
namespace TerraFX.Interop
{
    public unsafe partial struct PEERDIST_CONTENTINFO_HANDLE : IEquatable<PEERDIST_CONTENTINFO_HANDLE>
    {
        ...
        public static PEERDIST_CONTENTINFO_HANDLE INVALID_HANDLE_VALUE => new PEERDIST_CONTENTINFO_HANDLE(-1);
        ...
        public static implicit operator HANDLE(PEERDIST_CONTENTINFO_HANDLE value) => new PEERDIST_CONTENTINFO_HANDLE(value);
