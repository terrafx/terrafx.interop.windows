...
namespace TerraFX.Interop
{
    public unsafe partial struct HDIAGNOSTIC_EVENT_TAG_DESCRIPTION : IComparable, IComparable<HDIAGNOSTIC_EVENT_TAG_DESCRIPTION>, IEquatable<HDIAGNOSTIC_EVENT_TAG_DESCRIPTION>, IFormattable
    {
        ...
        public static HDIAGNOSTIC_EVENT_TAG_DESCRIPTION INVALID_VALUE => new HDIAGNOSTIC_EVENT_TAG_DESCRIPTION(-1);

        public static HDIAGNOSTIC_EVENT_TAG_DESCRIPTION NULL => new HDIAGNOSTIC_EVENT_TAG_DESCRIPTION(0);
        ...
        public static explicit operator HDIAGNOSTIC_EVENT_TAG_DESCRIPTION(void* value) => new HDIAGNOSTIC_EVENT_TAG_DESCRIPTION((nint)(value));
        ...
        public static explicit operator nuint(HDIAGNOSTIC_EVENT_TAG_DESCRIPTION value) => (nuint)(value.Value);
        ...
        public int CompareTo(HDIAGNOSTIC_EVENT_TAG_DESCRIPTION other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is HDIAGNOSTIC_EVENT_TAG_DESCRIPTION other) && Equals(other);

        public bool Equals(HDIAGNOSTIC_EVENT_TAG_DESCRIPTION other) => Value.Equals(other.Value);
