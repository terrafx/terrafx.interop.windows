...
namespace TerraFX.Interop
{
    public unsafe partial struct HDIAGNOSTIC_EVENT_TAG_DESCRIPTION : IEquatable<HDIAGNOSTIC_EVENT_TAG_DESCRIPTION>
    {
        ...
        public static HDIAGNOSTIC_EVENT_TAG_DESCRIPTION INVALID_HANDLE_VALUE => new HDIAGNOSTIC_EVENT_TAG_DESCRIPTION(-1);
        ...
        public static implicit operator HANDLE(HDIAGNOSTIC_EVENT_TAG_DESCRIPTION value) => new HDIAGNOSTIC_EVENT_TAG_DESCRIPTION(value);
