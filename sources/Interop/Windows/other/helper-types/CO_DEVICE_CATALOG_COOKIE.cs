...
namespace TerraFX.Interop
{
    public unsafe partial struct CO_DEVICE_CATALOG_COOKIE : IComparable, IComparable<CO_DEVICE_CATALOG_COOKIE>, IEquatable<CO_DEVICE_CATALOG_COOKIE>, IFormattable
    {
        ...
        public int CompareTo(CO_DEVICE_CATALOG_COOKIE other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is CO_DEVICE_CATALOG_COOKIE other) && Equals(other);

        public bool Equals(CO_DEVICE_CATALOG_COOKIE other) => Value.Equals(other.Value);
