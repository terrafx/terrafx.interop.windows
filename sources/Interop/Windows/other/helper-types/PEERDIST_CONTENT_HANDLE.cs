...
{
    public unsafe partial struct PEERDIST_CONTENT_HANDLE : IEquatable<PEERDIST_CONTENT_HANDLE>
    {
        ...
        public static PEERDIST_CONTENT_HANDLE INVALID_HANDLE_VALUE => new PEERDIST_CONTENT_HANDLE(-1);
        ...
        public static implicit operator byte(PEERDIST_CONTENT_HANDLE value) => (byte)(value.Value);

        public static explicit operator PEERDIST_CONTENT_HANDLE(short value) => new PEERDIST_CONTENT_HANDLE((nint)(value));

        public static implicit operator short(PEERDIST_CONTENT_HANDLE value) => (short)(value.Value);

        public static explicit operator PEERDIST_CONTENT_HANDLE(int value) => new PEERDIST_CONTENT_HANDLE((nint)(value));

        public static implicit operator int(PEERDIST_CONTENT_HANDLE value) => (int)(value.Value);
        ...
        public static implicit operator sbyte(PEERDIST_CONTENT_HANDLE value) => (sbyte)(value.Value);

        public static explicit operator PEERDIST_CONTENT_HANDLE(ushort value) => new PEERDIST_CONTENT_HANDLE((nint)(value));

        public static implicit operator ushort(PEERDIST_CONTENT_HANDLE value) => (ushort)(value.Value);

        public static explicit operator PEERDIST_CONTENT_HANDLE(uint value) => new PEERDIST_CONTENT_HANDLE((nint)(value));

        public static implicit operator uint(PEERDIST_CONTENT_HANDLE value) => (uint)(value.Value);
        ...
        public bool Equals(PEERDIST_CONTENT_HANDLE other) => (this == other);
