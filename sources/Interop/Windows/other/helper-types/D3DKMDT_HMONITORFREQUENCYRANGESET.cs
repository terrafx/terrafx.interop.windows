...
namespace TerraFX.Interop
{
    public unsafe partial struct D3DKMDT_HMONITORFREQUENCYRANGESET : IComparable, IComparable<D3DKMDT_HMONITORFREQUENCYRANGESET>, IEquatable<D3DKMDT_HMONITORFREQUENCYRANGESET>, IFormattable
    {
        ...
        public static D3DKMDT_HMONITORFREQUENCYRANGESET INVALID_VALUE => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(-1));

        public static D3DKMDT_HMONITORFREQUENCYRANGESET NULL => new D3DKMDT_HMONITORFREQUENCYRANGESET(null);
        ...
        public static implicit operator void*(D3DKMDT_HMONITORFREQUENCYRANGESET value) => value.Value;
        ...
        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(byte value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator byte(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (byte)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(short value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator short(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (short)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(int value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator int(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (int)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(long value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator long(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (long)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(nint value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static implicit operator nint(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (nint)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(sbyte value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator sbyte(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (sbyte)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(ushort value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator ushort(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (ushort)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(uint value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator uint(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (uint)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(ulong value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));

        public static explicit operator ulong(D3DKMDT_HMONITORFREQUENCYRANGESET value) => (ulong)(value.Value);

        public static explicit operator D3DKMDT_HMONITORFREQUENCYRANGESET(nuint value) => new D3DKMDT_HMONITORFREQUENCYRANGESET((void*)(value));
        ...
        public int CompareTo(D3DKMDT_HMONITORFREQUENCYRANGESET other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

        public override bool Equals(object? obj) => (obj is D3DKMDT_HMONITORFREQUENCYRANGESET other) && Equals(other);

        public bool Equals(D3DKMDT_HMONITORFREQUENCYRANGESET other) => ((nuint)(Value)).Equals((nuint)(other.Value));
