...
namespace TerraFX.Interop
{
    public unsafe partial struct D3DKMDT_HMONITORDESCRIPTORSET : IComparable, IComparable<D3DKMDT_HMONITORDESCRIPTORSET>, IEquatable<D3DKMDT_HMONITORDESCRIPTORSET>, IFormattable
    {
        ...
        public static D3DKMDT_HMONITORDESCRIPTORSET INVALID_VALUE => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(-1));

        public static D3DKMDT_HMONITORDESCRIPTORSET NULL => new D3DKMDT_HMONITORDESCRIPTORSET(null);
        ...
        public static implicit operator void*(D3DKMDT_HMONITORDESCRIPTORSET value) => value.Value;
        ...
        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(byte value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator byte(D3DKMDT_HMONITORDESCRIPTORSET value) => (byte)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(short value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator short(D3DKMDT_HMONITORDESCRIPTORSET value) => (short)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(int value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator int(D3DKMDT_HMONITORDESCRIPTORSET value) => (int)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(long value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator long(D3DKMDT_HMONITORDESCRIPTORSET value) => (long)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(nint value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static implicit operator nint(D3DKMDT_HMONITORDESCRIPTORSET value) => (nint)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(sbyte value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator sbyte(D3DKMDT_HMONITORDESCRIPTORSET value) => (sbyte)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(ushort value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator ushort(D3DKMDT_HMONITORDESCRIPTORSET value) => (ushort)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(uint value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator uint(D3DKMDT_HMONITORDESCRIPTORSET value) => (uint)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(ulong value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));

        public static explicit operator ulong(D3DKMDT_HMONITORDESCRIPTORSET value) => (ulong)(value.Value);

        public static explicit operator D3DKMDT_HMONITORDESCRIPTORSET(nuint value) => new D3DKMDT_HMONITORDESCRIPTORSET((void*)(value));
        ...
        public int CompareTo(D3DKMDT_HMONITORDESCRIPTORSET other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

        public override bool Equals(object? obj) => (obj is D3DKMDT_HMONITORDESCRIPTORSET other) && Equals(other);

        public bool Equals(D3DKMDT_HMONITORDESCRIPTORSET other) => ((nuint)(Value)).Equals((nuint)(other.Value));
