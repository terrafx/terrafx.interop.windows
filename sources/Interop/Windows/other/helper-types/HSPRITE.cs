...
namespace TerraFX.Interop
{
    public unsafe partial struct HSPRITE : IEquatable<HSPRITE>
    {
        ...
        public static HSPRITE INVALID_HANDLE_VALUE => new HSPRITE(-1);
        ...
        public static implicit operator HANDLE(HSPRITE value) => new HSPRITE(value);

        public static explicit operator HSPRITE(byte value) => new HSPRITE((nint)(value));

        public static implicit operator byte(HSPRITE value) => (byte)(value.Value);

        public static explicit operator HSPRITE(short value) => new HSPRITE((nint)(value));

        public static implicit operator short(HSPRITE value) => (short)(value.Value);
        ...
        public static implicit operator sbyte(HSPRITE value) => (sbyte)(value.Value);

        public static explicit operator HSPRITE(ushort value) => new HSPRITE((nint)(value));

        public static implicit operator ushort(HSPRITE value) => (ushort)(value.Value);
