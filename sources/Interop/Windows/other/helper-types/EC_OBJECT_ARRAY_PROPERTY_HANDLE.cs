...
namespace TerraFX.Interop
{
    public unsafe partial struct EC_OBJECT_ARRAY_PROPERTY_HANDLE : IEquatable<EC_OBJECT_ARRAY_PROPERTY_HANDLE>
    {
        ...
        public static implicit operator byte(EC_OBJECT_ARRAY_PROPERTY_HANDLE value) => (byte)(value.Value);
        ...
        public static implicit operator short(EC_OBJECT_ARRAY_PROPERTY_HANDLE value) => (short)(value.Value);

        public static explicit operator EC_OBJECT_ARRAY_PROPERTY_HANDLE(int value) => new EC_OBJECT_ARRAY_PROPERTY_HANDLE((nint)(value));

        public static implicit operator int(EC_OBJECT_ARRAY_PROPERTY_HANDLE value) => (int)(value.Value);
        ...
        public static implicit operator sbyte(EC_OBJECT_ARRAY_PROPERTY_HANDLE value) => (sbyte)(value.Value);
        ...
        public static implicit operator ushort(EC_OBJECT_ARRAY_PROPERTY_HANDLE value) => (ushort)(value.Value);
        ...
        public static implicit operator uint(EC_OBJECT_ARRAY_PROPERTY_HANDLE value) => (uint)(value.Value);
