...
namespace TerraFX.Interop
{
    public unsafe partial struct HDIAGNOSTIC_DATA_QUERY_SESSION : IComparable, IComparable<HDIAGNOSTIC_DATA_QUERY_SESSION>, IEquatable<HDIAGNOSTIC_DATA_QUERY_SESSION>, IFormattable
    {
        ...
        public static implicit operator long(HDIAGNOSTIC_DATA_QUERY_SESSION value) => value.Value;

        public static explicit operator HDIAGNOSTIC_DATA_QUERY_SESSION(nint value) => new HDIAGNOSTIC_DATA_QUERY_SESSION((nint)(value));

        public static implicit operator nint(HDIAGNOSTIC_DATA_QUERY_SESSION value) => value.Value;
        ...
        public int CompareTo(HDIAGNOSTIC_DATA_QUERY_SESSION other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is HDIAGNOSTIC_DATA_QUERY_SESSION other) && Equals(other);

        public bool Equals(HDIAGNOSTIC_DATA_QUERY_SESSION other) => Value.Equals(other.Value);
