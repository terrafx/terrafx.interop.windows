...
namespace TerraFX.Interop
{
    public unsafe partial struct LPPROC_THREAD_ATTRIBUTE_LIST : IEquatable<LPPROC_THREAD_ATTRIBUTE_LIST>
    {
        ...
        public static implicit operator byte(LPPROC_THREAD_ATTRIBUTE_LIST value) => (byte)(value.Value);

        public static explicit operator LPPROC_THREAD_ATTRIBUTE_LIST(short value) => new LPPROC_THREAD_ATTRIBUTE_LIST((nint)(value));

        public static implicit operator short(LPPROC_THREAD_ATTRIBUTE_LIST value) => (short)(value.Value);
        ...
        public static implicit operator sbyte(LPPROC_THREAD_ATTRIBUTE_LIST value) => (sbyte)(value.Value);

        public static explicit operator LPPROC_THREAD_ATTRIBUTE_LIST(ushort value) => new LPPROC_THREAD_ATTRIBUTE_LIST((nint)(value));

        public static implicit operator ushort(LPPROC_THREAD_ATTRIBUTE_LIST value) => (ushort)(value.Value);
