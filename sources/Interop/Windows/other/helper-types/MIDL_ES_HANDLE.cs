...
namespace TerraFX.Interop
{
    public unsafe partial struct MIDL_ES_HANDLE : IComparable, IComparable<MIDL_ES_HANDLE>, IEquatable<MIDL_ES_HANDLE>, IFormattable
    {
        ...
        public static implicit operator long(MIDL_ES_HANDLE value) => value.Value;

        public static explicit operator MIDL_ES_HANDLE(nint value) => new MIDL_ES_HANDLE((nint)(value));

        public static implicit operator nint(MIDL_ES_HANDLE value) => value.Value;
        ...
        public int CompareTo(MIDL_ES_HANDLE other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is MIDL_ES_HANDLE other) && Equals(other);

        public bool Equals(MIDL_ES_HANDLE other) => Value.Equals(other.Value);
