...
namespace TerraFX.Interop
{
    public unsafe partial struct HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION : IEquatable<HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION>
    {
        ...
        public static HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION INVALID_HANDLE_VALUE => new HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION(-1);
        ...
        public static implicit operator byte(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION value) => (byte)(value.Value);
        ...
        public static implicit operator short(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION value) => (short)(value.Value);
        ...
        public static implicit operator sbyte(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION value) => (sbyte)(value.Value);
        ...
        public static implicit operator ushort(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION value) => (ushort)(value.Value);
