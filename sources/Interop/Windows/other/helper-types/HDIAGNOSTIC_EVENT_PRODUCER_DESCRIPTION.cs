...
namespace TerraFX.Interop
{
    public unsafe partial struct HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION : IComparable, IComparable<HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION>, IEquatable<HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION>, IFormattable
    {
        ...
        public static implicit operator long(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION value) => value.Value;
        ...
        public static implicit operator nint(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION value) => value.Value;
        ...
        public int CompareTo(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION other) && Equals(other);

        public bool Equals(HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION other) => Value.Equals(other.Value);
