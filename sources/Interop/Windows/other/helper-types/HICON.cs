...
namespace TerraFX.Interop
{
    public unsafe partial struct HICON : IEquatable<HICON>
    {
        ...
        public static implicit operator byte(HICON value) => (byte)(value.Value);

        public static explicit operator HICON(short value) => new HICON((nint)(value));

        public static implicit operator short(HICON value) => (short)(value.Value);
        ...
        public static implicit operator sbyte(HICON value) => (sbyte)(value.Value);

        public static explicit operator HICON(ushort value) => new HICON((nint)(value));

        public static implicit operator ushort(HICON value) => (ushort)(value.Value);
