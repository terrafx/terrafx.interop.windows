...
namespace TerraFX.Interop
{
    public unsafe partial struct MIB_SERVER_HANDLE : IComparable, IComparable<MIB_SERVER_HANDLE>, IEquatable<MIB_SERVER_HANDLE>, IFormattable
    {
        ...
        public static implicit operator long(MIB_SERVER_HANDLE value) => value.Value;

        public static explicit operator MIB_SERVER_HANDLE(nint value) => new MIB_SERVER_HANDLE((nint)(value));

        public static implicit operator nint(MIB_SERVER_HANDLE value) => value.Value;
        ...
        public int CompareTo(MIB_SERVER_HANDLE other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is MIB_SERVER_HANDLE other) && Equals(other);

        public bool Equals(MIB_SERVER_HANDLE other) => Value.Equals(other.Value);
