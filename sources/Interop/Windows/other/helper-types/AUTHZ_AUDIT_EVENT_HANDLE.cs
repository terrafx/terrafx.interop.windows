...
namespace TerraFX.Interop
{
    public unsafe partial struct AUTHZ_AUDIT_EVENT_HANDLE : IComparable, IComparable<AUTHZ_AUDIT_EVENT_HANDLE>, IEquatable<AUTHZ_AUDIT_EVENT_HANDLE>, IFormattable
    {
        ...
        public static implicit operator long(AUTHZ_AUDIT_EVENT_HANDLE value) => value.Value;

        public static explicit operator AUTHZ_AUDIT_EVENT_HANDLE(nint value) => new AUTHZ_AUDIT_EVENT_HANDLE((nint)(value));

        public static implicit operator nint(AUTHZ_AUDIT_EVENT_HANDLE value) => value.Value;
        ...
        public int CompareTo(AUTHZ_AUDIT_EVENT_HANDLE other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is AUTHZ_AUDIT_EVENT_HANDLE other) && Equals(other);

        public bool Equals(AUTHZ_AUDIT_EVENT_HANDLE other) => Value.Equals(other.Value);
