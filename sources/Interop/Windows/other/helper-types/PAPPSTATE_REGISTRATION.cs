...
namespace TerraFX.Interop
{
    public unsafe partial struct PAPPSTATE_REGISTRATION : IEquatable<PAPPSTATE_REGISTRATION>
    {
        ...
        public static implicit operator byte(PAPPSTATE_REGISTRATION value) => (byte)(value.Value);

        public static explicit operator PAPPSTATE_REGISTRATION(short value) => new PAPPSTATE_REGISTRATION((nint)(value));

        public static implicit operator short(PAPPSTATE_REGISTRATION value) => (short)(value.Value);
        ...
        public static implicit operator sbyte(PAPPSTATE_REGISTRATION value) => (sbyte)(value.Value);

        public static explicit operator PAPPSTATE_REGISTRATION(ushort value) => new PAPPSTATE_REGISTRATION((nint)(value));

        public static implicit operator ushort(PAPPSTATE_REGISTRATION value) => (ushort)(value.Value);
