...
namespace TerraFX.Interop
{
    public unsafe partial struct HHANDLE : IComparable, IComparable<HHANDLE>, IEquatable<HHANDLE>, IFormattable
    {
        ...
        public static HHANDLE INVALID_VALUE => new HHANDLE(-1);
        ...
        public int CompareTo(HHANDLE other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is HHANDLE other) && Equals(other);

        public bool Equals(HHANDLE other) => Value.Equals(other.Value);
