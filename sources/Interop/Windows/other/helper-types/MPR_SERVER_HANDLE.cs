...
{
    public unsafe partial struct MPR_SERVER_HANDLE : IEquatable<MPR_SERVER_HANDLE>
    {
        ...
        public static MPR_SERVER_HANDLE INVALID_HANDLE_VALUE => new MPR_SERVER_HANDLE(-1);
        ...
        public bool Equals(MPR_SERVER_HANDLE other) => (this == other);
