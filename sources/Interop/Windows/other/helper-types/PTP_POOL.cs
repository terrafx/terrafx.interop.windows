...
namespace TerraFX.Interop
{
    public unsafe partial struct PTP_POOL : IEquatable<PTP_POOL>
    {
        ...
        public static implicit operator byte(PTP_POOL value) => (byte)(value.Value);

        public static explicit operator PTP_POOL(short value) => new PTP_POOL((nint)(value));

        public static implicit operator short(PTP_POOL value) => (short)(value.Value);
        ...
        public static implicit operator sbyte(PTP_POOL value) => (sbyte)(value.Value);

        public static explicit operator PTP_POOL(ushort value) => new PTP_POOL((nint)(value));

        public static implicit operator ushort(PTP_POOL value) => (ushort)(value.Value);
