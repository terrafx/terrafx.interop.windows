...
namespace TerraFX.Interop
{
    public unsafe partial struct PTP_POOL : IComparable, IComparable<PTP_POOL>, IEquatable<PTP_POOL>, IFormattable
    {
        ...
        public static explicit operator PTP_POOL(byte value) => new PTP_POOL((void*)(value));

        public static explicit operator byte(PTP_POOL value) => (byte)(value.Value);

        public static explicit operator PTP_POOL(short value) => new PTP_POOL((void*)(value));

        public static explicit operator short(PTP_POOL value) => (short)(value.Value);

        public static explicit operator PTP_POOL(int value) => new PTP_POOL((void*)(value));

        public static explicit operator int(PTP_POOL value) => (int)(value.Value);

        public static explicit operator PTP_POOL(long value) => new PTP_POOL((void*)(value));

        public static explicit operator long(PTP_POOL value) => (long)(value.Value);

        public static explicit operator PTP_POOL(nint value) => new PTP_POOL((void*)(value));

        public static implicit operator nint(PTP_POOL value) => (nint)(value.Value);

        public static explicit operator PTP_POOL(sbyte value) => new PTP_POOL((void*)(value));

        public static explicit operator sbyte(PTP_POOL value) => (sbyte)(value.Value);

        public static explicit operator PTP_POOL(ushort value) => new PTP_POOL((void*)(value));

        public static explicit operator ushort(PTP_POOL value) => (ushort)(value.Value);

        public static explicit operator PTP_POOL(uint value) => new PTP_POOL((void*)(value));

        public static explicit operator uint(PTP_POOL value) => (uint)(value.Value);

        public static explicit operator PTP_POOL(ulong value) => new PTP_POOL((void*)(value));

        public static explicit operator ulong(PTP_POOL value) => (ulong)(value.Value);

        public static explicit operator PTP_POOL(nuint value) => new PTP_POOL((void*)(value));
