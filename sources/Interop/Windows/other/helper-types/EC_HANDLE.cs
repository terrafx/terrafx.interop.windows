...
namespace TerraFX.Interop
{
    public unsafe partial struct EC_HANDLE : IComparable, IComparable<EC_HANDLE>, IEquatable<EC_HANDLE>, IFormattable
    {
        ...
        public int CompareTo(object? obj)
        {
            ...
            return (obj is null) ? 1 : throw new ArgumentException("obj is not an instance of EC_HANDLE.");
        }

        public int CompareTo(EC_HANDLE other) => Value.CompareTo(other.Value);

        public override bool Equals(object? obj) => (obj is EC_HANDLE other) && Equals(other);

        public bool Equals(EC_HANDLE other) => Value.Equals(other.Value);
