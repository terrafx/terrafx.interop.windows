...
namespace TerraFX.Interop
{
    public unsafe partial struct ID3D11On12On7Device
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11On12On7Device*, void*, D3D12_RESOURCE_STATES, int>)(lpVtbl[0]))((ID3D11On12On7Device*)Unsafe.AsPointer(ref this), pResource, state);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11On12On7Device*, void*, D3D12_RESOURCE_STATES, int>)(lpVtbl[1]))((ID3D11On12On7Device*)Unsafe.AsPointer(ref this), pResource, state);
        }
    }
}
