...
namespace TerraFX.Interop
{
    public unsafe partial struct D3D12_VIEWPORT : IEquatable<D3D12_VIEWPORT>
    {
        ...
        public D3D12_VIEWPORT(ID3D12Resource* pResource, [NativeTypeName("UINT")] uint mipSlice = 0, [NativeTypeName("FLOAT")] float topLeftX = 0.0f, [NativeTypeName("FLOAT")] float topLeftY = 0.0f, [NativeTypeName("FLOAT")] float minDepth = D3D12_MIN_DEPTH, [NativeTypeName("FLOAT")] float maxDepth = D3D12_MAX_DEPTH)
        {
