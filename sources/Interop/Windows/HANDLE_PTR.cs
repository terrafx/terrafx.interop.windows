...
{
    public partial struct HANDLE_PTR : IEquatable<HANDLE_PTR>
    {
        ...
        public static implicit operator HANDLE_PTR(nint value) => new HANDLE_PTR(value);

        public static implicit operator nint(HANDLE_PTR value) => value.Value;
