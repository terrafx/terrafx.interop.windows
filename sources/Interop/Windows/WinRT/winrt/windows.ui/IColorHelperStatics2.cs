...
public unsafe partial struct IColorHelperStatics2 : IColorHelperStatics2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IColorHelperStatics2*, HSTRING*, int>)(lpVtbl[4]))((IColorHelperStatics2*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged<IColorHelperStatics2*, Color, HSTRING*, int>)(lpVtbl[6]))((IColorHelperStatics2*)Unsafe.AsPointer(ref this), color, returnValue);
    }
