...
// Ported from winrt/windows.ui.composition.interop.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ICompositionDrawingSurfaceInterop2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, Guid*, void**, int>)(lpVtbl[0]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, uint>)(lpVtbl[1]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, uint>)(lpVtbl[2]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, RECT*, Guid*, void**, POINT*, int>)(lpVtbl[3]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this), updateRect, iid, updateObject, updateOffset);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, int>)(lpVtbl[4]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, SIZE, int>)(lpVtbl[5]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this), sizePixels);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, RECT*, RECT*, int, int, int>)(lpVtbl[6]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this), scrollRect, clipRect, offsetX, offsetY);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, int>)(lpVtbl[7]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, int>)(lpVtbl[8]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICompositionDrawingSurfaceInterop2*, IUnknown*, int, int, RECT*, int>)(lpVtbl[9]))((ICompositionDrawingSurfaceInterop2*)Unsafe.AsPointer(ref this), destinationResource, destinationOffsetX, destinationOffsetY, sourceRectangle);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, SIZE, int> Resize;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUnknown*, int, int, RECT*, int> CopySurface;
    }
}
