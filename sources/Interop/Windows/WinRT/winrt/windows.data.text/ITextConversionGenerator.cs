...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ITextConversionGenerator);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextConversionGenerator*, HSTRING, IAsyncOperation<Pointer<IVectorView<HSTRING>>>**, int>)(lpVtbl[8]))((ITextConversionGenerator*)Unsafe.AsPointer(ref this), input, result);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextConversionGenerator*, HSTRING, uint, IAsyncOperation<Pointer<IVectorView<HSTRING>>>**, int>)(lpVtbl[9]))((ITextConversionGenerator*)Unsafe.AsPointer(ref this), input, maxCandidates, result);
    }
