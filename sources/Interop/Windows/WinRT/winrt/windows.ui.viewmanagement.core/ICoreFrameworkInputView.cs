...
/// <include file='ICoreFrameworkInputView.xml' path='doc/member[@name="ICoreFrameworkInputView"]/*' />
[Guid("D77C94AE-46B8-5D4A-9489-8DDEC3D639A6")]
[NativeTypeName("struct ICoreFrameworkInputView : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct ICoreFrameworkInputView : ICoreFrameworkInputView.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ICoreFrameworkInputView);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, Guid*, void**, int>)(lpVtbl[0]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, uint>)(lpVtbl[1]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, uint>)(lpVtbl[2]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, uint*, Guid**, int>)(lpVtbl[3]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, HSTRING*, int>)(lpVtbl[4]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, TrustLevel*, int>)(lpVtbl[5]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this), trustLevel);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, EventRegistrationToken, int>)(lpVtbl[7]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this), token);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputView*, EventRegistrationToken, int>)(lpVtbl[9]))((ICoreFrameworkInputView*)Unsafe.AsPointer(ref this), token);
    }
