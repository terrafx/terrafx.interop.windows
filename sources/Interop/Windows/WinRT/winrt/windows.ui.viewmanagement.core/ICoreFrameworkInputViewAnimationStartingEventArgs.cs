...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ICoreFrameworkInputViewAnimationStartingEventArgs);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputViewAnimationStartingEventArgs*, IVectorView<Pointer<ICoreInputViewOcclusion>>**, int>)(lpVtbl[6]))((ICoreFrameworkInputViewAnimationStartingEventArgs*)Unsafe.AsPointer(ref this), value);
    }
