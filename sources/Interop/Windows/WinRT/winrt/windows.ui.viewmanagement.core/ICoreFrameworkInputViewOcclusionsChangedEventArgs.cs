...
public unsafe partial struct ICoreFrameworkInputViewOcclusionsChangedEventArgs : ICoreFrameworkInputViewOcclusionsChangedEventArgs.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoreFrameworkInputViewOcclusionsChangedEventArgs*, IVectorView<IntPtr>**, int>)(lpVtbl[6]))((ICoreFrameworkInputViewOcclusionsChangedEventArgs*)Unsafe.AsPointer(ref this), value);
    }
