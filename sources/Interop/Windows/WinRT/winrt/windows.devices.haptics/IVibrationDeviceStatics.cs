...
public unsafe partial struct IVibrationDeviceStatics : IVibrationDeviceStatics.Interface, INativeGuid
{
    ...
    public interface Interface : IInspectable.Interface
    {
        ...
        [VtblIndex(8)]
        HRESULT FromIdAsync(HSTRING deviceId, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CDevices__CHaptics__CVibrationDevice_t **")] IAsyncOperation<IntPtr>** operation);

        [VtblIndex(9)]
        HRESULT GetDefaultAsync([NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CDevices__CHaptics__CVibrationDevice_t **")] IAsyncOperation<IntPtr>** operation);

        [VtblIndex(10)]
        HRESULT FindAllAsync([NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CDevices__CHaptics__CVibrationDevice_t **")] IAsyncOperation<IntPtr>** operation);
    }
