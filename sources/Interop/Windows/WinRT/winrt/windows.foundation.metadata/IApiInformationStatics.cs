...
// Ported from winrt/windows.foundation.metadata.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IApiInformationStatics);
