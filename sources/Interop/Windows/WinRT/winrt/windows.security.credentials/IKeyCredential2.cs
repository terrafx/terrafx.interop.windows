...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IKeyCredential2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IKeyCredential2*, Guid*, void**, int>)(lpVtbl[0]))((IKeyCredential2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IKeyCredential2*, uint>)(lpVtbl[1]))((IKeyCredential2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IKeyCredential2*, uint>)(lpVtbl[2]))((IKeyCredential2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IKeyCredential2*, uint*, Guid**, int>)(lpVtbl[3]))((IKeyCredential2*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IKeyCredential2*, HSTRING*, int>)(lpVtbl[4]))((IKeyCredential2*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IKeyCredential2*, TrustLevel*, int>)(lpVtbl[5]))((IKeyCredential2*)Unsafe.AsPointer(ref this), trustLevel);
    }
