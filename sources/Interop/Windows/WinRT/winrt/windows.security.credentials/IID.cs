...
public static partial class IID
{
    ...
    public static ref readonly Guid IID_IKeyCredential2
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get
        {
    ...
    public static ref readonly Guid IID_IKeyCredentialCacheConfiguration
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get
        {
    ...
    public static ref readonly Guid IID_IKeyCredentialCacheConfigurationFactory
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get
        {
