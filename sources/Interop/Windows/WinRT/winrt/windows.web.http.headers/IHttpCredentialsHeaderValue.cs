...
public unsafe partial struct IHttpCredentialsHeaderValue : IHttpCredentialsHeaderValue.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpCredentialsHeaderValue*, IVector<IntPtr>**, int>)(lpVtbl[6]))((IHttpCredentialsHeaderValue*)Unsafe.AsPointer(ref this), value);
    }
