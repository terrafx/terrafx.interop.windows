...
public unsafe partial struct IConnectionProfile4 : IConnectionProfile4.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IConnectionProfile4*, DateTime, DateTime, NetworkUsageStates, IAsyncOperation<IntPtr>**, int>)(lpVtbl[6]))((IConnectionProfile4*)Unsafe.AsPointer(ref this), startTime, endTime, states, value);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DateTime, DateTime, NetworkUsageStates, IAsyncOperation<IntPtr>**, int> GetProviderNetworkUsageAsync;
    }
}
