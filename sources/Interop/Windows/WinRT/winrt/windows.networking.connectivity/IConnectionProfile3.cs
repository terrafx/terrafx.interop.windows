...
public unsafe partial struct IConnectionProfile3 : IConnectionProfile3.Interface, INativeGuid
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(6)]
    public HRESULT GetAttributedNetworkUsageAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime startTime, [NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime endTime, [NativeTypeName("ABI::Windows::Networking::Connectivity::NetworkUsageStates")] NetworkUsageStates states, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CNetworking__CConnectivity__CAttributedNetworkUsage_t **")] IAsyncOperation<IntPtr>** value)
    {
        return ((delegate* unmanaged[MemberFunction]<IConnectionProfile3*, DateTime, DateTime, NetworkUsageStates, IAsyncOperation<IntPtr>**, int>)(lpVtbl[6]))((IConnectionProfile3*)Unsafe.AsPointer(ref this), startTime, endTime, states, value);
    }

    public interface Interface : IInspectable.Interface
    {
        [VtblIndex(6)]
        HRESULT GetAttributedNetworkUsageAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime startTime, [NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime endTime, [NativeTypeName("ABI::Windows::Networking::Connectivity::NetworkUsageStates")] NetworkUsageStates states, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CNetworking__CConnectivity__CAttributedNetworkUsage_t **")] IAsyncOperation<IntPtr>** value);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DateTime, DateTime, NetworkUsageStates, IAsyncOperation<IntPtr>**, int> GetAttributedNetworkUsageAsync;
    }
}
