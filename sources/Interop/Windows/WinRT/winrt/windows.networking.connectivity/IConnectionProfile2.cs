...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IConnectionProfile2);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(13)]
    public HRESULT GetNetworkUsageAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] WinRTDateTime startTime, [NativeTypeName("ABI::Windows::Foundation::DateTime")] WinRTDateTime endTime, [NativeTypeName("ABI::Windows::Networking::Connectivity::DataUsageGranularity")] DataUsageGranularity granularity, [NativeTypeName("ABI::Windows::Networking::Connectivity::NetworkUsageStates")] NetworkUsageStates states, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CNetworking__CConnectivity__CNetworkUsage_t **")] IAsyncOperation<Pointer<IVectorView<Pointer<INetworkUsage>>>>** value)
    {
        return ((delegate* unmanaged[MemberFunction]<IConnectionProfile2*, WinRTDateTime, WinRTDateTime, DataUsageGranularity, NetworkUsageStates, IAsyncOperation<Pointer<IVectorView<Pointer<INetworkUsage>>>>**, int>)(lpVtbl[13]))((IConnectionProfile2*)Unsafe.AsPointer(ref this), startTime, endTime, granularity, states, value);
    }

    /// <include file='IConnectionProfile2.xml' path='doc/member[@name="IConnectionProfile2.GetConnectivityIntervalsAsync"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(14)]
    public HRESULT GetConnectivityIntervalsAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] WinRTDateTime startTime, [NativeTypeName("ABI::Windows::Foundation::DateTime")] WinRTDateTime endTime, [NativeTypeName("ABI::Windows::Networking::Connectivity::NetworkUsageStates")] NetworkUsageStates states, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CNetworking__CConnectivity__CConnectivityInterval_t **")] IAsyncOperation<Pointer<IVectorView<Pointer<IConnectivityInterval>>>>** value)
    {
        return ((delegate* unmanaged[MemberFunction]<IConnectionProfile2*, WinRTDateTime, WinRTDateTime, NetworkUsageStates, IAsyncOperation<Pointer<IVectorView<Pointer<IConnectivityInterval>>>>**, int>)(lpVtbl[14]))((IConnectionProfile2*)Unsafe.AsPointer(ref this), startTime, endTime, states, value);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, WinRTDateTime, WinRTDateTime, DataUsageGranularity, NetworkUsageStates, IAsyncOperation<Pointer<IVectorView<Pointer<INetworkUsage>>>>**, int> GetNetworkUsageAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, WinRTDateTime, WinRTDateTime, NetworkUsageStates, IAsyncOperation<Pointer<IVectorView<Pointer<IConnectivityInterval>>>>**, int> GetConnectivityIntervalsAsync;
    }
}
