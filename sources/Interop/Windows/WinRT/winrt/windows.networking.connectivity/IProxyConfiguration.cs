...
/// <include file='IProxyConfiguration.xml' path='doc/member[@name="IProxyConfiguration"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IProxyConfiguration);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IProxyConfiguration*, Guid*, void**, int>)(lpVtbl[0]))((IProxyConfiguration*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IProxyConfiguration*, uint>)(lpVtbl[1]))((IProxyConfiguration*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IProxyConfiguration*, uint>)(lpVtbl[2]))((IProxyConfiguration*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IProxyConfiguration*, uint*, Guid**, int>)(lpVtbl[3]))((IProxyConfiguration*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IProxyConfiguration*, HSTRING*, int>)(lpVtbl[4]))((IProxyConfiguration*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IProxyConfiguration*, TrustLevel*, int>)(lpVtbl[5]))((IProxyConfiguration*)Unsafe.AsPointer(ref this), trustLevel);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IProxyConfiguration*, byte*, int>)(lpVtbl[7]))((IProxyConfiguration*)Unsafe.AsPointer(ref this), value);
    }
