...
public unsafe partial struct IGeolocatorStatics : IGeolocatorStatics.Interface, INativeGuid
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT GetGeopositionHistoryAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime startTime, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CDevices__CGeolocation__CGeoposition_t **")] IAsyncOperation<IntPtr>** result)
    {
        return ((delegate* unmanaged[MemberFunction]<IGeolocatorStatics*, DateTime, IAsyncOperation<IntPtr>**, int>)(lpVtbl[7]))((IGeolocatorStatics*)Unsafe.AsPointer(ref this), startTime, result);
    }

    /// <include file='IGeolocatorStatics.xml' path='doc/member[@name="IGeolocatorStatics.GetGeopositionHistoryWithDurationAsync"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(8)]
    public HRESULT GetGeopositionHistoryWithDurationAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime startTime, [NativeTypeName("ABI::Windows::Foundation::TimeSpan")] TimeSpan duration, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CDevices__CGeolocation__CGeoposition_t **")] IAsyncOperation<IntPtr>** result)
    {
        return ((delegate* unmanaged[MemberFunction]<IGeolocatorStatics*, DateTime, TimeSpan, IAsyncOperation<IntPtr>**, int>)(lpVtbl[8]))((IGeolocatorStatics*)Unsafe.AsPointer(ref this), startTime, duration, result);
    }
    ...
    public interface Interface : IInspectable.Interface
    {
        ...
        [VtblIndex(7)]
        HRESULT GetGeopositionHistoryAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime startTime, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CDevices__CGeolocation__CGeoposition_t **")] IAsyncOperation<IntPtr>** result);

        [VtblIndex(8)]
        HRESULT GetGeopositionHistoryWithDurationAsync([NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime startTime, [NativeTypeName("ABI::Windows::Foundation::TimeSpan")] TimeSpan duration, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1___FIVectorView_1_Windows__CDevices__CGeolocation__CGeoposition_t **")] IAsyncOperation<IntPtr>** result);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DateTime, IAsyncOperation<IntPtr>**, int> GetGeopositionHistoryAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DateTime, TimeSpan, IAsyncOperation<IntPtr>**, int> GetGeopositionHistoryWithDurationAsync;
    }
}
