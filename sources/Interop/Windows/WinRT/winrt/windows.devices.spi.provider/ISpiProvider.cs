...
// Ported from winrt/windows.devices.spi.provider.h in the Windows SDK for Windows 10.0.28000.0
...
/// <include file='ISpiProvider.xml' path='doc/member[@name="ISpiProvider"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ISpiProvider);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpiProvider*, Guid*, void**, int>)(lpVtbl[0]))((ISpiProvider*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpiProvider*, uint>)(lpVtbl[1]))((ISpiProvider*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpiProvider*, uint>)(lpVtbl[2]))((ISpiProvider*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpiProvider*, uint*, Guid**, int>)(lpVtbl[3]))((ISpiProvider*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpiProvider*, HSTRING*, int>)(lpVtbl[4]))((ISpiProvider*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpiProvider*, TrustLevel*, int>)(lpVtbl[5]))((ISpiProvider*)Unsafe.AsPointer(ref this), trustLevel);
    }
