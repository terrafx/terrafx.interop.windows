...
/// <include file='IAudioGraphStatics.xml' path='doc/member[@name="IAudioGraphStatics"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAudioGraphStatics);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioGraphStatics*, Guid*, void**, int>)(lpVtbl[0]))((IAudioGraphStatics*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioGraphStatics*, uint>)(lpVtbl[1]))((IAudioGraphStatics*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioGraphStatics*, uint>)(lpVtbl[2]))((IAudioGraphStatics*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioGraphStatics*, uint*, Guid**, int>)(lpVtbl[3]))((IAudioGraphStatics*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioGraphStatics*, HSTRING*, int>)(lpVtbl[4]))((IAudioGraphStatics*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioGraphStatics*, TrustLevel*, int>)(lpVtbl[5]))((IAudioGraphStatics*)Unsafe.AsPointer(ref this), trustLevel);
    }
