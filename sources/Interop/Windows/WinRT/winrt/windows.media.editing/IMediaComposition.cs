...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IMediaComposition));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT get_Clips([NativeTypeName("ABI::Windows::Foundation::Collections::__FIVector_1_Windows__CMedia__CEditing__CMediaClip_t **")] IVector<IntPtr>** value)
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaComposition*, IVector<IntPtr>**, int>)(lpVtbl[7]))((IMediaComposition*)Unsafe.AsPointer(ref this), value);
    }

    /// <include file='IMediaComposition.xml' path='doc/member[@name="IMediaComposition.get_BackgroundAudioTracks"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(8)]
    public HRESULT get_BackgroundAudioTracks([NativeTypeName("ABI::Windows::Foundation::Collections::__FIVector_1_Windows__CMedia__CEditing__CBackgroundAudioTrack_t **")] IVector<IntPtr>** value)
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaComposition*, IVector<IntPtr>**, int>)(lpVtbl[8]))((IMediaComposition*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaComposition*, IIterable<TimeSpan>*, int, int, VideoFramePrecision, IAsyncOperation<IntPtr>**, int>)(lpVtbl[13]))((IMediaComposition*)Unsafe.AsPointer(ref this), timesFromStart, scaledWidth, scaledHeight, framePrecision, operation);
    }
    ...
    public interface Interface : IInspectable.Interface
    {
        ...
        [VtblIndex(7)]
        HRESULT get_Clips([NativeTypeName("ABI::Windows::Foundation::Collections::__FIVector_1_Windows__CMedia__CEditing__CMediaClip_t **")] IVector<IntPtr>** value);

        [VtblIndex(8)]
        HRESULT get_BackgroundAudioTracks([NativeTypeName("ABI::Windows::Foundation::Collections::__FIVector_1_Windows__CMedia__CEditing__CBackgroundAudioTrack_t **")] IVector<IntPtr>** value);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IVector<IntPtr>**, int> get_Clips;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IVector<IntPtr>**, int> get_BackgroundAudioTracks;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IIterable<TimeSpan>*, int, int, VideoFramePrecision, IAsyncOperation<IntPtr>**, int> GetThumbnailsAsync;
