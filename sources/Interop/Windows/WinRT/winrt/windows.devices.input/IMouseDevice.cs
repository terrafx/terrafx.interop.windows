...
/// <include file='IMouseDevice.xml' path='doc/member[@name="IMouseDevice"]/*' />
[Guid("88EDF458-F2C8-49F4-BE1F-C256B388BC11")]
[NativeTypeName("struct IMouseDevice : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IMouseDevice : IMouseDevice.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IMouseDevice);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMouseDevice*, Guid*, void**, int>)(lpVtbl[0]))((IMouseDevice*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IMouseDevice*, uint>)(lpVtbl[1]))((IMouseDevice*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IMouseDevice*, uint>)(lpVtbl[2]))((IMouseDevice*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMouseDevice*, uint*, Guid**, int>)(lpVtbl[3]))((IMouseDevice*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMouseDevice*, HSTRING*, int>)(lpVtbl[4]))((IMouseDevice*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMouseDevice*, TrustLevel*, int>)(lpVtbl[5]))((IMouseDevice*)Unsafe.AsPointer(ref this), trustLevel);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT remove_MouseMoved(EventRegistrationToken cookie)
    {
        return ((delegate* unmanaged[MemberFunction]<IMouseDevice*, EventRegistrationToken, int>)(lpVtbl[7]))((IMouseDevice*)Unsafe.AsPointer(ref this), cookie);
    }
