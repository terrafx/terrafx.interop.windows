...
/// <include file='IPrintManager.xml' path='doc/member[@name="IPrintManager"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IPrintManager);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPrintManager*, Guid*, void**, int>)(lpVtbl[0]))((IPrintManager*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IPrintManager*, uint>)(lpVtbl[1]))((IPrintManager*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IPrintManager*, uint>)(lpVtbl[2]))((IPrintManager*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPrintManager*, uint*, Guid**, int>)(lpVtbl[3]))((IPrintManager*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPrintManager*, HSTRING*, int>)(lpVtbl[4]))((IPrintManager*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPrintManager*, TrustLevel*, int>)(lpVtbl[5]))((IPrintManager*)Unsafe.AsPointer(ref this), trustLevel);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPrintManager*, EventRegistrationToken, int>)(lpVtbl[7]))((IPrintManager*)Unsafe.AsPointer(ref this), eventCookie);
    }
