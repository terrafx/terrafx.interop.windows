...
public unsafe partial struct IMediaCapture2 : IMediaCapture2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaCapture2*, IMediaEncodingProfile*, IStorageFile*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[6]))((IMediaCapture2*)Unsafe.AsPointer(ref this), encodingProfile, file, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaCapture2*, IMediaEncodingProfile*, IRandomAccessStream*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[7]))((IMediaCapture2*)Unsafe.AsPointer(ref this), encodingProfile, stream, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaCapture2*, IMediaEncodingProfile*, IMediaExtension*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[8]))((IMediaCapture2*)Unsafe.AsPointer(ref this), encodingProfile, customMediaSink, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaCapture2*, IMediaEncodingProfile*, HSTRING, IPropertySet*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[9]))((IMediaCapture2*)Unsafe.AsPointer(ref this), encodingProfile, customSinkActivationId, customSinkSettings, operation);
    }

    /// <include file='IMediaCapture2.xml' path='doc/member[@name="IMediaCapture2.PrepareLowLagPhotoCaptureAsync"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(10)]
    public HRESULT PrepareLowLagPhotoCaptureAsync([NativeTypeName("ABI::Windows::Media::MediaProperties::IImageEncodingProperties *")] IImageEncodingProperties* type, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CMedia__CCapture__CLowLagPhotoCapture_t **")] IAsyncOperation<IntPtr>** operation)
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaCapture2*, IImageEncodingProperties*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[10]))((IMediaCapture2*)Unsafe.AsPointer(ref this), type, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaCapture2*, IImageEncodingProperties*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[11]))((IMediaCapture2*)Unsafe.AsPointer(ref this), type, operation);
    }

    /// <include file='IMediaCapture2.xml' path='doc/member[@name="IMediaCapture2.SetEncodingPropertiesAsync"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(12)]
    public HRESULT SetEncodingPropertiesAsync([NativeTypeName("ABI::Windows::Media::Capture::MediaStreamType")] MediaStreamType mediaStreamType, [NativeTypeName("ABI::Windows::Media::MediaProperties::IMediaEncodingProperties *")] IMediaEncodingProperties* mediaEncodingProperties, [NativeTypeName("ABI::Windows::Foundation::Collections::__FIMap_2_GUID_IInspectable_t *")] IMap<Guid, IntPtr>* encoderProperties, [NativeTypeName("ABI::Windows::Foundation::IAsyncAction **")] IAsyncAction** operation)
    {
        return ((delegate* unmanaged[MemberFunction]<IMediaCapture2*, MediaStreamType, IMediaEncodingProperties*, IMap<Guid, IntPtr>*, IAsyncAction**, int>)(lpVtbl[12]))((IMediaCapture2*)Unsafe.AsPointer(ref this), mediaStreamType, mediaEncodingProperties, encoderProperties, operation);
    }
    ...
    public interface Interface : IInspectable.Interface
    {
        ...
        [VtblIndex(10)]
        HRESULT PrepareLowLagPhotoCaptureAsync([NativeTypeName("ABI::Windows::Media::MediaProperties::IImageEncodingProperties *")] IImageEncodingProperties* type, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CMedia__CCapture__CLowLagPhotoCapture_t **")] IAsyncOperation<IntPtr>** operation);

        [VtblIndex(11)]
        HRESULT PrepareLowLagPhotoSequenceCaptureAsync([NativeTypeName("ABI::Windows::Media::MediaProperties::IImageEncodingProperties *")] IImageEncodingProperties* type, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CMedia__CCapture__CLowLagPhotoSequenceCapture_t **")] IAsyncOperation<IntPtr>** operation);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IMediaEncodingProfile*, IStorageFile*, IAsyncOperation<IntPtr>**, int> PrepareLowLagRecordToStorageFileAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IMediaEncodingProfile*, IRandomAccessStream*, IAsyncOperation<IntPtr>**, int> PrepareLowLagRecordToStreamAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IMediaEncodingProfile*, IMediaExtension*, IAsyncOperation<IntPtr>**, int> PrepareLowLagRecordToCustomSinkAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IMediaEncodingProfile*, HSTRING, IPropertySet*, IAsyncOperation<IntPtr>**, int> PrepareLowLagRecordToCustomSinkIdAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IImageEncodingProperties*, IAsyncOperation<IntPtr>**, int> PrepareLowLagPhotoCaptureAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IImageEncodingProperties*, IAsyncOperation<IntPtr>**, int> PrepareLowLagPhotoSequenceCaptureAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, MediaStreamType, IMediaEncodingProperties*, IMap<Guid, IntPtr>*, IAsyncAction**, int> SetEncodingPropertiesAsync;
    }
}
