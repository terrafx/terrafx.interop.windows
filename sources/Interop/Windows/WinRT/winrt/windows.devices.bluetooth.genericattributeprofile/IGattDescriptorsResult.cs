...
/// <include file='IGattDescriptorsResult.xml' path='doc/member[@name="IGattDescriptorsResult"]/*' />
[Guid("9BC091F3-95E7-4489-8D25-FF81955A57B9")]
[NativeTypeName("struct IGattDescriptorsResult : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IGattDescriptorsResult : IGattDescriptorsResult.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IGattDescriptorsResult);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, Guid*, void**, int>)(lpVtbl[0]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, uint>)(lpVtbl[1]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, uint>)(lpVtbl[2]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, uint*, Guid**, int>)(lpVtbl[3]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, HSTRING*, int>)(lpVtbl[4]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, TrustLevel*, int>)(lpVtbl[5]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this), trustLevel);
    }

    /// <include file='IGattDescriptorsResult.xml' path='doc/member[@name="IGattDescriptorsResult.get_Status"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(6)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, GattCommunicationStatus*, int>)(lpVtbl[6]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this), value);
    }

    /// <include file='IGattDescriptorsResult.xml' path='doc/member[@name="IGattDescriptorsResult.get_ProtocolError"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT get_ProtocolError([NativeTypeName("ABI::Windows::Foundation::__FIReference_1_byte_t **")] IReference<byte>** value)
    {
        return ((delegate* unmanaged[MemberFunction]<IGattDescriptorsResult*, IReference<byte>**, int>)(lpVtbl[7]))((IGattDescriptorsResult*)Unsafe.AsPointer(ref this), value);
    }
