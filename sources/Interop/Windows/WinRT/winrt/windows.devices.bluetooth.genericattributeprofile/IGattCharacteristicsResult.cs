...
/// <include file='IGattCharacteristicsResult.xml' path='doc/member[@name="IGattCharacteristicsResult"]/*' />
[Guid("1194945C-B257-4F3E-9DB7-F68BC9A9AEF2")]
[NativeTypeName("struct IGattCharacteristicsResult : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IGattCharacteristicsResult : IGattCharacteristicsResult.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IGattCharacteristicsResult);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, Guid*, void**, int>)(lpVtbl[0]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, uint>)(lpVtbl[1]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, uint>)(lpVtbl[2]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, uint*, Guid**, int>)(lpVtbl[3]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, HSTRING*, int>)(lpVtbl[4]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, TrustLevel*, int>)(lpVtbl[5]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this), trustLevel);
    }

    /// <include file='IGattCharacteristicsResult.xml' path='doc/member[@name="IGattCharacteristicsResult.get_Status"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(6)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, GattCommunicationStatus*, int>)(lpVtbl[6]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this), value);
    }

    /// <include file='IGattCharacteristicsResult.xml' path='doc/member[@name="IGattCharacteristicsResult.get_ProtocolError"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT get_ProtocolError([NativeTypeName("ABI::Windows::Foundation::__FIReference_1_byte_t **")] IReference<byte>** value)
    {
        return ((delegate* unmanaged[MemberFunction]<IGattCharacteristicsResult*, IReference<byte>**, int>)(lpVtbl[7]))((IGattCharacteristicsResult*)Unsafe.AsPointer(ref this), value);
    }
