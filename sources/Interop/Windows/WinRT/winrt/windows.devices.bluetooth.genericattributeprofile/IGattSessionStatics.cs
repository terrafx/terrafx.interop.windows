...
/// <include file='IGattSessionStatics.xml' path='doc/member[@name="IGattSessionStatics"]/*' />
[Guid("2E65B95C-539F-4DB7-82A8-73BDBBF73EBF")]
[NativeTypeName("struct IGattSessionStatics : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IGattSessionStatics : IGattSessionStatics.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IGattSessionStatics);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattSessionStatics*, Guid*, void**, int>)(lpVtbl[0]))((IGattSessionStatics*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IGattSessionStatics*, uint>)(lpVtbl[1]))((IGattSessionStatics*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IGattSessionStatics*, uint>)(lpVtbl[2]))((IGattSessionStatics*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattSessionStatics*, uint*, Guid**, int>)(lpVtbl[3]))((IGattSessionStatics*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattSessionStatics*, HSTRING*, int>)(lpVtbl[4]))((IGattSessionStatics*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IGattSessionStatics*, TrustLevel*, int>)(lpVtbl[5]))((IGattSessionStatics*)Unsafe.AsPointer(ref this), trustLevel);
    }
