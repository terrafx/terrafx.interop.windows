...
public unsafe partial struct IStorageFileStatics : IStorageFileStatics.Interface, INativeGuid
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(6)]
    public HRESULT GetFileFromPathAsync(HSTRING path, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CStorage__CStorageFile_t **")] IAsyncOperation<IntPtr>** operation)
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics*, HSTRING, IAsyncOperation<IntPtr>**, int>)(lpVtbl[6]))((IStorageFileStatics*)Unsafe.AsPointer(ref this), path, operation);
    }

    /// <include file='IStorageFileStatics.xml' path='doc/member[@name="IStorageFileStatics.GetFileFromApplicationUriAsync"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT GetFileFromApplicationUriAsync([NativeTypeName("ABI::Windows::Foundation::IUriRuntimeClass *")] IUriRuntimeClass* uri, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CStorage__CStorageFile_t **")] IAsyncOperation<IntPtr>** operation)
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics*, IUriRuntimeClass*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[7]))((IStorageFileStatics*)Unsafe.AsPointer(ref this), uri, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics*, HSTRING, IStreamedFileDataRequestedHandler*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[8]))((IStorageFileStatics*)Unsafe.AsPointer(ref this), displayNameWithExtension, dataRequested, thumbnail, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics*, IStorageFile*, IStreamedFileDataRequestedHandler*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[9]))((IStorageFileStatics*)Unsafe.AsPointer(ref this), fileToReplace, dataRequested, thumbnail, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics*, HSTRING, IUriRuntimeClass*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[10]))((IStorageFileStatics*)Unsafe.AsPointer(ref this), displayNameWithExtension, uri, thumbnail, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics*, IStorageFile*, IUriRuntimeClass*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[11]))((IStorageFileStatics*)Unsafe.AsPointer(ref this), fileToReplace, uri, thumbnail, operation);
    }

    public interface Interface : IInspectable.Interface
    {
        [VtblIndex(6)]
        HRESULT GetFileFromPathAsync(HSTRING path, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CStorage__CStorageFile_t **")] IAsyncOperation<IntPtr>** operation);

        [VtblIndex(7)]
        HRESULT GetFileFromApplicationUriAsync([NativeTypeName("ABI::Windows::Foundation::IUriRuntimeClass *")] IUriRuntimeClass* uri, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CStorage__CStorageFile_t **")] IAsyncOperation<IntPtr>** operation);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HSTRING, IAsyncOperation<IntPtr>**, int> GetFileFromPathAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IAsyncOperation<IntPtr>**, int> GetFileFromApplicationUriAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HSTRING, IStreamedFileDataRequestedHandler*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int> CreateStreamedFileAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IStorageFile*, IStreamedFileDataRequestedHandler*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int> ReplaceWithStreamedFileAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HSTRING, IUriRuntimeClass*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int> CreateStreamedFileFromUriAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IStorageFile*, IUriRuntimeClass*, IRandomAccessStreamReference*, IAsyncOperation<IntPtr>**, int> ReplaceWithStreamedFileFromUriAsync;
    }
}
