...
/// <include file='IStorageFolder2.xml' path='doc/member[@name="IStorageFolder2"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IStorageFolder2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFolder2*, Guid*, void**, int>)(lpVtbl[0]))((IStorageFolder2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFolder2*, uint>)(lpVtbl[1]))((IStorageFolder2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFolder2*, uint>)(lpVtbl[2]))((IStorageFolder2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFolder2*, uint*, Guid**, int>)(lpVtbl[3]))((IStorageFolder2*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFolder2*, HSTRING*, int>)(lpVtbl[4]))((IStorageFolder2*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFolder2*, TrustLevel*, int>)(lpVtbl[5]))((IStorageFolder2*)Unsafe.AsPointer(ref this), trustLevel);
    }
