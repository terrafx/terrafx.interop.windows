...
/// <include file='IStorageFileStatics2.xml' path='doc/member[@name="IStorageFileStatics2"]/*' />
[Guid("5C76A781-212E-4AF9-8F04-740CAE108974")]
[NativeTypeName("struct IStorageFileStatics2 : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IStorageFileStatics2 : IStorageFileStatics2.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IStorageFileStatics2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics2*, Guid*, void**, int>)(lpVtbl[0]))((IStorageFileStatics2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics2*, uint>)(lpVtbl[1]))((IStorageFileStatics2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics2*, uint>)(lpVtbl[2]))((IStorageFileStatics2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics2*, uint*, Guid**, int>)(lpVtbl[3]))((IStorageFileStatics2*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics2*, HSTRING*, int>)(lpVtbl[4]))((IStorageFileStatics2*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStorageFileStatics2*, TrustLevel*, int>)(lpVtbl[5]))((IStorageFileStatics2*)Unsafe.AsPointer(ref this), trustLevel);
    }
