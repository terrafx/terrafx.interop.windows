...
public unsafe partial struct IProtectionPolicyManagerStatics4 : IProtectionPolicyManagerStatics4.Interface, INativeGuid
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(9)]
    public HRESULT RequestAccessToFilesForAppAsync([NativeTypeName("ABI::Windows::Foundation::Collections::__FIIterable_1_Windows__CStorage__CIStorageItem_t *")] IIterable<IntPtr>* sourceItemList, HSTRING appPackageFamilyName, [NativeTypeName("ABI::Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo *")] IProtectionPolicyAuditInfo* auditInfo, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CSecurity__CEnterpriseData__CProtectionPolicyEvaluationResult_t **")] IAsyncOperation<ProtectionPolicyEvaluationResult>** result)
    {
        return ((delegate* unmanaged[MemberFunction]<IProtectionPolicyManagerStatics4*, IIterable<IntPtr>*, HSTRING, IProtectionPolicyAuditInfo*, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int>)(lpVtbl[9]))((IProtectionPolicyManagerStatics4*)Unsafe.AsPointer(ref this), sourceItemList, appPackageFamilyName, auditInfo, result);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IProtectionPolicyManagerStatics4*, IIterable<IntPtr>*, HSTRING, IProtectionPolicyAuditInfo*, HSTRING, ProtectionPolicyRequestAccessBehavior, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int>)(lpVtbl[10]))((IProtectionPolicyManagerStatics4*)Unsafe.AsPointer(ref this), sourceItemList, appPackageFamilyName, auditInfo, messageFromApp, behavior, result);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(11)]
    public HRESULT RequestAccessToFilesForProcessAsync([NativeTypeName("ABI::Windows::Foundation::Collections::__FIIterable_1_Windows__CStorage__CIStorageItem_t *")] IIterable<IntPtr>* sourceItemList, [NativeTypeName("UINT32")] uint processId, [NativeTypeName("ABI::Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo *")] IProtectionPolicyAuditInfo* auditInfo, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CSecurity__CEnterpriseData__CProtectionPolicyEvaluationResult_t **")] IAsyncOperation<ProtectionPolicyEvaluationResult>** result)
    {
        return ((delegate* unmanaged[MemberFunction]<IProtectionPolicyManagerStatics4*, IIterable<IntPtr>*, uint, IProtectionPolicyAuditInfo*, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int>)(lpVtbl[11]))((IProtectionPolicyManagerStatics4*)Unsafe.AsPointer(ref this), sourceItemList, processId, auditInfo, result);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IProtectionPolicyManagerStatics4*, IIterable<IntPtr>*, uint, IProtectionPolicyAuditInfo*, HSTRING, ProtectionPolicyRequestAccessBehavior, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int>)(lpVtbl[12]))((IProtectionPolicyManagerStatics4*)Unsafe.AsPointer(ref this), sourceItemList, processId, auditInfo, messageFromApp, behavior, result);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IIterable<IntPtr>*, HSTRING, IProtectionPolicyAuditInfo*, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int> RequestAccessToFilesForAppAsync;

        [NativeTypeName("HRESULT (ABI::Windows::Foundation::Collections::__FIIterable_1_Windows__CStorage__CIStorageItem_t *, HSTRING, ABI::Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo *, HSTRING, ABI::Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior, ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CSecurity__CEnterpriseData__CProtectionPolicyEvaluationResult_t **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IIterable<IntPtr>*, HSTRING, IProtectionPolicyAuditInfo*, HSTRING, ProtectionPolicyRequestAccessBehavior, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int> RequestAccessToFilesForAppWithMessageAndBehaviorAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IIterable<IntPtr>*, uint, IProtectionPolicyAuditInfo*, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int> RequestAccessToFilesForProcessAsync;

        [NativeTypeName("HRESULT (ABI::Windows::Foundation::Collections::__FIIterable_1_Windows__CStorage__CIStorageItem_t *, UINT32, ABI::Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo *, HSTRING, ABI::Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior, ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CSecurity__CEnterpriseData__CProtectionPolicyEvaluationResult_t **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IIterable<IntPtr>*, uint, IProtectionPolicyAuditInfo*, HSTRING, ProtectionPolicyRequestAccessBehavior, IAsyncOperation<ProtectionPolicyEvaluationResult>**, int> RequestAccessToFilesForProcessWithMessageAndBehaviorAsync;
