...
public unsafe partial struct IHttpTransportInformation : IHttpTransportInformation.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpTransportInformation*, IVectorView<IntPtr>**, int>)(lpVtbl[9]))((IHttpTransportInformation*)Unsafe.AsPointer(ref this), value);
    }
