...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IHttpClient2));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[6]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[7]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, HttpCompletionOption, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[8]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, completionOption, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[9]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[10]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[11]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, IHttpContent*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[12]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, content, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IUriRuntimeClass*, IHttpContent*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[13]))((IHttpClient2*)Unsafe.AsPointer(ref this), uri, content, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IHttpRequestMessage*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[14]))((IHttpClient2*)Unsafe.AsPointer(ref this), request, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpClient2*, IHttpRequestMessage*, HttpCompletionOption, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int>)(lpVtbl[15]))((IHttpClient2*)Unsafe.AsPointer(ref this), request, completionOption, operation);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryDeleteAsync;

        [NativeTypeName("HRESULT (ABI::Windows::Foundation::IUriRuntimeClass *, ABI::Windows::Foundation::__FIAsyncOperationWithProgress_2_Windows__CWeb__CHttp__CHttpRequestResult_Windows__CWeb__CHttp__CHttpProgress_t **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryGetAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, HttpCompletionOption, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryGetAsync2;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryGetBufferAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryGetInputStreamAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryGetStringAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IHttpContent*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryPostAsync;

        [NativeTypeName("HRESULT (ABI::Windows::Foundation::IUriRuntimeClass *, ABI::Windows::Web::Http::IHttpContent *, ABI::Windows::Foundation::__FIAsyncOperationWithProgress_2_Windows__CWeb__CHttp__CHttpRequestResult_Windows__CWeb__CHttp__CHttpProgress_t **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IUriRuntimeClass*, IHttpContent*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TryPutAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IHttpRequestMessage*, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TrySendRequestAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IHttpRequestMessage*, HttpCompletionOption, IAsyncOperationWithProgress<IntPtr, HttpProgress>**, int> TrySendRequestAsync2;
    }
}
