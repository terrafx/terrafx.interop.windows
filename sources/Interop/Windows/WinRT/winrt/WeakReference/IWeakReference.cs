...
public unsafe partial struct IWeakReference : IWeakReference.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWeakReference;
