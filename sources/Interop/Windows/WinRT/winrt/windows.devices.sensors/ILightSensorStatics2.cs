...
public unsafe partial struct ILightSensorStatics2 : ILightSensorStatics2.Interface, INativeGuid
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT FromIdAsync(HSTRING deviceId, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CDevices__CSensors__CLightSensor_t **")] IAsyncOperation<IntPtr>** operation)
    {
        return ((delegate* unmanaged[MemberFunction]<ILightSensorStatics2*, HSTRING, IAsyncOperation<IntPtr>**, int>)(lpVtbl[7]))((ILightSensorStatics2*)Unsafe.AsPointer(ref this), deviceId, operation);
    }
    ...
    public interface Interface : IInspectable.Interface
    {
        ...
        [VtblIndex(7)]
        HRESULT FromIdAsync(HSTRING deviceId, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CDevices__CSensors__CLightSensor_t **")] IAsyncOperation<IntPtr>** operation);
    }
