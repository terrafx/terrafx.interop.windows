...
public unsafe partial struct IMagnetometerReading2 : IMagnetometerReading2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IMagnetometerReading2*, IMapView<HSTRING, IntPtr>**, int>)(lpVtbl[7]))((IMagnetometerReading2*)Unsafe.AsPointer(ref this), value);
    }
