...
/// <include file='IInclinometerStatics4.xml' path='doc/member[@name="IInclinometerStatics4"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IInclinometerStatics4);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IInclinometerStatics4*, Guid*, void**, int>)(lpVtbl[0]))((IInclinometerStatics4*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IInclinometerStatics4*, uint>)(lpVtbl[1]))((IInclinometerStatics4*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IInclinometerStatics4*, uint>)(lpVtbl[2]))((IInclinometerStatics4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IInclinometerStatics4*, uint*, Guid**, int>)(lpVtbl[3]))((IInclinometerStatics4*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IInclinometerStatics4*, HSTRING*, int>)(lpVtbl[4]))((IInclinometerStatics4*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IInclinometerStatics4*, TrustLevel*, int>)(lpVtbl[5]))((IInclinometerStatics4*)Unsafe.AsPointer(ref this), trustLevel);
    }

    /// <include file='IInclinometerStatics4.xml' path='doc/member[@name="IInclinometerStatics4.GetDeviceSelector"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(6)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IInclinometerStatics4*, SensorReadingType, HSTRING*, int>)(lpVtbl[6]))((IInclinometerStatics4*)Unsafe.AsPointer(ref this), readingType, result);
    }
