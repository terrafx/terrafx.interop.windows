...
/// <include file='IHumanPresenceSensorStatics.xml' path='doc/member[@name="IHumanPresenceSensorStatics"]/*' />
[Guid("2AE89842-DBA9-56B2-9F27-EAC69D621004")]
[NativeTypeName("struct IHumanPresenceSensorStatics : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IHumanPresenceSensorStatics : IHumanPresenceSensorStatics.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHumanPresenceSensorStatics);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHumanPresenceSensorStatics*, Guid*, void**, int>)(lpVtbl[0]))((IHumanPresenceSensorStatics*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IHumanPresenceSensorStatics*, uint>)(lpVtbl[1]))((IHumanPresenceSensorStatics*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IHumanPresenceSensorStatics*, uint>)(lpVtbl[2]))((IHumanPresenceSensorStatics*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHumanPresenceSensorStatics*, uint*, Guid**, int>)(lpVtbl[3]))((IHumanPresenceSensorStatics*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHumanPresenceSensorStatics*, HSTRING*, int>)(lpVtbl[4]))((IHumanPresenceSensorStatics*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHumanPresenceSensorStatics*, TrustLevel*, int>)(lpVtbl[5]))((IHumanPresenceSensorStatics*)Unsafe.AsPointer(ref this), trustLevel);
    }

    /// <include file='IHumanPresenceSensorStatics.xml' path='doc/member[@name="IHumanPresenceSensorStatics.GetDeviceSelector"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(6)]
    public HRESULT GetDeviceSelector(HSTRING* result)
    {
        return ((delegate* unmanaged[MemberFunction]<IHumanPresenceSensorStatics*, HSTRING*, int>)(lpVtbl[6]))((IHumanPresenceSensorStatics*)Unsafe.AsPointer(ref this), result);
    }
