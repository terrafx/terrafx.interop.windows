...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ILightSensorReading2));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ILightSensorReading2*, IMapView<HSTRING, IntPtr>**, int>)(lpVtbl[7]))((ILightSensorReading2*)Unsafe.AsPointer(ref this), value);
    }
