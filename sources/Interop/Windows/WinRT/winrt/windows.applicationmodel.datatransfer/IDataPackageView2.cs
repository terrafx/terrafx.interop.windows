...
/// <include file='IDataPackageView2.xml' path='doc/member[@name="IDataPackageView2"]/*' />
[Guid("40ECBA95-2450-4C1D-B6B4-ED45463DEE9C")]
[NativeTypeName("struct IDataPackageView2 : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IDataPackageView2 : IDataPackageView2.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDataPackageView2));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDataPackageView2*, Guid*, void**, int>)(lpVtbl[0]))((IDataPackageView2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDataPackageView2*, uint>)(lpVtbl[1]))((IDataPackageView2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDataPackageView2*, uint>)(lpVtbl[2]))((IDataPackageView2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDataPackageView2*, uint*, Guid**, int>)(lpVtbl[3]))((IDataPackageView2*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDataPackageView2*, HSTRING*, int>)(lpVtbl[4]))((IDataPackageView2*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDataPackageView2*, TrustLevel*, int>)(lpVtbl[5]))((IDataPackageView2*)Unsafe.AsPointer(ref this), trustLevel);
    }
