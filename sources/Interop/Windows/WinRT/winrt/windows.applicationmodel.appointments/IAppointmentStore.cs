...
public unsafe partial struct IAppointmentStore : IAppointmentStore.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentStore*, HSTRING, DateTime, IAsyncOperation<IntPtr>**, int>)(lpVtbl[10]))((IAppointmentStore*)Unsafe.AsPointer(ref this), localId, instanceStartTime, result);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentStore*, DateTime, TimeSpan, IAsyncOperation<IntPtr>**, int>)(lpVtbl[13]))((IAppointmentStore*)Unsafe.AsPointer(ref this), rangeStart, rangeLength, result);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentStore*, DateTime, TimeSpan, IFindAppointmentsOptions*, IAsyncOperation<IntPtr>**, int>)(lpVtbl[14]))((IAppointmentStore*)Unsafe.AsPointer(ref this), rangeStart, rangeLength, options, result);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentStore*, IAppointment*, DateTime, IAsyncOperation<IntPtr>**, int>)(lpVtbl[16]))((IAppointmentStore*)Unsafe.AsPointer(ref this), appointment, instanceStartTime, result);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentStore*, HSTRING, IAppointment*, Rect, Placement, DateTime, IAsyncOperation<HSTRING>**, int>)(lpVtbl[20]))((IAppointmentStore*)Unsafe.AsPointer(ref this), localId, appointment, selection, preferredPlacement, instanceStartDate, operation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentStore*, HSTRING, Rect, Placement, DateTime, IAsyncOperation<bool>**, int>)(lpVtbl[22]))((IAppointmentStore*)Unsafe.AsPointer(ref this), localId, selection, preferredPlacement, instanceStartDate, operation);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(24)]
    public HRESULT ShowAppointmentDetailsWithDateAsync(HSTRING localId, [NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime instanceStartDate, [NativeTypeName("ABI::Windows::Foundation::IAsyncAction **")] IAsyncAction** asyncAction)
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentStore*, HSTRING, DateTime, IAsyncAction**, int>)(lpVtbl[24]))((IAppointmentStore*)Unsafe.AsPointer(ref this), localId, instanceStartDate, asyncAction);
    }
    ...
    public interface Interface : IInspectable.Interface
    {
        ...
        [VtblIndex(24)]
        HRESULT ShowAppointmentDetailsWithDateAsync(HSTRING localId, [NativeTypeName("ABI::Windows::Foundation::DateTime")] DateTime instanceStartDate, [NativeTypeName("ABI::Windows::Foundation::IAsyncAction **")] IAsyncAction** asyncAction);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IAppointment*, DateTime, IAsyncOperation<IntPtr>**, int> FindConflictAsyncWithInstanceStart;
