...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IAppointmentCalendarSyncManager2));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentCalendarSyncManager2*, DateTime, int>)(lpVtbl[7]))((IAppointmentCalendarSyncManager2*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppointmentCalendarSyncManager2*, DateTime, int>)(lpVtbl[8]))((IAppointmentCalendarSyncManager2*)Unsafe.AsPointer(ref this), value);
    }
