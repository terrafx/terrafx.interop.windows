...
/// <include file='IAudioCaptureEffectsManager.xml' path='doc/member[@name="IAudioCaptureEffectsManager"]/*' />
[Guid("8F85C271-038D-4393-8298-540110608EEF")]
[NativeTypeName("struct IAudioCaptureEffectsManager : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IAudioCaptureEffectsManager : IAudioCaptureEffectsManager.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAudioCaptureEffectsManager);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioCaptureEffectsManager*, Guid*, void**, int>)(lpVtbl[0]))((IAudioCaptureEffectsManager*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioCaptureEffectsManager*, uint>)(lpVtbl[1]))((IAudioCaptureEffectsManager*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioCaptureEffectsManager*, uint>)(lpVtbl[2]))((IAudioCaptureEffectsManager*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioCaptureEffectsManager*, uint*, Guid**, int>)(lpVtbl[3]))((IAudioCaptureEffectsManager*)Unsafe.AsPointer(ref this), iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioCaptureEffectsManager*, HSTRING*, int>)(lpVtbl[4]))((IAudioCaptureEffectsManager*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioCaptureEffectsManager*, TrustLevel*, int>)(lpVtbl[5]))((IAudioCaptureEffectsManager*)Unsafe.AsPointer(ref this), trustLevel);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    public HRESULT remove_AudioCaptureEffectsChanged(EventRegistrationToken token)
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioCaptureEffectsManager*, EventRegistrationToken, int>)(lpVtbl[7]))((IAudioCaptureEffectsManager*)Unsafe.AsPointer(ref this), token);
    }
