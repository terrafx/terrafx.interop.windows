...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IWwwFormUrlDecoderEntry));
    ...
    {
        return ((delegate* unmanaged<IWwwFormUrlDecoderEntry*, HSTRING*, int>)(lpVtbl[4]))((IWwwFormUrlDecoderEntry*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged<IWwwFormUrlDecoderEntry*, HSTRING*, int>)(lpVtbl[6]))((IWwwFormUrlDecoderEntry*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged<IWwwFormUrlDecoderEntry*, HSTRING*, int>)(lpVtbl[7]))((IWwwFormUrlDecoderEntry*)Unsafe.AsPointer(ref this), value);
    }
