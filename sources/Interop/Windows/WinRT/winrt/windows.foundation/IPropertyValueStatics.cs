...
public unsafe partial struct IPropertyValueStatics : IPropertyValueStatics.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IPropertyValueStatics*, HSTRING*, int>)(lpVtbl[4]))((IPropertyValueStatics*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged<IPropertyValueStatics*, HSTRING, IInspectable**, int>)(lpVtbl[18]))((IPropertyValueStatics*)Unsafe.AsPointer(ref this), value, propertyValue);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(35)]
    public HRESULT CreateChar16Array([NativeTypeName("UINT32")] uint valueLength, [NativeTypeName("WCHAR *")] ushort* value, IInspectable** propertyValue)
    {
    ...
    {
        return ((delegate* unmanaged<IPropertyValueStatics*, uint, HSTRING*, IInspectable**, int>)(lpVtbl[37]))((IPropertyValueStatics*)Unsafe.AsPointer(ref this), valueLength, value, propertyValue);
    }
    ...
    public interface Interface : IInspectable.Interface
    {
        ...
        [VtblIndex(35)]
        HRESULT CreateChar16Array([NativeTypeName("UINT32")] uint valueLength, [NativeTypeName("WCHAR *")] ushort* value, IInspectable** propertyValue);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, DateTime, IInspectable**, int> CreateDateTime;
        ...
        public delegate* unmanaged<TSelf*, uint, IInspectable**, IInspectable**, int> CreateInspectableArray;
        ...
        public delegate* unmanaged<TSelf*, uint, DateTime*, IInspectable**, int> CreateDateTimeArray;
