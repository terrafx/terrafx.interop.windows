...
public unsafe partial struct IUriRuntimeClassWithAbsoluteCanonicalUri : IUriRuntimeClassWithAbsoluteCanonicalUri.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IUriRuntimeClassWithAbsoluteCanonicalUri*, HSTRING*, int>)(lpVtbl[4]))((IUriRuntimeClassWithAbsoluteCanonicalUri*)Unsafe.AsPointer(ref this), className);
    }
    ...
    {
        return ((delegate* unmanaged<IUriRuntimeClassWithAbsoluteCanonicalUri*, HSTRING*, int>)(lpVtbl[6]))((IUriRuntimeClassWithAbsoluteCanonicalUri*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged<IUriRuntimeClassWithAbsoluteCanonicalUri*, HSTRING*, int>)(lpVtbl[7]))((IUriRuntimeClassWithAbsoluteCanonicalUri*)Unsafe.AsPointer(ref this), value);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName("HRESULT (HSTRING *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, HSTRING*, int> get_AbsoluteCanonicalUri;

        [NativeTypeName("HRESULT (HSTRING *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, HSTRING*, int> get_DisplayIri;
    }
}
