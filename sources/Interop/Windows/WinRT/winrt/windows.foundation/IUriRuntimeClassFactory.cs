...
/// <include file='IUriRuntimeClassFactory.xml' path='doc/member[@name="IUriRuntimeClassFactory"]/*' />
[Guid("44A9796F-723E-4FDF-A218-033E75B0C084")]
[NativeTypeName("struct IUriRuntimeClassFactory : IInspectable")]
[NativeInheritance("IInspectable")]
public unsafe partial struct IUriRuntimeClassFactory : IUriRuntimeClassFactory.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IUriRuntimeClassFactory);
    ...
    {
        [VtblIndex(6)]
        HRESULT CreateUri(HSTRING uri, [NativeTypeName("ABI::Windows::Foundation::IUriRuntimeClass **")] IUriRuntimeClass** instance);

        [VtblIndex(7)]
        HRESULT CreateWithRelativeUri(HSTRING baseUri, HSTRING relativeUri, [NativeTypeName("ABI::Windows::Foundation::IUriRuntimeClass **")] IUriRuntimeClass** instance);
    }
