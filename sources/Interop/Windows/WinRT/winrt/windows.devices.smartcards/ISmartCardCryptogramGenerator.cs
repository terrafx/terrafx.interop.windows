...
public unsafe partial struct ISmartCardCryptogramGenerator : ISmartCardCryptogramGenerator.Interface, INativeGuid
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(13)]
    public HRESULT RequestCryptogramMaterialStorageKeyInfoAsync([NativeTypeName("ABI::Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior")] SmartCardUnlockPromptingBehavior promptingBehavior, HSTRING storageKeyName, [NativeTypeName("ABI::Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType")] CryptographicPublicKeyBlobType format, [NativeTypeName("ABI::Windows::Foundation::__FIAsyncOperation_1_Windows__CDevices__CSmartCards__CSmartCardCryptogramStorageKeyInfo_t **")] IAsyncOperation<IntPtr>** result)
    {
        return ((delegate* unmanaged[MemberFunction]<ISmartCardCryptogramGenerator*, SmartCardUnlockPromptingBehavior, HSTRING, CryptographicPublicKeyBlobType, IAsyncOperation<IntPtr>**, int>)(lpVtbl[13]))((ISmartCardCryptogramGenerator*)Unsafe.AsPointer(ref this), promptingBehavior, storageKeyName, format, result);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, SmartCardUnlockPromptingBehavior, HSTRING, CryptographicPublicKeyBlobType, IAsyncOperation<IntPtr>**, int> RequestCryptogramMaterialStorageKeyInfoAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, SmartCardUnlockPromptingBehavior, SmartCardCryptogramMaterialPackageConfirmationResponseFormat, HSTRING, HSTRING, IBuffer*, IAsyncOperation<IntPtr>**, int> TryProvePossessionOfCryptogramMaterialPackageAsync;
