...
public unsafe partial struct ISmartCardEmulatorApduReceivedEventArgsWithCryptograms : ISmartCardEmulatorApduReceivedEventArgsWithCryptograms.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISmartCardEmulatorApduReceivedEventArgsWithCryptograms*, IBuffer*, IIterable<IntPtr>*, IAsyncOperation<SmartCardCryptogramGeneratorOperationStatus>**, int>)(lpVtbl[6]))((ISmartCardEmulatorApduReceivedEventArgsWithCryptograms*)Unsafe.AsPointer(ref this), responseTemplate, cryptogramPlacementSteps, result);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IBuffer*, IIterable<IntPtr>*, IAsyncOperation<SmartCardCryptogramGeneratorOperationStatus>**, int> TryRespondWithCryptogramsAsync;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IBuffer*, IIterable<IntPtr>*, IReference<uint>*, IAsyncOperation<SmartCardCryptogramGeneratorOperationStatus>**, int> TryRespondWithCryptogramsAndStateAsync;
    }
}
