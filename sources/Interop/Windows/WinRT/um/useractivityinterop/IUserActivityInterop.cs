...
public unsafe partial struct IUserActivityInterop : IUserActivityInterop.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IUserActivityInterop;
