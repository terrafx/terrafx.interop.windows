...
public unsafe partial struct IVideoFrameNative : IVideoFrameNative.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IVideoFrameNative;
