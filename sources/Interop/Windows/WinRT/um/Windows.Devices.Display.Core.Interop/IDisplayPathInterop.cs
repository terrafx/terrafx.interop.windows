...
public unsafe partial struct IDisplayPathInterop : IDisplayPathInterop.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDisplayPathInterop;
