...
public unsafe partial struct IMLOperatorKernel : IMLOperatorKernel.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMLOperatorKernel;
