...
public unsafe partial struct IMLOperatorTypeInferrer : IMLOperatorTypeInferrer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMLOperatorTypeInferrer;
