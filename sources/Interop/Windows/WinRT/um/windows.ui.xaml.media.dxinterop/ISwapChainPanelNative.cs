...
public unsafe partial struct ISwapChainPanelNative : ISwapChainPanelNative.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISwapChainPanelNative;
