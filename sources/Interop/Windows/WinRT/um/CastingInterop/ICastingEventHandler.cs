...
public unsafe partial struct ICastingEventHandler : ICastingEventHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICastingEventHandler;
