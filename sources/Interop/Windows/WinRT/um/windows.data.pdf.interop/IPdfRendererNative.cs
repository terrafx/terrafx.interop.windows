...
public unsafe partial struct IPdfRendererNative : IPdfRendererNative.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPdfRendererNative;
