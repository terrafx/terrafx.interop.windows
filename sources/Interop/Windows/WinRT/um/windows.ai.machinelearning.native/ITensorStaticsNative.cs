...
public unsafe partial struct ITensorStaticsNative : ITensorStaticsNative.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITensorStaticsNative;
