...
public unsafe partial struct HueSaturationLightness
{
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status SetParameters([NativeTypeName("const Gdiplus::HueSaturationLightnessParams *")] HueSaturationLightnessParams* parameters)
    {
        uint size = 12;
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status GetParameters(uint* size, [NativeTypeName("Gdiplus::HueSaturationLightnessParams *")] HueSaturationLightnessParams* parameters)
    {
