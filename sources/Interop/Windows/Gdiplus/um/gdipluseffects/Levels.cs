...
public unsafe partial struct Levels
{
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status SetParameters([NativeTypeName("const Gdiplus::LevelsParams *")] LevelsParams* parameters)
    {
        uint size = 12;
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status GetParameters(uint* size, [NativeTypeName("Gdiplus::LevelsParams *")] LevelsParams* parameters)
    {
