...
public unsafe partial struct ColorCurve
{
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status SetParameters([NativeTypeName("const Gdiplus::ColorCurveParams *")] ColorCurveParams* parameters)
    {
        uint size = 12;
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status GetParameters(uint* size, [NativeTypeName("Gdiplus::ColorCurveParams *")] ColorCurveParams* parameters)
    {
