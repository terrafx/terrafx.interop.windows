...
public unsafe partial struct Tint
{
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status SetParameters([NativeTypeName("const Gdiplus::TintParams *")] TintParams* parameters)
    {
        uint size = 8;
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status GetParameters(uint* size, [NativeTypeName("Gdiplus::TintParams *")] TintParams* parameters)
    {
