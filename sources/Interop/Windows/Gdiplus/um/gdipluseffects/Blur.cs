...
public unsafe partial struct Blur
{
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status SetParameters([NativeTypeName("const Gdiplus::BlurParams *")] BlurParams* parameters)
    {
        uint size = 8;
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public Status GetParameters(uint* size, [NativeTypeName("Gdiplus::BlurParams *")] BlurParams* parameters)
    {
