...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDXGIFactory3
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDXGIFactory3*, IUnknown*, IntPtr, DXGI_SWAP_CHAIN_DESC1*, DXGI_SWAP_CHAIN_FULLSCREEN_DESC*, IDXGIOutput*, IDXGISwapChain1**, int>)(lpVtbl[15]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), pDevice, hWnd, pDesc, pFullscreenDesc, pRestrictToOutput, ppSwapChain);
        }
