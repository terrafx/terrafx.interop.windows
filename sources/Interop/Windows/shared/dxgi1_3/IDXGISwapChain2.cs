...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDXGISwapChain2
    {
        ...
        {
            return ((delegate* unmanaged<IDXGISwapChain2*, int, IDXGIOutput*, int>)(lpVtbl[10]))((IDXGISwapChain2*)Unsafe.AsPointer(ref this), Fullscreen, pTarget);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGISwapChain2*, int*, IDXGIOutput**, int>)(lpVtbl[11]))((IDXGISwapChain2*)Unsafe.AsPointer(ref this), pFullscreen, ppTarget);
        }
