...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDXGISwapChain4
    {
        ...
        {
            return ((delegate* unmanaged<IDXGISwapChain4*, nint>)(lpVtbl[33]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [VtblIndex(40)]
        public HRESULT SetHDRMetaData(DXGI_HDR_METADATA_TYPE Type, [NativeTypeName("UINT")] uint Size, void* pMetaData)
        {
