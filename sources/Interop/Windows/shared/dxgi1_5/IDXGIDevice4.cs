...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDXGIDevice4
    {
        ...
        {
            return ((delegate* unmanaged<IDXGIDevice4*, uint, IDXGIResource**, int*, int>)(lpVtbl[15]))((IDXGIDevice4*)Unsafe.AsPointer(ref this), NumResources, ppResources, pDiscarded);
        }
