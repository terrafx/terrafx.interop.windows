...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDXGIFactory5
    {
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr, uint, int>)(lpVtbl[8]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), WindowHandle, Flags);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr*, int>)(lpVtbl[9]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), pWindowHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr, IDXGIAdapter**, int>)(lpVtbl[11]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), Module, ppAdapter);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IUnknown*, IntPtr, DXGI_SWAP_CHAIN_DESC1*, DXGI_SWAP_CHAIN_FULLSCREEN_DESC*, IDXGIOutput*, IDXGISwapChain1**, int>)(lpVtbl[15]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), pDevice, hWnd, pDesc, pFullscreenDesc, pRestrictToOutput, ppSwapChain);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr, LUID*, int>)(lpVtbl[17]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), hResource, pLuid);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr, uint, uint*, int>)(lpVtbl[18]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr, uint*, int>)(lpVtbl[19]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), hEvent, pdwCookie);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr, uint, uint*, int>)(lpVtbl[21]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
        }
        ...
        {
            return ((delegate* unmanaged<IDXGIFactory5*, IntPtr, uint*, int>)(lpVtbl[22]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), hEvent, pdwCookie);
        }
