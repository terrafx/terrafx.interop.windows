...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("hid", EntryPoint = "HidP_GetCaps", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_GetCaps([NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData, [NativeTypeName("PHIDP_CAPS")] HIDP_CAPS* Capabilities);

        [DllImport("hid", EntryPoint = "HidP_GetLinkCollectionNodes", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_GetLinkCollectionNodes([NativeTypeName("PHIDP_LINK_COLLECTION_NODE")] HIDP_LINK_COLLECTION_NODE* LinkCollectionNodes, [NativeTypeName("PULONG")] uint* LinkCollectionNodesLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData);

        [DllImport("hid", EntryPoint = "HidP_GetSpecificButtonCaps", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_GetButtonCaps", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_GetButtonCaps(HIDP_REPORT_TYPE ReportType, [NativeTypeName("PHIDP_BUTTON_CAPS")] HIDP_BUTTON_CAPS* ButtonCaps, [NativeTypeName("PUSHORT")] ushort* ButtonCapsLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData);

        [DllImport("hid", EntryPoint = "HidP_GetSpecificValueCaps", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_GetValueCaps", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_GetValueCaps(HIDP_REPORT_TYPE ReportType, [NativeTypeName("PHIDP_VALUE_CAPS")] HIDP_VALUE_CAPS* ValueCaps, [NativeTypeName("PUSHORT")] ushort* ValueCapsLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData);

        [DllImport("hid", EntryPoint = "HidP_GetExtendedAttributes", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_InitializeReportForID", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_InitializeReportForID(HIDP_REPORT_TYPE ReportType, [NativeTypeName("UCHAR")] byte ReportID, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData, [NativeTypeName("PCHAR")] sbyte* Report, [NativeTypeName("ULONG")] uint ReportLength);

        [DllImport("hid", EntryPoint = "HidP_SetData", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_SetData(HIDP_REPORT_TYPE ReportType, [NativeTypeName("PHIDP_DATA")] HIDP_DATA* DataList, [NativeTypeName("PULONG")] uint* DataLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData, [NativeTypeName("PCHAR")] sbyte* Report, [NativeTypeName("ULONG")] uint ReportLength);

        [DllImport("hid", EntryPoint = "HidP_GetData", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_GetData(HIDP_REPORT_TYPE ReportType, [NativeTypeName("PHIDP_DATA")] HIDP_DATA* DataList, [NativeTypeName("PULONG")] uint* DataLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData, [NativeTypeName("PCHAR")] sbyte* Report, [NativeTypeName("ULONG")] uint ReportLength);

        [DllImport("hid", EntryPoint = "HidP_MaxDataListLength", ExactSpelling = true)]
        [return: NativeTypeName("ULONG")]
        public static extern uint HidP_MaxDataListLength(HIDP_REPORT_TYPE ReportType, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData);

        [DllImport("hid", EntryPoint = "HidP_SetUsages", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_UnsetUsages", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_UnsetUsages(HIDP_REPORT_TYPE ReportType, [NativeTypeName("USAGE")] ushort UsagePage, [NativeTypeName("USHORT")] ushort LinkCollection, [NativeTypeName("PUSAGE")] ushort* UsageList, [NativeTypeName("PULONG")] uint* UsageLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData, [NativeTypeName("PCHAR")] sbyte* Report, [NativeTypeName("ULONG")] uint ReportLength);

        [DllImport("hid", EntryPoint = "HidP_GetUsages", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_GetUsages(HIDP_REPORT_TYPE ReportType, [NativeTypeName("USAGE")] ushort UsagePage, [NativeTypeName("USHORT")] ushort LinkCollection, [NativeTypeName("PUSAGE")] ushort* UsageList, [NativeTypeName("PULONG")] uint* UsageLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData, [NativeTypeName("PCHAR")] sbyte* Report, [NativeTypeName("ULONG")] uint ReportLength);

        [DllImport("hid", EntryPoint = "HidP_GetUsagesEx", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_MaxUsageListLength", ExactSpelling = true)]
        [return: NativeTypeName("ULONG")]
        public static extern uint HidP_MaxUsageListLength(HIDP_REPORT_TYPE ReportType, [NativeTypeName("USAGE")] ushort UsagePage, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData);

        [DllImport("hid", EntryPoint = "HidP_SetUsageValue", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_SetScaledUsageValue", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_SetUsageValueArray", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_GetUsageValue", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_GetScaledUsageValue", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_GetUsageValueArray", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        public static extern int HidP_GetUsageValueArray(HIDP_REPORT_TYPE ReportType, [NativeTypeName("USAGE")] ushort UsagePage, [NativeTypeName("USHORT")] ushort LinkCollection, [NativeTypeName("USAGE")] ushort Usage, [NativeTypeName("PCHAR")] sbyte* UsageValue, [NativeTypeName("USHORT")] ushort UsageValueByteLength, [NativeTypeName("PHIDP_PREPARSED_DATA")] IntPtr PreparsedData, [NativeTypeName("PCHAR")] sbyte* Report, [NativeTypeName("ULONG")] uint ReportLength);

        [DllImport("hid", EntryPoint = "HidP_UsageListDifference", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_UsageAndPageListDifference", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_TranslateUsageAndPagesToI8042ScanCodes", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
        ...
        [DllImport("hid", EntryPoint = "HidP_TranslateUsagesToI8042ScanCodes", ExactSpelling = true)]
        [return: NativeTypeName("NTSTATUS")]
