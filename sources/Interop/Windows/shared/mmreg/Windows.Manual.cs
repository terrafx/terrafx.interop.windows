...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        public const int MM_PID_UNMAPPED = MM_UNMAPPED;
        ...
        public const int MM_PROAUD_MIDIOUT = (MM_MEDIAVISION_PROAUDIO + 1);

        public const int MM_PROAUD_MIDIIN = (MM_MEDIAVISION_PROAUDIO + 2);

        public const int MM_PROAUD_SYNTH = (MM_MEDIAVISION_PROAUDIO + 3);

        public const int MM_PROAUD_WAVEOUT = (MM_MEDIAVISION_PROAUDIO + 4);

        public const int MM_PROAUD_WAVEIN = (MM_MEDIAVISION_PROAUDIO + 5);

        public const int MM_PROAUD_MIXER = (MM_MEDIAVISION_PROAUDIO + 6);

        public const int MM_PROAUD_AUX = (MM_MEDIAVISION_PROAUDIO + 7);

        public const int MM_MEDIAVISION_THUNDER = 0x20;

        public const int MM_THUNDER_SYNTH = (MM_MEDIAVISION_THUNDER + 3);

        public const int MM_THUNDER_WAVEOUT = (MM_MEDIAVISION_THUNDER + 4);

        public const int MM_THUNDER_WAVEIN = (MM_MEDIAVISION_THUNDER + 5);

        public const int MM_THUNDER_AUX = (MM_MEDIAVISION_THUNDER + 7);

        public const int MM_MEDIAVISION_TPORT = 0x40;

        public const int MM_TPORT_WAVEOUT = (MM_MEDIAVISION_TPORT + 1);

        public const int MM_TPORT_WAVEIN = (MM_MEDIAVISION_TPORT + 2);

        public const int MM_TPORT_SYNTH = (MM_MEDIAVISION_TPORT + 3);

        public const int MM_MEDIAVISION_PROAUDIO_PLUS = 0x50;

        public const int MM_PROAUD_PLUS_MIDIOUT = (MM_MEDIAVISION_PROAUDIO_PLUS + 1);

        public const int MM_PROAUD_PLUS_MIDIIN = (MM_MEDIAVISION_PROAUDIO_PLUS + 2);

        public const int MM_PROAUD_PLUS_SYNTH = (MM_MEDIAVISION_PROAUDIO_PLUS + 3);

        public const int MM_PROAUD_PLUS_WAVEOUT = (MM_MEDIAVISION_PROAUDIO_PLUS + 4);

        public const int MM_PROAUD_PLUS_WAVEIN = (MM_MEDIAVISION_PROAUDIO_PLUS + 5);

        public const int MM_PROAUD_PLUS_MIXER = (MM_MEDIAVISION_PROAUDIO_PLUS + 6);

        public const int MM_PROAUD_PLUS_AUX = (MM_MEDIAVISION_PROAUDIO_PLUS + 7);

        public const int MM_MEDIAVISION_PROAUDIO_16 = 0x60;

        public const int MM_PROAUD_16_MIDIOUT = (MM_MEDIAVISION_PROAUDIO_16 + 1);

        public const int MM_PROAUD_16_MIDIIN = (MM_MEDIAVISION_PROAUDIO_16 + 2);

        public const int MM_PROAUD_16_SYNTH = (MM_MEDIAVISION_PROAUDIO_16 + 3);

        public const int MM_PROAUD_16_WAVEOUT = (MM_MEDIAVISION_PROAUDIO_16 + 4);

        public const int MM_PROAUD_16_WAVEIN = (MM_MEDIAVISION_PROAUDIO_16 + 5);

        public const int MM_PROAUD_16_MIXER = (MM_MEDIAVISION_PROAUDIO_16 + 6);

        public const int MM_PROAUD_16_AUX = (MM_MEDIAVISION_PROAUDIO_16 + 7);

        public const int MM_MEDIAVISION_PROSTUDIO_16 = 0x60;

        public const int MM_STUDIO_16_MIDIOUT = (MM_MEDIAVISION_PROSTUDIO_16 + 1);

        public const int MM_STUDIO_16_MIDIIN = (MM_MEDIAVISION_PROSTUDIO_16 + 2);

        public const int MM_STUDIO_16_SYNTH = (MM_MEDIAVISION_PROSTUDIO_16 + 3);

        public const int MM_STUDIO_16_WAVEOUT = (MM_MEDIAVISION_PROSTUDIO_16 + 4);

        public const int MM_STUDIO_16_WAVEIN = (MM_MEDIAVISION_PROSTUDIO_16 + 5);

        public const int MM_STUDIO_16_MIXER = (MM_MEDIAVISION_PROSTUDIO_16 + 6);

        public const int MM_STUDIO_16_AUX = (MM_MEDIAVISION_PROSTUDIO_16 + 7);

        public const int MM_MEDIAVISION_CDPC = 0x70;

        public const int MM_CDPC_MIDIOUT = (MM_MEDIAVISION_CDPC + 1);

        public const int MM_CDPC_MIDIIN = (MM_MEDIAVISION_CDPC + 2);

        public const int MM_CDPC_SYNTH = (MM_MEDIAVISION_CDPC + 3);

        public const int MM_CDPC_WAVEOUT = (MM_MEDIAVISION_CDPC + 4);

        public const int MM_CDPC_WAVEIN = (MM_MEDIAVISION_CDPC + 5);

        public const int MM_CDPC_MIXER = (MM_MEDIAVISION_CDPC + 6);

        public const int MM_CDPC_AUX = (MM_MEDIAVISION_CDPC + 7);

        public const int MM_MEDIAVISION_OPUS1208 = 0x80;

        public const int MM_OPUS401_MIDIOUT = (MM_MEDIAVISION_OPUS1208 + 1);

        public const int MM_OPUS401_MIDIIN = (MM_MEDIAVISION_OPUS1208 + 2);

        public const int MM_OPUS1208_SYNTH = (MM_MEDIAVISION_OPUS1208 + 3);

        public const int MM_OPUS1208_WAVEOUT = (MM_MEDIAVISION_OPUS1208 + 4);

        public const int MM_OPUS1208_WAVEIN = (MM_MEDIAVISION_OPUS1208 + 5);

        public const int MM_OPUS1208_MIXER = (MM_MEDIAVISION_OPUS1208 + 6);

        public const int MM_OPUS1208_AUX = (MM_MEDIAVISION_OPUS1208 + 7);

        public const int MM_MEDIAVISION_OPUS1216 = 0x90;

        public const int MM_OPUS1216_MIDIOUT = (MM_MEDIAVISION_OPUS1216 + 1);

        public const int MM_OPUS1216_MIDIIN = (MM_MEDIAVISION_OPUS1216 + 2);

        public const int MM_OPUS1216_SYNTH = (MM_MEDIAVISION_OPUS1216 + 3);

        public const int MM_OPUS1216_WAVEOUT = (MM_MEDIAVISION_OPUS1216 + 4);

        public const int MM_OPUS1216_WAVEIN = (MM_MEDIAVISION_OPUS1216 + 5);

        public const int MM_OPUS1216_MIXER = (MM_MEDIAVISION_OPUS1216 + 6);

        public const int MM_OPUS1216_AUX = (MM_MEDIAVISION_OPUS1216 + 7);
        ...
        public const int MM_SOUNDSCAPE_WAVEOUT = MM_ENSONIQ_SOUNDSCAPE + 1;

        public const int MM_SOUNDSCAPE_WAVEOUT_AUX = MM_ENSONIQ_SOUNDSCAPE + 2;

        public const int MM_SOUNDSCAPE_WAVEIN = MM_ENSONIQ_SOUNDSCAPE + 3;

        public const int MM_SOUNDSCAPE_MIDIOUT = MM_ENSONIQ_SOUNDSCAPE + 4;

        public const int MM_SOUNDSCAPE_MIDIIN = MM_ENSONIQ_SOUNDSCAPE + 5;

        public const int MM_SOUNDSCAPE_SYNTH = MM_ENSONIQ_SOUNDSCAPE + 6;

        public const int MM_SOUNDSCAPE_MIXER = MM_ENSONIQ_SOUNDSCAPE + 7;

        public const int MM_SOUNDSCAPE_AUX = MM_ENSONIQ_SOUNDSCAPE + 8;
        ...
        public const int MM_OKSORI_OSR8_WAVEOUT = MM_OKSORI_BASE + 1;

        public const int MM_OKSORI_OSR8_WAVEIN = MM_OKSORI_BASE + 2;

        public const int MM_OKSORI_OSR16_WAVEOUT = MM_OKSORI_BASE + 3;

        public const int MM_OKSORI_OSR16_WAVEIN = MM_OKSORI_BASE + 4;

        public const int MM_OKSORI_FM_OPL4 = MM_OKSORI_BASE + 5;

        public const int MM_OKSORI_MIX_MASTER = MM_OKSORI_BASE + 6;

        public const int MM_OKSORI_MIX_WAVE = MM_OKSORI_BASE + 7;

        public const int MM_OKSORI_MIX_FM = MM_OKSORI_BASE + 8;

        public const int MM_OKSORI_MIX_LINE = MM_OKSORI_BASE + 9;

        public const int MM_OKSORI_MIX_CD = MM_OKSORI_BASE + 10;

        public const int MM_OKSORI_MIX_MIC = MM_OKSORI_BASE + 11;

        public const int MM_OKSORI_MIX_ECHO = MM_OKSORI_BASE + 12;

        public const int MM_OKSORI_MIX_AUX1 = MM_OKSORI_BASE + 13;

        public const int MM_OKSORI_MIX_LINE1 = MM_OKSORI_BASE + 14;

        public const int MM_OKSORI_EXT_MIC1 = MM_OKSORI_BASE + 15;

        public const int MM_OKSORI_EXT_MIC2 = MM_OKSORI_BASE + 16;

        public const int MM_OKSORI_MIDIOUT = MM_OKSORI_BASE + 17;

        public const int MM_OKSORI_MIDIIN = MM_OKSORI_BASE + 18;

        public const int MM_OKSORI_MPEG_CDVISION = MM_OKSORI_BASE + 19;
        ...
        public const int WAVE_FORMAT_IMA_ADPCM = (WAVE_FORMAT_DVI_ADPCM);
        ...
        public const int SPEAKER_ALL = unchecked((int)0x80000000);
        ...
        public const int MSAUDIO1_BITS_PER_SAMPLE = WMAUDIO_BITS_PER_SAMPLE;

        public const int MSAUDIO1_MAX_CHANNELS = WMAUDIO_MAX_CHANNELS;

        public static readonly int MSAUDIO1_WFX_EXTRA_BYTES = (sizeof(MSAUDIO1WAVEFORMAT) - sizeof(WAVEFORMATEX));

        public const int MM_MSFT_ACM_WMAUDIO2 = 101;

        public const int WMAUDIO2_BITS_PER_SAMPLE = WMAUDIO_BITS_PER_SAMPLE;

        public const int WMAUDIO2_MAX_CHANNELS = WMAUDIO_MAX_CHANNELS;

        public static readonly int WMAUDIO2_WFX_EXTRA_BYTES = (sizeof(WMAUDIO2WAVEFORMAT) - sizeof(WAVEFORMATEX));

        public static readonly int WMAUDIO3_WFX_EXTRA_BYTES = (sizeof(WMAUDIO3WAVEFORMAT) - sizeof(WAVEFORMATEX));
        ...
        public const int MIXERCONTROL_CONTROLTYPE_SRS_MTS = (MIXERCONTROL_CONTROLTYPE_BOOLEAN + 6);
