...
namespace TerraFX.Interop
{
    public unsafe partial struct HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION : IEquatable<HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION>
    {
        ...
        public static implicit operator byte(HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION value) => (byte)(value.Value);
        ...
        public static implicit operator short(HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION value) => (short)(value.Value);
        ...
        public static implicit operator sbyte(HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION value) => (sbyte)(value.Value);
        ...
        public static implicit operator ushort(HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION value) => (ushort)(value.Value);
