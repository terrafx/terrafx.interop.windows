...
{
    public partial struct CO_MTA_USAGE_COOKIE : IEquatable<CO_MTA_USAGE_COOKIE>
    {
        ...
        public static implicit operator CO_MTA_USAGE_COOKIE(nint value) => new CO_MTA_USAGE_COOKIE(value);
