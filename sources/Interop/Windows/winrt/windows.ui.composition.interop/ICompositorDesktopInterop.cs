...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ICompositorDesktopInterop
    {
        ...
        [VtblIndex(3)]
        [return: NativeTypeName("HRESULT")]
        public int CreateDesktopWindowTarget([NativeTypeName("HWND")] IntPtr hwndTarget, BOOL isTopmost, [NativeTypeName("ABI::Windows::UI::Composition::Desktop::IDesktopWindowTarget **")] void** result)
        {
