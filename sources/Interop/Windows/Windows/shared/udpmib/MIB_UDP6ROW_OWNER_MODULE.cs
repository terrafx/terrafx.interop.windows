...
/// <include file='MIB_UDP6ROW_OWNER_MODULE.xml' path='doc/member[@name="MIB_UDP6ROW_OWNER_MODULE"]/*' />
public unsafe partial struct MIB_UDP6ROW_OWNER_MODULE
{
    ...
    /// <include file='MIB_UDP6ROW_OWNER_MODULE.xml' path='doc/member[@name="MIB_UDP6ROW_OWNER_MODULE.dwLocalPort"]/*' />
    [NativeTypeName("DWORD")]
    public uint dwLocalPort;

    /// <include file='MIB_UDP6ROW_OWNER_MODULE.xml' path='doc/member[@name="MIB_UDP6ROW_OWNER_MODULE.dwOwningPid"]/*' />
    [NativeTypeName("DWORD")]
    public uint dwOwningPid;

    /// <include file='MIB_UDP6ROW_OWNER_MODULE.xml' path='doc/member[@name="MIB_UDP6ROW_OWNER_MODULE.liCreateTimestamp"]/*' />
    ...
    [NativeTypeName("_MIB_UDP6ROW_OWNER_MODULE::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.20348.0/shared/udpmib.h:153:5)")]
    ...
    public partial struct _Anonymous_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("_MIB_UDP6ROW_OWNER_MODULE::(anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.20348.0/shared/udpmib.h:154:9)")]
