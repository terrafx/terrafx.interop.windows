...
// Ported from shared/hidusage.h in the Windows SDK for Windows 10.0.28000.0
...
public static partial class HID
{
    ...
    [NativeTypeName("#define HID_USAGE_ARCADE_GENERAL_PURPOSE_DIGITAL_INPUT_STATE ((USAGE) 0x0031)")]
    public const ushort HID_USAGE_ARCADE_GENERAL_PURPOSE_DIGITAL_INPUT_STATE = ((ushort)(0x0031));

    [NativeTypeName("#define HID_USAGE_ARCADE_GENERAL_PURPOSE_OPTICAL_INPUT_STATE ((USAGE) 0x0032)")]
    public const ushort HID_USAGE_ARCADE_GENERAL_PURPOSE_OPTICAL_INPUT_STATE = ((ushort)(0x0032));

    [NativeTypeName("#define HID_USAGE_ARCADE_GENERAL_PURPOSE_DIGITAL_OUTPUT_STATE ((USAGE) 0x0033)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_EAN_23_LABEL_CONTROL_REPORT ((USAGE) 0x0017)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_INTERLEAVED_2_OF_5_CONTROL_REPORT ((USAGE) 0x0019)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_INTERLEAVED_2_OF_5_CONTROL_REPORT = ((ushort)(0x0019));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_STANDARD_2_OF_5_CONTROL_REPORT ((USAGE) 0x001A)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_STANDARD_2_OF_5_CONTROL_REPORT = ((ushort)(0x001A));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_MSI_PLESSEY_CONTROL_REPORT ((USAGE) 0x001B)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_ELECTRONIC_ARTICLE_SURVEILLANCE_NOTIFICATION ((USAGE) 0x0036)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_ELECTRONIC_ARTICLE_SURVEILLANCE_NOTIFICATION = ((ushort)(0x0036));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CONSTANT_ELECTRONIC_ARTICLE_SURVEILLANCE ((USAGE) 0x0037)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CONSTANT_ELECTRONIC_ARTICLE_SURVEILLANCE = ((ushort)(0x0037));
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_BLINKING_LASER_ON ((USAGE) 0x0063)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_BLINKING_LASER_ON = ((ushort)(0x0063));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_CONTINUOUS_LASER_ON ((USAGE) 0x0064)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_CONTINUOUS_LASER_ON = ((ushort)(0x0064));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_LASER_ON_WHILE_PULLED ((USAGE) 0x0065)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_LASER_ON_WHILE_PULLED = ((ushort)(0x0065));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_LASER_STAYS_ON_AFTER_RELEASE ((USAGE) 0x0066)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_TRIGGER_MODE_LASER_STAYS_ON_AFTER_RELEASE = ((ushort)(0x0066));
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_SET_PARAMETER_DEFAULT_VALUES ((USAGE) 0x0070)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_GRWTI_BEEPLAMP_AFTER_TRANSMIT ((USAGE) 0x008A)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_GRWTI_BEEPLAMP_AFTER_TRANSMIT = ((ushort)(0x008A));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_GRWTI_NO_BEEPLAMP_USE_AT_ALL ((USAGE) 0x008B)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_PERIODICAL_AUTODISCRIMINATE_2 ((USAGE) 0x00AA)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_PERIODICAL_AUTODISCRIMINATE_2 = ((ushort)(0x00AA));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_PERIODICAL_ONLY_DECODE_WITH_2 ((USAGE) 0x00AB)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_PERIODICAL_ONLY_DECODE_WITH_2 = ((ushort)(0x00AB));
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_PERIODICAL_AUTODISCRIMINATE_5 ((USAGE) 0x00AD)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_PERIODICAL_AUTODISCRIMINATE_5 = ((ushort)(0x00AD));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_PERIODICAL_ONLY_DECODE_WITH_5 ((USAGE) 0x00AE)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_PERIODICAL_ONLY_DECODE_WITH_5 = ((ushort)(0x00AE));
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_4_DIGIT_PRICE ((USAGE) 0x00B2)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_4_DIGIT_PRICE = ((ushort)(0x00B2));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_5_DIGIT_PRICE ((USAGE) 0x00B3)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_5_DIGIT_PRICE = ((ushort)(0x00B3));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_EUROPEAN_4_DIGIT_PRICE ((USAGE) 0x00B4)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_EUROPEAN_4_DIGIT_PRICE = ((ushort)(0x00B4));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_EUROPEAN_5_DIGIT_PRICE ((USAGE) 0x00B5)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_ENABLE_EUROPEAN_5_DIGIT_PRICE = ((ushort)(0x00B5));
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_ADD_EAN_23_LABEL_DEFINITION ((USAGE) 0x00BF)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_ADD_EAN_23_LABEL_DEFINITION = ((ushort)(0x00BF));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CLEAR_ALL_EAN_23_LABEL_DEFINITIONS ((USAGE) 0x00C0)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CLEAR_ALL_EAN_23_LABEL_DEFINITIONS = ((ushort)(0x00C0));
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_INTERLEAVED_2_OF_5_OPCC ((USAGE) 0x00D8)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_INTERLEAVED_2_OF_5_OPCC = ((ushort)(0x00D8));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_INTERLEAVED_2_OF_5_USS ((USAGE) 0x00D9)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_INTERLEAVED_2_OF_5_USS = ((ushort)(0x00D9));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_STANDARD_2_OF_5_OPCC ((USAGE) 0x00DA)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_STANDARD_2_OF_5_OPCC = ((ushort)(0x00DA));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_STANDARD_2_OF_5_USS ((USAGE) 0x00DB)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_STANDARD_2_OF_5_USS = ((ushort)(0x00DB));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_ONE_MSI_PLESSEY ((USAGE) 0x00DC)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_ONE_MSI_PLESSEY = ((ushort)(0x00DC));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_TWO_MSI_PLESSEY ((USAGE) 0x00DD)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_ENABLE_TWO_MSI_PLESSEY = ((ushort)(0x00DD));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_CODABAR_ENABLE ((USAGE) 0x00DE)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_CODABAR_ENABLE = ((ushort)(0x00DE));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_CHECK_DIGIT_CODE_39_ENABLE ((USAGE) 0x00DF)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_DISABLE_CHECK_DIGIT_TRANSMIT ((USAGE) 0x00F1)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_DISABLE_CHECK_DIGIT_TRANSMIT = ((ushort)(0x00F1));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_ENABLE_CHECK_DIGIT_TRANSMIT ((USAGE) 0x00F2)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_POLARITY_INVERTED_BAR_CODE ((USAGE) 0x0103)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_DISCRETE_LENGTH_TO_DECODE_1 ((USAGE) 0x0108)")]
    public const ushort HID_USAGE_BARCODE_SCANNER_DISCRETE_LENGTH_TO_DECODE_1 = ((ushort)(0x0108));

    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_DISCRETE_LENGTH_TO_DECODE_2 ((USAGE) 0x0109)")]
    ...
    [NativeTypeName("#define HID_USAGE_BARCODE_SCANNER_DL_METHOD_CHECK_FOR_DISCRETE ((USAGE) 0x010D)")]
    ...
    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_BATTERY_STATUS ((USAGE) 0x0002)")]
    public const ushort HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_BATTERY_STATUS = ((ushort)(0x0002));

    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_ALARM_WARNING ((USAGE) 0x0003)")]
    ...
    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_CHARGER_STATUS ((USAGE) 0x0005)")]
    public const ushort HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_CHARGER_STATUS = ((ushort)(0x0005));

    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_CHARGER_SPEC_INFO ((USAGE) 0x0006)")]
    public const ushort HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_CHARGER_SPEC_INFO = ((ushort)(0x0006));

    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_SELECTOR_STATE ((USAGE) 0x0007)")]
    public const ushort HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_SELECTOR_STATE = ((ushort)(0x0007));

    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_SELECTOR_PRESETS ((USAGE) 0x0008)")]
    public const ushort HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_SELECTOR_PRESETS = ((ushort)(0x0008));

    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_SMART_BATTERY_SELECTOR_INFO ((USAGE) 0x0009)")]
    ...
    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_BELOW_REMAINING_CAPACITY_LIMIT ((USAGE) 0x0042)")]
    public const ushort HID_USAGE_BATTERY_SYSTEM_BELOW_REMAINING_CAPACITY_LIMIT = ((ushort)(0x0042));

    [NativeTypeName("#define HID_USAGE_BATTERY_SYSTEM_REMAINING_TIME_LIMIT_EXPIRED ((USAGE) 0x0043)")]
    ...
    [NativeTypeName("#define HID_USAGE_BRAILLE_DISPLAY_BRAILLE_KEYBOARD_LEFT_SPACE ((USAGE) 0x020A)")]
    public const ushort HID_USAGE_BRAILLE_DISPLAY_BRAILLE_KEYBOARD_LEFT_SPACE = ((ushort)(0x020A));

    [NativeTypeName("#define HID_USAGE_BRAILLE_DISPLAY_BRAILLE_KEYBOARD_RIGHT_SPACE ((USAGE) 0x020B)")]
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_DISPLAY_SET_BRIGHTNESS_TO_MINIMUM ((USAGE) 0x0073)")]
    public const ushort HID_USAGE_CONSUMER_DISPLAY_SET_BRIGHTNESS_TO_MINIMUM = ((ushort)(0x0073));

    [NativeTypeName("#define HID_USAGE_CONSUMER_DISPLAY_SET_BRIGHTNESS_TO_MAXIMUM ((USAGE) 0x0074)")]
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_START_OR_STOP_VOICE_DICTATION_SESSION ((USAGE) 0x00D8)")]
    public const ushort HID_USAGE_CONSUMER_START_OR_STOP_VOICE_DICTATION_SESSION = ((ushort)(0x00D8));
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_CHANNEL_LOW_FREQUENCY_ENHANCEMENT ((USAGE) 0x0168)")]
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_AL_LAUNCH_BUTTON_CONFIGURATION_TOOL ((USAGE) 0x0181)")]
    public const ushort HID_USAGE_CONSUMER_AL_LAUNCH_BUTTON_CONFIGURATION_TOOL = ((ushort)(0x0181));

    [NativeTypeName("#define HID_USAGE_CONSUMER_AL_PROGRAMMABLE_BUTTON_CONFIGURATION ((USAGE) 0x0182)")]
    public const ushort HID_USAGE_CONSUMER_AL_PROGRAMMABLE_BUTTON_CONFIGURATION = ((ushort)(0x0182));
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_AL_PREEMPTIVE_HALT_TASKAPPLICATION ((USAGE) 0x01A5)")]
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_AL_OEM_FEATURES_TIPSTUTORIAL_BROWSER ((USAGE) 0x01BD)")]
    public const ushort HID_USAGE_CONSUMER_AL_OEM_FEATURES_TIPSTUTORIAL_BROWSER = ((ushort)(0x01BD));
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_AL_CUSTOMIZED_CORPORATE_NEWS_BROWSER ((USAGE) 0x01C4)")]
    public const ushort HID_USAGE_CONSUMER_AL_CUSTOMIZED_CORPORATE_NEWS_BROWSER = ((ushort)(0x01C4));
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_AL_CONTEXTAWARE_DESKTOP_ASSISTANT ((USAGE) 0x01CB)")]
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_EXTENDED_KEYBOARD_ATTRIBUTES_COLLECTION ((USAGE) 0x02C0)")]
    public const ushort HID_USAGE_CONSUMER_EXTENDED_KEYBOARD_ATTRIBUTES_COLLECTION = ((ushort)(0x02C0));
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_VENDOR_SPECIFIC_KEYBOARD_PHYSICAL_LAYOUT ((USAGE) 0x02C4)")]
    public const ushort HID_USAGE_CONSUMER_VENDOR_SPECIFIC_KEYBOARD_PHYSICAL_LAYOUT = ((ushort)(0x02C4));
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_IMPLEMENTED_KEYBOARD_INPUT_ASSIST_CONTROLS ((USAGE) 0x02C6)")]
    public const ushort HID_USAGE_CONSUMER_IMPLEMENTED_KEYBOARD_INPUT_ASSIST_CONTROLS = ((ushort)(0x02C6));
    ...
    [NativeTypeName("#define HID_USAGE_CONSUMER_KEYBOARD_INPUT_ASSIST_PREVIOUS_GROUP ((USAGE) 0x02C9)")]
    public const ushort HID_USAGE_CONSUMER_KEYBOARD_INPUT_ASSIST_PREVIOUS_GROUP = ((ushort)(0x02C9));
    ...
    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_FORM_FACTOR_FULL_SIZE ((USAGE_VALUE) 0x0001)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_FORM_FACTOR_FULL_SIZE = ((int)(0x0001));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_FORM_FACTOR_COMPACT ((USAGE_VALUE) 0x0002)")]
    ...
    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_KEY_TYPE_FULL_TRAVEL ((USAGE_VALUE) 0x0001)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_KEY_TYPE_FULL_TRAVEL = ((int)(0x0001));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_KEY_TYPE_LOW_TRAVEL ((USAGE_VALUE) 0x0002)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_KEY_TYPE_LOW_TRAVEL = ((int)(0x0002));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_KEY_TYPE_ZERO_TRAVEL ((USAGE_VALUE) 0x0003)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_KEY_TYPE_ZERO_TRAVEL = ((int)(0x0003));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_UNKNOWN ((USAGE_VALUE) 0x0000)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_UNKNOWN = ((int)(0x0000));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_US_101 ((USAGE_VALUE) 0x0001)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_US_101 = ((int)(0x0001));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_KOREA_103 ((USAGE_VALUE) 0x0002)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_KOREA_103 = ((int)(0x0002));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_EUROPE_102 ((USAGE_VALUE) 0x0003)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_EUROPE_102 = ((int)(0x0003));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_BRAZIL_104 ((USAGE_VALUE) 0x0004)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_BRAZIL_104 = ((int)(0x0004));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_JAPAN_106 ((USAGE_VALUE) 0x0005)")]
    public const int HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_JAPAN_106 = ((int)(0x0005));

    [NativeTypeName("#define HID_VALUE_CONSUMER_KEYBOARD_PHYSICAL_LAYOUT_VENDOR ((USAGE_VALUE) 0x0006)")]
    ...
    [NativeTypeName("#define HID_USAGE_DIGITIZER_UTF16_LITTLE_ENDIAN_CHARACTER_GESTURE_ENCODING ((USAGE) 0x0066)")]
    public const ushort HID_USAGE_DIGITIZER_UTF16_LITTLE_ENDIAN_CHARACTER_GESTURE_ENCODING = ((ushort)(0x0066));

    [NativeTypeName("#define HID_USAGE_DIGITIZER_UTF16_BIG_ENDIAN_CHARACTER_GESTURE_ENCODING ((USAGE) 0x0067)")]
    public const ushort HID_USAGE_DIGITIZER_UTF16_BIG_ENDIAN_CHARACTER_GESTURE_ENCODING = ((ushort)(0x0067));

    [NativeTypeName("#define HID_USAGE_DIGITIZER_UTF32_LITTLE_ENDIAN_CHARACTER_GESTURE_ENCODING ((USAGE) 0x0068)")]
    public const ushort HID_USAGE_DIGITIZER_UTF32_LITTLE_ENDIAN_CHARACTER_GESTURE_ENCODING = ((ushort)(0x0068));

    [NativeTypeName("#define HID_USAGE_DIGITIZER_UTF32_BIG_ENDIAN_CHARACTER_GESTURE_ENCODING ((USAGE) 0x0069)")]
    public const ushort HID_USAGE_DIGITIZER_UTF32_BIG_ENDIAN_CHARACTER_GESTURE_ENCODING = ((ushort)(0x0069));
    ...
    [NativeTypeName("#define HID_USAGE_DIGITIZER_ERR_FULL_TRANS_FEATURES_UNAVAILABLE ((USAGE) 0x0084)")]
    public const ushort HID_USAGE_DIGITIZER_ERR_FULL_TRANS_FEATURES_UNAVAILABLE = ((ushort)(0x0084));
    ...
    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_HEAD_DIRECTION_POINT ((USAGE) 0x0028)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_HEAD_DIRECTION_POINT = ((ushort)(0x0028));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_ROTATION_ABOUT_X_AXIS ((USAGE) 0x0029)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_ROTATION_ABOUT_X_AXIS = ((ushort)(0x0029));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_ROTATION_ABOUT_Y_AXIS ((USAGE) 0x002A)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_ROTATION_ABOUT_Y_AXIS = ((ushort)(0x002A));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_ROTATION_ABOUT_Z_AXIS ((USAGE) 0x002B)")]
    ...
    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_MINIMUM_TRACKING_DISTANCE ((USAGE) 0x0101)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_MINIMUM_TRACKING_DISTANCE = ((ushort)(0x0101));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_OPTIMUM_TRACKING_DISTANCE ((USAGE) 0x0102)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_OPTIMUM_TRACKING_DISTANCE = ((ushort)(0x0102));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_MAXIMUM_TRACKING_DISTANCE ((USAGE) 0x0103)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_MAXIMUM_TRACKING_DISTANCE = ((ushort)(0x0103));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_MAXIMUM_SCREEN_PLANE_WIDTH ((USAGE) 0x0104)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_MAXIMUM_SCREEN_PLANE_WIDTH = ((ushort)(0x0104));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_MAXIMUM_SCREEN_PLANE_HEIGHT ((USAGE) 0x0105)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_MAXIMUM_SCREEN_PLANE_HEIGHT = ((ushort)(0x0105));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_DISPLAY_MANUFACTURER_ID ((USAGE) 0x0200)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_DISPLAY_MANUFACTURER_ID = ((ushort)(0x0200));
    ...
    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_DISPLAY_SERIAL_NUMBER ((USAGE) 0x0202)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_DISPLAY_SERIAL_NUMBER = ((ushort)(0x0202));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_DISPLAY_MANUFACTURER_DATE ((USAGE) 0x0203)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_DISPLAY_MANUFACTURER_DATE = ((ushort)(0x0203));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_CALIBRATED_SCREEN_WIDTH ((USAGE) 0x0204)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_CALIBRATED_SCREEN_WIDTH = ((ushort)(0x0204));

    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_CALIBRATED_SCREEN_HEIGHT ((USAGE) 0x0205)")]
    public const ushort HID_USAGE_EYE_AND_HEAD_TRACKERS_CALIBRATED_SCREEN_HEIGHT = ((ushort)(0x0205));
    ...
    [NativeTypeName("#define HID_USAGE_EYE_AND_HEAD_TRACKERS_CONFIGURATION_STATUS ((USAGE) 0x0301)")]
    ...
    [NativeTypeName("#define HID_USAGE_GENERIC_SYSTEM_DISPLAY_ROTATION_LOCK_BUTTON ((USAGE) 0x00C9)")]
    public const ushort HID_USAGE_GENERIC_SYSTEM_DISPLAY_ROTATION_LOCK_BUTTON = ((ushort)(0x00C9));

    [NativeTypeName("#define HID_USAGE_GENERIC_SYSTEM_DISPLAY_ROTATION_LOCK_SLIDER_SWITCH ((USAGE) 0x00CA)")]
    public const ushort HID_USAGE_GENERIC_SYSTEM_DISPLAY_ROTATION_LOCK_SLIDER_SWITCH = ((ushort)(0x00CA));
    ...
    [NativeTypeName("#define HID_USAGE_GENERIC_DOCKABLE_DEVICE_PRIMARY_USAGE_PAGE ((USAGE) 0x00D2)")]
    ...
    [NativeTypeName("#define HID_USAGE_LAMPARRAY_BOUNDING_BOX_WIDTH_IN_MICROMETERS ((USAGE) 0x0004)")]
    public const ushort HID_USAGE_LAMPARRAY_BOUNDING_BOX_WIDTH_IN_MICROMETERS = ((ushort)(0x0004));

    [NativeTypeName("#define HID_USAGE_LAMPARRAY_BOUNDING_BOX_HEIGHT_IN_MICROMETERS ((USAGE) 0x0005)")]
    public const ushort HID_USAGE_LAMPARRAY_BOUNDING_BOX_HEIGHT_IN_MICROMETERS = ((ushort)(0x0005));

    [NativeTypeName("#define HID_USAGE_LAMPARRAY_BOUNDING_BOX_DEPTH_IN_MICROMETERS ((USAGE) 0x0006)")]
    ...
    [NativeTypeName("#define HID_USAGE_LAMPARRAY_MIN_UPDATE_INTERVAL_IN_MICROSECONDS ((USAGE) 0x0008)")]
    public const ushort HID_USAGE_LAMPARRAY_MIN_UPDATE_INTERVAL_IN_MICROSECONDS = ((ushort)(0x0008));
    ...
    [NativeTypeName("#define HID_USAGE_MAGNETIC_STRIPE_READER_MSR_DEVICE_READONLY ((USAGE) 0x0001)")]
    ...
    [NativeTypeName("#define HID_USAGE_MEDICAL_INSTRUMENT_DEPTH_GAIN_COMPENSATION ((USAGE) 0x0070)")]
    ...
    [NativeTypeName("#define HID_USAGE_MEDICAL_INSTRUMENT_SPECTRAL_DOPPLER_MODE_SELECT ((USAGE) 0x0082)")]
    public const ushort HID_USAGE_MEDICAL_INSTRUMENT_SPECTRAL_DOPPLER_MODE_SELECT = ((ushort)(0x0082));

    [NativeTypeName("#define HID_USAGE_MEDICAL_INSTRUMENT_SPECTRAL_DOPPLER_ADJUST ((USAGE) 0x0083)")]
    public const ushort HID_USAGE_MEDICAL_INSTRUMENT_SPECTRAL_DOPPLER_ADJUST = ((ushort)(0x0083));

    [NativeTypeName("#define HID_USAGE_MEDICAL_INSTRUMENT_COLOR_DOPPLER_MODE_SELECT ((USAGE) 0x0084)")]
    ...
    [NativeTypeName("#define HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_STABLE_AT_CENTER_OF_ZERO ((USAGE) 0x0072)")]
    public const ushort HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_STABLE_AT_CENTER_OF_ZERO = ((ushort)(0x0072));
    ...
    [NativeTypeName("#define HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_WEIGHT_STABLE ((USAGE) 0x0074)")]
    ...
    [NativeTypeName("#define HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_OVER_WEIGHT_LIMIT ((USAGE) 0x0076)")]
    public const ushort HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_OVER_WEIGHT_LIMIT = ((ushort)(0x0076));

    [NativeTypeName("#define HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_REQUIRES_CALIBRATION ((USAGE) 0x0077)")]
    public const ushort HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_REQUIRES_CALIBRATION = ((ushort)(0x0077));

    [NativeTypeName("#define HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_REQUIRES_REZEROING ((USAGE) 0x0078)")]
    public const ushort HID_USAGE_WEIGHING_DEVICE_SCALE_STATUS_REQUIRES_REZEROING = ((ushort)(0x0078));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_BIOMETRIC_PERIPHERAL_OXYGEN_SATURATION ((USAGE) 0x0018)")]
    public const ushort HID_USAGE_SENSORS_BIOMETRIC_PERIPHERAL_OXYGEN_SATURATION = ((ushort)(0x0018));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_ENVIRONMENTAL_ATMOSPHERIC_PRESSURE ((USAGE) 0x0031)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_ENVIRONMENTAL_VOLATILE_ORGANIC_COMPOUNDS ((USAGE) 0x0039)")]
    public const ushort HID_USAGE_SENSORS_ENVIRONMENTAL_VOLATILE_ORGANIC_COMPOUNDS = ((ushort)(0x0039));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_LOCATION_GPS_GLOBAL_POSITIONING_SYSTEM ((USAGE) 0x0053)")]
    public const ushort HID_USAGE_SENSORS_LOCATION_GPS_GLOBAL_POSITIONING_SYSTEM = ((ushort)(0x0053));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PERSONAL_ACTIVITY_ACTIVITY_DETECTION ((USAGE) 0x00B1)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_ORIENTATION_EXTENDED_GEOMAGNETIC_ORIENTATION ((USAGE) 0x00C1)")]
    public const ushort HID_USAGE_SENSORS_ORIENTATION_EXTENDED_GEOMAGNETIC_ORIENTATION = ((ushort)(0x00C1));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_CHANGE_SENSITIVITY_ABSOLUTE ((USAGE) 0x030F)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_CHANGE_SENSITIVITY_ABSOLUTE = ((ushort)(0x030F));

    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_CHANGE_SENSITIVITY_PERCENT_OF_RANGE ((USAGE) 0x0310)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_CHANGE_SENSITIVITY_PERCENT_OF_RANGE = ((ushort)(0x0310));

    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_CHANGE_SENSITIVITY_PERCENT_RELATIVE ((USAGE) 0x0311)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_CHANGE_SENSITIVITY_PERCENT_RELATIVE = ((ushort)(0x0311));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_MAXIMUM_POWER_CONSUMPTION ((USAGE) 0x031D)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_HUMAN_PRESENCE_DETECTION_TYPE ((USAGE) 0x031F)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_HUMAN_PRESENCE_DETECTION_TYPE = ((ushort)(0x031F));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ALTITUDE_ANTENNA_SEA_LEVEL ((USAGE) 0x0402)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ALTITUDE_ANTENNA_SEA_LEVEL = ((ushort)(0x0402));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_DIFFERENTIAL_REFERENCE_STATION_ID ((USAGE) 0x0403)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_DIFFERENTIAL_REFERENCE_STATION_ID = ((ushort)(0x0403));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ALTITUDE_ELLIPSOID_ERROR ((USAGE) 0x0404)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ALTITUDE_SEA_LEVEL_ERROR ((USAGE) 0x0406)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_DIFFERENTIAL_GPS_DATA_AGE ((USAGE) 0x0408)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_POSITION_DILUTION_OF_PRECISION ((USAGE) 0x0410)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_POSITION_DILUTION_OF_PRECISION = ((ushort)(0x0410));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_HORIZONTAL_DILUTION_OF_PRECISION ((USAGE) 0x0411)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_HORIZONTAL_DILUTION_OF_PRECISION = ((ushort)(0x0411));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_VERTICAL_DILUTION_OF_PRECISION ((USAGE) 0x0412)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_VERTICAL_DILUTION_OF_PRECISION = ((ushort)(0x0412));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_AZIMUTH ((USAGE) 0x041A)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_AZIMUTH = ((ushort)(0x041A));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_ELEVATION ((USAGE) 0x041B)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_ELEVATION = ((ushort)(0x041B));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_PRNS ((USAGE) 0x041D)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_PRNS = ((ushort)(0x041D));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_SN_RATIOS ((USAGE) 0x041E)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_SATELLITES_IN_VIEW_SN_RATIOS = ((ushort)(0x041E));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_LOCATION_DESIRED_ACCURACY ((USAGE) 0x042B)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_VOLATILE_ORGANIC_COMPOUND_CONCENTRATION ((USAGE) 0x0439)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_VOLATILE_ORGANIC_COMPOUND_CONCENTRATION = ((ushort)(0x0439));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_OBJECT_PROXIMITY_OUT_OF_RANGE ((USAGE) 0x043C)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_OBJECT_PROXIMITY_OUT_OF_RANGE = ((ushort)(0x043C));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_VELOCITY_ABOUT_X_AXIS ((USAGE) 0x0457)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_VELOCITY_ABOUT_X_AXIS = ((ushort)(0x0457));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_VELOCITY_ABOUT_Y_AXIS ((USAGE) 0x0458)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_VELOCITY_ABOUT_Y_AXIS = ((ushort)(0x0458));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_VELOCITY_ABOUT_Z_AXIS ((USAGE) 0x0459)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_VELOCITY_ABOUT_Z_AXIS = ((ushort)(0x0459));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_POSITION_ABOUT_X_AXIS ((USAGE) 0x045B)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_POSITION_ABOUT_X_AXIS = ((ushort)(0x045B));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_POSITION_ABOUT_Y_AXIS ((USAGE) 0x045C)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_POSITION_ABOUT_Y_AXIS = ((ushort)(0x045C));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_POSITION_ABOUT_Z_AXIS ((USAGE) 0x045D)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ANGULAR_POSITION_ABOUT_Z_AXIS = ((ushort)(0x045D));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_HEADING_COMPENSATED_MAGNETIC_NORTH ((USAGE) 0x0475)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_HEADING_COMPENSATED_MAGNETIC_NORTH = ((ushort)(0x0475));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_HEADING_COMPENSATED_TRUE_NORTH ((USAGE) 0x0476)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_HEADING_COMPENSATED_TRUE_NORTH = ((ushort)(0x0476));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_SIMPLE_ORIENTATION_DIRECTION ((USAGE) 0x0489)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_SIMPLE_ORIENTATION_DIRECTION = ((ushort)(0x0489));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_BOOLEAN_SWITCH_ARRAY_STATES ((USAGE) 0x0492)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_BOOLEAN_SWITCH_ARRAY_STATES = ((ushort)(0x0492));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_MULTIVALUE_SWITCH_VALUE ((USAGE) 0x0493)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_HUMAN_PROXIMITY_OUT_OF_RANGE ((USAGE) 0x04B3)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_HUMAN_PROXIMITY_OUT_OF_RANGE = ((ushort)(0x04B3));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_BLOOD_PRESSURE_DIASTOLIC ((USAGE) 0x04B6)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_BLOOD_PRESSURE_DIASTOLIC = ((ushort)(0x04B6));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_BLOOD_PRESSURE_SYSTOLIC ((USAGE) 0x04B7)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_HUMAN_ATTENTION_DETECTED ((USAGE) 0x04BD)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_CONSUMER_IR_SENTENCE_RECEIVE ((USAGE) 0x04D6)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_CONSUMER_IR_SENTENCE_RECEIVE = ((ushort)(0x04D6));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_CONSUMER_IR_SENTENCE_SEND ((USAGE) 0x04E0)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_CONSUMER_IR_SENTENCE_SEND = ((ushort)(0x04E0));

    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_AUTO_BRIGHTNESS_PREFERRED ((USAGE) 0x04E2)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_TIME_ZONE_OFFSET_FROM_UTC ((USAGE) 0x0531)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_DAYLIGHT_SAVINGS_TIME_OBSERVED ((USAGE) 0x0533)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_DAYLIGHT_SAVINGS_TIME_OBSERVED = ((ushort)(0x0533));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_GUID_OR_PROPERTYKEY ((USAGE) 0x0561)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_GUID_OR_PROPERTYKEY = ((ushort)(0x0561));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_EVENT_PROPERTYKEY ((USAGE) 0x0564)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_EVENT_PROPERTYKEY = ((ushort)(0x0564));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_PROPERTY_PROPERTYKEY ((USAGE) 0x0565)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_PROPERTY_PROPERTYKEY = ((ushort)(0x0565));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_DATA_FIELD_PROPERTYKEY ((USAGE) 0x0566)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_DATA_FIELD_PROPERTYKEY = ((ushort)(0x0566));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ENUMERATOR_TABLE_ROW_INDEX ((USAGE) 0x056A)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ENUMERATOR_TABLE_ROW_INDEX = ((ushort)(0x056A));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_ENUMERATOR_TABLE_ROW_COUNT ((USAGE) 0x056B)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_ENUMERATOR_TABLE_ROW_COUNT = ((ushort)(0x056B));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_GUID_OR_PROPERTYKEY_KIND ((USAGE) 0x056C)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_GUID_OR_PROPERTYKEY_KIND = ((ushort)(0x056C));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_TOP_LEVEL_COLLECTION_ID ((USAGE) 0x056F)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_TOP_LEVEL_COLLECTION_ID = ((ushort)(0x056F));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_REPORT_ITEM_POSITION_INDEX ((USAGE) 0x0571)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_REPORT_ITEM_POSITION_INDEX = ((ushort)(0x0571));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_FIRMWARE_VARTYPE ((USAGE) 0x0572)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_GENERIC_FIRMWARE_VARTYPE = ((ushort)(0x0572));

    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_GENERIC_UNIT_OF_MEASURE ((USAGE) 0x0573)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_ENUMERATOR_TABLE_ROW_INDEX ((USAGE) 0x0581)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_ENUMERATOR_TABLE_ROW_INDEX = ((ushort)(0x0581));

    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_ENUMERATOR_TABLE_ROW_COUNT ((USAGE) 0x0582)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_MINIMUM_ACTIVITY_DETECTION_INTERVAL ((USAGE) 0x05A0)")]
    public const ushort HID_USAGE_SENSORS_PROPERTY_MINIMUM_ACTIVITY_DETECTION_INTERVAL = ((ushort)(0x05A0));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_PROPERTY_SUBSCRIBED_ACTIVITY_TYPES ((USAGE) 0x05A2)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_HINGE_FOLD_INITIAL_ANGLE ((USAGE) 0x05F2)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_DATA_FIELD_HINGE_FOLD_CONTRIBUTING_PANEL ((USAGE) 0x05F4)")]
    public const ushort HID_USAGE_SENSORS_DATA_FIELD_HINGE_FOLD_CONTRIBUTING_PANEL = ((ushort)(0x05F4));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_RANGE_MAXIMUM_REACHED ((USAGE) 0x0816)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_RANGE_MAXIMUM_REACHED = ((ushort)(0x0816));

    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_RANGE_MINIMUM_REACHED ((USAGE) 0x0817)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_RANGE_MINIMUM_REACHED = ((ushort)(0x0817));

    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_HIGH_THRESHOLD_CROSS_UPWARD ((USAGE) 0x0818)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_HIGH_THRESHOLD_CROSS_UPWARD = ((ushort)(0x0818));

    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_HIGH_THRESHOLD_CROSS_DOWNWARD ((USAGE) 0x0819)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_HIGH_THRESHOLD_CROSS_DOWNWARD = ((ushort)(0x0819));

    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_LOW_THRESHOLD_CROSS_UPWARD ((USAGE) 0x081A)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_LOW_THRESHOLD_CROSS_UPWARD = ((ushort)(0x081A));

    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_LOW_THRESHOLD_CROSS_DOWNWARD ((USAGE) 0x081B)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_LOW_THRESHOLD_CROSS_DOWNWARD = ((ushort)(0x081B));

    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_ZERO_THRESHOLD_CROSS_UPWARD ((USAGE) 0x081C)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_ZERO_THRESHOLD_CROSS_UPWARD = ((ushort)(0x081C));

    [NativeTypeName("#define HID_USAGE_SENSORS_SENSOR_EVENT_ZERO_THRESHOLD_CROSS_DOWNWARD ((USAGE) 0x081D)")]
    public const ushort HID_USAGE_SENSORS_SENSOR_EVENT_ZERO_THRESHOLD_CROSS_DOWNWARD = ((ushort)(0x081D));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_REPORTING_STATE_REPORT_THRESHOLD_EVENTS ((USAGE) 0x0842)")]
    public const ushort HID_USAGE_SENSORS_REPORTING_STATE_REPORT_THRESHOLD_EVENTS = ((ushort)(0x0842));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_REPORTING_STATE_WAKE_ON_ALL_EVENTS ((USAGE) 0x0844)")]
    public const ushort HID_USAGE_SENSORS_REPORTING_STATE_WAKE_ON_ALL_EVENTS = ((ushort)(0x0844));

    [NativeTypeName("#define HID_USAGE_SENSORS_REPORTING_STATE_WAKE_ON_THRESHOLD_EVENTS ((USAGE) 0x0845)")]
    public const ushort HID_USAGE_SENSORS_REPORTING_STATE_WAKE_ON_THRESHOLD_EVENTS = ((ushort)(0x0845));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_POWER_STATE_D2_STANDBY_POWER_WITH_WAKEUP ((USAGE) 0x0853)")]
    public const ushort HID_USAGE_SENSORS_POWER_STATE_D2_STANDBY_POWER_WITH_WAKEUP = ((ushort)(0x0853));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_GPS_SELECTION_MODE_ESTIMATED_DEAD_RECKONED ((USAGE) 0x08A2)")]
    public const ushort HID_USAGE_SENSORS_GPS_SELECTION_MODE_ESTIMATED_DEAD_RECKONED = ((ushort)(0x08A2));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_NOT_ROTATED ((USAGE) 0x08F0)")]
    public const ushort HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_NOT_ROTATED = ((ushort)(0x08F0));

    [NativeTypeName("#define HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_ROTATED_90_DEGREES_CCW ((USAGE) 0x08F1)")]
    public const ushort HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_ROTATED_90_DEGREES_CCW = ((ushort)(0x08F1));

    [NativeTypeName("#define HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_ROTATED_180_DEGREES_CCW ((USAGE) 0x08F2)")]
    public const ushort HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_ROTATED_180_DEGREES_CCW = ((ushort)(0x08F2));

    [NativeTypeName("#define HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_ROTATED_270_DEGREES_CCW ((USAGE) 0x08F3)")]
    public const ushort HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_ROTATED_270_DEGREES_CCW = ((ushort)(0x08F3));

    [NativeTypeName("#define HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_FACE_UP ((USAGE) 0x08F4)")]
    public const ushort HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_FACE_UP = ((ushort)(0x08F4));

    [NativeTypeName("#define HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_FACE_DOWN ((USAGE) 0x08F5)")]
    public const ushort HID_USAGE_SENSORS_SIMPLE_ORIENTATION_DIRECTION_FACE_DOWN = ((ushort)(0x08F5));
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_HINGE_FOLD_CONTRIBUTING_PANEL_UNKNOWN ((USAGE) 0x09B0)")]
    public const ushort HID_USAGE_SENSORS_HINGE_FOLD_CONTRIBUTING_PANEL_UNKNOWN = ((ushort)(0x09B0));

    [NativeTypeName("#define HID_USAGE_SENSORS_HINGE_FOLD_CONTRIBUTING_PANEL_PANEL_1 ((USAGE) 0x09B1)")]
    public const ushort HID_USAGE_SENSORS_HINGE_FOLD_CONTRIBUTING_PANEL_PANEL_1 = ((ushort)(0x09B1));

    [NativeTypeName("#define HID_USAGE_SENSORS_HINGE_FOLD_CONTRIBUTING_PANEL_PANEL_2 ((USAGE) 0x09B2)")]
    public const ushort HID_USAGE_SENSORS_HINGE_FOLD_CONTRIBUTING_PANEL_PANEL_2 = ((ushort)(0x09B2));

    [NativeTypeName("#define HID_USAGE_SENSORS_HINGE_FOLD_CONTRIBUTING_PANEL_BOTH ((USAGE) 0x09B3)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_VENDORDEFINED_NONBIOMETRIC ((USAGE) 0x09C0)")]
    public const ushort HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_VENDORDEFINED_NONBIOMETRIC = ((ushort)(0x09C0));

    [NativeTypeName("#define HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_VENDORDEFINED_BIOMETRIC ((USAGE) 0x09C1)")]
    public const ushort HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_VENDORDEFINED_BIOMETRIC = ((ushort)(0x09C1));

    [NativeTypeName("#define HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_FACIAL_BIOMETRIC ((USAGE) 0x09C2)")]
    public const ushort HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_FACIAL_BIOMETRIC = ((ushort)(0x09C2));

    [NativeTypeName("#define HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_AUDIO_BIOMETRIC ((USAGE) 0x09C3)")]
    public const ushort HID_USAGE_SENSORS_HUMAN_PRESENCE_DETECTION_TYPE_AUDIO_BIOMETRIC = ((ushort)(0x09C3));

    [NativeTypeName("#define HID_USAGE_SENSORS_MODIFIER_CHANGE_SENSITIVITY_ABSOLUTE ((USAGE) 0x1000)")]
    ...
    [NativeTypeName("#define HID_USAGE_SENSORS_MODIFIER_CHANGE_SENSITIVITY_PERCENT_OF_RANGE ((USAGE) 0xD000)")]
    public const ushort HID_USAGE_SENSORS_MODIFIER_CHANGE_SENSITIVITY_PERCENT_OF_RANGE = ((ushort)(0xD000));

    [NativeTypeName("#define HID_USAGE_SENSORS_MODIFIER_CHANGE_SENSITIVITY_PERCENT_RELATIVE ((USAGE) 0xE000)")]
    public const ushort HID_USAGE_SENSORS_MODIFIER_CHANGE_SENSITIVITY_PERCENT_RELATIVE = ((ushort)(0xE000));
    ...
    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_PINCUSHION ((USAGE) 0x0024)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_PINCUSHION = ((ushort)(0x0024));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_PINCUSHION_BALANCE ((USAGE) 0x0026)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_PINCUSHION_BALANCE = ((ushort)(0x0026));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_MISCONVERGENCE ((USAGE) 0x0028)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_MISCONVERGENCE = ((ushort)(0x0028));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_LINEARITY ((USAGE) 0x002A)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_LINEARITY = ((ushort)(0x002A));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_LINEARITY_BALANCE ((USAGE) 0x002C)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_LINEARITY_BALANCE = ((ushort)(0x002C));
    ...
    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_VERTICAL_PINCUSHION_BALANCE ((USAGE) 0x0036)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_VERTICAL_PINCUSHION_BALANCE = ((ushort)(0x0036));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_VERTICAL_MISCONVERGENCE ((USAGE) 0x0038)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_VERTICAL_MISCONVERGENCE = ((ushort)(0x0038));
    ...
    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_VERTICAL_LINEARITY_BALANCE ((USAGE) 0x003C)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_VERTICAL_LINEARITY_BALANCE = ((ushort)(0x003C));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_PARALLELOGRAM_DISTORTION_KEY_BALANCE ((USAGE) 0x0040)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_PARALLELOGRAM_DISTORTION_KEY_BALANCE = ((ushort)(0x0040));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_TRAPEZOIDAL_DISTORTION_KEY ((USAGE) 0x0042)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_TRAPEZOIDAL_DISTORTION_KEY = ((ushort)(0x0042));
    ...
    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_TOP_CORNER_DISTORTION_CONTROL ((USAGE) 0x0046)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_TOP_CORNER_DISTORTION_CONTROL = ((ushort)(0x0046));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_TOP_CORNER_DISTORTION_BALANCE ((USAGE) 0x0048)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_TOP_CORNER_DISTORTION_BALANCE = ((ushort)(0x0048));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_BOTTOM_CORNER_DISTORTION_CONTROL ((USAGE) 0x004A)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_BOTTOM_CORNER_DISTORTION_CONTROL = ((ushort)(0x004A));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_BOTTOM_CORNER_DISTORTION_BALANCE ((USAGE) 0x004C)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_BOTTOM_CORNER_DISTORTION_BALANCE = ((ushort)(0x004C));
    ...
    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_RED_VIDEO_BLACK_LEVEL ((USAGE) 0x006C)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_RED_VIDEO_BLACK_LEVEL = ((ushort)(0x006C));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_GREEN_VIDEO_BLACK_LEVEL ((USAGE) 0x006E)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_GREEN_VIDEO_BLACK_LEVEL = ((ushort)(0x006E));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_BLUE_VIDEO_BLACK_LEVEL ((USAGE) 0x0070)")]
    ...
    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_POLARITY_HORIZONTAL_SYNCHRONIZATION ((USAGE) 0x00A4)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_POLARITY_HORIZONTAL_SYNCHRONIZATION = ((ushort)(0x00A4));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_POLARITY_VERTICAL_SYNCHRONIZATION ((USAGE) 0x00A6)")]
    public const ushort HID_USAGE_VESA_VIRTUAL_CONTROLS_POLARITY_VERTICAL_SYNCHRONIZATION = ((ushort)(0x00A6));

    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_SYNCHRONIZATION_TYPE ((USAGE) 0x00A8)")]
    ...
    [NativeTypeName("#define HID_USAGE_VESA_VIRTUAL_CONTROLS_HORIZONTAL_FREQUENCY ((USAGE) 0x00AC)")]
