...
// Ported from shared/wtypes.h in the Windows SDK for Windows 10.0.28000.0
...
/// <include file='userHMETAFILE.xml' path='doc/member[@name="userHMETAFILE"]/*' />
public partial struct userHMETAFILE
{
    /// <include file='userHMETAFILE.xml' path='doc/member[@name="userHMETAFILE.fContext"]/*' />
    [NativeTypeName("LONG")]
    public int fContext;

    /// <include file='userHMETAFILE.xml' path='doc/member[@name="userHMETAFILE.u"]/*' />
    [NativeTypeName("union __MIDL_IWinTypes_0004")]
