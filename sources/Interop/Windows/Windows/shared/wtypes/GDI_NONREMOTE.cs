...
/// <include file='GDI_NONREMOTE.xml' path='doc/member[@name="GDI_NONREMOTE"]/*' />
public partial struct GDI_NONREMOTE
{
    /// <include file='GDI_NONREMOTE.xml' path='doc/member[@name="GDI_NONREMOTE.fContext"]/*' />
    [NativeTypeName("LONG")]
    public int fContext;

    /// <include file='GDI_NONREMOTE.xml' path='doc/member[@name="GDI_NONREMOTE.u"]/*' />
