...
public partial struct uCLSSPEC
{
    ...
    public unsafe partial struct _tagged_union_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/shared/wtypes.h:938:24)")]
        ...
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/shared/wtypes.h:943:24)")]
