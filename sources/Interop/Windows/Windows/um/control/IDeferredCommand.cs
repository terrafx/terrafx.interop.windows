...
public unsafe partial struct IDeferredCommand : IDeferredCommand.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDeferredCommand;
