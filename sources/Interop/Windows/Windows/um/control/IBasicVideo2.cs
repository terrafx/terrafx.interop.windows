...
public unsafe partial struct IBasicVideo2 : IBasicVideo2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IBasicVideo2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IBasicVideo2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
