...
public unsafe partial struct IMediaPosition : IMediaPosition.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMediaPosition;
