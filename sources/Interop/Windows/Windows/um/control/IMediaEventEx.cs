...
public unsafe partial struct IMediaEventEx : IMediaEventEx.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMediaEventEx*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IMediaEventEx*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
