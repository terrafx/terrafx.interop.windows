...
public unsafe partial struct IMFAsyncResult : IMFAsyncResult.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFAsyncResult;
