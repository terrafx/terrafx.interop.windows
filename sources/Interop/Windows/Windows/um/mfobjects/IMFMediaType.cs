...
public unsafe partial struct IMFMediaType : IMFMediaType.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMFMediaType*, Guid*, char*, uint, uint*, int>)(lpVtbl[12]))((IMFMediaType*)Unsafe.AsPointer(ref this), guidKey, pwszValue, cchBufSize, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFMediaType*, Guid*, char**, uint*, int>)(lpVtbl[13]))((IMFMediaType*)Unsafe.AsPointer(ref this), guidKey, ppwszValue, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFMediaType*, Guid*, char*, int>)(lpVtbl[25]))((IMFMediaType*)Unsafe.AsPointer(ref this), guidKey, wszValue);
    }
