...
public unsafe partial struct IMFVideoMediaType : IMFVideoMediaType.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMFVideoMediaType*, Guid*, char*, uint, uint*, int>)(lpVtbl[12]))((IMFVideoMediaType*)Unsafe.AsPointer(ref this), guidKey, pwszValue, cchBufSize, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFVideoMediaType*, Guid*, char**, uint*, int>)(lpVtbl[13]))((IMFVideoMediaType*)Unsafe.AsPointer(ref this), guidKey, ppwszValue, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFVideoMediaType*, Guid*, char*, int>)(lpVtbl[25]))((IMFVideoMediaType*)Unsafe.AsPointer(ref this), guidKey, wszValue);
    }
