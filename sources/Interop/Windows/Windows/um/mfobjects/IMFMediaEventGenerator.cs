...
public unsafe partial struct IMFMediaEventGenerator : IMFMediaEventGenerator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaEventGenerator;
