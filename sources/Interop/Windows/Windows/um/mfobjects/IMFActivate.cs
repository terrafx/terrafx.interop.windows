...
public unsafe partial struct IMFActivate : IMFActivate.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMFActivate*, Guid*, char*, uint, uint*, int>)(lpVtbl[12]))((IMFActivate*)Unsafe.AsPointer(ref this), guidKey, pwszValue, cchBufSize, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFActivate*, Guid*, char**, uint*, int>)(lpVtbl[13]))((IMFActivate*)Unsafe.AsPointer(ref this), guidKey, ppwszValue, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFActivate*, Guid*, char*, int>)(lpVtbl[25]))((IMFActivate*)Unsafe.AsPointer(ref this), guidKey, wszValue);
    }
