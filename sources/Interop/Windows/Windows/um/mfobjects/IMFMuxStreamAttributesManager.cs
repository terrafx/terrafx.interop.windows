...
public unsafe partial struct IMFMuxStreamAttributesManager : IMFMuxStreamAttributesManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMuxStreamAttributesManager;
