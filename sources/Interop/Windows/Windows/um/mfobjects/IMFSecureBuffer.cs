...
public unsafe partial struct IMFSecureBuffer : IMFSecureBuffer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSecureBuffer;
