...
public unsafe partial struct IMFMuxStreamSampleManager : IMFMuxStreamSampleManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMuxStreamSampleManager;
