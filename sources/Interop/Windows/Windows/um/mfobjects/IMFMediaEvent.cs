...
public unsafe partial struct IMFMediaEvent : IMFMediaEvent.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMFMediaEvent*, Guid*, char*, uint, uint*, int>)(lpVtbl[12]))((IMFMediaEvent*)Unsafe.AsPointer(ref this), guidKey, pwszValue, cchBufSize, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFMediaEvent*, Guid*, char**, uint*, int>)(lpVtbl[13]))((IMFMediaEvent*)Unsafe.AsPointer(ref this), guidKey, ppwszValue, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFMediaEvent*, Guid*, char*, int>)(lpVtbl[25]))((IMFMediaEvent*)Unsafe.AsPointer(ref this), guidKey, wszValue);
    }
