...
public unsafe partial struct IAudioEndpointVolumeEx : IAudioEndpointVolumeEx.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioEndpointVolumeEx;
