...
public unsafe partial struct IAudioEndpointVolume : IAudioEndpointVolume.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioEndpointVolume;
