...
using static TerraFX.Interop.Windows.D2D1_BORDER_MODE;
using static TerraFX.Interop.Windows.D2D1_CAP_STYLE;
using static TerraFX.Interop.Windows.D2D1_COLOR_SPACE;
using static TerraFX.Interop.Windows.D2D1_DASH_STYLE;
using static TerraFX.Interop.Windows.D2D1_DPICOMPENSATION_PROP;
using static TerraFX.Interop.Windows.D2D1_EXTEND_MODE;
using static TerraFX.Interop.Windows.D2D1_INTERPOLATION_MODE;
using static TerraFX.Interop.Windows.D2D1_LAYER_OPTIONS1;
using static TerraFX.Interop.Windows.D2D1_LINE_JOIN;
using static TerraFX.Interop.Windows.D2D1_PRIMITIVE_BLEND;
using static TerraFX.Interop.Windows.D2D1_PRINT_FONT_SUBSET_MODE;
using static TerraFX.Interop.Windows.D2D1_STROKE_TRANSFORM_TYPE;
using static TerraFX.Interop.Windows.D2D1_TEXT_ANTIALIAS_MODE;
using static TerraFX.Interop.Windows.D2D1_UNIT_MODE;
...
namespace TerraFX.Interop.Windows
{
    public static unsafe partial class Windows
    {
        ...
        public static D2D1_BITMAP_PROPERTIES1 BitmapProperties1(D2D1_BITMAP_OPTIONS bitmapOptions = D2D1_BITMAP_OPTIONS_NONE, [NativeTypeName("const D2D1_PIXEL_FORMAT")] D2D1_PIXEL_FORMAT pixelFormat = default, float dpiX = 96.0f, float dpiY = 96.0f, ID2D1ColorContext *colorContext = null)
        {
        ...
        public static D2D1_PRINT_CONTROL_PROPERTIES PrintControlProperties(D2D1_PRINT_FONT_SUBSET_MODE fontSubsetMode = D2D1_PRINT_FONT_SUBSET_MODE_DEFAULT, float rasterDpi = 150.0f, D2D1_COLOR_SPACE colorSpace = D2D1_COLOR_SPACE_SRGB)
        {
        ...
        public static D2D_VECTOR_2F Vector2F(float x = 0.0f, float y = 0.0f)
        {
        ...
        [return: NativeTypeName("D2D1_VECTOR_2F")]
        public static D2D_VECTOR_3F Vector3F(float x = 0.0f, float y = 0.0f, float z = 0.0f)
        {
        ...
        [return: NativeTypeName("D2D1_VECTOR_2F")]
        public static D2D_VECTOR_4F Vector4F(float x = 0.0f, float y = 0.0f, float z = 0.0f, float w = 0.0f)
        {
