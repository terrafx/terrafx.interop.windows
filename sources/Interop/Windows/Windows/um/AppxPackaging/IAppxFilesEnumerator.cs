...
public unsafe partial struct IAppxFilesEnumerator : IAppxFilesEnumerator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxFilesEnumerator;
