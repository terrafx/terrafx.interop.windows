...
public unsafe partial struct IAppxBundleFactory : IAppxBundleFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxBundleFactory;
