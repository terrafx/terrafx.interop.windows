...
public unsafe partial struct IAppxContentGroupMapWriter : IAppxContentGroupMapWriter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxContentGroupMapWriter;
