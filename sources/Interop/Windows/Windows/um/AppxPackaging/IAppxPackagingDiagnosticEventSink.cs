...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAppxPackagingDiagnosticEventSink);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxPackagingDiagnosticEventSink*, Guid*, void**, int>)(lpVtbl[0]))((IAppxPackagingDiagnosticEventSink*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxPackagingDiagnosticEventSink*, uint>)(lpVtbl[1]))((IAppxPackagingDiagnosticEventSink*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxPackagingDiagnosticEventSink*, uint>)(lpVtbl[2]))((IAppxPackagingDiagnosticEventSink*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxPackagingDiagnosticEventSink*, APPX_PACKAGING_CONTEXT_CHANGE_TYPE, int, sbyte*, char*, char*, int>)(lpVtbl[3]))((IAppxPackagingDiagnosticEventSink*)Unsafe.AsPointer(ref this), changeType, contextId, contextName, contextMessage, detailsMessage);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxPackagingDiagnosticEventSink*, char*, int>)(lpVtbl[4]))((IAppxPackagingDiagnosticEventSink*)Unsafe.AsPointer(ref this), errorMessage);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, APPX_PACKAGING_CONTEXT_CHANGE_TYPE, int, sbyte*, char*, char*, int> ReportContextChange;

        [NativeTypeName("HRESULT (LPCWSTR) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, int> ReportError;
    }
}
