...
public unsafe partial struct IAppxBundleReader : IAppxBundleReader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxBundleReader;
