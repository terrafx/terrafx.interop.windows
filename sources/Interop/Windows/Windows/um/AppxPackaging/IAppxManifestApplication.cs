...
public unsafe partial struct IAppxManifestApplication : IAppxManifestApplication.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxManifestApplication;
