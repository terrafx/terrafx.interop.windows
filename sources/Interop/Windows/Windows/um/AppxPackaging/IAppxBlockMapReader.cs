...
public unsafe partial struct IAppxBlockMapReader : IAppxBlockMapReader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxBlockMapReader;
