...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAppxEncryptionFactory);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, Guid*, void**, int>)(lpVtbl[0]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, uint>)(lpVtbl[1]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, uint>)(lpVtbl[2]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, IStream*, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, int>)(lpVtbl[3]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), inputStream, outputStream, settings, keyInfo, exemptedFiles);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, IStream*, APPX_KEY_INFO*, int>)(lpVtbl[4]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), inputStream, outputStream, keyInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, IStream*, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, IAppxEncryptedPackageWriter**, int>)(lpVtbl[5]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), outputStream, manifestStream, settings, keyInfo, exemptedFiles, packageWriter);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, APPX_KEY_INFO*, IAppxPackageReader**, int>)(lpVtbl[6]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), inputStream, keyInfo, packageReader);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, IStream*, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, int>)(lpVtbl[7]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), inputStream, outputStream, settings, keyInfo, exemptedFiles);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, IStream*, APPX_KEY_INFO*, int>)(lpVtbl[8]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), inputStream, outputStream, keyInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, ulong, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, IAppxEncryptedBundleWriter**, int>)(lpVtbl[9]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), outputStream, bundleVersion, settings, keyInfo, exemptedFiles, bundleWriter);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxEncryptionFactory*, IStream*, APPX_KEY_INFO*, IAppxBundleReader**, int>)(lpVtbl[10]))((IAppxEncryptionFactory*)Unsafe.AsPointer(ref this), inputStream, keyInfo, bundleReader);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, IStream*, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, int> EncryptPackage;

        [NativeTypeName("HRESULT (IStream *, IStream *, const APPX_KEY_INFO *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, IStream*, APPX_KEY_INFO*, int> DecryptPackage;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, IStream*, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, IAppxEncryptedPackageWriter**, int> CreateEncryptedPackageWriter;

        [NativeTypeName("HRESULT (IStream *, const APPX_KEY_INFO *, IAppxPackageReader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, APPX_KEY_INFO*, IAppxPackageReader**, int> CreateEncryptedPackageReader;

        [NativeTypeName("HRESULT (IStream *, IStream *, const APPX_ENCRYPTED_PACKAGE_SETTINGS *, const APPX_KEY_INFO *, const APPX_ENCRYPTED_EXEMPTIONS *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, IStream*, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, int> EncryptBundle;

        [NativeTypeName("HRESULT (IStream *, IStream *, const APPX_KEY_INFO *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, IStream*, APPX_KEY_INFO*, int> DecryptBundle;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, ulong, APPX_ENCRYPTED_PACKAGE_SETTINGS*, APPX_KEY_INFO*, APPX_ENCRYPTED_EXEMPTIONS*, IAppxEncryptedBundleWriter**, int> CreateEncryptedBundleWriter;

        [NativeTypeName("HRESULT (IStream *, const APPX_KEY_INFO *, IAppxBundleReader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, APPX_KEY_INFO*, IAppxBundleReader**, int> CreateEncryptedBundleReader;
    }
}
