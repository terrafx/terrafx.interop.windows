...
public unsafe partial struct IAppxEncryptionFactory : IAppxEncryptionFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxEncryptionFactory;
