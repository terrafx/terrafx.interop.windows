...
public unsafe partial struct IAppxPackageWriter : IAppxPackageWriter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxPackageWriter;
