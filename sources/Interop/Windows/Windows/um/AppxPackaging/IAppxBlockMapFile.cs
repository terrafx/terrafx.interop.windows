...
public unsafe partial struct IAppxBlockMapFile : IAppxBlockMapFile.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxBlockMapFile;
