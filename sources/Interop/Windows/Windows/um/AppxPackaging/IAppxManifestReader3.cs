...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAppxManifestReader3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, Guid*, void**, int>)(lpVtbl[0]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, uint>)(lpVtbl[1]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, uint>)(lpVtbl[2]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestPackageId**, int>)(lpVtbl[3]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), packageId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestProperties**, int>)(lpVtbl[4]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), packageProperties);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestPackageDependenciesEnumerator**, int>)(lpVtbl[5]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), dependencies);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, APPX_CAPABILITIES*, int>)(lpVtbl[6]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), capabilities);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestResourcesEnumerator**, int>)(lpVtbl[7]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), resources);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestDeviceCapabilitiesEnumerator**, int>)(lpVtbl[8]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), deviceCapabilities);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, char*, ulong*, int>)(lpVtbl[9]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), name, value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestApplicationsEnumerator**, int>)(lpVtbl[10]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), applications);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IStream**, int>)(lpVtbl[11]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), manifestStream);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestQualifiedResourcesEnumerator**, int>)(lpVtbl[12]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), resources);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, APPX_CAPABILITY_CLASS_TYPE, IAppxManifestCapabilitiesEnumerator**, int>)(lpVtbl[13]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), capabilityClass, capabilities);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAppxManifestReader3*, IAppxManifestTargetDeviceFamiliesEnumerator**, int>)(lpVtbl[14]))((IAppxManifestReader3*)Unsafe.AsPointer(ref this), targetDeviceFamilies);
    }
