...
public unsafe partial struct IAppxManifestProperties : IAppxManifestProperties.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxManifestProperties;
