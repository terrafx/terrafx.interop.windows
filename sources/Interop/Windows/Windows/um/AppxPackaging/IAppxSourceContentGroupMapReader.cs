...
public unsafe partial struct IAppxSourceContentGroupMapReader : IAppxSourceContentGroupMapReader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxSourceContentGroupMapReader;
