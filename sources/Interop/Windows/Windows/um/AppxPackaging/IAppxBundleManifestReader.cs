...
public unsafe partial struct IAppxBundleManifestReader : IAppxBundleManifestReader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxBundleManifestReader;
