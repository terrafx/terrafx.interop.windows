...
public unsafe partial struct IAppxBundleWriter : IAppxBundleWriter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxBundleWriter;
