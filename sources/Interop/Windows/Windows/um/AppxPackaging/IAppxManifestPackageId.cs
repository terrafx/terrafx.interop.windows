...
public unsafe partial struct IAppxManifestPackageId : IAppxManifestPackageId.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxManifestPackageId;
