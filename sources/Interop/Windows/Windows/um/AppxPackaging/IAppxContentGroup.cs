...
public unsafe partial struct IAppxContentGroup : IAppxContentGroup.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxContentGroup;
