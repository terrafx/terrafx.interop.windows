...
public unsafe partial struct IAppxEncryptedPackageWriter : IAppxEncryptedPackageWriter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppxEncryptedPackageWriter;
