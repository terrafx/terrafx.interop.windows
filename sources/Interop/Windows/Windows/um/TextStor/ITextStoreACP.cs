...
// Ported from um/TextStor.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ITextStoreACP);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, Guid*, void**, int>)(lpVtbl[0]))((ITextStoreACP*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint>)(lpVtbl[1]))((ITextStoreACP*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint>)(lpVtbl[2]))((ITextStoreACP*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, Guid*, IUnknown*, uint, int>)(lpVtbl[3]))((ITextStoreACP*)Unsafe.AsPointer(ref this), riid, punk, dwMask);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, IUnknown*, int>)(lpVtbl[4]))((ITextStoreACP*)Unsafe.AsPointer(ref this), punk);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, HRESULT*, int>)(lpVtbl[5]))((ITextStoreACP*)Unsafe.AsPointer(ref this), dwLockFlags, phrSession);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, TS_STATUS*, int>)(lpVtbl[6]))((ITextStoreACP*)Unsafe.AsPointer(ref this), pdcs);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int, int, uint, int*, int*, int>)(lpVtbl[7]))((ITextStoreACP*)Unsafe.AsPointer(ref this), acpTestStart, acpTestEnd, cch, pacpResultStart, pacpResultEnd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, uint, TS_SELECTION_ACP*, uint*, int>)(lpVtbl[8]))((ITextStoreACP*)Unsafe.AsPointer(ref this), ulIndex, ulCount, pSelection, pcFetched);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, TS_SELECTION_ACP*, int>)(lpVtbl[9]))((ITextStoreACP*)Unsafe.AsPointer(ref this), ulCount, pSelection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int, int, char*, uint, uint*, TS_RUNINFO*, uint, uint*, int*, int>)(lpVtbl[10]))((ITextStoreACP*)Unsafe.AsPointer(ref this), acpStart, acpEnd, pchPlain, cchPlainReq, pcchPlainRet, prgRunInfo, cRunInfoReq, pcRunInfoRet, pacpNext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, int, int, char*, uint, TS_TEXTCHANGE*, int>)(lpVtbl[11]))((ITextStoreACP*)Unsafe.AsPointer(ref this), dwFlags, acpStart, acpEnd, pchText, cch, pChange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int, int, IDataObject**, int>)(lpVtbl[12]))((ITextStoreACP*)Unsafe.AsPointer(ref this), acpStart, acpEnd, ppDataObject);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int, Guid*, Guid*, IUnknown**, int>)(lpVtbl[13]))((ITextStoreACP*)Unsafe.AsPointer(ref this), acpPos, rguidService, riid, ppunk);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, Guid*, FORMATETC*, BOOL*, int>)(lpVtbl[14]))((ITextStoreACP*)Unsafe.AsPointer(ref this), pguidService, pFormatEtc, pfInsertable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, int, int, IDataObject*, TS_TEXTCHANGE*, int>)(lpVtbl[15]))((ITextStoreACP*)Unsafe.AsPointer(ref this), dwFlags, acpStart, acpEnd, pDataObject, pChange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, char*, uint, int*, int*, TS_TEXTCHANGE*, int>)(lpVtbl[16]))((ITextStoreACP*)Unsafe.AsPointer(ref this), dwFlags, pchText, cch, pacpStart, pacpEnd, pChange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, IDataObject*, int*, int*, TS_TEXTCHANGE*, int>)(lpVtbl[17]))((ITextStoreACP*)Unsafe.AsPointer(ref this), dwFlags, pDataObject, pacpStart, pacpEnd, pChange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, uint, Guid*, int>)(lpVtbl[18]))((ITextStoreACP*)Unsafe.AsPointer(ref this), dwFlags, cFilterAttrs, paFilterAttrs);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int, uint, Guid*, uint, int>)(lpVtbl[19]))((ITextStoreACP*)Unsafe.AsPointer(ref this), acpPos, cFilterAttrs, paFilterAttrs, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int, uint, Guid*, uint, int>)(lpVtbl[20]))((ITextStoreACP*)Unsafe.AsPointer(ref this), acpPos, cFilterAttrs, paFilterAttrs, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int, int, uint, Guid*, uint, int*, BOOL*, int*, int>)(lpVtbl[21]))((ITextStoreACP*)Unsafe.AsPointer(ref this), acpStart, acpHalt, cFilterAttrs, paFilterAttrs, dwFlags, pacpNext, pfFound, plFoundOffset);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, TS_ATTRVAL*, uint*, int>)(lpVtbl[22]))((ITextStoreACP*)Unsafe.AsPointer(ref this), ulCount, paAttrVals, pcFetched);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, int*, int>)(lpVtbl[23]))((ITextStoreACP*)Unsafe.AsPointer(ref this), pacp);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint*, int>)(lpVtbl[24]))((ITextStoreACP*)Unsafe.AsPointer(ref this), pvcView);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, POINT*, uint, int*, int>)(lpVtbl[25]))((ITextStoreACP*)Unsafe.AsPointer(ref this), vcView, ptScreen, dwFlags, pacp);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, int, int, RECT*, BOOL*, int>)(lpVtbl[26]))((ITextStoreACP*)Unsafe.AsPointer(ref this), vcView, acpStart, acpEnd, prc, pfClipped);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, RECT*, int>)(lpVtbl[27]))((ITextStoreACP*)Unsafe.AsPointer(ref this), vcView, prc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITextStoreACP*, uint, HWND*, int>)(lpVtbl[28]))((ITextStoreACP*)Unsafe.AsPointer(ref this), vcView, phwnd);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int, uint, int*, int*, int> QueryInsert;

        [NativeTypeName("HRESULT (ULONG, ULONG, TS_SELECTION_ACP *, ULONG *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, uint, TS_SELECTION_ACP*, uint*, int> GetSelection;

        [NativeTypeName("HRESULT (ULONG, const TS_SELECTION_ACP *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, TS_SELECTION_ACP*, int> SetSelection;

        [NativeTypeName("HRESULT (LONG, LONG, WCHAR *, ULONG, ULONG *, TS_RUNINFO *, ULONG, ULONG *, LONG *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int, char*, uint, uint*, TS_RUNINFO*, uint, uint*, int*, int> GetText;

        [NativeTypeName("HRESULT (DWORD, LONG, LONG, const WCHAR *, ULONG, TS_TEXTCHANGE *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, int, int, char*, uint, TS_TEXTCHANGE*, int> SetText;

        [NativeTypeName("HRESULT (LONG, LONG, IDataObject **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int, IDataObject**, int> GetFormattedText;

        [NativeTypeName("HRESULT (LONG, const GUID &, const IID &, IUnknown **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, Guid*, Guid*, IUnknown**, int> GetEmbedded;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, int, int, IDataObject*, TS_TEXTCHANGE*, int> InsertEmbedded;

        [NativeTypeName("HRESULT (DWORD, const WCHAR *, ULONG, LONG *, LONG *, TS_TEXTCHANGE *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, char*, uint, int*, int*, TS_TEXTCHANGE*, int> InsertTextAtSelection;

        [NativeTypeName("HRESULT (DWORD, IDataObject *, LONG *, LONG *, TS_TEXTCHANGE *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, IDataObject*, int*, int*, TS_TEXTCHANGE*, int> InsertEmbeddedAtSelection;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, int, uint, Guid*, uint, int> RequestAttrsAtPosition;

        [NativeTypeName("HRESULT (LONG, ULONG, const TS_ATTRID *, DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, uint, Guid*, uint, int> RequestAttrsTransitioningAtPosition;

        [NativeTypeName("HRESULT (LONG, LONG, ULONG, const TS_ATTRID *, DWORD, LONG *, BOOL *, LONG *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int, uint, Guid*, uint, int*, BOOL*, int*, int> FindNextAttrTransition;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, int*, int> GetEndACP;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, POINT*, uint, int*, int> GetACPFromPoint;

        [NativeTypeName("HRESULT (TsViewCookie, LONG, LONG, RECT *, BOOL *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, int, int, RECT*, BOOL*, int> GetTextExt;
