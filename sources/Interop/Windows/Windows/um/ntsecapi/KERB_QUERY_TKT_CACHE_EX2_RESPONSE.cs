...
/// <include file='KERB_QUERY_TKT_CACHE_EX2_RESPONSE.xml' path='doc/member[@name="KERB_QUERY_TKT_CACHE_EX2_RESPONSE"]/*' />
public partial struct KERB_QUERY_TKT_CACHE_EX2_RESPONSE
{
    /// <include file='KERB_QUERY_TKT_CACHE_EX2_RESPONSE.xml' path='doc/member[@name="KERB_QUERY_TKT_CACHE_EX2_RESPONSE.MessageType"]/*' />
    public KERB_PROTOCOL_MESSAGE_TYPE MessageType;

    /// <include file='KERB_QUERY_TKT_CACHE_EX2_RESPONSE.xml' path='doc/member[@name="KERB_QUERY_TKT_CACHE_EX2_RESPONSE.CountOfTickets"]/*' />
