...
public static partial class DEVICEFAMILYDEVICEFORM
{
    ...
    [NativeTypeName("#define DEVICEFAMILYDEVICEFORM_GAMING_HANDHELD 0x0000002E")]
    public const int DEVICEFAMILYDEVICEFORM_GAMING_HANDHELD = 0x0000002E;

    [NativeTypeName("#define DEVICEFAMILYDEVICEFORM_GAMING_CONSOLE 0x0000002F")]
    public const int DEVICEFAMILYDEVICEFORM_GAMING_CONSOLE = 0x0000002F;

    [NativeTypeName("#define DEVICEFAMILYDEVICEFORM_MAX 0x0000002F")]
    public const int DEVICEFAMILYDEVICEFORM_MAX = 0x0000002F;
}
