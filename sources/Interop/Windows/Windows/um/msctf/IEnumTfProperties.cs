...
public unsafe partial struct IEnumTfProperties : IEnumTfProperties.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumTfProperties;
