...
public unsafe partial struct ITfThreadMgrEx : ITfThreadMgrEx.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfThreadMgrEx;
