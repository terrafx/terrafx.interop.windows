...
public unsafe partial struct ITfDisplayAttributeProvider : ITfDisplayAttributeProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfDisplayAttributeProvider;
