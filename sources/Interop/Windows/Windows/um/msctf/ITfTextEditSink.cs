...
public unsafe partial struct ITfTextEditSink : ITfTextEditSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfTextEditSink;
