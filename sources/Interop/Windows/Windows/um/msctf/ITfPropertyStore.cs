...
public unsafe partial struct ITfPropertyStore : ITfPropertyStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfPropertyStore;
