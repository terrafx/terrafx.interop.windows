...
public unsafe partial struct ITfTransitoryExtensionSink : ITfTransitoryExtensionSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfTransitoryExtensionSink;
