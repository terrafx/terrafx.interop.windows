...
public unsafe partial struct ITfContextKeyEventSink : ITfContextKeyEventSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfContextKeyEventSink;
