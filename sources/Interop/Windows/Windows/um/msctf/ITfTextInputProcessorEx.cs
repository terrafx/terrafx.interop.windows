...
public unsafe partial struct ITfTextInputProcessorEx : ITfTextInputProcessorEx.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfTextInputProcessorEx;
