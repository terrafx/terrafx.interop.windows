...
public unsafe partial struct ITfContextOwnerServices : ITfContextOwnerServices.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfContextOwnerServices;
