...
public unsafe partial struct ITfDisplayAttributeInfo : ITfDisplayAttributeInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfDisplayAttributeInfo;
