...
public unsafe partial struct ITfUIElementMgr : ITfUIElementMgr.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfUIElementMgr;
