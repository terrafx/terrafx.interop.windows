...
public unsafe partial struct ITfMouseTracker : ITfMouseTracker.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfMouseTracker;
