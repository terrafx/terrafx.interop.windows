...
public unsafe partial struct IEnumTfPropertyValue : IEnumTfPropertyValue.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumTfPropertyValue;
