...
public unsafe partial struct IEnumTfDocumentMgrs : IEnumTfDocumentMgrs.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumTfDocumentMgrs;
