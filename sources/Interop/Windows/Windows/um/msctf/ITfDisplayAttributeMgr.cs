...
public unsafe partial struct ITfDisplayAttributeMgr : ITfDisplayAttributeMgr.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfDisplayAttributeMgr;
