...
public unsafe partial struct ITfCreatePropertyStore : ITfCreatePropertyStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfCreatePropertyStore;
