...
public unsafe partial struct IEnumTfUIElements : IEnumTfUIElements.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumTfUIElements;
