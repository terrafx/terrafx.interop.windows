...
public unsafe partial struct ITfCategoryMgr : ITfCategoryMgr.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfCategoryMgr;
