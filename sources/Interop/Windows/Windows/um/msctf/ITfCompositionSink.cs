...
public unsafe partial struct ITfCompositionSink : ITfCompositionSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfCompositionSink;
