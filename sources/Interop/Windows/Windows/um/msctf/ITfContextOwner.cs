...
public unsafe partial struct ITfContextOwner : ITfContextOwner.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfContextOwner;
