...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ITfContextOwner);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, Guid*, void**, int>)(lpVtbl[0]))((ITfContextOwner*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, uint>)(lpVtbl[1]))((ITfContextOwner*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, uint>)(lpVtbl[2]))((ITfContextOwner*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, POINT*, uint, int*, int>)(lpVtbl[3]))((ITfContextOwner*)Unsafe.AsPointer(ref this), ptScreen, dwFlags, pacp);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, int, int, RECT*, BOOL*, int>)(lpVtbl[4]))((ITfContextOwner*)Unsafe.AsPointer(ref this), acpStart, acpEnd, prc, pfClipped);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, RECT*, int>)(lpVtbl[5]))((ITfContextOwner*)Unsafe.AsPointer(ref this), prc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, TS_STATUS*, int>)(lpVtbl[6]))((ITfContextOwner*)Unsafe.AsPointer(ref this), pdcs);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, HWND*, int>)(lpVtbl[7]))((ITfContextOwner*)Unsafe.AsPointer(ref this), phwnd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfContextOwner*, Guid*, VARIANT*, int>)(lpVtbl[8]))((ITfContextOwner*)Unsafe.AsPointer(ref this), rguidAttribute, pvarValue);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, POINT*, uint, int*, int> GetACPFromPoint;

        [NativeTypeName("HRESULT (LONG, LONG, RECT *, BOOL *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int, RECT*, BOOL*, int> GetTextExt;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, VARIANT*, int> GetAttribute;
    }
}
