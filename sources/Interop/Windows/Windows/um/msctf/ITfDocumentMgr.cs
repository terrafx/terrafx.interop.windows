...
public unsafe partial struct ITfDocumentMgr : ITfDocumentMgr.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfDocumentMgr;
