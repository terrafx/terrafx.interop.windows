...
public unsafe partial struct ITfCompartmentEventSink : ITfCompartmentEventSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfCompartmentEventSink;
