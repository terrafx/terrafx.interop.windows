...
public unsafe partial struct ITfFunctionProvider : ITfFunctionProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfFunctionProvider;
