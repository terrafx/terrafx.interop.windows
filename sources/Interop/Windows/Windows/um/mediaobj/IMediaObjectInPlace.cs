...
public unsafe partial struct IMediaObjectInPlace : IMediaObjectInPlace.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMediaObjectInPlace;
