...
public unsafe partial struct IRendezvousApplication : IRendezvousApplication.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IRendezvousApplication;
