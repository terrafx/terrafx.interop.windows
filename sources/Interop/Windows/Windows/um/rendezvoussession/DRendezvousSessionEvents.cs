...
public unsafe partial struct DRendezvousSessionEvents : DRendezvousSessionEvents.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DRendezvousSessionEvents*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DRendezvousSessionEvents*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
