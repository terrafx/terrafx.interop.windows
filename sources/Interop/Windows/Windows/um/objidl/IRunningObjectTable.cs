...
public unsafe partial struct IRunningObjectTable : IRunningObjectTable.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IRunningObjectTable;
