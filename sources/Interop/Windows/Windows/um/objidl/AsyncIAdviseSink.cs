...
public unsafe partial struct AsyncIAdviseSink : AsyncIAdviseSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_AsyncIAdviseSink;
