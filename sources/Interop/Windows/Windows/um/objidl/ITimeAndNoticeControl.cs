...
public unsafe partial struct ITimeAndNoticeControl : ITimeAndNoticeControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITimeAndNoticeControl;
