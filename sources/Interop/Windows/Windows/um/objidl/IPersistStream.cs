...
public unsafe partial struct IPersistStream : IPersistStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPersistStream;
