...
public unsafe partial struct IMessageFilter : IMessageFilter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMessageFilter;
