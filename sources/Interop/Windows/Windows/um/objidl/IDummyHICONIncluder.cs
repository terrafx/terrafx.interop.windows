...
public unsafe partial struct IDummyHICONIncluder : IDummyHICONIncluder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDummyHICONIncluder;
