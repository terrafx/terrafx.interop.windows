...
public unsafe partial struct IClassActivator : IClassActivator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IClassActivator;
