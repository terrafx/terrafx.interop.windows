...
public unsafe partial struct IForegroundTransfer : IForegroundTransfer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IForegroundTransfer;
