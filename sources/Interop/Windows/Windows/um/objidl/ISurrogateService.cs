...
public unsafe partial struct ISurrogateService : ISurrogateService.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISurrogateService;
