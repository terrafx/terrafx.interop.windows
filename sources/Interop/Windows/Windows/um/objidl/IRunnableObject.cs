...
public unsafe partial struct IRunnableObject : IRunnableObject.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IRunnableObject;
