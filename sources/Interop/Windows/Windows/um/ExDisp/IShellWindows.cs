...
public unsafe partial struct IShellWindows : IShellWindows.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IShellWindows*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IShellWindows*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
