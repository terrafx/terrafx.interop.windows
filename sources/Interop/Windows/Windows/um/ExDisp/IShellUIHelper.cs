...
public unsafe partial struct IShellUIHelper : IShellUIHelper.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellUIHelper;
