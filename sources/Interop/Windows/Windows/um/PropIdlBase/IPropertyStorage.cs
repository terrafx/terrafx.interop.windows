...
public unsafe partial struct IPropertyStorage : IPropertyStorage.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyStorage;
