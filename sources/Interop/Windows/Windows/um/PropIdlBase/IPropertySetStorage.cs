...
public unsafe partial struct IPropertySetStorage : IPropertySetStorage.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertySetStorage;
