...
public unsafe partial struct IEnumSTATPROPSTG : IEnumSTATPROPSTG.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumSTATPROPSTG;
