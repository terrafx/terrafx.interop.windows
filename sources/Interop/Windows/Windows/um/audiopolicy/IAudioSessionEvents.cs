...
public unsafe partial struct IAudioSessionEvents : IAudioSessionEvents.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioSessionEvents;
