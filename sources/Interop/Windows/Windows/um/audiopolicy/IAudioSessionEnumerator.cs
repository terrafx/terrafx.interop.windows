...
public unsafe partial struct IAudioSessionEnumerator : IAudioSessionEnumerator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioSessionEnumerator;
