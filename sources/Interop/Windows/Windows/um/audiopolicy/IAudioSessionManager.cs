...
public unsafe partial struct IAudioSessionManager : IAudioSessionManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioSessionManager;
