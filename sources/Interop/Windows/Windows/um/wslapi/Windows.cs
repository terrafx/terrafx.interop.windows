...
// Ported from um/wslapi.h in the Windows SDK for Windows 10.0.28000.0
...
public static unsafe partial class Windows
{
    ...
    public static extern BOOL WslIsDistributionRegistered([NativeTypeName("PCWSTR")] char* distributionName);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.WslRegisterDistribution"]/*' />
    [DllImport("api-ms-win-wsl-api-l1-1-0", ExactSpelling = true)]
    public static extern HRESULT WslRegisterDistribution([NativeTypeName("PCWSTR")] char* distributionName, [NativeTypeName("PCWSTR")] char* tarGzFilename);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.WslUnregisterDistribution"]/*' />
    [DllImport("api-ms-win-wsl-api-l1-1-0", ExactSpelling = true)]
    public static extern HRESULT WslUnregisterDistribution([NativeTypeName("PCWSTR")] char* distributionName);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.WslConfigureDistribution"]/*' />
    [DllImport("api-ms-win-wsl-api-l1-1-0", ExactSpelling = true)]
    public static extern HRESULT WslConfigureDistribution([NativeTypeName("PCWSTR")] char* distributionName, [NativeTypeName("ULONG")] uint defaultUID, WSL_DISTRIBUTION_FLAGS wslDistributionFlags);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.WslGetDistributionConfiguration"]/*' />
    [DllImport("api-ms-win-wsl-api-l1-1-0", ExactSpelling = true)]
    public static extern HRESULT WslGetDistributionConfiguration([NativeTypeName("PCWSTR")] char* distributionName, [NativeTypeName("ULONG *")] uint* distributionVersion, [NativeTypeName("ULONG *")] uint* defaultUID, WSL_DISTRIBUTION_FLAGS* wslDistributionFlags, [NativeTypeName("PSTR **")] sbyte*** defaultEnvironmentVariables, [NativeTypeName("ULONG *")] uint* defaultEnvironmentVariableCount);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.WslLaunchInteractive"]/*' />
    [DllImport("api-ms-win-wsl-api-l1-1-0", ExactSpelling = true)]
    public static extern HRESULT WslLaunchInteractive([NativeTypeName("PCWSTR")] char* distributionName, [NativeTypeName("PCWSTR")] char* command, BOOL useCurrentWorkingDirectory, [NativeTypeName("DWORD *")] uint* exitCode);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.WslLaunch"]/*' />
    [DllImport("api-ms-win-wsl-api-l1-1-0", ExactSpelling = true)]
    public static extern HRESULT WslLaunch([NativeTypeName("PCWSTR")] char* distributionName, [NativeTypeName("PCWSTR")] char* command, BOOL useCurrentWorkingDirectory, HANDLE stdIn, HANDLE stdOut, HANDLE stdErr, HANDLE* process);
