...
public unsafe partial struct IGlobalOptions : IGlobalOptions.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IGlobalOptions;
