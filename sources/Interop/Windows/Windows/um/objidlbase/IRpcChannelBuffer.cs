...
public unsafe partial struct IRpcChannelBuffer : IRpcChannelBuffer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IRpcChannelBuffer;
