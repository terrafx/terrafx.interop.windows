...
public unsafe partial struct IAddrExclusionControl : IAddrExclusionControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAddrExclusionControl;
