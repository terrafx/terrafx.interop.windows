...
public unsafe partial struct IStdMarshalInfo : IStdMarshalInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IStdMarshalInfo;
