...
public unsafe partial struct IRpcSyntaxNegotiate : IRpcSyntaxNegotiate.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IRpcSyntaxNegotiate;
