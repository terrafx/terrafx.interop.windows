...
public unsafe partial struct ISynchronizeContainer : ISynchronizeContainer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISynchronizeContainer;
