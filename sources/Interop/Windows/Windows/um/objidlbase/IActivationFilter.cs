...
public unsafe partial struct IActivationFilter : IActivationFilter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IActivationFilter;
