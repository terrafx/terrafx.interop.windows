...
public unsafe partial struct IComThreadingInfo : IComThreadingInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IComThreadingInfo;
