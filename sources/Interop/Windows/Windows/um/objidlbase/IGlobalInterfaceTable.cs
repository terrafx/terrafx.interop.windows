...
public unsafe partial struct IGlobalInterfaceTable : IGlobalInterfaceTable.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IGlobalInterfaceTable;
