...
public unsafe partial struct IMarshalingStream : IMarshalingStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMarshalingStream;
