...
public unsafe partial struct AsyncIPipeByte : AsyncIPipeByte.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_AsyncIPipeByte;
