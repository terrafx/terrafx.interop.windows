...
// Ported from um/objidlbase.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IRpcChannelBuffer3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, Guid*, void**, int>)(lpVtbl[0]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, uint>)(lpVtbl[1]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, uint>)(lpVtbl[2]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, Guid*, int>)(lpVtbl[3]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMessage, riid);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, uint*, int>)(lpVtbl[4]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMessage, pStatus);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, int>)(lpVtbl[5]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMessage);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, uint*, void**, int>)(lpVtbl[6]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pdwDestContext, ppvDestContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, int>)(lpVtbl[7]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, uint*, int>)(lpVtbl[8]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pdwVersion);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, uint*, int>)(lpVtbl[9]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMsg, pulStatus);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, uint, uint*, int>)(lpVtbl[10]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMsg, ulSize, pulStatus);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, int>)(lpVtbl[11]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMsg);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, Guid*, void**, int>)(lpVtbl[12]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMsg, riid, pInterface);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, uint*, void**, int>)(lpVtbl[13]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMsg, pdwDestContext, ppvDestContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, uint*, int>)(lpVtbl[14]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMsg, pState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRpcChannelBuffer3*, RPCOLEMESSAGE*, IAsyncManager*, int>)(lpVtbl[15]))((IRpcChannelBuffer3*)Unsafe.AsPointer(ref this), pMsg, pAsyncMgr);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName("HRESULT (RPCOLEMESSAGE *, ULONG *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, RPCOLEMESSAGE*, uint*, int> Send;

        [NativeTypeName("HRESULT (RPCOLEMESSAGE *, ULONG, ULONG *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, RPCOLEMESSAGE*, uint, uint*, int> Receive;

        [NativeTypeName("HRESULT (RPCOLEMESSAGE *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, RPCOLEMESSAGE*, int> Cancel;

        [NativeTypeName("HRESULT (RPCOLEMESSAGE *, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, RPCOLEMESSAGE*, Guid*, void**, int> GetCallContext;

        [NativeTypeName("HRESULT (RPCOLEMESSAGE *, DWORD *, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, RPCOLEMESSAGE*, uint*, void**, int> GetDestCtxEx;

        [NativeTypeName("HRESULT (RPCOLEMESSAGE *, DWORD *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, RPCOLEMESSAGE*, uint*, int> GetState;

        [NativeTypeName("HRESULT (RPCOLEMESSAGE *, IAsyncManager *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, RPCOLEMESSAGE*, IAsyncManager*, int> RegisterAsync;
    }
}
