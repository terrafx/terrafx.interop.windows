...
public unsafe partial struct ISynchronizeHandle : ISynchronizeHandle.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISynchronizeHandle;
