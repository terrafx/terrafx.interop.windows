...
public unsafe partial struct IPSFactoryBuffer : IPSFactoryBuffer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPSFactoryBuffer;
