...
public unsafe partial struct IServerSecurity : IServerSecurity.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IServerSecurity;
