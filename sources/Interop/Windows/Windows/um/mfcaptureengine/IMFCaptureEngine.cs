...
public unsafe partial struct IMFCaptureEngine : IMFCaptureEngine.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFCaptureEngine;
