...
public unsafe partial struct IMFCaptureSink : IMFCaptureSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFCaptureSink;
