...
public unsafe partial struct IMFCaptureSource : IMFCaptureSource.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFCaptureSource;
