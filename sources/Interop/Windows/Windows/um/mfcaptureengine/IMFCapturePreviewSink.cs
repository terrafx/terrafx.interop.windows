...
public unsafe partial struct IMFCapturePreviewSink : IMFCapturePreviewSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFCapturePreviewSink;
