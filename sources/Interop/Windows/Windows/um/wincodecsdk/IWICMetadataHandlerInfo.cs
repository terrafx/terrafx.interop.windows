...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IWICMetadataHandlerInfo);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICMetadataHandlerInfo*, BOOL*, int>)(lpVtbl[15]))((IWICMetadataHandlerInfo*)Unsafe.AsPointer(ref this), pfRequiresFullStream);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICMetadataHandlerInfo*, BOOL*, int>)(lpVtbl[16]))((IWICMetadataHandlerInfo*)Unsafe.AsPointer(ref this), pfSupportsPadding);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICMetadataHandlerInfo*, BOOL*, int>)(lpVtbl[17]))((IWICMetadataHandlerInfo*)Unsafe.AsPointer(ref this), pfFixedSize);
    }
