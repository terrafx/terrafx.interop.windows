...
public unsafe partial struct IWICPersistStream : IWICPersistStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICPersistStream;
