...
public unsafe partial struct IWICMetadataWriterInfo : IWICMetadataWriterInfo.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICMetadataWriterInfo*, BOOL*, int>)(lpVtbl[15]))((IWICMetadataWriterInfo*)Unsafe.AsPointer(ref this), pfRequiresFullStream);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICMetadataWriterInfo*, BOOL*, int>)(lpVtbl[16]))((IWICMetadataWriterInfo*)Unsafe.AsPointer(ref this), pfSupportsPadding);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICMetadataWriterInfo*, BOOL*, int>)(lpVtbl[17]))((IWICMetadataWriterInfo*)Unsafe.AsPointer(ref this), pfFixedSize);
    }
