...
public unsafe partial struct ISpeechCommandProvider : ISpeechCommandProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechCommandProvider;
