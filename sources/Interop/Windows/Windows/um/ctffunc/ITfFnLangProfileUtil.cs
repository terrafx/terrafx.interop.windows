...
public unsafe partial struct ITfFnLangProfileUtil : ITfFnLangProfileUtil.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfFnLangProfileUtil;
