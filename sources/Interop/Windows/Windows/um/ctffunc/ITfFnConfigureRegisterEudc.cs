...
public unsafe partial struct ITfFnConfigureRegisterEudc : ITfFnConfigureRegisterEudc.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ITfFnConfigureRegisterEudc*, char**, int>)(lpVtbl[3]))((ITfFnConfigureRegisterEudc*)Unsafe.AsPointer(ref this), pbstrName);
    }
    ...
    {
        return ((delegate* unmanaged<ITfFnConfigureRegisterEudc*, HWND, ushort, Guid*, char*, int>)(lpVtbl[4]))((ITfFnConfigureRegisterEudc*)Unsafe.AsPointer(ref this), hwndParent, langid, rguidProfile, bstrRegistered);
    }
