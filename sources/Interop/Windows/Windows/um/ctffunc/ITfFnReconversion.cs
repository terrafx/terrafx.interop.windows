...
public unsafe partial struct ITfFnReconversion : ITfFnReconversion.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfFnReconversion;
