...
public unsafe partial struct ITfCandidateList : ITfCandidateList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfCandidateList;
