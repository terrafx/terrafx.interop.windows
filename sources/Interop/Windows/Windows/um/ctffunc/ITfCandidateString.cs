...
public unsafe partial struct ITfCandidateString : ITfCandidateString.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfCandidateString;
