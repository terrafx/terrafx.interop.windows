...
// Ported from um/ctffunc.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ITfFnLMInternal);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, Guid*, void**, int>)(lpVtbl[0]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, uint>)(lpVtbl[1]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, uint>)(lpVtbl[2]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, char**, int>)(lpVtbl[3]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), pbstrName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, ITfRange*, ITfRange**, BOOL*, int>)(lpVtbl[4]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), pRange, ppNewRange, pfAccepted);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, ushort, BOOL*, int>)(lpVtbl[5]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), langid, pfAccepted);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, ITfRange*, ITfCandidateList**, int>)(lpVtbl[6]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), pRange, ppCandList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, ITfRange*, int>)(lpVtbl[7]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), pRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, BOOL, WPARAM, LPARAM, BOOL*, int>)(lpVtbl[8]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), fUp, vKey, lparamKeydata, pfInterested);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, BOOL, WPARAM, LPARAM, int>)(lpVtbl[9]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), fUp, vKey, lparamKeyData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, ITfContext*, Guid*, int>)(lpVtbl[10]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), pic, refguidFunc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITfFnLMInternal*, ITfRange*, int>)(lpVtbl[11]))((ITfFnLMInternal*)Unsafe.AsPointer(ref this), pRange);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName("HRESULT (ITfRange *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ITfRange*, int> ProcessLattice;
    }
}
