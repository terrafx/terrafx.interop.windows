...
/// <include file='SP_NEWDEVICEWIZARD_DATA.xml' path='doc/member[@name="SP_NEWDEVICEWIZARD_DATA"]/*' />
public partial struct SP_NEWDEVICEWIZARD_DATA
{
    /// <include file='SP_NEWDEVICEWIZARD_DATA.xml' path='doc/member[@name="SP_NEWDEVICEWIZARD_DATA.ClassInstallHeader"]/*' />
    public SP_CLASSINSTALL_HEADER ClassInstallHeader;

    /// <include file='SP_NEWDEVICEWIZARD_DATA.xml' path='doc/member[@name="SP_NEWDEVICEWIZARD_DATA.Flags"]/*' />
    [NativeTypeName("DWORD")]
    public uint Flags;

    /// <include file='SP_NEWDEVICEWIZARD_DATA.xml' path='doc/member[@name="SP_NEWDEVICEWIZARD_DATA.DynamicPages"]/*' />
    [NativeTypeName("HPROPSHEETPAGE[20]")]
    public _DynamicPages_e__FixedBuffer DynamicPages;

    /// <include file='SP_NEWDEVICEWIZARD_DATA.xml' path='doc/member[@name="SP_NEWDEVICEWIZARD_DATA.NumDynamicPages"]/*' />
    [NativeTypeName("DWORD")]
    public uint NumDynamicPages;

    /// <include file='SP_NEWDEVICEWIZARD_DATA.xml' path='doc/member[@name="SP_NEWDEVICEWIZARD_DATA.hwndWizardDlg"]/*' />
