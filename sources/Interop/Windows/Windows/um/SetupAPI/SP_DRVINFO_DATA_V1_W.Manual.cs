...
public unsafe partial struct SP_DRVINFO_DATA_V1_W
{
    public static uint SizeOf
    {
        get
        {
            if (sizeof(nint) == 4)
            {
                return (uint)(sizeof(SP_DRVINFO_DATA32_V1_W));
            }
            else
            {
                return (uint)(sizeof(SP_DRVINFO_DATA64_V1_W));
            }
        }
    }

    [FieldOffset(0)]
    public SP_DRVINFO_DATA32_V1_W _value32;
