...
public unsafe partial struct IThumbnailSettings : IThumbnailSettings.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IThumbnailSettings;
