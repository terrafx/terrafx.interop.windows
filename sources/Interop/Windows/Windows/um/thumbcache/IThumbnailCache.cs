...
public unsafe partial struct IThumbnailCache : IThumbnailCache.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IThumbnailCache;
