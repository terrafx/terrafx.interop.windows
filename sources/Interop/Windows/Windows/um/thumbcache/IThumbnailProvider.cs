...
public unsafe partial struct IThumbnailProvider : IThumbnailProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IThumbnailProvider;
