...
public unsafe partial struct IActiveIMMRegistrar : IActiveIMMRegistrar.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IActiveIMMRegistrar;
