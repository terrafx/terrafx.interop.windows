...
public unsafe partial struct IEnumRegisterWordA : IEnumRegisterWordA.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumRegisterWordA;
