...
public unsafe partial struct IEnumInputContext : IEnumInputContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumInputContext;
