...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IActiveIME2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, Guid*, void**, int>)(lpVtbl[0]))((IActiveIME2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, uint>)(lpVtbl[1]))((IActiveIME2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, uint>)(lpVtbl[2]))((IActiveIME2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, uint, IMEINFO*, char*, uint*, int>)(lpVtbl[3]))((IActiveIME2*)Unsafe.AsPointer(ref this), dwSystemInfoFlags, pIMEInfo, szWndClass, pdwPrivate);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HIMC, char*, uint, uint, CANDIDATELIST*, uint*, int>)(lpVtbl[4]))((IActiveIME2*)Unsafe.AsPointer(ref this), hIMC, szSource, uFlag, uBufLen, pDest, puCopied);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HKL, HWND, uint, REGISTERWORDW*, int>)(lpVtbl[5]))((IActiveIME2*)Unsafe.AsPointer(ref this), hKL, hWnd, dwMode, pRegisterWord);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, uint, int>)(lpVtbl[6]))((IActiveIME2*)Unsafe.AsPointer(ref this), uReserved);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HIMC, uint, void*, LRESULT*, int>)(lpVtbl[7]))((IActiveIME2*)Unsafe.AsPointer(ref this), hIMC, uEscape, pData, plResult);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HIMC, BOOL, int>)(lpVtbl[8]))((IActiveIME2*)Unsafe.AsPointer(ref this), hIMC, fFlag);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HIMC, uint, uint, byte*, int>)(lpVtbl[9]))((IActiveIME2*)Unsafe.AsPointer(ref this), hIMC, uVirKey, lParam, pbKeyState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HIMC, uint, uint, uint, int>)(lpVtbl[10]))((IActiveIME2*)Unsafe.AsPointer(ref this), hIMC, dwAction, dwIndex, dwValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HIMC, BOOL, int>)(lpVtbl[11]))((IActiveIME2*)Unsafe.AsPointer(ref this), hIMC, fSelect);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, HIMC, uint, void*, uint, void*, uint, int>)(lpVtbl[12]))((IActiveIME2*)Unsafe.AsPointer(ref this), hIMC, dwIndex, pComp, dwCompLen, pRead, dwReadLen);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, uint, uint, byte*, uint, HIMC, uint*, uint*, int>)(lpVtbl[13]))((IActiveIME2*)Unsafe.AsPointer(ref this), uVirKey, uScanCode, pbKeyState, fuState, hIMC, pdwTransBuf, puSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, char*, uint, char*, int>)(lpVtbl[14]))((IActiveIME2*)Unsafe.AsPointer(ref this), szReading, dwStyle, szString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, char*, uint, char*, int>)(lpVtbl[15]))((IActiveIME2*)Unsafe.AsPointer(ref this), szReading, dwStyle, szString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, uint, STYLEBUFW*, uint*, int>)(lpVtbl[16]))((IActiveIME2*)Unsafe.AsPointer(ref this), nItem, pStyleBuf, puBufSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, char*, uint, char*, void*, IEnumRegisterWordW**, int>)(lpVtbl[17]))((IActiveIME2*)Unsafe.AsPointer(ref this), szReading, dwStyle, szRegister, pData, ppEnum);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, uint*, int>)(lpVtbl[18]))((IActiveIME2*)Unsafe.AsPointer(ref this), uCodePage);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, ushort*, int>)(lpVtbl[19]))((IActiveIME2*)Unsafe.AsPointer(ref this), plid);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, int>)(lpVtbl[20]))((IActiveIME2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IActiveIME2*, BOOL, int>)(lpVtbl[21]))((IActiveIME2*)Unsafe.AsPointer(ref this), fDead);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, int> Sleep;

        [NativeTypeName("HRESULT (BOOL) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, int> Unsleep;
    }
}
