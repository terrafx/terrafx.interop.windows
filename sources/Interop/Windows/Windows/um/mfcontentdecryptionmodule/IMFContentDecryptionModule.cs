...
public unsafe partial struct IMFContentDecryptionModule : IMFContentDecryptionModule.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFContentDecryptionModule;
