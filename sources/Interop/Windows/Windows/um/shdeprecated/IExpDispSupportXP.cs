...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IExpDispSupportXP);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExpDispSupportXP*, Guid*, void**, int>)(lpVtbl[0]))((IExpDispSupportXP*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IExpDispSupportXP*, uint>)(lpVtbl[1]))((IExpDispSupportXP*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IExpDispSupportXP*, uint>)(lpVtbl[2]))((IExpDispSupportXP*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExpDispSupportXP*, Guid*, CIE4ConnectionPoint**, int>)(lpVtbl[3]))((IExpDispSupportXP*)Unsafe.AsPointer(ref this), riid, ppccp);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExpDispSupportXP*, MSG*, uint, int>)(lpVtbl[4]))((IExpDispSupportXP*)Unsafe.AsPointer(ref this), pMsg, grfModifiers);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExpDispSupportXP*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int>)(lpVtbl[5]))((IExpDispSupportXP*)Unsafe.AsPointer(ref this), dispidMember, iid, lcid, wFlags, pdispparams, pVarResult, pexcepinfo, puArgErr);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, CIE4ConnectionPoint**, int> FindCIE4ConnectionPoint;
