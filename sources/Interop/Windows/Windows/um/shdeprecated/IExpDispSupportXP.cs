...
public unsafe partial struct IExpDispSupportXP : IExpDispSupportXP.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IExpDispSupportXP;
