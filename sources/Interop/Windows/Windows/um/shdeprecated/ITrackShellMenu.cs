...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ITrackShellMenu);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, Guid*, void**, int>)(lpVtbl[0]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, uint>)(lpVtbl[1]))((ITrackShellMenu*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, uint>)(lpVtbl[2]))((ITrackShellMenu*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, IShellMenuCallback*, uint, uint, uint, int>)(lpVtbl[3]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), psmc, uId, uIdAncestor, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, IShellMenuCallback**, uint*, uint*, uint*, int>)(lpVtbl[4]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), ppsmc, puId, puIdAncestor, pdwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, IShellFolder*, ITEMIDLIST*, HKEY, uint, int>)(lpVtbl[5]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), psf, pidlFolder, hKey, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, uint*, ITEMIDLIST**, Guid*, void**, int>)(lpVtbl[6]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), pdwFlags, ppidl, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, HMENU, HWND, uint, int>)(lpVtbl[7]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), hmenu, hwnd, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, HMENU*, HWND*, uint*, int>)(lpVtbl[8]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), phmenu, phwnd, pdwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, SMDATA*, uint, int>)(lpVtbl[9]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), psmd, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, SMDATA*, int>)(lpVtbl[10]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), psmd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, IUnknown*, uint, int>)(lpVtbl[11]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), punk, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, HWND, IUnknown*, uint, int>)(lpVtbl[12]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), hwndTB, punkBand, dwSMSetFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITrackShellMenu*, HWND, POINTL*, RECTL*, int, int>)(lpVtbl[13]))((ITrackShellMenu*)Unsafe.AsPointer(ref this), hwnd, ppt, prcExclude, dwFlags);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, IUnknown*, uint, int> SetObscured;

        [NativeTypeName("HRESULT (HWND, POINTL *, RECTL *, MP_POPUPFLAGS) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, POINTL*, RECTL*, int, int> Popup;
    }
}
