...
public unsafe partial struct ICreateTypeInfo : ICreateTypeInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICreateTypeInfo;
