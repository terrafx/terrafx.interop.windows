...
public unsafe partial struct ITypeLibRegistrationReader : ITypeLibRegistrationReader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITypeLibRegistrationReader;
