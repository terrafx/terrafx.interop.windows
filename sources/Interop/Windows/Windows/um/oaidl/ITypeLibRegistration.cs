...
public unsafe partial struct ITypeLibRegistration : ITypeLibRegistration.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITypeLibRegistration;
