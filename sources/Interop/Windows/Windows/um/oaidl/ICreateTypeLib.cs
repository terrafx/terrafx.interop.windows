...
public unsafe partial struct ICreateTypeLib : ICreateTypeLib.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICreateTypeLib;
