...
public partial struct PSAPI_WORKING_SET_EX_BLOCK
{
    ...
    [FieldOffset(0)]
    [NativeTypeName("_PSAPI_WORKING_SET_EX_BLOCK::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/Psapi.h:406:5)")]
    ...
    public partial struct _Anonymous_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("_PSAPI_WORKING_SET_EX_BLOCK::(anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/Psapi.h:407:9)")]
        public _Anonymous_e__Struct Anonymous;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.Invalid"]/*' />
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/Psapi.h:422:9)")]
