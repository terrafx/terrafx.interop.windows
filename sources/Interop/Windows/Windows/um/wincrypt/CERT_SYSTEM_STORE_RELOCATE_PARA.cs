...
public unsafe partial struct CERT_SYSTEM_STORE_RELOCATE_PARA
{
    ...
    [NativeTypeName("_CERT_SYSTEM_STORE_RELOCATE_PARA::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/wincrypt.h:9485:5)")]
    public _Anonymous1_e__Union Anonymous1;

    /// <include file='CERT_SYSTEM_STORE_RELOCATE_PARA.xml' path='doc/member[@name="CERT_SYSTEM_STORE_RELOCATE_PARA.Anonymous2"]/*' />
    [NativeTypeName("_CERT_SYSTEM_STORE_RELOCATE_PARA::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/wincrypt.h:9489:5)")]
