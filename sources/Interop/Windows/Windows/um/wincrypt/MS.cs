...
public static partial class MS
{
    ...
    public static ReadOnlySpan<byte> MS_DEF_PROV_A => "Microsoft Base Cryptographic Provider v1.0"u8;
    ...
    public static ReadOnlySpan<byte> MS_ENHANCED_PROV_A => "Microsoft Enhanced Cryptographic Provider v1.0"u8;
    ...
    public static ReadOnlySpan<byte> MS_STRONG_PROV_A => "Microsoft Strong Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_DEF_RSA_SIG_PROV_A => "Microsoft RSA Signature Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_DEF_RSA_SCHANNEL_PROV_A => "Microsoft RSA SChannel Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_DEF_DSS_PROV_A => "Microsoft Base DSS Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_DEF_DSS_DH_PROV_A => "Microsoft Base DSS and Diffie-Hellman Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_ENH_DSS_DH_PROV_A => "Microsoft Enhanced DSS and Diffie-Hellman Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_DEF_DH_SCHANNEL_PROV_A => "Microsoft DH SChannel Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_SCARD_PROV_A => "Microsoft Base Smart Card Crypto Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_ENH_RSA_AES_PROV_A => "Microsoft Enhanced RSA and AES Cryptographic Provider"u8;
    ...
    public static ReadOnlySpan<byte> MS_ENH_RSA_AES_PROV_XP_A => "Microsoft Enhanced RSA and AES Cryptographic Provider (Prototype)"u8;
