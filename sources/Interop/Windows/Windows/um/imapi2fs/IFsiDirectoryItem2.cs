...
public unsafe partial struct IFsiDirectoryItem2 : IFsiDirectoryItem2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char**, int>)(lpVtbl[7]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), pVal);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char**, int>)(lpVtbl[8]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), pVal);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, FsiFileSystems, char**, int>)(lpVtbl[17]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), fileSystem, pVal);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, FsiFileSystems, char**, int>)(lpVtbl[18]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), fileSystem, pVal);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char*, IFsiItem**, int>)(lpVtbl[20]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), path, item);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char*, int>)(lpVtbl[23]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), path);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char*, IStream*, int>)(lpVtbl[24]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), path, fileData);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char*, short, int>)(lpVtbl[25]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), sourceDirectory, includeBaseDirectory);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char*, int>)(lpVtbl[27]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), path);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char*, int>)(lpVtbl[28]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), path);
    }
    ...
    {
        return ((delegate* unmanaged<IFsiDirectoryItem2*, char*, short, int>)(lpVtbl[29]))((IFsiDirectoryItem2*)Unsafe.AsPointer(ref this), sourceDirectory, includeBaseDirectory);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName("HRESULT (BSTR, VARIANT_BOOL) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, char*, short, int> AddTreeWithNamedStreams;
    }
}
