...
public unsafe partial struct DFileSystemImageEvents : DFileSystemImageEvents.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_DFileSystemImageEvents;
