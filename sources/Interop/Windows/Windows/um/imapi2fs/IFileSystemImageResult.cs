...
public unsafe partial struct IFileSystemImageResult : IFileSystemImageResult.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFileSystemImageResult;
