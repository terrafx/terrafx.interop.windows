...
public unsafe partial struct IProgressItem : IProgressItem.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IProgressItem*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IProgressItem*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IProgressItem*, char**, int>)(lpVtbl[7]))((IProgressItem*)Unsafe.AsPointer(ref this), desc);
    }
