...
public unsafe partial struct IProgressItems : IProgressItems.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IProgressItems*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IProgressItems*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IProgressItems*, char*, IProgressItem**, int>)(lpVtbl[11]))((IProgressItems*)Unsafe.AsPointer(ref this), description, item);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, char*, IProgressItem**, int> ProgressItemFromDescription;
