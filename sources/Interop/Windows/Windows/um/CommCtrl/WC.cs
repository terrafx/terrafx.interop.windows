...
public static partial class WC
{
    ...
    public static ReadOnlySpan<byte> WC_HEADERA => "SysHeader32\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_LISTVIEWA => "SysListView32\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_TREEVIEWA => "SysTreeView32\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_COMBOBOXEXA => "ComboBoxEx32\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_TABCONTROLA => "SysTabControl32\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_IPADDRESSA => "SysIPAddress32\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_PAGESCROLLERA => "SysPager\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_NATIVEFONTCTLA => "NativeFontCtl\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_BUTTONA => "Button\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_STATICA => "Static\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_EDITA => "Edit\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_LISTBOXA => "ListBox\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_COMBOBOXA => "ComboBox\0"u8;
    ...
    public static ReadOnlySpan<byte> WC_SCROLLBARA => "ScrollBar\0"u8;
