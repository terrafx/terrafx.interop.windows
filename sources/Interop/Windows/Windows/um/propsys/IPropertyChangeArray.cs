...
public unsafe partial struct IPropertyChangeArray : IPropertyChangeArray.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyChangeArray;
