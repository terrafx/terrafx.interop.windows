...
public unsafe partial struct IPropertyStore : IPropertyStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyStore;
