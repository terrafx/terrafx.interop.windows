...
public unsafe partial struct IPropertyStoreCache : IPropertyStoreCache.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyStoreCache;
