...
public unsafe partial struct IPropertyChange : IPropertyChange.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyChange;
