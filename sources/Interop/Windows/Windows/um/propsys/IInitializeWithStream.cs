...
public unsafe partial struct IInitializeWithStream : IInitializeWithStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeWithStream;
