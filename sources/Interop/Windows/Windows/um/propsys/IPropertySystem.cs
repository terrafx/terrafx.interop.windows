...
public unsafe partial struct IPropertySystem : IPropertySystem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertySystem;
