...
public unsafe partial struct IObjectWithPropertyKey : IObjectWithPropertyKey.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IObjectWithPropertyKey;
