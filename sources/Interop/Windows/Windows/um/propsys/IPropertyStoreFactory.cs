...
public unsafe partial struct IPropertyStoreFactory : IPropertyStoreFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyStoreFactory;
