...
public unsafe partial struct INamedPropertyStore : INamedPropertyStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_INamedPropertyStore;
