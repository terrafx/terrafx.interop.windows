...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IPropertyDescription2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, Guid*, void**, int>)(lpVtbl[0]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, uint>)(lpVtbl[1]))((IPropertyDescription2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, uint>)(lpVtbl[2]))((IPropertyDescription2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPERTYKEY*, int>)(lpVtbl[3]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), pkey);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, char**, int>)(lpVtbl[4]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppszName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, ushort*, int>)(lpVtbl[5]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), pvartype);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, char**, int>)(lpVtbl[6]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppszName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, char**, int>)(lpVtbl[7]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppszInvite);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_TYPE_FLAGS, PROPDESC_TYPE_FLAGS*, int>)(lpVtbl[8]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), mask, ppdtFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_VIEW_FLAGS*, int>)(lpVtbl[9]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppdvFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, uint*, int>)(lpVtbl[10]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), pcxChars);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_DISPLAYTYPE*, int>)(lpVtbl[11]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), pdisplaytype);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, uint*, int>)(lpVtbl[12]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), pcsFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_GROUPING_RANGE*, int>)(lpVtbl[13]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), pgr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_RELATIVEDESCRIPTION_TYPE*, int>)(lpVtbl[14]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), prdt);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPVARIANT*, PROPVARIANT*, char**, char**, int>)(lpVtbl[15]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), propvar1, propvar2, ppszDesc1, ppszDesc2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_SORTDESCRIPTION*, int>)(lpVtbl[16]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), psd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, BOOL, char**, int>)(lpVtbl[17]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), fDescending, ppszDescription);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_AGGREGATION_TYPE*, int>)(lpVtbl[18]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), paggtype);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPDESC_CONDITION_TYPE*, CONDITION_OPERATION*, int>)(lpVtbl[19]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), pcontype, popDefault);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, Guid*, void**, int>)(lpVtbl[20]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPVARIANT*, int>)(lpVtbl[21]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppropvar);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPVARIANT*, PROPDESC_FORMAT_FLAGS, char**, int>)(lpVtbl[22]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), propvar, pdfFlags, ppszDisplay);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPVARIANT*, int>)(lpVtbl[23]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), propvar);
    }

    /// <include file='IPropertyDescription2.xml' path='doc/member[@name="IPropertyDescription2.GetImageReferenceForValue"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(24)]
    public HRESULT GetImageReferenceForValue([NativeTypeName("const PROPVARIANT &")] PROPVARIANT* propvar, [NativeTypeName("LPWSTR *")] char** ppszImageRes)
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescription2*, PROPVARIANT*, char**, int>)(lpVtbl[24]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), propvar, ppszImageRes);
    }

    public interface Interface : IPropertyDescription.Interface
    {
        [VtblIndex(24)]
        HRESULT GetImageReferenceForValue([NativeTypeName("const PROPVARIANT &")] PROPVARIANT* propvar, [NativeTypeName("LPWSTR *")] char** ppszImageRes);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, PROPVARIANT*, char**, int> GetImageReferenceForValue;
    }
}
