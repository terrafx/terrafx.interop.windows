...
public unsafe partial struct IPropertyDescription2 : IPropertyDescription2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IPropertyDescription2*, char**, int>)(lpVtbl[4]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppszName);
    }
    ...
    {
        return ((delegate* unmanaged<IPropertyDescription2*, char**, int>)(lpVtbl[6]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppszName);
    }
    ...
    {
        return ((delegate* unmanaged<IPropertyDescription2*, char**, int>)(lpVtbl[7]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), ppszInvite);
    }
    ...
    {
        return ((delegate* unmanaged<IPropertyDescription2*, PROPVARIANT*, PROPVARIANT*, char**, char**, int>)(lpVtbl[15]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), propvar1, propvar2, ppszDesc1, ppszDesc2);
    }
    ...
    {
        return ((delegate* unmanaged<IPropertyDescription2*, BOOL, char**, int>)(lpVtbl[17]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), fDescending, ppszDescription);
    }
    ...
    {
        return ((delegate* unmanaged<IPropertyDescription2*, PROPVARIANT*, PROPDESC_FORMAT_FLAGS, char**, int>)(lpVtbl[22]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), propvar, pdfFlags, ppszDisplay);
    }
    ...
    {
        return ((delegate* unmanaged<IPropertyDescription2*, PROPVARIANT*, char**, int>)(lpVtbl[24]))((IPropertyDescription2*)Unsafe.AsPointer(ref this), propvar, ppszImageRes);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, PROPVARIANT*, char**, int> GetImageReferenceForValue;
    }
}
