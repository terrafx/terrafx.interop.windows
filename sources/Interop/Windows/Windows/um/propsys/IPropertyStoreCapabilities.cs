...
public unsafe partial struct IPropertyStoreCapabilities : IPropertyStoreCapabilities.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyStoreCapabilities;
