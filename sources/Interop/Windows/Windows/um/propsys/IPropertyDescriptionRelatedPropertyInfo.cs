...
// Ported from um/propsys.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IPropertyDescriptionRelatedPropertyInfo);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, Guid*, void**, int>)(lpVtbl[0]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, uint>)(lpVtbl[1]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, uint>)(lpVtbl[2]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPERTYKEY*, int>)(lpVtbl[3]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pkey);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, char**, int>)(lpVtbl[4]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), ppszName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, ushort*, int>)(lpVtbl[5]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pvartype);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, char**, int>)(lpVtbl[6]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), ppszName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, char**, int>)(lpVtbl[7]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), ppszInvite);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_TYPE_FLAGS, PROPDESC_TYPE_FLAGS*, int>)(lpVtbl[8]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), mask, ppdtFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_VIEW_FLAGS*, int>)(lpVtbl[9]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), ppdvFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, uint*, int>)(lpVtbl[10]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pcxChars);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_DISPLAYTYPE*, int>)(lpVtbl[11]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pdisplaytype);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, uint*, int>)(lpVtbl[12]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pcsFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_GROUPING_RANGE*, int>)(lpVtbl[13]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pgr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_RELATIVEDESCRIPTION_TYPE*, int>)(lpVtbl[14]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), prdt);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPVARIANT*, PROPVARIANT*, char**, char**, int>)(lpVtbl[15]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), propvar1, propvar2, ppszDesc1, ppszDesc2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_SORTDESCRIPTION*, int>)(lpVtbl[16]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), psd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, BOOL, char**, int>)(lpVtbl[17]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), fDescending, ppszDescription);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_AGGREGATION_TYPE*, int>)(lpVtbl[18]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), paggtype);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPDESC_CONDITION_TYPE*, CONDITION_OPERATION*, int>)(lpVtbl[19]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pcontype, popDefault);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, Guid*, void**, int>)(lpVtbl[20]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPVARIANT*, int>)(lpVtbl[21]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), ppropvar);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPVARIANT*, PROPDESC_FORMAT_FLAGS, char**, int>)(lpVtbl[22]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), propvar, pdfFlags, ppszDisplay);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, PROPVARIANT*, int>)(lpVtbl[23]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), propvar);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(24)]
    public HRESULT GetRelatedProperty([NativeTypeName("LPCWSTR")] char* pszRelationshipName, [NativeTypeName("const IID &")] Guid* riid, void** ppv)
    {
        return ((delegate* unmanaged[MemberFunction]<IPropertyDescriptionRelatedPropertyInfo*, char*, Guid*, void**, int>)(lpVtbl[24]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), pszRelationshipName, riid, ppv);
    }

    public interface Interface : IPropertyDescription.Interface
    {
        [VtblIndex(24)]
        HRESULT GetRelatedProperty([NativeTypeName("LPCWSTR")] char* pszRelationshipName, [NativeTypeName("const IID &")] Guid* riid, void** ppv);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, Guid*, void**, int> GetRelatedProperty;
    }
}
