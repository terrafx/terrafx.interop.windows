...
public unsafe partial struct IPropertyEnumTypeList : IPropertyEnumTypeList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyEnumTypeList;
