...
public unsafe partial struct IMMDeviceCollection : IMMDeviceCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMMDeviceCollection;
