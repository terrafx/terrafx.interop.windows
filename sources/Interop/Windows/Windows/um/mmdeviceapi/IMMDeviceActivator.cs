...
public unsafe partial struct IMMDeviceActivator : IMMDeviceActivator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMMDeviceActivator;
