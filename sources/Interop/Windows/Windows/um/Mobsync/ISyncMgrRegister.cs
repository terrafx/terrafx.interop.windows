...
public unsafe partial struct ISyncMgrRegister : ISyncMgrRegister.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrRegister;
