...
public unsafe partial struct ISyncMgrSynchronize : ISyncMgrSynchronize.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrSynchronize;
