...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ISpeechRecoResult2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, Guid*, void**, int>)(lpVtbl[0]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, uint>)(lpVtbl[1]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, uint>)(lpVtbl[2]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, uint*, int>)(lpVtbl[3]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), pctinfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, uint, uint, ITypeInfo**, int>)(lpVtbl[4]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), iTInfo, lcid, ppTInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int>)(lpVtbl[6]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, ISpeechRecoContext**, int>)(lpVtbl[7]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), RecoContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, ISpeechRecoResultTimes**, int>)(lpVtbl[8]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), Times);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, ISpeechAudioFormat*, int>)(lpVtbl[9]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), Format);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, ISpeechAudioFormat**, int>)(lpVtbl[10]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), Format);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, ISpeechPhraseInfo**, int>)(lpVtbl[11]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), PhraseInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, int, int, int, ISpeechPhraseAlternates**, int>)(lpVtbl[12]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), RequestCount, StartElement, Elements, Alternates);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, int, int, ISpeechMemoryStream**, int>)(lpVtbl[13]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), StartElement, Elements, Stream);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, int, int, SpeechVoiceSpeakFlags, int*, int>)(lpVtbl[14]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), StartElement, Elements, Flags, StreamNumber);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, VARIANT*, int>)(lpVtbl[15]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), ResultBlock);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, SpeechDiscardType, int>)(lpVtbl[16]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), ValueTypes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpeechRecoResult2*, char*, short, int>)(lpVtbl[17]))((ISpeechRecoResult2*)Unsafe.AsPointer(ref this), Feedback, WasSuccessful);
    }
