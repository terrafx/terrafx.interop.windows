...
public unsafe partial struct ISpRecoCategory : ISpRecoCategory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpRecoCategory;
