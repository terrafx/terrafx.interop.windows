...
public unsafe partial struct ISpeechRecoResultTimes : ISpeechRecoResultTimes.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechRecoResultTimes*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechRecoResultTimes*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, VARIANT*, int> get_StreamTime;

        [NativeTypeName("HRESULT (VARIANT *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, VARIANT*, int> get_Length;

        [NativeTypeName("HRESULT (long *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, int*, int> get_TickCount;

        [NativeTypeName("HRESULT (VARIANT *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, VARIANT*, int> get_OffsetFromStart;
    }
}
