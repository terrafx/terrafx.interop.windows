...
public unsafe partial struct _ISpeechVoiceEvents : _ISpeechVoiceEvents.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<_ISpeechVoiceEvents*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((_ISpeechVoiceEvents*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
