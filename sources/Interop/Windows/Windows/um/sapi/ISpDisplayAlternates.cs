...
public unsafe partial struct ISpDisplayAlternates : ISpDisplayAlternates.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpDisplayAlternates;
