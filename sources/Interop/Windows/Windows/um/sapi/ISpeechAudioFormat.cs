...
public unsafe partial struct ISpeechAudioFormat : ISpeechAudioFormat.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechAudioFormat;
