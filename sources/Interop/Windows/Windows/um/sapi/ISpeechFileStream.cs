...
public unsafe partial struct ISpeechFileStream : ISpeechFileStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechFileStream;
