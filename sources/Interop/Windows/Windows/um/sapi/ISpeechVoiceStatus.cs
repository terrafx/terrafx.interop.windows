...
public unsafe partial struct ISpeechVoiceStatus : ISpeechVoiceStatus.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechVoiceStatus;
