...
public unsafe partial struct ISpeechRecognizerStatus : ISpeechRecognizerStatus.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechRecognizerStatus;
