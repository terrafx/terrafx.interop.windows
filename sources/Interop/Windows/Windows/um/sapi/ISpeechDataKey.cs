...
public unsafe partial struct ISpeechDataKey : ISpeechDataKey.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechDataKey;
