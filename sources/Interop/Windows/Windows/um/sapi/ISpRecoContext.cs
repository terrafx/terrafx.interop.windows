...
public unsafe partial struct ISpRecoContext : ISpRecoContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpRecoContext;
