...
public unsafe partial struct ISpeechMemoryStream : ISpeechMemoryStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechMemoryStream;
