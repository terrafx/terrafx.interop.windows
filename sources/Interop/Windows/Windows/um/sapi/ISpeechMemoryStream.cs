...
public unsafe partial struct ISpeechMemoryStream : ISpeechMemoryStream.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechMemoryStream*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechMemoryStream*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, VARIANT, int> SetData;
