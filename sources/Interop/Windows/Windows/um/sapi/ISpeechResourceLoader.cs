...
public unsafe partial struct ISpeechResourceLoader : ISpeechResourceLoader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechResourceLoader;
