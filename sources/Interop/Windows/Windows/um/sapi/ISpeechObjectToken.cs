...
public unsafe partial struct ISpeechObjectToken : ISpeechObjectToken.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechObjectToken;
