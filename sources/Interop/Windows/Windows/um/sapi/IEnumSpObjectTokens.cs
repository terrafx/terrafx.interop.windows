...
public unsafe partial struct IEnumSpObjectTokens : IEnumSpObjectTokens.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumSpObjectTokens;
