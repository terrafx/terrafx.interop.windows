...
public unsafe partial struct ISpeechPhraseAlternates : ISpeechPhraseAlternates.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseAlternates*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechPhraseAlternates*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, int, ISpeechPhraseAlternate**, int> Item;
