...
public unsafe partial struct ISpeechPhraseRules : ISpeechPhraseRules.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseRules*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechPhraseRules*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
