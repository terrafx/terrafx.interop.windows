...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ISpPhrase2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, Guid*, void**, int>)(lpVtbl[0]))((ISpPhrase2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, uint>)(lpVtbl[1]))((ISpPhrase2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, uint>)(lpVtbl[2]))((ISpPhrase2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, SPPHRASE**, int>)(lpVtbl[3]))((ISpPhrase2*)Unsafe.AsPointer(ref this), ppCoMemPhrase);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, SPSERIALIZEDPHRASE**, int>)(lpVtbl[4]))((ISpPhrase2*)Unsafe.AsPointer(ref this), ppCoMemPhrase);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, uint, uint, BOOL, char**, byte*, int>)(lpVtbl[5]))((ISpPhrase2*)Unsafe.AsPointer(ref this), ulStart, ulCount, fUseTextReplacements, ppszCoMemText, pbDisplayAttributes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, uint, int>)(lpVtbl[6]))((ISpPhrase2*)Unsafe.AsPointer(ref this), dwValueTypes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, char**, SPXMLRESULTOPTIONS, int>)(lpVtbl[7]))((ISpPhrase2*)Unsafe.AsPointer(ref this), ppszCoMemXMLResult, Options);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, SPSEMANTICERRORINFO*, int>)(lpVtbl[8]))((ISpPhrase2*)Unsafe.AsPointer(ref this), pSemanticErrorInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpPhrase2*, uint, uint, ISpStreamFormat**, int>)(lpVtbl[9]))((ISpPhrase2*)Unsafe.AsPointer(ref this), ulStartElement, cElements, ppStream);
    }
