...
public unsafe partial struct ISpeechPhraseElements : ISpeechPhraseElements.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseElements*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechPhraseElements*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, int, ISpeechPhraseElement**, int> Item;
