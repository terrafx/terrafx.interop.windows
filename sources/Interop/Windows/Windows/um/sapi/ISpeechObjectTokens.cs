...
public unsafe partial struct ISpeechObjectTokens : ISpeechObjectTokens.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechObjectTokens*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechObjectTokens*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, int, ISpeechObjectToken**, int> Item;
