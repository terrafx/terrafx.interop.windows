...
public unsafe partial struct ISpeechCustomStream : ISpeechCustomStream.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechCustomStream*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechCustomStream*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
