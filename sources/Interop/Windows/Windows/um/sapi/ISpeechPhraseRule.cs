...
public unsafe partial struct ISpeechPhraseRule : ISpeechPhraseRule.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechPhraseRule;
