...
public unsafe partial struct ISpeechPhraseRule : ISpeechPhraseRule.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseRule*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechPhraseRule*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseRule*, char**, int>)(lpVtbl[7]))((ISpeechPhraseRule*)Unsafe.AsPointer(ref this), Name);
    }
