...
public unsafe partial struct ISpeechGrammarRuleStateTransitions : ISpeechGrammarRuleStateTransitions.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechGrammarRuleStateTransitions*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechGrammarRuleStateTransitions*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
