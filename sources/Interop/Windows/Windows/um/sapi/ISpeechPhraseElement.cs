...
public unsafe partial struct ISpeechPhraseElement : ISpeechPhraseElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechPhraseElement;
