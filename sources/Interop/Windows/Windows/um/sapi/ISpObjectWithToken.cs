...
public unsafe partial struct ISpObjectWithToken : ISpObjectWithToken.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpObjectWithToken;
