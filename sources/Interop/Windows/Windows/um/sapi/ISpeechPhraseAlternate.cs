...
public unsafe partial struct ISpeechPhraseAlternate : ISpeechPhraseAlternate.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseAlternate*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechPhraseAlternate*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
