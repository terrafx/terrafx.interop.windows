...
public unsafe partial struct ISpeechWaveFormatEx : ISpeechWaveFormatEx.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechWaveFormatEx*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechWaveFormatEx*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
