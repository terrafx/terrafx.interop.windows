...
public unsafe partial struct ISpeechPhraseProperties : ISpeechPhraseProperties.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseProperties*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechPhraseProperties*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
