...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ISpStreamFormat);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, Guid*, void**, int>)(lpVtbl[0]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, uint>)(lpVtbl[1]))((ISpStreamFormat*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, uint>)(lpVtbl[2]))((ISpStreamFormat*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, void*, uint, uint*, int>)(lpVtbl[3]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), pv, cb, pcbRead);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, void*, uint, uint*, int>)(lpVtbl[4]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), pv, cb, pcbWritten);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, LARGE_INTEGER, uint, ULARGE_INTEGER*, int>)(lpVtbl[5]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), dlibMove, dwOrigin, plibNewPosition);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, ULARGE_INTEGER, int>)(lpVtbl[6]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), libNewSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, IStream*, ULARGE_INTEGER, ULARGE_INTEGER*, ULARGE_INTEGER*, int>)(lpVtbl[7]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), pstm, cb, pcbRead, pcbWritten);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, uint, int>)(lpVtbl[8]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), grfCommitFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, int>)(lpVtbl[9]))((ISpStreamFormat*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, ULARGE_INTEGER, ULARGE_INTEGER, uint, int>)(lpVtbl[10]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), libOffset, cb, dwLockType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, ULARGE_INTEGER, ULARGE_INTEGER, uint, int>)(lpVtbl[11]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), libOffset, cb, dwLockType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, STATSTG*, uint, int>)(lpVtbl[12]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), pstatstg, grfStatFlag);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, IStream**, int>)(lpVtbl[13]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), ppstm);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpStreamFormat*, Guid*, WAVEFORMATEX**, int>)(lpVtbl[14]))((ISpStreamFormat*)Unsafe.AsPointer(ref this), pguidFormatId, ppCoMemWaveFormatEx);
    }
