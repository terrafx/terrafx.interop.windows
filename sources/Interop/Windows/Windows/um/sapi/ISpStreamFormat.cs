...
public unsafe partial struct ISpStreamFormat : ISpStreamFormat.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpStreamFormat;
