...
public unsafe partial struct ISpeechAudio : ISpeechAudio.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechAudio*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechAudio*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
