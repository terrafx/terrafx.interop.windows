...
public unsafe partial struct ISpeechAudioStatus : ISpeechAudioStatus.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechAudioStatus;
