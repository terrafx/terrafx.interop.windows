...
public unsafe partial struct ISpeechAudioStatus : ISpeechAudioStatus.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechAudioStatus*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechAudioStatus*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
