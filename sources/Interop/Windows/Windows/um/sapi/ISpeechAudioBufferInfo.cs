...
public unsafe partial struct ISpeechAudioBufferInfo : ISpeechAudioBufferInfo.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechAudioBufferInfo*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechAudioBufferInfo*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
