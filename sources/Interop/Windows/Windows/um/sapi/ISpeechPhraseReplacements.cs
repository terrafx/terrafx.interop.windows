...
public unsafe partial struct ISpeechPhraseReplacements : ISpeechPhraseReplacements.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechPhraseReplacements*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechPhraseReplacements*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, int, ISpeechPhraseReplacement**, int> Item;
