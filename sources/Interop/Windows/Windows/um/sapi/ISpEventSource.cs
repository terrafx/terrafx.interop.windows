...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ISpEventSource);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, Guid*, void**, int>)(lpVtbl[0]))((ISpEventSource*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, uint>)(lpVtbl[1]))((ISpEventSource*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, uint>)(lpVtbl[2]))((ISpEventSource*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, ISpNotifySink*, int>)(lpVtbl[3]))((ISpEventSource*)Unsafe.AsPointer(ref this), pNotifySink);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, HWND, uint, WPARAM, LPARAM, int>)(lpVtbl[4]))((ISpEventSource*)Unsafe.AsPointer(ref this), hWnd, Msg, wParam, lParam);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, delegate* unmanaged<WPARAM, LPARAM, void>, WPARAM, LPARAM, int>)(lpVtbl[5]))((ISpEventSource*)Unsafe.AsPointer(ref this), pfnCallback, wParam, lParam);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, ISpNotifyCallback*, WPARAM, LPARAM, int>)(lpVtbl[6]))((ISpEventSource*)Unsafe.AsPointer(ref this), pSpCallback, wParam, lParam);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, int>)(lpVtbl[7]))((ISpEventSource*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, uint, int>)(lpVtbl[8]))((ISpEventSource*)Unsafe.AsPointer(ref this), dwMilliseconds);
    }
    ...
    {
        return ((HANDLE)(((delegate* unmanaged[MemberFunction]<ISpEventSource*, void*>)(lpVtbl[9]))((ISpEventSource*)Unsafe.AsPointer(ref this))));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, ulong, ulong, int>)(lpVtbl[10]))((ISpEventSource*)Unsafe.AsPointer(ref this), ullEventInterest, ullQueuedInterest);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, uint, SPEVENT*, uint*, int>)(lpVtbl[11]))((ISpEventSource*)Unsafe.AsPointer(ref this), ulCount, pEventArray, pulFetched);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISpEventSource*, SPEVENTSOURCEINFO*, int>)(lpVtbl[12]))((ISpEventSource*)Unsafe.AsPointer(ref this), pInfo);
    }
