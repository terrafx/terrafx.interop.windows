...
public unsafe partial struct ISpeechRecoResult : ISpeechRecoResult.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechRecoResult*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechRecoResult*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
