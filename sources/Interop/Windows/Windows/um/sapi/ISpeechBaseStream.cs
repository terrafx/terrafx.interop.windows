...
public unsafe partial struct ISpeechBaseStream : ISpeechBaseStream.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpeechBaseStream*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISpeechBaseStream*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
