...
public unsafe partial struct ISpeechBaseStream : ISpeechBaseStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechBaseStream;
