...
public unsafe partial struct ISpRegDataKey : ISpRegDataKey.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, uint, byte*, int>)(lpVtbl[3]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszValueName, cbData, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, uint*, byte*, int>)(lpVtbl[4]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszValueName, pcbData, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, char*, int>)(lpVtbl[5]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszValueName, pszValue);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, char**, int>)(lpVtbl[6]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszValueName, ppszValue);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, uint, int>)(lpVtbl[7]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszValueName, dwValue);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, uint*, int>)(lpVtbl[8]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszValueName, pdwValue);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, ISpDataKey**, int>)(lpVtbl[9]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszSubKeyName, ppSubKey);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, ISpDataKey**, int>)(lpVtbl[10]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszSubKey, ppSubKey);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, int>)(lpVtbl[11]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszSubKey);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, char*, int>)(lpVtbl[12]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), pszValueName);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, uint, char**, int>)(lpVtbl[13]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), Index, ppszSubKeyName);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRegDataKey*, uint, char**, int>)(lpVtbl[14]))((ISpRegDataKey*)Unsafe.AsPointer(ref this), Index, ppszValueName);
    }
