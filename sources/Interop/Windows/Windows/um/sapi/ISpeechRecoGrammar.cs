...
public unsafe partial struct ISpeechRecoGrammar : ISpeechRecoGrammar.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechRecoGrammar;
