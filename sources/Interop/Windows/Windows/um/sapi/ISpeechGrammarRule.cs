...
public unsafe partial struct ISpeechGrammarRule : ISpeechGrammarRule.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpeechGrammarRule;
