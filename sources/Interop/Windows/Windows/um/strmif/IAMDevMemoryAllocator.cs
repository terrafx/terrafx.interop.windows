...
public unsafe partial struct IAMDevMemoryAllocator : IAMDevMemoryAllocator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMDevMemoryAllocator;
