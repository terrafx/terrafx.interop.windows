...
public unsafe partial struct IVMRMonitorConfig : IVMRMonitorConfig.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IVMRMonitorConfig;
