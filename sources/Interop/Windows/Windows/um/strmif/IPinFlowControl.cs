...
public unsafe partial struct IPinFlowControl : IPinFlowControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPinFlowControl;
