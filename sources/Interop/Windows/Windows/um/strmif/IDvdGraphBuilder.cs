...
public unsafe partial struct IDvdGraphBuilder : IDvdGraphBuilder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDvdGraphBuilder;
