...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IFilterMapper2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IFilterMapper2*, Guid*, void**, int>)(lpVtbl[0]))((IFilterMapper2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IFilterMapper2*, uint>)(lpVtbl[1]))((IFilterMapper2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IFilterMapper2*, uint>)(lpVtbl[2]))((IFilterMapper2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IFilterMapper2*, Guid*, uint, char*, int>)(lpVtbl[3]))((IFilterMapper2*)Unsafe.AsPointer(ref this), clsidCategory, dwCategoryMerit, Description);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IFilterMapper2*, Guid*, char*, Guid*, int>)(lpVtbl[4]))((IFilterMapper2*)Unsafe.AsPointer(ref this), pclsidCategory, szInstance, Filter);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IFilterMapper2*, Guid*, char*, IMoniker**, Guid*, char*, REGFILTER2*, int>)(lpVtbl[5]))((IFilterMapper2*)Unsafe.AsPointer(ref this), clsidFilter, Name, ppMoniker, pclsidCategory, szInstance, prf2);
    }
