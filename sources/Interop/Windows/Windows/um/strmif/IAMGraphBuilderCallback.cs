...
public unsafe partial struct IAMGraphBuilderCallback : IAMGraphBuilderCallback.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMGraphBuilderCallback;
