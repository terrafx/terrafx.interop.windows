...
public unsafe partial struct IAMDevMemoryControl : IAMDevMemoryControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMDevMemoryControl;
