...
public unsafe partial struct IKsPropertySet : IKsPropertySet.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IKsPropertySet;
