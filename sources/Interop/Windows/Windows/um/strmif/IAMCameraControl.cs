...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAMCameraControl);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAMCameraControl*, Guid*, void**, int>)(lpVtbl[0]))((IAMCameraControl*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAMCameraControl*, uint>)(lpVtbl[1]))((IAMCameraControl*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAMCameraControl*, uint>)(lpVtbl[2]))((IAMCameraControl*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAMCameraControl*, int, int*, int*, int*, int*, int*, int>)(lpVtbl[3]))((IAMCameraControl*)Unsafe.AsPointer(ref this), Property, pMin, pMax, pSteppingDelta, pDefault, pCapsFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAMCameraControl*, int, int, int, int>)(lpVtbl[4]))((IAMCameraControl*)Unsafe.AsPointer(ref this), Property, lValue, Flags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAMCameraControl*, int, int*, int*, int>)(lpVtbl[5]))((IAMCameraControl*)Unsafe.AsPointer(ref this), Property, lValue, Flags);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int*, int*, int*, int*, int*, int> GetRange;

        [NativeTypeName("HRESULT (long, long, long) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int, int, int> Set;

        [NativeTypeName("HRESULT (long, long *, long *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int, int*, int*, int> Get;
    }
}
