...
public unsafe partial struct IEnumRegFilters : IEnumRegFilters.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumRegFilters;
