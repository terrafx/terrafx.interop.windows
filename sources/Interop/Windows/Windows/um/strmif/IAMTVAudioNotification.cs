...
public unsafe partial struct IAMTVAudioNotification : IAMTVAudioNotification.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMTVAudioNotification;
