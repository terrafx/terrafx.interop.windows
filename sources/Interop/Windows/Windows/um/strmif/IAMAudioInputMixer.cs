...
public unsafe partial struct IAMAudioInputMixer : IAMAudioInputMixer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMAudioInputMixer;
