...
public unsafe partial struct IResourceConsumer : IResourceConsumer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IResourceConsumer;
