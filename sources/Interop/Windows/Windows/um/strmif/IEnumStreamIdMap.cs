...
public unsafe partial struct IEnumStreamIdMap : IEnumStreamIdMap.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumStreamIdMap;
