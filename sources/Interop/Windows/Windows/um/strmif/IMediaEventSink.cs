...
public unsafe partial struct IMediaEventSink : IMediaEventSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMediaEventSink;
