...
public unsafe partial struct IFileSinkFilter : IFileSinkFilter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFileSinkFilter;
