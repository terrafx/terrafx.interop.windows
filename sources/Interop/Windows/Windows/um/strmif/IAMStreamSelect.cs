...
public unsafe partial struct IAMStreamSelect : IAMStreamSelect.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMStreamSelect;
