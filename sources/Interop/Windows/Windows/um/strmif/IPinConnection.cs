...
public unsafe partial struct IPinConnection : IPinConnection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPinConnection;
