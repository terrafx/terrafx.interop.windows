...
public unsafe partial struct IQualityControl : IQualityControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IQualityControl;
