...
public unsafe partial struct IReferenceClock : IReferenceClock.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IReferenceClock;
