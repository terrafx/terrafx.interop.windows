...
public unsafe partial struct IVMRImagePresenter : IVMRImagePresenter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IVMRImagePresenter;
