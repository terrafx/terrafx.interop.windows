...
public unsafe partial struct IAMFilterMiscFlags : IAMFilterMiscFlags.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMFilterMiscFlags;
