...
public unsafe partial struct IVMRSurfaceAllocator : IVMRSurfaceAllocator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IVMRSurfaceAllocator;
