...
public unsafe partial struct IAMDroppedFrames : IAMDroppedFrames.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMDroppedFrames;
