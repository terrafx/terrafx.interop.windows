...
public unsafe partial struct IDrawVideoImage : IDrawVideoImage.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDrawVideoImage;
