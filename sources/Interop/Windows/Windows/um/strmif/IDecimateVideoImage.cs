...
public unsafe partial struct IDecimateVideoImage : IDecimateVideoImage.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDecimateVideoImage;
