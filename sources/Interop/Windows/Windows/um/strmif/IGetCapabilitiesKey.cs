...
public unsafe partial struct IGetCapabilitiesKey : IGetCapabilitiesKey.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IGetCapabilitiesKey;
