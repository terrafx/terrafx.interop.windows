...
public unsafe partial struct IOverlayNotify : IOverlayNotify.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOverlayNotify;
