...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IOverlayNotify);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOverlayNotify*, Guid*, void**, int>)(lpVtbl[0]))((IOverlayNotify*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IOverlayNotify*, uint>)(lpVtbl[1]))((IOverlayNotify*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IOverlayNotify*, uint>)(lpVtbl[2]))((IOverlayNotify*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOverlayNotify*, uint, PALETTEENTRY*, int>)(lpVtbl[3]))((IOverlayNotify*)Unsafe.AsPointer(ref this), dwColors, pPalette);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOverlayNotify*, RECT*, RECT*, RGNDATA*, int>)(lpVtbl[4]))((IOverlayNotify*)Unsafe.AsPointer(ref this), pSourceRect, pDestinationRect, pRgnData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOverlayNotify*, COLORKEY*, int>)(lpVtbl[5]))((IOverlayNotify*)Unsafe.AsPointer(ref this), pColorKey);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOverlayNotify*, RECT*, RECT*, int>)(lpVtbl[6]))((IOverlayNotify*)Unsafe.AsPointer(ref this), pSourceRect, pDestinationRect);
    }
