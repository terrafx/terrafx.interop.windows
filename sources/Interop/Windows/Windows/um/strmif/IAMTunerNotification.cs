...
public unsafe partial struct IAMTunerNotification : IAMTunerNotification.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMTunerNotification;
