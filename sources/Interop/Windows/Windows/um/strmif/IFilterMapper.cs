...
public unsafe partial struct IFilterMapper : IFilterMapper.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IFilterMapper*, Guid, char*, uint, int>)(lpVtbl[3]))((IFilterMapper*)Unsafe.AsPointer(ref this), clsid, Name, dwMerit);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterMapper*, Guid, char*, Guid*, int>)(lpVtbl[4]))((IFilterMapper*)Unsafe.AsPointer(ref this), clsid, Name, MRId);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterMapper*, Guid, char*, BOOL, BOOL, BOOL, BOOL, Guid, char*, int>)(lpVtbl[5]))((IFilterMapper*)Unsafe.AsPointer(ref this), Filter, Name, bRendered, bOutput, bZero, bMany, ConnectsToFilter, ConnectsToPin);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterMapper*, Guid, char*, Guid, Guid, int>)(lpVtbl[6]))((IFilterMapper*)Unsafe.AsPointer(ref this), clsFilter, strName, clsMajorType, clsSubType);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterMapper*, Guid, char*, int>)(lpVtbl[9]))((IFilterMapper*)Unsafe.AsPointer(ref this), Filter, Name);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, Guid, char*, uint, int> RegisterFilter;

        [NativeTypeName("HRESULT (CLSID, LPCWSTR, CLSID *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, Guid, char*, Guid*, int> RegisterFilterInstance;

        [NativeTypeName("HRESULT (CLSID, LPCWSTR, BOOL, BOOL, BOOL, BOOL, CLSID, LPCWSTR) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, Guid, char*, BOOL, BOOL, BOOL, BOOL, Guid, char*, int> RegisterPin;

        [NativeTypeName("HRESULT (CLSID, LPCWSTR, CLSID, CLSID) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, Guid, char*, Guid, Guid, int> RegisterPinType;
        ...
        public delegate* unmanaged<TSelf*, Guid, char*, int> UnregisterPin;
