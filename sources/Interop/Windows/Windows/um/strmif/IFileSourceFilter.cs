...
public unsafe partial struct IFileSourceFilter : IFileSourceFilter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFileSourceFilter;
