...
public unsafe partial struct IAMTimecodeDisplay : IAMTimecodeDisplay.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMTimecodeDisplay;
