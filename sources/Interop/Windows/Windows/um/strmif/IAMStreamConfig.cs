...
public unsafe partial struct IAMStreamConfig : IAMStreamConfig.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAMStreamConfig;
