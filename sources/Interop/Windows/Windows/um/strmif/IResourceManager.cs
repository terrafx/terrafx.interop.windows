...
public unsafe partial struct IResourceManager : IResourceManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IResourceManager;
