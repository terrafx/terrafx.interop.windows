...
public unsafe partial struct IOleDocumentView : IOleDocumentView.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleDocumentView;
