...
public unsafe partial struct IContinueCallback : IContinueCallback.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IContinueCallback;
