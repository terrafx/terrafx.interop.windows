...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHlinkTarget);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, Guid*, void**, int>)(lpVtbl[0]))((IHlinkTarget*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, uint>)(lpVtbl[1]))((IHlinkTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, uint>)(lpVtbl[2]))((IHlinkTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, IHlinkBrowseContext*, int>)(lpVtbl[3]))((IHlinkTarget*)Unsafe.AsPointer(ref this), pihlbc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, IHlinkBrowseContext**, int>)(lpVtbl[4]))((IHlinkTarget*)Unsafe.AsPointer(ref this), ppihlbc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, uint, char*, int>)(lpVtbl[5]))((IHlinkTarget*)Unsafe.AsPointer(ref this), grfHLNF, pwzJumpLocation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, char*, uint, IMoniker**, int>)(lpVtbl[6]))((IHlinkTarget*)Unsafe.AsPointer(ref this), pwzLocation, dwAssign, ppimkLocation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkTarget*, char*, char**, int>)(lpVtbl[7]))((IHlinkTarget*)Unsafe.AsPointer(ref this), pwzLocation, ppwzFriendlyName);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, char*, int> Navigate;

        [NativeTypeName("HRESULT (LPCWSTR, DWORD, IMoniker **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, uint, IMoniker**, int> GetMoniker;

        [NativeTypeName("HRESULT (LPCWSTR, LPWSTR *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, char**, int> GetFriendlyName;
    }
}
