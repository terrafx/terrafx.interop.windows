...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHlinkFrame);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, Guid*, void**, int>)(lpVtbl[0]))((IHlinkFrame*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, uint>)(lpVtbl[1]))((IHlinkFrame*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, uint>)(lpVtbl[2]))((IHlinkFrame*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, IHlinkBrowseContext*, int>)(lpVtbl[3]))((IHlinkFrame*)Unsafe.AsPointer(ref this), pihlbc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, IHlinkBrowseContext**, int>)(lpVtbl[4]))((IHlinkFrame*)Unsafe.AsPointer(ref this), ppihlbc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, uint, IBindCtx*, IBindStatusCallback*, IHlink*, int>)(lpVtbl[5]))((IHlinkFrame*)Unsafe.AsPointer(ref this), grfHLNF, pbc, pibsc, pihlNavigate);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, uint, IMoniker*, char*, char*, uint, int>)(lpVtbl[6]))((IHlinkFrame*)Unsafe.AsPointer(ref this), grfHLNF, pimkTarget, pwzLocation, pwzFriendlyName, dwreserved);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHlinkFrame*, uint, IMoniker*, char*, char*, int>)(lpVtbl[7]))((IHlinkFrame*)Unsafe.AsPointer(ref this), uHLID, pimkTarget, pwzLocation, pwzFriendlyName);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IHlinkBrowseContext*, int> SetBrowseContext;

        [NativeTypeName("HRESULT (IHlinkBrowseContext **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IHlinkBrowseContext**, int> GetBrowseContext;

        [NativeTypeName("HRESULT (DWORD, LPBC, IBindStatusCallback *, IHlink *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, IBindCtx*, IBindStatusCallback*, IHlink*, int> Navigate;

        [NativeTypeName("HRESULT (DWORD, IMoniker *, LPCWSTR, LPCWSTR, DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, IMoniker*, char*, char*, uint, int> OnNavigate;
