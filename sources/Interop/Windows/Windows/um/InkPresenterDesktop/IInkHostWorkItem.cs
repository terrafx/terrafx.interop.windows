...
public unsafe partial struct IInkHostWorkItem : IInkHostWorkItem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInkHostWorkItem;
