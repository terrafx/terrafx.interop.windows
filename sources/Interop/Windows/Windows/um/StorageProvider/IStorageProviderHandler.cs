...
public unsafe partial struct IStorageProviderHandler : IStorageProviderHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IStorageProviderHandler;
