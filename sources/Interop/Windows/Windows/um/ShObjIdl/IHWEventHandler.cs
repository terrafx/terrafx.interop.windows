...
public unsafe partial struct IHWEventHandler : IHWEventHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHWEventHandler;
