...
public unsafe partial struct IResultsFolder : IResultsFolder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IResultsFolder;
