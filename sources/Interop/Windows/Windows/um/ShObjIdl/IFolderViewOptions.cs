...
public unsafe partial struct IFolderViewOptions : IFolderViewOptions.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFolderViewOptions;
