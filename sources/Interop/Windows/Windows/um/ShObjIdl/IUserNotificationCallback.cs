...
public unsafe partial struct IUserNotificationCallback : IUserNotificationCallback.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IUserNotificationCallback;
