...
public unsafe partial struct IPreviousVersionsInfo : IPreviousVersionsInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPreviousVersionsInfo;
