...
public unsafe partial struct IWizardExtension : IWizardExtension.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWizardExtension;
