...
public unsafe partial struct IDynamicHWHandler : IDynamicHWHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDynamicHWHandler;
