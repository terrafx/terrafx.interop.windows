...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IShellView3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, Guid*, void**, int>)(lpVtbl[0]))((IShellView3*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, uint>)(lpVtbl[1]))((IShellView3*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, uint>)(lpVtbl[2]))((IShellView3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, HWND*, int>)(lpVtbl[3]))((IShellView3*)Unsafe.AsPointer(ref this), phwnd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, BOOL, int>)(lpVtbl[4]))((IShellView3*)Unsafe.AsPointer(ref this), fEnterMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, MSG*, int>)(lpVtbl[5]))((IShellView3*)Unsafe.AsPointer(ref this), pmsg);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, BOOL, int>)(lpVtbl[6]))((IShellView3*)Unsafe.AsPointer(ref this), fEnable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, uint, int>)(lpVtbl[7]))((IShellView3*)Unsafe.AsPointer(ref this), uState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, int>)(lpVtbl[8]))((IShellView3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, IShellView*, FOLDERSETTINGS*, IShellBrowser*, RECT*, HWND*, int>)(lpVtbl[9]))((IShellView3*)Unsafe.AsPointer(ref this), psvPrevious, pfs, psb, prcView, phWnd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, int>)(lpVtbl[10]))((IShellView3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, FOLDERSETTINGS*, int>)(lpVtbl[11]))((IShellView3*)Unsafe.AsPointer(ref this), pfs);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, uint, delegate* unmanaged<HPROPSHEETPAGE, LPARAM, BOOL>, LPARAM, int>)(lpVtbl[12]))((IShellView3*)Unsafe.AsPointer(ref this), dwReserved, pfn, lparam);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, int>)(lpVtbl[13]))((IShellView3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, ITEMIDLIST*, uint, int>)(lpVtbl[14]))((IShellView3*)Unsafe.AsPointer(ref this), pidlItem, uFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, uint, Guid*, void**, int>)(lpVtbl[15]))((IShellView3*)Unsafe.AsPointer(ref this), uItem, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, Guid*, uint, int>)(lpVtbl[16]))((IShellView3*)Unsafe.AsPointer(ref this), pvid, uView);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, SV2CVW2_PARAMS*, int>)(lpVtbl[17]))((IShellView3*)Unsafe.AsPointer(ref this), lpParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, ITEMIDLIST*, int>)(lpVtbl[18]))((IShellView3*)Unsafe.AsPointer(ref this), pidlNew);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, ITEMIDLIST*, uint, POINT*, int>)(lpVtbl[19]))((IShellView3*)Unsafe.AsPointer(ref this), pidlItem, uFlags, ppt);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellView3*, IShellBrowser*, IShellView*, uint, FOLDERFLAGS, FOLDERFLAGS, FOLDERVIEWMODE, Guid*, RECT*, HWND*, int>)(lpVtbl[20]))((IShellView3*)Unsafe.AsPointer(ref this), psbOwner, psvPrev, dwViewFlags, dwMask, dwFlags, fvMode, pvid, prcView, phwndView);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IShellBrowser*, IShellView*, uint, FOLDERFLAGS, FOLDERFLAGS, FOLDERVIEWMODE, Guid*, RECT*, HWND*, int> CreateViewWindow3;
    }
}
