...
public unsafe partial struct IEnumReadyCallback : IEnumReadyCallback.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumReadyCallback;
