...
public unsafe partial struct IEnumTfLangBarItems : IEnumTfLangBarItems.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumTfLangBarItems;
