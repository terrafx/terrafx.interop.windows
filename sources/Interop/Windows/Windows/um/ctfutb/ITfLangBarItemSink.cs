...
public unsafe partial struct ITfLangBarItemSink : ITfLangBarItemSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfLangBarItemSink;
