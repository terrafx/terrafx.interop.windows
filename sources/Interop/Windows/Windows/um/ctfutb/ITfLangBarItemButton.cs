...
public unsafe partial struct ITfLangBarItemButton : ITfLangBarItemButton.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfLangBarItemButton;
