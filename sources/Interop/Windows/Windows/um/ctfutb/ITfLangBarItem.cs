...
public unsafe partial struct ITfLangBarItem : ITfLangBarItem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITfLangBarItem;
