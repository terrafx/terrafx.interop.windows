...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IHttpRequest3));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_REQUEST_V2*>)(lpVtbl[0]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_HEADER_ID, ushort*, sbyte*>)(lpVtbl[2]))((IHttpRequest3*)Unsafe.AsPointer(ref this), ulHeaderIndex, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*, ushort*, sbyte*>)(lpVtbl[3]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pszHeaderName, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*>)(lpVtbl[8]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, int>)(lpVtbl[12]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, char*>)(lpVtbl[13]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, SOCKADDR*>)(lpVtbl[14]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, SOCKADDR*>)(lpVtbl[15]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, ushort*, ushort*, void>)(lpVtbl[19]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pMajorVersion, pMinorVersion);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, uint>)(lpVtbl[22]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
