...
/// <include file='IHttpRequest3.xml' path='doc/member[@name="IHttpRequest3"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHttpRequest3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_REQUEST_V2*>)(lpVtbl[0]))((IHttpRequest3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_REQUEST_V2*>)(lpVtbl[1]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_HEADER_ID, ushort*, sbyte*>)(lpVtbl[2]))((IHttpRequest3*)Unsafe.AsPointer(in this), ulHeaderIndex, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*, ushort*, sbyte*>)(lpVtbl[3]))((IHttpRequest3*)Unsafe.AsPointer(in this), pszHeaderName, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_HEADER_ID, sbyte*, ushort, BOOL, int>)(lpVtbl[4]))((IHttpRequest3*)Unsafe.AsPointer(ref this), ulHeaderIndex, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*, sbyte*, ushort, BOOL, int>)(lpVtbl[5]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pszHeaderName, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_HEADER_ID, int>)(lpVtbl[6]))((IHttpRequest3*)Unsafe.AsPointer(ref this), ulHeaderIndex);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*, int>)(lpVtbl[7]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pszHeaderName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*>)(lpVtbl[8]))((IHttpRequest3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*, int>)(lpVtbl[9]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pszHttpMethod);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, sbyte*, uint, BOOL, int>)(lpVtbl[10]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pszUrl, cchUrl, fResetQueryString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, char*, uint, BOOL, int>)(lpVtbl[11]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pszUrl, cchUrl, fResetQueryString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, int>)(lpVtbl[12]))((IHttpRequest3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, char*>)(lpVtbl[13]))((IHttpRequest3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, SOCKADDR*>)(lpVtbl[14]))((IHttpRequest3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, SOCKADDR*>)(lpVtbl[15]))((IHttpRequest3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, void*, uint, BOOL, uint*, BOOL*, int>)(lpVtbl[16]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pvBuffer, cbBuffer, fAsync, pcbBytesReceived, pfCompletionPending);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, void*, uint, int>)(lpVtbl[17]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pvBuffer, cbBuffer);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, uint>)(lpVtbl[18]))((IHttpRequest3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, ushort*, ushort*, void>)(lpVtbl[19]))((IHttpRequest3*)Unsafe.AsPointer(in this), pMajorVersion, pMinorVersion);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, HTTP_SSL_CLIENT_CERT_INFO**, BOOL*, int>)(lpVtbl[20]))((IHttpRequest3*)Unsafe.AsPointer(ref this), ppClientCertInfo, pfClientCertNegotiated);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, BOOL, BOOL*, int>)(lpVtbl[21]))((IHttpRequest3*)Unsafe.AsPointer(ref this), fAsync, pfCompletionPending);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, uint>)(lpVtbl[22]))((IHttpRequest3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, uint, uint*, sbyte**, uint*, sbyte***, sbyte***, uint*, uint*, uint**, int>)(lpVtbl[23]))((IHttpRequest3*)Unsafe.AsPointer(ref this), dwOldChangeNumber, pdwNewChangeNumber, knownHeaderSnapshot, pdwUnknownHeaderSnapshot, ppUnknownHeaderNameSnapshot, ppUnknownHeaderValueSnapshot, diffedKnownHeaderIndices, pdwDiffedUnknownHeaders, ppDiffedUnknownHeaderIndices);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, byte**, uint*, int>)(lpVtbl[24]))((IHttpRequest3*)Unsafe.AsPointer(ref this), ppToken, pTokenSize);
    }

    /// <include file='IHttpRequest3.xml' path='doc/member[@name="IHttpRequest3.ReadEntityBody"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(25)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest3*, void*, uint, BOOL, delegate* unmanaged<IHttpContext3*, IHttpCompletionInfo2*, void*, REQUEST_NOTIFICATION_STATUS>, void*, uint*, BOOL*, int>)(lpVtbl[25]))((IHttpRequest3*)Unsafe.AsPointer(ref this), pvBuffer, cbBuffer, fAsync, pfnCompletionCallback, pvCompletionContext, pcbBytesReceived, pfCompletionPending);
    }
