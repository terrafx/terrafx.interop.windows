...
public unsafe partial struct IHttpResponse : IHttpResponse.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, HTTP_RESPONSE_V2*>)(lpVtbl[1]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, IHttpCachePolicy*>)(lpVtbl[2]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, ushort, sbyte*, ushort, HRESULT, IAppHostConfigException*, BOOL, int>)(lpVtbl[3]))((IHttpResponse*)Unsafe.AsPointer(ref this), statusCode, pszReason, uSubStatus, hrErrorToReport, pException, fTrySkipCustomErrors);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, HTTP_HEADER_ID, sbyte*, ushort, BOOL, int>)(lpVtbl[4]))((IHttpResponse*)Unsafe.AsPointer(ref this), ulHeaderIndex, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, sbyte*, sbyte*, ushort, BOOL, int>)(lpVtbl[5]))((IHttpResponse*)Unsafe.AsPointer(ref this), pszHeaderName, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, HTTP_HEADER_ID, int>)(lpVtbl[6]))((IHttpResponse*)Unsafe.AsPointer(ref this), ulHeaderIndex);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, sbyte*, int>)(lpVtbl[7]))((IHttpResponse*)Unsafe.AsPointer(ref this), pszHeaderName);
    }
    ...
    public void Clear()
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, void>)(lpVtbl[10]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, void>)(lpVtbl[11]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, void>)(lpVtbl[12]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, void>)(lpVtbl[13]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, uint, void>)(lpVtbl[14]))((IHttpResponse*)Unsafe.AsPointer(ref this), reason);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, void>)(lpVtbl[16]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, BOOL, BOOL, uint*, BOOL*, int>)(lpVtbl[18]))((IHttpResponse*)Unsafe.AsPointer(ref this), fAsync, fMoreData, pcbSent, pfCompletionExpected);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, sbyte*, BOOL, BOOL, int>)(lpVtbl[19]))((IHttpResponse*)Unsafe.AsPointer(ref this), pszUrl, fResetStatusCode, fIncludeParameters);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, HTTP_DATA_CHUNK*, int, int>)(lpVtbl[20]))((IHttpResponse*)Unsafe.AsPointer(ref this), pDataChunk, lInsertPosition);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, HTTP_DATA_CHUNK*, uint, BOOL, BOOL, uint*, BOOL*, int>)(lpVtbl[21]))((IHttpResponse*)Unsafe.AsPointer(ref this), pDataChunks, nChunks, fAsync, fMoreData, pcbSent, pfCompletionExpected);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, void>)(lpVtbl[22]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, ushort*, ushort*, sbyte**, ushort*, HRESULT*, char**, uint*, IAppHostConfigException**, BOOL*, void>)(lpVtbl[23]))((IHttpResponse*)Unsafe.AsPointer(ref this), pStatusCode, pSubStatus, ppszReason, pcchReason, phrErrorToReport, ppszModule, pdwNotification, ppException, pfTrySkipCustomErrors);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, char*, uint, BOOL, int>)(lpVtbl[24]))((IHttpResponse*)Unsafe.AsPointer(ref this), pszDescription, cchDescription, fHtmlEncode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, uint*, char*>)(lpVtbl[25]))((IHttpResponse*)Unsafe.AsPointer(ref this), pcchDescription);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse*, uint, uint*, sbyte**, uint*, sbyte***, sbyte***, uint*, uint*, uint**, int>)(lpVtbl[26]))((IHttpResponse*)Unsafe.AsPointer(ref this), dwOldChangeNumber, pdwNewChangeNumber, knownHeaderSnapshot, pdwUnknownHeaderSnapshot, ppUnknownHeaderNameSnapshot, ppUnknownHeaderValueSnapshot, diffedKnownHeaderIndices, pdwDiffedUnknownHeaders, ppDiffedUnknownHeaderIndices);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse*, void>)(lpVtbl[27]))((IHttpResponse*)Unsafe.AsPointer(ref this));
    }
    ...
    public interface Interface
    {
        ...
        [VtblIndex(3)]
        HRESULT SetStatus(ushort statusCode, [NativeTypeName("PCSTR")] sbyte* pszReason, [Optional] ushort uSubStatus, [Optional, DefaultParameterValue(0)] HRESULT hrErrorToReport, [Optional] IAppHostConfigException* pException, [Optional] BOOL fTrySkipCustomErrors);
        ...
        [VtblIndex(18)]
        HRESULT Flush(BOOL fAsync, BOOL fMoreData, [NativeTypeName("DWORD *")] uint* pcbSent, BOOL* pfCompletionExpected = null);

        [VtblIndex(19)]
        HRESULT Redirect([NativeTypeName("PCSTR")] sbyte* pszUrl, [Optional, DefaultParameterValue(1)] BOOL fResetStatusCode, [Optional] BOOL fIncludeParameters);

        [VtblIndex(20)]
        HRESULT WriteEntityChunkByReference(HTTP_DATA_CHUNK* pDataChunk, [NativeTypeName("LONG")] int lInsertPosition = -1);

        [VtblIndex(21)]
        HRESULT WriteEntityChunks(HTTP_DATA_CHUNK* pDataChunks, [NativeTypeName("DWORD")] uint nChunks, BOOL fAsync, BOOL fMoreData, [NativeTypeName("DWORD *")] uint* pcbSent, BOOL* pfCompletionExpected = null);

        [VtblIndex(22)]
        void DisableBuffering();

        [VtblIndex(23)]
        void GetStatus(ushort* pStatusCode, ushort* pSubStatus = null, [NativeTypeName("PCSTR *")] sbyte** ppszReason = null, ushort* pcchReason = null, HRESULT* phrErrorToReport = null, [NativeTypeName("PCWSTR *")] char** ppszModule = null, [NativeTypeName("DWORD *")] uint* pdwNotification = null, IAppHostConfigException** ppException = null, BOOL* pfTrySkipCustomErrors = null);

        [VtblIndex(24)]
        HRESULT SetErrorDescription([NativeTypeName("PCWSTR")] char* pszDescription, [NativeTypeName("DWORD")] uint cchDescription, [Optional, DefaultParameterValue(1)] BOOL fHtmlEncode);
