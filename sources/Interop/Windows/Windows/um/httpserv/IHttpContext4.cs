...
/// <include file='IHttpContext4.xml' path='doc/member[@name="IHttpContext4"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHttpContext4);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpSite*>)(lpVtbl[0]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpApplication*>)(lpVtbl[1]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpConnection*>)(lpVtbl[2]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpRequest*>)(lpVtbl[3]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpResponse*>)(lpVtbl[4]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, int>)(lpVtbl[5]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpUser*>)(lpVtbl[6]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpModuleContextContainer*>)(lpVtbl[7]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpContext4*, REQUEST_NOTIFICATION_STATUS, void>)(lpVtbl[8]))((IHttpContext4*)Unsafe.AsPointer(ref this), notificationStatus);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint, int>)(lpVtbl[9]))((IHttpContext4*)Unsafe.AsPointer(ref this), cbBytes);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint, uint, void>)(lpVtbl[10]))((IHttpContext4*)Unsafe.AsPointer(ref this), dwNotifications, dwPostNotifications);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, REQUEST_NOTIFICATION_STATUS, uint*, BOOL*, CHttpModule**, IHttpEventProvider**, int>)(lpVtbl[11]))((IHttpContext4*)Unsafe.AsPointer(ref this), status, pdwNotification, pfIsPostNotification, ppModuleInfo, ppRequestOutput);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, REQUEST_NOTIFICATION_STATUS, int>)(lpVtbl[12]))((IHttpContext4*)Unsafe.AsPointer(ref this), status);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, BOOL, IHttpContext*, uint, IHttpUser*, BOOL*, int>)(lpVtbl[13]))((IHttpContext4*)Unsafe.AsPointer(ref this), fAsync, pHttpContext, dwExecuteFlags, pHttpUser, pfCompletionExpected);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint>)(lpVtbl[14]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, sbyte*, sbyte**, uint*, int>)(lpVtbl[15]))((IHttpContext4*)Unsafe.AsPointer(ref this), pszVariableName, ppszValue, pcchValueLength);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, sbyte*, char**, uint*, int>)(lpVtbl[16]))((IHttpContext4*)Unsafe.AsPointer(ref this), pszVariableName, ppszValue, pcchValueLength);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, sbyte*, char*, int>)(lpVtbl[17]))((IHttpContext4*)Unsafe.AsPointer(ref this), pszVariableName, pszVariableValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint, void*>)(lpVtbl[18]))((IHttpContext4*)Unsafe.AsPointer(ref this), cbAllocation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpUrlInfo*>)(lpVtbl[19]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IMetadataInfo*>)(lpVtbl[20]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint*, char*>)(lpVtbl[21]))((IHttpContext4*)Unsafe.AsPointer(ref this), pcchPhysicalPath);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint*, char*>)(lpVtbl[22]))((IHttpContext4*)Unsafe.AsPointer(in this), pcchScriptName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint*, char*>)(lpVtbl[23]))((IHttpContext4*)Unsafe.AsPointer(ref this), pcchScriptTranslated);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IScriptMapInfo*>)(lpVtbl[24]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpContext4*, void>)(lpVtbl[25]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpFileInfo*>)(lpVtbl[26]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, char*, char*, uint*, int>)(lpVtbl[27]))((IHttpContext4*)Unsafe.AsPointer(ref this), pszUrl, pszPhysicalPath, pcbPhysicalPath);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, ICustomNotificationProvider*, BOOL*, int>)(lpVtbl[28]))((IHttpContext4*)Unsafe.AsPointer(ref this), pCustomOutput, pfCompletionExpected);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpContext*>)(lpVtbl[29]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpContext*>)(lpVtbl[30]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint, IHttpContext**, int>)(lpVtbl[31]))((IHttpContext4*)Unsafe.AsPointer(ref this), dwCloneFlags, ppHttpContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, int>)(lpVtbl[32]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint*, uint*, char**, uint*, uint*, uint*, int>)(lpVtbl[33]))((IHttpContext4*)Unsafe.AsPointer(in this), pdwNotification, pdwNotificationStartTickCount, ppszModule, pdwModuleStartTickCount, pdwAsyncNotification, pdwAsyncNotificationStartTickCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpTraceContext*>)(lpVtbl[34]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint, uint*, uint*, sbyte***, char***, uint*, uint**, int>)(lpVtbl[35]))((IHttpContext4*)Unsafe.AsPointer(ref this), dwOldChangeNumber, pdwNewChangeNumber, pdwVariableSnapshot, ppVariableNameSnapshot, ppVariableValueSnapshot, pdwDiffedVariables, ppDiffedVariableIndices);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, int>)(lpVtbl[36]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint, char*, char*, sbyte*, IScriptMapInfo**, BOOL, int>)(lpVtbl[37]))((IHttpContext4*)Unsafe.AsPointer(ref this), dwSiteId, pszSiteName, pszUrl, pszVerb, ppScriptMap, fIgnoreWildcardMappings);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, HTTP_CONTEXT_INTERFACE_VERSION, void**, int>)(lpVtbl[38]))((IHttpContext4*)Unsafe.AsPointer(ref this), version, ppInterface);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, IHttpUser*>)(lpVtbl[39]))((IHttpContext4*)Unsafe.AsPointer(in this));
    }

    /// <inheritdoc cref="IHttpContext3.GetNamedContextContainer" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(40)]
    public INamedContextContainer* GetNamedContextContainer()
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, INamedContextContainer*>)(lpVtbl[40]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }

    /// <inheritdoc cref="IHttpContext3.EnableFullDuplex" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(41)]
    public void EnableFullDuplex()
    {
        ((delegate* unmanaged[MemberFunction]<IHttpContext4*, void>)(lpVtbl[41]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }

    /// <inheritdoc cref="IHttpContext3.InheritServerVariable" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(42)]
    public HRESULT InheritServerVariable([NativeTypeName("PCSTR")] sbyte* szName, [Optional] BOOL fFailIfNotExist)
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, sbyte*, BOOL, int>)(lpVtbl[42]))((IHttpContext4*)Unsafe.AsPointer(ref this), szName, fFailIfNotExist);
    }

    /// <inheritdoc cref="IHttpContext3.PostCompletion" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(43)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, uint, delegate* unmanaged<uint, uint, OVERLAPPED*, void>, void*, int>)(lpVtbl[43]))((IHttpContext4*)Unsafe.AsPointer(ref this), cbBytes, pfnCompletionRoutine, pvCompletionContext);
    }

    /// <include file='IHttpContext4.xml' path='doc/member[@name="IHttpContext4.GetRequestStartTime"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(44)]
    [return: NativeTypeName("ULONGLONG")]
    public ulong GetRequestStartTime()
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, ulong>)(lpVtbl[44]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }

    /// <include file='IHttpContext4.xml' path='doc/member[@name="IHttpContext4.GetRequestElapsedTime"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(45)]
    [return: NativeTypeName("ULONGLONG")]
    public ulong GetRequestElapsedTime()
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext4*, ulong>)(lpVtbl[45]))((IHttpContext4*)Unsafe.AsPointer(ref this));
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, ulong> GetRequestStartTime;

        [NativeTypeName("ULONGLONG ()")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ulong> GetRequestElapsedTime;
    }
}
