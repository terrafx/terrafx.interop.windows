...
/// <include file='IHttpRequest4.xml' path='doc/member[@name="IHttpRequest4"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHttpRequest4);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, HTTP_REQUEST_V2*>)(lpVtbl[0]))((IHttpRequest4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, HTTP_REQUEST_V2*>)(lpVtbl[1]))((IHttpRequest4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, HTTP_HEADER_ID, ushort*, sbyte*>)(lpVtbl[2]))((IHttpRequest4*)Unsafe.AsPointer(in this), ulHeaderIndex, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, sbyte*, ushort*, sbyte*>)(lpVtbl[3]))((IHttpRequest4*)Unsafe.AsPointer(in this), pszHeaderName, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, HTTP_HEADER_ID, sbyte*, ushort, BOOL, int>)(lpVtbl[4]))((IHttpRequest4*)Unsafe.AsPointer(ref this), ulHeaderIndex, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, sbyte*, sbyte*, ushort, BOOL, int>)(lpVtbl[5]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pszHeaderName, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, HTTP_HEADER_ID, int>)(lpVtbl[6]))((IHttpRequest4*)Unsafe.AsPointer(ref this), ulHeaderIndex);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, sbyte*, int>)(lpVtbl[7]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pszHeaderName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, sbyte*>)(lpVtbl[8]))((IHttpRequest4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, sbyte*, int>)(lpVtbl[9]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pszHttpMethod);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, sbyte*, uint, BOOL, int>)(lpVtbl[10]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pszUrl, cchUrl, fResetQueryString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, char*, uint, BOOL, int>)(lpVtbl[11]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pszUrl, cchUrl, fResetQueryString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, int>)(lpVtbl[12]))((IHttpRequest4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, char*>)(lpVtbl[13]))((IHttpRequest4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, SOCKADDR*>)(lpVtbl[14]))((IHttpRequest4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, SOCKADDR*>)(lpVtbl[15]))((IHttpRequest4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, void*, uint, BOOL, uint*, BOOL*, int>)(lpVtbl[16]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pvBuffer, cbBuffer, fAsync, pcbBytesReceived, pfCompletionPending);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, void*, uint, int>)(lpVtbl[17]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pvBuffer, cbBuffer);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, uint>)(lpVtbl[18]))((IHttpRequest4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, ushort*, ushort*, void>)(lpVtbl[19]))((IHttpRequest4*)Unsafe.AsPointer(in this), pMajorVersion, pMinorVersion);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, HTTP_SSL_CLIENT_CERT_INFO**, BOOL*, int>)(lpVtbl[20]))((IHttpRequest4*)Unsafe.AsPointer(ref this), ppClientCertInfo, pfClientCertNegotiated);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, BOOL, BOOL*, int>)(lpVtbl[21]))((IHttpRequest4*)Unsafe.AsPointer(ref this), fAsync, pfCompletionPending);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, uint>)(lpVtbl[22]))((IHttpRequest4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, uint, uint*, sbyte**, uint*, sbyte***, sbyte***, uint*, uint*, uint**, int>)(lpVtbl[23]))((IHttpRequest4*)Unsafe.AsPointer(ref this), dwOldChangeNumber, pdwNewChangeNumber, knownHeaderSnapshot, pdwUnknownHeaderSnapshot, ppUnknownHeaderNameSnapshot, ppUnknownHeaderValueSnapshot, diffedKnownHeaderIndices, pdwDiffedUnknownHeaders, ppDiffedUnknownHeaderIndices);
    }

    /// <inheritdoc cref="IHttpRequest2.GetChannelBindingToken" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(24)]
    public HRESULT GetChannelBindingToken([NativeTypeName("PBYTE *")] byte** ppToken, [NativeTypeName("DWORD *")] uint* pTokenSize)
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, byte**, uint*, int>)(lpVtbl[24]))((IHttpRequest4*)Unsafe.AsPointer(ref this), ppToken, pTokenSize);
    }

    /// <inheritdoc cref="IHttpRequest3.ReadEntityBody" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(25)]
    public HRESULT ReadEntityBody(void* pvBuffer, [NativeTypeName("DWORD")] uint cbBuffer, BOOL fAsync, [NativeTypeName("PFN_ASYNC_COMPLETION")] delegate* unmanaged<IHttpContext3*, IHttpCompletionInfo2*, void*, REQUEST_NOTIFICATION_STATUS> pfnCompletionCallback, void* pvCompletionContext, [NativeTypeName("DWORD *")] uint* pcbBytesReceived, BOOL* pfCompletionPending = null)
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, void*, uint, BOOL, delegate* unmanaged<IHttpContext3*, IHttpCompletionInfo2*, void*, REQUEST_NOTIFICATION_STATUS>, void*, uint*, BOOL*, int>)(lpVtbl[25]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pvBuffer, cbBuffer, fAsync, pfnCompletionCallback, pvCompletionContext, pcbBytesReceived, pfCompletionPending);
    }

    /// <include file='IHttpRequest4.xml' path='doc/member[@name="IHttpRequest4.ReadEntityBody"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(26)]
    public HRESULT ReadEntityBody(void* pvBuffer, [NativeTypeName("DWORD")] uint cbBuffer, BOOL fAsync, [NativeTypeName("ULONG")] uint ulFlags, [NativeTypeName("DWORD *")] uint* pcbBytesReceived, BOOL* pfCompletionPending = null)
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpRequest4*, void*, uint, BOOL, uint, uint*, BOOL*, int>)(lpVtbl[26]))((IHttpRequest4*)Unsafe.AsPointer(ref this), pvBuffer, cbBuffer, fAsync, ulFlags, pcbBytesReceived, pfCompletionPending);
    }

    public interface Interface : IHttpRequest3.Interface
    {
        [VtblIndex(26)]
        HRESULT ReadEntityBody(void* pvBuffer, [NativeTypeName("DWORD")] uint cbBuffer, BOOL fAsync, [NativeTypeName("ULONG")] uint ulFlags, [NativeTypeName("DWORD *")] uint* pcbBytesReceived, BOOL* pfCompletionPending = null);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName("HRESULT (void *, DWORD, BOOL, PFN_ASYNC_COMPLETION, void *, DWORD *, BOOL *)")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, uint, BOOL, delegate* unmanaged<IHttpContext3*, IHttpCompletionInfo2*, void*, REQUEST_NOTIFICATION_STATUS>, void*, uint*, BOOL*, int> ReadEntityBody1;

        [NativeTypeName("HRESULT (void *, DWORD, BOOL, ULONG, DWORD *, BOOL *)")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, uint, BOOL, uint, uint*, BOOL*, int> ReadEntityBody2;
    }
}
