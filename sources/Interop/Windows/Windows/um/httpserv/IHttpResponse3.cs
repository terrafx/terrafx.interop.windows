...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IHttpResponse3));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_RESPONSE_V2*>)(lpVtbl[0]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_HEADER_ID, ushort*, sbyte*>)(lpVtbl[8]))((IHttpResponse3*)Unsafe.AsPointer(ref this), ulHeaderIndex, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, sbyte*, ushort*, sbyte*>)(lpVtbl[9]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pszHeaderName, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, int>)(lpVtbl[15]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, int>)(lpVtbl[17]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
