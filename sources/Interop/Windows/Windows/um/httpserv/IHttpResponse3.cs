...
/// <include file='IHttpResponse3.xml' path='doc/member[@name="IHttpResponse3"]/*' />
[Guid("19578E49-D080-45DA-B673-96CB475D3C5D")]
[NativeTypeName("struct IHttpResponse3 : IHttpResponse2")]
[NativeInheritance("IHttpResponse2")]
public unsafe partial struct IHttpResponse3 : IHttpResponse3.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHttpResponse3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_RESPONSE_V2*>)(lpVtbl[0]))((IHttpResponse3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_RESPONSE_V2*>)(lpVtbl[1]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, IHttpCachePolicy*>)(lpVtbl[2]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, ushort, sbyte*, ushort, HRESULT, IAppHostConfigException*, BOOL, int>)(lpVtbl[3]))((IHttpResponse3*)Unsafe.AsPointer(ref this), statusCode, pszReason, uSubStatus, hrErrorToReport, pException, fTrySkipCustomErrors);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_HEADER_ID, sbyte*, ushort, BOOL, int>)(lpVtbl[4]))((IHttpResponse3*)Unsafe.AsPointer(ref this), ulHeaderIndex, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, sbyte*, sbyte*, ushort, BOOL, int>)(lpVtbl[5]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pszHeaderName, pszHeaderValue, cchHeaderValue, fReplace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_HEADER_ID, int>)(lpVtbl[6]))((IHttpResponse3*)Unsafe.AsPointer(ref this), ulHeaderIndex);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, sbyte*, int>)(lpVtbl[7]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pszHeaderName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_HEADER_ID, ushort*, sbyte*>)(lpVtbl[8]))((IHttpResponse3*)Unsafe.AsPointer(in this), ulHeaderIndex, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, sbyte*, ushort*, sbyte*>)(lpVtbl[9]))((IHttpResponse3*)Unsafe.AsPointer(in this), pszHeaderName, pcchHeaderValue);
    }
    ...
    public void Clear()
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, void>)(lpVtbl[10]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, void>)(lpVtbl[11]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, void>)(lpVtbl[12]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, void>)(lpVtbl[13]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, uint, void>)(lpVtbl[14]))((IHttpResponse3*)Unsafe.AsPointer(ref this), reason);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, int>)(lpVtbl[15]))((IHttpResponse3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, void>)(lpVtbl[16]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, int>)(lpVtbl[17]))((IHttpResponse3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, BOOL, BOOL, uint*, BOOL*, int>)(lpVtbl[18]))((IHttpResponse3*)Unsafe.AsPointer(ref this), fAsync, fMoreData, pcbSent, pfCompletionExpected);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, sbyte*, BOOL, BOOL, int>)(lpVtbl[19]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pszUrl, fResetStatusCode, fIncludeParameters);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_DATA_CHUNK*, int, int>)(lpVtbl[20]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pDataChunk, lInsertPosition);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_DATA_CHUNK*, uint, BOOL, BOOL, uint*, BOOL*, int>)(lpVtbl[21]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pDataChunks, nChunks, fAsync, fMoreData, pcbSent, pfCompletionExpected);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, void>)(lpVtbl[22]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, ushort*, ushort*, sbyte**, ushort*, HRESULT*, char**, uint*, IAppHostConfigException**, BOOL*, void>)(lpVtbl[23]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pStatusCode, pSubStatus, ppszReason, pcchReason, phrErrorToReport, ppszModule, pdwNotification, ppException, pfTrySkipCustomErrors);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, char*, uint, BOOL, int>)(lpVtbl[24]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pszDescription, cchDescription, fHtmlEncode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, uint*, char*>)(lpVtbl[25]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pcchDescription);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, uint, uint*, sbyte**, uint*, sbyte***, sbyte***, uint*, uint*, uint**, int>)(lpVtbl[26]))((IHttpResponse3*)Unsafe.AsPointer(ref this), dwOldChangeNumber, pdwNewChangeNumber, knownHeaderSnapshot, pdwUnknownHeaderSnapshot, ppUnknownHeaderNameSnapshot, ppUnknownHeaderValueSnapshot, diffedKnownHeaderIndices, pdwDiffedUnknownHeaders, ppDiffedUnknownHeaderIndices);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, void>)(lpVtbl[27]))((IHttpResponse3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, HTTP_DATA_CHUNK*, uint, BOOL, BOOL, delegate* unmanaged<IHttpContext3*, IHttpCompletionInfo2*, void*, REQUEST_NOTIFICATION_STATUS>, void*, uint*, BOOL*, int>)(lpVtbl[28]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pDataChunks, nChunks, fAsync, fMoreData, pfnCompletionCallback, pvCompletionContext, pcbSent, pfCompletionExpected);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, BOOL, BOOL, delegate* unmanaged<IHttpContext3*, IHttpCompletionInfo2*, void*, REQUEST_NOTIFICATION_STATUS>, void*, uint*, BOOL*, int>)(lpVtbl[29]))((IHttpResponse3*)Unsafe.AsPointer(ref this), fAsync, fMoreData, pfnCompletionCallback, pvCompletionContext, pcbSent, pfCompletionExpected);
    }

    /// <include file='IHttpResponse3.xml' path='doc/member[@name="IHttpResponse3.PushPromise"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(30)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpResponse3*, sbyte*, char*, char*, uint, sbyte**, sbyte**, int>)(lpVtbl[30]))((IHttpResponse3*)Unsafe.AsPointer(ref this), pszVerb, pwszPath, pwszQuery, cHeaders, rgHeaderNames, rgHeaderValues);
    }

    public interface Interface : IHttpResponse2.Interface
    {
        [VtblIndex(30)]
        HRESULT PushPromise([NativeTypeName("PCSTR")] sbyte* pszVerb, [NativeTypeName("PCWSTR")] char* pwszPath, [NativeTypeName("PCWSTR")] char* pwszQuery, [NativeTypeName("DWORD")] uint cHeaders, [NativeTypeName("PCSTR *")] sbyte** rgHeaderNames, [NativeTypeName("PCSTR *")] sbyte** rgHeaderValues);
    }
