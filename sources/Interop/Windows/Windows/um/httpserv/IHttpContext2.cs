...
/// <include file='IHttpContext2.xml' path='doc/member[@name="IHttpContext2"]/*' />
...
public unsafe partial struct IHttpContext2 : IHttpContext2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IHttpSite*>)(lpVtbl[0]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IHttpApplication*>)(lpVtbl[1]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IHttpConnection*>)(lpVtbl[2]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IHttpRequest*>)(lpVtbl[3]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IHttpResponse*>)(lpVtbl[4]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IHttpModuleContextContainer*>)(lpVtbl[7]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpContext2*, REQUEST_NOTIFICATION_STATUS, void>)(lpVtbl[8]))((IHttpContext2*)Unsafe.AsPointer(ref this), notificationStatus);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint, int>)(lpVtbl[9]))((IHttpContext2*)Unsafe.AsPointer(ref this), cbBytes);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint, uint, void>)(lpVtbl[10]))((IHttpContext2*)Unsafe.AsPointer(ref this), dwNotifications, dwPostNotifications);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, REQUEST_NOTIFICATION_STATUS, uint*, BOOL*, CHttpModule**, IHttpEventProvider**, int>)(lpVtbl[11]))((IHttpContext2*)Unsafe.AsPointer(ref this), status, pdwNotification, pfIsPostNotification, ppModuleInfo, ppRequestOutput);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, REQUEST_NOTIFICATION_STATUS, int>)(lpVtbl[12]))((IHttpContext2*)Unsafe.AsPointer(ref this), status);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, BOOL, IHttpContext*, uint, IHttpUser*, BOOL*, int>)(lpVtbl[13]))((IHttpContext2*)Unsafe.AsPointer(ref this), fAsync, pHttpContext, dwExecuteFlags, pHttpUser, pfCompletionExpected);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, sbyte*, sbyte**, uint*, int>)(lpVtbl[15]))((IHttpContext2*)Unsafe.AsPointer(ref this), pszVariableName, ppszValue, pcchValueLength);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, sbyte*, char**, uint*, int>)(lpVtbl[16]))((IHttpContext2*)Unsafe.AsPointer(ref this), pszVariableName, ppszValue, pcchValueLength);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, sbyte*, char*, int>)(lpVtbl[17]))((IHttpContext2*)Unsafe.AsPointer(ref this), pszVariableName, pszVariableValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint, void*>)(lpVtbl[18]))((IHttpContext2*)Unsafe.AsPointer(ref this), cbAllocation);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IHttpUrlInfo*>)(lpVtbl[19]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, IMetadataInfo*>)(lpVtbl[20]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint*, char*>)(lpVtbl[21]))((IHttpContext2*)Unsafe.AsPointer(ref this), pcchPhysicalPath);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint*, char*>)(lpVtbl[23]))((IHttpContext2*)Unsafe.AsPointer(ref this), pcchScriptTranslated);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IHttpContext2*, void>)(lpVtbl[25]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, char*, char*, uint*, int>)(lpVtbl[27]))((IHttpContext2*)Unsafe.AsPointer(ref this), pszUrl, pszPhysicalPath, pcbPhysicalPath);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, ICustomNotificationProvider*, BOOL*, int>)(lpVtbl[28]))((IHttpContext2*)Unsafe.AsPointer(ref this), pCustomOutput, pfCompletionExpected);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint, IHttpContext**, int>)(lpVtbl[31]))((IHttpContext2*)Unsafe.AsPointer(ref this), dwCloneFlags, ppHttpContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, int>)(lpVtbl[32]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint, uint*, uint*, sbyte***, char***, uint*, uint**, int>)(lpVtbl[35]))((IHttpContext2*)Unsafe.AsPointer(ref this), dwOldChangeNumber, pdwNewChangeNumber, pdwVariableSnapshot, ppVariableNameSnapshot, ppVariableValueSnapshot, pdwDiffedVariables, ppDiffedVariableIndices);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, int>)(lpVtbl[36]))((IHttpContext2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, uint, char*, char*, sbyte*, IScriptMapInfo**, BOOL, int>)(lpVtbl[37]))((IHttpContext2*)Unsafe.AsPointer(ref this), dwSiteId, pszSiteName, pszUrl, pszVerb, ppScriptMap, fIgnoreWildcardMappings);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext2*, HTTP_CONTEXT_INTERFACE_VERSION, void**, int>)(lpVtbl[38]))((IHttpContext2*)Unsafe.AsPointer(ref this), version, ppInterface);
    }
