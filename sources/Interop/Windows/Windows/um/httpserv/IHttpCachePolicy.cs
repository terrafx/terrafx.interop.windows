...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHttpCachePolicy);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpCachePolicy*, sbyte*>)(lpVtbl[4]))((IHttpCachePolicy*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpCachePolicy*, sbyte*>)(lpVtbl[6]))((IHttpCachePolicy*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpCachePolicy*, sbyte*>)(lpVtbl[8]))((IHttpCachePolicy*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpCachePolicy*, int>)(lpVtbl[9]))((IHttpCachePolicy*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpCachePolicy*, int>)(lpVtbl[11]))((IHttpCachePolicy*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpCachePolicy*, int>)(lpVtbl[13]))((IHttpCachePolicy*)Unsafe.AsPointer(in this));
    }
