...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IHttpContext3));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, int>)(lpVtbl[5]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, IHttpUser*>)(lpVtbl[6]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, uint>)(lpVtbl[14]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, uint*, char*>)(lpVtbl[22]))((IHttpContext3*)Unsafe.AsPointer(ref this), pcchScriptName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, IScriptMapInfo*>)(lpVtbl[24]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, IHttpFileInfo*>)(lpVtbl[26]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, IHttpContext*>)(lpVtbl[29]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, IHttpContext*>)(lpVtbl[30]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, uint*, uint*, char**, uint*, uint*, uint*, int>)(lpVtbl[33]))((IHttpContext3*)Unsafe.AsPointer(ref this), pdwNotification, pdwNotificationStartTickCount, ppszModule, pdwModuleStartTickCount, pdwAsyncNotification, pdwAsyncNotificationStartTickCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, IHttpTraceContext*>)(lpVtbl[34]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHttpContext3*, IHttpUser*>)(lpVtbl[39]))((IHttpContext3*)Unsafe.AsPointer(ref this));
    }
