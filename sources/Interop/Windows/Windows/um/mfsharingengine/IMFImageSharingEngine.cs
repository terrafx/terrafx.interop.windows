...
public unsafe partial struct IMFImageSharingEngine : IMFImageSharingEngine.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFImageSharingEngine;
