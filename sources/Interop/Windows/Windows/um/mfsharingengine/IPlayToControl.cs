...
public unsafe partial struct IPlayToControl : IPlayToControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPlayToControl;
