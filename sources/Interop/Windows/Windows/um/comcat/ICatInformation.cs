...
public unsafe partial struct ICatInformation : ICatInformation.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICatInformation;
