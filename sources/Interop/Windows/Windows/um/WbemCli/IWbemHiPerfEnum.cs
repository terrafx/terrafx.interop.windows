...
public unsafe partial struct IWbemHiPerfEnum : IWbemHiPerfEnum.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWbemHiPerfEnum;
