...
public unsafe partial struct IWbemQualifierSet : IWbemQualifierSet.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWbemQualifierSet;
