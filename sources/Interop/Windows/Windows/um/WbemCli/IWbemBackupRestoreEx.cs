...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IWbemBackupRestoreEx);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWbemBackupRestoreEx*, Guid*, void**, int>)(lpVtbl[0]))((IWbemBackupRestoreEx*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IWbemBackupRestoreEx*, uint>)(lpVtbl[1]))((IWbemBackupRestoreEx*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IWbemBackupRestoreEx*, uint>)(lpVtbl[2]))((IWbemBackupRestoreEx*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWbemBackupRestoreEx*, char*, int, int>)(lpVtbl[3]))((IWbemBackupRestoreEx*)Unsafe.AsPointer(ref this), strBackupToFile, lFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWbemBackupRestoreEx*, char*, int, int>)(lpVtbl[4]))((IWbemBackupRestoreEx*)Unsafe.AsPointer(ref this), strRestoreFromFile, lFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWbemBackupRestoreEx*, int>)(lpVtbl[5]))((IWbemBackupRestoreEx*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWbemBackupRestoreEx*, int>)(lpVtbl[6]))((IWbemBackupRestoreEx*)Unsafe.AsPointer(ref this));
    }
