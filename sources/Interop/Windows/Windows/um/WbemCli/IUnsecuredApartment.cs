...
public unsafe partial struct IUnsecuredApartment : IUnsecuredApartment.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IUnsecuredApartment;
