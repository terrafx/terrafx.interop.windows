...
public unsafe partial struct IWbemObjectSinkEx : IWbemObjectSinkEx.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWbemObjectSinkEx;
