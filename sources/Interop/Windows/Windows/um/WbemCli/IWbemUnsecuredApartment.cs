...
public unsafe partial struct IWbemUnsecuredApartment : IWbemUnsecuredApartment.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWbemUnsecuredApartment;
