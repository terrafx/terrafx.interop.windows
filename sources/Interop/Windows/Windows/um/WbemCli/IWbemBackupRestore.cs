...
public unsafe partial struct IWbemBackupRestore : IWbemBackupRestore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWbemBackupRestore;
