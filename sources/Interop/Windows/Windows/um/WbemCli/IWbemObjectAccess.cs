...
public unsafe partial struct IWbemObjectAccess : IWbemObjectAccess.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWbemObjectAccess;
