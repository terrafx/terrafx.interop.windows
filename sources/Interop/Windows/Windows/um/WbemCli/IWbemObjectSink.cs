...
public unsafe partial struct IWbemObjectSink : IWbemObjectSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWbemObjectSink;
