...
public partial struct DEVICE_LOCATION
{
    ...
    [NativeTypeName("_DEVICE_LOCATION::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:2991:5)")]
    ...
    public partial struct _Anonymous_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("_DEVICE_LOCATION::(anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:2993:9)")]
        public _Anonymous1_e__Struct Anonymous1;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.Anonymous2"]/*' />
        [FieldOffset(0)]
        [NativeTypeName("_DEVICE_LOCATION::(anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:3001:9)")]
