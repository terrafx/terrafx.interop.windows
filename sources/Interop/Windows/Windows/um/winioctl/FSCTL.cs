...
public static partial class FSCTL
{
    ...
    [NativeTypeName("#define FSCTL_START_VIRTUALIZATION_INSTANCE CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 240, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_START_VIRTUALIZATION_INSTANCE = (((0x00000009) << 16) | ((0) << 14) | ((240) << 2) | (0));

    [NativeTypeName("#define FSCTL_GET_FILTER_FILE_IDENTIFIER CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 241, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_GET_FILTER_FILE_IDENTIFIER = (((0x00000009) << 16) | ((0) << 14) | ((241) << 2) | (0));
    ...
    [NativeTypeName("#define FSCTL_CLEAR_LCN_WEAK_REFERENCE CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 281, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_CLEAR_LCN_WEAK_REFERENCE = (((0x00000009) << 16) | ((0) << 14) | ((281) << 2) | (0));
    ...
    [NativeTypeName("#define FSCTL_CLEAR_ALL_LCN_WEAK_REFERENCES CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 283, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_CLEAR_ALL_LCN_WEAK_REFERENCES = (((0x00000009) << 16) | ((0) << 14) | ((283) << 2) | (0));
    ...
    [NativeTypeName("#define FSCTL_REFS_CHECKPOINT_VOLUME CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 287, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_REFS_CHECKPOINT_VOLUME = (((0x00000009) << 16) | ((0) << 14) | ((287) << 2) | (0));

    [NativeTypeName("#define FSCTL_REFS_QUERY_VOLUME_TOTAL_SHARED_LCNS CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 288, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_REFS_QUERY_VOLUME_TOTAL_SHARED_LCNS = (((0x00000009) << 16) | ((0) << 14) | ((288) << 2) | (0));

    [NativeTypeName("#define FSCTL_UPGRADE_VOLUME CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 289, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_UPGRADE_VOLUME = (((0x00000009) << 16) | ((0) << 14) | ((289) << 2) | (0));

    [NativeTypeName("#define FSCTL_REFS_SET_VOLUME_IO_METRICS_INFO CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 290, METHOD_BUFFERED, FILE_ANY_ACCESS)")]
    public const int FSCTL_REFS_SET_VOLUME_IO_METRICS_INFO = (((0x00000009) << 16) | ((0) << 14) | ((290) << 2) | (0));
