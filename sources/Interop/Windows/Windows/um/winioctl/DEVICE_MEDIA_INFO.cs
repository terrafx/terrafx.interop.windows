...
public partial struct DEVICE_MEDIA_INFO
{
    ...
    [NativeTypeName("union (anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:954:5)")]
    ...
    public partial struct _DeviceSpecific_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:965:9)")]
        ...
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:975:9)")]
        ...
        public partial struct _TapeInfo_e__Struct
        {
            ...
            [NativeTypeName("union (anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:985:13)")]
            ...
            public partial struct _BusSpecificData_e__Union
            {
                ...
                [FieldOffset(0)]
                [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/winioctl.h:986:17)")]
