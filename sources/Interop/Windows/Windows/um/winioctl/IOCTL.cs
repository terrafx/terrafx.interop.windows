...
public static partial class IOCTL
{
    ...
    [NativeTypeName("#define IOCTL_STORAGE_GET_SYSTEM_FEATURE_SUPPORT CTL_CODE(IOCTL_STORAGE_BASE, 0x0307, METHOD_BUFFERED, FILE_READ_ACCESS)")]
    public const int IOCTL_STORAGE_GET_SYSTEM_FEATURE_SUPPORT = (((0x0000002d) << 16) | (((0x0001)) << 14) | ((0x0307) << 2) | (0));
    ...
    [NativeTypeName("#define IOCTL_STORAGE_MINIPORT_PASSTHROUGH_REQUEST CTL_CODE(IOCTL_STORAGE_BASE, 0x0414, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)")]
    public const int IOCTL_STORAGE_MINIPORT_PASSTHROUGH_REQUEST = (((0x0000002d) << 16) | (((0x0001) | (0x0002)) << 14) | ((0x0414) << 2) | (0));
