...
// Ported from um/appmodel.h in the Windows SDK for Windows 10.0.28000.0
...
public static unsafe partial class Windows
{
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetPackagePathByFullName2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    [SupportedOSPlatform("windows10.0")]
    public static extern int GetPackagePathByFullName2([NativeTypeName("PCWSTR")] char* packageFullName, PackagePathType packagePathType, [NativeTypeName("UINT32 *")] uint* pathLength, [NativeTypeName("PWSTR")] char* path);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetStagedPackagePathByFullName2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    [SupportedOSPlatform("windows10.0")]
    public static extern int GetStagedPackagePathByFullName2([NativeTypeName("PCWSTR")] char* packageFullName, PackagePathType packagePathType, [NativeTypeName("UINT32 *")] uint* pathLength, [NativeTypeName("PWSTR")] char* path);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetCurrentPackageInfo2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    [SupportedOSPlatform("windows10.0")]
    public static extern int GetCurrentPackageInfo2([NativeTypeName("const UINT32")] uint flags, PackagePathType packagePathType, [NativeTypeName("UINT32 *")] uint* bufferLength, byte* buffer, [NativeTypeName("UINT32 *")] uint* count);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetCurrentPackagePath2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    [SupportedOSPlatform("windows10.0")]
    public static extern int GetCurrentPackagePath2(PackagePathType packagePathType, [NativeTypeName("UINT32 *")] uint* pathLength, [NativeTypeName("PWSTR")] char* path);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.VerifyPackageFullName"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    public static extern int VerifyPackageFullName([NativeTypeName("PCWSTR")] char* packageFullName);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.VerifyPackageFamilyName"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    public static extern int VerifyPackageFamilyName([NativeTypeName("PCWSTR")] char* packageFamilyName);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.VerifyPackageId"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    public static extern int VerifyPackageId([NativeTypeName("const PACKAGE_ID *")] PACKAGE_ID* packageId);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.VerifyApplicationUserModelId"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    public static extern int VerifyApplicationUserModelId([NativeTypeName("PCWSTR")] char* applicationUserModelId);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.VerifyPackageRelativeApplicationId"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    public static extern int VerifyPackageRelativeApplicationId([NativeTypeName("PCWSTR")] char* packageRelativeApplicationId);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.OpenPackageInfoByFullNameForUser"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    public static extern int OpenPackageInfoByFullNameForUser([NativeTypeName("PSID")] void* userSid, [NativeTypeName("PCWSTR")] char* packageFullName, [NativeTypeName("const UINT32")] uint reserved, PACKAGE_INFO_REFERENCE* packageInfoReference);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetPackageInfo2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    [return: NativeTypeName("LONG")]
    [SupportedOSPlatform("windows10.0")]
    public static extern int GetPackageInfo2(PACKAGE_INFO_REFERENCE packageInfoReference, [NativeTypeName("const UINT32")] uint flags, PackagePathType packagePathType, [NativeTypeName("UINT32 *")] uint* bufferLength, byte* buffer, [NativeTypeName("UINT32 *")] uint* count);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.CheckIsMSIXPackage"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    public static extern HRESULT CheckIsMSIXPackage([NativeTypeName("PCWSTR")] char* packageFullName, BOOL* isMSIXPackage);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.TryCreatePackageDependency2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    public static extern HRESULT TryCreatePackageDependency2([NativeTypeName("PSID")] void* user, [NativeTypeName("PCWSTR")] char* packageFamilyName, PACKAGE_VERSION minVersion, PackageDependencyProcessorArchitectures packageDependencyProcessorArchitectures, PackageDependencyLifetimeKind lifetimeKind, [NativeTypeName("PCWSTR")] char* lifetimeArtifact, CreatePackageDependencyOptions options, [NativeTypeName("const FILETIME *")] FILETIME* lifetimeExpiration, [NativeTypeName("PWSTR *")] char** packageDependencyId);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.AddPackageDependency2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    public static extern HRESULT AddPackageDependency2([NativeTypeName("PCWSTR")] char* packageDependencyId, [NativeTypeName("INT32")] int rank, AddPackageDependencyOptions2 options, PACKAGEDEPENDENCY_CONTEXT* packageDependencyContext, [NativeTypeName("PWSTR *")] char** packageFullName);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetResolvedPackageFullNameForPackageDependency2"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    public static extern HRESULT GetResolvedPackageFullNameForPackageDependency2([NativeTypeName("PCWSTR")] char* packageDependencyId, [NativeTypeName("PWSTR *")] char** packageFullName);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.FindPackageDependency"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    public static extern HRESULT FindPackageDependency([NativeTypeName("const FindPackageDependencyCriteria *")] FindPackageDependencyCriteria* findPackageDependencyCriteria, [NativeTypeName("UINT32 *")] uint* packageDependencyIdsCount, [NativeTypeName("PWSTR **")] char*** packageDependencyIds);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetPackageDependencyInformation"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    public static extern HRESULT GetPackageDependencyInformation([NativeTypeName("PCWSTR")] char* packageDependencyId, [NativeTypeName("PSID *")] void** user, [NativeTypeName("PWSTR *")] char** packageFamilyName, PACKAGE_VERSION* minVersion, PackageDependencyProcessorArchitectures* packageDependencyProcessorArchitectures, PackageDependencyLifetimeKind* lifetimeKind, [NativeTypeName("PWSTR *")] char** lifetimeArtifact, CreatePackageDependencyOptions* options, FILETIME* lifetimeExpiration);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetProcessesUsingPackageDependency"]/*' />
    [DllImport("kernelbase", ExactSpelling = true)]
    public static extern HRESULT GetProcessesUsingPackageDependency([NativeTypeName("PCWSTR")] char* packageDependencyId, [NativeTypeName("PSID")] void* user, BOOL scopeIsSystem, [NativeTypeName("UINT32 *")] uint* processIdsCount, [NativeTypeName("DWORD **")] uint** processIds);
