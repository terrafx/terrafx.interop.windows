...
public unsafe partial struct ICanvasGradient : ICanvasGradient.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICanvasGradient;
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, float, ushort*, int> addColorStop;
    }
}
