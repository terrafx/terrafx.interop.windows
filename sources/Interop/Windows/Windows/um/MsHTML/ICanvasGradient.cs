...
public unsafe partial struct ICanvasGradient : ICanvasGradient.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ICanvasGradient*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ICanvasGradient*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<ICanvasGradient*, float, char*, int>)(lpVtbl[7]))((ICanvasGradient*)Unsafe.AsPointer(ref this), offset, color);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, float, char*, int> addColorStop;
    }
}
