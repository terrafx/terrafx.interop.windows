...
public unsafe partial struct IDOMWheelEvent : IDOMWheelEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMWheelEvent;
