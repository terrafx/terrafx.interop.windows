...
public unsafe partial struct IElementBehaviorRender : IElementBehaviorRender.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementBehaviorRender;
