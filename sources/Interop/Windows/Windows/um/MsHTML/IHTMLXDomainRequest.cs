...
public unsafe partial struct IHTMLXDomainRequest : IHTMLXDomainRequest.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLXDomainRequest;
