...
public unsafe partial struct IHTCPropertyBehavior : IHTCPropertyBehavior.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTCPropertyBehavior*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTCPropertyBehavior*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
