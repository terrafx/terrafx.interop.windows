...
public unsafe partial struct IHTMLTextRangeMetrics : IHTMLTextRangeMetrics.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLTextRangeMetrics*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLTextRangeMetrics*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
