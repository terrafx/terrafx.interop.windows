...
public unsafe partial struct ISVGAnimatedAngle : ISVGAnimatedAngle.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAnimatedAngle*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAnimatedAngle*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
