...
public unsafe partial struct IDOMCustomEvent : IDOMCustomEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMCustomEvent;
