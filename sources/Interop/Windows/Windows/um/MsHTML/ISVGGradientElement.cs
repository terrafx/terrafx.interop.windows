...
public unsafe partial struct ISVGGradientElement : ISVGGradientElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGGradientElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGGradientElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
