...
public unsafe partial struct ISVGEllipseElement : ISVGEllipseElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGEllipseElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGEllipseElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
