...
public unsafe partial struct ISVGEllipseElement : ISVGEllipseElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGEllipseElement;
