...
public unsafe partial struct ISVGAngle : ISVGAngle.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAngle*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAngle*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<ISVGAngle*, char*, int>)(lpVtbl[13]))((ISVGAngle*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<ISVGAngle*, char**, int>)(lpVtbl[14]))((ISVGAngle*)Unsafe.AsPointer(ref this), p);
    }
