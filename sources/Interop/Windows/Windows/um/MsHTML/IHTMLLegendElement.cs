...
public unsafe partial struct IHTMLLegendElement : IHTMLLegendElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLLegendElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLLegendElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLegendElement*, char*, int>)(lpVtbl[7]))((IHTMLLegendElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLegendElement*, char**, int>)(lpVtbl[8]))((IHTMLLegendElement*)Unsafe.AsPointer(ref this), p);
    }
