...
public unsafe partial struct ISVGFitToViewBox : ISVGFitToViewBox.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGFitToViewBox*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGFitToViewBox*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
