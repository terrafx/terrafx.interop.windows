...
public unsafe partial struct ISVGFitToViewBox : ISVGFitToViewBox.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGFitToViewBox;
