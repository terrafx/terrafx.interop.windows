...
public unsafe partial struct IDOMFocusEvent : IDOMFocusEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMFocusEvent;
