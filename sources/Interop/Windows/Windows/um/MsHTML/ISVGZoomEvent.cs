...
public unsafe partial struct ISVGZoomEvent : ISVGZoomEvent.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGZoomEvent*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGZoomEvent*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
