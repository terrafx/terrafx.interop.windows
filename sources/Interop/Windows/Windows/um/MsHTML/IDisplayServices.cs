...
public unsafe partial struct IDisplayServices : IDisplayServices.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDisplayServices;
