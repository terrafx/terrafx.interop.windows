...
public unsafe partial struct IDOMCloseEvent : IDOMCloseEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMCloseEvent;
