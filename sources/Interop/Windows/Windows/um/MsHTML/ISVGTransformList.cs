...
public unsafe partial struct ISVGTransformList : ISVGTransformList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGTransformList;
