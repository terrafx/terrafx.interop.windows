...
public unsafe partial struct IDOMProgressEvent : IDOMProgressEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMProgressEvent;
