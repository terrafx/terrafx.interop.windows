...
public unsafe partial struct ISVGAnimatedRect : ISVGAnimatedRect.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAnimatedRect*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAnimatedRect*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
