...
public unsafe partial struct IHTMLMediaElement2 : IHTMLMediaElement2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLMediaElement2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLMediaElement2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
