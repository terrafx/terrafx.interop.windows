...
public unsafe partial struct ISegmentListIterator : ISegmentListIterator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISegmentListIterator;
