...
public unsafe partial struct IHTMLBookmarkCollection : IHTMLBookmarkCollection.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLBookmarkCollection*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLBookmarkCollection*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
