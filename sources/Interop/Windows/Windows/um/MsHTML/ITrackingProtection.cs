...
public unsafe partial struct ITrackingProtection : ITrackingProtection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITrackingProtection;
