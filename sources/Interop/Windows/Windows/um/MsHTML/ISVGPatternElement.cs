...
public unsafe partial struct ISVGPatternElement : ISVGPatternElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGPatternElement;
