...
public unsafe partial struct ISVGPatternElement : ISVGPatternElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPatternElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPatternElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
