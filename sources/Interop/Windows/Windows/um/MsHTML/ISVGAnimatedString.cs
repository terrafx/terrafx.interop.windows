...
public unsafe partial struct ISVGAnimatedString : ISVGAnimatedString.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGAnimatedString;
