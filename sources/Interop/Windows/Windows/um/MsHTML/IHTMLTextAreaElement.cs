...
public unsafe partial struct IHTMLTextAreaElement : IHTMLTextAreaElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLTextAreaElement;
