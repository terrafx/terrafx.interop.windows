...
public unsafe partial struct ISVGPathSegCurvetoCubicSmoothAbs : ISVGPathSegCurvetoCubicSmoothAbs.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegCurvetoCubicSmoothAbs*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegCurvetoCubicSmoothAbs*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
