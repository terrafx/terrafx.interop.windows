...
public unsafe partial struct IDOMEventRegistrationCallback : IDOMEventRegistrationCallback.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMEventRegistrationCallback;
