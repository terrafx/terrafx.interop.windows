...
public unsafe partial struct ICanvasTextMetrics : ICanvasTextMetrics.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICanvasTextMetrics;
