...
public unsafe partial struct ICanvasTextMetrics : ICanvasTextMetrics.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ICanvasTextMetrics*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ICanvasTextMetrics*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
