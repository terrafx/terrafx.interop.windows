...
public unsafe partial struct IHTMLDOMConstructorCollection : IHTMLDOMConstructorCollection.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMConstructorCollection*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLDOMConstructorCollection*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
