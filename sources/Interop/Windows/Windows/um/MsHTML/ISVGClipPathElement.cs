...
public unsafe partial struct ISVGClipPathElement : ISVGClipPathElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGClipPathElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGClipPathElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
