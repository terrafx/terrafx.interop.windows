...
public unsafe partial struct IHTMLTextContainer : IHTMLTextContainer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLTextContainer;
