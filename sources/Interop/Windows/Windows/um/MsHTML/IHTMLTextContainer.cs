...
public unsafe partial struct IHTMLTextContainer : IHTMLTextContainer.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLTextContainer*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLTextContainer*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
