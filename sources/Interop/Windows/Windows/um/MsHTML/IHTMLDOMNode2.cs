...
public unsafe partial struct IHTMLDOMNode2 : IHTMLDOMNode2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMNode2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLDOMNode2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
