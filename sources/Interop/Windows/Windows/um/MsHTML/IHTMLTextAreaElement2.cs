...
public unsafe partial struct IHTMLTextAreaElement2 : IHTMLTextAreaElement2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLTextAreaElement2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLTextAreaElement2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
