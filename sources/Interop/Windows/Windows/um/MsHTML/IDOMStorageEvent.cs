...
public unsafe partial struct IDOMStorageEvent : IDOMStorageEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMStorageEvent;
