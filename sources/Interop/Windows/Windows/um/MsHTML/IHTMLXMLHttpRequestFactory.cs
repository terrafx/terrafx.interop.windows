...
public unsafe partial struct IHTMLXMLHttpRequestFactory : IHTMLXMLHttpRequestFactory.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLXMLHttpRequestFactory*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLXMLHttpRequestFactory*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, IHTMLXMLHttpRequest**, int> create;
    }
}
