...
public unsafe partial struct IDOMMessageEvent : IDOMMessageEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMMessageEvent;
