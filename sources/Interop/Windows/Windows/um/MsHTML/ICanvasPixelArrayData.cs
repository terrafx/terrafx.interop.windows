...
public unsafe partial struct ICanvasPixelArrayData : ICanvasPixelArrayData.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICanvasPixelArrayData;
