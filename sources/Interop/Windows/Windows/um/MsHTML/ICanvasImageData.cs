...
public unsafe partial struct ICanvasImageData : ICanvasImageData.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ICanvasImageData*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ICanvasImageData*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
