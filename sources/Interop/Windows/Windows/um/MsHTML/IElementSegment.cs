...
public unsafe partial struct IElementSegment : IElementSegment.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementSegment;
