...
public unsafe partial struct IDOMMutationEvent : IDOMMutationEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMMutationEvent;
