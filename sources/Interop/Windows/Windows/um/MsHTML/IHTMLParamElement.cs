...
public unsafe partial struct IHTMLParamElement : IHTMLParamElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLParamElement;
