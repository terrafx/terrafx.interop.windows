...
public unsafe partial struct IHTMLDOMAttribute : IHTMLDOMAttribute.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMAttribute*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLDOMAttribute*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMAttribute*, char**, int>)(lpVtbl[7]))((IHTMLDOMAttribute*)Unsafe.AsPointer(ref this), p);
    }
