...
public unsafe partial struct IEnumPrivacyRecords : IEnumPrivacyRecords.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumPrivacyRecords;
