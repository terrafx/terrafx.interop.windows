...
public unsafe partial struct IHTMLAreasCollection : IHTMLAreasCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLAreasCollection;
