...
public unsafe partial struct ISVGElementInstance : ISVGElementInstance.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGElementInstance;
