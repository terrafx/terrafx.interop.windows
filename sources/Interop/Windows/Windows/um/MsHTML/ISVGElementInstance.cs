...
public unsafe partial struct ISVGElementInstance : ISVGElementInstance.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGElementInstance*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGElementInstance*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
