...
public unsafe partial struct DispHTMLDOMTextNode : DispHTMLDOMTextNode.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DispHTMLDOMTextNode*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DispHTMLDOMTextNode*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
