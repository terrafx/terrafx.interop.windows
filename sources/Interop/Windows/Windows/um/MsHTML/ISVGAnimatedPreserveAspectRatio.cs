...
public unsafe partial struct ISVGAnimatedPreserveAspectRatio : ISVGAnimatedPreserveAspectRatio.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGAnimatedPreserveAspectRatio;
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, ISVGPreserveAspectRatio*, int> putref_baseVal;

        [NativeTypeName("HRESULT (ISVGPreserveAspectRatio **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ISVGPreserveAspectRatio**, int> get_baseVal;

        [NativeTypeName("HRESULT (ISVGPreserveAspectRatio *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ISVGPreserveAspectRatio*, int> putref_animVal;

        [NativeTypeName("HRESULT (ISVGPreserveAspectRatio **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ISVGPreserveAspectRatio**, int> get_animVal;
    }
}
