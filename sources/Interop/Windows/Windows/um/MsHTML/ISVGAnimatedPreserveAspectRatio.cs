...
public unsafe partial struct ISVGAnimatedPreserveAspectRatio : ISVGAnimatedPreserveAspectRatio.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAnimatedPreserveAspectRatio*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAnimatedPreserveAspectRatio*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
