...
public unsafe partial struct IHTMLBaseFontElement : IHTMLBaseFontElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLBaseFontElement;
