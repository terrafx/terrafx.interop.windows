...
public unsafe partial struct IHTMLIPrintCollection : IHTMLIPrintCollection.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLIPrintCollection*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLIPrintCollection*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
