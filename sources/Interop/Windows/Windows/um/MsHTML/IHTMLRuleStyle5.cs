...
public unsafe partial struct IHTMLRuleStyle5 : IHTMLRuleStyle5.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLRuleStyle5*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLRuleStyle5*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLRuleStyle5*, char*, int>)(lpVtbl[7]))((IHTMLRuleStyle5*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLRuleStyle5*, char**, int>)(lpVtbl[8]))((IHTMLRuleStyle5*)Unsafe.AsPointer(ref this), p);
    }
