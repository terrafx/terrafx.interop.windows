...
public unsafe partial struct IHostBehaviorInit : IHostBehaviorInit.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHostBehaviorInit;
