...
public unsafe partial struct IRangeException : IRangeException.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IRangeException;
