...
public unsafe partial struct ISVGNumberList : ISVGNumberList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGNumberList;
