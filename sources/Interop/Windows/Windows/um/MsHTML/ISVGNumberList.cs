...
public unsafe partial struct ISVGNumberList : ISVGNumberList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGNumberList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGNumberList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
