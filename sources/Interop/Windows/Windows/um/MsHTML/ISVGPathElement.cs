...
public unsafe partial struct ISVGPathElement : ISVGPathElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
