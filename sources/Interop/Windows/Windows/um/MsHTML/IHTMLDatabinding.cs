...
public unsafe partial struct IHTMLDatabinding : IHTMLDatabinding.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLDatabinding;
