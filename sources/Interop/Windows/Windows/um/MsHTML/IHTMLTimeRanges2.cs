...
public unsafe partial struct IHTMLTimeRanges2 : IHTMLTimeRanges2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLTimeRanges2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLTimeRanges2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
