...
public unsafe partial struct ISVGRectElement : ISVGRectElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGRectElement;
