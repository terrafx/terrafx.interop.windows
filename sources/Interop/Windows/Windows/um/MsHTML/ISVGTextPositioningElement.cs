...
public unsafe partial struct ISVGTextPositioningElement : ISVGTextPositioningElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGTextPositioningElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGTextPositioningElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
