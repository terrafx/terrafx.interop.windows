...
public unsafe partial struct IFontNames : IFontNames.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IFontNames*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IFontNames*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IFontNames*, VARIANT*, char**, int>)(lpVtbl[9]))((IFontNames*)Unsafe.AsPointer(ref this), pvarIndex, pbstrFontName);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, VARIANT*, char**, int> Item;
    }
}
