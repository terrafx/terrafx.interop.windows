...
public unsafe partial struct IWebGeolocation : IWebGeolocation.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IWebGeolocation*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IWebGeolocation*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, IDispatch*, IDispatch*, IDispatch*, int> getCurrentPosition;

        [NativeTypeName("HRESULT (IDispatch *, IDispatch *, IDispatch *, long *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, IDispatch*, IDispatch*, IDispatch*, int*, int> watchPosition;

        [NativeTypeName("HRESULT (long) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, int, int> clearWatch;
    }
}
