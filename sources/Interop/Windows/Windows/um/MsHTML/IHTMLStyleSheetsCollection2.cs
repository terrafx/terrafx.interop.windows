...
public unsafe partial struct IHTMLStyleSheetsCollection2 : IHTMLStyleSheetsCollection2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLStyleSheetsCollection2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLStyleSheetsCollection2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
