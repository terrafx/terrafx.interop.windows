...
public unsafe partial struct IHTMLBodyElement4 : IHTMLBodyElement4.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLBodyElement4*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLBodyElement4*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
