...
public unsafe partial struct ISVGLinearGradientElement : ISVGLinearGradientElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGLinearGradientElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGLinearGradientElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
