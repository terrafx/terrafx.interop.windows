...
public unsafe partial struct ISVGAnimatedNumber : ISVGAnimatedNumber.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAnimatedNumber*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAnimatedNumber*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
