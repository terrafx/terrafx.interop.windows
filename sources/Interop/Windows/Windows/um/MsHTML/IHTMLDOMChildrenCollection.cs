...
public unsafe partial struct IHTMLDOMChildrenCollection : IHTMLDOMChildrenCollection.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMChildrenCollection*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLDOMChildrenCollection*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
