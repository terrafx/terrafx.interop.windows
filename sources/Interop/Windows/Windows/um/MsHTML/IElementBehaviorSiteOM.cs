...
public unsafe partial struct IElementBehaviorSiteOM : IElementBehaviorSiteOM.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementBehaviorSiteOM;
