...
public unsafe partial struct IElementBehaviorCategory : IElementBehaviorCategory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementBehaviorCategory;
