...
public unsafe partial struct ISVGImageElement : ISVGImageElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGImageElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGImageElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
