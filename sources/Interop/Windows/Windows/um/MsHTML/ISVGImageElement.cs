...
public unsafe partial struct ISVGImageElement : ISVGImageElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGImageElement;
