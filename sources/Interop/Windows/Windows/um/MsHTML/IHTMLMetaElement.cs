...
public unsafe partial struct IHTMLMetaElement : IHTMLMetaElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLMetaElement;
