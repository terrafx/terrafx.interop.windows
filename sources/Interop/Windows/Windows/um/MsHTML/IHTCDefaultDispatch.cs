...
public unsafe partial struct IHTCDefaultDispatch : IHTCDefaultDispatch.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTCDefaultDispatch*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTCDefaultDispatch*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
