...
public unsafe partial struct DispSVGSwitchElement : DispSVGSwitchElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DispSVGSwitchElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DispSVGSwitchElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
