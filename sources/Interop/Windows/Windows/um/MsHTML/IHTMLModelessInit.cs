...
public unsafe partial struct IHTMLModelessInit : IHTMLModelessInit.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLModelessInit*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLModelessInit*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
