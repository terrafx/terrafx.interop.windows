...
public unsafe partial struct IHTMLInputButtonElement : IHTMLInputButtonElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLInputButtonElement;
