...
public unsafe partial struct IHTMLInputButtonElement : IHTMLInputButtonElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLInputButtonElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLInputButtonElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputButtonElement*, char**, int>)(lpVtbl[7]))((IHTMLInputButtonElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputButtonElement*, char*, int>)(lpVtbl[8]))((IHTMLInputButtonElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputButtonElement*, char**, int>)(lpVtbl[9]))((IHTMLInputButtonElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputButtonElement*, char*, int>)(lpVtbl[10]))((IHTMLInputButtonElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputButtonElement*, char**, int>)(lpVtbl[11]))((IHTMLInputButtonElement*)Unsafe.AsPointer(ref this), p);
    }
