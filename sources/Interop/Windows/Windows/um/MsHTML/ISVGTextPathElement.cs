...
public unsafe partial struct ISVGTextPathElement : ISVGTextPathElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGTextPathElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGTextPathElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
