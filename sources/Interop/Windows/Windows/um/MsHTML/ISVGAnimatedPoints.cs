...
public unsafe partial struct ISVGAnimatedPoints : ISVGAnimatedPoints.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAnimatedPoints*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAnimatedPoints*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
