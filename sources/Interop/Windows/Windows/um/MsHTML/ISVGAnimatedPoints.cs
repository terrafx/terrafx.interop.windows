...
public unsafe partial struct ISVGAnimatedPoints : ISVGAnimatedPoints.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGAnimatedPoints;
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, ISVGPointList*, int> putref_points;

        [NativeTypeName("HRESULT (ISVGPointList **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ISVGPointList**, int> get_points;

        [NativeTypeName("HRESULT (ISVGPointList *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ISVGPointList*, int> putref_animatedPoints;

        [NativeTypeName("HRESULT (ISVGPointList **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ISVGPointList**, int> get_animatedPoints;
    }
}
