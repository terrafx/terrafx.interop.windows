...
public unsafe partial struct ISVGPathSegCurvetoQuadraticSmoothRel : ISVGPathSegCurvetoQuadraticSmoothRel.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegCurvetoQuadraticSmoothRel*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegCurvetoQuadraticSmoothRel*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
