...
public unsafe partial struct IDOMDocumentType : IDOMDocumentType.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMDocumentType;
