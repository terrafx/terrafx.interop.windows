...
public unsafe partial struct IDOMDocumentType : IDOMDocumentType.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDOMDocumentType*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IDOMDocumentType*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IDOMDocumentType*, char**, int>)(lpVtbl[7]))((IDOMDocumentType*)Unsafe.AsPointer(ref this), p);
    }
