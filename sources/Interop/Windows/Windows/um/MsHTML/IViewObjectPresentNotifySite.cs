...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IViewObjectPresentNotifySite);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IViewObjectPresentNotifySite*, Guid*, void**, int>)(lpVtbl[0]))((IViewObjectPresentNotifySite*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IViewObjectPresentNotifySite*, uint>)(lpVtbl[1]))((IViewObjectPresentNotifySite*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IViewObjectPresentNotifySite*, uint>)(lpVtbl[2]))((IViewObjectPresentNotifySite*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IViewObjectPresentNotifySite*, IUnknown*, uint, uint, uint, DXGI_FORMAT, VIEW_OBJECT_ALPHA_MODE, ISurfacePresenter**, int>)(lpVtbl[3]))((IViewObjectPresentNotifySite*)Unsafe.AsPointer(ref this), pDevice, width, height, backBufferCount, format, mode, ppQueue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IViewObjectPresentNotifySite*, BOOL*, int>)(lpVtbl[4]))((IViewObjectPresentNotifySite*)Unsafe.AsPointer(ref this), pIsHardwareComposition);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IViewObjectPresentNotifySite*, VIEW_OBJECT_COMPOSITION_MODE, int>)(lpVtbl[5]))((IViewObjectPresentNotifySite*)Unsafe.AsPointer(ref this), mode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IViewObjectPresentNotifySite*, int>)(lpVtbl[6]))((IViewObjectPresentNotifySite*)Unsafe.AsPointer(ref this));
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, int> RequestFrame;
    }
}
