...
public unsafe partial struct ISVGMarkerElement : ISVGMarkerElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGMarkerElement;
