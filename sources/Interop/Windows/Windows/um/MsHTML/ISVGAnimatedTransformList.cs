...
public unsafe partial struct ISVGAnimatedTransformList : ISVGAnimatedTransformList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAnimatedTransformList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAnimatedTransformList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
