...
public unsafe partial struct IDOMMouseWheelEvent : IDOMMouseWheelEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMMouseWheelEvent;
