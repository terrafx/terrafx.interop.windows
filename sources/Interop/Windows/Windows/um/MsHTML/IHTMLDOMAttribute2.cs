...
public unsafe partial struct IHTMLDOMAttribute2 : IHTMLDOMAttribute2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMAttribute2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLDOMAttribute2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMAttribute2*, char**, int>)(lpVtbl[7]))((IHTMLDOMAttribute2*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMAttribute2*, char*, int>)(lpVtbl[8]))((IHTMLDOMAttribute2*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLDOMAttribute2*, char**, int>)(lpVtbl[9]))((IHTMLDOMAttribute2*)Unsafe.AsPointer(ref this), p);
    }
