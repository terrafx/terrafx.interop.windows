...
public unsafe partial struct IHTMLTableCaption : IHTMLTableCaption.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLTableCaption*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLTableCaption*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLTableCaption*, char*, int>)(lpVtbl[7]))((IHTMLTableCaption*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLTableCaption*, char**, int>)(lpVtbl[8]))((IHTMLTableCaption*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLTableCaption*, char*, int>)(lpVtbl[9]))((IHTMLTableCaption*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLTableCaption*, char**, int>)(lpVtbl[10]))((IHTMLTableCaption*)Unsafe.AsPointer(ref this), p);
    }
