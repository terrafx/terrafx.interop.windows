...
public unsafe partial struct IHTMLCSSMediaList : IHTMLCSSMediaList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLCSSMediaList;
