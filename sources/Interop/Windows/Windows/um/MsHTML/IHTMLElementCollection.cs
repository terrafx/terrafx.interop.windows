...
public unsafe partial struct IHTMLElementCollection : IHTMLElementCollection.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLElementCollection*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLElementCollection*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLElementCollection*, char**, int>)(lpVtbl[7]))((IHTMLElementCollection*)Unsafe.AsPointer(ref this), String);
    }
