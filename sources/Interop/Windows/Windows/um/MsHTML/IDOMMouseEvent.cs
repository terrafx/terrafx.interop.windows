...
public unsafe partial struct IDOMMouseEvent : IDOMMouseEvent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMMouseEvent;
