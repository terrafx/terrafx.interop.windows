...
public unsafe partial struct ISVGLocatable : ISVGLocatable.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGLocatable*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGLocatable*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
