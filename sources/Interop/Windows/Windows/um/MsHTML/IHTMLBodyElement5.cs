...
public unsafe partial struct IHTMLBodyElement5 : IHTMLBodyElement5.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLBodyElement5*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLBodyElement5*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
