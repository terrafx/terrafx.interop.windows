...
public unsafe partial struct IHTMLFrameSetElement2 : IHTMLFrameSetElement2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLFrameSetElement2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLFrameSetElement2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
