...
public unsafe partial struct DispSVGStyleElement : DispSVGStyleElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DispSVGStyleElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DispSVGStyleElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
