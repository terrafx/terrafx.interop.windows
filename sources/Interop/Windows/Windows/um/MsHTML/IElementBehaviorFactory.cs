...
public unsafe partial struct IElementBehaviorFactory : IElementBehaviorFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementBehaviorFactory;
