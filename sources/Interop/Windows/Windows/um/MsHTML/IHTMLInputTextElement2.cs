...
public unsafe partial struct IHTMLInputTextElement2 : IHTMLInputTextElement2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLInputTextElement2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLInputTextElement2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
