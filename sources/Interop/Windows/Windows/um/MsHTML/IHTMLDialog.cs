...
public unsafe partial struct IHTMLDialog : IHTMLDialog.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLDialog*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLDialog*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLDialog*, char**, int>)(lpVtbl[20]))((IHTMLDialog*)Unsafe.AsPointer(ref this), String);
    }
