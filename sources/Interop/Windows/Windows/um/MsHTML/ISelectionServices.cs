...
public unsafe partial struct ISelectionServices : ISelectionServices.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISelectionServices;
