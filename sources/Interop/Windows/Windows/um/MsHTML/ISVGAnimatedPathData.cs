...
/// <include file='ISVGAnimatedPathData.xml' path='doc/member[@name="ISVGAnimatedPathData"]/*' />
...
public unsafe partial struct ISVGAnimatedPathData : ISVGAnimatedPathData.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGAnimatedPathData*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGAnimatedPathData*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
