...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IIE70DispatchEx);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, Guid*, void**, int>)(lpVtbl[0]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, uint>)(lpVtbl[1]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, uint>)(lpVtbl[2]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, uint*, int>)(lpVtbl[3]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), pctinfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, uint, uint, ITypeInfo**, int>)(lpVtbl[4]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), iTInfo, lcid, ppTInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int>)(lpVtbl[6]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, char*, uint, int*, int>)(lpVtbl[7]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), bstrName, grfdex, pid);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, int, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, IServiceProvider*, int>)(lpVtbl[8]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), id, lcid, wFlags, pdp, pvarRes, pei, pspCaller);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, char*, uint, int>)(lpVtbl[9]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), bstrName, grfdex);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, int, int>)(lpVtbl[10]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), id);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, int, uint, uint*, int>)(lpVtbl[11]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), id, grfdexFetch, pgrfdex);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, int, char**, int>)(lpVtbl[12]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), id, pbstrName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, uint, int, int*, int>)(lpVtbl[13]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), grfdex, id, pid);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IIE70DispatchEx*, IUnknown**, int>)(lpVtbl[14]))((IIE70DispatchEx*)Unsafe.AsPointer(ref this), ppunk);
    }
