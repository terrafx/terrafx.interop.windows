...
public unsafe partial struct IHTMLSpanFlow : IHTMLSpanFlow.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLSpanFlow*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLSpanFlow*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSpanFlow*, char*, int>)(lpVtbl[7]))((IHTMLSpanFlow*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSpanFlow*, char**, int>)(lpVtbl[8]))((IHTMLSpanFlow*)Unsafe.AsPointer(ref this), p);
    }
