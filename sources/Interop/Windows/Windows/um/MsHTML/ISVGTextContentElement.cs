...
public unsafe partial struct ISVGTextContentElement : ISVGTextContentElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGTextContentElement;
