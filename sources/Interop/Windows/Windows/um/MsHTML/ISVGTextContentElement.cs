...
public unsafe partial struct ISVGTextContentElement : ISVGTextContentElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGTextContentElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGTextContentElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
