...
public unsafe partial struct IHTMLIFrameElement3 : IHTMLIFrameElement3.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLIFrameElement3*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLIFrameElement3*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLIFrameElement3*, char*, int>)(lpVtbl[8]))((IHTMLIFrameElement3*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLIFrameElement3*, char**, int>)(lpVtbl[9]))((IHTMLIFrameElement3*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLIFrameElement3*, char*, int>)(lpVtbl[10]))((IHTMLIFrameElement3*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLIFrameElement3*, char**, int>)(lpVtbl[11]))((IHTMLIFrameElement3*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLIFrameElement3*, char*, int>)(lpVtbl[12]))((IHTMLIFrameElement3*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLIFrameElement3*, char**, int>)(lpVtbl[13]))((IHTMLIFrameElement3*)Unsafe.AsPointer(ref this), p);
    }
