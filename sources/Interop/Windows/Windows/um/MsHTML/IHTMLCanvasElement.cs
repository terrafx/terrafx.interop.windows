...
public unsafe partial struct IHTMLCanvasElement : IHTMLCanvasElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLCanvasElement;
