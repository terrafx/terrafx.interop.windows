...
public unsafe partial struct IHTMLButtonElement : IHTMLButtonElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLButtonElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLButtonElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLButtonElement*, char**, int>)(lpVtbl[7]))((IHTMLButtonElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLButtonElement*, char*, int>)(lpVtbl[8]))((IHTMLButtonElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLButtonElement*, char**, int>)(lpVtbl[9]))((IHTMLButtonElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLButtonElement*, char*, int>)(lpVtbl[10]))((IHTMLButtonElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLButtonElement*, char**, int>)(lpVtbl[11]))((IHTMLButtonElement*)Unsafe.AsPointer(ref this), p);
    }
