...
public unsafe partial struct ISVGPreserveAspectRatio : ISVGPreserveAspectRatio.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPreserveAspectRatio*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPreserveAspectRatio*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
