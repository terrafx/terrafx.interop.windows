...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHTMLEditServices2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, Guid*, void**, int>)(lpVtbl[0]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, uint>)(lpVtbl[1]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, uint>)(lpVtbl[2]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IHTMLEditDesigner*, int>)(lpVtbl[3]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pIDesigner);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IHTMLEditDesigner*, int>)(lpVtbl[4]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pIDesigner);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IMarkupContainer*, ISelectionServices**, int>)(lpVtbl[5]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pIContainer, ppSelSvc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IMarkupPointer*, int>)(lpVtbl[6]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pIStartAnchor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IMarkupPointer*, int>)(lpVtbl[7]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pIEndAnchor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IMarkupPointer*, IMarkupPointer*, SELECTION_TYPE, int>)(lpVtbl[8]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pStart, pEnd, eType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IDisplayPointer*, int>)(lpVtbl[9]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pIStartAnchor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, IDisplayPointer*, int>)(lpVtbl[10]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), pIEndAnchor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, BOOL, int>)(lpVtbl[11]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), fReCompute);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IHTMLEditServices2*, BOOL, int>)(lpVtbl[12]))((IHTMLEditServices2*)Unsafe.AsPointer(ref this), fReset);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IDisplayPointer*, int> MoveToSelectionAnchorEx;

        [NativeTypeName("HRESULT (IDisplayPointer *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IDisplayPointer*, int> MoveToSelectionEndEx;

        [NativeTypeName("HRESULT (BOOL) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, int> FreezeVirtualCaretPos;

        [NativeTypeName("HRESULT (BOOL) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, int> UnFreezeVirtualCaretPos;
    }
}
