...
public unsafe partial struct ISVGRadialGradientElement : ISVGRadialGradientElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGRadialGradientElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGRadialGradientElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
