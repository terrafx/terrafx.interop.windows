...
public unsafe partial struct ISVGStringList : ISVGStringList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGStringList;
