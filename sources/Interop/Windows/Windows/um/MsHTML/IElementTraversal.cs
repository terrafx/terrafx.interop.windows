...
public unsafe partial struct IElementTraversal : IElementTraversal.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementTraversal;
