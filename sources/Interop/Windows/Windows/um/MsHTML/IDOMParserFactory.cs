...
public unsafe partial struct IDOMParserFactory : IDOMParserFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMParserFactory;
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, IDOMParser**, int> create;
    }
}
