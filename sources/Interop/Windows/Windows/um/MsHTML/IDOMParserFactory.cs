...
public unsafe partial struct IDOMParserFactory : IDOMParserFactory.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDOMParserFactory*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IDOMParserFactory*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
