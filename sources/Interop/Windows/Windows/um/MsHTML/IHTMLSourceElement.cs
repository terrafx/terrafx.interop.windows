...
public unsafe partial struct IHTMLSourceElement : IHTMLSourceElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLSourceElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLSourceElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSourceElement*, char*, int>)(lpVtbl[7]))((IHTMLSourceElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSourceElement*, char**, int>)(lpVtbl[8]))((IHTMLSourceElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSourceElement*, char*, int>)(lpVtbl[9]))((IHTMLSourceElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSourceElement*, char**, int>)(lpVtbl[10]))((IHTMLSourceElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSourceElement*, char*, int>)(lpVtbl[11]))((IHTMLSourceElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLSourceElement*, char**, int>)(lpVtbl[12]))((IHTMLSourceElement*)Unsafe.AsPointer(ref this), p);
    }
