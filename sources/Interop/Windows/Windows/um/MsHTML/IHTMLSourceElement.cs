...
public unsafe partial struct IHTMLSourceElement : IHTMLSourceElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLSourceElement;
