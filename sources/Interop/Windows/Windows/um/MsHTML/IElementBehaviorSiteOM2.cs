...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IElementBehaviorSiteOM2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, Guid*, void**, int>)(lpVtbl[0]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, uint>)(lpVtbl[1]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, uint>)(lpVtbl[2]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, char*, int, int*, int>)(lpVtbl[3]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), pchEvent, lFlags, plCookie);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, char*, int*, int>)(lpVtbl[4]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), pchEvent, plCookie);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, int, IHTMLEventObj*, int>)(lpVtbl[5]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), lCookie, pEventObject);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, IHTMLEventObj**, int>)(lpVtbl[6]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), ppEventObject);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, char*, int>)(lpVtbl[7]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), pchName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, char*, int>)(lpVtbl[8]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), pchUrn);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IElementBehaviorSiteOM2*, IHTMLElementDefaults**, int>)(lpVtbl[9]))((IElementBehaviorSiteOM2*)Unsafe.AsPointer(ref this), ppDefaults);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IHTMLElementDefaults**, int> GetDefaults;
    }
}
