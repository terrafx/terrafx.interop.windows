...
public unsafe partial struct IWebGeocoordinates : IWebGeocoordinates.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IWebGeocoordinates*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IWebGeocoordinates*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
