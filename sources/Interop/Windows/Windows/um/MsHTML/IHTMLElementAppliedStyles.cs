...
public unsafe partial struct IHTMLElementAppliedStyles : IHTMLElementAppliedStyles.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLElementAppliedStyles*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLElementAppliedStyles*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
