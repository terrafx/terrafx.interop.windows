...
public unsafe partial struct IHTMLTableSection : IHTMLTableSection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLTableSection;
