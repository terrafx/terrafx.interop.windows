...
public unsafe partial struct ISVGViewElement : ISVGViewElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGViewElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGViewElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
