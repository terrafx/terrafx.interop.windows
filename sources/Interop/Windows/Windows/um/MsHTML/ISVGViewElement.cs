...
public unsafe partial struct ISVGViewElement : ISVGViewElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGViewElement;
