...
public unsafe partial struct IHTMLStyleElement : IHTMLStyleElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLStyleElement;
