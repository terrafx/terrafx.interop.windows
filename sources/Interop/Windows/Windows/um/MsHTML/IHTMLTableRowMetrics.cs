...
public unsafe partial struct IHTMLTableRowMetrics : IHTMLTableRowMetrics.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLTableRowMetrics;
