...
public unsafe partial struct IHTMLTableRowMetrics : IHTMLTableRowMetrics.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLTableRowMetrics*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLTableRowMetrics*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
