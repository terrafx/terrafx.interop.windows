...
public unsafe partial struct ISVGPointList : ISVGPointList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPointList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPointList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
