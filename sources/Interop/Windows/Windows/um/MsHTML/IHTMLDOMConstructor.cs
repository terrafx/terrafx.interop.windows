...
public unsafe partial struct IHTMLDOMConstructor : IHTMLDOMConstructor.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLDOMConstructor;
