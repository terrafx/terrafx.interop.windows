...
public unsafe partial struct IHTMLInputFileElement : IHTMLInputFileElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLInputFileElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLInputFileElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputFileElement*, char**, int>)(lpVtbl[7]))((IHTMLInputFileElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputFileElement*, char*, int>)(lpVtbl[8]))((IHTMLInputFileElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputFileElement*, char**, int>)(lpVtbl[9]))((IHTMLInputFileElement*)Unsafe.AsPointer(ref this), p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputFileElement*, char*, int>)(lpVtbl[24]))((IHTMLInputFileElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLInputFileElement*, char**, int>)(lpVtbl[25]))((IHTMLInputFileElement*)Unsafe.AsPointer(ref this), p);
    }
