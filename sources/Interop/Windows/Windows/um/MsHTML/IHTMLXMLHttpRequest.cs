...
public unsafe partial struct IHTMLXMLHttpRequest : IHTMLXMLHttpRequest.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLXMLHttpRequest;
