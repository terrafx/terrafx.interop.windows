...
public unsafe partial struct IElementBehaviorLayout : IElementBehaviorLayout.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementBehaviorLayout;
