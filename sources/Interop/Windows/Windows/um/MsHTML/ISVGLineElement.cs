...
public unsafe partial struct ISVGLineElement : ISVGLineElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGLineElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGLineElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
