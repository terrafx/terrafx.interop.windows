...
public unsafe partial struct IHTMLTxtRangeCollection : IHTMLTxtRangeCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLTxtRangeCollection;
