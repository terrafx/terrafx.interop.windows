...
public unsafe partial struct ISVGPathSegMovetoRel : ISVGPathSegMovetoRel.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegMovetoRel*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegMovetoRel*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
