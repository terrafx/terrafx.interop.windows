...
public unsafe partial struct IDocumentTraversal : IDocumentTraversal.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDocumentTraversal;
