...
public unsafe partial struct IDocumentTraversal : IDocumentTraversal.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDocumentTraversal*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IDocumentTraversal*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
