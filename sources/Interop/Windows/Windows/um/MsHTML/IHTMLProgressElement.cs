...
public unsafe partial struct IHTMLProgressElement : IHTMLProgressElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLProgressElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLProgressElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
