...
public unsafe partial struct DispSVGPathSegArcAbs : DispSVGPathSegArcAbs.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DispSVGPathSegArcAbs*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DispSVGPathSegArcAbs*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
