...
public unsafe partial struct ISVGElementInstanceList : ISVGElementInstanceList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGElementInstanceList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGElementInstanceList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
