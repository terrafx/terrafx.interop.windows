...
public unsafe partial struct ISVGElementInstanceList : ISVGElementInstanceList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGElementInstanceList;
