...
public unsafe partial struct IHTMLStyle5 : IHTMLStyle5.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLStyle5*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLStyle5*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLStyle5*, char*, int>)(lpVtbl[7]))((IHTMLStyle5*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLStyle5*, char**, int>)(lpVtbl[8]))((IHTMLStyle5*)Unsafe.AsPointer(ref this), p);
    }
