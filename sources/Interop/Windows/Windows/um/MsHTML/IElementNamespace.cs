...
public unsafe partial struct IElementNamespace : IElementNamespace.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementNamespace;
