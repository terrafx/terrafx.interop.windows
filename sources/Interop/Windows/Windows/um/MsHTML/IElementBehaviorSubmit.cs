...
public unsafe partial struct IElementBehaviorSubmit : IElementBehaviorSubmit.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementBehaviorSubmit;
