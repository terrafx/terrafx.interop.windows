...
public unsafe partial struct IDOMTreeWalker : IDOMTreeWalker.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDOMTreeWalker;
