...
public unsafe partial struct IHTMLPopup : IHTMLPopup.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLPopup*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLPopup*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, int, int, int, int, VARIANT*, int> show;

        [NativeTypeName("HRESULT () __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, int> hide;

        [NativeTypeName("HRESULT (IHTMLDocument **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, IHTMLDocument**, int> get_document;

        [NativeTypeName("HRESULT (VARIANT_BOOL *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, short*, int> get_isOpen;
    }
}
