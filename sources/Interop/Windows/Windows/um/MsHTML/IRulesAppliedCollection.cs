...
public unsafe partial struct IRulesAppliedCollection : IRulesAppliedCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IRulesAppliedCollection;
