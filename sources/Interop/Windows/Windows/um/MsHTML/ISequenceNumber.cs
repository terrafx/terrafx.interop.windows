...
public unsafe partial struct ISequenceNumber : ISequenceNumber.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISequenceNumber;
