...
public unsafe partial struct ISVGPathSegList : ISVGPathSegList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
