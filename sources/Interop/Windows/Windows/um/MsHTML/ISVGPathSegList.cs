...
public unsafe partial struct ISVGPathSegList : ISVGPathSegList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGPathSegList;
