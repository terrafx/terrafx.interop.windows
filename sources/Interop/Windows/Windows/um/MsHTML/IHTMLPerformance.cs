...
public unsafe partial struct IHTMLPerformance : IHTMLPerformance.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLPerformance;
