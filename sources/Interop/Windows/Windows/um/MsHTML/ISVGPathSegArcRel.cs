...
public unsafe partial struct ISVGPathSegArcRel : ISVGPathSegArcRel.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGPathSegArcRel;
