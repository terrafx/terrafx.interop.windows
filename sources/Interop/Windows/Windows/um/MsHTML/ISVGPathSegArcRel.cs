...
public unsafe partial struct ISVGPathSegArcRel : ISVGPathSegArcRel.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegArcRel*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegArcRel*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
