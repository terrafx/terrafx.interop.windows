...
public unsafe partial struct IHTMLInputHiddenElement : IHTMLInputHiddenElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLInputHiddenElement;
