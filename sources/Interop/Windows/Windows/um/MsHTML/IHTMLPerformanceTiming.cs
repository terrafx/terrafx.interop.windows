...
public unsafe partial struct IHTMLPerformanceTiming : IHTMLPerformanceTiming.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLPerformanceTiming;
