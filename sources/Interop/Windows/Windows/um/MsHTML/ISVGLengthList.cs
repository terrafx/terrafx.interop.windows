...
public unsafe partial struct ISVGLengthList : ISVGLengthList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGLengthList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGLengthList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
