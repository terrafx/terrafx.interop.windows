...
public unsafe partial struct ISVGLengthList : ISVGLengthList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGLengthList;
