...
public unsafe partial struct IHTMLVideoElement : IHTMLVideoElement.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLVideoElement;
