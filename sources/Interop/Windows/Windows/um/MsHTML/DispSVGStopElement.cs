...
public unsafe partial struct DispSVGStopElement : DispSVGStopElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DispSVGStopElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DispSVGStopElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
