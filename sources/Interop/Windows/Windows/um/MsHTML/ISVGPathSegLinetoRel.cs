...
public unsafe partial struct ISVGPathSegLinetoRel : ISVGPathSegLinetoRel.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegLinetoRel*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegLinetoRel*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
