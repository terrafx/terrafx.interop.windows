...
public unsafe partial struct ISVGPathSegMovetoAbs : ISVGPathSegMovetoAbs.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegMovetoAbs*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegMovetoAbs*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
