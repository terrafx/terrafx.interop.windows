...
public unsafe partial struct IElementBehaviorSite : IElementBehaviorSite.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IElementBehaviorSite;
