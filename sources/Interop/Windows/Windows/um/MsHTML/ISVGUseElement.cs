...
public unsafe partial struct ISVGUseElement : ISVGUseElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGUseElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGUseElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
