...
public unsafe partial struct IHTMLWindow4 : IHTMLWindow4.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLWindow4*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLWindow4*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, VARIANT*, IDispatch**, int> createPopup;

        [NativeTypeName("HRESULT (IHTMLFrameBase **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, IHTMLFrameBase**, int> get_frameElement;
    }
}
