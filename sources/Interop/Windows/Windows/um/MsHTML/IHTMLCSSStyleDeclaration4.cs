...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IHTMLCSSStyleDeclaration4);
    ...
    {
        [VtblIndex(7)]
        HRESULT put_webkitAppearance([NativeTypeName("BSTR")] char* v);

        [VtblIndex(8)]
        HRESULT get_webkitAppearance([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(9)]
        HRESULT put_webkitUserSelect([NativeTypeName("BSTR")] char* v);

        [VtblIndex(10)]
        HRESULT get_webkitUserSelect([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(11)]
        HRESULT put_webkitBoxAlign([NativeTypeName("BSTR")] char* v);

        [VtblIndex(12)]
        HRESULT get_webkitBoxAlign([NativeTypeName("BSTR *")] char** p);
        ...
        [VtblIndex(15)]
        HRESULT put_webkitBoxPack([NativeTypeName("BSTR")] char* v);

        [VtblIndex(16)]
        HRESULT get_webkitBoxPack([NativeTypeName("BSTR *")] char** p);
        ...
        [VtblIndex(19)]
        HRESULT put_webkitBoxOrient([NativeTypeName("BSTR")] char* v);

        [VtblIndex(20)]
        HRESULT get_webkitBoxOrient([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(21)]
        HRESULT put_webkitBoxDirection([NativeTypeName("BSTR")] char* v);

        [VtblIndex(22)]
        HRESULT get_webkitBoxDirection([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(23)]
        HRESULT put_webkitTransform([NativeTypeName("BSTR")] char* v);

        [VtblIndex(24)]
        HRESULT get_webkitTransform([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(25)]
        HRESULT put_webkitBackgroundSize([NativeTypeName("BSTR")] char* v);

        [VtblIndex(26)]
        HRESULT get_webkitBackgroundSize([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(27)]
        HRESULT put_webkitBackfaceVisibility([NativeTypeName("BSTR")] char* v);

        [VtblIndex(28)]
        HRESULT get_webkitBackfaceVisibility([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(29)]
        HRESULT put_webkitAnimation([NativeTypeName("BSTR")] char* v);

        [VtblIndex(30)]
        HRESULT get_webkitAnimation([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(31)]
        HRESULT put_webkitTransition([NativeTypeName("BSTR")] char* v);

        [VtblIndex(32)]
        HRESULT get_webkitTransition([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(33)]
        HRESULT put_webkitAnimationName([NativeTypeName("BSTR")] char* v);

        [VtblIndex(34)]
        HRESULT get_webkitAnimationName([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(35)]
        HRESULT put_webkitAnimationDuration([NativeTypeName("BSTR")] char* v);

        [VtblIndex(36)]
        HRESULT get_webkitAnimationDuration([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(37)]
        HRESULT put_webkitAnimationTimingFunction([NativeTypeName("BSTR")] char* v);

        [VtblIndex(38)]
        HRESULT get_webkitAnimationTimingFunction([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(39)]
        HRESULT put_webkitAnimationDelay([NativeTypeName("BSTR")] char* v);

        [VtblIndex(40)]
        HRESULT get_webkitAnimationDelay([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(41)]
        HRESULT put_webkitAnimationIterationCount([NativeTypeName("BSTR")] char* v);

        [VtblIndex(42)]
        HRESULT get_webkitAnimationIterationCount([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(43)]
        HRESULT put_webkitAnimationDirection([NativeTypeName("BSTR")] char* v);

        [VtblIndex(44)]
        HRESULT get_webkitAnimationDirection([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(45)]
        HRESULT put_webkitAnimationPlayState([NativeTypeName("BSTR")] char* v);

        [VtblIndex(46)]
        HRESULT get_webkitAnimationPlayState([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(47)]
        HRESULT put_webkitTransitionProperty([NativeTypeName("BSTR")] char* v);

        [VtblIndex(48)]
        HRESULT get_webkitTransitionProperty([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(49)]
        HRESULT put_webkitTransitionDuration([NativeTypeName("BSTR")] char* v);

        [VtblIndex(50)]
        HRESULT get_webkitTransitionDuration([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(51)]
        HRESULT put_webkitTransitionTimingFunction([NativeTypeName("BSTR")] char* v);

        [VtblIndex(52)]
        HRESULT get_webkitTransitionTimingFunction([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(53)]
        HRESULT put_webkitTransitionDelay([NativeTypeName("BSTR")] char* v);

        [VtblIndex(54)]
        HRESULT get_webkitTransitionDelay([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(55)]
        HRESULT put_webkitBackgroundAttachment([NativeTypeName("BSTR")] char* v);

        [VtblIndex(56)]
        HRESULT get_webkitBackgroundAttachment([NativeTypeName("BSTR *")] char** p);
        ...
        [VtblIndex(59)]
        HRESULT put_webkitBackgroundClip([NativeTypeName("BSTR")] char* v);

        [VtblIndex(60)]
        HRESULT get_webkitBackgroundClip([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(61)]
        HRESULT put_webkitBackgroundImage([NativeTypeName("BSTR")] char* v);

        [VtblIndex(62)]
        HRESULT get_webkitBackgroundImage([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(63)]
        HRESULT put_webkitBackgroundRepeat([NativeTypeName("BSTR")] char* v);

        [VtblIndex(64)]
        HRESULT get_webkitBackgroundRepeat([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(65)]
        HRESULT put_webkitBackgroundOrigin([NativeTypeName("BSTR")] char* v);

        [VtblIndex(66)]
        HRESULT get_webkitBackgroundOrigin([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(67)]
        HRESULT put_webkitBackgroundPosition([NativeTypeName("BSTR")] char* v);

        [VtblIndex(68)]
        HRESULT get_webkitBackgroundPosition([NativeTypeName("BSTR *")] char** p);
        ...
        [VtblIndex(73)]
        HRESULT put_webkitBackground([NativeTypeName("BSTR")] char* v);

        [VtblIndex(74)]
        HRESULT get_webkitBackground([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(75)]
        HRESULT put_webkitTransformOrigin([NativeTypeName("BSTR")] char* v);

        [VtblIndex(76)]
        HRESULT get_webkitTransformOrigin([NativeTypeName("BSTR *")] char** p);
        ...
        [VtblIndex(81)]
        HRESULT put_webkitBorderImage([NativeTypeName("BSTR")] char* v);

        [VtblIndex(82)]
        HRESULT get_webkitBorderImage([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(83)]
        HRESULT put_webkitBorderImageSource([NativeTypeName("BSTR")] char* v);

        [VtblIndex(84)]
        HRESULT get_webkitBorderImageSource([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(85)]
        HRESULT put_webkitBorderImageSlice([NativeTypeName("BSTR")] char* v);

        [VtblIndex(86)]
        HRESULT get_webkitBorderImageSlice([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(87)]
        HRESULT put_webkitBorderImageWidth([NativeTypeName("BSTR")] char* v);

        [VtblIndex(88)]
        HRESULT get_webkitBorderImageWidth([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(89)]
        HRESULT put_webkitBorderImageOutset([NativeTypeName("BSTR")] char* v);

        [VtblIndex(90)]
        HRESULT get_webkitBorderImageOutset([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(91)]
        HRESULT put_webkitBorderImageRepeat([NativeTypeName("BSTR")] char* v);

        [VtblIndex(92)]
        HRESULT get_webkitBorderImageRepeat([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(93)]
        HRESULT put_webkitBoxSizing([NativeTypeName("BSTR")] char* v);

        [VtblIndex(94)]
        HRESULT get_webkitBoxSizing([NativeTypeName("BSTR *")] char** p);

        [VtblIndex(95)]
        HRESULT put_webkitAnimationFillMode([NativeTypeName("BSTR")] char* v);

        [VtblIndex(96)]
        HRESULT get_webkitAnimationFillMode([NativeTypeName("BSTR *")] char** p);
    }
