...
public unsafe partial struct IHTMLCSSMediaRule : IHTMLCSSMediaRule.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLCSSMediaRule;
