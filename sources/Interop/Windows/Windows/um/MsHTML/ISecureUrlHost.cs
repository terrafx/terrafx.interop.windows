...
public unsafe partial struct ISecureUrlHost : ISecureUrlHost.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISecureUrlHost;
