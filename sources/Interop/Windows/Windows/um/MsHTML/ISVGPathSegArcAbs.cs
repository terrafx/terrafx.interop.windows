...
public unsafe partial struct ISVGPathSegArcAbs : ISVGPathSegArcAbs.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISVGPathSegArcAbs;
