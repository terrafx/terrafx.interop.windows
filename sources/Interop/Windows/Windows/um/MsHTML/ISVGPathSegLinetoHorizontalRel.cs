...
public unsafe partial struct ISVGPathSegLinetoHorizontalRel : ISVGPathSegLinetoHorizontalRel.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ISVGPathSegLinetoHorizontalRel*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((ISVGPathSegLinetoHorizontalRel*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
