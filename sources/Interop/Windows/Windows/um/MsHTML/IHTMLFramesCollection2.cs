...
public unsafe partial struct IHTMLFramesCollection2 : IHTMLFramesCollection2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLFramesCollection2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLFramesCollection2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
