...
public unsafe partial struct IHTMLOpsProfile : IHTMLOpsProfile.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHTMLOpsProfile;
