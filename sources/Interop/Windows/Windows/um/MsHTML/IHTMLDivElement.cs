...
public unsafe partial struct IHTMLDivElement : IHTMLDivElement.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHTMLDivElement*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IHTMLDivElement*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLDivElement*, char*, int>)(lpVtbl[7]))((IHTMLDivElement*)Unsafe.AsPointer(ref this), v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLDivElement*, char**, int>)(lpVtbl[8]))((IHTMLDivElement*)Unsafe.AsPointer(ref this), p);
    }
