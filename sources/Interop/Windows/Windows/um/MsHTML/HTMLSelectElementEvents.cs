...
public unsafe partial struct HTMLSelectElementEvents : HTMLSelectElementEvents.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<HTMLSelectElementEvents*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((HTMLSelectElementEvents*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
