...
public unsafe partial struct IScriptEventHandler : IScriptEventHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IScriptEventHandler;
