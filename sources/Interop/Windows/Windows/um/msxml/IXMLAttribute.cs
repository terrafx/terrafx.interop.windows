...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IXMLAttribute);
    ...
    {
        [VtblIndex(7)]
        HRESULT get_name([NativeTypeName("BSTR *")] char** n);

        [VtblIndex(8)]
        HRESULT get_value([NativeTypeName("BSTR *")] char** v);
    }
