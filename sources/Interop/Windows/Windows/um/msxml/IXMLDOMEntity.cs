...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IXMLDOMEntity);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, Guid*, void**, int>)(lpVtbl[0]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, uint>)(lpVtbl[1]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, uint>)(lpVtbl[2]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, uint*, int>)(lpVtbl[3]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), pctinfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, uint, uint, ITypeInfo**, int>)(lpVtbl[4]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), iTInfo, lcid, ppTInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int>)(lpVtbl[6]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[7]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), name);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, VARIANT*, int>)(lpVtbl[8]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, VARIANT, int>)(lpVtbl[9]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, DOMNodeType*, int>)(lpVtbl[10]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), type);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode**, int>)(lpVtbl[11]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), parent);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNodeList**, int>)(lpVtbl[12]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), childList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode**, int>)(lpVtbl[13]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), firstChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode**, int>)(lpVtbl[14]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), lastChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode**, int>)(lpVtbl[15]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), previousSibling);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode**, int>)(lpVtbl[16]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), nextSibling);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNamedNodeMap**, int>)(lpVtbl[17]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), attributeMap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode*, VARIANT, IXMLDOMNode**, int>)(lpVtbl[18]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), newChild, refChild, outNewChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode*, IXMLDOMNode*, IXMLDOMNode**, int>)(lpVtbl[19]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), newChild, oldChild, outOldChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode*, IXMLDOMNode**, int>)(lpVtbl[20]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), childNode, oldChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode*, IXMLDOMNode**, int>)(lpVtbl[21]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), newChild, outNewChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, short*, int>)(lpVtbl[22]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), hasChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMDocument**, int>)(lpVtbl[23]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), XMLDOMDocument);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, short, IXMLDOMNode**, int>)(lpVtbl[24]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), deep, cloneRoot);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[25]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), nodeType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[26]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), text);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char*, int>)(lpVtbl[27]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), text);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, short*, int>)(lpVtbl[28]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), isSpecified);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode**, int>)(lpVtbl[29]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), definitionNode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, VARIANT*, int>)(lpVtbl[30]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), typedValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, VARIANT, int>)(lpVtbl[31]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), typedValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, VARIANT*, int>)(lpVtbl[32]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), dataTypeName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char*, int>)(lpVtbl[33]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), dataTypeName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[34]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), xmlString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode*, char**, int>)(lpVtbl[35]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), stylesheet, xmlString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char*, IXMLDOMNodeList**, int>)(lpVtbl[36]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), queryString, resultList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char*, IXMLDOMNode**, int>)(lpVtbl[37]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), queryString, resultNode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, short*, int>)(lpVtbl[38]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), isParsed);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[39]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), namespaceURI);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[40]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), prefixString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[41]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), nameString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, IXMLDOMNode*, VARIANT, int>)(lpVtbl[42]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), stylesheet, outputObject);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, VARIANT*, int>)(lpVtbl[43]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), publicID);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, VARIANT*, int>)(lpVtbl[44]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), systemID);
    }

    /// <include file='IXMLDOMEntity.xml' path='doc/member[@name="IXMLDOMEntity.get_notationName"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(45)]
    public HRESULT get_notationName([NativeTypeName("BSTR *")] char** name)
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMEntity*, char**, int>)(lpVtbl[45]))((IXMLDOMEntity*)Unsafe.AsPointer(ref this), name);
    }
    ...
    public interface Interface : IXMLDOMNode.Interface
    {
        ...
        [VtblIndex(45)]
        HRESULT get_notationName([NativeTypeName("BSTR *")] char** name);
    }
