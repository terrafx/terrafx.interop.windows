...
public unsafe partial struct IXMLDSOControl : IXMLDSOControl.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IXMLDSOControl*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IXMLDSOControl*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
