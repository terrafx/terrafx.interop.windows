...
public unsafe partial struct IXMLDOMDocument : IXMLDOMDocument.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IXMLDOMDocument;
