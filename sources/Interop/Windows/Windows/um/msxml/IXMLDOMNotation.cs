...
public unsafe partial struct IXMLDOMNotation : IXMLDOMNotation.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char**, int>)(lpVtbl[7]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), name);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char**, int>)(lpVtbl[25]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), nodeType);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char**, int>)(lpVtbl[26]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), text);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char*, int>)(lpVtbl[27]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), text);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char*, int>)(lpVtbl[33]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), dataTypeName);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char**, int>)(lpVtbl[34]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), xmlString);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, IXMLDOMNode*, char**, int>)(lpVtbl[35]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), stylesheet, xmlString);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char*, IXMLDOMNodeList**, int>)(lpVtbl[36]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), queryString, resultList);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char*, IXMLDOMNode**, int>)(lpVtbl[37]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), queryString, resultNode);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char**, int>)(lpVtbl[39]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), namespaceURI);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char**, int>)(lpVtbl[40]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), prefixString);
    }
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNotation*, char**, int>)(lpVtbl[41]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), nameString);
    }
