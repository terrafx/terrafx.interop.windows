...
/// <include file='IXMLDOMNotation.xml' path='doc/member[@name="IXMLDOMNotation"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IXMLDOMNotation);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, Guid*, void**, int>)(lpVtbl[0]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, uint>)(lpVtbl[1]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, uint>)(lpVtbl[2]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, uint*, int>)(lpVtbl[3]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), pctinfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, uint, uint, ITypeInfo**, int>)(lpVtbl[4]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), iTInfo, lcid, ppTInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int>)(lpVtbl[6]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char**, int>)(lpVtbl[7]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), name);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, VARIANT*, int>)(lpVtbl[8]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, VARIANT, int>)(lpVtbl[9]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, DOMNodeType*, int>)(lpVtbl[10]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), type);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode**, int>)(lpVtbl[11]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), parent);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNodeList**, int>)(lpVtbl[12]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), childList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode**, int>)(lpVtbl[13]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), firstChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode**, int>)(lpVtbl[14]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), lastChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode**, int>)(lpVtbl[15]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), previousSibling);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode**, int>)(lpVtbl[16]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), nextSibling);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNamedNodeMap**, int>)(lpVtbl[17]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), attributeMap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode*, VARIANT, IXMLDOMNode**, int>)(lpVtbl[18]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), newChild, refChild, outNewChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode*, IXMLDOMNode*, IXMLDOMNode**, int>)(lpVtbl[19]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), newChild, oldChild, outOldChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode*, IXMLDOMNode**, int>)(lpVtbl[20]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), childNode, oldChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode*, IXMLDOMNode**, int>)(lpVtbl[21]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), newChild, outNewChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, short*, int>)(lpVtbl[22]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), hasChild);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMDocument**, int>)(lpVtbl[23]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), XMLDOMDocument);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, short, IXMLDOMNode**, int>)(lpVtbl[24]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), deep, cloneRoot);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char**, int>)(lpVtbl[25]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), nodeType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char**, int>)(lpVtbl[26]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), text);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char*, int>)(lpVtbl[27]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), text);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, short*, int>)(lpVtbl[28]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), isSpecified);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode**, int>)(lpVtbl[29]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), definitionNode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, VARIANT*, int>)(lpVtbl[30]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), typedValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, VARIANT, int>)(lpVtbl[31]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), typedValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, VARIANT*, int>)(lpVtbl[32]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), dataTypeName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char*, int>)(lpVtbl[33]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), dataTypeName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char**, int>)(lpVtbl[34]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), xmlString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode*, char**, int>)(lpVtbl[35]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), stylesheet, xmlString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char*, IXMLDOMNodeList**, int>)(lpVtbl[36]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), queryString, resultList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char*, IXMLDOMNode**, int>)(lpVtbl[37]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), queryString, resultNode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, short*, int>)(lpVtbl[38]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), isParsed);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char**, int>)(lpVtbl[39]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), namespaceURI);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char**, int>)(lpVtbl[40]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), prefixString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, char**, int>)(lpVtbl[41]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), nameString);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, IXMLDOMNode*, VARIANT, int>)(lpVtbl[42]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), stylesheet, outputObject);
    }

    /// <include file='IXMLDOMNotation.xml' path='doc/member[@name="IXMLDOMNotation.get_publicId"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(43)]
    public HRESULT get_publicId(VARIANT* publicID)
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, VARIANT*, int>)(lpVtbl[43]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), publicID);
    }

    /// <include file='IXMLDOMNotation.xml' path='doc/member[@name="IXMLDOMNotation.get_systemId"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(44)]
    public HRESULT get_systemId(VARIANT* systemID)
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMNotation*, VARIANT*, int>)(lpVtbl[44]))((IXMLDOMNotation*)Unsafe.AsPointer(ref this), systemID);
    }
