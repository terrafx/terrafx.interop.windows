...
public unsafe partial struct IXMLElementCollection : IXMLElementCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IXMLElementCollection;
