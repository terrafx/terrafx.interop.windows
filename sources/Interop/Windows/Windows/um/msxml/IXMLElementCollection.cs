...
public unsafe partial struct IXMLElementCollection : IXMLElementCollection.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IXMLElementCollection*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IXMLElementCollection*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
