...
public unsafe partial struct IXMLDOMNodeList : IXMLDOMNodeList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IXMLDOMNodeList;
