...
public unsafe partial struct IXMLDOMNodeList : IXMLDOMNodeList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IXMLDOMNodeList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IXMLDOMNodeList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
