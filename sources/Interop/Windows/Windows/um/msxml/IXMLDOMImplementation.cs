...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IXMLDOMImplementation);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMImplementation*, uint*, int>)(lpVtbl[3]))((IXMLDOMImplementation*)Unsafe.AsPointer(ref this), pctinfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMImplementation*, uint, uint, ITypeInfo**, int>)(lpVtbl[4]))((IXMLDOMImplementation*)Unsafe.AsPointer(ref this), iTInfo, lcid, ppTInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMImplementation*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IXMLDOMImplementation*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMImplementation*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int>)(lpVtbl[6]))((IXMLDOMImplementation*)Unsafe.AsPointer(ref this), dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IXMLDOMImplementation*, char*, char*, short*, int>)(lpVtbl[7]))((IXMLDOMImplementation*)Unsafe.AsPointer(ref this), feature, version, hasFeature);
    }
