...
// Ported from um/CommDlg.h in the Windows SDK for Windows 10.0.28000.0
...
{
    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetOpenFileNameA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL GetOpenFileNameA([NativeTypeName("LPOPENFILENAMEA")] OPENFILENAMEA* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetOpenFileNameW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL GetOpenFileNameW([NativeTypeName("LPOPENFILENAMEW")] OPENFILENAMEW* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetSaveFileNameA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL GetSaveFileNameA([NativeTypeName("LPOPENFILENAMEA")] OPENFILENAMEA* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetSaveFileNameW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL GetSaveFileNameW([NativeTypeName("LPOPENFILENAMEW")] OPENFILENAMEW* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetFileTitleA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern short GetFileTitleA([NativeTypeName("LPCSTR")] sbyte* param0, [NativeTypeName("LPSTR")] sbyte* Buf, [NativeTypeName("WORD")] ushort cchSize);
    ...
    /// <include file='Windows.xml' path='doc/member[@name="Windows.ChooseColorW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL ChooseColorW([NativeTypeName("LPCHOOSECOLORW")] CHOOSECOLORW* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.FindTextA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern HWND FindTextA([NativeTypeName("LPFINDREPLACEA")] FINDREPLACEA* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.FindTextW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern HWND FindTextW([NativeTypeName("LPFINDREPLACEW")] FINDREPLACEW* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.ReplaceTextA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern HWND ReplaceTextA([NativeTypeName("LPFINDREPLACEA")] FINDREPLACEA* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.ReplaceTextW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern HWND ReplaceTextW([NativeTypeName("LPFINDREPLACEW")] FINDREPLACEW* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.ChooseFontA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL ChooseFontA([NativeTypeName("LPCHOOSEFONTA")] CHOOSEFONTA* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.ChooseFontW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL ChooseFontW([NativeTypeName("LPCHOOSEFONTW")] CHOOSEFONTW* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.PrintDlgA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL PrintDlgA([NativeTypeName("LPPRINTDLGA")] PRINTDLGA* pPD);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.PrintDlgW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL PrintDlgW([NativeTypeName("LPPRINTDLGW")] PRINTDLGW* pPD);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.PrintDlgExA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern HRESULT PrintDlgExA([NativeTypeName("LPPRINTDLGEXA")] PRINTDLGEXA* pPD);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.PrintDlgExW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern HRESULT PrintDlgExW([NativeTypeName("LPPRINTDLGEXW")] PRINTDLGEXW* pPD);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.CommDlgExtendedError"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint CommDlgExtendedError();

    /// <include file='Windows.xml' path='doc/member[@name="Windows.PageSetupDlgA"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL PageSetupDlgA([NativeTypeName("LPPAGESETUPDLGA")] PAGESETUPDLGA* param0);

    /// <include file='Windows.xml' path='doc/member[@name="Windows.PageSetupDlgW"]/*' />
    [DllImport("comdlg32", ExactSpelling = true)]
    public static extern BOOL PageSetupDlgW([NativeTypeName("LPPAGESETUPDLGW")] PAGESETUPDLGW* param0);
