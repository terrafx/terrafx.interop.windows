...
public unsafe partial struct IContactManager : IContactManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IContactManager;
