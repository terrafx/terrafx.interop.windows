...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IShellFolder2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, Guid*, void**, int>)(lpVtbl[0]))((IShellFolder2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, uint>)(lpVtbl[1]))((IShellFolder2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, uint>)(lpVtbl[2]))((IShellFolder2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, HWND, IBindCtx*, char*, uint*, ITEMIDLIST**, uint*, int>)(lpVtbl[3]))((IShellFolder2*)Unsafe.AsPointer(ref this), hwnd, pbc, pszDisplayName, pchEaten, ppidl, pdwAttributes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, HWND, uint, IEnumIDList**, int>)(lpVtbl[4]))((IShellFolder2*)Unsafe.AsPointer(ref this), hwnd, grfFlags, ppenumIDList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, ITEMIDLIST*, IBindCtx*, Guid*, void**, int>)(lpVtbl[5]))((IShellFolder2*)Unsafe.AsPointer(ref this), pidl, pbc, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, ITEMIDLIST*, IBindCtx*, Guid*, void**, int>)(lpVtbl[6]))((IShellFolder2*)Unsafe.AsPointer(ref this), pidl, pbc, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, LPARAM, ITEMIDLIST*, ITEMIDLIST*, int>)(lpVtbl[7]))((IShellFolder2*)Unsafe.AsPointer(ref this), lParam, pidl1, pidl2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, HWND, Guid*, void**, int>)(lpVtbl[8]))((IShellFolder2*)Unsafe.AsPointer(ref this), hwndOwner, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, uint, ITEMIDLIST**, uint*, int>)(lpVtbl[9]))((IShellFolder2*)Unsafe.AsPointer(ref this), cidl, apidl, rgfInOut);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, HWND, uint, ITEMIDLIST**, Guid*, uint*, void**, int>)(lpVtbl[10]))((IShellFolder2*)Unsafe.AsPointer(ref this), hwndOwner, cidl, apidl, riid, rgfReserved, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, ITEMIDLIST*, uint, STRRET*, int>)(lpVtbl[11]))((IShellFolder2*)Unsafe.AsPointer(ref this), pidl, uFlags, pName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, HWND, ITEMIDLIST*, char*, uint, ITEMIDLIST**, int>)(lpVtbl[12]))((IShellFolder2*)Unsafe.AsPointer(ref this), hwnd, pidl, pszName, uFlags, ppidlOut);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, Guid*, int>)(lpVtbl[13]))((IShellFolder2*)Unsafe.AsPointer(ref this), pguid);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, IEnumExtraSearch**, int>)(lpVtbl[14]))((IShellFolder2*)Unsafe.AsPointer(ref this), ppenum);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, uint, uint*, uint*, int>)(lpVtbl[15]))((IShellFolder2*)Unsafe.AsPointer(ref this), dwRes, pSort, pDisplay);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, uint, uint*, int>)(lpVtbl[16]))((IShellFolder2*)Unsafe.AsPointer(ref this), iColumn, pcsFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, ITEMIDLIST*, PROPERTYKEY*, VARIANT*, int>)(lpVtbl[17]))((IShellFolder2*)Unsafe.AsPointer(ref this), pidl, pscid, pv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, ITEMIDLIST*, uint, SHELLDETAILS*, int>)(lpVtbl[18]))((IShellFolder2*)Unsafe.AsPointer(ref this), pidl, iColumn, psd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IShellFolder2*, uint, PROPERTYKEY*, int>)(lpVtbl[19]))((IShellFolder2*)Unsafe.AsPointer(ref this), iColumn, pscid);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, IBindCtx*, char*, uint*, ITEMIDLIST**, uint*, int> ParseDisplayName;

        [NativeTypeName("HRESULT (HWND, SHCONTF, IEnumIDList **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, uint, IEnumIDList**, int> EnumObjects;

        [NativeTypeName("HRESULT (LPCITEMIDLIST, IBindCtx *, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ITEMIDLIST*, IBindCtx*, Guid*, void**, int> BindToObject;

        [NativeTypeName("HRESULT (LPCITEMIDLIST, IBindCtx *, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ITEMIDLIST*, IBindCtx*, Guid*, void**, int> BindToStorage;

        [NativeTypeName("HRESULT (LPARAM, LPCITEMIDLIST, LPCITEMIDLIST) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, LPARAM, ITEMIDLIST*, ITEMIDLIST*, int> CompareIDs;

        [NativeTypeName("HRESULT (HWND, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, Guid*, void**, int> CreateViewObject;

        [NativeTypeName("HRESULT (UINT, LPCITEMIDLIST *, SFGAOF *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, ITEMIDLIST**, uint*, int> GetAttributesOf;

        [NativeTypeName("HRESULT (HWND, UINT, LPCITEMIDLIST *, const IID &, UINT *, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, uint, ITEMIDLIST**, Guid*, uint*, void**, int> GetUIObjectOf;

        [NativeTypeName("HRESULT (LPCITEMIDLIST, SHGDNF, STRRET *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ITEMIDLIST*, uint, STRRET*, int> GetDisplayNameOf;

        [NativeTypeName("HRESULT (HWND, LPCITEMIDLIST, LPCWSTR, SHGDNF, LPITEMIDLIST *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, ITEMIDLIST*, char*, uint, ITEMIDLIST**, int> SetNameOf;

        [NativeTypeName("HRESULT (GUID *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, int> GetDefaultSearchGUID;

        [NativeTypeName("HRESULT (IEnumExtraSearch **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IEnumExtraSearch**, int> EnumSearches;

        [NativeTypeName("HRESULT (DWORD, ULONG *, ULONG *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, uint*, uint*, int> GetDefaultColumn;

        [NativeTypeName("HRESULT (UINT, SHCOLSTATEF *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, uint*, int> GetDefaultColumnState;

        [NativeTypeName("HRESULT (LPCITEMIDLIST, const SHCOLUMNID *, VARIANT *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ITEMIDLIST*, PROPERTYKEY*, VARIANT*, int> GetDetailsEx;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, PROPERTYKEY*, int> MapColumnToSCID;
    }
}
