...
public unsafe partial struct IExplorerCommandState : IExplorerCommandState.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IExplorerCommandState;
