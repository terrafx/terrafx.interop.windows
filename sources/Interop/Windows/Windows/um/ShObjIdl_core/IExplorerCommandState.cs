...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IExplorerCommandState);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandState*, Guid*, void**, int>)(lpVtbl[0]))((IExplorerCommandState*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandState*, uint>)(lpVtbl[1]))((IExplorerCommandState*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandState*, uint>)(lpVtbl[2]))((IExplorerCommandState*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandState*, IShellItemArray*, BOOL, uint*, int>)(lpVtbl[3]))((IExplorerCommandState*)Unsafe.AsPointer(ref this), psiItemArray, fOkToBeSlow, pCmdState);
    }
