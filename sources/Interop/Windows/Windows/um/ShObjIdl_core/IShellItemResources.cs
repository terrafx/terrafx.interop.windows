...
public unsafe partial struct IShellItemResources : IShellItemResources.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellItemResources;
