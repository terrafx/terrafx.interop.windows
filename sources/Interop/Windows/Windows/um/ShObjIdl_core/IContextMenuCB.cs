...
public unsafe partial struct IContextMenuCB : IContextMenuCB.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IContextMenuCB;
