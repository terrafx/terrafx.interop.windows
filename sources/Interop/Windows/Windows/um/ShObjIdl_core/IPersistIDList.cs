...
public unsafe partial struct IPersistIDList : IPersistIDList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPersistIDList;
