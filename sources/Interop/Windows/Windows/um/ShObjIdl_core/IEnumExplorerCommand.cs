...
public unsafe partial struct IEnumExplorerCommand : IEnumExplorerCommand.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumExplorerCommand;
