...
public unsafe partial struct IShellLinkDataList : IShellLinkDataList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellLinkDataList;
