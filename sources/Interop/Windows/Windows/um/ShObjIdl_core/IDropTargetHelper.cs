...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDropTargetHelper);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, Guid*, void**, int>)(lpVtbl[0]))((IDropTargetHelper*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, uint>)(lpVtbl[1]))((IDropTargetHelper*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, uint>)(lpVtbl[2]))((IDropTargetHelper*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, HWND, IDataObject*, POINT*, uint, int>)(lpVtbl[3]))((IDropTargetHelper*)Unsafe.AsPointer(ref this), hwndTarget, pDataObject, ppt, dwEffect);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, int>)(lpVtbl[4]))((IDropTargetHelper*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, POINT*, uint, int>)(lpVtbl[5]))((IDropTargetHelper*)Unsafe.AsPointer(ref this), ppt, dwEffect);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, IDataObject*, POINT*, uint, int>)(lpVtbl[6]))((IDropTargetHelper*)Unsafe.AsPointer(ref this), pDataObject, ppt, dwEffect);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDropTargetHelper*, BOOL, int>)(lpVtbl[7]))((IDropTargetHelper*)Unsafe.AsPointer(ref this), fShow);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HWND, IDataObject*, POINT*, uint, int> DragEnter;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, POINT*, uint, int> DragOver;

        [NativeTypeName("HRESULT (IDataObject *, POINT *, DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IDataObject*, POINT*, uint, int> Drop;
