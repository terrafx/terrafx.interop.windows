...
public unsafe partial struct IGetServiceIds : IGetServiceIds.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IGetServiceIds;
