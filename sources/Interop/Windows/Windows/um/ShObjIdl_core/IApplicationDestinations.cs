...
public unsafe partial struct IApplicationDestinations : IApplicationDestinations.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IApplicationDestinations;
