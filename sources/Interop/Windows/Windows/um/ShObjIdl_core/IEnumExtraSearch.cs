...
public unsafe partial struct IEnumExtraSearch : IEnumExtraSearch.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumExtraSearch;
