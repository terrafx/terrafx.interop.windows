...
public unsafe partial struct IPropertyKeyStore : IPropertyKeyStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyKeyStore;
