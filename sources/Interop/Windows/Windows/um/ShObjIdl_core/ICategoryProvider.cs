...
public unsafe partial struct ICategoryProvider : ICategoryProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICategoryProvider;
