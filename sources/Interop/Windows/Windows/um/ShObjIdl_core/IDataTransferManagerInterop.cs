...
public unsafe partial struct IDataTransferManagerInterop : IDataTransferManagerInterop.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDataTransferManagerInterop;
