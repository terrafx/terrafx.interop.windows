...
public unsafe partial struct IHandlerActivationHost : IHandlerActivationHost.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IHandlerActivationHost;
