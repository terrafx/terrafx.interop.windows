...
public unsafe partial struct IEnumShellItems : IEnumShellItems.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumShellItems;
