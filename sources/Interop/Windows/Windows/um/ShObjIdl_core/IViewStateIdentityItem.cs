...
public unsafe partial struct IViewStateIdentityItem : IViewStateIdentityItem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IViewStateIdentityItem;
