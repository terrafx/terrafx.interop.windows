...
public unsafe partial struct IColumnManager : IColumnManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IColumnManager;
