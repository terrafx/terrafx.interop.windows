...
public unsafe partial struct IInputObjectSite : IInputObjectSite.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInputObjectSite;
