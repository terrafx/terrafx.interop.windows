...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IRelatedItem);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRelatedItem*, Guid*, void**, int>)(lpVtbl[0]))((IRelatedItem*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IRelatedItem*, uint>)(lpVtbl[1]))((IRelatedItem*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IRelatedItem*, uint>)(lpVtbl[2]))((IRelatedItem*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRelatedItem*, ITEMIDLIST**, int>)(lpVtbl[3]))((IRelatedItem*)Unsafe.AsPointer(ref this), ppidl);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IRelatedItem*, IShellItem**, int>)(lpVtbl[4]))((IRelatedItem*)Unsafe.AsPointer(ref this), ppsi);
    }
