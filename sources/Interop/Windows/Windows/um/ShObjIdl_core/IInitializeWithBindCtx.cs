...
public unsafe partial struct IInitializeWithBindCtx : IInitializeWithBindCtx.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeWithBindCtx;
