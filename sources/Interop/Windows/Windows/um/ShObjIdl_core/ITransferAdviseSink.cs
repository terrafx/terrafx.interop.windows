...
public unsafe partial struct ITransferAdviseSink : ITransferAdviseSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITransferAdviseSink;
