...
public unsafe partial struct IApplicationDocumentLists : IApplicationDocumentLists.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IApplicationDocumentLists;
