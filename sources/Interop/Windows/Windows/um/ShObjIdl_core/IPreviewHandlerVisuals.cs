...
public unsafe partial struct IPreviewHandlerVisuals : IPreviewHandlerVisuals.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPreviewHandlerVisuals;
