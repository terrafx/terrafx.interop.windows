...
public unsafe partial struct IEnumFullIDList : IEnumFullIDList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumFullIDList;
