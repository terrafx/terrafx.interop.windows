...
public unsafe partial struct IFrameworkInputPane : IFrameworkInputPane.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFrameworkInputPane;
