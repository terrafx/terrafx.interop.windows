...
public unsafe partial struct IObjectWithProgID : IObjectWithProgID.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IObjectWithProgID;
