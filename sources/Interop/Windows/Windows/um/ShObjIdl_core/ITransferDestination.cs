...
public unsafe partial struct ITransferDestination : ITransferDestination.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITransferDestination;
