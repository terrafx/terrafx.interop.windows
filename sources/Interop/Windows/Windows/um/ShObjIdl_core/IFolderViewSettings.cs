...
public unsafe partial struct IFolderViewSettings : IFolderViewSettings.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFolderViewSettings;
