...
public unsafe partial struct IPersistFolder2 : IPersistFolder2.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPersistFolder2;
