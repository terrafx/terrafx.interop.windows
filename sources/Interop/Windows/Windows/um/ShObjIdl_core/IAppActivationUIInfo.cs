...
public unsafe partial struct IAppActivationUIInfo : IAppActivationUIInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAppActivationUIInfo;
