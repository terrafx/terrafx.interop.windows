...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IOpenControlPanel);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOpenControlPanel*, Guid*, void**, int>)(lpVtbl[0]))((IOpenControlPanel*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IOpenControlPanel*, uint>)(lpVtbl[1]))((IOpenControlPanel*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IOpenControlPanel*, uint>)(lpVtbl[2]))((IOpenControlPanel*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOpenControlPanel*, char*, char*, IUnknown*, int>)(lpVtbl[3]))((IOpenControlPanel*)Unsafe.AsPointer(ref this), pszName, pszPage, punkSite);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOpenControlPanel*, char*, char*, uint, int>)(lpVtbl[4]))((IOpenControlPanel*)Unsafe.AsPointer(ref this), pszName, pszPath, cchPath);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOpenControlPanel*, CPVIEW*, int>)(lpVtbl[5]))((IOpenControlPanel*)Unsafe.AsPointer(ref this), pView);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, char*, IUnknown*, int> Open;

        [NativeTypeName("HRESULT (LPCWSTR, LPWSTR, UINT) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, char*, uint, int> GetPath;

        [NativeTypeName("HRESULT (CPVIEW *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, CPVIEW*, int> GetCurrentView;
    }
}
