...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IPersistFolder);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder*, Guid*, void**, int>)(lpVtbl[0]))((IPersistFolder*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder*, uint>)(lpVtbl[1]))((IPersistFolder*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder*, uint>)(lpVtbl[2]))((IPersistFolder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder*, Guid*, int>)(lpVtbl[3]))((IPersistFolder*)Unsafe.AsPointer(ref this), pClassID);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder*, ITEMIDLIST*, int>)(lpVtbl[4]))((IPersistFolder*)Unsafe.AsPointer(ref this), pidl);
    }
