...
public unsafe partial struct IPersistFolder : IPersistFolder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPersistFolder;
