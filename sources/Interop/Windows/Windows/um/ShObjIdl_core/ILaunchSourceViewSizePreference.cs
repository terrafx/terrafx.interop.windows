...
public unsafe partial struct ILaunchSourceViewSizePreference : ILaunchSourceViewSizePreference.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ILaunchSourceViewSizePreference;
