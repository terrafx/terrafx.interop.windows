...
public unsafe partial struct IObjectProvider : IObjectProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IObjectProvider;
