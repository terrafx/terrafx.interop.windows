...
public unsafe partial struct IApplicationActivationManager : IApplicationActivationManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IApplicationActivationManager;
