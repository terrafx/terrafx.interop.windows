...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IShellLinkW);
    ...
    {
        [VtblIndex(3)]
        HRESULT GetPath([NativeTypeName("LPWSTR")] char* pszFile, int cch, WIN32_FIND_DATAW* pfd, [NativeTypeName("DWORD")] uint fFlags);
        ...
        [VtblIndex(6)]
        HRESULT GetDescription([NativeTypeName("LPWSTR")] char* pszName, int cch);

        [VtblIndex(7)]
        HRESULT SetDescription([NativeTypeName("LPCWSTR")] char* pszName);

        [VtblIndex(8)]
        HRESULT GetWorkingDirectory([NativeTypeName("LPWSTR")] char* pszDir, int cch);

        [VtblIndex(9)]
        HRESULT SetWorkingDirectory([NativeTypeName("LPCWSTR")] char* pszDir);

        [VtblIndex(10)]
        HRESULT GetArguments([NativeTypeName("LPWSTR")] char* pszArgs, int cch);

        [VtblIndex(11)]
        HRESULT SetArguments([NativeTypeName("LPCWSTR")] char* pszArgs);
        ...
        [VtblIndex(16)]
        HRESULT GetIconLocation([NativeTypeName("LPWSTR")] char* pszIconPath, int cch, int* piIcon);

        [VtblIndex(17)]
        HRESULT SetIconLocation([NativeTypeName("LPCWSTR")] char* pszIconPath, int iIcon);

        [VtblIndex(18)]
        HRESULT SetRelativePath([NativeTypeName("LPCWSTR")] char* pszPathRel, [NativeTypeName("DWORD")] uint dwReserved);

        [VtblIndex(19)]
        HRESULT Resolve(HWND hwnd, [NativeTypeName("DWORD")] uint fFlags);

        [VtblIndex(20)]
        HRESULT SetPath([NativeTypeName("LPCWSTR")] char* pszFile);
    }
