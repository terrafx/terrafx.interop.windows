...
public unsafe partial struct IDestinationStreamFactory : IDestinationStreamFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDestinationStreamFactory;
