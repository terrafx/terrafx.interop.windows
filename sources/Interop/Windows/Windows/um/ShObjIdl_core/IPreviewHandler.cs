...
public unsafe partial struct IPreviewHandler : IPreviewHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPreviewHandler;
