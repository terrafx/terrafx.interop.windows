...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDeskBand);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, Guid*, void**, int>)(lpVtbl[0]))((IDeskBand*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, uint>)(lpVtbl[1]))((IDeskBand*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, uint>)(lpVtbl[2]))((IDeskBand*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, HWND*, int>)(lpVtbl[3]))((IDeskBand*)Unsafe.AsPointer(ref this), phwnd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, BOOL, int>)(lpVtbl[4]))((IDeskBand*)Unsafe.AsPointer(ref this), fEnterMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, BOOL, int>)(lpVtbl[5]))((IDeskBand*)Unsafe.AsPointer(ref this), fShow);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, uint, int>)(lpVtbl[6]))((IDeskBand*)Unsafe.AsPointer(ref this), dwReserved);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, RECT*, IUnknown*, BOOL, int>)(lpVtbl[7]))((IDeskBand*)Unsafe.AsPointer(ref this), prcBorder, punkToolbarSite, fReserved);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDeskBand*, uint, uint, DESKBANDINFO*, int>)(lpVtbl[8]))((IDeskBand*)Unsafe.AsPointer(ref this), dwBandID, dwViewMode, pdbi);
    }
