...
public unsafe partial struct INamespaceWalkCB : INamespaceWalkCB.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_INamespaceWalkCB;
