...
public unsafe partial struct IContactManagerInterop : IContactManagerInterop.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IContactManagerInterop;
