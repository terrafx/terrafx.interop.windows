...
public unsafe partial struct IParentAndItem : IParentAndItem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IParentAndItem;
