...
public unsafe partial struct IObjectWithBackReferences : IObjectWithBackReferences.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IObjectWithBackReferences;
