...
public unsafe partial struct IExplorerCommandProvider : IExplorerCommandProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IExplorerCommandProvider;
