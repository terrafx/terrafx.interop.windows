...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IExplorerCommandProvider);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandProvider*, Guid*, void**, int>)(lpVtbl[0]))((IExplorerCommandProvider*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandProvider*, uint>)(lpVtbl[1]))((IExplorerCommandProvider*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandProvider*, uint>)(lpVtbl[2]))((IExplorerCommandProvider*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandProvider*, IUnknown*, Guid*, void**, int>)(lpVtbl[3]))((IExplorerCommandProvider*)Unsafe.AsPointer(ref this), punkSite, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IExplorerCommandProvider*, Guid*, Guid*, void**, int>)(lpVtbl[4]))((IExplorerCommandProvider*)Unsafe.AsPointer(ref this), rguidCommandId, riid, ppv);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IUnknown*, Guid*, void**, int> GetCommands;

        [NativeTypeName("HRESULT (const GUID &, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, Guid*, void**, int> GetCommand;
    }
}
