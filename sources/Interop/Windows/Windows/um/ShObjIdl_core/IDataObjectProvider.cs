...
public unsafe partial struct IDataObjectProvider : IDataObjectProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDataObjectProvider;
