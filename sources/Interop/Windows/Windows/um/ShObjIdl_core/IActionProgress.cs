...
public unsafe partial struct IActionProgress : IActionProgress.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IActionProgress;
