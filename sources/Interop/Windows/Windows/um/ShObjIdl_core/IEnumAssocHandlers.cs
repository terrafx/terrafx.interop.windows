...
public unsafe partial struct IEnumAssocHandlers : IEnumAssocHandlers.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumAssocHandlers;
