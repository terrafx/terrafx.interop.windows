...
public unsafe partial struct IFileOpenDialog : IFileOpenDialog.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFileOpenDialog;
