...
public unsafe partial struct ICommDlgBrowser : ICommDlgBrowser.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICommDlgBrowser;
