...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ICommDlgBrowser);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICommDlgBrowser*, Guid*, void**, int>)(lpVtbl[0]))((ICommDlgBrowser*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ICommDlgBrowser*, uint>)(lpVtbl[1]))((ICommDlgBrowser*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ICommDlgBrowser*, uint>)(lpVtbl[2]))((ICommDlgBrowser*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICommDlgBrowser*, IShellView*, int>)(lpVtbl[3]))((ICommDlgBrowser*)Unsafe.AsPointer(ref this), ppshv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICommDlgBrowser*, IShellView*, uint, int>)(lpVtbl[4]))((ICommDlgBrowser*)Unsafe.AsPointer(ref this), ppshv, uChange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICommDlgBrowser*, IShellView*, ITEMIDLIST*, int>)(lpVtbl[5]))((ICommDlgBrowser*)Unsafe.AsPointer(ref this), ppshv, pidl);
    }
