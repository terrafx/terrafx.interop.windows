...
public unsafe partial struct ITransferSource : ITransferSource.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITransferSource;
