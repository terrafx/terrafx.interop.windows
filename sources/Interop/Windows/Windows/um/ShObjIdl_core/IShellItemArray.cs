...
public unsafe partial struct IShellItemArray : IShellItemArray.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellItemArray;
