...
public unsafe partial struct IFileOperation : IFileOperation.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFileOperation;
