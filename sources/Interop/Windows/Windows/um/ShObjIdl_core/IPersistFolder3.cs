...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IPersistFolder3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, Guid*, void**, int>)(lpVtbl[0]))((IPersistFolder3*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, uint>)(lpVtbl[1]))((IPersistFolder3*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, uint>)(lpVtbl[2]))((IPersistFolder3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, Guid*, int>)(lpVtbl[3]))((IPersistFolder3*)Unsafe.AsPointer(ref this), pClassID);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, ITEMIDLIST*, int>)(lpVtbl[4]))((IPersistFolder3*)Unsafe.AsPointer(ref this), pidl);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, ITEMIDLIST**, int>)(lpVtbl[5]))((IPersistFolder3*)Unsafe.AsPointer(ref this), ppidl);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, IBindCtx*, ITEMIDLIST*, PERSIST_FOLDER_TARGET_INFO*, int>)(lpVtbl[6]))((IPersistFolder3*)Unsafe.AsPointer(ref this), pbc, pidlRoot, ppfti);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPersistFolder3*, PERSIST_FOLDER_TARGET_INFO*, int>)(lpVtbl[7]))((IPersistFolder3*)Unsafe.AsPointer(ref this), ppfti);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IBindCtx*, ITEMIDLIST*, PERSIST_FOLDER_TARGET_INFO*, int> InitializeEx;

        [NativeTypeName("HRESULT (PERSIST_FOLDER_TARGET_INFO *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, PERSIST_FOLDER_TARGET_INFO*, int> GetFolderTargetInfo;
    }
}
