...
public unsafe partial struct IEnumResources : IEnumResources.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumResources;
