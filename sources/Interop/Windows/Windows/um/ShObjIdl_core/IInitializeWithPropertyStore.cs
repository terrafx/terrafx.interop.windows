...
public unsafe partial struct IInitializeWithPropertyStore : IInitializeWithPropertyStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeWithPropertyStore;
