...
public unsafe partial struct ILaunchUIContext : ILaunchUIContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ILaunchUIContext;
