...
public unsafe partial struct IInitializeWithWindow : IInitializeWithWindow.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeWithWindow;
