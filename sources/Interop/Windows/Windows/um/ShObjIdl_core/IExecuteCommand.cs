...
public unsafe partial struct IExecuteCommand : IExecuteCommand.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IExecuteCommand;
