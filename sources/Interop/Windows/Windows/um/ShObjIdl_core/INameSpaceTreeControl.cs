...
public unsafe partial struct INameSpaceTreeControl : INameSpaceTreeControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_INameSpaceTreeControl;
