...
public unsafe partial struct IInitializeNetworkFolder : IInitializeNetworkFolder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeNetworkFolder;
