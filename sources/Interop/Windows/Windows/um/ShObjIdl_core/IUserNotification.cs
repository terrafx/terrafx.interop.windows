...
public unsafe partial struct IUserNotification : IUserNotification.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IUserNotification;
