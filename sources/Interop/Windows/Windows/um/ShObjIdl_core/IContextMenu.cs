...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IContextMenu);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IContextMenu*, Guid*, void**, int>)(lpVtbl[0]))((IContextMenu*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IContextMenu*, uint>)(lpVtbl[1]))((IContextMenu*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IContextMenu*, uint>)(lpVtbl[2]))((IContextMenu*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IContextMenu*, HMENU, uint, uint, uint, uint, int>)(lpVtbl[3]))((IContextMenu*)Unsafe.AsPointer(ref this), hmenu, indexMenu, idCmdFirst, idCmdLast, uFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IContextMenu*, CMINVOKECOMMANDINFO*, int>)(lpVtbl[4]))((IContextMenu*)Unsafe.AsPointer(ref this), pici);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IContextMenu*, nuint, uint, uint*, sbyte*, uint, int>)(lpVtbl[5]))((IContextMenu*)Unsafe.AsPointer(ref this), idCmd, uType, pReserved, pszName, cchMax);
    }
