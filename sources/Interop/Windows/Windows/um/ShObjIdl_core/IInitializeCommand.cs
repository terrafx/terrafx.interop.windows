...
public unsafe partial struct IInitializeCommand : IInitializeCommand.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeCommand;
