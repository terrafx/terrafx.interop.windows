...
public unsafe partial struct IAssocHandlerInvoker : IAssocHandlerInvoker.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAssocHandlerInvoker;
