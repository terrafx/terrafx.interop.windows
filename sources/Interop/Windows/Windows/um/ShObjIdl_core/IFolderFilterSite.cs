...
public unsafe partial struct IFolderFilterSite : IFolderFilterSite.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFolderFilterSite;
