...
public unsafe partial struct IFileDialogCustomize : IFileDialogCustomize.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IFileDialogCustomize;
