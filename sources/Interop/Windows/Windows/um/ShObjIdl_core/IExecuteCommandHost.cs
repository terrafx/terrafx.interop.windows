...
public unsafe partial struct IExecuteCommandHost : IExecuteCommandHost.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IExecuteCommandHost;
