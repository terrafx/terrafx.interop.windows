...
public unsafe partial struct IInitializeWithItem : IInitializeWithItem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeWithItem;
