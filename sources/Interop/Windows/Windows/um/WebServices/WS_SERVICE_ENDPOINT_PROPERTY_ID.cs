...
public enum WS_SERVICE_ENDPOINT_PROPERTY_ID
{
    ...
    /// <include file='WS_SERVICE_ENDPOINT_PROPERTY_ID.xml' path='doc/member[@name="WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_MAX_CHANNELS_PER_IP"]/*' />
