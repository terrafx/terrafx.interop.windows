...
/// <include file='HTTP_RESPONSE_V2.xml' path='doc/member[@name="HTTP_RESPONSE_V2"]/*' />
...
public unsafe partial struct HTTP_RESPONSE_V2
{
    ...
    /// <include file='HTTP_RESPONSE_V2.xml' path='doc/member[@name="HTTP_RESPONSE_V2.ResponseInfoCount"]/*' />
    public ushort ResponseInfoCount;

    /// <include file='HTTP_RESPONSE_V2.xml' path='doc/member[@name="HTTP_RESPONSE_V2.pResponseInfo"]/*' />
