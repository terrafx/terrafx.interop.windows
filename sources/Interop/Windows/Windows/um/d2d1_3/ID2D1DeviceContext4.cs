...
using static TerraFX.Interop.Windows.D2D1_ALPHA_MODE;
using static TerraFX.Interop.Windows.D2D1_BITMAP_INTERPOLATION_MODE;
using static TerraFX.Interop.Windows.D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION;
using static TerraFX.Interop.Windows.D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS;
using static TerraFX.Interop.Windows.D2D1_COMPOSITE_MODE;
using static TerraFX.Interop.Windows.D2D1_DRAW_TEXT_OPTIONS;
using static TerraFX.Interop.Windows.D2D1_EXTEND_MODE;
using static TerraFX.Interop.Windows.D2D1_GAMMA;
using static TerraFX.Interop.Windows.D2D1_IMAGE_SOURCE_LOADING_OPTIONS;
using static TerraFX.Interop.Windows.D2D1_INTERPOLATION_MODE;
using static TerraFX.Interop.Windows.D2D1_SPRITE_OPTIONS;
using static TerraFX.Interop.Windows.DWRITE_MEASURING_MODE;
...
namespace TerraFX.Interop.Windows
{
    ...
    public unsafe partial struct ID2D1DeviceContext4 : ID2D1DeviceContext4.Interface
    {
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[4]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), size, srcData, pitch, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[5]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, Guid*, void*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[6]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), riid, data, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush**, int>)(lpVtbl[7]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, DXGI_RGBA*, D2D1_BRUSH_PROPERTIES*, ID2D1SolidColorBrush**, int>)(lpVtbl[8]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), color, brushProperties, solidColorBrush);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_GRADIENT_STOP*, uint, D2D1_GAMMA, D2D1_EXTEND_MODE, ID2D1GradientStopCollection**, int>)(lpVtbl[9]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode, gradientStopCollection);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1LinearGradientBrush**, int>)(lpVtbl[10]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), linearGradientBrushProperties, brushProperties, gradientStopCollection, linearGradientBrush);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1RadialGradientBrush**, int>)(lpVtbl[11]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), radialGradientBrushProperties, brushProperties, gradientStopCollection, radialGradientBrush);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_F*, D2D_SIZE_U*, D2D1_PIXEL_FORMAT*, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, ID2D1BitmapRenderTarget**, int>)(lpVtbl[12]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), desiredSize, desiredPixelSize, desiredFormat, options, bitmapRenderTarget);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_F*, ID2D1Layer**, int>)(lpVtbl[13]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), size, layer);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, D2D_POINT_2F, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[15]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), point0, point1, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_RECT_F*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_RECT_F*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), rect, brush);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ROUNDED_RECT*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[18]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), roundedRect, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ROUNDED_RECT*, ID2D1Brush*, void>)(lpVtbl[19]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), roundedRect, brush);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ELLIPSE*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[20]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), ellipse, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ELLIPSE*, ID2D1Brush*, void>)(lpVtbl[21]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), ellipse, brush);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, ID2D1Brush*, D2D1_OPACITY_MASK_CONTENT, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[25]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_BITMAP_INTERPOLATION_MODE, D2D_RECT_F*, void>)(lpVtbl[26]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ushort*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void>)(lpVtbl[27]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutRect, defaultFillBrush, options, measuringMode);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, void>)(lpVtbl[28]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, options);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[29]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, foregroundBrush, measuringMode);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[30]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), transform);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), transform);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[32]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), antialiasMode);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ANTIALIAS_MODE>)(lpVtbl[33]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_TEXT_ANTIALIAS_MODE, void>)(lpVtbl[34]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), textAntialiasMode);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_TEXT_ANTIALIAS_MODE>)(lpVtbl[35]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, IDWriteRenderingParams*, void>)(lpVtbl[36]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), textRenderingParams);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, IDWriteRenderingParams**, void>)(lpVtbl[37]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), textRenderingParams);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_LAYER_PARAMETERS*, ID2D1Layer*, void>)(lpVtbl[40]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), layerParameters, layer);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[45]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, DXGI_RGBA*, void>)(lpVtbl[47]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), clearColor);
        }
        ...
        public D2D1_PIXEL_FORMAT GetPixelFormat()
        {
            ...
            return *((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_PIXEL_FORMAT*, D2D1_PIXEL_FORMAT*>)(lpVtbl[50]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            D2D_SIZE_F result;
            return *((delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_F*, D2D_SIZE_F*>)(lpVtbl[53]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            D2D_SIZE_U result;
            return *((delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_U*, D2D_SIZE_U*>)(lpVtbl[54]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderTargetProperties);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[57]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), size, sourceData, pitch, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[58]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_COLOR_SPACE, byte*, uint, ID2D1ColorContext**, int>)(lpVtbl[59]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), space, profile, profileSize, colorContext);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, IWICColorContext*, ID2D1ColorContext**, int>)(lpVtbl[61]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), wicColorContext, colorContext);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, IDXGISurface*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[62]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), surface, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D1_IMAGE_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1ImageBrush**, int>)(lpVtbl[65]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, imageBrushProperties, brushProperties, imageBrush);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES1*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush1**, int>)(lpVtbl[66]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, DXGI_FORMAT, int>)(lpVtbl[68]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), format);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[69]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bufferPrecision);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[70]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, localBounds);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[71]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, worldBounds);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_RECT_F*, int>)(lpVtbl[72]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, measuringMode, bounds);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RENDERING_CONTROLS*, void>)(lpVtbl[76]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderingControls);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RENDERING_CONTROLS*, void>)(lpVtbl[77]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderingControls);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_PRIMITIVE_BLEND, void>)(lpVtbl[78]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), primitiveBlend);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_PRIMITIVE_BLEND>)(lpVtbl[79]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_UNIT_MODE, void>)(lpVtbl[80]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), unitMode);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_UNIT_MODE>)(lpVtbl[81]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[82]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, foregroundBrush, measuringMode);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D_POINT_2F*, D2D_RECT_F*, D2D1_INTERPOLATION_MODE, D2D1_COMPOSITE_MODE, void>)(lpVtbl[83]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, targetOffset, imageRectangle, interpolationMode, compositeMode);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GdiMetafile*, D2D_POINT_2F*, void>)(lpVtbl[84]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gdiMetafile, targetOffset);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_INTERPOLATION_MODE, D2D_RECT_F*, D2D_MATRIX_4X4_F*, void>)(lpVtbl[85]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle, perspectiveTransform);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_LAYER_PARAMETERS1*, ID2D1Layer*, void>)(lpVtbl[86]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), layerParameters, layer);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Effect*, uint, D2D_RECT_F*, int>)(lpVtbl[87]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), effect, input, inputRectangle);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Effect*, D2D_RECT_F*, uint, int>)(lpVtbl[89]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), effect, rectangles, rectanglesCount);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Effect*, D2D_RECT_F*, D2D1_EFFECT_INPUT_DESCRIPTION*, D2D_RECT_F*, uint, int>)(lpVtbl[90]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderEffect, renderImageRectangle, inputDescriptions, requiredInputRects, inputCount);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, ID2D1Brush*, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[91]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_INK_POINT*, ID2D1Ink**, int>)(lpVtbl[95]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), startPoint, ink);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_INK_STYLE_PROPERTIES*, ID2D1InkStyle**, int>)(lpVtbl[96]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), inkStyleProperties, inkStyle);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_GRADIENT_MESH_PATCH*, uint, ID2D1GradientMesh**, int>)(lpVtbl[97]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), patches, patchesCount, gradientMesh);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, IWICBitmapSource*, D2D1_IMAGE_SOURCE_LOADING_OPTIONS, D2D1_ALPHA_MODE, ID2D1ImageSourceFromWic**, int>)(lpVtbl[98]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), wicBitmapSource, loadingOptions, alphaMode, imageSource);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, D2D1_BUFFER_PRECISION, uint*, byte*, uint, uint*, ID2D1LookupTable3D**, int>)(lpVtbl[99]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), precision, extents, data, dataCount, strides, lookupTable);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, IDXGISurface**, uint, DXGI_COLOR_SPACE_TYPE, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS, ID2D1ImageSource**, int>)(lpVtbl[100]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), surfaces, surfaceCount, colorSpace, options, imageSource);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GradientMesh*, D2D_RECT_F*, int>)(lpVtbl[101]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gradientMesh, pBounds);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GdiMetafile*, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[104]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gdiMetafile, destinationRectangle, sourceRectangle);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1ImageSource*, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES*, ID2D1TransformedImageSource**, int>)(lpVtbl[105]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), imageSource, properties, transformedImageSource);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, ID2D1SpriteBatch*, uint, uint, ID2D1Bitmap*, D2D1_BITMAP_INTERPOLATION_MODE, D2D1_SPRITE_OPTIONS, void>)(lpVtbl[107]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), spriteBatch, startIndex, spriteCount, bitmap, interpolationMode, spriteOptions);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, D2D1_DRAW_TEXT_OPTIONS, void>)(lpVtbl[110]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, options);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, DWRITE_GLYPH_IMAGE_FORMATS, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION, void>)(lpVtbl[111]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), glyphImageFormat, baselineOrigin, glyphRun, measuringMode, bitmapSnapOption);
        }
        ...
        {
            ((delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, DWRITE_MEASURING_MODE, void>)(lpVtbl[112]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, measuringMode);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1DeviceContext4*, DWRITE_GLYPH_IMAGE_FORMATS, D2D_POINT_2F, IDWriteFontFace*, float, ushort, BOOL, D2D_MATRIX_3X2_F*, float, float, D2D_MATRIX_3X2_F*, ID2D1Image**, int>)(lpVtbl[113]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), glyphImageFormat, glyphOrigin, fontFace, fontEmSize, glyphIndex, isSideways, worldTransform, dpiX, dpiY, glyphTransform, glyphImage);
        }
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, uint> Release;

            [NativeTypeName("void (ID2D1Factory **) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Factory**, void> GetFactory;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int> CreateBitmap1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int> CreateBitmapFromWicBitmap1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, Guid*, void*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int> CreateSharedBitmap;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush**, int> CreateBitmapBrush2;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, DXGI_RGBA*, D2D1_BRUSH_PROPERTIES*, ID2D1SolidColorBrush**, int> CreateSolidColorBrush1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_GRADIENT_STOP*, uint, D2D1_GAMMA, D2D1_EXTEND_MODE, ID2D1GradientStopCollection**, int> CreateGradientStopCollection1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1LinearGradientBrush**, int> CreateLinearGradientBrush1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1RadialGradientBrush**, int> CreateRadialGradientBrush1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_F*, D2D_SIZE_U*, D2D1_PIXEL_FORMAT*, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, ID2D1BitmapRenderTarget**, int> CreateCompatibleRenderTarget5;

            [NativeTypeName("HRESULT (const D2D1_SIZE_F *, ID2D1Layer **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_F*, ID2D1Layer**, int> CreateLayer2;

            [NativeTypeName("HRESULT (ID2D1Mesh **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Mesh**, int> CreateMesh;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, D2D_POINT_2F, ID2D1Brush*, float, ID2D1StrokeStyle*, void> DrawLine;

            [NativeTypeName("void (const D2D1_RECT_F *, ID2D1Brush *, FLOAT, ID2D1StrokeStyle *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_RECT_F*, ID2D1Brush*, float, ID2D1StrokeStyle*, void> DrawRectangle;

            [NativeTypeName("void (const D2D1_RECT_F *, ID2D1Brush *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_RECT_F*, ID2D1Brush*, void> FillRectangle;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ROUNDED_RECT*, ID2D1Brush*, float, ID2D1StrokeStyle*, void> DrawRoundedRectangle;

            [NativeTypeName("void (const D2D1_ROUNDED_RECT *, ID2D1Brush *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ROUNDED_RECT*, ID2D1Brush*, void> FillRoundedRectangle;

            [NativeTypeName("void (const D2D1_ELLIPSE *, ID2D1Brush *, FLOAT, ID2D1StrokeStyle *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ELLIPSE*, ID2D1Brush*, float, ID2D1StrokeStyle*, void> DrawEllipse;

            [NativeTypeName("void (const D2D1_ELLIPSE *, ID2D1Brush *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ELLIPSE*, ID2D1Brush*, void> FillEllipse;

            [NativeTypeName("void (ID2D1Geometry *, ID2D1Brush *, FLOAT, ID2D1StrokeStyle *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Geometry*, ID2D1Brush*, float, ID2D1StrokeStyle*, void> DrawGeometry;

            [NativeTypeName("void (ID2D1Geometry *, ID2D1Brush *, ID2D1Brush *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Geometry*, ID2D1Brush*, ID2D1Brush*, void> FillGeometry;

            [NativeTypeName("void (ID2D1Mesh *, ID2D1Brush *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Mesh*, ID2D1Brush*, void> FillMesh;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, ID2D1Brush*, D2D1_OPACITY_MASK_CONTENT, D2D_RECT_F*, D2D_RECT_F*, void> FillOpacityMask;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_BITMAP_INTERPOLATION_MODE, D2D_RECT_F*, void> DrawBitmap;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ushort*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void> DrawText;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, void> DrawTextLayout;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, DWRITE_MEASURING_MODE, void> DrawGlyphRun;

            [NativeTypeName("void (const D2D1_MATRIX_3X2_F *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_MATRIX_3X2_F*, void> SetTransform;

            [NativeTypeName("void (D2D1_MATRIX_3X2_F *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_MATRIX_3X2_F*, void> GetTransform;

            [NativeTypeName("void (D2D1_ANTIALIAS_MODE) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ANTIALIAS_MODE, void> SetAntialiasMode;

            [NativeTypeName("D2D1_ANTIALIAS_MODE () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_ANTIALIAS_MODE> GetAntialiasMode;

            [NativeTypeName("void (D2D1_TEXT_ANTIALIAS_MODE) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_TEXT_ANTIALIAS_MODE, void> SetTextAntialiasMode;

            [NativeTypeName("D2D1_TEXT_ANTIALIAS_MODE () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_TEXT_ANTIALIAS_MODE> GetTextAntialiasMode;

            [NativeTypeName("void (IDWriteRenderingParams *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, IDWriteRenderingParams*, void> SetTextRenderingParams;

            [NativeTypeName("void (IDWriteRenderingParams **) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, IDWriteRenderingParams**, void> GetTextRenderingParams;

            [NativeTypeName("void (D2D1_TAG, D2D1_TAG) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ulong, ulong, void> SetTags;

            [NativeTypeName("void (D2D1_TAG *, D2D1_TAG *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ulong*, ulong*, void> GetTags;

            [NativeTypeName("void (const D2D1_LAYER_PARAMETERS *, ID2D1Layer *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_LAYER_PARAMETERS*, ID2D1Layer*, void> PushLayer;

            [NativeTypeName("void () __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, void> PopLayer;

            [NativeTypeName("HRESULT (D2D1_TAG *, D2D1_TAG *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ulong*, ulong*, int> Flush;

            [NativeTypeName("void (ID2D1DrawingStateBlock *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1DrawingStateBlock*, void> SaveDrawingState;

            [NativeTypeName("void (ID2D1DrawingStateBlock *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1DrawingStateBlock*, void> RestoreDrawingState;

            [NativeTypeName("void (const D2D1_RECT_F *, D2D1_ANTIALIAS_MODE) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, void> PushAxisAlignedClip;

            [NativeTypeName("void () __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, void> PopAxisAlignedClip;

            [NativeTypeName("void (const D2D1_COLOR_F *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, DXGI_RGBA*, void> Clear;

            [NativeTypeName("void () __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, void> BeginDraw;

            [NativeTypeName("HRESULT (D2D1_TAG *, D2D1_TAG *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ulong*, ulong*, int> EndDraw;

            [NativeTypeName("D2D1_PIXEL_FORMAT () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_PIXEL_FORMAT*, D2D1_PIXEL_FORMAT*> GetPixelFormat;

            [NativeTypeName("void (FLOAT, FLOAT) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, float, float, void> SetDpi;

            [NativeTypeName("void (FLOAT *, FLOAT *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, float*, float*, void> GetDpi;

            [NativeTypeName("D2D1_SIZE_F () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_F*, D2D_SIZE_F*> GetSize;

            [NativeTypeName("D2D1_SIZE_U () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_U*, D2D_SIZE_U*> GetPixelSize;

            [NativeTypeName("UINT32 () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, uint> GetMaximumBitmapSize;

            [NativeTypeName("BOOL (const D2D1_RENDER_TARGET_PROPERTIES *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RENDER_TARGET_PROPERTIES*, int> IsSupported;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int> CreateBitmap2;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int> CreateBitmapFromWicBitmap3;

            [NativeTypeName("HRESULT (D2D1_COLOR_SPACE, const BYTE *, UINT32, ID2D1ColorContext **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_COLOR_SPACE, byte*, uint, ID2D1ColorContext**, int> CreateColorContext;

            [NativeTypeName("HRESULT (PCWSTR, ID2D1ColorContext **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ushort*, ID2D1ColorContext**, int> CreateColorContextFromFilename;

            [NativeTypeName("HRESULT (IWICColorContext *, ID2D1ColorContext **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, IWICColorContext*, ID2D1ColorContext**, int> CreateColorContextFromWicColorContext;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, IDXGISurface*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int> CreateBitmapFromDxgiSurface;

            [NativeTypeName("HRESULT (const IID &, ID2D1Effect **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, Guid*, ID2D1Effect**, int> CreateEffect;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_GRADIENT_STOP*, uint, D2D1_COLOR_SPACE, D2D1_COLOR_SPACE, D2D1_BUFFER_PRECISION, D2D1_EXTEND_MODE, D2D1_COLOR_INTERPOLATION_MODE, ID2D1GradientStopCollection1**, int> CreateGradientStopCollection2;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D1_IMAGE_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1ImageBrush**, int> CreateImageBrush1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES1*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush1**, int> CreateBitmapBrush5;

            [NativeTypeName("HRESULT (ID2D1CommandList **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1CommandList**, int> CreateCommandList;

            [NativeTypeName("BOOL (DXGI_FORMAT) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, DXGI_FORMAT, int> IsDxgiFormatSupported;

            [NativeTypeName("BOOL (D2D1_BUFFER_PRECISION) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_BUFFER_PRECISION, int> IsBufferPrecisionSupported;

            [NativeTypeName("HRESULT (ID2D1Image *, D2D1_RECT_F *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D_RECT_F*, int> GetImageLocalBounds;

            [NativeTypeName("HRESULT (ID2D1Image *, D2D1_RECT_F *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D_RECT_F*, int> GetImageWorldBounds;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_RECT_F*, int> GetGlyphRunWorldBounds;

            [NativeTypeName("void (ID2D1Device **) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Device**, void> GetDevice;

            [NativeTypeName("void (ID2D1Image *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, void> SetTarget;

            [NativeTypeName("void (ID2D1Image **) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image**, void> GetTarget;

            [NativeTypeName("void (const D2D1_RENDERING_CONTROLS *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RENDERING_CONTROLS*, void> SetRenderingControls;

            [NativeTypeName("void (D2D1_RENDERING_CONTROLS *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_RENDERING_CONTROLS*, void> GetRenderingControls;

            [NativeTypeName("void (D2D1_PRIMITIVE_BLEND) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_PRIMITIVE_BLEND, void> SetPrimitiveBlend;

            [NativeTypeName("D2D1_PRIMITIVE_BLEND () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_PRIMITIVE_BLEND> GetPrimitiveBlend;

            [NativeTypeName("void (D2D1_UNIT_MODE) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_UNIT_MODE, void> SetUnitMode;

            [NativeTypeName("D2D1_UNIT_MODE () const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_UNIT_MODE> GetUnitMode;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, ID2D1Brush*, DWRITE_MEASURING_MODE, void> DrawGlyphRun1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Image*, D2D_POINT_2F*, D2D_RECT_F*, D2D1_INTERPOLATION_MODE, D2D1_COMPOSITE_MODE, void> DrawImage7;

            [NativeTypeName("void (ID2D1GdiMetafile *, const D2D1_POINT_2F *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GdiMetafile*, D2D_POINT_2F*, void> DrawGdiMetafile1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_INTERPOLATION_MODE, D2D_RECT_F*, D2D_MATRIX_4X4_F*, void> DrawBitmap1;

            [NativeTypeName("void (const D2D1_LAYER_PARAMETERS1 *, ID2D1Layer *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_LAYER_PARAMETERS1*, ID2D1Layer*, void> PushLayer1;

            [NativeTypeName("HRESULT (ID2D1Effect *, UINT32, const D2D1_RECT_F *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Effect*, uint, D2D_RECT_F*, int> InvalidateEffectInputRectangle;

            [NativeTypeName("HRESULT (ID2D1Effect *, UINT32 *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Effect*, uint*, int> GetEffectInvalidRectangleCount;

            [NativeTypeName("HRESULT (ID2D1Effect *, D2D1_RECT_F *, UINT32) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Effect*, D2D_RECT_F*, uint, int> GetEffectInvalidRectangles;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Effect*, D2D_RECT_F*, D2D1_EFFECT_INPUT_DESCRIPTION*, D2D_RECT_F*, uint, int> GetEffectRequiredInputRectangles;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Bitmap*, ID2D1Brush*, D2D_RECT_F*, D2D_RECT_F*, void> FillOpacityMask1;

            [NativeTypeName("HRESULT (ID2D1Geometry *, FLOAT, ID2D1GeometryRealization **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Geometry*, float, ID2D1GeometryRealization**, int> CreateFilledGeometryRealization;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Geometry*, float, float, ID2D1StrokeStyle*, ID2D1GeometryRealization**, int> CreateStrokedGeometryRealization;

            [NativeTypeName("void (ID2D1GeometryRealization *, ID2D1Brush *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GeometryRealization*, ID2D1Brush*, void> DrawGeometryRealization;

            [NativeTypeName("HRESULT (const D2D1_INK_POINT *, ID2D1Ink **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_INK_POINT*, ID2D1Ink**, int> CreateInk;

            [NativeTypeName("HRESULT (const D2D1_INK_STYLE_PROPERTIES *, ID2D1InkStyle **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_INK_STYLE_PROPERTIES*, ID2D1InkStyle**, int> CreateInkStyle;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_GRADIENT_MESH_PATCH*, uint, ID2D1GradientMesh**, int> CreateGradientMesh;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, IWICBitmapSource*, D2D1_IMAGE_SOURCE_LOADING_OPTIONS, D2D1_ALPHA_MODE, ID2D1ImageSourceFromWic**, int> CreateImageSourceFromWic2;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D1_BUFFER_PRECISION, uint*, byte*, uint, uint*, ID2D1LookupTable3D**, int> CreateLookupTable3D;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, IDXGISurface**, uint, DXGI_COLOR_SPACE_TYPE, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS, ID2D1ImageSource**, int> CreateImageSourceFromDxgi;

            [NativeTypeName("HRESULT (ID2D1GradientMesh *, D2D1_RECT_F *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GradientMesh*, D2D_RECT_F*, int> GetGradientMeshWorldBounds;

            [NativeTypeName("void (ID2D1Ink *, ID2D1Brush *, ID2D1InkStyle *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1Ink*, ID2D1Brush*, ID2D1InkStyle*, void> DrawInk;

            [NativeTypeName("void (ID2D1GradientMesh *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GradientMesh*, void> DrawGradientMesh;

            [NativeTypeName("void (ID2D1GdiMetafile *, const D2D1_RECT_F *, const D2D1_RECT_F *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1GdiMetafile*, D2D_RECT_F*, D2D_RECT_F*, void> DrawGdiMetafile2;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1ImageSource*, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES*, ID2D1TransformedImageSource**, int> CreateTransformedImageSource;

            [NativeTypeName("HRESULT (ID2D1SpriteBatch **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1SpriteBatch**, int> CreateSpriteBatch;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1SpriteBatch*, uint, uint, ID2D1Bitmap*, D2D1_BITMAP_INTERPOLATION_MODE, D2D1_SPRITE_OPTIONS, void> DrawSpriteBatch1;

            [NativeTypeName("HRESULT (ID2D1SvgGlyphStyle **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* unmanaged<ID2D1DeviceContext4*, ID2D1SvgGlyphStyle**, int> CreateSvgGlyphStyle;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, ushort*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void> DrawText1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, D2D1_DRAW_TEXT_OPTIONS, void> DrawTextLayout1;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, DWRITE_GLYPH_IMAGE_FORMATS, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION, void> DrawColorBitmapGlyphRun;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, DWRITE_MEASURING_MODE, void> DrawSvgGlyphRun;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, DWRITE_GLYPH_IMAGE_FORMATS, D2D_POINT_2F, IDWriteFontFace*, float, ushort, BOOL, D2D_MATRIX_3X2_F*, float, float, D2D_MATRIX_3X2_F*, ID2D1Image**, int> GetColorBitmapGlyphImage;
            ...
            public delegate* unmanaged<ID2D1DeviceContext4*, D2D_POINT_2F, IDWriteFontFace*, float, ushort, BOOL, D2D_MATRIX_3X2_F*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, D2D_MATRIX_3X2_F*, ID2D1CommandList**, int> GetSvgGlyphImage;
        }
    }
}
