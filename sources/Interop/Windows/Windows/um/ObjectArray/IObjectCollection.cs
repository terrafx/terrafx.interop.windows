...
public unsafe partial struct IObjectCollection : IObjectCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IObjectCollection;
