...
public unsafe partial struct IMFNetCredentialManager : IMFNetCredentialManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFNetCredentialManager;
