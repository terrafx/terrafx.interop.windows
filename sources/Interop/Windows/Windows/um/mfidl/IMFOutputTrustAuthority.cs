...
public unsafe partial struct IMFOutputTrustAuthority : IMFOutputTrustAuthority.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFOutputTrustAuthority;
