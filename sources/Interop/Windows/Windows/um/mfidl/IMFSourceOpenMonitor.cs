...
public unsafe partial struct IMFSourceOpenMonitor : IMFSourceOpenMonitor.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSourceOpenMonitor;
