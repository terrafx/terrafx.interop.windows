...
public unsafe partial struct IMFTrustedInput : IMFTrustedInput.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFTrustedInput;
