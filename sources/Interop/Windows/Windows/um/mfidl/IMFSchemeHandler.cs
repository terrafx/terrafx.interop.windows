...
public unsafe partial struct IMFSchemeHandler : IMFSchemeHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSchemeHandler;
