...
public unsafe partial struct IMFSourceResolver : IMFSourceResolver.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSourceResolver;
