...
public unsafe partial struct IMFMediaTypeHandler : IMFMediaTypeHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaTypeHandler;
