...
public unsafe partial struct IMFSimpleAudioVolume : IMFSimpleAudioVolume.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSimpleAudioVolume;
