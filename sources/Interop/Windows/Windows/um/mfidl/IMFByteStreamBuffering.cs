...
public unsafe partial struct IMFByteStreamBuffering : IMFByteStreamBuffering.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFByteStreamBuffering;
