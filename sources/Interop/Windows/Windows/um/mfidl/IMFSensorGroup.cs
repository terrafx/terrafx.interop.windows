...
public unsafe partial struct IMFSensorGroup : IMFSensorGroup.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSensorGroup;
