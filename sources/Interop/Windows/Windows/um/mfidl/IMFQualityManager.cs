...
public unsafe partial struct IMFQualityManager : IMFQualityManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFQualityManager;
