...
public unsafe partial struct IMFTopologyNode : IMFTopologyNode.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFTopologyNode;
