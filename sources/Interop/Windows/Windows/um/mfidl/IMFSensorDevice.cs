...
public unsafe partial struct IMFSensorDevice : IMFSensorDevice.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSensorDevice;
