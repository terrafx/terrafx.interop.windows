...
public unsafe partial struct IMFByteStreamTimeSeek : IMFByteStreamTimeSeek.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFByteStreamTimeSeek;
