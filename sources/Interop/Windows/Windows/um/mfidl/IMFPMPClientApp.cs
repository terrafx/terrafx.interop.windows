...
public unsafe partial struct IMFPMPClientApp : IMFPMPClientApp.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFPMPClientApp;
