...
public unsafe partial struct IMFVideoSampleAllocator : IMFVideoSampleAllocator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFVideoSampleAllocator;
