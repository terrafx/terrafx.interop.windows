...
public unsafe partial struct IMFObjectReferenceStream : IMFObjectReferenceStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFObjectReferenceStream;
