...
public unsafe partial struct IMFSignedLibrary : IMFSignedLibrary.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSignedLibrary;
