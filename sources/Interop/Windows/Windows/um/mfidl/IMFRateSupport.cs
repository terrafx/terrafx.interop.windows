...
public unsafe partial struct IMFRateSupport : IMFRateSupport.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFRateSupport;
