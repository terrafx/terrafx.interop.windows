...
public unsafe partial struct IMFMediaStream : IMFMediaStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaStream;
