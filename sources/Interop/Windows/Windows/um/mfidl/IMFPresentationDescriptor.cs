...
public unsafe partial struct IMFPresentationDescriptor : IMFPresentationDescriptor.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMFPresentationDescriptor*, Guid*, char*, uint, uint*, int>)(lpVtbl[12]))((IMFPresentationDescriptor*)Unsafe.AsPointer(ref this), guidKey, pwszValue, cchBufSize, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFPresentationDescriptor*, Guid*, char**, uint*, int>)(lpVtbl[13]))((IMFPresentationDescriptor*)Unsafe.AsPointer(ref this), guidKey, ppwszValue, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFPresentationDescriptor*, Guid*, char*, int>)(lpVtbl[25]))((IMFPresentationDescriptor*)Unsafe.AsPointer(ref this), guidKey, wszValue);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, uint*, int> GetStreamDescriptorCount;

        [NativeTypeName("HRESULT (DWORD, BOOL *, IMFStreamDescriptor **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, uint, BOOL*, IMFStreamDescriptor**, int> GetStreamDescriptorByIndex;

        [NativeTypeName("HRESULT (DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, uint, int> SelectStream;

        [NativeTypeName("HRESULT (DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, uint, int> DeselectStream;

        [NativeTypeName("HRESULT (IMFPresentationDescriptor **) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, IMFPresentationDescriptor**, int> Clone;
    }
}
