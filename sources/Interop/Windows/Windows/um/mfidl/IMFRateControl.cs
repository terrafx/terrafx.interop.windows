...
public unsafe partial struct IMFRateControl : IMFRateControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFRateControl;
