...
public unsafe partial struct IMFOutputPolicy : IMFOutputPolicy.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMFOutputPolicy*, Guid*, char*, uint, uint*, int>)(lpVtbl[12]))((IMFOutputPolicy*)Unsafe.AsPointer(ref this), guidKey, pwszValue, cchBufSize, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFOutputPolicy*, Guid*, char**, uint*, int>)(lpVtbl[13]))((IMFOutputPolicy*)Unsafe.AsPointer(ref this), guidKey, ppwszValue, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFOutputPolicy*, Guid*, char*, int>)(lpVtbl[25]))((IMFOutputPolicy*)Unsafe.AsPointer(ref this), guidKey, wszValue);
    }
