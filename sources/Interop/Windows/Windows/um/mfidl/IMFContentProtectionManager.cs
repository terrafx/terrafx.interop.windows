...
public unsafe partial struct IMFContentProtectionManager : IMFContentProtectionManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFContentProtectionManager;
