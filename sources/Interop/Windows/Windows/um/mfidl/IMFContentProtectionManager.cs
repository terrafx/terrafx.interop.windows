...
public unsafe partial struct IMFContentProtectionManager : IMFContentProtectionManager.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IMFContentProtectionManager);
