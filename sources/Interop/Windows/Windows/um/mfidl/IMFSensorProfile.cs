...
public unsafe partial struct IMFSensorProfile : IMFSensorProfile.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSensorProfile;
