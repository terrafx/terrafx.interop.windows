...
public unsafe partial struct IMFSensorStream : IMFSensorStream.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMFSensorStream*, Guid*, char*, uint, uint*, int>)(lpVtbl[12]))((IMFSensorStream*)Unsafe.AsPointer(ref this), guidKey, pwszValue, cchBufSize, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFSensorStream*, Guid*, char**, uint*, int>)(lpVtbl[13]))((IMFSensorStream*)Unsafe.AsPointer(ref this), guidKey, ppwszValue, pcchLength);
    }
    ...
    {
        return ((delegate* unmanaged<IMFSensorStream*, Guid*, char*, int>)(lpVtbl[25]))((IMFSensorStream*)Unsafe.AsPointer(ref this), guidKey, wszValue);
    }
