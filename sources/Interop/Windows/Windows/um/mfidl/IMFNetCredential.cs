...
public unsafe partial struct IMFNetCredential : IMFNetCredential.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFNetCredential;
