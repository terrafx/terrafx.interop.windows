...
public unsafe partial struct IMFContentProtectionDevice : IMFContentProtectionDevice.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFContentProtectionDevice;
