...
public unsafe partial struct IMFByteStreamHandler : IMFByteStreamHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFByteStreamHandler;
