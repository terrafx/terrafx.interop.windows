...
public unsafe partial struct IMFAudioPolicy : IMFAudioPolicy.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFAudioPolicy;
