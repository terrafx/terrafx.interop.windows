...
public unsafe partial struct IAudioRenderClient : IAudioRenderClient.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioRenderClient;
