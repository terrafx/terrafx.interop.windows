...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAudioClient2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, Guid*, void**, int>)(lpVtbl[0]))((IAudioClient2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, uint>)(lpVtbl[1]))((IAudioClient2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, uint>)(lpVtbl[2]))((IAudioClient2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, AUDCLNT_SHAREMODE, uint, long, long, WAVEFORMATEX*, Guid*, int>)(lpVtbl[3]))((IAudioClient2*)Unsafe.AsPointer(ref this), ShareMode, StreamFlags, hnsBufferDuration, hnsPeriodicity, pFormat, AudioSessionGuid);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, uint*, int>)(lpVtbl[4]))((IAudioClient2*)Unsafe.AsPointer(ref this), pNumBufferFrames);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, long*, int>)(lpVtbl[5]))((IAudioClient2*)Unsafe.AsPointer(ref this), phnsLatency);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, uint*, int>)(lpVtbl[6]))((IAudioClient2*)Unsafe.AsPointer(ref this), pNumPaddingFrames);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, AUDCLNT_SHAREMODE, WAVEFORMATEX*, WAVEFORMATEX**, int>)(lpVtbl[7]))((IAudioClient2*)Unsafe.AsPointer(ref this), ShareMode, pFormat, ppClosestMatch);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, WAVEFORMATEX**, int>)(lpVtbl[8]))((IAudioClient2*)Unsafe.AsPointer(ref this), ppDeviceFormat);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, long*, long*, int>)(lpVtbl[9]))((IAudioClient2*)Unsafe.AsPointer(ref this), phnsDefaultDevicePeriod, phnsMinimumDevicePeriod);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, int>)(lpVtbl[10]))((IAudioClient2*)Unsafe.AsPointer(ref this));
    }
    ...
    public HRESULT Stop()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, int>)(lpVtbl[11]))((IAudioClient2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, int>)(lpVtbl[12]))((IAudioClient2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, HANDLE, int>)(lpVtbl[13]))((IAudioClient2*)Unsafe.AsPointer(ref this), eventHandle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, Guid*, void**, int>)(lpVtbl[14]))((IAudioClient2*)Unsafe.AsPointer(ref this), riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, AUDIO_STREAM_CATEGORY, BOOL*, int>)(lpVtbl[15]))((IAudioClient2*)Unsafe.AsPointer(ref this), Category, pbOffloadCapable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, AudioClientProperties*, int>)(lpVtbl[16]))((IAudioClient2*)Unsafe.AsPointer(ref this), pProperties);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioClient2*, WAVEFORMATEX*, BOOL, long*, long*, int>)(lpVtbl[17]))((IAudioClient2*)Unsafe.AsPointer(ref this), pFormat, bEventDriven, phnsMinBufferDuration, phnsMaxBufferDuration);
    }
