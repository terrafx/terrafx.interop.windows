...
public unsafe partial struct IAudioStreamVolume : IAudioStreamVolume.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioStreamVolume;
