...
public unsafe partial struct IAudioAmbisonicsControl : IAudioAmbisonicsControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioAmbisonicsControl;
