...
public unsafe partial struct ISimpleAudioVolume : ISimpleAudioVolume.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISimpleAudioVolume;
