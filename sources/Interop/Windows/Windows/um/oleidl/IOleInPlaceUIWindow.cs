...
public unsafe partial struct IOleInPlaceUIWindow : IOleInPlaceUIWindow.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleInPlaceUIWindow;
