...
public unsafe partial struct IOleAdviseHolder : IOleAdviseHolder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleAdviseHolder;
