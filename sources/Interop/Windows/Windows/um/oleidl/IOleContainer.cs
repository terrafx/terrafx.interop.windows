...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IOleContainer);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleContainer*, Guid*, void**, int>)(lpVtbl[0]))((IOleContainer*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IOleContainer*, uint>)(lpVtbl[1]))((IOleContainer*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IOleContainer*, uint>)(lpVtbl[2]))((IOleContainer*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleContainer*, IBindCtx*, char*, uint*, IMoniker**, int>)(lpVtbl[3]))((IOleContainer*)Unsafe.AsPointer(ref this), pbc, pszDisplayName, pchEaten, ppmkOut);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleContainer*, uint, IEnumUnknown**, int>)(lpVtbl[4]))((IOleContainer*)Unsafe.AsPointer(ref this), grfFlags, ppenum);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleContainer*, BOOL, int>)(lpVtbl[5]))((IOleContainer*)Unsafe.AsPointer(ref this), fLock);
    }
