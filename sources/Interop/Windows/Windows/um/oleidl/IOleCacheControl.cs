...
public unsafe partial struct IOleCacheControl : IOleCacheControl.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleCacheControl;
