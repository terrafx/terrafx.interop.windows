...
public unsafe partial struct IParseDisplayName : IParseDisplayName.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IParseDisplayName;
