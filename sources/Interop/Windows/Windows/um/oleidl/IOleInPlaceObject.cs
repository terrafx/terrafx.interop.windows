...
public unsafe partial struct IOleInPlaceObject : IOleInPlaceObject.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleInPlaceObject;
