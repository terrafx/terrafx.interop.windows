...
public unsafe partial struct IOleItemContainer : IOleItemContainer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleItemContainer;
