...
public unsafe partial struct IOleInPlaceSite : IOleInPlaceSite.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleInPlaceSite;
