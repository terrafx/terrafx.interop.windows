...
public unsafe partial struct IOleClientSite : IOleClientSite.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IOleClientSite;
