...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IOleCache2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, Guid*, void**, int>)(lpVtbl[0]))((IOleCache2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, uint>)(lpVtbl[1]))((IOleCache2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, uint>)(lpVtbl[2]))((IOleCache2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, FORMATETC*, uint, uint*, int>)(lpVtbl[3]))((IOleCache2*)Unsafe.AsPointer(ref this), pformatetc, advf, pdwConnection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, uint, int>)(lpVtbl[4]))((IOleCache2*)Unsafe.AsPointer(ref this), dwConnection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, IEnumSTATDATA**, int>)(lpVtbl[5]))((IOleCache2*)Unsafe.AsPointer(ref this), ppenumSTATDATA);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, IDataObject*, int>)(lpVtbl[6]))((IOleCache2*)Unsafe.AsPointer(ref this), pDataObject);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, FORMATETC*, STGMEDIUM*, BOOL, int>)(lpVtbl[7]))((IOleCache2*)Unsafe.AsPointer(ref this), pformatetc, pmedium, fRelease);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, IDataObject*, uint, void*, int>)(lpVtbl[8]))((IOleCache2*)Unsafe.AsPointer(ref this), pDataObject, grfUpdf, pReserved);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IOleCache2*, uint, int>)(lpVtbl[9]))((IOleCache2*)Unsafe.AsPointer(ref this), dwDiscardOptions);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, FORMATETC*, uint, uint*, int> Cache;
