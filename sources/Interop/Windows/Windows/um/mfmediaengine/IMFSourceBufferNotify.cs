...
public unsafe partial struct IMFSourceBufferNotify : IMFSourceBufferNotify.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSourceBufferNotify;
