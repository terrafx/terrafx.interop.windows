...
public unsafe partial struct IMFTimedTextRegion : IMFTimedTextRegion.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFTimedTextRegion;
