...
public unsafe partial struct IMFMediaTimeRange : IMFMediaTimeRange.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaTimeRange;
