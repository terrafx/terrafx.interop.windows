...
public unsafe partial struct IMFMediaSourceExtension : IMFMediaSourceExtension.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaSourceExtension;
