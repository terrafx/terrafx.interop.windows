...
public unsafe partial struct IAudioSourceProvider : IAudioSourceProvider.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioSourceProvider;
