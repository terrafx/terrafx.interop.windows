...
public unsafe partial struct IMFTimedTextStyle : IMFTimedTextStyle.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFTimedTextStyle;
