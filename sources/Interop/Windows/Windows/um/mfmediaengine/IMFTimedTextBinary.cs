...
public unsafe partial struct IMFTimedTextBinary : IMFTimedTextBinary.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFTimedTextBinary;
