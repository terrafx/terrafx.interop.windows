...
public unsafe partial struct IMFMediaEngineExtension : IMFMediaEngineExtension.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaEngineExtension;
