...
public unsafe partial struct IMFMediaKeySystemAccess : IMFMediaKeySystemAccess.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaKeySystemAccess;
