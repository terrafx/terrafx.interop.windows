...
public unsafe partial struct IMFMediaEngineEME : IMFMediaEngineEME.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaEngineEME;
