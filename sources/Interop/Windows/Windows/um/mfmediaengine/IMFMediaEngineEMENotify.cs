...
public unsafe partial struct IMFMediaEngineEMENotify : IMFMediaEngineEMENotify.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaEngineEMENotify;
