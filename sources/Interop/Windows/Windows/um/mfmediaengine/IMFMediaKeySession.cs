...
public unsafe partial struct IMFMediaKeySession : IMFMediaKeySession.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFMediaKeySession;
