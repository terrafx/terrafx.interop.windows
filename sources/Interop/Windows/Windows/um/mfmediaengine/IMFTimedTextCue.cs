...
public unsafe partial struct IMFTimedTextCue : IMFTimedTextCue.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFTimedTextCue;
