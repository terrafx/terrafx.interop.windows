...
public unsafe partial struct IMFSourceBufferList : IMFSourceBufferList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSourceBufferList;
