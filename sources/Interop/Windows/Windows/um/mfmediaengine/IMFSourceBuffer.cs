...
public unsafe partial struct IMFSourceBuffer : IMFSourceBuffer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IMFSourceBuffer;
