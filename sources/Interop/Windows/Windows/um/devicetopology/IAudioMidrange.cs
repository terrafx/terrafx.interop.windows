...
// Ported from um/devicetopology.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IAudioMidrange);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, Guid*, void**, int>)(lpVtbl[0]))((IAudioMidrange*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, uint>)(lpVtbl[1]))((IAudioMidrange*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, uint>)(lpVtbl[2]))((IAudioMidrange*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, uint*, int>)(lpVtbl[3]))((IAudioMidrange*)Unsafe.AsPointer(ref this), pcChannels);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, uint, float*, float*, float*, int>)(lpVtbl[4]))((IAudioMidrange*)Unsafe.AsPointer(ref this), nChannel, pfMinLevelDB, pfMaxLevelDB, pfStepping);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, uint, float*, int>)(lpVtbl[5]))((IAudioMidrange*)Unsafe.AsPointer(ref this), nChannel, pfLevelDB);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, uint, float, Guid*, int>)(lpVtbl[6]))((IAudioMidrange*)Unsafe.AsPointer(ref this), nChannel, fLevelDB, pguidEventContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, float, Guid*, int>)(lpVtbl[7]))((IAudioMidrange*)Unsafe.AsPointer(ref this), fLevelDB, pguidEventContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IAudioMidrange*, float*, uint, Guid*, int>)(lpVtbl[8]))((IAudioMidrange*)Unsafe.AsPointer(ref this), aLevelsDB, cChannels, pguidEventContext);
    }
