...
public unsafe partial struct IAudioMidrange : IAudioMidrange.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioMidrange;
