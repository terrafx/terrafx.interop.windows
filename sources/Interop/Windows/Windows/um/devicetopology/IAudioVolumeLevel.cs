...
public unsafe partial struct IAudioVolumeLevel : IAudioVolumeLevel.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioVolumeLevel;
