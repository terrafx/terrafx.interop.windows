...
public unsafe partial struct IAudioChannelConfig : IAudioChannelConfig.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioChannelConfig;
