...
public unsafe partial struct IAudioInputSelector : IAudioInputSelector.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioInputSelector;
