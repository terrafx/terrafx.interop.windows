...
public unsafe partial struct IAudioLoudness : IAudioLoudness.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioLoudness;
