...
public unsafe partial struct IControlInterface : IControlInterface.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IControlInterface;
