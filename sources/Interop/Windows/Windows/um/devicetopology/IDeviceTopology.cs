...
public unsafe partial struct IDeviceTopology : IDeviceTopology.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDeviceTopology;
