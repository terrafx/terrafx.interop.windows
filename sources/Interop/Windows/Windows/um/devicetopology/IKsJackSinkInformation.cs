...
public unsafe partial struct IKsJackSinkInformation : IKsJackSinkInformation.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IKsJackSinkInformation;
