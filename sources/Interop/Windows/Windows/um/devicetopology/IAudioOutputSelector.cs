...
public unsafe partial struct IAudioOutputSelector : IAudioOutputSelector.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioOutputSelector;
