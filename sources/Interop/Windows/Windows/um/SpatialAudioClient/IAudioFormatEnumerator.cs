...
public unsafe partial struct IAudioFormatEnumerator : IAudioFormatEnumerator.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAudioFormatEnumerator;
