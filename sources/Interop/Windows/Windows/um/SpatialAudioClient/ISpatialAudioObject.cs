...
public unsafe partial struct ISpatialAudioObject : ISpatialAudioObject.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpatialAudioObject;
