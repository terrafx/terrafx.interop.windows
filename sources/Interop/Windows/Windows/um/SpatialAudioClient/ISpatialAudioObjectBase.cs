...
public unsafe partial struct ISpatialAudioObjectBase : ISpatialAudioObjectBase.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpatialAudioObjectBase;
