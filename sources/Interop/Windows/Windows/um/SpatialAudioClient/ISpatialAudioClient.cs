...
public unsafe partial struct ISpatialAudioClient : ISpatialAudioClient.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISpatialAudioClient;
