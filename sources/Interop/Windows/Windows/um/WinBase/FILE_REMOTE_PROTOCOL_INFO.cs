...
public partial struct FILE_REMOTE_PROTOCOL_INFO
{
    ...
    [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/WinBase.h:9102:5)")]
    ...
    [NativeTypeName("union (anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/WinBase.h:9115:5)")]
    ...
    public unsafe partial struct _ProtocolSpecific_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/WinBase.h:9117:9)")]
        ...
        public partial struct _Smb2_e__Struct
        {
            ...
            [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/WinBase.h:9119:13)")]
            public _Server_e__Struct Server;

            /// <include file='_Smb2_e__Struct.xml' path='doc/member[@name="_Smb2_e__Struct.Share"]/*' />
            [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um/WinBase.h:9123:13)")]
