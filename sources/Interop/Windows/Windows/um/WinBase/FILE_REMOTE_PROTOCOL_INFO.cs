...
public partial struct FILE_REMOTE_PROTOCOL_INFO
{
    ...
    [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/WinBase.h:9125:5)")]
    ...
    [NativeTypeName("union (anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/WinBase.h:9138:5)")]
    ...
    public unsafe partial struct _ProtocolSpecific_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/WinBase.h:9140:9)")]
        ...
        public partial struct _Smb2_e__Struct
        {
            ...
            [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/WinBase.h:9142:13)")]
            public _Server_e__Struct Server;

            /// <include file='_Smb2_e__Struct.xml' path='doc/member[@name="_Smb2_e__Struct.Share"]/*' />
            [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/WinBase.h:9146:13)")]
