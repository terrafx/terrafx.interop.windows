...
public enum COPYFILE2_MESSAGE_TYPE
{
    ...
    /// <include file='COPYFILE2_MESSAGE_TYPE.xml' path='doc/member[@name="COPYFILE2_MESSAGE_TYPE.COPYFILE2_CALLBACK_SPARSE_CHUNK_STARTED"]/*' />
    COPYFILE2_CALLBACK_SPARSE_CHUNK_STARTED,

    /// <include file='COPYFILE2_MESSAGE_TYPE.xml' path='doc/member[@name="COPYFILE2_MESSAGE_TYPE.COPYFILE2_CALLBACK_SPARSE_CHUNK_FINISHED"]/*' />
