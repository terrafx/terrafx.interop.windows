...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ITranscodeImage);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITranscodeImage*, Guid*, void**, int>)(lpVtbl[0]))((ITranscodeImage*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ITranscodeImage*, uint>)(lpVtbl[1]))((ITranscodeImage*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ITranscodeImage*, uint>)(lpVtbl[2]))((ITranscodeImage*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ITranscodeImage*, IShellItem*, uint, uint, uint, IStream*, uint*, uint*, int>)(lpVtbl[3]))((ITranscodeImage*)Unsafe.AsPointer(ref this), pShellItem, uiMaxWidth, uiMaxHeight, flags, pvImage, puiWidth, puiHeight);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IShellItem*, uint, uint, uint, IStream*, uint*, uint*, int> TranscodeImage;
    }
}
