...
public unsafe partial struct IInternetZoneManager : IInternetZoneManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInternetZoneManager;
