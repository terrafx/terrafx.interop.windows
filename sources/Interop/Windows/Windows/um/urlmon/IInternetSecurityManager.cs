...
public unsafe partial struct IInternetSecurityManager : IInternetSecurityManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInternetSecurityManager;
