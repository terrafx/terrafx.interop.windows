...
public unsafe partial struct IInternetSecurityManager : IInternetSecurityManager.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManager*, char*, uint*, uint, int>)(lpVtbl[5]))((IInternetSecurityManager*)Unsafe.AsPointer(ref this), pwszUrl, pdwZone, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManager*, char*, byte*, uint*, nuint, int>)(lpVtbl[6]))((IInternetSecurityManager*)Unsafe.AsPointer(ref this), pwszUrl, pbSecurityId, pcbSecurityId, dwReserved);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManager*, char*, uint, byte*, uint, byte*, uint, uint, uint, int>)(lpVtbl[7]))((IInternetSecurityManager*)Unsafe.AsPointer(ref this), pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags, dwReserved);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManager*, char*, Guid*, byte**, uint*, byte*, uint, uint, int>)(lpVtbl[8]))((IInternetSecurityManager*)Unsafe.AsPointer(ref this), pwszUrl, guidKey, ppPolicy, pcbPolicy, pContext, cbContext, dwReserved);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManager*, uint, char*, uint, int>)(lpVtbl[9]))((IInternetSecurityManager*)Unsafe.AsPointer(ref this), dwZone, lpszPattern, dwFlags);
    }
