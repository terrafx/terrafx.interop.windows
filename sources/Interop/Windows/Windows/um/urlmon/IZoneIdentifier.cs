...
public unsafe partial struct IZoneIdentifier : IZoneIdentifier.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IZoneIdentifier;
