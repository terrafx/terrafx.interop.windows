...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IWinInetHttpTimeouts);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWinInetHttpTimeouts*, Guid*, void**, int>)(lpVtbl[0]))((IWinInetHttpTimeouts*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IWinInetHttpTimeouts*, uint>)(lpVtbl[1]))((IWinInetHttpTimeouts*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IWinInetHttpTimeouts*, uint>)(lpVtbl[2]))((IWinInetHttpTimeouts*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWinInetHttpTimeouts*, uint*, uint*, uint*, int>)(lpVtbl[3]))((IWinInetHttpTimeouts*)Unsafe.AsPointer(ref this), pdwConnectTimeout, pdwSendTimeout, pdwReceiveTimeout);
    }
