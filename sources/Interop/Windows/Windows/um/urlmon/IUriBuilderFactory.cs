...
public unsafe partial struct IUriBuilderFactory : IUriBuilderFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IUriBuilderFactory;
