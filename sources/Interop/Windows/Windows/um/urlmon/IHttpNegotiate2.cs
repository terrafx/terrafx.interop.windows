...
public unsafe partial struct IHttpNegotiate2 : IHttpNegotiate2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IHttpNegotiate2*, char*, char*, uint, char**, int>)(lpVtbl[3]))((IHttpNegotiate2*)Unsafe.AsPointer(ref this), szURL, szHeaders, dwReserved, pszAdditionalHeaders);
    }
    ...
    {
        return ((delegate* unmanaged<IHttpNegotiate2*, uint, char*, char*, char**, int>)(lpVtbl[4]))((IHttpNegotiate2*)Unsafe.AsPointer(ref this), dwResponseCode, szResponseHeaders, szRequestHeaders, pszAdditionalRequestHeaders);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, char*, char*, uint, char**, int> BeginningTransaction;

        [NativeTypeName("HRESULT (DWORD, LPCWSTR, LPCWSTR, LPWSTR *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, uint, char*, char*, char**, int> OnResponse;
