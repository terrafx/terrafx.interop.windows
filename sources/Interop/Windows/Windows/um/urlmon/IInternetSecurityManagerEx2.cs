...
public unsafe partial struct IInternetSecurityManagerEx2 : IInternetSecurityManagerEx2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManagerEx2*, char*, uint*, uint, int>)(lpVtbl[5]))((IInternetSecurityManagerEx2*)Unsafe.AsPointer(ref this), pwszUrl, pdwZone, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManagerEx2*, char*, byte*, uint*, nuint, int>)(lpVtbl[6]))((IInternetSecurityManagerEx2*)Unsafe.AsPointer(ref this), pwszUrl, pbSecurityId, pcbSecurityId, dwReserved);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManagerEx2*, char*, uint, byte*, uint, byte*, uint, uint, uint, int>)(lpVtbl[7]))((IInternetSecurityManagerEx2*)Unsafe.AsPointer(ref this), pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags, dwReserved);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManagerEx2*, char*, Guid*, byte**, uint*, byte*, uint, uint, int>)(lpVtbl[8]))((IInternetSecurityManagerEx2*)Unsafe.AsPointer(ref this), pwszUrl, guidKey, ppPolicy, pcbPolicy, pContext, cbContext, dwReserved);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManagerEx2*, uint, char*, uint, int>)(lpVtbl[9]))((IInternetSecurityManagerEx2*)Unsafe.AsPointer(ref this), dwZone, lpszPattern, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManagerEx2*, char*, uint, byte*, uint, byte*, uint, uint, uint, uint*, int>)(lpVtbl[11]))((IInternetSecurityManagerEx2*)Unsafe.AsPointer(ref this), pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags, dwReserved, pdwOutFlags);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetSecurityManagerEx2*, IUri*, uint*, uint, char**, uint*, int>)(lpVtbl[12]))((IInternetSecurityManagerEx2*)Unsafe.AsPointer(ref this), pUri, pdwZone, dwFlags, ppwszMappedUrl, pdwOutFlags);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, char*, uint*, uint, int> MapUrlToZone;

        [NativeTypeName("HRESULT (LPCWSTR, BYTE *, DWORD *, DWORD_PTR) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, char*, byte*, uint*, nuint, int> GetSecurityId;

        [NativeTypeName("HRESULT (LPCWSTR, DWORD, BYTE *, DWORD, BYTE *, DWORD, DWORD, DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, char*, uint, byte*, uint, byte*, uint, uint, uint, int> ProcessUrlAction;

        [NativeTypeName("HRESULT (LPCWSTR, const GUID &, BYTE **, DWORD *, BYTE *, DWORD, DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, char*, Guid*, byte**, uint*, byte*, uint, uint, int> QueryCustomPolicy;

        [NativeTypeName("HRESULT (DWORD, LPCWSTR, DWORD) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, uint, char*, uint, int> SetZoneMapping;
        ...
        public delegate* unmanaged<TSelf*, char*, uint, byte*, uint, byte*, uint, uint, uint, uint*, int> ProcessUrlActionEx;

        [NativeTypeName("HRESULT (IUri *, DWORD *, DWORD, LPWSTR *, DWORD *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, IUri*, uint*, uint, char**, uint*, int> MapUrlToZoneEx2;
