...
public unsafe partial struct IGetBindHandle : IGetBindHandle.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IGetBindHandle;
