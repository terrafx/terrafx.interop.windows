...
public unsafe partial struct IWinInetHttpInfo : IWinInetHttpInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWinInetHttpInfo;
