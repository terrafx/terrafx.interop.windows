...
public unsafe partial struct IInternetSession : IInternetSession.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInternetSession;
