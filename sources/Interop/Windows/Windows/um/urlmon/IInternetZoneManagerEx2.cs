...
public unsafe partial struct IInternetZoneManagerEx2 : IInternetZoneManagerEx2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IInternetZoneManagerEx2*, uint, HWND, char*, char*, uint, int>)(lpVtbl[9]))((IInternetZoneManagerEx2*)Unsafe.AsPointer(ref this), dwAction, hwndParent, pwszUrl, pwszText, dwPromptFlags);
    }
    ...
    {
        return ((delegate* unmanaged<IInternetZoneManagerEx2*, uint, char*, char*, uint, int>)(lpVtbl[10]))((IInternetZoneManagerEx2*)Unsafe.AsPointer(ref this), dwAction, pwszUrl, pwszText, dwLogFlags);
    }
