...
public unsafe partial struct IStreamConcatenate : IStreamConcatenate.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IStreamConcatenate;
