...
public unsafe partial struct IDiscFormat2 : IDiscFormat2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDiscFormat2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IDiscFormat2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
