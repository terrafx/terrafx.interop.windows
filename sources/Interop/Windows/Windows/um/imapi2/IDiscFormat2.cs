...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDiscFormat2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, Guid*, void**, int>)(lpVtbl[0]))((IDiscFormat2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, uint>)(lpVtbl[1]))((IDiscFormat2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, uint>)(lpVtbl[2]))((IDiscFormat2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, uint*, int>)(lpVtbl[3]))((IDiscFormat2*)Unsafe.AsPointer(ref this), pctinfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, uint, uint, ITypeInfo**, int>)(lpVtbl[4]))((IDiscFormat2*)Unsafe.AsPointer(ref this), iTInfo, lcid, ppTInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IDiscFormat2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int>)(lpVtbl[6]))((IDiscFormat2*)Unsafe.AsPointer(ref this), dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, IDiscRecorder2*, short*, int>)(lpVtbl[7]))((IDiscFormat2*)Unsafe.AsPointer(ref this), recorder, value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, IDiscRecorder2*, short*, int>)(lpVtbl[8]))((IDiscFormat2*)Unsafe.AsPointer(ref this), recorder, value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, short*, int>)(lpVtbl[9]))((IDiscFormat2*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, short*, int>)(lpVtbl[10]))((IDiscFormat2*)Unsafe.AsPointer(ref this), value);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiscFormat2*, SAFEARRAY**, int>)(lpVtbl[11]))((IDiscFormat2*)Unsafe.AsPointer(ref this), value);
    }
