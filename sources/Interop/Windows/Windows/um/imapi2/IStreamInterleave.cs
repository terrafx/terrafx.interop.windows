...
public unsafe partial struct IStreamInterleave : IStreamInterleave.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IStreamInterleave;
