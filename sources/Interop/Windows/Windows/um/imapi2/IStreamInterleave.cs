...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IStreamInterleave);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, Guid*, void**, int>)(lpVtbl[0]))((IStreamInterleave*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, uint>)(lpVtbl[1]))((IStreamInterleave*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, uint>)(lpVtbl[2]))((IStreamInterleave*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, void*, uint, uint*, int>)(lpVtbl[3]))((IStreamInterleave*)Unsafe.AsPointer(ref this), pv, cb, pcbRead);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, void*, uint, uint*, int>)(lpVtbl[4]))((IStreamInterleave*)Unsafe.AsPointer(ref this), pv, cb, pcbWritten);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, LARGE_INTEGER, uint, ULARGE_INTEGER*, int>)(lpVtbl[5]))((IStreamInterleave*)Unsafe.AsPointer(ref this), dlibMove, dwOrigin, plibNewPosition);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, ULARGE_INTEGER, int>)(lpVtbl[6]))((IStreamInterleave*)Unsafe.AsPointer(ref this), libNewSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, IStream*, ULARGE_INTEGER, ULARGE_INTEGER*, ULARGE_INTEGER*, int>)(lpVtbl[7]))((IStreamInterleave*)Unsafe.AsPointer(ref this), pstm, cb, pcbRead, pcbWritten);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, uint, int>)(lpVtbl[8]))((IStreamInterleave*)Unsafe.AsPointer(ref this), grfCommitFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, int>)(lpVtbl[9]))((IStreamInterleave*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, ULARGE_INTEGER, ULARGE_INTEGER, uint, int>)(lpVtbl[10]))((IStreamInterleave*)Unsafe.AsPointer(ref this), libOffset, cb, dwLockType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, ULARGE_INTEGER, ULARGE_INTEGER, uint, int>)(lpVtbl[11]))((IStreamInterleave*)Unsafe.AsPointer(ref this), libOffset, cb, dwLockType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, STATSTG*, uint, int>)(lpVtbl[12]))((IStreamInterleave*)Unsafe.AsPointer(ref this), pstatstg, grfStatFlag);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, IStream**, int>)(lpVtbl[13]))((IStreamInterleave*)Unsafe.AsPointer(ref this), ppstm);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IStreamInterleave*, IStream**, uint*, uint, int>)(lpVtbl[14]))((IStreamInterleave*)Unsafe.AsPointer(ref this), streams, interleaveSizes, streamCount);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream**, uint*, uint, int> Initialize;
    }
}
