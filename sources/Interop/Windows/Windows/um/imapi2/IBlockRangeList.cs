...
public unsafe partial struct IBlockRangeList : IBlockRangeList.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IBlockRangeList*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IBlockRangeList*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, SAFEARRAY**, int> get_BlockRanges;
    }
}
