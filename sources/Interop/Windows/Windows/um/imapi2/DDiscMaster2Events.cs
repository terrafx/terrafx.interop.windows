...
public unsafe partial struct DDiscMaster2Events : DDiscMaster2Events.Interface
{
    ...
    public partial struct Vtbl
    {
        ...
        public delegate* unmanaged<DDiscMaster2Events*, Guid*, void**, int> QueryInterface;

        [NativeTypeName("ULONG () __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, uint> AddRef;

        [NativeTypeName("ULONG () __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, uint> Release;

        [NativeTypeName("HRESULT (UINT *) __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, uint*, int> GetTypeInfoCount;

        [NativeTypeName("HRESULT (UINT, LCID, ITypeInfo **) __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, uint, uint, ITypeInfo**, int> GetTypeInfo;

        [NativeTypeName("HRESULT (const IID &, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, Guid*, ushort**, uint, uint, int*, int> GetIDsOfNames;

        [NativeTypeName("HRESULT (DISPID, const IID &, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, int, Guid*, uint, ushort, DISPPARAMS*, VARIANT*, EXCEPINFO*, uint*, int> Invoke;

        [NativeTypeName("HRESULT (IDispatch *, BSTR) __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, IDispatch*, ushort*, int> NotifyDeviceAdded;

        [NativeTypeName("HRESULT (IDispatch *, BSTR) __attribute__((stdcall))")]
        public delegate* unmanaged<DDiscMaster2Events*, IDispatch*, ushort*, int> NotifyDeviceRemoved;
    }
}
