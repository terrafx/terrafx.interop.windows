...
public unsafe partial struct DWriteEngine2Events : DWriteEngine2Events.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DWriteEngine2Events*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DWriteEngine2Events*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
