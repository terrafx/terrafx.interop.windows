...
public unsafe partial struct IMultisessionRandomWrite : IMultisessionRandomWrite.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMultisessionRandomWrite*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IMultisessionRandomWrite*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
