...
public unsafe partial struct IWriteSpeedDescriptor : IWriteSpeedDescriptor.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IWriteSpeedDescriptor*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IWriteSpeedDescriptor*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
