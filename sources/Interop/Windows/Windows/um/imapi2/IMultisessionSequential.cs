...
/// <include file='IMultisessionSequential.xml' path='doc/member[@name="IMultisessionSequential"]/*' />
...
public unsafe partial struct IMultisessionSequential : IMultisessionSequential.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMultisessionSequential*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IMultisessionSequential*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
