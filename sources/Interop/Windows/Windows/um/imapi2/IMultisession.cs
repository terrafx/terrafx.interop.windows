...
public unsafe partial struct IMultisession : IMultisession.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IMultisession*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IMultisession*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
