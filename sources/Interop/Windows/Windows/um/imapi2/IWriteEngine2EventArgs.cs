...
public unsafe partial struct IWriteEngine2EventArgs : IWriteEngine2EventArgs.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWriteEngine2EventArgs;
