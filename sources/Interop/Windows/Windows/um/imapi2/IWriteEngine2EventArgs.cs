...
public unsafe partial struct IWriteEngine2EventArgs : IWriteEngine2EventArgs.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IWriteEngine2EventArgs*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IWriteEngine2EventArgs*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
