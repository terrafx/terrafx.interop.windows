...
public unsafe partial struct DDiscFormat2RawCDEvents : DDiscFormat2RawCDEvents.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<DDiscFormat2RawCDEvents*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((DDiscFormat2RawCDEvents*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
