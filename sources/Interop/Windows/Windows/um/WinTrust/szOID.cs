...
// Ported from um/WinTrust.h in the Windows SDK for Windows 10.0.28000.0
...
public static partial class szOID
{
    ...
    public static ReadOnlySpan<byte> szOID_SIGNED_ATTRIBUTE_INTERNAL_NAME => "1.3.6.1.4.1.311.2.7.1"u8;

    [NativeTypeName("#define szOID_SIGNED_ATTRIBUTE_FILE_VERSION \"1.3.6.1.4.1.311.2.7.2\"")]
    public static ReadOnlySpan<byte> szOID_SIGNED_ATTRIBUTE_FILE_VERSION => "1.3.6.1.4.1.311.2.7.2"u8;

    [NativeTypeName("#define szOID_SIGNED_ATTRIBUTE_FILE_DESCRIPTION \"1.3.6.1.4.1.311.2.7.3\"")]
    public static ReadOnlySpan<byte> szOID_SIGNED_ATTRIBUTE_FILE_DESCRIPTION => "1.3.6.1.4.1.311.2.7.3"u8;
    ...
    public static ReadOnlySpan<byte> szOID_SIGNED_ATTRIBUTE_PRODUCT_VERSION => "1.3.6.1.4.1.311.2.7.5"u8;

    [NativeTypeName("#define szOID_SIGNED_ATTRIBUTE_ORIGINAL_FILENAME \"1.3.6.1.4.1.311.2.7.6\"")]
    public static ReadOnlySpan<byte> szOID_SIGNED_ATTRIBUTE_ORIGINAL_FILENAME => "1.3.6.1.4.1.311.2.7.6"u8;
    ...
    public static ReadOnlySpan<byte> szOID_SIGNED_ATTRIBUTE_PUBLISH_TIME => "1.3.6.1.4.1.311.2.7.9"u8;

    [NativeTypeName("#define szOID_SIGNED_ATTRIBUTE_SOURCE_URL \"1.3.6.1.4.1.311.2.7.10\"")]
    public static ReadOnlySpan<byte> szOID_SIGNED_ATTRIBUTE_SOURCE_URL => "1.3.6.1.4.1.311.2.7.10"u8;
