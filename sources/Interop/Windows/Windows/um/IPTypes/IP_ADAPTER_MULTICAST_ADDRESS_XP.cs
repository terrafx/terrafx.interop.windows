...
{
    /// <include file='IP_ADAPTER_MULTICAST_ADDRESS_XP.xml' path='doc/member[@name="IP_ADAPTER_MULTICAST_ADDRESS_XP.Anonymous"]/*' />
    [NativeTypeName("_IP_ADAPTER_MULTICAST_ADDRESS_XP::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/IPTypes.h:186:5)")]
    public _Anonymous_e__Union Anonymous;

    /// <include file='IP_ADAPTER_MULTICAST_ADDRESS_XP.xml' path='doc/member[@name="IP_ADAPTER_MULTICAST_ADDRESS_XP.Next"]/*' />
    [NativeTypeName("struct _IP_ADAPTER_MULTICAST_ADDRESS_XP *")]
    public IP_ADAPTER_MULTICAST_ADDRESS_XP* Next;

    /// <include file='IP_ADAPTER_MULTICAST_ADDRESS_XP.xml' path='doc/member[@name="IP_ADAPTER_MULTICAST_ADDRESS_XP.Address"]/*' />
    ...
    public partial struct _Anonymous_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("_IP_ADAPTER_MULTICAST_ADDRESS_XP::(anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/IPTypes.h:188:9)")]
