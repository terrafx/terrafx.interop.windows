...
public partial struct OnexPlapSmartcardCredentialProvider : IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_OnexPlapSmartcardCredentialProvider;
}
