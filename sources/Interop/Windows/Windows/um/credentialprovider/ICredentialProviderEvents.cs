...
public unsafe partial struct ICredentialProviderEvents : ICredentialProviderEvents.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICredentialProviderEvents;
