...
public unsafe partial struct ICredentialProviderCredential : ICredentialProviderCredential.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICredentialProviderCredential;
