...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ICredentialProvider);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, Guid*, void**, int>)(lpVtbl[0]))((ICredentialProvider*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, uint>)(lpVtbl[1]))((ICredentialProvider*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, uint>)(lpVtbl[2]))((ICredentialProvider*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, CREDENTIAL_PROVIDER_USAGE_SCENARIO, uint, int>)(lpVtbl[3]))((ICredentialProvider*)Unsafe.AsPointer(ref this), cpus, dwFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION*, int>)(lpVtbl[4]))((ICredentialProvider*)Unsafe.AsPointer(ref this), pcpcs);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, ICredentialProviderEvents*, nuint, int>)(lpVtbl[5]))((ICredentialProvider*)Unsafe.AsPointer(ref this), pcpe, upAdviseContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, int>)(lpVtbl[6]))((ICredentialProvider*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, uint*, int>)(lpVtbl[7]))((ICredentialProvider*)Unsafe.AsPointer(ref this), pdwCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, uint, CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR**, int>)(lpVtbl[8]))((ICredentialProvider*)Unsafe.AsPointer(ref this), dwIndex, ppcpfd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, uint*, uint*, BOOL*, int>)(lpVtbl[9]))((ICredentialProvider*)Unsafe.AsPointer(ref this), pdwCount, pdwDefault, pbAutoLogonWithDefault);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICredentialProvider*, uint, ICredentialProviderCredential**, int>)(lpVtbl[10]))((ICredentialProvider*)Unsafe.AsPointer(ref this), dwIndex, ppcpc);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, CREDENTIAL_PROVIDER_USAGE_SCENARIO, uint, int> SetUsageScenario;

        [NativeTypeName("HRESULT (const CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION*, int> SetSerialization;

        [NativeTypeName("HRESULT (ICredentialProviderEvents *, UINT_PTR) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ICredentialProviderEvents*, nuint, int> Advise;

        [NativeTypeName("HRESULT () __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, int> UnAdvise;

        [NativeTypeName("HRESULT (DWORD *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint*, int> GetFieldDescriptorCount;

        [NativeTypeName("HRESULT (DWORD, CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR**, int> GetFieldDescriptorAt;

        [NativeTypeName("HRESULT (DWORD *, DWORD *, BOOL *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint*, uint*, BOOL*, int> GetCredentialCount;

        [NativeTypeName("HRESULT (DWORD, ICredentialProviderCredential **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, ICredentialProviderCredential**, int> GetCredentialAt;
    }
}
