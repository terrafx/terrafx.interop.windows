...
public unsafe partial struct ICoCreateLocally : ICoCreateLocally.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ICoCreateLocally;
