...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ICoCreateLocally);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoCreateLocally*, Guid*, void**, int>)(lpVtbl[0]))((ICoCreateLocally*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ICoCreateLocally*, uint>)(lpVtbl[1]))((ICoCreateLocally*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ICoCreateLocally*, uint>)(lpVtbl[2]))((ICoCreateLocally*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ICoCreateLocally*, Guid*, uint, Guid*, IUnknown**, Guid*, IUnknown*, VARIANT, int>)(lpVtbl[3]))((ICoCreateLocally*)Unsafe.AsPointer(ref this), rclsid, dwClsContext, riid, punk, riidParam, punkParam, varParam);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, uint, Guid*, IUnknown**, Guid*, IUnknown*, VARIANT, int> CoCreateLocally;
    }
}
