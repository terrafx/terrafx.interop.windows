...
public unsafe partial struct IAccDictionary : IAccDictionary.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IAccDictionary;
