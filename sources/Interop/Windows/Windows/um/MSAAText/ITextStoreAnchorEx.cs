...
public unsafe partial struct ITextStoreAnchorEx : ITextStoreAnchorEx.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITextStoreAnchorEx;
