...
public unsafe partial struct ITextStoreACPEx : ITextStoreACPEx.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ITextStoreACPEx;
