...
public unsafe partial struct IEnumSyncMgrEvents : IEnumSyncMgrEvents.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumSyncMgrEvents;
