...
public unsafe partial struct ISyncMgrSyncItem : ISyncMgrSyncItem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrSyncItem;
