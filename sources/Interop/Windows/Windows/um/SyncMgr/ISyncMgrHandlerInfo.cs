...
public unsafe partial struct ISyncMgrHandlerInfo : ISyncMgrHandlerInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrHandlerInfo;
