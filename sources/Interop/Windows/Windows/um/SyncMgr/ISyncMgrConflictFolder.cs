...
public unsafe partial struct ISyncMgrConflictFolder : ISyncMgrConflictFolder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrConflictFolder;
