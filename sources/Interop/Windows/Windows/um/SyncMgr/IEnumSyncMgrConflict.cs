...
public unsafe partial struct IEnumSyncMgrConflict : IEnumSyncMgrConflict.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumSyncMgrConflict;
