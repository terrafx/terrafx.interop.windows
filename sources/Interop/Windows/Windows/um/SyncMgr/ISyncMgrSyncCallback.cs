...
public unsafe partial struct ISyncMgrSyncCallback : ISyncMgrSyncCallback.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrSyncCallback;
