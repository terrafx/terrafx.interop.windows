...
public unsafe partial struct ISyncMgrHandlerCollection : ISyncMgrHandlerCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrHandlerCollection;
