...
public unsafe partial struct ISyncMgrConflictItems : ISyncMgrConflictItems.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrConflictItems;
