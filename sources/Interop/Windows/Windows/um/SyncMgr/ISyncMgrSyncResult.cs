...
public unsafe partial struct ISyncMgrSyncResult : ISyncMgrSyncResult.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrSyncResult;
