...
public unsafe partial struct ISyncMgrHandler : ISyncMgrHandler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrHandler;
