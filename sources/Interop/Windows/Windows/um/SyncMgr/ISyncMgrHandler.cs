...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ISyncMgrHandler);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, Guid*, void**, int>)(lpVtbl[0]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, uint>)(lpVtbl[1]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, uint>)(lpVtbl[2]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, char**, int>)(lpVtbl[3]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), ppszName);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, ISyncMgrHandlerInfo**, int>)(lpVtbl[4]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), ppHandlerInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, Guid*, Guid*, void**, int>)(lpVtbl[5]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), rguidObjectID, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, SYNCMGR_HANDLER_CAPABILITIES*, int>)(lpVtbl[6]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), pmCapabilities);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, SYNCMGR_HANDLER_POLICIES*, int>)(lpVtbl[7]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), pmPolicies);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, BOOL, int>)(lpVtbl[8]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), fActivate);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, BOOL, int>)(lpVtbl[9]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), fEnable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ISyncMgrHandler*, char**, uint, HWND, ISyncMgrSessionCreator*, IUnknown*, int>)(lpVtbl[10]))((ISyncMgrHandler*)Unsafe.AsPointer(ref this), ppszItemIDs, cItems, hwndOwner, pSessionCreator, punk);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, ISyncMgrHandlerInfo**, int> GetHandlerInfo;

        [NativeTypeName("HRESULT (const GUID &, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, Guid*, void**, int> GetObjectW;

        [NativeTypeName("HRESULT (SYNCMGR_HANDLER_CAPABILITIES *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, SYNCMGR_HANDLER_CAPABILITIES*, int> GetCapabilities;

        [NativeTypeName("HRESULT (SYNCMGR_HANDLER_POLICIES *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, SYNCMGR_HANDLER_POLICIES*, int> GetPolicies;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, char**, uint, HWND, ISyncMgrSessionCreator*, IUnknown*, int> Synchronize;
    }
}
