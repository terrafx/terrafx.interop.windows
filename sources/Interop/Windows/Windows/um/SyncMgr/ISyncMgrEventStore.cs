...
public unsafe partial struct ISyncMgrEventStore : ISyncMgrEventStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrEventStore;
