...
public unsafe partial struct ISyncMgrConflictStore : ISyncMgrConflictStore.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrConflictStore;
