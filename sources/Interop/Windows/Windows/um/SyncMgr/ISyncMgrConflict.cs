...
public unsafe partial struct ISyncMgrConflict : ISyncMgrConflict.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISyncMgrConflict;
