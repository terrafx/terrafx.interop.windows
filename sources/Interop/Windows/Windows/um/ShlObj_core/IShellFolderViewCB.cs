...
public unsafe partial struct IShellFolderViewCB : IShellFolderViewCB.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellFolderViewCB;
