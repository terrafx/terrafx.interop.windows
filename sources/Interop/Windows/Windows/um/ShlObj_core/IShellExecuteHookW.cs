...
public unsafe partial struct IShellExecuteHookW : IShellExecuteHookW.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellExecuteHookW;
