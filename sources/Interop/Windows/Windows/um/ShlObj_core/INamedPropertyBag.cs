...
public unsafe partial struct INamedPropertyBag : INamedPropertyBag.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_INamedPropertyBag;
