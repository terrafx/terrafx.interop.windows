...
public unsafe partial struct IShellIconOverlay : IShellIconOverlay.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellIconOverlay;
