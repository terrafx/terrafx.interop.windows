...
/// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1"]/*' />
public unsafe partial struct PROPSHEETPAGEW_V1
{
    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.dwSize"]/*' />
    [NativeTypeName("DWORD")]
    public uint dwSize;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.dwFlags"]/*' />
    [NativeTypeName("DWORD")]
    public uint dwFlags;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.hInstance"]/*' />
    public HINSTANCE hInstance;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.Anonymous1"]/*' />
    [NativeTypeName("_PROPSHEETPAGEW_V1::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/prsht.h:244:5)")]
    public _Anonymous1_e__Union Anonymous1;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.Anonymous2"]/*' />
    [NativeTypeName("_PROPSHEETPAGEW_V1::(anonymous union at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um/prsht.h:244:5)")]
    public _Anonymous2_e__Union Anonymous2;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.pszTitle"]/*' />
    [NativeTypeName("LPCWSTR")]
    public ushort* pszTitle;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.pfnDlgProc"]/*' />
    [NativeTypeName("DLGPROC")]
    public delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint> pfnDlgProc;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.lParam"]/*' />
    public LPARAM lParam;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.pfnCallback"]/*' />
    [NativeTypeName("LPFNPSPCALLBACKW")]
    public delegate* unmanaged<HWND, uint, PROPSHEETPAGEW*, uint> pfnCallback;

    /// <include file='PROPSHEETPAGEW_V1.xml' path='doc/member[@name="PROPSHEETPAGEW_V1.pcRefParent"]/*' />
