...
public unsafe partial struct IActiveDesktopP : IActiveDesktopP.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IActiveDesktopP;
