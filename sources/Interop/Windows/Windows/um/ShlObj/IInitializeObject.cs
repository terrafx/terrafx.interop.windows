...
public unsafe partial struct IInitializeObject : IInitializeObject.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IInitializeObject;
