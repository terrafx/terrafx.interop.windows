...
public unsafe partial struct IIsolatedAppLauncher : IIsolatedAppLauncher.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IIsolatedAppLauncher;
