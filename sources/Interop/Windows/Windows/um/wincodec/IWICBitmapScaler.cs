...
public unsafe partial struct IWICBitmapScaler : IWICBitmapScaler.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICBitmapScaler;
