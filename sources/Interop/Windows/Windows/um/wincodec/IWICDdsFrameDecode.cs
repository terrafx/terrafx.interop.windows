...
public unsafe partial struct IWICDdsFrameDecode : IWICDdsFrameDecode.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICDdsFrameDecode;
