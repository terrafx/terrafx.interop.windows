...
public unsafe partial struct IWICBitmapDecoderInfo : IWICBitmapDecoderInfo.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[6]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchAuthor, wzAuthor, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[8]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchVersion, wzVersion, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[9]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchSpecVersion, wzSpecVersion, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[10]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchFriendlyName, wzFriendlyName, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[13]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchColorManagementVersion, wzColorManagementVersion, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[14]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchDeviceManufacturer, wzDeviceManufacturer, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[15]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchDeviceModels, wzDeviceModels, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[16]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchMimeTypes, wzMimeTypes, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, uint, char*, uint*, int>)(lpVtbl[17]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), cchFileExtensions, wzFileExtensions, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICBitmapDecoderInfo*, char*, BOOL*, int>)(lpVtbl[22]))((IWICBitmapDecoderInfo*)Unsafe.AsPointer(ref this), wzMimeType, pfMatches);
    }
