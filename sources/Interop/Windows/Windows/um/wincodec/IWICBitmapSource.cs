...
public unsafe partial struct IWICBitmapSource : IWICBitmapSource.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICBitmapSource;
