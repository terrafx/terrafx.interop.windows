...
public unsafe partial struct IWICJpegFrameDecode : IWICJpegFrameDecode.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICJpegFrameDecode;
