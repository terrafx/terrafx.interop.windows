...
public unsafe partial struct IWICPixelFormatInfo : IWICPixelFormatInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICPixelFormatInfo;
