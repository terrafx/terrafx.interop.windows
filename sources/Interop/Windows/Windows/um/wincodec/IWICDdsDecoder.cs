...
public unsafe partial struct IWICDdsDecoder : IWICDdsDecoder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICDdsDecoder;
