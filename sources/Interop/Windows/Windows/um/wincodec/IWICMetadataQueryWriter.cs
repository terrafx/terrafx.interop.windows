...
public unsafe partial struct IWICMetadataQueryWriter : IWICMetadataQueryWriter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICMetadataQueryWriter;
