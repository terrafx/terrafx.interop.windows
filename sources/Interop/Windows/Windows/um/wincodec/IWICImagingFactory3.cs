...
/// <include file='IWICImagingFactory3.xml' path='doc/member[@name="IWICImagingFactory3"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IWICImagingFactory3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICImagingFactory3*, char*, Guid*, uint, WICDecodeOptions, IWICBitmapDecoder**, int>)(lpVtbl[3]))((IWICImagingFactory3*)Unsafe.AsPointer(ref this), wzFilename, pguidVendor, dwDesiredAccess, metadataOptions, ppIDecoder);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICImagingFactory3*, IStream*, Guid*, WICDecodeOptions, IWICBitmapDecoder**, int>)(lpVtbl[4]))((IWICImagingFactory3*)Unsafe.AsPointer(ref this), pIStream, pguidVendor, metadataOptions, ppIDecoder);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICImagingFactory3*, HBITMAP, HPALETTE, WICBitmapAlphaChannelOption, IWICBitmap**, int>)(lpVtbl[21]))((IWICImagingFactory3*)Unsafe.AsPointer(ref this), hBitmap, hPalette, options, ppIBitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICImagingFactory3*, HICON, IWICBitmap**, int>)(lpVtbl[22]))((IWICImagingFactory3*)Unsafe.AsPointer(ref this), hIcon, ppIBitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICImagingFactory3*, uint, uint, IEnumUnknown**, int>)(lpVtbl[23]))((IWICImagingFactory3*)Unsafe.AsPointer(ref this), componentTypes, options, ppIEnumUnknown);
    }
    ...
    /// <include file='IWICImagingFactory3.xml' path='doc/member[@name="IWICImagingFactory3.CreateBitmapToneMapper"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(29)]
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName("HRESULT (IWICBitmapToneMapper **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IWICBitmapToneMapper**, int> CreateBitmapToneMapper;
    }
}
