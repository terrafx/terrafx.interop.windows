...
public unsafe partial struct IWICEnumMetadataItem : IWICEnumMetadataItem.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICEnumMetadataItem;
