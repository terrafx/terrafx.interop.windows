...
public unsafe partial struct IWICFormatConverterInfo : IWICFormatConverterInfo.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IWICFormatConverterInfo*, uint, char*, uint*, int>)(lpVtbl[6]))((IWICFormatConverterInfo*)Unsafe.AsPointer(ref this), cchAuthor, wzAuthor, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICFormatConverterInfo*, uint, char*, uint*, int>)(lpVtbl[8]))((IWICFormatConverterInfo*)Unsafe.AsPointer(ref this), cchVersion, wzVersion, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICFormatConverterInfo*, uint, char*, uint*, int>)(lpVtbl[9]))((IWICFormatConverterInfo*)Unsafe.AsPointer(ref this), cchSpecVersion, wzSpecVersion, pcchActual);
    }
    ...
    {
        return ((delegate* unmanaged<IWICFormatConverterInfo*, uint, char*, uint*, int>)(lpVtbl[10]))((IWICFormatConverterInfo*)Unsafe.AsPointer(ref this), cchFriendlyName, wzFriendlyName, pcchActual);
    }
