...
public unsafe partial struct IWICBitmapEncoder : IWICBitmapEncoder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICBitmapEncoder;
