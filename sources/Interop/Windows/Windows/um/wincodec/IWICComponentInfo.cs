...
public unsafe partial struct IWICComponentInfo : IWICComponentInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICComponentInfo;
