...
public unsafe partial struct IWICColorContext : IWICColorContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICColorContext;
