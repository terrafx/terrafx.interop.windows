...
public unsafe partial struct IWICMetadataQueryReader : IWICMetadataQueryReader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWICMetadataQueryReader;
