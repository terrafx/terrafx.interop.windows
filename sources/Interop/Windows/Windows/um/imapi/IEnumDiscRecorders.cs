...
public unsafe partial struct IEnumDiscRecorders : IEnumDiscRecorders.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumDiscRecorders;
