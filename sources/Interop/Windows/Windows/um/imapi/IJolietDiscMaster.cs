...
public unsafe partial struct IJolietDiscMaster : IJolietDiscMaster.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IJolietDiscMaster;
