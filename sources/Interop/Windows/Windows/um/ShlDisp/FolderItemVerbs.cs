...
public unsafe partial struct FolderItemVerbs : FolderItemVerbs.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<FolderItemVerbs*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((FolderItemVerbs*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, VARIANT, FolderItemVerb**, int> Item;
