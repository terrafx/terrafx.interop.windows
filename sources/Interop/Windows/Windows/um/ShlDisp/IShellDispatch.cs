...
public unsafe partial struct IShellDispatch : IShellDispatch.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellDispatch;
