...
public unsafe partial struct Folder2 : Folder2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<Folder2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((Folder2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<Folder2*, char**, int>)(lpVtbl[7]))((Folder2*)Unsafe.AsPointer(ref this), pbs);
    }
    ...
    {
        return ((delegate* unmanaged<Folder2*, char*, FolderItem**, int>)(lpVtbl[12]))((Folder2*)Unsafe.AsPointer(ref this), bName, ppid);
    }
    ...
    {
        return ((delegate* unmanaged<Folder2*, char*, VARIANT, int>)(lpVtbl[13]))((Folder2*)Unsafe.AsPointer(ref this), bName, vOptions);
    }
    ...
    {
        return ((delegate* unmanaged<Folder2*, VARIANT, int, char**, int>)(lpVtbl[16]))((Folder2*)Unsafe.AsPointer(ref this), vItem, iColumn, pbs);
    }
