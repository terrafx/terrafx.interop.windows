...
public unsafe partial struct FolderItems2 : FolderItems2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<FolderItems2*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((FolderItems2*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
