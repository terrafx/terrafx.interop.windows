...
public unsafe partial struct IWebWizardHost : IWebWizardHost.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IWebWizardHost;
