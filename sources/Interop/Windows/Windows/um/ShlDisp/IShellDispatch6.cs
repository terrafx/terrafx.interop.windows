...
public unsafe partial struct IShellDispatch6 : IShellDispatch6.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, Guid*, char**, uint, uint, int*, int>)(lpVtbl[5]))((IShellDispatch6*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, int, char*, int, VARIANT, Folder**, int>)(lpVtbl[10]))((IShellDispatch6*)Unsafe.AsPointer(ref this), Hwnd, Title, Options, RootFolder, ppsdf);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, int>)(lpVtbl[29]))((IShellDispatch6*)Unsafe.AsPointer(ref this), bstrDir);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, char*, int*, int>)(lpVtbl[30]))((IShellDispatch6*)Unsafe.AsPointer(ref this), Group, Restriction, plRestrictValue);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT, VARIANT, VARIANT, VARIANT, int>)(lpVtbl[31]))((IShellDispatch6*)Unsafe.AsPointer(ref this), File, vArgs, vDir, vOperation, vShow);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, char*, char*, int>)(lpVtbl[32]))((IShellDispatch6*)Unsafe.AsPointer(ref this), name, location, model);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT*, int>)(lpVtbl[33]))((IShellDispatch6*)Unsafe.AsPointer(ref this), name, pv);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT, VARIANT*, int>)(lpVtbl[34]))((IShellDispatch6*)Unsafe.AsPointer(ref this), ServiceName, Persistent, pSuccess);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT, VARIANT*, int>)(lpVtbl[35]))((IShellDispatch6*)Unsafe.AsPointer(ref this), ServiceName, Persistent, pSuccess);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT*, int>)(lpVtbl[36]))((IShellDispatch6*)Unsafe.AsPointer(ref this), ServiceName, pRunning);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT*, int>)(lpVtbl[37]))((IShellDispatch6*)Unsafe.AsPointer(ref this), ServiceName, pCanStartStop);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT, VARIANT*, int>)(lpVtbl[38]))((IShellDispatch6*)Unsafe.AsPointer(ref this), bstrClsid, bShow, pSuccess);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, VARIANT, char*, int>)(lpVtbl[39]))((IShellDispatch6*)Unsafe.AsPointer(ref this), varFile, bstrCategory);
    }
    ...
    {
        return ((delegate* unmanaged<IShellDispatch6*, char*, VARIANT*, int>)(lpVtbl[42]))((IShellDispatch6*)Unsafe.AsPointer(ref this), bstrPolicyName, pValue);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName("HRESULT () __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, int> SearchCommand;
    }
}
