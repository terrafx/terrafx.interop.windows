...
public unsafe partial struct FolderItemVerb : FolderItemVerb.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_FolderItemVerb;
