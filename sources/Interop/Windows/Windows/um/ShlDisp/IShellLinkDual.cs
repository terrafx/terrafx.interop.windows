...
public unsafe partial struct IShellLinkDual : IShellLinkDual.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IShellLinkDual;
