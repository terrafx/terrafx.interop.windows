...
public unsafe partial struct IPersistMemory : IPersistMemory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPersistMemory;
