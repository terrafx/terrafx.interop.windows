...
public unsafe partial struct IConnectionPoint : IConnectionPoint.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IConnectionPoint;
