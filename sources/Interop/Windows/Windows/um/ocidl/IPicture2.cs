...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IPicture2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, Guid*, void**, int>)(lpVtbl[0]))((IPicture2*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, uint>)(lpVtbl[1]))((IPicture2*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, uint>)(lpVtbl[2]))((IPicture2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, HHANDLE*, int>)(lpVtbl[3]))((IPicture2*)Unsafe.AsPointer(ref this), pHandle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, HHANDLE*, int>)(lpVtbl[4]))((IPicture2*)Unsafe.AsPointer(ref this), phPal);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, short*, int>)(lpVtbl[5]))((IPicture2*)Unsafe.AsPointer(ref this), pType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, int*, int>)(lpVtbl[6]))((IPicture2*)Unsafe.AsPointer(ref this), pWidth);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, int*, int>)(lpVtbl[7]))((IPicture2*)Unsafe.AsPointer(ref this), pHeight);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, HDC, int, int, int, int, int, int, int, int, RECT*, int>)(lpVtbl[8]))((IPicture2*)Unsafe.AsPointer(ref this), hDC, x, y, cx, cy, xSrc, ySrc, cxSrc, cySrc, pRcWBounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, HHANDLE, int>)(lpVtbl[9]))((IPicture2*)Unsafe.AsPointer(ref this), hPal);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, HDC*, int>)(lpVtbl[10]))((IPicture2*)Unsafe.AsPointer(ref this), phDC);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, HDC, HDC*, HHANDLE*, int>)(lpVtbl[11]))((IPicture2*)Unsafe.AsPointer(ref this), hDCIn, phDCOut, phBmpOut);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, BOOL*, int>)(lpVtbl[12]))((IPicture2*)Unsafe.AsPointer(ref this), pKeep);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, BOOL, int>)(lpVtbl[13]))((IPicture2*)Unsafe.AsPointer(ref this), keep);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, int>)(lpVtbl[14]))((IPicture2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, IStream*, BOOL, int*, int>)(lpVtbl[15]))((IPicture2*)Unsafe.AsPointer(ref this), pStream, fSaveMemCopy, pCbSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IPicture2*, uint*, int>)(lpVtbl[16]))((IPicture2*)Unsafe.AsPointer(ref this), pDwAttr);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HHANDLE*, int> get_Handle;

        [NativeTypeName("HRESULT (HHANDLE *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HHANDLE*, int> get_hPal;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HDC, int, int, int, int, int, int, int, int, RECT*, int> Render;

        [NativeTypeName("HRESULT (HHANDLE) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HHANDLE, int> set_hPal;

        [NativeTypeName("HRESULT (HDC *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HDC*, int> get_CurDC;

        [NativeTypeName("HRESULT (HDC, HDC *, HHANDLE *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HDC, HDC*, HHANDLE*, int> SelectPicture;

        [NativeTypeName("HRESULT (BOOL *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL*, int> get_KeepOriginalFormat;

        [NativeTypeName("HRESULT (BOOL) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, int> put_KeepOriginalFormat;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IStream*, BOOL, int*, int> SaveAsFile;
