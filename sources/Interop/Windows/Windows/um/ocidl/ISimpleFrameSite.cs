...
public unsafe partial struct ISimpleFrameSite : ISimpleFrameSite.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ISimpleFrameSite;
