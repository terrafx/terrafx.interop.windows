...
public unsafe partial struct IPropertyNotifySink : IPropertyNotifySink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPropertyNotifySink;
