...
public unsafe partial struct IPointerInactive : IPointerInactive.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPointerInactive;
