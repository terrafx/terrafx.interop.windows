...
public unsafe partial struct IEnumConnections : IEnumConnections.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IEnumConnections;
