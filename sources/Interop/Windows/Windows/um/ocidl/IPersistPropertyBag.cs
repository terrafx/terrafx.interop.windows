...
public unsafe partial struct IPersistPropertyBag : IPersistPropertyBag.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IPersistPropertyBag;
