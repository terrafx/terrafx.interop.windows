...
using static TerraFX.Interop.Windows.D3D12_ROOT_PARAMETER_TYPE;
using static TerraFX.Interop.Windows.D3D12_SHADER_VISIBILITY;
...
namespace TerraFX.Interop.Windows
{
    public unsafe partial struct D3D12_ROOT_PARAMETER
    {
        ...
        public static void InitAsConstantBufferView([NativeTypeName("D3D12_ROOT_PARAMETER &")] out D3D12_ROOT_PARAMETER rootParam, uint shaderRegister, uint registerSpace = 0, D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL)
        {
            rootParam = default;
        ...
        public static void InitAsShaderResourceView([NativeTypeName("D3D12_ROOT_PARAMETER &")] out D3D12_ROOT_PARAMETER rootParam, uint shaderRegister, uint registerSpace = 0, D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL)
        {
            rootParam = default;
