...
public unsafe partial struct HFONT : IComparable, IComparable<HFONT>, IEquatable<HFONT>, IFormattable
{
    ...
    public static explicit operator HFONT(byte value) => new HFONT((void*)(value));

    public static explicit operator byte(HFONT value) => (byte)(value.Value);

    public static explicit operator HFONT(short value) => new HFONT((void*)(value));

    public static explicit operator short(HFONT value) => (short)(value.Value);

    public static explicit operator HFONT(int value) => new HFONT((void*)(value));

    public static explicit operator int(HFONT value) => (int)(value.Value);

    public static explicit operator HFONT(long value) => new HFONT((void*)(value));

    public static explicit operator long(HFONT value) => (long)(value.Value);

    public static explicit operator HFONT(nint value) => new HFONT((void*)(value));

    public static implicit operator nint(HFONT value) => (nint)(value.Value);

    public static explicit operator HFONT(sbyte value) => new HFONT((void*)(value));

    public static explicit operator sbyte(HFONT value) => (sbyte)(value.Value);

    public static explicit operator HFONT(ushort value) => new HFONT((void*)(value));

    public static explicit operator ushort(HFONT value) => (ushort)(value.Value);

    public static explicit operator HFONT(uint value) => new HFONT((void*)(value));

    public static explicit operator uint(HFONT value) => (uint)(value.Value);

    public static explicit operator HFONT(ulong value) => new HFONT((void*)(value));

    public static explicit operator ulong(HFONT value) => (ulong)(value.Value);

    public static explicit operator HFONT(nuint value) => new HFONT((void*)(value));
