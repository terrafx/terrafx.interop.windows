...
namespace TerraFX.Interop.Windows
{
    public unsafe partial struct HCS_PROCESS : IComparable, IComparable<HCS_PROCESS>, IEquatable<HCS_PROCESS>, IFormattable
    {
        ...
        public static HCS_PROCESS INVALID_VALUE => new HCS_PROCESS((void*)(-1));

        public static HCS_PROCESS NULL => new HCS_PROCESS(null);
        ...
        public static implicit operator void*(HCS_PROCESS value) => value.Value;
        ...
        public static explicit operator HCS_PROCESS(byte value) => new HCS_PROCESS((void*)(value));

        public static explicit operator byte(HCS_PROCESS value) => (byte)(value.Value);

        public static explicit operator HCS_PROCESS(short value) => new HCS_PROCESS((void*)(value));

        public static explicit operator short(HCS_PROCESS value) => (short)(value.Value);

        public static explicit operator HCS_PROCESS(int value) => new HCS_PROCESS((void*)(value));

        public static explicit operator int(HCS_PROCESS value) => (int)(value.Value);

        public static explicit operator HCS_PROCESS(long value) => new HCS_PROCESS((void*)(value));

        public static explicit operator long(HCS_PROCESS value) => (long)(value.Value);

        public static explicit operator HCS_PROCESS(nint value) => new HCS_PROCESS((void*)(value));

        public static implicit operator nint(HCS_PROCESS value) => (nint)(value.Value);

        public static explicit operator HCS_PROCESS(sbyte value) => new HCS_PROCESS((void*)(value));

        public static explicit operator sbyte(HCS_PROCESS value) => (sbyte)(value.Value);

        public static explicit operator HCS_PROCESS(ushort value) => new HCS_PROCESS((void*)(value));

        public static explicit operator ushort(HCS_PROCESS value) => (ushort)(value.Value);

        public static explicit operator HCS_PROCESS(uint value) => new HCS_PROCESS((void*)(value));

        public static explicit operator uint(HCS_PROCESS value) => (uint)(value.Value);

        public static explicit operator HCS_PROCESS(ulong value) => new HCS_PROCESS((void*)(value));

        public static explicit operator ulong(HCS_PROCESS value) => (ulong)(value.Value);

        public static explicit operator HCS_PROCESS(nuint value) => new HCS_PROCESS((void*)(value));
        ...
        public int CompareTo(HCS_PROCESS other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

        public override bool Equals(object? obj) => (obj is HCS_PROCESS other) && Equals(other);

        public bool Equals(HCS_PROCESS other) => ((nuint)(Value)).Equals((nuint)(other.Value));
