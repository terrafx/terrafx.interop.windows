...
public readonly unsafe partial struct HSPFILEQ : IComparable, IComparable<HSPFILEQ>, IEquatable<HSPFILEQ>, IFormattable
{
    ...
    public static explicit operator HSPFILEQ(short value) => new HSPFILEQ(unchecked((void*)(value)));
    ...
    public static explicit operator HSPFILEQ(sbyte value) => new HSPFILEQ(unchecked((void*)(value)));

    public static explicit operator sbyte(HSPFILEQ value) => (sbyte)(value.Value);

    public static explicit operator HSPFILEQ(ushort value) => new HSPFILEQ(unchecked((void*)(value)));
    ...
    public static explicit operator HSPFILEQ(ulong value) => new HSPFILEQ(unchecked((void*)(value)));

    public static explicit operator ulong(HSPFILEQ value) => (ulong)(value.Value);

    public static explicit operator HSPFILEQ(nuint value) => new HSPFILEQ(unchecked((void*)(value)));
