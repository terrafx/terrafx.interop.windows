...
namespace TerraFX.Interop.Windows
{
    public unsafe partial struct HPROFILE : IComparable, IComparable<HPROFILE>, IEquatable<HPROFILE>, IFormattable
    {
        ...
        public static explicit operator HPROFILE(byte value) => new HPROFILE((void*)(value));

        public static explicit operator byte(HPROFILE value) => (byte)(value.Value);

        public static explicit operator HPROFILE(short value) => new HPROFILE((void*)(value));

        public static explicit operator short(HPROFILE value) => (short)(value.Value);

        public static explicit operator HPROFILE(int value) => new HPROFILE((void*)(value));

        public static explicit operator int(HPROFILE value) => (int)(value.Value);

        public static explicit operator HPROFILE(long value) => new HPROFILE((void*)(value));

        public static explicit operator long(HPROFILE value) => (long)(value.Value);

        public static explicit operator HPROFILE(nint value) => new HPROFILE((void*)(value));

        public static implicit operator nint(HPROFILE value) => (nint)(value.Value);

        public static explicit operator HPROFILE(sbyte value) => new HPROFILE((void*)(value));

        public static explicit operator sbyte(HPROFILE value) => (sbyte)(value.Value);

        public static explicit operator HPROFILE(ushort value) => new HPROFILE((void*)(value));

        public static explicit operator ushort(HPROFILE value) => (ushort)(value.Value);

        public static explicit operator HPROFILE(uint value) => new HPROFILE((void*)(value));

        public static explicit operator uint(HPROFILE value) => (uint)(value.Value);

        public static explicit operator HPROFILE(ulong value) => new HPROFILE((void*)(value));

        public static explicit operator ulong(HPROFILE value) => (ulong)(value.Value);

        public static explicit operator HPROFILE(nuint value) => new HPROFILE((void*)(value));
