...
public readonly unsafe partial struct HPROFILE : IComparable, IComparable<HPROFILE>, IEquatable<HPROFILE>, IFormattable
{
    ...
    public static explicit operator HPROFILE(short value) => new HPROFILE(unchecked((void*)(value)));
    ...
    public static explicit operator HPROFILE(sbyte value) => new HPROFILE(unchecked((void*)(value)));

    public static explicit operator sbyte(HPROFILE value) => (sbyte)(value.Value);

    public static explicit operator HPROFILE(ushort value) => new HPROFILE(unchecked((void*)(value)));
    ...
    public static explicit operator HPROFILE(ulong value) => new HPROFILE(unchecked((void*)(value)));

    public static explicit operator ulong(HPROFILE value) => (ulong)(value.Value);

    public static explicit operator HPROFILE(nuint value) => new HPROFILE(unchecked((void*)(value)));
