...
namespace TerraFX.Interop.Windows
{
    public unsafe partial struct HFASTMUTEX : IComparable, IComparable<HFASTMUTEX>, IEquatable<HFASTMUTEX>, IFormattable
    {
        ...
        public static HFASTMUTEX INVALID_VALUE => new HFASTMUTEX((void*)(-1));

        public static HFASTMUTEX NULL => new HFASTMUTEX(null);
        ...
        public static implicit operator void*(HFASTMUTEX value) => value.Value;
        ...
        public static explicit operator HFASTMUTEX(byte value) => new HFASTMUTEX((void*)(value));

        public static explicit operator byte(HFASTMUTEX value) => (byte)(value.Value);

        public static explicit operator HFASTMUTEX(short value) => new HFASTMUTEX((void*)(value));

        public static explicit operator short(HFASTMUTEX value) => (short)(value.Value);

        public static explicit operator HFASTMUTEX(int value) => new HFASTMUTEX((void*)(value));

        public static explicit operator int(HFASTMUTEX value) => (int)(value.Value);

        public static explicit operator HFASTMUTEX(long value) => new HFASTMUTEX((void*)(value));

        public static explicit operator long(HFASTMUTEX value) => (long)(value.Value);

        public static explicit operator HFASTMUTEX(nint value) => new HFASTMUTEX((void*)(value));

        public static implicit operator nint(HFASTMUTEX value) => (nint)(value.Value);

        public static explicit operator HFASTMUTEX(sbyte value) => new HFASTMUTEX((void*)(value));

        public static explicit operator sbyte(HFASTMUTEX value) => (sbyte)(value.Value);

        public static explicit operator HFASTMUTEX(ushort value) => new HFASTMUTEX((void*)(value));

        public static explicit operator ushort(HFASTMUTEX value) => (ushort)(value.Value);

        public static explicit operator HFASTMUTEX(uint value) => new HFASTMUTEX((void*)(value));

        public static explicit operator uint(HFASTMUTEX value) => (uint)(value.Value);

        public static explicit operator HFASTMUTEX(ulong value) => new HFASTMUTEX((void*)(value));

        public static explicit operator ulong(HFASTMUTEX value) => (ulong)(value.Value);

        public static explicit operator HFASTMUTEX(nuint value) => new HFASTMUTEX((void*)(value));
        ...
        public int CompareTo(HFASTMUTEX other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

        public override bool Equals(object? obj) => (obj is HFASTMUTEX other) && Equals(other);

        public bool Equals(HFASTMUTEX other) => ((nuint)(Value)).Equals((nuint)(other.Value));
