...
public readonly unsafe partial struct HHANDLE : IComparable, IComparable<HHANDLE>, IEquatable<HHANDLE>, IFormattable
{
    ...
    public static explicit operator HHANDLE(byte value) => new HHANDLE((void*)(value));

    public static explicit operator byte(HHANDLE value) => (byte)(value.Value);

    public static explicit operator HHANDLE(short value) => new HHANDLE((void*)(value));

    public static explicit operator short(HHANDLE value) => (short)(value.Value);

    public static explicit operator HHANDLE(int value) => new HHANDLE((void*)(value));

    public static explicit operator int(HHANDLE value) => (int)(value.Value);

    public static explicit operator HHANDLE(long value) => new HHANDLE((void*)(value));

    public static explicit operator long(HHANDLE value) => (long)(value.Value);

    public static explicit operator HHANDLE(nint value) => new HHANDLE((void*)(value));

    public static implicit operator nint(HHANDLE value) => (nint)(value.Value);

    public static explicit operator HHANDLE(sbyte value) => new HHANDLE((void*)(value));

    public static explicit operator sbyte(HHANDLE value) => (sbyte)(value.Value);

    public static explicit operator HHANDLE(ushort value) => new HHANDLE((void*)(value));

    public static explicit operator ushort(HHANDLE value) => (ushort)(value.Value);

    public static explicit operator HHANDLE(uint value) => new HHANDLE((void*)(value));

    public static explicit operator uint(HHANDLE value) => (uint)(value.Value);

    public static explicit operator HHANDLE(ulong value) => new HHANDLE((void*)(value));

    public static explicit operator ulong(HHANDLE value) => (ulong)(value.Value);

    public static explicit operator HHANDLE(nuint value) => new HHANDLE((void*)(value));
    ...
    public int CompareTo(object? obj)
    {
        ...
        return (obj is null) ? 1 : throw new ArgumentException("obj is not an instance of HHANDLE.");
    }
