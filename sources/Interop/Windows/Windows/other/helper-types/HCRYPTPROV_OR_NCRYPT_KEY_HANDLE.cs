...
public readonly unsafe partial struct HCRYPTPROV_OR_NCRYPT_KEY_HANDLE : IComparable, IComparable<HCRYPTPROV_OR_NCRYPT_KEY_HANDLE>, IEquatable<HCRYPTPROV_OR_NCRYPT_KEY_HANDLE>, IFormattable
{
    ...
    public static HCRYPTPROV_OR_NCRYPT_KEY_HANDLE INVALID_VALUE => new HCRYPTPROV_OR_NCRYPT_KEY_HANDLE((void*)(-1));
    ...
    public int CompareTo(HCRYPTPROV_OR_NCRYPT_KEY_HANDLE other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

    public override bool Equals(object? obj) => (obj is HCRYPTPROV_OR_NCRYPT_KEY_HANDLE other) && Equals(other);

    public bool Equals(HCRYPTPROV_OR_NCRYPT_KEY_HANDLE other) => ((nuint)(Value)).Equals((nuint)(other.Value));
