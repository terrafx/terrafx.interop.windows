...
namespace TerraFX.Interop.Windows
{
    public unsafe partial struct APARTMENT_SHUTDOWN_REGISTRATION_COOKIE : IComparable, IComparable<APARTMENT_SHUTDOWN_REGISTRATION_COOKIE>, IEquatable<APARTMENT_SHUTDOWN_REGISTRATION_COOKIE>, IFormattable
    {
        ...
        public static APARTMENT_SHUTDOWN_REGISTRATION_COOKIE INVALID_VALUE => new APARTMENT_SHUTDOWN_REGISTRATION_COOKIE((void*)(-1));

        public static APARTMENT_SHUTDOWN_REGISTRATION_COOKIE NULL => new APARTMENT_SHUTDOWN_REGISTRATION_COOKIE(null);
        ...
        public static implicit operator void*(APARTMENT_SHUTDOWN_REGISTRATION_COOKIE value) => value.Value;
        ...
        public int CompareTo(APARTMENT_SHUTDOWN_REGISTRATION_COOKIE other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

        public override bool Equals(object? obj) => (obj is APARTMENT_SHUTDOWN_REGISTRATION_COOKIE other) && Equals(other);

        public bool Equals(APARTMENT_SHUTDOWN_REGISTRATION_COOKIE other) => ((nuint)(Value)).Equals((nuint)(other.Value));
