...
public readonly unsafe partial struct PACKAGEDEPENDENCY_CONTEXT : IComparable, IComparable<PACKAGEDEPENDENCY_CONTEXT>, IEquatable<PACKAGEDEPENDENCY_CONTEXT>, IFormattable
{
    ...
    public static bool operator ==(PACKAGEDEPENDENCY_CONTEXT left, PACKAGEDEPENDENCY_CONTEXT right) => left.Value == right.Value;
    ...
    public static explicit operator PACKAGEDEPENDENCY_CONTEXT(void* value) => new PACKAGEDEPENDENCY_CONTEXT(value);
    ...
    public int CompareTo(object? obj)
    {
        ...
        return (obj is null) ? 1 : throw new ArgumentException("obj is not an instance of PACKAGEDEPENDENCY_CONTEXT.");
    }

    public int CompareTo(PACKAGEDEPENDENCY_CONTEXT other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

    public override bool Equals(object? obj) => (obj is PACKAGEDEPENDENCY_CONTEXT other) && Equals(other);

    public bool Equals(PACKAGEDEPENDENCY_CONTEXT other) => ((nuint)(Value)).Equals((nuint)(other.Value));
