...
public readonly unsafe partial struct PTP_POOL : IComparable, IComparable<PTP_POOL>, IEquatable<PTP_POOL>, IFormattable
{
    ...
    public static explicit operator PTP_POOL(short value) => new PTP_POOL(unchecked((void*)(value)));
    ...
    public static explicit operator PTP_POOL(sbyte value) => new PTP_POOL(unchecked((void*)(value)));

    public static explicit operator sbyte(PTP_POOL value) => (sbyte)(value.Value);

    public static explicit operator PTP_POOL(ushort value) => new PTP_POOL(unchecked((void*)(value)));
    ...
    public static explicit operator PTP_POOL(ulong value) => new PTP_POOL(unchecked((void*)(value)));

    public static explicit operator ulong(PTP_POOL value) => (ulong)(value.Value);

    public static explicit operator PTP_POOL(nuint value) => new PTP_POOL(unchecked((void*)(value)));
