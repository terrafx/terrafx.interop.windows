...
public unsafe partial struct HTOUCHINPUT : IComparable, IComparable<HTOUCHINPUT>, IEquatable<HTOUCHINPUT>, IFormattable
{
    ...
    public static explicit operator HTOUCHINPUT(byte value) => new HTOUCHINPUT((void*)(value));

    public static explicit operator byte(HTOUCHINPUT value) => (byte)(value.Value);

    public static explicit operator HTOUCHINPUT(short value) => new HTOUCHINPUT((void*)(value));
    ...
    public static explicit operator HTOUCHINPUT(nint value) => new HTOUCHINPUT((void*)(value));

    public static implicit operator nint(HTOUCHINPUT value) => (nint)(value.Value);

    public static explicit operator HTOUCHINPUT(sbyte value) => new HTOUCHINPUT((void*)(value));

    public static explicit operator sbyte(HTOUCHINPUT value) => (sbyte)(value.Value);

    public static explicit operator HTOUCHINPUT(ushort value) => new HTOUCHINPUT((void*)(value));

    public static explicit operator ushort(HTOUCHINPUT value) => (ushort)(value.Value);

    public static explicit operator HTOUCHINPUT(uint value) => new HTOUCHINPUT((void*)(value));

    public static explicit operator uint(HTOUCHINPUT value) => (uint)(value.Value);

    public static explicit operator HTOUCHINPUT(ulong value) => new HTOUCHINPUT((void*)(value));

    public static explicit operator ulong(HTOUCHINPUT value) => (ulong)(value.Value);

    public static explicit operator HTOUCHINPUT(nuint value) => new HTOUCHINPUT((void*)(value));
