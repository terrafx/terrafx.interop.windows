...
public readonly unsafe partial struct UI_ANIMATION_KEYFRAME : IComparable, IComparable<UI_ANIMATION_KEYFRAME>, IEquatable<UI_ANIMATION_KEYFRAME>, IFormattable
{
    ...
    public static bool operator ==(UI_ANIMATION_KEYFRAME left, UI_ANIMATION_KEYFRAME right) => left.Value == right.Value;
    ...
    public static explicit operator UI_ANIMATION_KEYFRAME(void* value) => new UI_ANIMATION_KEYFRAME((int*)(value));
    ...
    public int CompareTo(object? obj)
    {
        ...
        return (obj is null) ? 1 : throw new ArgumentException("obj is not an instance of UI_ANIMATION_KEYFRAME.");
    }

    public int CompareTo(UI_ANIMATION_KEYFRAME other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

    public override bool Equals(object? obj) => (obj is UI_ANIMATION_KEYFRAME other) && Equals(other);

    public bool Equals(UI_ANIMATION_KEYFRAME other) => ((nuint)(Value)).Equals((nuint)(other.Value));
