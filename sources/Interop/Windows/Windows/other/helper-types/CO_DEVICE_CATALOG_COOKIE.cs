...
public unsafe partial struct CO_DEVICE_CATALOG_COOKIE : IComparable, IComparable<CO_DEVICE_CATALOG_COOKIE>, IEquatable<CO_DEVICE_CATALOG_COOKIE>, IFormattable
{
    ...
    public static CO_DEVICE_CATALOG_COOKIE INVALID_VALUE => new CO_DEVICE_CATALOG_COOKIE((void*)(-1));
    ...
    public int CompareTo(object? obj)
    {
        ...
        return (obj is null) ? 1 : throw new ArgumentException("obj is not an instance of CO_DEVICE_CATALOG_COOKIE.");
    }

    public int CompareTo(CO_DEVICE_CATALOG_COOKIE other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));

    public override bool Equals(object? obj) => (obj is CO_DEVICE_CATALOG_COOKIE other) && Equals(other);

    public bool Equals(CO_DEVICE_CATALOG_COOKIE other) => ((nuint)(Value)).Equals((nuint)(other.Value));
