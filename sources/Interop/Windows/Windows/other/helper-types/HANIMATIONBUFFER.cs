...
public readonly unsafe partial struct HANIMATIONBUFFER : IComparable, IComparable<HANIMATIONBUFFER>, IEquatable<HANIMATIONBUFFER>, IFormattable
{
    ...
    public static explicit operator HANIMATIONBUFFER(byte value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator byte(HANIMATIONBUFFER value) => (byte)(value.Value);

    public static explicit operator HANIMATIONBUFFER(short value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator short(HANIMATIONBUFFER value) => (short)(value.Value);

    public static explicit operator HANIMATIONBUFFER(int value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator int(HANIMATIONBUFFER value) => (int)(value.Value);

    public static explicit operator HANIMATIONBUFFER(long value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator long(HANIMATIONBUFFER value) => (long)(value.Value);

    public static explicit operator HANIMATIONBUFFER(nint value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static implicit operator nint(HANIMATIONBUFFER value) => (nint)(value.Value);

    public static explicit operator HANIMATIONBUFFER(sbyte value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator sbyte(HANIMATIONBUFFER value) => (sbyte)(value.Value);

    public static explicit operator HANIMATIONBUFFER(ushort value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator ushort(HANIMATIONBUFFER value) => (ushort)(value.Value);

    public static explicit operator HANIMATIONBUFFER(uint value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator uint(HANIMATIONBUFFER value) => (uint)(value.Value);

    public static explicit operator HANIMATIONBUFFER(ulong value) => new HANIMATIONBUFFER(unchecked((void*)(value)));

    public static explicit operator ulong(HANIMATIONBUFFER value) => (ulong)(value.Value);

    public static explicit operator HANIMATIONBUFFER(nuint value) => new HANIMATIONBUFFER(unchecked((void*)(value)));
    ...
    public int CompareTo(HANIMATIONBUFFER other) => ((nuint)(Value)).CompareTo((nuint)(other.Value));
