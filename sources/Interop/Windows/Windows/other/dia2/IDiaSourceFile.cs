...
public unsafe partial struct IDiaSourceFile : IDiaSourceFile.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaSourceFile;
