...
public unsafe partial struct IDiaPropertyStorage : IDiaPropertyStorage.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaPropertyStorage;
