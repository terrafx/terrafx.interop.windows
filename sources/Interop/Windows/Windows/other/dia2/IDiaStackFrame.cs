...
public unsafe partial struct IDiaStackFrame : IDiaStackFrame.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaStackFrame;
