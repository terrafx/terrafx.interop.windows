...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDiaStackWalkHelper);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, Guid*, void**, int>)(lpVtbl[0]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, uint>)(lpVtbl[1]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, uint>)(lpVtbl[2]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, uint, ulong*, int>)(lpVtbl[3]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), index, pRetVal);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, uint, ulong, int>)(lpVtbl[4]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), index, NewVal);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, MemoryTypeEnum, ulong, uint, uint*, byte*, int>)(lpVtbl[5]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), type, va, cbData, pcbData, pbData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, IDiaFrameData*, ulong*, int>)(lpVtbl[6]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), frame, returnAddress);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, IDiaFrameData*, ulong, ulong*, int>)(lpVtbl[7]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), frame, startAddress, returnAddress);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, ulong, IDiaFrameData**, int>)(lpVtbl[8]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), va, ppFrame);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, ulong, IDiaSymbol**, int>)(lpVtbl[9]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), va, ppSymbol);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, ulong, uint, uint*, byte*, int>)(lpVtbl[10]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), va, cbData, pcbData, pbData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, ulong, ulong*, int>)(lpVtbl[11]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), vaContext, pvaImageStart);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, ulong, uint*, uint*, int>)(lpVtbl[12]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), va, pISect, pOffset);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, ulong, uint, uint*, int>)(lpVtbl[13]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), vaFunc, cbFunc, pNumFragments);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDiaStackWalkHelper*, ulong, uint, uint, ulong*, uint*, int>)(lpVtbl[14]))((IDiaStackWalkHelper*)Unsafe.AsPointer(ref this), vaFunc, cbFunc, cFragments, pVaFragment, pLenFragment);
    }
