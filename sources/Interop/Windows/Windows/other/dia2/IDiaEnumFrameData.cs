...
public unsafe partial struct IDiaEnumFrameData : IDiaEnumFrameData.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaEnumFrameData;
