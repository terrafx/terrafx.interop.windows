...
public unsafe partial struct IDiaStackWalkFrame : IDiaStackWalkFrame.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaStackWalkFrame;
