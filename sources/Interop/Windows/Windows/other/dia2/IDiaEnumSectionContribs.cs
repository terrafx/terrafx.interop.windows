...
public unsafe partial struct IDiaEnumSectionContribs : IDiaEnumSectionContribs.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaEnumSectionContribs;
