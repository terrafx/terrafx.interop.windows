...
public unsafe partial struct IDiaEnumTables : IDiaEnumTables.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaEnumTables;
