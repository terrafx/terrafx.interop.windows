...
public unsafe partial struct IDiaLineNumber : IDiaLineNumber.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaLineNumber;
