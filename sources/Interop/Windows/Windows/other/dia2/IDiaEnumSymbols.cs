...
public unsafe partial struct IDiaEnumSymbols : IDiaEnumSymbols.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaEnumSymbols;
