...
public unsafe partial struct IDiaEnumSegments : IDiaEnumSegments.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaEnumSegments;
