...
public unsafe partial struct IDiaEnumStackFrames : IDiaEnumStackFrames.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaEnumStackFrames;
