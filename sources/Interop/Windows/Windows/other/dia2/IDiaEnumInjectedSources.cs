...
public unsafe partial struct IDiaEnumInjectedSources : IDiaEnumInjectedSources.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDiaEnumInjectedSources;
