...
public unsafe partial struct ID3D12Device7 : ID3D12Device7.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ID3D12Device7*, char*, int>)(lpVtbl[6]))((ID3D12Device7*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Device7*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, char*, HANDLE*, int>)(lpVtbl[31]))((ID3D12Device7*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Device7*, char*, uint, HANDLE*, int>)(lpVtbl[33]))((ID3D12Device7*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
    }
