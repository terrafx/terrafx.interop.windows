...
public unsafe partial struct ID3D12Device11 : ID3D12Device11.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ID3D12Device11*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, ushort*, HANDLE*, int>)(lpVtbl[31]))((ID3D12Device11*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
    }
