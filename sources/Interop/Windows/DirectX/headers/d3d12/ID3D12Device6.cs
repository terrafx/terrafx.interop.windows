...
public unsafe partial struct ID3D12Device6 : ID3D12Device6.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ID3D12Device6*, char*, int>)(lpVtbl[6]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Device6*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, char*, HANDLE*, int>)(lpVtbl[31]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Device6*, char*, uint, HANDLE*, int>)(lpVtbl[33]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
    }
