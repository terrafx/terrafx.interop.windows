...
public unsafe partial struct IDirect3DVertexBuffer9 : IDirect3DVertexBuffer9.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, Guid*, void**, int>)(lpVtbl[0]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, uint>)(lpVtbl[1]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, uint>)(lpVtbl[2]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, IDirect3DDevice9**, int>)(lpVtbl[3]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), ppDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, Guid*, void*, uint, uint, int>)(lpVtbl[4]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), refguid, pData, SizeOfData, Flags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, Guid*, void*, uint*, int>)(lpVtbl[5]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), refguid, pData, pSizeOfData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, Guid*, int>)(lpVtbl[6]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), refguid);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, uint, uint>)(lpVtbl[7]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), PriorityNew);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, uint>)(lpVtbl[8]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this));
    }
    ...
    public void PreLoad()
    {
        ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, void>)(lpVtbl[9]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, D3DRESOURCETYPE>)(lpVtbl[10]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, uint, uint, void**, uint, int>)(lpVtbl[11]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), OffsetToLock, SizeToLock, ppbData, Flags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, int>)(lpVtbl[12]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this));
    }

    /// <include file='IDirect3DVertexBuffer9.xml' path='doc/member[@name="IDirect3DVertexBuffer9.GetDesc"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(13)]
    public HRESULT GetDesc(D3DVERTEXBUFFER_DESC* pDesc)
    {
        return ((delegate* unmanaged[MemberFunction]<IDirect3DVertexBuffer9*, D3DVERTEXBUFFER_DESC*, int>)(lpVtbl[13]))((IDirect3DVertexBuffer9*)Unsafe.AsPointer(ref this), pDesc);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3DVERTEXBUFFER_DESC*, int> GetDesc;
    }
}
