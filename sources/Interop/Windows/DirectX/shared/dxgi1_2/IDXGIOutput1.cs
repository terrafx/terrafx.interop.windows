...
public unsafe partial struct IDXGIOutput1 : IDXGIOutput1.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput1*, DXGI_OUTPUT_DESC*, int>)(lpVtbl[7]))((IDXGIOutput1*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput1*, DXGI_FORMAT, uint, uint*, DXGI_MODE_DESC*, int>)(lpVtbl[8]))((IDXGIOutput1*)Unsafe.AsPointer(ref this), EnumFormat, Flags, pNumModes, pDesc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput1*, IUnknown*, BOOL, int>)(lpVtbl[11]))((IDXGIOutput1*)Unsafe.AsPointer(ref this), pDevice, Exclusive);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput1*, DXGI_FRAME_STATISTICS*, int>)(lpVtbl[18]))((IDXGIOutput1*)Unsafe.AsPointer(ref this), pStats);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput1*, DXGI_FORMAT, uint, uint*, DXGI_MODE_DESC1*, int>)(lpVtbl[19]))((IDXGIOutput1*)Unsafe.AsPointer(ref this), EnumFormat, Flags, pNumModes, pDesc);
    }
