...
public unsafe partial struct IDXGIOutputDuplication : IDXGIOutputDuplication.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGIOutputDuplication;
