...
public unsafe partial struct IDXGIKeyedMutex : IDXGIKeyedMutex.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGIKeyedMutex;
