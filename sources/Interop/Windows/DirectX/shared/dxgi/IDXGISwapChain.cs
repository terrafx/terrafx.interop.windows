...
public unsafe partial struct IDXGISwapChain : IDXGISwapChain.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGISwapChain;
