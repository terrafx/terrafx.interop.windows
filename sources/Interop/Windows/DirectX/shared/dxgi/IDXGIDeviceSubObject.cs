...
public unsafe partial struct IDXGIDeviceSubObject : IDXGIDeviceSubObject.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGIDeviceSubObject;
