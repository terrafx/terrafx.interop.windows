...
// Ported from shared/dxgi1_5.h in the Windows SDK for Windows 10.0.28000.0
...
/// <include file='IDXGISwapChain4.xml' path='doc/member[@name="IDXGISwapChain4"]/*' />
...
public unsafe partial struct IDXGISwapChain4 : IDXGISwapChain4.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint, uint, int>)(lpVtbl[8]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), SyncInterval, Flags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, BOOL, IDXGIOutput*, int>)(lpVtbl[10]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), Fullscreen, pTarget);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, BOOL*, IDXGIOutput**, int>)(lpVtbl[11]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pFullscreen, ppTarget);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint, uint, uint, DXGI_FORMAT, uint, int>)(lpVtbl[13]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), BufferCount, Width, Height, NewFormat, SwapChainFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, HWND*, int>)(lpVtbl[20]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pHwnd);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint, uint, DXGI_PRESENT_PARAMETERS*, int>)(lpVtbl[22]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), SyncInterval, PresentFlags, pPresentParameters);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, int>)(lpVtbl[23]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, DXGI_RGBA*, int>)(lpVtbl[25]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pColor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, DXGI_RGBA*, int>)(lpVtbl[26]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pColor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, DXGI_MATRIX_3X2_F*, int>)(lpVtbl[34]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pMatrix);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, DXGI_MATRIX_3X2_F*, int>)(lpVtbl[35]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pMatrix);
    }
    ...
    /// <include file='IDXGISwapChain4.xml' path='doc/member[@name="IDXGISwapChain4.SetHDRMetaData"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(40)]
