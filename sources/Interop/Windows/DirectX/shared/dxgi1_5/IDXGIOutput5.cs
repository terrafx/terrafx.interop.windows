...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDXGIOutput5);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput5*, DXGI_FORMAT, uint, uint*, DXGI_MODE_DESC*, int>)(lpVtbl[8]))((IDXGIOutput5*)Unsafe.AsPointer(ref this), EnumFormat, Flags, pNumModes, pDesc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput5*, IUnknown*, BOOL, int>)(lpVtbl[11]))((IDXGIOutput5*)Unsafe.AsPointer(ref this), pDevice, Exclusive);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput5*, DXGI_FORMAT, uint, uint*, DXGI_MODE_DESC1*, int>)(lpVtbl[19]))((IDXGIOutput5*)Unsafe.AsPointer(ref this), EnumFormat, Flags, pNumModes, pDesc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput5*, int>)(lpVtbl[23]))((IDXGIOutput5*)Unsafe.AsPointer(ref this));
    }
