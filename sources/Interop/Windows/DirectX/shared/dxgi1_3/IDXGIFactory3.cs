...
/// <include file='IDXGIFactory3.xml' path='doc/member[@name="IDXGIFactory3"]/*' />
...
public unsafe partial struct IDXGIFactory3 : IDXGIFactory3.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, HWND, uint, int>)(lpVtbl[8]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), WindowHandle, Flags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, HWND*, int>)(lpVtbl[9]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), pWindowHandle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, IUnknown*, DXGI_SWAP_CHAIN_DESC*, IDXGISwapChain**, int>)(lpVtbl[10]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), pDevice, pDesc, ppSwapChain);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, HMODULE, IDXGIAdapter**, int>)(lpVtbl[11]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), Module, ppAdapter);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, int>)(lpVtbl[13]))((IDXGIFactory3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, int>)(lpVtbl[14]))((IDXGIFactory3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, IUnknown*, HWND, DXGI_SWAP_CHAIN_DESC1*, DXGI_SWAP_CHAIN_FULLSCREEN_DESC*, IDXGIOutput*, IDXGISwapChain1**, int>)(lpVtbl[15]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), pDevice, hWnd, pDesc, pFullscreenDesc, pRestrictToOutput, ppSwapChain);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, IUnknown*, IUnknown*, DXGI_SWAP_CHAIN_DESC1*, IDXGIOutput*, IDXGISwapChain1**, int>)(lpVtbl[16]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), pDevice, pWindow, pDesc, pRestrictToOutput, ppSwapChain);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, HWND, uint, uint*, int>)(lpVtbl[18]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, HWND, uint, uint*, int>)(lpVtbl[21]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIFactory3*, IUnknown*, DXGI_SWAP_CHAIN_DESC1*, IDXGIOutput*, IDXGISwapChain1**, int>)(lpVtbl[24]))((IDXGIFactory3*)Unsafe.AsPointer(ref this), pDevice, pDesc, pRestrictToOutput, ppSwapChain);
    }

    /// <include file='IDXGIFactory3.xml' path='doc/member[@name="IDXGIFactory3.GetCreationFlags"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(25)]
