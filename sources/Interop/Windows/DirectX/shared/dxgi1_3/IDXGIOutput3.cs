...
// Ported from shared/dxgi1_3.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDXGIOutput3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_OUTPUT_DESC*, int>)(lpVtbl[7]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_FORMAT, uint, uint*, DXGI_MODE_DESC*, int>)(lpVtbl[8]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), EnumFormat, Flags, pNumModes, pDesc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_MODE_DESC*, DXGI_MODE_DESC*, IUnknown*, int>)(lpVtbl[9]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pModeToMatch, pClosestMatch, pConcernedDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, IUnknown*, BOOL, int>)(lpVtbl[11]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pDevice, Exclusive);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_GAMMA_CONTROL_CAPABILITIES*, int>)(lpVtbl[13]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pGammaCaps);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_GAMMA_CONTROL*, int>)(lpVtbl[14]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pArray);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_GAMMA_CONTROL*, int>)(lpVtbl[15]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pArray);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_FRAME_STATISTICS*, int>)(lpVtbl[18]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pStats);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_FORMAT, uint, uint*, DXGI_MODE_DESC1*, int>)(lpVtbl[19]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), EnumFormat, Flags, pNumModes, pDesc);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_MODE_DESC1*, DXGI_MODE_DESC1*, IUnknown*, int>)(lpVtbl[20]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), pModeToMatch, pClosestMatch, pConcernedDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, int>)(lpVtbl[23]))((IDXGIOutput3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDXGIOutput3*, DXGI_FORMAT, IUnknown*, uint*, int>)(lpVtbl[24]))((IDXGIOutput3*)Unsafe.AsPointer(ref this), EnumFormat, pConcernedDevice, pFlags);
    }
