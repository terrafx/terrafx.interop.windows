...
public unsafe partial struct IDXGISwapChainMedia : IDXGISwapChainMedia.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGISwapChainMedia;
