...
public unsafe partial struct IDXGIFactoryMedia : IDXGIFactoryMedia.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGIFactoryMedia;
