...
public unsafe partial struct IDXGIDecodeSwapChain : IDXGIDecodeSwapChain.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGIDecodeSwapChain;
