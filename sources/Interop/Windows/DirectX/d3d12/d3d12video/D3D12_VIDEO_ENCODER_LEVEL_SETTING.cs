...
public unsafe partial struct D3D12_VIDEO_ENCODER_LEVEL_SETTING
{
    ...
    [NativeTypeName("__AnonymousRecord_d3d12video_L7079_C5")]
    ...
    /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pAV1LevelSetting"]/*' />
    [UnscopedRef]
    public ref D3D12_VIDEO_ENCODER_AV1_LEVEL_TIER_CONSTRAINTS* pAV1LevelSetting
    {
        ...
        get
        {
            return ref Anonymous.pAV1LevelSetting;
        }
    }
