...
public unsafe partial struct ID3D12VideoDevice : ID3D12VideoDevice.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12VideoDevice;
