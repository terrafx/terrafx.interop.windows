...
public unsafe partial struct ID3D12VideoProcessor : ID3D12VideoProcessor.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12VideoProcessor;
