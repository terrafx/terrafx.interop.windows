...
/// <include file='ID3D12VideoProcessCommandList2.xml' path='doc/member[@name="ID3D12VideoProcessCommandList2"]/*' />
...
public unsafe partial struct ID3D12VideoProcessCommandList2 : ID3D12VideoProcessCommandList2.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12VideoProcessCommandList2;
