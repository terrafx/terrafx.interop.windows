...
/// <include file='ID3D12VideoProcessCommandList1.xml' path='doc/member[@name="ID3D12VideoProcessCommandList1"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12VideoProcessCommandList1);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, uint>)(lpVtbl[1]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, uint>)(lpVtbl[2]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), guid, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, char*, int>)(lpVtbl[6]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, Guid*, void**, int>)(lpVtbl[7]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), riid, ppvDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, D3D12_COMMAND_LIST_TYPE>)(lpVtbl[8]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, int>)(lpVtbl[9]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, ID3D12CommandAllocator*, int>)(lpVtbl[10]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), pAllocator);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, void>)(lpVtbl[11]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, uint, D3D12_RESOURCE_BARRIER*, void>)(lpVtbl[12]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), NumBarriers, pBarriers);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, ID3D12Resource*, D3D12_DISCARD_REGION*, void>)(lpVtbl[13]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), pResource, pRegion);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, void>)(lpVtbl[14]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), pQueryHeap, Type, Index);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, void>)(lpVtbl[15]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), pQueryHeap, Type, Index);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, uint, ID3D12Resource*, ulong, void>)(lpVtbl[16]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), pQueryHeap, Type, StartIndex, NumQueries, pDestinationBuffer, AlignedDestinationBufferOffset);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, ID3D12Resource*, ulong, D3D12_PREDICATION_OP, void>)(lpVtbl[17]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), pBuffer, AlignedBufferOffset, Operation);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, uint, void*, uint, void>)(lpVtbl[18]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, uint, void*, uint, void>)(lpVtbl[19]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, void>)(lpVtbl[20]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, uint, D3D12_WRITEBUFFERIMMEDIATE_PARAMETER*, D3D12_WRITEBUFFERIMMEDIATE_MODE*, void>)(lpVtbl[22]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), Count, pParams, pModes);
    }

    /// <include file='ID3D12VideoProcessCommandList1.xml' path='doc/member[@name="ID3D12VideoProcessCommandList1.ProcessFrames1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(23)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12VideoProcessCommandList1*, ID3D12VideoProcessor*, D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS*, uint, D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS1*, void>)(lpVtbl[23]))((ID3D12VideoProcessCommandList1*)Unsafe.AsPointer(ref this), pVideoProcessor, pOutputArguments, NumInputStreams, pInputArguments);
    }
