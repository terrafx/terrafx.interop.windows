...
public unsafe partial struct ID3D12VideoDevice1 : ID3D12VideoDevice1.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12VideoDevice1;
