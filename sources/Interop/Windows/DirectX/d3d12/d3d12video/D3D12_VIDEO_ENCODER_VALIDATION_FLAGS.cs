...
public enum D3D12_VIDEO_ENCODER_VALIDATION_FLAGS
{
    ...
    /// <include file='D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.xml' path='doc/member[@name="D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.D3D12_VIDEO_ENCODER_VALIDATION_FLAG_QPMAP_NOT_SUPPORTED"]/*' />
    D3D12_VIDEO_ENCODER_VALIDATION_FLAG_QPMAP_NOT_SUPPORTED = 0x2000,

    /// <include file='D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.xml' path='doc/member[@name="D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.D3D12_VIDEO_ENCODER_VALIDATION_FLAG_DIRTY_REGIONS_NOT_SUPPORTED"]/*' />
    D3D12_VIDEO_ENCODER_VALIDATION_FLAG_DIRTY_REGIONS_NOT_SUPPORTED = 0x4000,

    /// <include file='D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.xml' path='doc/member[@name="D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.D3D12_VIDEO_ENCODER_VALIDATION_FLAG_MOTION_SEARCH_NOT_SUPPORTED"]/*' />
    D3D12_VIDEO_ENCODER_VALIDATION_FLAG_MOTION_SEARCH_NOT_SUPPORTED = 0x8000,

    /// <include file='D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.xml' path='doc/member[@name="D3D12_VIDEO_ENCODER_VALIDATION_FLAGS.D3D12_VIDEO_ENCODER_VALIDATION_FLAG_FRAME_ANALYSIS_NOT_SUPPORTED"]/*' />
