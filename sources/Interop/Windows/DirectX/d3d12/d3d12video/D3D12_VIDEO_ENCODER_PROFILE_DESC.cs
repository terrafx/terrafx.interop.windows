...
public unsafe partial struct D3D12_VIDEO_ENCODER_PROFILE_DESC
{
    ...
    [NativeTypeName("__AnonymousRecord_d3d12video_L6967_C5")]
    ...
    /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pAV1Profile"]/*' />
    [UnscopedRef]
    public ref D3D12_VIDEO_ENCODER_AV1_PROFILE* pAV1Profile
    {
        ...
        get
        {
            return ref Anonymous.pAV1Profile;
        }
    }
