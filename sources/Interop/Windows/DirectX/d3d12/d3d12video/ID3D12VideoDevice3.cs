...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12VideoDevice3));
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, uint>)(lpVtbl[1]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, uint>)(lpVtbl[2]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_FEATURE_VIDEO, void*, uint, int>)(lpVtbl[3]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), FeatureVideo, pFeatureSupportData, FeatureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_DECODER_DESC*, Guid*, void**, int>)(lpVtbl[4]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoDecoder);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_DECODER_HEAP_DESC*, Guid*, void**, int>)(lpVtbl[5]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pVideoDecoderHeapDesc, riid, ppVideoDecoderHeap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, uint, D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC*, uint, D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC*, Guid*, void**, int>)(lpVtbl[6]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), NodeMask, pOutputStreamDesc, NumInputStreamDescs, pInputStreamDescs, riid, ppVideoProcessor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_MOTION_ESTIMATOR_DESC*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[7]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, pProtectedResourceSession, riid, ppVideoMotionEstimator);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[8]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, pProtectedResourceSession, riid, ppVideoMotionVectorHeap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_DECODER_DESC*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[9]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, pProtectedResourceSession, riid, ppVideoDecoder);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_DECODER_HEAP_DESC*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[10]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pVideoDecoderHeapDesc, pProtectedResourceSession, riid, ppVideoDecoderHeap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, uint, D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC*, uint, D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[11]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), NodeMask, pOutputStreamDesc, NumInputStreamDescs, pInputStreamDescs, pProtectedResourceSession, riid, ppVideoProcessor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, ID3D12VideoExtensionCommand*, void*, nuint, void*, nuint, int>)(lpVtbl[13]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pExtensionCommand, pExecutionParameters, ExecutionParametersSizeInBytes, pOutputData, OutputDataSizeInBytes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_ENCODER_DESC*, Guid*, void**, int>)(lpVtbl[14]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoEncoder);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoDevice3*, D3D12_VIDEO_ENCODER_HEAP_DESC*, Guid*, void**, int>)(lpVtbl[15]))((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoEncoderHeap);
    }

    public interface Interface : ID3D12VideoDevice2.Interface
    {
        [VtblIndex(14)]
        HRESULT CreateVideoEncoder([NativeTypeName("const D3D12_VIDEO_ENCODER_DESC *")] D3D12_VIDEO_ENCODER_DESC* pDesc, [NativeTypeName("const IID &")] Guid* riid, void** ppVideoEncoder);

        [VtblIndex(15)]
        HRESULT CreateVideoEncoderHeap([NativeTypeName("const D3D12_VIDEO_ENCODER_HEAP_DESC *")] D3D12_VIDEO_ENCODER_HEAP_DESC* pDesc, [NativeTypeName("const IID &")] Guid* riid, void** ppVideoEncoderHeap);
    }
