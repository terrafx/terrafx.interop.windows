...
public unsafe partial struct ID3D12VideoEncoder : ID3D12VideoEncoder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12VideoEncoder;
