...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12VideoEncoder);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, uint>)(lpVtbl[1]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, uint>)(lpVtbl[2]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), guid, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, char*, int>)(lpVtbl[6]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, Guid*, void**, int>)(lpVtbl[7]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), riid, ppvDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, uint>)(lpVtbl[8]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, D3D12_VIDEO_ENCODER_FLAGS>)(lpVtbl[9]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, D3D12_VIDEO_ENCODER_CODEC>)(lpVtbl[10]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, D3D12_VIDEO_ENCODER_PROFILE_DESC, int>)(lpVtbl[11]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), dstProfile);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION, int>)(lpVtbl[12]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), dstCodecConfig);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, DXGI_FORMAT>)(lpVtbl[13]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12VideoEncoder*, D3D12_VIDEO_ENCODER_MOTION_ESTIMATION_PRECISION_MODE>)(lpVtbl[14]))((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this));
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_VIDEO_ENCODER_FLAGS> GetEncoderFlags;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION, int> GetCodecConfiguration;

        [NativeTypeName("DXGI_FORMAT () __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, DXGI_FORMAT> GetInputFormat;

        [NativeTypeName("D3D12_VIDEO_ENCODER_MOTION_ESTIMATION_PRECISION_MODE () __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_VIDEO_ENCODER_MOTION_ESTIMATION_PRECISION_MODE> GetMaxMotionEstimationPrecision;
    }
}
