...
public unsafe partial struct ID3D12VideoDecodeCommandList3 : ID3D12VideoDecodeCommandList3.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12VideoDecodeCommandList3;
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, uint>)(lpVtbl[1]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, uint>)(lpVtbl[2]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), guid, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ushort*, int>)(lpVtbl[6]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, Guid*, void**, int>)(lpVtbl[7]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), riid, ppvDevice);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, D3D12_COMMAND_LIST_TYPE>)(lpVtbl[8]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, int>)(lpVtbl[9]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12CommandAllocator*, int>)(lpVtbl[10]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pAllocator);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, void>)(lpVtbl[11]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, uint, D3D12_RESOURCE_BARRIER*, void>)(lpVtbl[12]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), NumBarriers, pBarriers);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12Resource*, D3D12_DISCARD_REGION*, void>)(lpVtbl[13]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pResource, pRegion);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, void>)(lpVtbl[14]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pQueryHeap, Type, Index);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, void>)(lpVtbl[15]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pQueryHeap, Type, Index);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, uint, ID3D12Resource*, ulong, void>)(lpVtbl[16]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pQueryHeap, Type, StartIndex, NumQueries, pDestinationBuffer, AlignedDestinationBufferOffset);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12Resource*, ulong, D3D12_PREDICATION_OP, void>)(lpVtbl[17]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pBuffer, AlignedBufferOffset, Operation);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, uint, void*, uint, void>)(lpVtbl[18]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, uint, void*, uint, void>)(lpVtbl[19]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, void>)(lpVtbl[20]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12VideoDecoder*, D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS*, D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS*, void>)(lpVtbl[21]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pDecoder, pOutputArguments, pInputArguments);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, uint, D3D12_WRITEBUFFERIMMEDIATE_PARAMETER*, D3D12_WRITEBUFFERIMMEDIATE_MODE*, void>)(lpVtbl[22]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), Count, pParams, pModes);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12VideoDecoder*, D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS1*, D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS*, void>)(lpVtbl[23]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pDecoder, pOutputArguments, pInputArguments);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12ProtectedResourceSession*, void>)(lpVtbl[24]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pProtectedResourceSession);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12VideoExtensionCommand*, void*, nuint, void>)(lpVtbl[25]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pExtensionCommand, pInitializationParameters, InitializationParametersSizeInBytes);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, ID3D12VideoExtensionCommand*, void*, nuint, void>)(lpVtbl[26]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), pExtensionCommand, pExecutionParameters, ExecutionParametersSizeInBytes);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12VideoDecodeCommandList3*, uint, D3D12_BARRIER_GROUP*, void>)(lpVtbl[27]))((ID3D12VideoDecodeCommandList3*)Unsafe.AsPointer(ref this), NumBarrierGroups, pBarrierGroups);
    }
