...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDMLOperator);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, Guid*, void**, int>)(lpVtbl[0]))((IDMLOperator*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, uint>)(lpVtbl[1]))((IDMLOperator*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, uint>)(lpVtbl[2]))((IDMLOperator*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, Guid*, uint*, void*, int>)(lpVtbl[3]))((IDMLOperator*)Unsafe.AsPointer(ref this), guid, dataSize, data);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, Guid*, uint, void*, int>)(lpVtbl[4]))((IDMLOperator*)Unsafe.AsPointer(ref this), guid, dataSize, data);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, Guid*, IUnknown*, int>)(lpVtbl[5]))((IDMLOperator*)Unsafe.AsPointer(ref this), guid, data);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, char*, int>)(lpVtbl[6]))((IDMLOperator*)Unsafe.AsPointer(ref this), name);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDMLOperator*, Guid*, void**, int>)(lpVtbl[7]))((IDMLOperator*)Unsafe.AsPointer(ref this), riid, ppv);
    }
