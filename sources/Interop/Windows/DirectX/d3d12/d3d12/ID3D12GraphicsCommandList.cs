...
public unsafe partial struct ID3D12GraphicsCommandList : ID3D12GraphicsCommandList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12GraphicsCommandList;
