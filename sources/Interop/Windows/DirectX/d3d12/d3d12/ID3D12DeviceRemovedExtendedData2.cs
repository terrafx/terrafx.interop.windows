...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12DeviceRemovedExtendedData2);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_DRED_PAGE_FAULT_OUTPUT2*, int> GetPageFaultAllocationOutput2;

        [NativeTypeName("D3D12_DRED_DEVICE_STATE () __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_DRED_DEVICE_STATE> GetDeviceState;
    }
}
