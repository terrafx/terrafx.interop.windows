...
public unsafe partial struct ID3D12MetaCommand : ID3D12MetaCommand.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12MetaCommand;
