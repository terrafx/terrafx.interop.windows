...
/// <include file='ID3D12Device4.xml' path='doc/member[@name="ID3D12Device4"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12Device4);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_COMMAND_QUEUE_DESC*, Guid*, void**, int>)(lpVtbl[8]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, riid, ppCommandQueue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_COMMAND_LIST_TYPE, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device4*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_GRAPHICS_PIPELINE_STATE_DESC*, Guid*, void**, int>)(lpVtbl[10]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_COMPUTE_PIPELINE_STATE_DESC*, Guid*, void**, int>)(lpVtbl[11]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, D3D12_COMMAND_LIST_TYPE, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device4*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_FEATURE, void*, uint, int>)(lpVtbl[13]))((ID3D12Device4*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_DESCRIPTOR_HEAP_DESC*, Guid*, void**, int>)(lpVtbl[14]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDescriptorHeapDesc, riid, ppvHeap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_DESCRIPTOR_HEAP_TYPE, uint>)(lpVtbl[15]))((ID3D12Device4*)Unsafe.AsPointer(ref this), DescriptorHeapType);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_CONSTANT_BUFFER_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[17]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12Resource*, D3D12_SHADER_RESOURCE_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[18]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12Resource*, ID3D12Resource*, D3D12_UNORDERED_ACCESS_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[19]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pResource, pCounterResource, pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12Resource*, D3D12_RENDER_TARGET_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[20]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12Resource*, D3D12_DEPTH_STENCIL_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[21]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_SAMPLER_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[22]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, D3D12_CPU_DESCRIPTOR_HANDLE*, uint*, uint, D3D12_CPU_DESCRIPTOR_HANDLE*, uint*, D3D12_DESCRIPTOR_HEAP_TYPE, void>)(lpVtbl[23]))((ID3D12Device4*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_DESCRIPTOR_HEAP_TYPE, void>)(lpVtbl[24]))((ID3D12Device4*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, uint, D3D12_RESOURCE_DESC*, D3D12_RESOURCE_ALLOCATION_INFO>)(lpVtbl[25]))((ID3D12Device4*)Unsafe.AsPointer(ref this), visibleMask, numResourceDescs, pResourceDescs);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, D3D12_HEAP_TYPE, D3D12_HEAP_PROPERTIES>)(lpVtbl[26]))((ID3D12Device4*)Unsafe.AsPointer(ref this), nodeMask, heapType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_HEAP_DESC*, Guid*, void**, int>)(lpVtbl[28]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12Heap*, ulong, D3D12_RESOURCE_DESC*, D3D12_RESOURCE_STATES, D3D12_CLEAR_VALUE*, Guid*, void**, int>)(lpVtbl[29]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_RESOURCE_DESC*, D3D12_RESOURCE_STATES, D3D12_CLEAR_VALUE*, Guid*, void**, int>)(lpVtbl[30]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, char*, HANDLE*, int>)(lpVtbl[31]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ulong, D3D12_FENCE_FLAGS, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device4*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_RESOURCE_DESC*, uint, uint, ulong, D3D12_PLACED_SUBRESOURCE_FOOTPRINT*, uint*, ulong*, ulong*, void>)(lpVtbl[38]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_QUERY_HEAP_DESC*, Guid*, void**, int>)(lpVtbl[39]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, BOOL, int>)(lpVtbl[40]))((ID3D12Device4*)Unsafe.AsPointer(ref this), Enable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_COMMAND_SIGNATURE_DESC*, ID3D12RootSignature*, Guid*, void**, int>)(lpVtbl[41]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, pRootSignature, riid, ppvCommandSignature);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12Resource*, uint*, D3D12_PACKED_MIP_INFO*, D3D12_TILE_SHAPE*, uint*, uint, D3D12_SUBRESOURCE_TILING*, void>)(lpVtbl[42]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pTiledResource, pNumTilesForEntireResource, pPackedMipDesc, pStandardTileShapeForNonPackedMips, pNumSubresourceTilings, FirstSubresourceTilingToGet, pSubresourceTilingsForNonPackedMips);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, LUID>)(lpVtbl[43]))((ID3D12Device4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, ID3D12Fence**, ulong*, uint, D3D12_MULTIPLE_FENCE_WAIT_FLAGS, HANDLE, int>)(lpVtbl[45]))((ID3D12Device4*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, ID3D12Pageable**, D3D12_RESIDENCY_PRIORITY*, int>)(lpVtbl[46]))((ID3D12Device4*)Unsafe.AsPointer(ref this), NumObjects, ppObjects, pPriorities);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_PIPELINE_STATE_STREAM_DESC*, Guid*, void**, int>)(lpVtbl[47]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_RESIDENCY_FLAGS, uint, ID3D12Pageable**, ID3D12Fence*, ulong, int>)(lpVtbl[50]))((ID3D12Device4*)Unsafe.AsPointer(ref this), Flags, NumObjects, ppObjects, pFenceToSignal, FenceValueToSignal);
    }

    /// <include file='ID3D12Device4.xml' path='doc/member[@name="ID3D12Device4.CreateCommandList1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(51)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, D3D12_COMMAND_LIST_TYPE, D3D12_COMMAND_LIST_FLAGS, Guid*, void**, int>)(lpVtbl[51]))((ID3D12Device4*)Unsafe.AsPointer(ref this), nodeMask, type, flags, riid, ppCommandList);
    }

    /// <include file='ID3D12Device4.xml' path='doc/member[@name="ID3D12Device4.CreateProtectedResourceSession"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(52)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_PROTECTED_RESOURCE_SESSION_DESC*, Guid*, void**, int>)(lpVtbl[52]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, riid, ppSession);
    }

    /// <include file='ID3D12Device4.xml' path='doc/member[@name="ID3D12Device4.CreateCommittedResource1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(53)]
    ...
    /// <include file='ID3D12Device4.xml' path='doc/member[@name="ID3D12Device4.CreateHeap1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(54)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_HEAP_DESC*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[54]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, pProtectedSession, riid, ppvHeap);
    }

    /// <include file='ID3D12Device4.xml' path='doc/member[@name="ID3D12Device4.CreateReservedResource1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(55)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, D3D12_RESOURCE_DESC*, D3D12_RESOURCE_STATES, D3D12_CLEAR_VALUE*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[55]))((ID3D12Device4*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, pProtectedSession, riid, ppvResource);
    }

    /// <include file='ID3D12Device4.xml' path='doc/member[@name="ID3D12Device4.GetResourceAllocationInfo1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(56)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device4*, uint, uint, D3D12_RESOURCE_DESC*, D3D12_RESOURCE_ALLOCATION_INFO1*, D3D12_RESOURCE_ALLOCATION_INFO>)(lpVtbl[56]))((ID3D12Device4*)Unsafe.AsPointer(ref this), visibleMask, numResourceDescs, pResourceDescs, pResourceAllocationInfo1);
    }
