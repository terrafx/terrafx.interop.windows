...
public unsafe partial struct ID3D12RootSignature : ID3D12RootSignature.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12RootSignature;
