...
public unsafe partial struct ID3D12PipelineLibrary : ID3D12PipelineLibrary.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12PipelineLibrary;
