...
public unsafe partial struct ID3D12SDKConfiguration : ID3D12SDKConfiguration.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12SDKConfiguration;
