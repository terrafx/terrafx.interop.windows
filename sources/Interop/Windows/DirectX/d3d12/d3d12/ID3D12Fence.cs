...
/// <include file='ID3D12Fence.xml' path='doc/member[@name="ID3D12Fence"]/*' />
[Guid("0A753DCF-C4D8-4B91-ADF6-BE5A60D95A76")]
[NativeTypeName("struct ID3D12Fence : ID3D12Pageable")]
[NativeInheritance("ID3D12Pageable")]
public unsafe partial struct ID3D12Fence : ID3D12Fence.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12Fence;
    ...
    /// <include file='ID3D12Fence.xml' path='doc/member[@name="ID3D12Fence.GetCompletedValue"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(8)]
    ...
    /// <include file='ID3D12Fence.xml' path='doc/member[@name="ID3D12Fence.SetEventOnCompletion"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(9)]
    ...
    /// <include file='ID3D12Fence.xml' path='doc/member[@name="ID3D12Fence.Signal"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(10)]
