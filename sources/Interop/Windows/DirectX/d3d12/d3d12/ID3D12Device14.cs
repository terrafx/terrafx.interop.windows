...
/// <include file='ID3D12Device14.xml' path='doc/member[@name="ID3D12Device14"]/*' />
...
public unsafe partial struct ID3D12Device14 : ID3D12Device14.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, D3D12_COMMAND_LIST_TYPE, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device14*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, D3D12_COMMAND_LIST_TYPE, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device14*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, D3D12_FEATURE, void*, uint, int>)(lpVtbl[13]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, D3D12_DESCRIPTOR_HEAP_TYPE, uint>)(lpVtbl[15]))((ID3D12Device14*)Unsafe.AsPointer(ref this), DescriptorHeapType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, char*, HANDLE*, int>)(lpVtbl[31]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ulong, D3D12_FENCE_FLAGS, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device14*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, BOOL, int>)(lpVtbl[40]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Enable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12Fence**, ulong*, uint, D3D12_MULTIPLE_FENCE_WAIT_FLAGS, HANDLE, int>)(lpVtbl[45]))((ID3D12Device14*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, ID3D12Pageable**, D3D12_RESIDENCY_PRIORITY*, int>)(lpVtbl[46]))((ID3D12Device14*)Unsafe.AsPointer(ref this), NumObjects, ppObjects, pPriorities);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, D3D12_RESIDENCY_FLAGS, uint, ID3D12Pageable**, ID3D12Fence*, ulong, int>)(lpVtbl[50]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Flags, NumObjects, ppObjects, pFenceToSignal, FenceValueToSignal);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, D3D12_COMMAND_LIST_TYPE, D3D12_COMMAND_LIST_FLAGS, Guid*, void**, int>)(lpVtbl[51]))((ID3D12Device14*)Unsafe.AsPointer(ref this), nodeMask, type, flags, riid, ppCommandList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, D3D12_BACKGROUND_PROCESSING_MODE, D3D12_MEASUREMENTS_ACTION, HANDLE, BOOL*, int>)(lpVtbl[65]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, D3D12_SHADER_CACHE_KIND_FLAGS, D3D12_SHADER_CACHE_CONTROL_FLAGS, int>)(lpVtbl[74]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Kinds, Control);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, D3D12_RESOURCE_DESC*, D3D12_BARRIER_LAYOUT, D3D12_CLEAR_VALUE*, ID3D12ProtectedResourceSession*, uint, DXGI_FORMAT*, Guid*, void**, int>)(lpVtbl[78]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pDesc, InitialLayout, pOptimizedClearValue, pProtectedSession, NumCastableFormats, pCastableFormats, riid, ppvResource);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, uint, D3D12_RESOURCE_DESC1*, uint*, DXGI_FORMAT**, D3D12_RESOURCE_ALLOCATION_INFO1*, D3D12_RESOURCE_ALLOCATION_INFO>)(lpVtbl[80]))((ID3D12Device14*)Unsafe.AsPointer(ref this), visibleMask, numResourceDescs, pResourceDescs, pNumCastableFormats, ppCastableFormats, pResourceAllocationInfo1);
    }
    ...
    /// <include file='ID3D12Device14.xml' path='doc/member[@name="ID3D12Device14.CreateRootSignatureFromSubobjectInLibrary"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(82)]
    ...
    {
        [VtblIndex(82)]
        HRESULT CreateRootSignatureFromSubobjectInLibrary(uint nodeMask, [NativeTypeName("const void *")] void* pLibraryBlob, [NativeTypeName("SIZE_T")] nuint blobLengthInBytes, [NativeTypeName("LPCWSTR")] char* subobjectName, [NativeTypeName("const IID &")] Guid* riid, void** ppvRootSignature);
    }
