...
public unsafe partial struct ID3D12PipelineState : ID3D12PipelineState.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12PipelineState;
