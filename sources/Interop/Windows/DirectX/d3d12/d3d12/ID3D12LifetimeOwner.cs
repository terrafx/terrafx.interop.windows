...
public unsafe partial struct ID3D12LifetimeOwner : ID3D12LifetimeOwner.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12LifetimeOwner;
