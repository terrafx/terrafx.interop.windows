...
public unsafe partial struct ID3D12Resource : ID3D12Resource.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12Resource;
