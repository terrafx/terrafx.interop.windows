...
public unsafe partial struct ID3D12CommandQueue : ID3D12CommandQueue.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12CommandQueue;
