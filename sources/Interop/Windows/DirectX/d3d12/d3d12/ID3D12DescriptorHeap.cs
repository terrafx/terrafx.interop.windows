...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12DescriptorHeap);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_DESCRIPTOR_HEAP_DESC> GetDesc;

        [NativeTypeName("D3D12_CPU_DESCRIPTOR_HANDLE () __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_CPU_DESCRIPTOR_HANDLE> GetCPUDescriptorHandleForHeapStart;

        [NativeTypeName("D3D12_GPU_DESCRIPTOR_HANDLE () __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_GPU_DESCRIPTOR_HANDLE> GetGPUDescriptorHandleForHeapStart;
    }
}
