...
public unsafe partial struct ID3D12ProtectedSession : ID3D12ProtectedSession.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12ProtectedSession;
