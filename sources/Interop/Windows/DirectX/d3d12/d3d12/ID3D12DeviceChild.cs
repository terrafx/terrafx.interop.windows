...
/// <include file='ID3D12DeviceChild.xml' path='doc/member[@name="ID3D12DeviceChild"]/*' />
...
public unsafe partial struct ID3D12DeviceChild : ID3D12DeviceChild.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12DeviceChild;
    ...
    /// <include file='ID3D12DeviceChild.xml' path='doc/member[@name="ID3D12DeviceChild.GetDevice"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
