...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12Resource1);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Resource1*, uint, D3D12_RANGE*, void**, int>)(lpVtbl[8]))((ID3D12Resource1*)Unsafe.AsPointer(ref this), Subresource, pReadRange, ppData);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Resource1*, uint, D3D12_RANGE*, void>)(lpVtbl[9]))((ID3D12Resource1*)Unsafe.AsPointer(ref this), Subresource, pWrittenRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Resource1*, D3D12_RESOURCE_DESC>)(lpVtbl[10]))((ID3D12Resource1*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Resource1*, uint, D3D12_BOX*, void*, uint, uint, int>)(lpVtbl[12]))((ID3D12Resource1*)Unsafe.AsPointer(ref this), DstSubresource, pDstBox, pSrcData, SrcRowPitch, SrcDepthPitch);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Resource1*, void*, uint, uint, uint, D3D12_BOX*, int>)(lpVtbl[13]))((ID3D12Resource1*)Unsafe.AsPointer(ref this), pDstData, DstRowPitch, DstDepthPitch, SrcSubresource, pSrcBox);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Resource1*, D3D12_HEAP_PROPERTIES*, D3D12_HEAP_FLAGS*, int>)(lpVtbl[14]))((ID3D12Resource1*)Unsafe.AsPointer(ref this), pHeapProperties, pHeapFlags);
    }
