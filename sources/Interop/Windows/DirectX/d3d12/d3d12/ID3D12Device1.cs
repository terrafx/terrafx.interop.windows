...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12Device1);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, D3D12_COMMAND_LIST_TYPE, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device1*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, D3D12_COMMAND_LIST_TYPE, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device1*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, D3D12_FEATURE, void*, uint, int>)(lpVtbl[13]))((ID3D12Device1*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, D3D12_DESCRIPTOR_HEAP_TYPE, uint>)(lpVtbl[15]))((ID3D12Device1*)Unsafe.AsPointer(ref this), DescriptorHeapType);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, char*, HANDLE*, int>)(lpVtbl[31]))((ID3D12Device1*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, ulong, D3D12_FENCE_FLAGS, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device1*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, BOOL, int>)(lpVtbl[40]))((ID3D12Device1*)Unsafe.AsPointer(ref this), Enable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, ID3D12Fence**, ulong*, uint, D3D12_MULTIPLE_FENCE_WAIT_FLAGS, HANDLE, int>)(lpVtbl[45]))((ID3D12Device1*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, ID3D12Pageable**, D3D12_RESIDENCY_PRIORITY*, int>)(lpVtbl[46]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NumObjects, ppObjects, pPriorities);
    }
