...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12Device);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device*, ID3D12Resource*, D3D12_RENDER_TARGET_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[20]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device*, ID3D12Resource*, D3D12_DEPTH_STENCIL_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[21]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Device*, D3D12_SAMPLER_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[22]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, BOOL, int>)(lpVtbl[40]))((ID3D12Device*)Unsafe.AsPointer(ref this), Enable);
    }
    ...
    public interface Interface : ID3D12Object.Interface
    {
        ...
        [VtblIndex(31)]
        HRESULT CreateSharedHandle(ID3D12DeviceChild* pObject, [NativeTypeName("const SECURITY_ATTRIBUTES *")] SECURITY_ATTRIBUTES* pAttributes, [NativeTypeName("DWORD")] uint Access, [NativeTypeName("LPCWSTR")] char* Name, HANDLE* pHandle);

        [VtblIndex(32)]
        HRESULT OpenSharedHandle(HANDLE NTHandle, [NativeTypeName("const IID &")] Guid* riid, void** ppvObj);

        [VtblIndex(33)]
        HRESULT OpenSharedHandleByName([NativeTypeName("LPCWSTR")] char* Name, [NativeTypeName("DWORD")] uint Access, HANDLE* pNTHandle);
