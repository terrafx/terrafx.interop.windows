...
public unsafe partial struct ID3D12Device10 : ID3D12Device10.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12Device10;
    ...
    {
        return ((delegate* unmanaged<ID3D12Device10*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, ushort*, HANDLE*, int>)(lpVtbl[31]))((ID3D12Device10*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
    }
