...
/// <include file='ID3D12CommandList.xml' path='doc/member[@name="ID3D12CommandList"]/*' />
...
public unsafe partial struct ID3D12CommandList : ID3D12CommandList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12CommandList;
    ...
    /// <include file='ID3D12CommandList.xml' path='doc/member[@name="ID3D12CommandList.GetType"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(8)]
