...
public unsafe partial struct ID3D12DebugDevice : ID3D12DebugDevice.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12DebugDevice;
