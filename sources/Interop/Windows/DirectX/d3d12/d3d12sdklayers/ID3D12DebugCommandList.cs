...
public unsafe partial struct ID3D12DebugCommandList : ID3D12DebugCommandList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12DebugCommandList;
