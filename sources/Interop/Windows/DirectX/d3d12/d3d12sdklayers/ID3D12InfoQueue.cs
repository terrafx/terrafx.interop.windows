...
public unsafe partial struct ID3D12InfoQueue : ID3D12InfoQueue.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12InfoQueue;
