...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12Debug3);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Debug3*, BOOL, void>)(lpVtbl[4]))((ID3D12Debug3*)Unsafe.AsPointer(ref this), Enable);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Debug3*, BOOL, void>)(lpVtbl[5]))((ID3D12Debug3*)Unsafe.AsPointer(ref this), Enable);
    }
