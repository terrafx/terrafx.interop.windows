...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12Debug4);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Debug4*, BOOL, void>)(lpVtbl[4]))((ID3D12Debug4*)Unsafe.AsPointer(ref this), Enable);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Debug4*, BOOL, void>)(lpVtbl[5]))((ID3D12Debug4*)Unsafe.AsPointer(ref this), Enable);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D12Debug4*, D3D12_GPU_BASED_VALIDATION_FLAGS, void>)(lpVtbl[6]))((ID3D12Debug4*)Unsafe.AsPointer(ref this), Flags);
    }
