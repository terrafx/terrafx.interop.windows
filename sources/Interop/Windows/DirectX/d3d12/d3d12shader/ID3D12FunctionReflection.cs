...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D12FunctionReflection);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D12FunctionReflection*, sbyte*, D3D12_SHADER_INPUT_BIND_DESC*, int>)(lpVtbl[5]))((ID3D12FunctionReflection*)Unsafe.AsPointer(ref this), Name, pDesc);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D12_FUNCTION_DESC*, int> GetDesc;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, int, ID3D12FunctionParameterReflection*> GetFunctionParameter;
    }
}
