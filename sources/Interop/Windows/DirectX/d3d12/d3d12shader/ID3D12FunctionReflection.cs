...
public unsafe partial struct ID3D12FunctionReflection : ID3D12FunctionReflection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12FunctionReflection;
