...
public unsafe partial struct ID3D12DeviceDownlevel : ID3D12DeviceDownlevel.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D12DeviceDownlevel;
