...
public unsafe partial struct D3D12_HEAP_DESC
{
    ...
    public D3D12_HEAP_DESC([NativeTypeName("const D3D12_RESOURCE_ALLOCATION_INFO &")] D3D12_RESOURCE_ALLOCATION_INFO* resAllocInfo, D3D12_HEAP_PROPERTIES properties, D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE)
    {
    ...
    public D3D12_HEAP_DESC([NativeTypeName("const D3D12_RESOURCE_ALLOCATION_INFO &")] D3D12_RESOURCE_ALLOCATION_INFO* resAllocInfo, D3D12_HEAP_TYPE type, D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE)
    {
        SizeInBytes = resAllocInfo->SizeInBytes;
        Properties = new D3D12_HEAP_PROPERTIES(type);
        Alignment = resAllocInfo->Alignment;
    ...
    public D3D12_HEAP_DESC([NativeTypeName("const D3D12_RESOURCE_ALLOCATION_INFO &")] D3D12_RESOURCE_ALLOCATION_INFO* resAllocInfo, D3D12_CPU_PAGE_PROPERTY cpuPageProperty, D3D12_MEMORY_POOL memoryPoolPreference, D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE)
    {
        SizeInBytes = resAllocInfo->SizeInBytes;
        Properties = new D3D12_HEAP_PROPERTIES(cpuPageProperty, memoryPoolPreference);
        Alignment = resAllocInfo->Alignment;
