...
using static TerraFX.Interop.DirectX.D3D12_LINE_RASTERIZATION_MODE;
...
{
    public D3D12_RASTERIZER_DESC2([NativeTypeName("const D3D12_RASTERIZER_DESC1 &")] D3D12_RASTERIZER_DESC1* o)
    {
        FillMode = o->FillMode;
        CullMode = o->CullMode;
