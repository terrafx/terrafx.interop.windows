...
public unsafe partial struct ID3DX12PipelineParserCallbacks : ID3DX12PipelineParserCallbacks.Interface
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, D3D12_RT_FORMAT_ARRAY*, void>)(lpVtbl[21]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, DXGI_SAMPLE_DESC*, void>)(lpVtbl[22]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, uint, void>)(lpVtbl[23]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, D3D12_VIEW_INSTANCING_DESC*, void>)(lpVtbl[24]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, D3D12_CACHED_PIPELINE_STATE*, void>)(lpVtbl[25]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, uint, void>)(lpVtbl[26]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, void>)(lpVtbl[27]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    public void Dispose()
    {
        ((delegate* unmanaged[MemberFunction]<ID3DX12PipelineParserCallbacks*, void>)(lpVtbl[29]))((ID3DX12PipelineParserCallbacks*)Unsafe.AsPointer(ref this));
    }
