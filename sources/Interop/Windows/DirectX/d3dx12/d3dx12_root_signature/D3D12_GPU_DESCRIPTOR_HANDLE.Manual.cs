...
// Ported from d3dx12_root_signature.h in microsoft/DirectX-Headers tag v1.619.2
...
public unsafe partial struct D3D12_GPU_DESCRIPTOR_HANDLE : IEquatable<D3D12_GPU_DESCRIPTOR_HANDLE>
{
    ...
    public static bool operator ==(D3D12_GPU_DESCRIPTOR_HANDLE left, D3D12_GPU_DESCRIPTOR_HANDLE right)
        => left.ptr == right.ptr;

    public static bool operator !=(D3D12_GPU_DESCRIPTOR_HANDLE left, D3D12_GPU_DESCRIPTOR_HANDLE right)
        => left.ptr != right.ptr;

    public override readonly bool Equals([NotNullWhen(true)] object? obj) => (obj is D3D12_GPU_DESCRIPTOR_HANDLE other) && Equals(other);
    ...
    public static void InitOffsetted([NativeTypeName("D3D12_GPU_DESCRIPTOR_HANDLE &")] ref D3D12_GPU_DESCRIPTOR_HANDLE handle, [NativeTypeName("const D3D12_GPU_DESCRIPTOR_HANDLE &")] in D3D12_GPU_DESCRIPTOR_HANDLE @base, int offsetScaledByIncrementSize)
    {
        handle.ptr = unchecked((ulong)((long)(@base.ptr) + (long)(offsetScaledByIncrementSize)));
    }

    public static void InitOffsetted([NativeTypeName("D3D12_GPU_DESCRIPTOR_HANDLE &")] ref D3D12_GPU_DESCRIPTOR_HANDLE handle, [NativeTypeName("const D3D12_GPU_DESCRIPTOR_HANDLE &")] in D3D12_GPU_DESCRIPTOR_HANDLE @base, int offsetInDescriptors, uint descriptorIncrementSize)
    {
    ...
    public ref D3D12_GPU_DESCRIPTOR_HANDLE Offset(int offsetInDescriptors, uint descriptorIncrementSize)
    {
    ...
    [UnscopedRef]
    [return: NativeTypeName("CD3DX12_GPU_DESCRIPTOR_HANDLE &")]
    public ref D3D12_GPU_DESCRIPTOR_HANDLE Offset(int offsetScaledByIncrementSize)
    {
