...
public struct CD3DX12_PIPELINE_STATE_STREAM_GS
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_GS([NativeTypeName("D3D12_SHADER_BYTECODE const &")] in D3D12_SHADER_BYTECODE i)
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_GS;
        pssInner = i;
    }

    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_GS(in D3D12_SHADER_BYTECODE value) => new CD3DX12_PIPELINE_STATE_STREAM_GS(value);

    public static implicit operator D3D12_SHADER_BYTECODE(in CD3DX12_PIPELINE_STATE_STREAM_GS value) => value.pssInner;
