...
public unsafe struct CD3DX12_PIPELINE_STATE_STREAM
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM([NativeTypeName("const D3D12_GRAPHICS_PIPELINE_STATE_DESC &")] in D3D12_GRAPHICS_PIPELINE_STATE_DESC Desc)
    {
        Flags = Desc.Flags;
    ...
    public CD3DX12_PIPELINE_STATE_STREAM([NativeTypeName("const D3D12_COMPUTE_PIPELINE_STATE_DESC &")] in D3D12_COMPUTE_PIPELINE_STATE_DESC Desc)
    {
        Flags = Desc.Flags;
        NodeMask = Desc.NodeMask;
        pRootSignature = Desc.pRootSignature;
