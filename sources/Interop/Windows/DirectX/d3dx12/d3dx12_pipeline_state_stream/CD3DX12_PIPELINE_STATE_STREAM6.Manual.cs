...
public unsafe partial struct CD3DX12_PIPELINE_STATE_STREAM6
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_SERIALIZED_ROOT_SIGNATURE SerializedRootSignature;
    ...
    public CD3DX12_PIPELINE_STATE_STREAM6([NativeTypeName("const D3D12_GRAPHICS_PIPELINE_STATE_DESC &")] in D3D12_GRAPHICS_PIPELINE_STATE_DESC Desc)
    {
        Flags = Desc.Flags;
        ...
        SerializedRootSignature = D3D12_SERIALIZED_ROOT_SIGNATURE_DESC.DEFAULT;
    }

    public CD3DX12_PIPELINE_STATE_STREAM6([NativeTypeName("const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC &")] in D3DX12_MESH_SHADER_PIPELINE_STATE_DESC Desc)
    {
        Flags = Desc.Flags;
        NodeMask = Desc.NodeMask;
        pRootSignature = Desc.pRootSignature;
    ...
    public CD3DX12_PIPELINE_STATE_STREAM6([NativeTypeName("const D3D12_COMPUTE_PIPELINE_STATE_DESC &")] in D3D12_COMPUTE_PIPELINE_STATE_DESC Desc)
    {
        Flags = Desc.Flags;
        NodeMask = Desc.NodeMask;
        pRootSignature = Desc.pRootSignature;
