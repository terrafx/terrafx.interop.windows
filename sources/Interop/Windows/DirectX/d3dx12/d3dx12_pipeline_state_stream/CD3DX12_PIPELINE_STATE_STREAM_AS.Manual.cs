...
public struct CD3DX12_PIPELINE_STATE_STREAM_AS
{
    ...
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_AS;
        pssInner = default;
    }

    public CD3DX12_PIPELINE_STATE_STREAM_AS([NativeTypeName("D3D12_SHADER_BYTECODE const &")] in D3D12_SHADER_BYTECODE i)
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_AS;
        pssInner = i;
    }
