...
public unsafe partial struct ID3D11ShaderReflection : ID3D11ShaderReflection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11ShaderReflection;
