...
public unsafe partial struct ID3D11ShaderReflectionType : ID3D11ShaderReflectionType.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11ShaderReflectionType;
