...
public unsafe partial struct ID3D11ModuleInstance : ID3D11ModuleInstance.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11ModuleInstance;
