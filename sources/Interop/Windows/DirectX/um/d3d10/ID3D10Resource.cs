...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D10Resource);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, Guid*, void**, int>)(lpVtbl[0]))((ID3D10Resource*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, uint>)(lpVtbl[1]))((ID3D10Resource*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, uint>)(lpVtbl[2]))((ID3D10Resource*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, ID3D10Device**, void>)(lpVtbl[3]))((ID3D10Resource*)Unsafe.AsPointer(ref this), ppDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, Guid*, uint*, void*, int>)(lpVtbl[4]))((ID3D10Resource*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, Guid*, uint, void*, int>)(lpVtbl[5]))((ID3D10Resource*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, Guid*, IUnknown*, int>)(lpVtbl[6]))((ID3D10Resource*)Unsafe.AsPointer(ref this), guid, pData);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, D3D10_RESOURCE_DIMENSION*, void>)(lpVtbl[7]))((ID3D10Resource*)Unsafe.AsPointer(ref this), rType);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, uint, void>)(lpVtbl[8]))((ID3D10Resource*)Unsafe.AsPointer(ref this), EvictionPriority);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Resource*, uint>)(lpVtbl[9]))((ID3D10Resource*)Unsafe.AsPointer(ref this));
    }
