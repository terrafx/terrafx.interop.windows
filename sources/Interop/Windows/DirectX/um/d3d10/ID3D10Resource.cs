...
public unsafe partial struct ID3D10Resource : ID3D10Resource.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10Resource;
