...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D10DeviceChild);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10DeviceChild*, Guid*, void**, int>)(lpVtbl[0]))((ID3D10DeviceChild*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10DeviceChild*, uint>)(lpVtbl[1]))((ID3D10DeviceChild*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10DeviceChild*, uint>)(lpVtbl[2]))((ID3D10DeviceChild*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10DeviceChild*, ID3D10Device**, void>)(lpVtbl[3]))((ID3D10DeviceChild*)Unsafe.AsPointer(ref this), ppDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10DeviceChild*, Guid*, uint*, void*, int>)(lpVtbl[4]))((ID3D10DeviceChild*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10DeviceChild*, Guid*, uint, void*, int>)(lpVtbl[5]))((ID3D10DeviceChild*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10DeviceChild*, Guid*, IUnknown*, int>)(lpVtbl[6]))((ID3D10DeviceChild*)Unsafe.AsPointer(ref this), guid, pData);
    }
