...
public unsafe partial struct ID3D10DeviceChild : ID3D10DeviceChild.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10DeviceChild;
