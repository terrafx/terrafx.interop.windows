...
public unsafe partial struct ID3D10Predicate : ID3D10Predicate.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10Predicate;
