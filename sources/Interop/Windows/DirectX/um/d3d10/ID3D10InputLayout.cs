...
public unsafe partial struct ID3D10InputLayout : ID3D10InputLayout.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10InputLayout;
