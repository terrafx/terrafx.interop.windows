...
public unsafe partial struct ID3D10SamplerState : ID3D10SamplerState.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10SamplerState;
