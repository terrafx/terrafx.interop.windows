...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D10Query);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, Guid*, void**, int>)(lpVtbl[0]))((ID3D10Query*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, uint>)(lpVtbl[1]))((ID3D10Query*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, uint>)(lpVtbl[2]))((ID3D10Query*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Query*, ID3D10Device**, void>)(lpVtbl[3]))((ID3D10Query*)Unsafe.AsPointer(ref this), ppDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, Guid*, uint*, void*, int>)(lpVtbl[4]))((ID3D10Query*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, Guid*, uint, void*, int>)(lpVtbl[5]))((ID3D10Query*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, Guid*, IUnknown*, int>)(lpVtbl[6]))((ID3D10Query*)Unsafe.AsPointer(ref this), guid, pData);
    }
    ...
    public void Begin()
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Query*, void>)(lpVtbl[7]))((ID3D10Query*)Unsafe.AsPointer(ref this));
    }
    ...
    public void End()
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Query*, void>)(lpVtbl[8]))((ID3D10Query*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, void*, uint, uint, int>)(lpVtbl[9]))((ID3D10Query*)Unsafe.AsPointer(ref this), pData, DataSize, GetDataFlags);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Query*, uint>)(lpVtbl[10]))((ID3D10Query*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Query*, D3D10_QUERY_DESC*, void>)(lpVtbl[11]))((ID3D10Query*)Unsafe.AsPointer(ref this), pDesc);
    }
