...
public unsafe partial struct ID3D10Texture3D : ID3D10Texture3D.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10Texture3D;
