...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D10Texture3D);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, Guid*, void**, int>)(lpVtbl[0]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, uint>)(lpVtbl[1]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, uint>)(lpVtbl[2]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, ID3D10Device**, void>)(lpVtbl[3]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), ppDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, Guid*, uint*, void*, int>)(lpVtbl[4]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, Guid*, uint, void*, int>)(lpVtbl[5]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, Guid*, IUnknown*, int>)(lpVtbl[6]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), guid, pData);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, D3D10_RESOURCE_DIMENSION*, void>)(lpVtbl[7]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), rType);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, uint, void>)(lpVtbl[8]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), EvictionPriority);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, uint>)(lpVtbl[9]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, uint, D3D10_MAP, uint, D3D10_MAPPED_TEXTURE3D*, int>)(lpVtbl[10]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), Subresource, MapType, MapFlags, pMappedTex3D);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, uint, void>)(lpVtbl[11]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), Subresource);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D10Texture3D*, D3D10_TEXTURE3D_DESC*, void>)(lpVtbl[12]))((ID3D10Texture3D*)Unsafe.AsPointer(ref this), pDesc);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, D3D10_MAP, uint, D3D10_MAPPED_TEXTURE3D*, int> Map;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D10_TEXTURE3D_DESC*, void> GetDesc;
    }
}
