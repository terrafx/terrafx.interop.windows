...
/// <include file='ID3D10Asynchronous.xml' path='doc/member[@name="ID3D10Asynchronous"]/*' />
...
public unsafe partial struct ID3D10Asynchronous : ID3D10Asynchronous.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10Asynchronous;
