...
public unsafe partial struct ID3D10BlendState : ID3D10BlendState.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10BlendState;
