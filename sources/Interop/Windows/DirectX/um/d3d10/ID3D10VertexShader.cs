...
public unsafe partial struct ID3D10VertexShader : ID3D10VertexShader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10VertexShader;
