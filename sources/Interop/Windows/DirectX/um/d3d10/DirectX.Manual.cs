...
public static partial class DirectX
{
    ...
    {
        return ((D3D10_FILTER)(((bComparison) ? (0x80) : 0) | (((min) & (0x3)) << (4)) | (((mag) & (0x3)) << (2)) | (((mip) & (0x3)) << (0))));
    }

    public static D3D10_FILTER D3D10_ENCODE_ANISOTROPIC_FILTER(bool bComparison)
    {
        return ((D3D10_FILTER)(((0x40) | (int)D3D10_ENCODE_BASIC_FILTER((int)(D3D10_FILTER_TYPE_LINEAR), (int)(D3D10_FILTER_TYPE_LINEAR), (int)(D3D10_FILTER_TYPE_LINEAR), bComparison))));
    }
    ...
    {
        return (((int)(d3d10Filter) & (0x40)) != 0 && (D3D10_FILTER_TYPE_LINEAR == D3D10_DECODE_MIN_FILTER(d3d10Filter)) && (D3D10_FILTER_TYPE_LINEAR == D3D10_DECODE_MAG_FILTER(d3d10Filter)) && (D3D10_FILTER_TYPE_LINEAR == D3D10_DECODE_MIP_FILTER(d3d10Filter)));
    }
