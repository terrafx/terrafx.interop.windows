...
public unsafe partial struct ID3D10Texture2D : ID3D10Texture2D.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10Texture2D;
