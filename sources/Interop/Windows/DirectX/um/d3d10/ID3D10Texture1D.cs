...
public unsafe partial struct ID3D10Texture1D : ID3D10Texture1D.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10Texture1D;
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, uint, D3D10_MAP, uint, void**, int> Map;

        [NativeTypeName("void (UINT) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, uint, void> Unmap;

        [NativeTypeName("void (D3D10_TEXTURE1D_DESC *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, D3D10_TEXTURE1D_DESC*, void> GetDesc;
    }
}
