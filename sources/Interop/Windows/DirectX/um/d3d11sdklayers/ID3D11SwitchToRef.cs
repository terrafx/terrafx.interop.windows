...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D11SwitchToRef);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11SwitchToRef*, BOOL, int>)(lpVtbl[3]))((ID3D11SwitchToRef*)Unsafe.AsPointer(ref this), UseRef);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11SwitchToRef*, int>)(lpVtbl[4]))((ID3D11SwitchToRef*)Unsafe.AsPointer(ref this));
    }
