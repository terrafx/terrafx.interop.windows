...
public unsafe partial struct ID3D11RefTrackingOptions : ID3D11RefTrackingOptions.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11RefTrackingOptions;
