...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D11On12Device2);
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11Resource*, ID3D12CommandQueue*, Guid*, void**, int> UnwrapUnderlyingResource;

        [NativeTypeName("HRESULT (ID3D11Resource *, UINT, UINT64 *, ID3D12Fence **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11Resource*, uint, ulong*, ID3D12Fence**, int> ReturnUnderlyingResource;
    }
}
