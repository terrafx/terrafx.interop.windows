...
public unsafe partial struct ID3DDeviceContextState : ID3DDeviceContextState.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3DDeviceContextState;
