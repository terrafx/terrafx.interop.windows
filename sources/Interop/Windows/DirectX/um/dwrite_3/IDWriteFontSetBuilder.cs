...
public unsafe partial struct IDWriteFontSetBuilder : IDWriteFontSetBuilder.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontSetBuilder;
