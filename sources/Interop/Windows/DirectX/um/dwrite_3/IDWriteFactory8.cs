...
/// <include file='IDWriteFactory8.xml' path='doc/member[@name="IDWriteFactory8"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDWriteFactory8);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, IDWriteFontCollection**, BOOL, int>)(lpVtbl[3]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, char*, FILETIME*, IDWriteFontFile**, int>)(lpVtbl[7]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, fontFile);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, DWRITE_FONT_FACE_TYPE, uint, IDWriteFontFile**, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFace**, int>)(lpVtbl[9]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontFaceType, numberOfFiles, fontFiles, faceIndex, fontFaceSimulationFlags, fontFace);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, HMONITOR, IDWriteRenderingParams**, int>)(lpVtbl[11]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), monitor, renderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE, IDWriteRenderingParams**, int>)(lpVtbl[12]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), gamma, enhancedContrast, clearTypeLevel, pixelGeometry, renderingMode, renderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, char*, IDWriteFontCollection*, DWRITE_FONT_WEIGHT, DWRITE_FONT_STYLE, DWRITE_FONT_STRETCH, float, char*, IDWriteTextFormat**, int>)(lpVtbl[15]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontFamilyName, fontCollection, fontWeight, fontStyle, fontStretch, fontSize, localeName, textFormat);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, char*, uint, IDWriteTextFormat*, float, float, float, DWRITE_MATRIX*, BOOL, IDWriteTextLayout**, int>)(lpVtbl[19]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutWidth, layoutHeight, pixelsPerDip, transform, useGdiNatural, textLayout);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, DWRITE_NUMBER_SUBSTITUTION_METHOD, char*, BOOL, IDWriteNumberSubstitution**, int>)(lpVtbl[22]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), substitutionMethod, localeName, ignoreUserOverride, numberSubstitution);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, IDWriteFontCollection**, BOOL, int>)(lpVtbl[24]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, float, float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE, IDWriteRenderingParams1**, int>)(lpVtbl[25]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), gamma, enhancedContrast, enhancedContrastGrayscale, clearTypeLevel, pixelGeometry, renderingMode, renderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, float, float, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, DWRITE_MEASURING_MODE, DWRITE_MATRIX*, uint, IDWriteColorGlyphRunEnumerator**, int>)(lpVtbl[28]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), baselineOriginX, baselineOriginY, glyphRun, glyphRunDescription, measuringMode, worldToDeviceTransform, colorPaletteIndex, colorLayers);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, float, float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE, DWRITE_GRID_FIT_MODE, IDWriteRenderingParams2**, int>)(lpVtbl[29]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), gamma, enhancedContrast, grayscaleEnhancedContrast, clearTypeLevel, pixelGeometry, renderingMode, gridFitMode, renderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, float, float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE1, DWRITE_GRID_FIT_MODE, IDWriteRenderingParams3**, int>)(lpVtbl[32]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), gamma, enhancedContrast, grayscaleEnhancedContrast, clearTypeLevel, pixelGeometry, renderingMode, gridFitMode, renderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, IDWriteFontFile*, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFaceReference**, int>)(lpVtbl[33]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontFile, faceIndex, fontSimulations, fontFaceReference);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, char*, FILETIME*, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFaceReference**, int>)(lpVtbl[34]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, faceIndex, fontSimulations, fontFaceReference);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, BOOL, IDWriteFontCollection1**, BOOL, int>)(lpVtbl[38]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), includeDownloadableFonts, fontCollection, checkForUpdates);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, DWRITE_GLYPH_IMAGE_FORMATS, DWRITE_MEASURING_MODE, DWRITE_MATRIX*, uint, IDWriteColorGlyphRunEnumerator1**, int>)(lpVtbl[40]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, desiredGlyphImageFormats, measuringMode, worldAndDpiTransform, colorPaletteIndex, colorLayers);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, DWRITE_GLYPH_RUN*, D2D_POINT_2F, D2D_POINT_2F*, int>)(lpVtbl[41]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), glyphRun, baselineOrigin, glyphOrigins);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_POINT_2F, DWRITE_MATRIX*, D2D_POINT_2F*, int>)(lpVtbl[42]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), glyphRun, measuringMode, baselineOrigin, worldAndDpiTransform, glyphOrigins);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, void*, uint, DWRITE_CONTAINER_TYPE>)(lpVtbl[46]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fileData, fileDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, DWRITE_CONTAINER_TYPE, void*, uint, IDWriteFontFileStream**, int>)(lpVtbl[47]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), containerType, fileData, fileDataSize, unpackedFontStream);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, IDWriteFontFile*, uint, DWRITE_FONT_SIMULATIONS, DWRITE_FONT_AXIS_VALUE*, uint, IDWriteFontFaceReference1**, int>)(lpVtbl[48]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontFile, faceIndex, fontSimulations, fontAxisValues, fontAxisValueCount, fontFaceReference);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, BOOL, IDWriteFontSet1**, int>)(lpVtbl[50]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), includeDownloadableFonts, fontSet);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, BOOL, DWRITE_FONT_FAMILY_MODEL, IDWriteFontCollection2**, int>)(lpVtbl[51]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), includeDownloadableFonts, fontFamilyModel, fontCollection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, IDWriteFontSet*, DWRITE_FONT_FAMILY_MODEL, IDWriteFontCollection2**, int>)(lpVtbl[52]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontSet, fontFamilyModel, fontCollection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, char*, IDWriteFontCollection*, DWRITE_FONT_AXIS_VALUE*, uint, float, char*, IDWriteTextFormat3**, int>)(lpVtbl[54]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), fontFamilyName, fontCollection, fontAxisValues, fontAxisValueCount, fontSize, localeName, textFormat);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, BOOL, IDWriteFontSet2**, int>)(lpVtbl[55]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), includeDownloadableFonts, fontSet);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, BOOL, DWRITE_FONT_FAMILY_MODEL, IDWriteFontCollection3**, int>)(lpVtbl[56]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), includeDownloadableFonts, fontFamilyModel, fontCollection);
    }

    /// <include file='IDWriteFactory8.xml' path='doc/member[@name="IDWriteFactory8.TranslateColorGlyphRun"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(57)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFactory8*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, DWRITE_GLYPH_IMAGE_FORMATS, DWRITE_PAINT_FEATURE_LEVEL, DWRITE_MEASURING_MODE, DWRITE_MATRIX*, uint, IDWriteColorGlyphRunEnumerator1**, int>)(lpVtbl[57]))((IDWriteFactory8*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, desiredGlyphImageFormats, paintFeatureLevel, measuringMode, worldAndDpiTransform, colorPaletteIndex, colorEnumerator);
    }

    public interface Interface : IDWriteFactory7.Interface
    {
        [VtblIndex(57)]
        HRESULT TranslateColorGlyphRun([NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, [NativeTypeName("const DWRITE_GLYPH_RUN *")] DWRITE_GLYPH_RUN* glyphRun, [NativeTypeName("const DWRITE_GLYPH_RUN_DESCRIPTION *")] DWRITE_GLYPH_RUN_DESCRIPTION* glyphRunDescription, DWRITE_GLYPH_IMAGE_FORMATS desiredGlyphImageFormats, DWRITE_PAINT_FEATURE_LEVEL paintFeatureLevel, DWRITE_MEASURING_MODE measuringMode, [NativeTypeName("const DWRITE_MATRIX *")] DWRITE_MATRIX* worldAndDpiTransform, [NativeTypeName("UINT32")] uint colorPaletteIndex, IDWriteColorGlyphRunEnumerator1** colorEnumerator);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, IDWriteFontSet1**, int> GetSystemFontSet1;

        [NativeTypeName("HRESULT (BOOL, DWRITE_FONT_FAMILY_MODEL, IDWriteFontCollection2 **) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, DWRITE_FONT_FAMILY_MODEL, IDWriteFontCollection2**, int> GetSystemFontCollection2;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, IDWriteFontSet2**, int> GetSystemFontSet2;

        [NativeTypeName("HRESULT (BOOL, DWRITE_FONT_FAMILY_MODEL, IDWriteFontCollection3 **) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, DWRITE_FONT_FAMILY_MODEL, IDWriteFontCollection3**, int> GetSystemFontCollection3;
