...
public unsafe partial struct IDWriteTextFormat2 : IDWriteTextFormat2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextFormat2*, BOOL, int>)(lpVtbl[30]))((IDWriteTextFormat2*)Unsafe.AsPointer(ref this), isLastLineWrappingEnabled);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextFormat2*, int>)(lpVtbl[31]))((IDWriteTextFormat2*)Unsafe.AsPointer(ref this));
    }
