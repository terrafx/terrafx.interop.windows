...
public unsafe partial struct IDWriteFontSet2 : IDWriteFontSet2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet2*, DWRITE_FONT_PROPERTY_ID, char*, IDWriteStringList**, int>)(lpVtbl[8]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), propertyID, preferredLocaleNames, values);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet2*, char*, DWRITE_FONT_WEIGHT, DWRITE_FONT_STRETCH, DWRITE_FONT_STYLE, IDWriteFontSet**, int>)(lpVtbl[11]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), familyName, fontWeight, fontStretch, fontStyle, filteredSet);
    }
