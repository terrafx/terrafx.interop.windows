...
/// <include file='IDWriteFontFace7.xml' path='doc/member[@name="IDWriteFontFace7"]/*' />
...
public unsafe partial struct IDWriteFontFace7 : IDWriteFontFace7.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, int>)(lpVtbl[7]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, ushort*, uint, DWRITE_GLYPH_METRICS*, BOOL, int>)(lpVtbl[10]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphIndices, glyphCount, glyphMetrics, isSideways);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, void**, uint*, void**, BOOL*, int>)(lpVtbl[12]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), openTypeTableTag, tableData, tableSize, tableContext, exists);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, ushort*, float*, DWRITE_GLYPH_OFFSET*, uint, BOOL, BOOL, ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[14]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), emSize, glyphIndices, glyphAdvances, glyphOffsets, glyphCount, isSideways, isRightToLeft, geometrySink);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, float, DWRITE_MATRIX*, DWRITE_FONT_METRICS*, int>)(lpVtbl[16]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, fontFaceMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, float, DWRITE_MATRIX*, BOOL, ushort*, uint, DWRITE_GLYPH_METRICS*, BOOL, int>)(lpVtbl[17]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, useGdiNatural, glyphIndices, glyphCount, glyphMetrics, isSideways);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, float, DWRITE_MATRIX*, DWRITE_FONT_METRICS1*, int>)(lpVtbl[19]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, fontMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, int>)(lpVtbl[22]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, ushort*, int*, BOOL, int>)(lpVtbl[23]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphCount, glyphIndices, glyphAdvances, isSideways);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, float, DWRITE_MATRIX*, BOOL, BOOL, uint, ushort*, int*, int>)(lpVtbl[24]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, useGdiNatural, isSideways, glyphCount, glyphIndices, glyphAdvances);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, int>)(lpVtbl[26]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, float, float, DWRITE_MATRIX*, BOOL, DWRITE_OUTLINE_THRESHOLD, DWRITE_MEASURING_MODE, DWRITE_RENDERING_MODE*, int>)(lpVtbl[27]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), fontEmSize, dpiX, dpiY, transform, isSideways, outlineThreshold, measuringMode, renderingMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, int>)(lpVtbl[29]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, int>)(lpVtbl[30]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, uint, uint, DXGI_RGBA*, int>)(lpVtbl[33]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, float, float, DWRITE_MATRIX*, BOOL, DWRITE_OUTLINE_THRESHOLD, DWRITE_MEASURING_MODE, IDWriteRenderingParams*, DWRITE_RENDERING_MODE*, DWRITE_GRID_FIT_MODE*, int>)(lpVtbl[34]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), fontEmSize, dpiX, dpiY, transform, isSideways, outlineThreshold, measuringMode, renderingParams, renderingMode, gridFitMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, DWRITE_INFORMATIONAL_STRING_ID, IDWriteLocalizedStrings**, BOOL*, int>)(lpVtbl[42]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), informationalStringID, informationalStrings, exists);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, int>)(lpVtbl[43]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), unicodeValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, int>)(lpVtbl[45]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), unicodeValue);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, ushort, int>)(lpVtbl[46]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, char*, uint, BOOL, BOOL*, int>)(lpVtbl[47]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), characters, characterCount, enqueueIfNotLocal, isLocal);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, ushort*, uint, BOOL, BOOL*, int>)(lpVtbl[48]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphIndices, glyphCount, enqueueIfNotLocal, isLocal);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, int>)(lpVtbl[55]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, IDWriteFontFace*, int>)(lpVtbl[57]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), fontFace);
    }
    ...
    /// <include file='IDWriteFontFace7.xml' path='doc/member[@name="IDWriteFontFace7.GetPaintFeatureLevel"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(60)]
    ...
    /// <include file='IDWriteFontFace7.xml' path='doc/member[@name="IDWriteFontFace7.CreatePaintReader"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(61)]
