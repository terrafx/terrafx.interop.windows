...
public unsafe partial struct IDWriteFactory7 : IDWriteFactory7.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory7*, char*, FILETIME*, IDWriteFontFile**, int>)(lpVtbl[7]))((IDWriteFactory7*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, fontFile);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory7*, char*, uint, IDWriteTextFormat*, float, float, IDWriteTextLayout**, int>)(lpVtbl[18]))((IDWriteFactory7*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, maxWidth, maxHeight, textLayout);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory7*, char*, uint, IDWriteTextFormat*, float, float, float, DWRITE_MATRIX*, BOOL, IDWriteTextLayout**, int>)(lpVtbl[19]))((IDWriteFactory7*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutWidth, layoutHeight, pixelsPerDip, transform, useGdiNatural, textLayout);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory7*, DWRITE_NUMBER_SUBSTITUTION_METHOD, char*, BOOL, IDWriteNumberSubstitution**, int>)(lpVtbl[22]))((IDWriteFactory7*)Unsafe.AsPointer(ref this), substitutionMethod, localeName, ignoreUserOverride, numberSubstitution);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory7*, char*, FILETIME*, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFaceReference**, int>)(lpVtbl[34]))((IDWriteFactory7*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, faceIndex, fontSimulations, fontFaceReference);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory7*, char*, char*, IDWriteRemoteFontFileLoader**, int>)(lpVtbl[45]))((IDWriteFactory7*)Unsafe.AsPointer(ref this), referrerUrl, extraHeaders, newLoader);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory7*, char*, IDWriteFontCollection*, DWRITE_FONT_AXIS_VALUE*, uint, float, char*, IDWriteTextFormat3**, int>)(lpVtbl[54]))((IDWriteFactory7*)Unsafe.AsPointer(ref this), fontFamilyName, fontCollection, fontAxisValues, fontAxisValueCount, fontSize, localeName, textFormat);
    }
