...
public unsafe partial struct IDWriteFontSet : IDWriteFontSet.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontSet;
