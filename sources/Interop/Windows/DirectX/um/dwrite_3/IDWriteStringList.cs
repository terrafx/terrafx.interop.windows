...
public unsafe partial struct IDWriteStringList : IDWriteStringList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteStringList;
