...
public unsafe partial struct IDWriteTextLayout3 : IDWriteTextLayout3.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDWriteTextLayout3*, char*, uint, int>)(lpVtbl[21]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), fontFamilyName, nameSize);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteTextLayout3*, char*, uint, int>)(lpVtbl[27]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), localeName, nameSize);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteTextLayout3*, char*, DWRITE_TEXT_RANGE, int>)(lpVtbl[31]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), fontFamilyName, textRange);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteTextLayout3*, char*, DWRITE_TEXT_RANGE, int>)(lpVtbl[41]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), localeName, textRange);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteTextLayout3*, uint, char*, uint, DWRITE_TEXT_RANGE*, int>)(lpVtbl[46]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), currentPosition, fontFamilyName, nameSize, textRange);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteTextLayout3*, uint, char*, uint, DWRITE_TEXT_RANGE*, int>)(lpVtbl[57]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), currentPosition, localeName, nameSize, textRange);
    }
