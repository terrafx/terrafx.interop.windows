...
/// <include file='IDWriteFontSet3.xml' path='doc/member[@name="IDWriteFontSet3"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDWriteFontSet3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, IDWriteFontFaceReference*, uint*, BOOL*, int>)(lpVtbl[5]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), fontFaceReference, listIndex, exists);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, IDWriteFontFace*, uint*, BOOL*, int>)(lpVtbl[6]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), fontFace, listIndex, exists);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_PROPERTY_ID, IDWriteStringList**, int>)(lpVtbl[7]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), propertyID, values);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_PROPERTY_ID, char*, IDWriteStringList**, int>)(lpVtbl[8]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), propertyID, preferredLocaleNames, values);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, uint, DWRITE_FONT_PROPERTY_ID, BOOL*, IDWriteLocalizedStrings**, int>)(lpVtbl[9]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), listIndex, propertyId, exists, values);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_PROPERTY*, uint*, int>)(lpVtbl[10]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), property, propertyOccurrenceCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, char*, DWRITE_FONT_WEIGHT, DWRITE_FONT_STRETCH, DWRITE_FONT_STYLE, IDWriteFontSet**, int>)(lpVtbl[11]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), familyName, fontWeight, fontStretch, fontStyle, filteredSet);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_PROPERTY*, uint, IDWriteFontSet**, int>)(lpVtbl[12]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), properties, propertyCount, filteredSet);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_PROPERTY*, DWRITE_FONT_AXIS_VALUE*, uint, IDWriteFontSet1**, int>)(lpVtbl[13]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), fontProperty, fontAxisValues, fontAxisValueCount, matchingFonts);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_AXIS_RANGE*, uint, BOOL, IDWriteFontSet1**, int>)(lpVtbl[16]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), fontAxisRanges, fontAxisRangeCount, selectAnyRange, filteredFontSet);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_PROPERTY*, uint, BOOL, IDWriteFontSet1**, int>)(lpVtbl[17]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), properties, propertyCount, selectAnyProperty, filteredFontSet);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_AXIS_RANGE*, uint, BOOL, uint*, uint, uint*, int>)(lpVtbl[18]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), fontAxisRanges, fontAxisRangeCount, selectAnyRange, indices, maxIndexCount, actualIndexCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_PROPERTY*, uint, BOOL, uint*, uint, uint*, int>)(lpVtbl[19]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), properties, propertyCount, selectAnyProperty, indices, maxIndexCount, actualIndexCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, uint, DWRITE_FONT_AXIS_RANGE*, uint, uint*, int>)(lpVtbl[20]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), listIndex, fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, DWRITE_FONT_AXIS_RANGE*, uint, uint*, int>)(lpVtbl[21]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, uint, DWRITE_LOCALITY>)(lpVtbl[25]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), listIndex);
    }
    ...
    /// <include file='IDWriteFontSet3.xml' path='doc/member[@name="IDWriteFontSet3.GetFontSourceType"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(27)]
    public DWRITE_FONT_SOURCE_TYPE GetFontSourceType([NativeTypeName("UINT32")] uint fontIndex)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet3*, uint, DWRITE_FONT_SOURCE_TYPE>)(lpVtbl[27]))((IDWriteFontSet3*)Unsafe.AsPointer(ref this), fontIndex);
    }

    /// <include file='IDWriteFontSet3.xml' path='doc/member[@name="IDWriteFontSet3.GetFontSourceNameLength"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(28)]
    [return: NativeTypeName("UINT32")]
    ...
    /// <include file='IDWriteFontSet3.xml' path='doc/member[@name="IDWriteFontSet3.GetFontSourceName"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(29)]
    ...
    public interface Interface : IDWriteFontSet2.Interface
    {
        ...
        [VtblIndex(29)]
        HRESULT GetFontSourceName([NativeTypeName("UINT32")] uint listIndex, [NativeTypeName("WCHAR *")] char* stringBuffer, [NativeTypeName("UINT32")] uint stringBufferSize);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IDWriteFontFaceReference*, uint*, BOOL*, int> FindFontFaceReference;

        [NativeTypeName("HRESULT (IDWriteFontFace *, UINT32 *, BOOL *) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, IDWriteFontFace*, uint*, BOOL*, int> FindFontFace;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, DWRITE_FONT_PROPERTY_ID, BOOL*, IDWriteLocalizedStrings**, int> GetPropertyValues2;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DWRITE_FONT_AXIS_RANGE*, uint, BOOL, IDWriteFontSet1**, int> GetFilteredFonts1;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DWRITE_FONT_PROPERTY*, uint, BOOL, IDWriteFontSet1**, int> GetFilteredFonts2;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DWRITE_FONT_AXIS_RANGE*, uint, BOOL, uint*, uint, uint*, int> GetFilteredFontIndices;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DWRITE_FONT_PROPERTY*, uint, BOOL, uint*, uint, uint*, int> GetFilteredFontIndices1;
