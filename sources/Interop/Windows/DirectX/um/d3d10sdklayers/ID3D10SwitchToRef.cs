...
public unsafe partial struct ID3D10SwitchToRef : ID3D10SwitchToRef.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10SwitchToRef;
