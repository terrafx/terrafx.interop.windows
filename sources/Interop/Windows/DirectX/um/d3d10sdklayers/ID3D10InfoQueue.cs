...
public unsafe partial struct ID3D10InfoQueue : ID3D10InfoQueue.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D10InfoQueue;
