...
public unsafe partial struct IDirectManipulationManager : IDirectManipulationManager.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDirectManipulationManager;
