...
public unsafe partial struct IDirectManipulationContent : IDirectManipulationContent.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDirectManipulationContent;
