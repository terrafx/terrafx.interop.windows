...
public unsafe partial struct IDCompositionSurfaceFactory : IDCompositionSurfaceFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDCompositionSurfaceFactory;
