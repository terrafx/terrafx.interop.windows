...
public unsafe partial struct IDCompositionSurface : IDCompositionSurface.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDCompositionSurface;
