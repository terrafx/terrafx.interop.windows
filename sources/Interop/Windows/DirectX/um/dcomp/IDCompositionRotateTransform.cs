...
public unsafe partial struct IDCompositionRotateTransform : IDCompositionRotateTransform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDCompositionRotateTransform;
