...
public unsafe partial struct IDCompositionShadowEffect : IDCompositionShadowEffect.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDCompositionShadowEffect;
