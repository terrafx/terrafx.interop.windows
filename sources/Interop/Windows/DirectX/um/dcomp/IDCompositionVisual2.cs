...
public unsafe partial struct IDCompositionVisual2 : IDCompositionVisual2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDCompositionVisual2*, D2D_MATRIX_3X2_F*, int>)(lpVtbl[8]))((IDCompositionVisual2*)Unsafe.AsPointer(ref this), matrix);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDCompositionVisual2*, D2D_RECT_F*, int>)(lpVtbl[14]))((IDCompositionVisual2*)Unsafe.AsPointer(ref this), rect);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDCompositionVisual2*, IDCompositionVisual*, BOOL, IDCompositionVisual*, int>)(lpVtbl[16]))((IDCompositionVisual2*)Unsafe.AsPointer(ref this), visual, insertAbove, referenceVisual);
    }
