...
public unsafe partial struct IDCompositionTarget : IDCompositionTarget.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDCompositionTarget;
