...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1CommandSink1);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D1_ANTIALIAS_MODE, int>)(lpVtbl[5]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), antialiasMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D1_TEXT_ANTIALIAS_MODE, int>)(lpVtbl[7]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), textAntialiasMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, IDWriteRenderingParams*, int>)(lpVtbl[8]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), textRenderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D_MATRIX_3X2_F*, int>)(lpVtbl[9]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D1_PRIMITIVE_BLEND, int>)(lpVtbl[10]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), primitiveBlend);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D1_UNIT_MODE, int>)(lpVtbl[11]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), unitMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, DXGI_RGBA*, int>)(lpVtbl[12]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), color);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, ID2D1Brush*, DWRITE_MEASURING_MODE, int>)(lpVtbl[13]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, foregroundBrush, measuringMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D_POINT_2F, D2D_POINT_2F, ID2D1Brush*, float, ID2D1StrokeStyle*, int>)(lpVtbl[14]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), point0, point1, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D_RECT_F*, ID2D1Brush*, float, ID2D1StrokeStyle*, int>)(lpVtbl[16]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_INTERPOLATION_MODE, D2D_RECT_F*, D2D_MATRIX_4X4_F*, int>)(lpVtbl[17]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle, perspectiveTransform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, ID2D1Image*, D2D_POINT_2F*, D2D_RECT_F*, D2D1_INTERPOLATION_MODE, D2D1_COMPOSITE_MODE, int>)(lpVtbl[18]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), image, targetOffset, imageRectangle, interpolationMode, compositeMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, ID2D1GdiMetafile*, D2D_POINT_2F*, int>)(lpVtbl[19]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), gdiMetafile, targetOffset);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, ID2D1Bitmap*, ID2D1Brush*, D2D_RECT_F*, D2D_RECT_F*, int>)(lpVtbl[21]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D_RECT_F*, ID2D1Brush*, int>)(lpVtbl[23]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), rect, brush);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, int>)(lpVtbl[24]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D1_LAYER_PARAMETERS1*, ID2D1Layer*, int>)(lpVtbl[25]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), layerParameters1, layer);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink1*, D2D1_PRIMITIVE_BLEND, int>)(lpVtbl[28]))((ID2D1CommandSink1*)Unsafe.AsPointer(ref this), primitiveBlend);
    }
