...
public unsafe partial struct ID2D1GeometryRealization : ID2D1GeometryRealization.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1GeometryRealization;
