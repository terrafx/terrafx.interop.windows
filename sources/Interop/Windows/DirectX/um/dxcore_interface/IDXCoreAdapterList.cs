...
public unsafe partial struct IDXCoreAdapterList : IDXCoreAdapterList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXCoreAdapterList;
