...
public unsafe partial struct IDXGIInfoQueue : IDXGIInfoQueue.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDXGIInfoQueue;
