...
public unsafe partial struct ID2D1PathGeometry : ID2D1PathGeometry.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1PathGeometry;
