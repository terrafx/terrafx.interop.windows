...
public unsafe partial struct ID2D1PathGeometry : ID2D1PathGeometry.Interface
{
    ...
    public partial struct Vtbl
    {
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, Guid*, void**, int> QueryInterface;

        [NativeTypeName("ULONG () __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, uint> AddRef;

        [NativeTypeName("ULONG () __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, uint> Release;

        [NativeTypeName("void (ID2D1Factory **) const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, ID2D1Factory**, void> GetFactory;

        [NativeTypeName("HRESULT (const D2D1_MATRIX_3X2_F *, D2D1_RECT_F *) const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, D2D_MATRIX_3X2_F*, D2D_RECT_F*, int> GetBounds;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, float, ID2D1StrokeStyle*, D2D_MATRIX_3X2_F*, float, D2D_RECT_F*, int> GetWidenedBounds1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, D2D_POINT_2F, float, ID2D1StrokeStyle*, D2D_MATRIX_3X2_F*, float, BOOL*, int> StrokeContainsPoint1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, D2D_POINT_2F, D2D_MATRIX_3X2_F*, float, BOOL*, int> FillContainsPoint1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, ID2D1Geometry*, D2D_MATRIX_3X2_F*, float, D2D1_GEOMETRY_RELATION*, int> CompareWithGeometry1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, D2D1_GEOMETRY_SIMPLIFICATION_OPTION, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> Simplify1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, D2D_MATRIX_3X2_F*, float, ID2D1TessellationSink*, int> Tessellate1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, ID2D1Geometry*, D2D1_COMBINE_MODE, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> CombineWithGeometry1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> Outline1;

        [NativeTypeName("HRESULT (const D2D1_MATRIX_3X2_F *, FLOAT, FLOAT *) const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, D2D_MATRIX_3X2_F*, float, float*, int> ComputeArea1;

        [NativeTypeName("HRESULT (const D2D1_MATRIX_3X2_F *, FLOAT, FLOAT *) const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, D2D_MATRIX_3X2_F*, float, float*, int> ComputeLength1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, float, D2D_MATRIX_3X2_F*, float, D2D_POINT_2F*, D2D_POINT_2F*, int> ComputePointAtLength1;
        ...
        public delegate* unmanaged<ID2D1PathGeometry*, float, ID2D1StrokeStyle*, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> Widen1;

        [NativeTypeName("HRESULT (ID2D1GeometrySink **) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, ID2D1GeometrySink**, int> Open;

        [NativeTypeName("HRESULT (ID2D1GeometrySink *) const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<ID2D1PathGeometry*, ID2D1GeometrySink*, int> Stream;

        [NativeTypeName("HRESULT (UINT32 *) const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[SuppressGCTransition]<ID2D1PathGeometry*, uint*, int> GetSegmentCount;

        [NativeTypeName("HRESULT (UINT32 *) const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[SuppressGCTransition]<ID2D1PathGeometry*, uint*, int> GetFigureCount;
    }
}
