...
public unsafe partial struct ID2D1GradientStopCollection : ID2D1GradientStopCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1GradientStopCollection;
