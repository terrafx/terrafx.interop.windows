...
public unsafe partial struct ID2D1RenderTarget : ID2D1RenderTarget.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_ANTIALIAS_MODE>)(lpVtbl[33]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_TEXT_ANTIALIAS_MODE>)(lpVtbl[35]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_SIZE_F>)(lpVtbl[53]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_SIZE_U>)(lpVtbl[54]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), renderTargetProperties);
    }
