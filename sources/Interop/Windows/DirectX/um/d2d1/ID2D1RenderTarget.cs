...
// Ported from um/d2d1.h in the Windows SDK for Windows 10.0.28000.0
...
/// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1RenderTarget);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this), factory);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateBitmap"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(4)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[4]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), size, srcData, pitch, bitmapProperties, bitmap);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateBitmapFromWicBitmap"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(5)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateSharedBitmap"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(6)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, Guid*, void*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[6]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), riid, data, bitmapProperties, bitmap);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateBitmapBrush"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush**, int>)(lpVtbl[7]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateSolidColorBrush"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(8)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, DXGI_RGBA*, D2D1_BRUSH_PROPERTIES*, ID2D1SolidColorBrush**, int>)(lpVtbl[8]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), color, brushProperties, solidColorBrush);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateGradientStopCollection"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(9)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateLinearGradientBrush"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(10)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1LinearGradientBrush**, int>)(lpVtbl[10]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), linearGradientBrushProperties, brushProperties, gradientStopCollection, linearGradientBrush);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateRadialGradientBrush"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(11)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1RadialGradientBrush**, int>)(lpVtbl[11]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), radialGradientBrushProperties, brushProperties, gradientStopCollection, radialGradientBrush);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateCompatibleRenderTarget"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(12)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_SIZE_F*, D2D_SIZE_U*, D2D1_PIXEL_FORMAT*, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, ID2D1BitmapRenderTarget**, int>)(lpVtbl[12]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), desiredSize, desiredPixelSize, desiredFormat, options, bitmapRenderTarget);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateLayer"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(13)]
    public HRESULT CreateLayer([NativeTypeName("const D2D1_SIZE_F *")] D2D_SIZE_F* size, ID2D1Layer** layer)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_SIZE_F*, ID2D1Layer**, int>)(lpVtbl[13]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), size, layer);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.CreateMesh"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(14)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawLine"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(15)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_POINT_2F, D2D_POINT_2F, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[15]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), point0, point1, brush, strokeWidth, strokeStyle);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawRectangle"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(16)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_RECT_F*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.FillRectangle"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(17)]
    public void FillRectangle([NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* rect, ID2D1Brush* brush)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_RECT_F*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), rect, brush);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawRoundedRectangle"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(18)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_ROUNDED_RECT*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[18]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), roundedRect, brush, strokeWidth, strokeStyle);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.FillRoundedRectangle"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(19)]
    public void FillRoundedRectangle([NativeTypeName("const D2D1_ROUNDED_RECT *")] D2D1_ROUNDED_RECT* roundedRect, ID2D1Brush* brush)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_ROUNDED_RECT*, ID2D1Brush*, void>)(lpVtbl[19]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), roundedRect, brush);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawEllipse"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(20)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_ELLIPSE*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[20]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), ellipse, brush, strokeWidth, strokeStyle);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.FillEllipse"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(21)]
    public void FillEllipse([NativeTypeName("const D2D1_ELLIPSE *")] D2D1_ELLIPSE* ellipse, ID2D1Brush* brush)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_ELLIPSE*, ID2D1Brush*, void>)(lpVtbl[21]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), ellipse, brush);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawGeometry"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(22)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.FillGeometry"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(23)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.FillMesh"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(24)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.FillOpacityMask"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(25)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ID2D1Bitmap*, ID2D1Brush*, D2D1_OPACITY_MASK_CONTENT, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[25]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawBitmap"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(26)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_BITMAP_INTERPOLATION_MODE, D2D_RECT_F*, void>)(lpVtbl[26]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawText"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(27)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, char*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void>)(lpVtbl[27]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutRect, defaultFillBrush, options, measuringMode);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawTextLayout"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(28)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, void>)(lpVtbl[28]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, options);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.DrawGlyphRun"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(29)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[29]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, foregroundBrush, measuringMode);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.SetTransform"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(30)]
    public void SetTransform([NativeTypeName("const D2D1_MATRIX_3X2_F *")] D2D_MATRIX_3X2_F* transform)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[30]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), transform);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetTransform"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(31)]
    public readonly void GetTransform([NativeTypeName("D2D1_MATRIX_3X2_F *")] D2D_MATRIX_3X2_F* transform)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this), transform);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[32]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), antialiasMode);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetAntialiasMode"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(33)]
    public readonly D2D1_ANTIALIAS_MODE GetAntialiasMode()
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_ANTIALIAS_MODE>)(lpVtbl[33]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_TEXT_ANTIALIAS_MODE, void>)(lpVtbl[34]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), textAntialiasMode);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetTextAntialiasMode"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(35)]
    public readonly D2D1_TEXT_ANTIALIAS_MODE GetTextAntialiasMode()
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_TEXT_ANTIALIAS_MODE>)(lpVtbl[35]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetTextRenderingParams"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(37)]
    public readonly void GetTextRenderingParams(IDWriteRenderingParams** textRenderingParams)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, IDWriteRenderingParams**, void>)(lpVtbl[37]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this), textRenderingParams);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.SetTags"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(38)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetTags"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(39)]
    public readonly void GetTags([NativeTypeName("D2D1_TAG *")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG *")] ulong* tag2 = null)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ulong*, ulong*, void>)(lpVtbl[39]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this), tag1, tag2);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.PushLayer"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(40)]
    public void PushLayer([NativeTypeName("const D2D1_LAYER_PARAMETERS *")] D2D1_LAYER_PARAMETERS* layerParameters, ID2D1Layer* layer)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_LAYER_PARAMETERS*, ID2D1Layer*, void>)(lpVtbl[40]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), layerParameters, layer);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.PopLayer"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(41)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.Flush"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(42)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.SaveDrawingState"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(43)]
    public readonly void SaveDrawingState(ID2D1DrawingStateBlock* drawingStateBlock)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ID2D1DrawingStateBlock*, void>)(lpVtbl[43]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this), drawingStateBlock);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.RestoreDrawingState"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(44)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.PushAxisAlignedClip"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(45)]
    public void PushAxisAlignedClip([NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* clipRect, D2D1_ANTIALIAS_MODE antialiasMode)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[45]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.PopAxisAlignedClip"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(46)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.Clear"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(47)]
    public void Clear([NativeTypeName("const D2D1_COLOR_F *")] DXGI_RGBA* clearColor = null)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, DXGI_RGBA*, void>)(lpVtbl[47]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), clearColor);
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.BeginDraw"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(48)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.EndDraw"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(49)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetPixelFormat"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(50)]
    public readonly D2D1_PIXEL_FORMAT GetPixelFormat()
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_PIXEL_FORMAT>)(lpVtbl[50]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this));
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.SetDpi"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(51)]
    ...
    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetDpi"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(52)]
    public readonly void GetDpi(float* dpiX, float* dpiY)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, float*, float*, void>)(lpVtbl[52]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this), dpiX, dpiY);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_SIZE_F>)(lpVtbl[53]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this));
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetPixelSize"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(54)]
    [return: NativeTypeName("D2D1_SIZE_U")]
    public readonly D2D_SIZE_U GetPixelSize()
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D_SIZE_U>)(lpVtbl[54]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this));
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.GetMaximumBitmapSize"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(55)]
    [return: NativeTypeName("UINT32")]
    public readonly uint GetMaximumBitmapSize()
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, uint>)(lpVtbl[55]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this));
    }

    /// <include file='ID2D1RenderTarget.xml' path='doc/member[@name="ID2D1RenderTarget.IsSupported"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(56)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1RenderTarget*)Unsafe.AsPointer(in this), renderTargetProperties);
    }

    public interface Interface : ID2D1Resource.Interface
    {
        [VtblIndex(4)]
        HRESULT CreateBitmap([NativeTypeName("D2D1_SIZE_U")] D2D_SIZE_U size, [NativeTypeName("const void *")] void* srcData, [NativeTypeName("UINT32")] uint pitch, [NativeTypeName("const D2D1_BITMAP_PROPERTIES *")] D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);

        [VtblIndex(5)]
        HRESULT CreateBitmapFromWicBitmap(IWICBitmapSource* wicBitmapSource, [NativeTypeName("const D2D1_BITMAP_PROPERTIES *")] D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);

        [VtblIndex(6)]
        HRESULT CreateSharedBitmap([NativeTypeName("const IID &")] Guid* riid, void* data, [NativeTypeName("const D2D1_BITMAP_PROPERTIES *")] D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);

        [VtblIndex(7)]
        HRESULT CreateBitmapBrush(ID2D1Bitmap* bitmap, [NativeTypeName("const D2D1_BITMAP_BRUSH_PROPERTIES *")] D2D1_BITMAP_BRUSH_PROPERTIES* bitmapBrushProperties, [NativeTypeName("const D2D1_BRUSH_PROPERTIES *")] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1BitmapBrush** bitmapBrush);

        [VtblIndex(8)]
        HRESULT CreateSolidColorBrush([NativeTypeName("const D2D1_COLOR_F *")] DXGI_RGBA* color, [NativeTypeName("const D2D1_BRUSH_PROPERTIES *")] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1SolidColorBrush** solidColorBrush);

        [VtblIndex(9)]
        HRESULT CreateGradientStopCollection([NativeTypeName("const D2D1_GRADIENT_STOP *")] D2D1_GRADIENT_STOP* gradientStops, [NativeTypeName("UINT32")] uint gradientStopsCount, D2D1_GAMMA colorInterpolationGamma, D2D1_EXTEND_MODE extendMode, ID2D1GradientStopCollection** gradientStopCollection);

        [VtblIndex(10)]
        HRESULT CreateLinearGradientBrush([NativeTypeName("const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *")] D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES* linearGradientBrushProperties, [NativeTypeName("const D2D1_BRUSH_PROPERTIES *")] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1GradientStopCollection* gradientStopCollection, ID2D1LinearGradientBrush** linearGradientBrush);

        [VtblIndex(11)]
        HRESULT CreateRadialGradientBrush([NativeTypeName("const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *")] D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES* radialGradientBrushProperties, [NativeTypeName("const D2D1_BRUSH_PROPERTIES *")] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1GradientStopCollection* gradientStopCollection, ID2D1RadialGradientBrush** radialGradientBrush);

        [VtblIndex(12)]
        HRESULT CreateCompatibleRenderTarget([NativeTypeName("const D2D1_SIZE_F *")] D2D_SIZE_F* desiredSize, [NativeTypeName("const D2D1_SIZE_U *")] D2D_SIZE_U* desiredPixelSize, [NativeTypeName("const D2D1_PIXEL_FORMAT *")] D2D1_PIXEL_FORMAT* desiredFormat, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS options, ID2D1BitmapRenderTarget** bitmapRenderTarget);

        [VtblIndex(13)]
        HRESULT CreateLayer([NativeTypeName("const D2D1_SIZE_F *")] D2D_SIZE_F* size, ID2D1Layer** layer);
        ...
        [VtblIndex(26)]
        void DrawBitmap(ID2D1Bitmap* bitmap, [NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* destinationRectangle = null, float opacity = 1.0f, D2D1_BITMAP_INTERPOLATION_MODE interpolationMode = D2D1_BITMAP_INTERPOLATION_MODE_LINEAR, [NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* sourceRectangle = null);

        [VtblIndex(27)]
        void DrawText([NativeTypeName("const WCHAR *")] char* @string, [NativeTypeName("UINT32")] uint stringLength, IDWriteTextFormat* textFormat, [NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* layoutRect, ID2D1Brush* defaultFillBrush, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL);

        [VtblIndex(28)]
        void DrawTextLayout([NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F origin, IDWriteTextLayout* textLayout, ID2D1Brush* defaultFillBrush, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE);

        [VtblIndex(29)]
        void DrawGlyphRun([NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, [NativeTypeName("const DWRITE_GLYPH_RUN *")] DWRITE_GLYPH_RUN* glyphRun, ID2D1Brush* foregroundBrush, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL);
        ...
        [VtblIndex(42)]
        HRESULT Flush([NativeTypeName("D2D1_TAG *")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG *")] ulong* tag2 = null);
        ...
        [VtblIndex(47)]
        void Clear([NativeTypeName("const D2D1_COLOR_F *")] DXGI_RGBA* clearColor = null);

        [VtblIndex(48)]
        void BeginDraw();

        [VtblIndex(49)]
        HRESULT EndDraw([NativeTypeName("D2D1_TAG *")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG *")] ulong* tag2 = null);
