...
public unsafe partial struct ID2D1GeometrySink : ID2D1GeometrySink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1GeometrySink;
