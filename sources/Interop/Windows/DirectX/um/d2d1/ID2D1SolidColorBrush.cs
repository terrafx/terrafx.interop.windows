...
public unsafe partial struct ID2D1SolidColorBrush : ID2D1SolidColorBrush.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1SolidColorBrush;
