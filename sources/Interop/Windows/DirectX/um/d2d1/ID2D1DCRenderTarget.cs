...
public unsafe partial struct ID2D1DCRenderTarget : ID2D1DCRenderTarget.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, IDWriteRenderingParams**, void>)(lpVtbl[37]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), textRenderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D1_PIXEL_FORMAT>)(lpVtbl[50]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_SIZE_F>)(lpVtbl[53]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_SIZE_U>)(lpVtbl[54]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), renderTargetProperties);
    }
