...
/// <include file='ID2D1DCRenderTarget.xml' path='doc/member[@name="ID2D1DCRenderTarget"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1DCRenderTarget);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this), factory);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[4]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), size, srcData, pitch, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[5]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, DXGI_RGBA*, D2D1_BRUSH_PROPERTIES*, ID2D1SolidColorBrush**, int>)(lpVtbl[8]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), color, brushProperties, solidColorBrush);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D1_GRADIENT_STOP*, uint, D2D1_GAMMA, D2D1_EXTEND_MODE, ID2D1GradientStopCollection**, int>)(lpVtbl[9]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode, gradientStopCollection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_SIZE_F*, D2D_SIZE_U*, D2D1_PIXEL_FORMAT*, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, ID2D1BitmapRenderTarget**, int>)(lpVtbl[12]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), desiredSize, desiredPixelSize, desiredFormat, options, bitmapRenderTarget);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_SIZE_F*, ID2D1Layer**, int>)(lpVtbl[13]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), size, layer);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_POINT_2F, D2D_POINT_2F, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[15]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), point0, point1, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_RECT_F*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_RECT_F*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), rect, brush);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, ID2D1Bitmap*, ID2D1Brush*, D2D1_OPACITY_MASK_CONTENT, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[25]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_BITMAP_INTERPOLATION_MODE, D2D_RECT_F*, void>)(lpVtbl[26]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, char*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void>)(lpVtbl[27]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutRect, defaultFillBrush, options, measuringMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, void>)(lpVtbl[28]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, options);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[29]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, foregroundBrush, measuringMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[30]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this), transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D1_ANTIALIAS_MODE>)(lpVtbl[33]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D1_TEXT_ANTIALIAS_MODE>)(lpVtbl[35]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, IDWriteRenderingParams*, void>)(lpVtbl[36]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), textRenderingParams);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, IDWriteRenderingParams**, void>)(lpVtbl[37]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this), textRenderingParams);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, ulong*, ulong*, void>)(lpVtbl[39]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this), tag1, tag2);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, ID2D1DrawingStateBlock*, void>)(lpVtbl[43]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this), drawingStateBlock);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[45]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, DXGI_RGBA*, void>)(lpVtbl[47]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), clearColor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D1_PIXEL_FORMAT>)(lpVtbl[50]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, float*, float*, void>)(lpVtbl[52]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this), dpiX, dpiY);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_SIZE_F>)(lpVtbl[53]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D_SIZE_U>)(lpVtbl[54]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, uint>)(lpVtbl[55]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(in this), renderTargetProperties);
    }

    /// <include file='ID2D1DCRenderTarget.xml' path='doc/member[@name="ID2D1DCRenderTarget.BindDC"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(57)]
    public HRESULT BindDC([NativeTypeName("const HDC")] HDC hDC, [NativeTypeName("const RECT *")] RECT* pSubRect)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DCRenderTarget*, HDC, RECT*, int>)(lpVtbl[57]))((ID2D1DCRenderTarget*)Unsafe.AsPointer(ref this), hDC, pSubRect);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, HDC, RECT*, int> BindDC;
    }
}
