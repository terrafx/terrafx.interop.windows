...
public unsafe partial struct ID2D1HwndRenderTarget : ID2D1HwndRenderTarget.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1HwndRenderTarget;
