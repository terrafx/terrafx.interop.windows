...
public unsafe partial struct ID2D1HwndRenderTarget : ID2D1HwndRenderTarget.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged<ID2D1HwndRenderTarget*, char*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void>)(lpVtbl[27]))((ID2D1HwndRenderTarget*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutRect, defaultFillBrush, options, measuringMode);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, D2D1_WINDOW_STATE> CheckWindowState;

        [NativeTypeName("HRESULT (const D2D1_SIZE_U *) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, D2D_SIZE_U*, int> Resize;

        [NativeTypeName("HWND () const __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, void*> GetHwnd;
    }
}
