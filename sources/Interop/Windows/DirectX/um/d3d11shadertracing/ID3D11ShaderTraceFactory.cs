...
public unsafe partial struct ID3D11ShaderTraceFactory : ID3D11ShaderTraceFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11ShaderTraceFactory;
