...
public unsafe partial struct ID3D11ShaderTrace : ID3D11ShaderTrace.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11ShaderTrace;
