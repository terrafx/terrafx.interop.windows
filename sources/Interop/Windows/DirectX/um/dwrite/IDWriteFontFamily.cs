...
public unsafe partial struct IDWriteFontFamily : IDWriteFontFamily.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontFamily;
