...
public unsafe partial struct IDWriteTextLayout : IDWriteTextLayout.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout*, BOOL, DWRITE_TEXT_RANGE, int>)(lpVtbl[36]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), hasUnderline, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout*, BOOL, DWRITE_TEXT_RANGE, int>)(lpVtbl[37]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), hasStrikethrough, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout*, uint, BOOL*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[51]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), currentPosition, hasUnderline, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout*, uint, BOOL*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[52]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), currentPosition, hasStrikethrough, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout*, float, float, BOOL*, BOOL*, DWRITE_HIT_TEST_METRICS*, int>)(lpVtbl[64]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), pointX, pointY, isTrailingHit, isInside, hitTestMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout*, uint, BOOL, float*, float*, DWRITE_HIT_TEST_METRICS*, int>)(lpVtbl[65]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), textPosition, isTrailingHit, pointX, pointY, hitTestMetrics);
    }
    ...
    public interface Interface : IDWriteTextFormat.Interface
    {
        ...
        [VtblIndex(31)]
        HRESULT SetFontFamilyName([NativeTypeName("const WCHAR *")] char* fontFamilyName, DWRITE_TEXT_RANGE textRange);
        ...
        [VtblIndex(41)]
        HRESULT SetLocaleName([NativeTypeName("const WCHAR *")] char* localeName, DWRITE_TEXT_RANGE textRange);
        ...
        [VtblIndex(46)]
        HRESULT GetFontFamilyName([NativeTypeName("UINT32")] uint currentPosition, [NativeTypeName("WCHAR *")] char* fontFamilyName, [NativeTypeName("UINT32")] uint nameSize, DWRITE_TEXT_RANGE* textRange = null);
        ...
        [VtblIndex(57)]
        HRESULT GetLocaleName([NativeTypeName("UINT32")] uint currentPosition, [NativeTypeName("WCHAR *")] char* localeName, [NativeTypeName("UINT32")] uint nameSize, DWRITE_TEXT_RANGE* textRange = null);
