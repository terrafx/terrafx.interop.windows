...
public unsafe partial struct IDWriteFactory : IDWriteFactory.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFactory;
