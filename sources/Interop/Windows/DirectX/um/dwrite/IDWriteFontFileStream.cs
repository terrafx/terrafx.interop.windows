...
public unsafe partial struct IDWriteFontFileStream : IDWriteFontFileStream.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontFileStream;
