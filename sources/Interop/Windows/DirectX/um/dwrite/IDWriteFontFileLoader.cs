...
public unsafe partial struct IDWriteFontFileLoader : IDWriteFontFileLoader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontFileLoader;
