...
public unsafe partial struct IDWriteInlineObject : IDWriteInlineObject.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteInlineObject;
