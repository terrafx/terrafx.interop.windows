...
public unsafe partial struct IDWriteTypography : IDWriteTypography.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteTypography;
