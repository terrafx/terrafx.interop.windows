...
public unsafe partial struct IDWriteTextAnalysisSink : IDWriteTextAnalysisSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteTextAnalysisSink;
