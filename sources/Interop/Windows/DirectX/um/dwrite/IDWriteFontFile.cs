...
public unsafe partial struct IDWriteFontFile : IDWriteFontFile.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontFile;
