...
public unsafe partial struct IDWriteFontCollectionLoader : IDWriteFontCollectionLoader.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontCollectionLoader;
