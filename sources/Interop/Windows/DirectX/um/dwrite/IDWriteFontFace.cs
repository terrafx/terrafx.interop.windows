...
public unsafe partial struct IDWriteFontFace : IDWriteFontFace.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontFace;
