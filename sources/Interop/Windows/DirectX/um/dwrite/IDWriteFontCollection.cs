...
public unsafe partial struct IDWriteFontCollection : IDWriteFontCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontCollection;
