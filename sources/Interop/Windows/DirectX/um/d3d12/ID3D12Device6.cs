...
public unsafe partial struct ID3D12Device6 : ID3D12Device6.Interface
{
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<ID3D12Device6*, uint>)(lpVtbl[7]))((ID3D12Device6*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        LUID result;
        return *((delegate* unmanaged[SuppressGCTransition]<ID3D12Device6*, LUID*, LUID*>)(lpVtbl[43]))((ID3D12Device6*)Unsafe.AsPointer(ref this), &result);
    }
    ...
    public partial struct Vtbl
    {
        ...
        public delegate* unmanaged[SuppressGCTransition]<ID3D12Device6*, uint> GetNodeCount;
        ...
        public delegate* unmanaged[SuppressGCTransition]<ID3D12Device6*, LUID*, LUID*> GetAdapterLuid;
