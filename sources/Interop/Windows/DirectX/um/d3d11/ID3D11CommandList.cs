...
public unsafe partial struct ID3D11CommandList : ID3D11CommandList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11CommandList;
