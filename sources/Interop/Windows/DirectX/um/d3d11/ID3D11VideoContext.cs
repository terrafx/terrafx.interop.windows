...
public unsafe partial struct ID3D11VideoContext : ID3D11VideoContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11VideoContext;
