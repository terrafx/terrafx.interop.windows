...
{
    public D3D11_RENDER_TARGET_VIEW_DESC(D3D11_RTV_DIMENSION viewDimension, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, uint mipSlice = 0, uint firstArraySlice = 0, uint arraySize = unchecked((uint)-1))
    {
        Format = format;
    ...
    public D3D11_RENDER_TARGET_VIEW_DESC(ID3D11Buffer* param0, DXGI_FORMAT format, uint firstElement, uint numElements)
    {
        Format = format;
    ...
    public D3D11_RENDER_TARGET_VIEW_DESC(ID3D11Texture1D* pTex1D, D3D11_RTV_DIMENSION viewDimension, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, uint mipSlice = 0, uint firstArraySlice = 0, uint arraySize = unchecked((uint)-1))
    {
        ViewDimension = viewDimension;
    ...
    public D3D11_RENDER_TARGET_VIEW_DESC(ID3D11Texture2D* pTex2D, D3D11_RTV_DIMENSION viewDimension, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, uint mipSlice = 0, uint firstArraySlice = 0, uint arraySize = unchecked((uint)-1))
    {
        ViewDimension = viewDimension;
    ...
    public D3D11_RENDER_TARGET_VIEW_DESC(ID3D11Texture3D* pTex3D, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, uint mipSlice = 0, uint firstWSlice = 0, uint wSize = unchecked((uint)-1))
    {
