...
public unsafe partial struct ID3D11ShaderResourceView : ID3D11ShaderResourceView.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11ShaderResourceView;
