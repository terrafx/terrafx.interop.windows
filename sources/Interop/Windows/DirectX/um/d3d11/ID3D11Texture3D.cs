...
/// <include file='ID3D11Texture3D.xml' path='doc/member[@name="ID3D11Texture3D"]/*' />
...
public unsafe partial struct ID3D11Texture3D : ID3D11Texture3D.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11Texture3D;
    ...
    /// <include file='ID3D11Texture3D.xml' path='doc/member[@name="ID3D11Texture3D.GetDesc"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(10)]
