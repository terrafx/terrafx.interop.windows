...
public unsafe partial struct ID3D11ClassInstance : ID3D11ClassInstance.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11ClassInstance*, sbyte*, nuint*, void>)(lpVtbl[9]))((ID3D11ClassInstance*)Unsafe.AsPointer(ref this), pInstanceName, pBufferLength);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11ClassInstance*, sbyte*, nuint*, void>)(lpVtbl[10]))((ID3D11ClassInstance*)Unsafe.AsPointer(ref this), pTypeName, pBufferLength);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, sbyte*, nuint*, void> GetInstanceName;

        [NativeTypeName("void (LPSTR, SIZE_T *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, sbyte*, nuint*, void> GetTypeName;
    }
}
