...
public unsafe partial struct ID3D11RenderTargetView : ID3D11RenderTargetView.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11RenderTargetView;
