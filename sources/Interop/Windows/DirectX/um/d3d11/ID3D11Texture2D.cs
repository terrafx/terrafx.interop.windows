...
public unsafe partial struct ID3D11Texture2D : ID3D11Texture2D.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11Texture2D;
