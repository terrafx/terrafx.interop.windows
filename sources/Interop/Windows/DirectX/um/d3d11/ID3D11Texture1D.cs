...
public unsafe partial struct ID3D11Texture1D : ID3D11Texture1D.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Texture1D*, D3D11_RESOURCE_DIMENSION*, void>)(lpVtbl[7]))((ID3D11Texture1D*)Unsafe.AsPointer(ref this), pResourceDimension);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Texture1D*, D3D11_TEXTURE1D_DESC*, void>)(lpVtbl[10]))((ID3D11Texture1D*)Unsafe.AsPointer(ref this), pDesc);
    }
