...
public unsafe partial struct ID3D11Texture1D : ID3D11Texture1D.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11Texture1D;
