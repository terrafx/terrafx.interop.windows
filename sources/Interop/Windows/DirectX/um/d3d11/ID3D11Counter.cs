...
/// <include file='ID3D11Counter.xml' path='doc/member[@name="ID3D11Counter"]/*' />
...
public unsafe partial struct ID3D11Counter : ID3D11Counter.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11Counter;
    ...
    /// <include file='ID3D11Counter.xml' path='doc/member[@name="ID3D11Counter.GetDesc"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(8)]
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, D3D11_COUNTER_DESC*, void> GetDesc;
    }
}
