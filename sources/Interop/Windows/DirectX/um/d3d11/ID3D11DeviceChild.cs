...
public unsafe partial struct ID3D11DeviceChild : ID3D11DeviceChild.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11DeviceChild;
