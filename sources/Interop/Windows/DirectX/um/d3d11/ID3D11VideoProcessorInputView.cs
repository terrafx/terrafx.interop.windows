...
/// <include file='ID3D11VideoProcessorInputView.xml' path='doc/member[@name="ID3D11VideoProcessorInputView"]/*' />
...
public unsafe partial struct ID3D11VideoProcessorInputView : ID3D11VideoProcessorInputView.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11VideoProcessorInputView;
    ...
    /// <include file='ID3D11VideoProcessorInputView.xml' path='doc/member[@name="ID3D11VideoProcessorInputView.GetDesc"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(8)]
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, D3D11_VIDEO_PROCESSOR_INPUT_VIEW_DESC*, void> GetDesc;
    }
}
