...
public unsafe partial struct ID3D11VideoDevice : ID3D11VideoDevice.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11VideoDevice;
