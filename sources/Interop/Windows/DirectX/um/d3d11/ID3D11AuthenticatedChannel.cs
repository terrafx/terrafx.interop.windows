...
public unsafe partial struct ID3D11AuthenticatedChannel : ID3D11AuthenticatedChannel.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11AuthenticatedChannel;
