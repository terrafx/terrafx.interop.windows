...
public unsafe partial struct ID3D11VideoProcessor : ID3D11VideoProcessor.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11VideoProcessor;
