...
public unsafe partial struct ID3D11DeviceContext : ID3D11DeviceContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11DeviceContext;
