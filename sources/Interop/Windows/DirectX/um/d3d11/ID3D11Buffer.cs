...
/// <include file='ID3D11Buffer.xml' path='doc/member[@name="ID3D11Buffer"]/*' />
...
public unsafe partial struct ID3D11Buffer : ID3D11Buffer.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11Buffer;
    ...
    /// <include file='ID3D11Buffer.xml' path='doc/member[@name="ID3D11Buffer.GetDesc"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(10)]
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, D3D11_BUFFER_DESC*, void> GetDesc;
    }
}
