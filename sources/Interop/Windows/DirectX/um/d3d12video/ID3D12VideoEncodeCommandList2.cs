...
public unsafe partial struct ID3D12VideoEncodeCommandList2 : ID3D12VideoEncodeCommandList2.Interface
{
    public void** lpVtbl;
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<ID3D12VideoEncodeCommandList2*, D3D12_COMMAND_LIST_TYPE>)(lpVtbl[8]))((ID3D12VideoEncodeCommandList2*)Unsafe.AsPointer(ref this));
    }
