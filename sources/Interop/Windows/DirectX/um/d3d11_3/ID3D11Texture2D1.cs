...
public unsafe partial struct ID3D11Texture2D1 : ID3D11Texture2D1.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11Texture2D1;
