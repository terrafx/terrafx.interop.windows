...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D11Texture2D1);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Texture2D1*, D3D11_RESOURCE_DIMENSION*, void>)(lpVtbl[7]))((ID3D11Texture2D1*)Unsafe.AsPointer(ref this), pResourceDimension);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Texture2D1*, D3D11_TEXTURE2D_DESC*, void>)(lpVtbl[10]))((ID3D11Texture2D1*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Texture2D1*, D3D11_TEXTURE2D_DESC1*, void>)(lpVtbl[11]))((ID3D11Texture2D1*)Unsafe.AsPointer(ref this), pDesc);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_TEXTURE2D_DESC1*, void> GetDesc1;
    }
}
