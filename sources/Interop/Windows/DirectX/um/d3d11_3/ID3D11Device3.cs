...
// Ported from um/d3d11_3.h in the Windows SDK for Windows 10.0.28000.0
...
/// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D11Device3);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_BUFFER_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Buffer**, int>)(lpVtbl[3]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppBuffer);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_TEXTURE1D_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture1D**, int>)(lpVtbl[4]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppTexture1D);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_TEXTURE2D_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture2D**, int>)(lpVtbl[5]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppTexture2D);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_TEXTURE3D_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture3D**, int>)(lpVtbl[6]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppTexture3D);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, D3D11_SHADER_RESOURCE_VIEW_DESC*, ID3D11ShaderResourceView**, int>)(lpVtbl[7]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pResource, pDesc, ppSRView);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, D3D11_UNORDERED_ACCESS_VIEW_DESC*, ID3D11UnorderedAccessView**, int>)(lpVtbl[8]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pResource, pDesc, ppUAView);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, D3D11_RENDER_TARGET_VIEW_DESC*, ID3D11RenderTargetView**, int>)(lpVtbl[9]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pResource, pDesc, ppRTView);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, D3D11_DEPTH_STENCIL_VIEW_DESC*, ID3D11DepthStencilView**, int>)(lpVtbl[10]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pResource, pDesc, ppDepthStencilView);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_INPUT_ELEMENT_DESC*, uint, void*, nuint, ID3D11InputLayout**, int>)(lpVtbl[11]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pInputElementDescs, NumElements, pShaderBytecodeWithInputSignature, BytecodeLength, ppInputLayout);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_BLEND_DESC*, ID3D11BlendState**, int>)(lpVtbl[20]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pBlendStateDesc, ppBlendState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_DEPTH_STENCIL_DESC*, ID3D11DepthStencilState**, int>)(lpVtbl[21]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDepthStencilDesc, ppDepthStencilState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_RASTERIZER_DESC*, ID3D11RasterizerState**, int>)(lpVtbl[22]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pRasterizerDesc, ppRasterizerState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_SAMPLER_DESC*, ID3D11SamplerState**, int>)(lpVtbl[23]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pSamplerDesc, ppSamplerState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_QUERY_DESC*, ID3D11Query**, int>)(lpVtbl[24]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pQueryDesc, ppQuery);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_QUERY_DESC*, ID3D11Predicate**, int>)(lpVtbl[25]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pPredicateDesc, ppPredicate);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_COUNTER_DESC*, ID3D11Counter**, int>)(lpVtbl[26]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pCounterDesc, ppCounter);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, DXGI_FORMAT, uint*, int>)(lpVtbl[29]))((ID3D11Device3*)Unsafe.AsPointer(ref this), Format, pFormatSupport);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, DXGI_FORMAT, uint, uint*, int>)(lpVtbl[30]))((ID3D11Device3*)Unsafe.AsPointer(ref this), Format, SampleCount, pNumQualityLevels);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_COUNTER_INFO*, void>)(lpVtbl[31]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pCounterInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_COUNTER_DESC*, D3D11_COUNTER_TYPE*, uint*, sbyte*, uint*, sbyte*, uint*, sbyte*, uint*, int>)(lpVtbl[32]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDesc, pType, pActiveCounters, szName, pNameLength, szUnits, pUnitsLength, szDescription, pDescriptionLength);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_FEATURE, void*, uint, int>)(lpVtbl[33]))((ID3D11Device3*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D_FEATURE_LEVEL>)(lpVtbl[37]))((ID3D11Device3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_BLEND_DESC1*, ID3D11BlendState1**, int>)(lpVtbl[45]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pBlendStateDesc, ppBlendState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_RASTERIZER_DESC1*, ID3D11RasterizerState1**, int>)(lpVtbl[46]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pRasterizerDesc, ppRasterizerState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, uint, D3D_FEATURE_LEVEL*, uint, uint, Guid*, D3D_FEATURE_LEVEL*, ID3DDeviceContextState**, int>)(lpVtbl[47]))((ID3D11Device3*)Unsafe.AsPointer(ref this), Flags, pFeatureLevels, FeatureLevels, SDKVersion, EmulatedInterface, pChosenFeatureLevel, ppContextState);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, DXGI_FORMAT, uint, uint, uint*, int>)(lpVtbl[53]))((ID3D11Device3*)Unsafe.AsPointer(ref this), Format, SampleCount, Flags, pNumQualityLevels);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateTexture2D1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(54)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_TEXTURE2D_DESC1*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture2D1**, int>)(lpVtbl[54]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDesc1, pInitialData, ppTexture2D);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateTexture3D1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(55)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_TEXTURE3D_DESC1*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture3D1**, int>)(lpVtbl[55]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDesc1, pInitialData, ppTexture3D);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateRasterizerState2"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(56)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_RASTERIZER_DESC2*, ID3D11RasterizerState2**, int>)(lpVtbl[56]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pRasterizerDesc, ppRasterizerState);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateShaderResourceView1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(57)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, D3D11_SHADER_RESOURCE_VIEW_DESC1*, ID3D11ShaderResourceView1**, int>)(lpVtbl[57]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pResource, pDesc1, ppSRView1);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateUnorderedAccessView1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(58)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, D3D11_UNORDERED_ACCESS_VIEW_DESC1*, ID3D11UnorderedAccessView1**, int>)(lpVtbl[58]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pResource, pDesc1, ppUAView1);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateRenderTargetView1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(59)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, D3D11_RENDER_TARGET_VIEW_DESC1*, ID3D11RenderTargetView1**, int>)(lpVtbl[59]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pResource, pDesc1, ppRTView1);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateQuery1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(60)]
    public HRESULT CreateQuery1([NativeTypeName("const D3D11_QUERY_DESC1 *")] D3D11_QUERY_DESC1* pQueryDesc1, ID3D11Query1** ppQuery1)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, D3D11_QUERY_DESC1*, ID3D11Query1**, int>)(lpVtbl[60]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pQueryDesc1, ppQuery1);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.GetImmediateContext3"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(61)]
    ...
    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.CreateDeferredContext3"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(62)]
    ...
    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.WriteToSubresource"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(63)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, ID3D11Resource*, uint, D3D11_BOX*, void*, uint, uint, void>)(lpVtbl[63]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDstResource, DstSubresource, pDstBox, pSrcData, SrcRowPitch, SrcDepthPitch);
    }

    /// <include file='ID3D11Device3.xml' path='doc/member[@name="ID3D11Device3.ReadFromSubresource"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(64)]
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Device3*, void*, uint, uint, ID3D11Resource*, uint, D3D11_BOX*, void>)(lpVtbl[64]))((ID3D11Device3*)Unsafe.AsPointer(ref this), pDstData, DstRowPitch, DstDepthPitch, pSrcResource, SrcSubresource, pSrcBox);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_INPUT_ELEMENT_DESC*, uint, void*, nuint, ID3D11InputLayout**, int> CreateInputLayout;

        [NativeTypeName("HRESULT (const void *, SIZE_T, ID3D11ClassLinkage *, ID3D11VertexShader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, nuint, ID3D11ClassLinkage*, ID3D11VertexShader**, int> CreateVertexShader;

        [NativeTypeName("HRESULT (const void *, SIZE_T, ID3D11ClassLinkage *, ID3D11GeometryShader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, nuint, ID3D11ClassLinkage*, ID3D11GeometryShader**, int> CreateGeometryShader;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, nuint, D3D11_SO_DECLARATION_ENTRY*, uint, uint*, uint, uint, ID3D11ClassLinkage*, ID3D11GeometryShader**, int> CreateGeometryShaderWithStreamOutput;

        [NativeTypeName("HRESULT (const void *, SIZE_T, ID3D11ClassLinkage *, ID3D11PixelShader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, nuint, ID3D11ClassLinkage*, ID3D11PixelShader**, int> CreatePixelShader;

        [NativeTypeName("HRESULT (const void *, SIZE_T, ID3D11ClassLinkage *, ID3D11HullShader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, nuint, ID3D11ClassLinkage*, ID3D11HullShader**, int> CreateHullShader;

        [NativeTypeName("HRESULT (const void *, SIZE_T, ID3D11ClassLinkage *, ID3D11DomainShader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, nuint, ID3D11ClassLinkage*, ID3D11DomainShader**, int> CreateDomainShader;

        [NativeTypeName("HRESULT (const void *, SIZE_T, ID3D11ClassLinkage *, ID3D11ComputeShader **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, nuint, ID3D11ClassLinkage*, ID3D11ComputeShader**, int> CreateComputeShader;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11DeviceContext1**, void> GetImmediateContext1;

        [NativeTypeName("HRESULT (UINT, ID3D11DeviceContext1 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, ID3D11DeviceContext1**, int> CreateDeferredContext1;

        [NativeTypeName("HRESULT (const D3D11_BLEND_DESC1 *, ID3D11BlendState1 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_BLEND_DESC1*, ID3D11BlendState1**, int> CreateBlendState1;

        [NativeTypeName("HRESULT (const D3D11_RASTERIZER_DESC1 *, ID3D11RasterizerState1 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_RASTERIZER_DESC1*, ID3D11RasterizerState1**, int> CreateRasterizerState1;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, D3D_FEATURE_LEVEL*, uint, uint, Guid*, D3D_FEATURE_LEVEL*, ID3DDeviceContextState**, int> CreateDeviceContextState;

        [NativeTypeName("HRESULT (HANDLE, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, HANDLE, Guid*, void**, int> OpenSharedResource1;

        [NativeTypeName("HRESULT (LPCWSTR, DWORD, const IID &, void **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, uint, Guid*, void**, int> OpenSharedResourceByName;

        [NativeTypeName("void (ID3D11DeviceContext2 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11DeviceContext2**, void> GetImmediateContext2;

        [NativeTypeName("HRESULT (UINT, ID3D11DeviceContext2 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, ID3D11DeviceContext2**, int> CreateDeferredContext2;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11Resource*, uint*, D3D11_PACKED_MIP_DESC*, D3D11_TILE_SHAPE*, uint*, uint, D3D11_SUBRESOURCE_TILING*, void> GetResourceTiling;

        [NativeTypeName("HRESULT (DXGI_FORMAT, UINT, UINT, UINT *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, DXGI_FORMAT, uint, uint, uint*, int> CheckMultisampleQualityLevels1;

        [NativeTypeName("HRESULT (const D3D11_TEXTURE2D_DESC1 *, const D3D11_SUBRESOURCE_DATA *, ID3D11Texture2D1 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_TEXTURE2D_DESC1*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture2D1**, int> CreateTexture2D1;

        [NativeTypeName("HRESULT (const D3D11_TEXTURE3D_DESC1 *, const D3D11_SUBRESOURCE_DATA *, ID3D11Texture3D1 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_TEXTURE3D_DESC1*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture3D1**, int> CreateTexture3D1;

        [NativeTypeName("HRESULT (const D3D11_RASTERIZER_DESC2 *, ID3D11RasterizerState2 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_RASTERIZER_DESC2*, ID3D11RasterizerState2**, int> CreateRasterizerState2;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11Resource*, D3D11_SHADER_RESOURCE_VIEW_DESC1*, ID3D11ShaderResourceView1**, int> CreateShaderResourceView1;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11Resource*, D3D11_UNORDERED_ACCESS_VIEW_DESC1*, ID3D11UnorderedAccessView1**, int> CreateUnorderedAccessView1;

        [NativeTypeName("HRESULT (ID3D11Resource *, const D3D11_RENDER_TARGET_VIEW_DESC1 *, ID3D11RenderTargetView1 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11Resource*, D3D11_RENDER_TARGET_VIEW_DESC1*, ID3D11RenderTargetView1**, int> CreateRenderTargetView1;

        [NativeTypeName("HRESULT (const D3D11_QUERY_DESC1 *, ID3D11Query1 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_QUERY_DESC1*, ID3D11Query1**, int> CreateQuery1;

        [NativeTypeName("void (ID3D11DeviceContext3 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11DeviceContext3**, void> GetImmediateContext3;

        [NativeTypeName("HRESULT (UINT, ID3D11DeviceContext3 **) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, ID3D11DeviceContext3**, int> CreateDeferredContext3;

        [NativeTypeName("void (ID3D11Resource *, UINT, const D3D11_BOX *, const void *, UINT, UINT) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, ID3D11Resource*, uint, D3D11_BOX*, void*, uint, uint, void> WriteToSubresource;

        [NativeTypeName("void (void *, UINT, UINT, ID3D11Resource *, UINT, const D3D11_BOX *) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, void*, uint, uint, ID3D11Resource*, uint, D3D11_BOX*, void> ReadFromSubresource;
    }
}
