...
/// <include file='ID3D11UnorderedAccessView1.xml' path='doc/member[@name="ID3D11UnorderedAccessView1"]/*' />
...
public unsafe partial struct ID3D11UnorderedAccessView1 : ID3D11UnorderedAccessView1.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11UnorderedAccessView1;
    ...
    /// <include file='ID3D11UnorderedAccessView1.xml' path='doc/member[@name="ID3D11UnorderedAccessView1.GetDesc1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(9)]
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, D3D11_UNORDERED_ACCESS_VIEW_DESC*, void> GetDesc;

        [NativeTypeName("void (D3D11_UNORDERED_ACCESS_VIEW_DESC1 *) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, D3D11_UNORDERED_ACCESS_VIEW_DESC1*, void> GetDesc1;
    }
}
