...
public unsafe partial struct ID3D11DeviceContext4 : ID3D11DeviceContext4.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged<ID3D11DeviceContext4*, char*, int, void>)(lpVtbl[141]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), pLabel, Data);
    }
    ...
    {
        ((delegate* unmanaged<ID3D11DeviceContext4*, char*, int, void>)(lpVtbl[142]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), pLabel, Data);
    }
