...
/// <include file='ID3D11RenderTargetView1.xml' path='doc/member[@name="ID3D11RenderTargetView1"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D11RenderTargetView1);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11RenderTargetView1*, D3D11_RENDER_TARGET_VIEW_DESC*, void>)(lpVtbl[8]))((ID3D11RenderTargetView1*)Unsafe.AsPointer(ref this), pDesc);
    }

    /// <include file='ID3D11RenderTargetView1.xml' path='doc/member[@name="ID3D11RenderTargetView1.GetDesc1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(9)]
    public void GetDesc1(D3D11_RENDER_TARGET_VIEW_DESC1* pDesc1)
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11RenderTargetView1*, D3D11_RENDER_TARGET_VIEW_DESC1*, void>)(lpVtbl[9]))((ID3D11RenderTargetView1*)Unsafe.AsPointer(ref this), pDesc1);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, D3D11_RENDER_TARGET_VIEW_DESC1*, void> GetDesc1;
    }
}
