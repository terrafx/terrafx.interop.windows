...
public unsafe partial struct ID3D10EffectShaderResourceVariable : ID3D10EffectShaderResourceVariable.Interface
{
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, ID3D10ShaderResourceView*, int> SetResource;

        [NativeTypeName("HRESULT (ID3D10ShaderResourceView **) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ID3D10ShaderResourceView**, int> GetResource;

        [NativeTypeName("HRESULT (ID3D10ShaderResourceView **, UINT, UINT) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ID3D10ShaderResourceView**, uint, uint, int> SetResourceArray;

        [NativeTypeName("HRESULT (ID3D10ShaderResourceView **, UINT, UINT) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ID3D10ShaderResourceView**, uint, uint, int> GetResourceArray;
    }
}
