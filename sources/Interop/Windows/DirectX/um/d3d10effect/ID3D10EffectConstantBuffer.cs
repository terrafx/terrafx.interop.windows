...
public unsafe partial struct ID3D10EffectConstantBuffer : ID3D10EffectConstantBuffer.Interface
{
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, ID3D10Buffer*, int> SetConstantBuffer;

        [NativeTypeName("HRESULT (ID3D10Buffer **) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ID3D10Buffer**, int> GetConstantBuffer;

        [NativeTypeName("HRESULT (ID3D10ShaderResourceView *) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ID3D10ShaderResourceView*, int> SetTextureBuffer;

        [NativeTypeName("HRESULT (ID3D10ShaderResourceView **) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ID3D10ShaderResourceView**, int> GetTextureBuffer;
    }
}
