...
public unsafe partial struct ID3D10EffectDepthStencilViewVariable : ID3D10EffectDepthStencilViewVariable.Interface
{
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, ID3D10DepthStencilView**, uint, uint, int> SetDepthStencilArray;

        [NativeTypeName("HRESULT (ID3D10DepthStencilView **, UINT, UINT) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged<TSelf*, ID3D10DepthStencilView**, uint, uint, int> GetDepthStencilArray;
    }
}
