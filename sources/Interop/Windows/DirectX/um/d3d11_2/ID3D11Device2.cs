...
// Ported from um/d3d11_2.h in the Windows SDK for Windows 10.0.28000.0
...
/// <include file='ID3D11Device2.xml' path='doc/member[@name="ID3D11Device2"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D11Device2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device2*, D3D11_COUNTER_DESC*, D3D11_COUNTER_TYPE*, uint*, sbyte*, uint*, sbyte*, uint*, sbyte*, uint*, int>)(lpVtbl[32]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pDesc, pType, pActiveCounters, szName, pNameLength, szUnits, pUnitsLength, szDescription, pDescriptionLength);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device2*, D3D11_FEATURE, void*, uint, int>)(lpVtbl[33]))((ID3D11Device2*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
    }
    ...
    /// <include file='ID3D11Device2.xml' path='doc/member[@name="ID3D11Device2.GetImmediateContext2"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(50)]
    ...
    /// <include file='ID3D11Device2.xml' path='doc/member[@name="ID3D11Device2.CreateDeferredContext2"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(51)]
    ...
    /// <include file='ID3D11Device2.xml' path='doc/member[@name="ID3D11Device2.GetResourceTiling"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(52)]
    ...
    /// <include file='ID3D11Device2.xml' path='doc/member[@name="ID3D11Device2.CheckMultisampleQualityLevels1"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(53)]
