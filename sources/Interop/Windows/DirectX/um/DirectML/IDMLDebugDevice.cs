...
public unsafe partial struct IDMLDebugDevice : IDMLDebugDevice.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDMLDebugDevice;
