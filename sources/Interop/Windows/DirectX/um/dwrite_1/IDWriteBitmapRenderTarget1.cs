...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDWriteBitmapRenderTarget1);
    ...
    {
        return ((HDC)(((delegate* unmanaged[MemberFunction]<IDWriteBitmapRenderTarget1*, void*>)(lpVtbl[4]))((IDWriteBitmapRenderTarget1*)Unsafe.AsPointer(ref this))));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteBitmapRenderTarget1*, DWRITE_MATRIX*, int>)(lpVtbl[7]))((IDWriteBitmapRenderTarget1*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteBitmapRenderTarget1*, DWRITE_MATRIX*, int>)(lpVtbl[8]))((IDWriteBitmapRenderTarget1*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteBitmapRenderTarget1*, SIZE*, int>)(lpVtbl[9]))((IDWriteBitmapRenderTarget1*)Unsafe.AsPointer(ref this), size);
    }
