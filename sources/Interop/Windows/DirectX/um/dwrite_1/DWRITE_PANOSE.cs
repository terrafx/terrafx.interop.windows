...
public unsafe partial struct DWRITE_PANOSE
{
    ...
    [FieldOffset(0)]
    [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.20348.0/um/dwrite_1.h:758:5)")]
    public _text_e__Struct text;

    /// <include file='DWRITE_PANOSE.xml' path='doc/member[@name="DWRITE_PANOSE.script"]/*' />
    [FieldOffset(0)]
    [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.20348.0/um/dwrite_1.h:772:5)")]
    public _script_e__Struct script;

    /// <include file='DWRITE_PANOSE.xml' path='doc/member[@name="DWRITE_PANOSE.decorative"]/*' />
    [FieldOffset(0)]
    [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.20348.0/um/dwrite_1.h:786:5)")]
    public _decorative_e__Struct decorative;

    /// <include file='DWRITE_PANOSE.xml' path='doc/member[@name="DWRITE_PANOSE.symbol"]/*' />
    [FieldOffset(0)]
    [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.20348.0/um/dwrite_1.h:800:5)")]
