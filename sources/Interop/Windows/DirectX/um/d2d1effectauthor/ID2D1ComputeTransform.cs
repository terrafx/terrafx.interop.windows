...
public unsafe partial struct ID2D1ComputeTransform : ID2D1ComputeTransform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1ComputeTransform;
