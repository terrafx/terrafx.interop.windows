...
public unsafe partial struct ID2D1DrawTransform : ID2D1DrawTransform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1DrawTransform;
