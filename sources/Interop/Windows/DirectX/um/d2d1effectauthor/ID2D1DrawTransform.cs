...
// Ported from um/d2d1effectauthor.h in the Windows SDK for Windows 10.0.28000.0
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1DrawTransform);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DrawTransform*, uint>)(lpVtbl[3]))((ID2D1DrawTransform*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DrawTransform*, RECT*, RECT*, uint, int>)(lpVtbl[4]))((ID2D1DrawTransform*)Unsafe.AsPointer(in this), outputRect, inputRects, inputRectsCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DrawTransform*, uint, RECT, RECT*, int>)(lpVtbl[6]))((ID2D1DrawTransform*)Unsafe.AsPointer(in this), inputIndex, invalidInputRect, invalidOutputRect);
    }
