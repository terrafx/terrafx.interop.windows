...
public unsafe partial struct ID2D1Transform : ID2D1Transform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1Transform;
