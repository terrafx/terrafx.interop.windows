...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1DrawInfo);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DrawInfo*, BOOL, void>)(lpVtbl[5]))((ID2D1DrawInfo*)Unsafe.AsPointer(ref this), isCached);
    }
