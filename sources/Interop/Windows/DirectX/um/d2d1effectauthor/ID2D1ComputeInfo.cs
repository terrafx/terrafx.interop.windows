...
public unsafe partial struct ID2D1ComputeInfo : ID2D1ComputeInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1ComputeInfo;
