...
public unsafe partial struct ID2D1OffsetTransform : ID2D1OffsetTransform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1OffsetTransform;
