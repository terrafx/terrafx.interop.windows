...
public unsafe partial struct ID2D1EffectContext : ID2D1EffectContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1EffectContext;
