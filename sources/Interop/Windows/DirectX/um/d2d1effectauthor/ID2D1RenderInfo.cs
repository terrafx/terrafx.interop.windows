...
public unsafe partial struct ID2D1RenderInfo : ID2D1RenderInfo.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1RenderInfo;
