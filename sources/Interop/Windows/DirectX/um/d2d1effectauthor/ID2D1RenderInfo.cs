...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1RenderInfo);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1RenderInfo*, BOOL, void>)(lpVtbl[5]))((ID2D1RenderInfo*)Unsafe.AsPointer(ref this), isCached);
    }
