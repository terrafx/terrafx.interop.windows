...
public unsafe partial struct ID2D1AnalysisTransform : ID2D1AnalysisTransform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1AnalysisTransform;
