...
public unsafe partial struct ID2D1ConcreteTransform : ID2D1ConcreteTransform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1ConcreteTransform;
