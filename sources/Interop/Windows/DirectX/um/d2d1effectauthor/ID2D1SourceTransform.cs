...
public unsafe partial struct ID2D1SourceTransform : ID2D1SourceTransform.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1SourceTransform;
