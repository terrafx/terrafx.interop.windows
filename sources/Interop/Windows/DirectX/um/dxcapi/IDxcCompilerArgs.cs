...
public unsafe partial struct IDxcCompilerArgs : IDxcCompilerArgs.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDxcCompilerArgs;
