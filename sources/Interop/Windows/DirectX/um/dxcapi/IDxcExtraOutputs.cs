...
public unsafe partial struct IDxcExtraOutputs : IDxcExtraOutputs.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDxcExtraOutputs;
