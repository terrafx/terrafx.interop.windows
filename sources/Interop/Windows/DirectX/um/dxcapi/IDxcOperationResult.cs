...
public unsafe partial struct IDxcOperationResult : IDxcOperationResult.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDxcOperationResult;
