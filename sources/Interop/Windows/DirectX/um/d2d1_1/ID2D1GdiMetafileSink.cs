...
public unsafe partial struct ID2D1GdiMetafileSink : ID2D1GdiMetafileSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1GdiMetafileSink;
