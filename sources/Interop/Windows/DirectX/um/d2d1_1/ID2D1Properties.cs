...
public unsafe partial struct ID2D1Properties : ID2D1Properties.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1Properties;
