...
public unsafe partial struct ID2D1ImageBrush : ID2D1ImageBrush.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1ImageBrush;
