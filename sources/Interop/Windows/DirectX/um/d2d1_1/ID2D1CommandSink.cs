...
public unsafe partial struct ID2D1CommandSink : ID2D1CommandSink.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1CommandSink;
