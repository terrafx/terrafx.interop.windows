...
public unsafe partial struct ID2D1CommandList : ID2D1CommandList.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1CommandList;
