...
public unsafe partial struct ID2D1ColorContext : ID2D1ColorContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1ColorContext;
