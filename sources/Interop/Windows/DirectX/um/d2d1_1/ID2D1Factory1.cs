...
/// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1Factory1);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, D2D_RECT_F*, ID2D1RectangleGeometry**, int>)(lpVtbl[5]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), rectangle, rectangleGeometry);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, D2D1_FILL_MODE, ID2D1Geometry**, uint, ID2D1GeometryGroup**, int>)(lpVtbl[8]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), fillMode, geometries, geometriesCount, geometryGroup);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, ID2D1Geometry*, D2D_MATRIX_3X2_F*, ID2D1TransformedGeometry**, int>)(lpVtbl[9]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), sourceGeometry, transform, transformedGeometry);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, D2D1_DRAWING_STATE_DESCRIPTION*, IDWriteRenderingParams*, ID2D1DrawingStateBlock**, int>)(lpVtbl[12]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), drawingStateDescription, textRenderingParams, drawingStateBlock);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, IWICBitmap*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1RenderTarget**, int>)(lpVtbl[13]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), target, renderTargetProperties, renderTarget);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, IDXGISurface*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1RenderTarget**, int>)(lpVtbl[15]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), dxgiSurface, renderTargetProperties, renderTarget);
    }
    ...
    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.CreateDevice"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(17)]
    public HRESULT CreateDevice(IDXGIDevice* dxgiDevice, ID2D1Device** d2dDevice)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, IDXGIDevice*, ID2D1Device**, int>)(lpVtbl[17]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), dxgiDevice, d2dDevice);
    }

    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.CreateStrokeStyle"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(18)]
    ...
    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.CreatePathGeometry"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(19)]
    ...
    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.CreateDrawingStateBlock"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(20)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, D2D1_DRAWING_STATE_DESCRIPTION1*, IDWriteRenderingParams*, ID2D1DrawingStateBlock1**, int>)(lpVtbl[20]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), drawingStateDescription, textRenderingParams, drawingStateBlock);
    }

    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.CreateGdiMetafile"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(21)]
    public HRESULT CreateGdiMetafile(IStream* metafileStream, ID2D1GdiMetafile** metafile)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, IStream*, ID2D1GdiMetafile**, int>)(lpVtbl[21]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), metafileStream, metafile);
    }

    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.RegisterEffectFromStream"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(22)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, Guid*, IStream*, D2D1_PROPERTY_BINDING*, uint, delegate* unmanaged<IUnknown**, HRESULT>, int>)(lpVtbl[22]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), classId, propertyXml, bindings, bindingsCount, effectFactory);
    }

    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.RegisterEffectFromString"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(23)]
    ...
    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.UnregisterEffect"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(24)]
    ...
    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.GetRegisteredEffects"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(25)]
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, Guid*, uint, uint*, uint*, int>)(lpVtbl[25]))((ID2D1Factory1*)Unsafe.AsPointer(in this), effects, effectsCount, effectsReturned, effectsRegistered);
    }

    /// <include file='ID2D1Factory1.xml' path='doc/member[@name="ID2D1Factory1.GetEffectProperties"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(26)]
    public readonly HRESULT GetEffectProperties([NativeTypeName("const IID &")] Guid* effectId, ID2D1Properties** properties)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Factory1*, Guid*, ID2D1Properties**, int>)(lpVtbl[26]))((ID2D1Factory1*)Unsafe.AsPointer(in this), effectId, properties);
    }
