...
public unsafe partial struct ID2D1Factory1 : ID2D1Factory1.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ID2D1Factory1*, Guid*, char*, D2D1_PROPERTY_BINDING*, uint, delegate* unmanaged<IUnknown**, HRESULT>, int>)(lpVtbl[23]))((ID2D1Factory1*)Unsafe.AsPointer(ref this), classId, propertyXml, bindings, bindingsCount, effectFactory);
    }
