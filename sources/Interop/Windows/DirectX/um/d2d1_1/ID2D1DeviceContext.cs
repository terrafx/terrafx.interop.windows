...
public unsafe partial struct ID2D1DeviceContext : ID2D1DeviceContext.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1DeviceContext;
