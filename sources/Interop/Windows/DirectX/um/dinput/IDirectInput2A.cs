...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDirectInput2A);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, Guid*, void**, int>)(lpVtbl[0]))((IDirectInput2A*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, uint>)(lpVtbl[1]))((IDirectInput2A*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, uint>)(lpVtbl[2]))((IDirectInput2A*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, Guid*, IDirectInputDeviceA**, IUnknown*, int>)(lpVtbl[3]))((IDirectInput2A*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, uint, delegate* unmanaged<DIDEVICEINSTANCEA*, void*, BOOL>, void*, uint, int>)(lpVtbl[4]))((IDirectInput2A*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, Guid*, int>)(lpVtbl[5]))((IDirectInput2A*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, HWND, uint, int>)(lpVtbl[6]))((IDirectInput2A*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, HINSTANCE, uint, int>)(lpVtbl[7]))((IDirectInput2A*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput2A*, Guid*, sbyte*, Guid*, int>)(lpVtbl[8]))((IDirectInput2A*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
