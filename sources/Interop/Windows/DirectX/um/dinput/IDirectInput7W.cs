...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDirectInput7W);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, Guid*, void**, int>)(lpVtbl[0]))((IDirectInput7W*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, uint>)(lpVtbl[1]))((IDirectInput7W*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, uint>)(lpVtbl[2]))((IDirectInput7W*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, Guid*, IDirectInputDeviceW**, IUnknown*, int>)(lpVtbl[3]))((IDirectInput7W*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, uint, delegate* unmanaged<DIDEVICEINSTANCE*, void*, BOOL>, void*, uint, int>)(lpVtbl[4]))((IDirectInput7W*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, Guid*, int>)(lpVtbl[5]))((IDirectInput7W*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, HWND, uint, int>)(lpVtbl[6]))((IDirectInput7W*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, HINSTANCE, uint, int>)(lpVtbl[7]))((IDirectInput7W*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, Guid*, char*, Guid*, int>)(lpVtbl[8]))((IDirectInput7W*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput7W*, Guid*, Guid*, void**, IUnknown*, int>)(lpVtbl[9]))((IDirectInput7W*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, IDirectInputDeviceW**, IUnknown*, int> CreateDevice;
