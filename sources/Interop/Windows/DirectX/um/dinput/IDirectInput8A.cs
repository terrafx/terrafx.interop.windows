...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDirectInput8A);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, Guid*, void**, int>)(lpVtbl[0]))((IDirectInput8A*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, uint>)(lpVtbl[1]))((IDirectInput8A*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, uint>)(lpVtbl[2]))((IDirectInput8A*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, Guid*, IDirectInputDevice8A**, IUnknown*, int>)(lpVtbl[3]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, uint, delegate* unmanaged<DIDEVICEINSTANCEA*, void*, BOOL>, void*, uint, int>)(lpVtbl[4]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, Guid*, int>)(lpVtbl[5]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, HWND, uint, int>)(lpVtbl[6]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, HINSTANCE, uint, int>)(lpVtbl[7]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, Guid*, sbyte*, Guid*, int>)(lpVtbl[8]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, sbyte*, DIACTIONFORMATA*, delegate* unmanaged<DIDEVICEINSTANCEA*, IDirectInputDevice8A*, uint, uint, void*, BOOL>, void*, uint, int>)(lpVtbl[9]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0, param1, param2, param3, param4);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDirectInput8A*, delegate* unmanaged<IUnknown*, void*, BOOL>, DICONFIGUREDEVICESPARAMSA*, uint, void*, int>)(lpVtbl[10]))((IDirectInput8A*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, Guid*, IDirectInputDevice8A**, IUnknown*, int> CreateDevice;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, sbyte*, DIACTIONFORMATA*, delegate* unmanaged<DIDEVICEINSTANCEA*, IDirectInputDevice8A*, uint, uint, void*, BOOL>, void*, uint, int> EnumDevicesBySemantics;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, delegate* unmanaged<IUnknown*, void*, BOOL>, DICONFIGUREDEVICESPARAMSA*, uint, void*, int> ConfigureDevices;
    }
}
