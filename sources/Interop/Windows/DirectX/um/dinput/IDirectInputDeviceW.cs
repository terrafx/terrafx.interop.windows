...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDirectInputDeviceW));
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, Guid*, void**, int>)(lpVtbl[0]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, uint>)(lpVtbl[1]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, uint>)(lpVtbl[2]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, DIDEVCAPS*, int>)(lpVtbl[3]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, delegate* unmanaged<DIDEVICEOBJECTINSTANCE*, void*, BOOL>, void*, uint, int>)(lpVtbl[4]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, Guid*, DIPROPHEADER*, int>)(lpVtbl[5]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, Guid*, DIPROPHEADER*, int>)(lpVtbl[6]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, int>)(lpVtbl[7]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, int>)(lpVtbl[8]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, uint, void*, int>)(lpVtbl[9]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, uint, DIDEVICEOBJECTDATA*, uint*, uint, int>)(lpVtbl[10]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, DIDATAFORMAT*, int>)(lpVtbl[11]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, HANDLE, int>)(lpVtbl[12]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, HWND, uint, int>)(lpVtbl[13]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, DIDEVICEOBJECTINSTANCE*, uint, uint, int>)(lpVtbl[14]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, DIDEVICEINSTANCE*, int>)(lpVtbl[15]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, HWND, uint, int>)(lpVtbl[16]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInputDeviceW*, HINSTANCE, uint, Guid*, int>)(lpVtbl[17]))((IDirectInputDeviceW*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
