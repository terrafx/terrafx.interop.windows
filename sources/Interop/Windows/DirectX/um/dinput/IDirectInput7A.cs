...
public unsafe partial struct IDirectInput7A : IDirectInput7A.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, Guid*, void**, int>)(lpVtbl[0]))((IDirectInput7A*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDirectInput7A*, uint>)(lpVtbl[1]))((IDirectInput7A*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDirectInput7A*, uint>)(lpVtbl[2]))((IDirectInput7A*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, Guid*, IDirectInputDeviceA**, IUnknown*, int>)(lpVtbl[3]))((IDirectInput7A*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, uint, delegate* unmanaged<DIDEVICEINSTANCEA*, void*, BOOL>, void*, uint, int>)(lpVtbl[4]))((IDirectInput7A*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, Guid*, int>)(lpVtbl[5]))((IDirectInput7A*)Unsafe.AsPointer(ref this), param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, HWND, uint, int>)(lpVtbl[6]))((IDirectInput7A*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, HINSTANCE, uint, int>)(lpVtbl[7]))((IDirectInput7A*)Unsafe.AsPointer(ref this), param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, Guid*, sbyte*, Guid*, int>)(lpVtbl[8]))((IDirectInput7A*)Unsafe.AsPointer(ref this), param0, param1, param2);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectInput7A*, Guid*, Guid*, void**, IUnknown*, int>)(lpVtbl[9]))((IDirectInput7A*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
    }
