...
/// <include file='ID3D11Device4.xml' path='doc/member[@name="ID3D11Device4"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID3D11Device4);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Device4*, D3D11_COUNTER_INFO*, void>)(lpVtbl[31]))((ID3D11Device4*)Unsafe.AsPointer(ref this), pCounterInfo);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device4*, D3D11_COUNTER_DESC*, D3D11_COUNTER_TYPE*, uint*, sbyte*, uint*, sbyte*, uint*, sbyte*, uint*, int>)(lpVtbl[32]))((ID3D11Device4*)Unsafe.AsPointer(ref this), pDesc, pType, pActiveCounters, szName, pNameLength, szUnits, pUnitsLength, szDescription, pDescriptionLength);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device4*, D3D11_FEATURE, void*, uint, int>)(lpVtbl[33]))((ID3D11Device4*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Device4*, D3D_FEATURE_LEVEL>)(lpVtbl[37]))((ID3D11Device4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Device4*, ID3D11Resource*, uint, D3D11_BOX*, void*, uint, uint, void>)(lpVtbl[63]))((ID3D11Device4*)Unsafe.AsPointer(ref this), pDstResource, DstSubresource, pDstBox, pSrcData, SrcRowPitch, SrcDepthPitch);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID3D11Device4*, void*, uint, uint, ID3D11Resource*, uint, D3D11_BOX*, void>)(lpVtbl[64]))((ID3D11Device4*)Unsafe.AsPointer(ref this), pDstData, DstRowPitch, DstDepthPitch, pSrcResource, SrcSubresource, pSrcBox);
    }

    /// <include file='ID3D11Device4.xml' path='doc/member[@name="ID3D11Device4.RegisterDeviceRemovedEvent"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(65)]
    ...
    /// <include file='ID3D11Device4.xml' path='doc/member[@name="ID3D11Device4.UnregisterDeviceRemoved"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(66)]
