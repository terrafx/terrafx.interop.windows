...
public unsafe partial struct ID3D11Device5 : ID3D11Device5.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ID3D11Device5*, char*, uint, Guid*, void**, int>)(lpVtbl[49]))((ID3D11Device5*)Unsafe.AsPointer(ref this), lpName, dwDesiredAccess, returnedInterface, ppResource);
    }
