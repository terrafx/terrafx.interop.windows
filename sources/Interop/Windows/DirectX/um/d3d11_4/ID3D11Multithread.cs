...
public unsafe partial struct ID3D11Multithread : ID3D11Multithread.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Multithread*, BOOL, int>)(lpVtbl[5]))((ID3D11Multithread*)Unsafe.AsPointer(ref this), bMTProtect);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D11Multithread*, int>)(lpVtbl[6]))((ID3D11Multithread*)Unsafe.AsPointer(ref this));
    }
