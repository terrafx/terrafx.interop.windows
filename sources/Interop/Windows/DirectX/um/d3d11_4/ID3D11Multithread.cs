...
public unsafe partial struct ID3D11Multithread : ID3D11Multithread.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID3D11Multithread;
