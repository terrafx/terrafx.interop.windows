...
/// <include file='ID2D1Device6.xml' path='doc/member[@name="ID2D1Device6"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1Device6);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1Device6*)Unsafe.AsPointer(in this), factory);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext**, int>)(lpVtbl[4]))((ID2D1Device6*)Unsafe.AsPointer(ref this), options, deviceContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, IWICImagingFactory*, IPrintDocumentPackageTarget*, D2D1_PRINT_CONTROL_PROPERTIES*, ID2D1PrintControl**, int>)(lpVtbl[5]))((ID2D1Device6*)Unsafe.AsPointer(ref this), wicFactory, documentTarget, printControlProperties, printControl);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ulong, void>)(lpVtbl[6]))((ID2D1Device6*)Unsafe.AsPointer(ref this), maximumInBytes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ulong>)(lpVtbl[7]))((ID2D1Device6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, uint, void>)(lpVtbl[8]))((ID2D1Device6*)Unsafe.AsPointer(ref this), millisecondsSinceUse);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_RENDERING_PRIORITY>)(lpVtbl[9]))((ID2D1Device6*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_RENDERING_PRIORITY, void>)(lpVtbl[10]))((ID2D1Device6*)Unsafe.AsPointer(ref this), renderingPriority);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext1**, int>)(lpVtbl[11]))((ID2D1Device6*)Unsafe.AsPointer(ref this), options, deviceContext1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext2**, int>)(lpVtbl[12]))((ID2D1Device6*)Unsafe.AsPointer(ref this), options, deviceContext2);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ID2D1Bitmap*, void>)(lpVtbl[13]))((ID2D1Device6*)Unsafe.AsPointer(ref this), bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, IDXGIDevice**, int>)(lpVtbl[14]))((ID2D1Device6*)Unsafe.AsPointer(ref this), dxgiDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext3**, int>)(lpVtbl[15]))((ID2D1Device6*)Unsafe.AsPointer(ref this), options, deviceContext3);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext4**, int>)(lpVtbl[16]))((ID2D1Device6*)Unsafe.AsPointer(ref this), options, deviceContext4);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ulong, void>)(lpVtbl[17]))((ID2D1Device6*)Unsafe.AsPointer(ref this), maximumInBytes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ulong>)(lpVtbl[18]))((ID2D1Device6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext5**, int>)(lpVtbl[19]))((ID2D1Device6*)Unsafe.AsPointer(ref this), options, deviceContext5);
    }

    /// <include file='ID2D1Device6.xml' path='doc/member[@name="ID2D1Device6.CreateDeviceContext"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(20)]
    public HRESULT CreateDeviceContext(D2D1_DEVICE_CONTEXT_OPTIONS options, ID2D1DeviceContext6** deviceContext6)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext6**, int>)(lpVtbl[20]))((ID2D1Device6*)Unsafe.AsPointer(ref this), options, deviceContext6);
    }
