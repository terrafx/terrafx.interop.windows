...
public unsafe partial struct ID2D1Device6 : ID2D1Device6.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ulong>)(lpVtbl[7]))((ID2D1Device6*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device6*, ulong>)(lpVtbl[18]))((ID2D1Device6*)Unsafe.AsPointer(ref this));
    }
