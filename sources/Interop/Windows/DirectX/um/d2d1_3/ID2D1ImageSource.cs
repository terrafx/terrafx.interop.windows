...
public unsafe partial struct ID2D1ImageSource : ID2D1ImageSource.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1ImageSource;
