...
public unsafe partial struct ID2D1DeviceContext3 : ID2D1DeviceContext3.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, IDWriteRenderingParams**, void>)(lpVtbl[37]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), textRenderingParams);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, D2D1_PIXEL_FORMAT>)(lpVtbl[50]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, D2D_SIZE_F>)(lpVtbl[53]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, D2D_SIZE_U>)(lpVtbl[54]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), renderTargetProperties);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, DXGI_FORMAT, int>)(lpVtbl[68]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), format);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[69]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), bufferPrecision);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[70]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), image, localBounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[71]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), image, worldBounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_RECT_F*, int>)(lpVtbl[72]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, measuringMode, bounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1GradientMesh*, D2D_RECT_F*, int>)(lpVtbl[101]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), gradientMesh, pBounds);
    }
