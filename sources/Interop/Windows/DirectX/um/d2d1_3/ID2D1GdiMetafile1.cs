...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1GdiMetafile1);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1GdiMetafile1*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1GdiMetafile1*)Unsafe.AsPointer(in this), factory);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1GdiMetafile1*, D2D_RECT_F*, int>)(lpVtbl[5]))((ID2D1GdiMetafile1*)Unsafe.AsPointer(ref this), bounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1GdiMetafile1*, D2D_RECT_F*, int>)(lpVtbl[7]))((ID2D1GdiMetafile1*)Unsafe.AsPointer(ref this), bounds);
    }
