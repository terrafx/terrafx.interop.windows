...
/// <include file='ID2D1Device4.xml' path='doc/member[@name="ID2D1Device4"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1Device4);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1Device4*)Unsafe.AsPointer(in this), factory);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext**, int>)(lpVtbl[4]))((ID2D1Device4*)Unsafe.AsPointer(ref this), options, deviceContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, IWICImagingFactory*, IPrintDocumentPackageTarget*, D2D1_PRINT_CONTROL_PROPERTIES*, ID2D1PrintControl**, int>)(lpVtbl[5]))((ID2D1Device4*)Unsafe.AsPointer(ref this), wicFactory, documentTarget, printControlProperties, printControl);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, ulong, void>)(lpVtbl[6]))((ID2D1Device4*)Unsafe.AsPointer(ref this), maximumInBytes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, ulong>)(lpVtbl[7]))((ID2D1Device4*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, uint, void>)(lpVtbl[8]))((ID2D1Device4*)Unsafe.AsPointer(ref this), millisecondsSinceUse);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, D2D1_RENDERING_PRIORITY>)(lpVtbl[9]))((ID2D1Device4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, D2D1_RENDERING_PRIORITY, void>)(lpVtbl[10]))((ID2D1Device4*)Unsafe.AsPointer(ref this), renderingPriority);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext1**, int>)(lpVtbl[11]))((ID2D1Device4*)Unsafe.AsPointer(ref this), options, deviceContext1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext2**, int>)(lpVtbl[12]))((ID2D1Device4*)Unsafe.AsPointer(ref this), options, deviceContext2);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, ID2D1Bitmap*, void>)(lpVtbl[13]))((ID2D1Device4*)Unsafe.AsPointer(ref this), bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, IDXGIDevice**, int>)(lpVtbl[14]))((ID2D1Device4*)Unsafe.AsPointer(ref this), dxgiDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext3**, int>)(lpVtbl[15]))((ID2D1Device4*)Unsafe.AsPointer(ref this), options, deviceContext3);
    }

    /// <include file='ID2D1Device4.xml' path='doc/member[@name="ID2D1Device4.CreateDeviceContext"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(16)]
    public HRESULT CreateDeviceContext(D2D1_DEVICE_CONTEXT_OPTIONS options, ID2D1DeviceContext4** deviceContext4)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext4**, int>)(lpVtbl[16]))((ID2D1Device4*)Unsafe.AsPointer(ref this), options, deviceContext4);
    }

    /// <include file='ID2D1Device4.xml' path='doc/member[@name="ID2D1Device4.SetMaximumColorGlyphCacheMemory"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(17)]
    public void SetMaximumColorGlyphCacheMemory([NativeTypeName("UINT64")] ulong maximumInBytes)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, ulong, void>)(lpVtbl[17]))((ID2D1Device4*)Unsafe.AsPointer(ref this), maximumInBytes);
    }

    /// <include file='ID2D1Device4.xml' path='doc/member[@name="ID2D1Device4.GetMaximumColorGlyphCacheMemory"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(18)]
    [return: NativeTypeName("UINT64")]
    public readonly ulong GetMaximumColorGlyphCacheMemory()
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device4*, ulong>)(lpVtbl[18]))((ID2D1Device4*)Unsafe.AsPointer(in this));
    }
