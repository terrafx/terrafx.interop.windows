...
public unsafe partial struct ID2D1Device5 : ID2D1Device5.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device5*, ulong>)(lpVtbl[7]))((ID2D1Device5*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device5*, ulong>)(lpVtbl[18]))((ID2D1Device5*)Unsafe.AsPointer(ref this));
    }
