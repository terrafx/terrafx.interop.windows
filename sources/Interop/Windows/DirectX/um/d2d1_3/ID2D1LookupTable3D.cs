...
/// <include file='ID2D1LookupTable3D.xml' path='doc/member[@name="ID2D1LookupTable3D"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1LookupTable3D);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1LookupTable3D*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1LookupTable3D*)Unsafe.AsPointer(in this), factory);
    }
