...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1Device3);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1Device3*)Unsafe.AsPointer(in this), factory);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, IWICImagingFactory*, IPrintDocumentPackageTarget*, D2D1_PRINT_CONTROL_PROPERTIES*, ID2D1PrintControl**, int>)(lpVtbl[5]))((ID2D1Device3*)Unsafe.AsPointer(ref this), wicFactory, documentTarget, printControlProperties, printControl);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, ulong, void>)(lpVtbl[6]))((ID2D1Device3*)Unsafe.AsPointer(ref this), maximumInBytes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, ulong>)(lpVtbl[7]))((ID2D1Device3*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, uint, void>)(lpVtbl[8]))((ID2D1Device3*)Unsafe.AsPointer(ref this), millisecondsSinceUse);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, D2D1_RENDERING_PRIORITY>)(lpVtbl[9]))((ID2D1Device3*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, D2D1_RENDERING_PRIORITY, void>)(lpVtbl[10]))((ID2D1Device3*)Unsafe.AsPointer(ref this), renderingPriority);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext1**, int>)(lpVtbl[11]))((ID2D1Device3*)Unsafe.AsPointer(ref this), options, deviceContext1);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext2**, int>)(lpVtbl[12]))((ID2D1Device3*)Unsafe.AsPointer(ref this), options, deviceContext2);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, ID2D1Bitmap*, void>)(lpVtbl[13]))((ID2D1Device3*)Unsafe.AsPointer(ref this), bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, IDXGIDevice**, int>)(lpVtbl[14]))((ID2D1Device3*)Unsafe.AsPointer(ref this), dxgiDevice);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device3*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext3**, int>)(lpVtbl[15]))((ID2D1Device3*)Unsafe.AsPointer(ref this), options, deviceContext3);
    }
