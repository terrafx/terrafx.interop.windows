...
public unsafe partial struct ID2D1DeviceContext4 : ID2D1DeviceContext4.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D1_ANTIALIAS_MODE>)(lpVtbl[33]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D1_TEXT_ANTIALIAS_MODE>)(lpVtbl[35]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D_SIZE_F>)(lpVtbl[53]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D_SIZE_U>)(lpVtbl[54]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderTargetProperties);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, DXGI_FORMAT, int>)(lpVtbl[68]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), format);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[69]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bufferPrecision);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[70]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, localBounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[71]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, worldBounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_RECT_F*, int>)(lpVtbl[72]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, measuringMode, bounds);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D1_RENDERING_CONTROLS*, void>)(lpVtbl[77]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderingControls);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D1_PRIMITIVE_BLEND>)(lpVtbl[79]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, D2D1_UNIT_MODE>)(lpVtbl[81]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1GradientMesh*, D2D_RECT_F*, int>)(lpVtbl[101]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gradientMesh, pBounds);
    }
