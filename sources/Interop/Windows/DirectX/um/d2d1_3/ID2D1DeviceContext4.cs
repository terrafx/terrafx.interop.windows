...
public unsafe partial struct ID2D1DeviceContext4 : ID2D1DeviceContext4.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1DeviceContext4;
