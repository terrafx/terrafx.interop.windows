...
public unsafe partial struct ID2D1DeviceContext6 : ID2D1DeviceContext6.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1DeviceContext6;
