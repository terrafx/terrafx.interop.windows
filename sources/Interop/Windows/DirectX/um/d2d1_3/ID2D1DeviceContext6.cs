...
public unsafe partial struct ID2D1DeviceContext6 : ID2D1DeviceContext6.Interface, INativeGuid
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), factory);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[4]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), size, srcData, pitch, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[5]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, Guid*, void*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[6]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), riid, data, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush**, int>)(lpVtbl[7]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, DXGI_RGBA*, D2D1_BRUSH_PROPERTIES*, ID2D1SolidColorBrush**, int>)(lpVtbl[8]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), color, brushProperties, solidColorBrush);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_GRADIENT_STOP*, uint, D2D1_GAMMA, D2D1_EXTEND_MODE, ID2D1GradientStopCollection**, int>)(lpVtbl[9]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode, gradientStopCollection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_SIZE_F*, D2D_SIZE_U*, D2D1_PIXEL_FORMAT*, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, ID2D1BitmapRenderTarget**, int>)(lpVtbl[12]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), desiredSize, desiredPixelSize, desiredFormat, options, bitmapRenderTarget);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_SIZE_F*, ID2D1Layer**, int>)(lpVtbl[13]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), size, layer);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, D2D_POINT_2F, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[15]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), point0, point1, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_RECT_F*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_RECT_F*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), rect, brush);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_ROUNDED_RECT*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[18]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), roundedRect, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_ROUNDED_RECT*, ID2D1Brush*, void>)(lpVtbl[19]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), roundedRect, brush);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_ELLIPSE*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[20]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), ellipse, brush, strokeWidth, strokeStyle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_ELLIPSE*, ID2D1Brush*, void>)(lpVtbl[21]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), ellipse, brush);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Bitmap*, ID2D1Brush*, D2D1_OPACITY_MASK_CONTENT, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[25]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_BITMAP_INTERPOLATION_MODE, D2D_RECT_F*, void>)(lpVtbl[26]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, char*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void>)(lpVtbl[27]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutRect, defaultFillBrush, options, measuringMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, void>)(lpVtbl[28]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, options);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[29]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, foregroundBrush, measuringMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[30]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), transform);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), transform);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[32]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), antialiasMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_ANTIALIAS_MODE>)(lpVtbl[33]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_TEXT_ANTIALIAS_MODE, void>)(lpVtbl[34]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), textAntialiasMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_TEXT_ANTIALIAS_MODE>)(lpVtbl[35]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IDWriteRenderingParams*, void>)(lpVtbl[36]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), textRenderingParams);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IDWriteRenderingParams**, void>)(lpVtbl[37]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), textRenderingParams);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ulong*, ulong*, void>)(lpVtbl[39]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), tag1, tag2);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_LAYER_PARAMETERS*, ID2D1Layer*, void>)(lpVtbl[40]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), layerParameters, layer);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1DrawingStateBlock*, void>)(lpVtbl[43]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), drawingStateBlock);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[45]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, DXGI_RGBA*, void>)(lpVtbl[47]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), clearColor);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_PIXEL_FORMAT>)(lpVtbl[50]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, float*, float*, void>)(lpVtbl[52]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), dpiX, dpiY);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_SIZE_F>)(lpVtbl[53]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_SIZE_U>)(lpVtbl[54]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, uint>)(lpVtbl[55]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), renderTargetProperties);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[57]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), size, sourceData, pitch, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[58]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_COLOR_SPACE, byte*, uint, ID2D1ColorContext**, int>)(lpVtbl[59]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), space, profile, profileSize, colorContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IWICColorContext*, ID2D1ColorContext**, int>)(lpVtbl[61]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), wicColorContext, colorContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IDXGISurface*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[62]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), surface, bitmapProperties, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Image*, D2D1_IMAGE_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1ImageBrush**, int>)(lpVtbl[65]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), image, imageBrushProperties, brushProperties, imageBrush);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES1*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush1**, int>)(lpVtbl[66]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, DXGI_FORMAT, int>)(lpVtbl[68]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), format);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[69]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), bufferPrecision);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[70]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), image, localBounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[71]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), image, worldBounds);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_RECT_F*, int>)(lpVtbl[72]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), baselineOrigin, glyphRun, measuringMode, bounds);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Device**, void>)(lpVtbl[73]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), device);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Image**, void>)(lpVtbl[75]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), image);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_RENDERING_CONTROLS*, void>)(lpVtbl[76]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), renderingControls);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_RENDERING_CONTROLS*, void>)(lpVtbl[77]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), renderingControls);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_PRIMITIVE_BLEND, void>)(lpVtbl[78]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), primitiveBlend);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_PRIMITIVE_BLEND>)(lpVtbl[79]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_UNIT_MODE, void>)(lpVtbl[80]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), unitMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_UNIT_MODE>)(lpVtbl[81]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[82]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, foregroundBrush, measuringMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Image*, D2D_POINT_2F*, D2D_RECT_F*, D2D1_INTERPOLATION_MODE, D2D1_COMPOSITE_MODE, void>)(lpVtbl[83]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), image, targetOffset, imageRectangle, interpolationMode, compositeMode);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1GdiMetafile*, D2D_POINT_2F*, void>)(lpVtbl[84]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), gdiMetafile, targetOffset);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_INTERPOLATION_MODE, D2D_RECT_F*, D2D_MATRIX_4X4_F*, void>)(lpVtbl[85]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle, perspectiveTransform);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_LAYER_PARAMETERS1*, ID2D1Layer*, void>)(lpVtbl[86]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), layerParameters, layer);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Effect*, uint, D2D_RECT_F*, int>)(lpVtbl[87]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), effect, input, inputRectangle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Effect*, D2D_RECT_F*, uint, int>)(lpVtbl[89]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), effect, rectangles, rectanglesCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Effect*, D2D_RECT_F*, D2D1_EFFECT_INPUT_DESCRIPTION*, D2D_RECT_F*, uint, int>)(lpVtbl[90]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), renderEffect, renderImageRectangle, inputDescriptions, requiredInputRects, inputCount);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Bitmap*, ID2D1Brush*, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[91]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_INK_POINT*, ID2D1Ink**, int>)(lpVtbl[95]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), startPoint, ink);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_INK_STYLE_PROPERTIES*, ID2D1InkStyle**, int>)(lpVtbl[96]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), inkStyleProperties, inkStyle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_GRADIENT_MESH_PATCH*, uint, ID2D1GradientMesh**, int>)(lpVtbl[97]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), patches, patchesCount, gradientMesh);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IWICBitmapSource*, D2D1_IMAGE_SOURCE_LOADING_OPTIONS, D2D1_ALPHA_MODE, ID2D1ImageSourceFromWic**, int>)(lpVtbl[98]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), wicBitmapSource, loadingOptions, alphaMode, imageSource);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_BUFFER_PRECISION, uint*, byte*, uint, uint*, ID2D1LookupTable3D**, int>)(lpVtbl[99]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), precision, extents, data, dataCount, strides, lookupTable);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IDXGISurface**, uint, DXGI_COLOR_SPACE_TYPE, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS, ID2D1ImageSource**, int>)(lpVtbl[100]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), surfaces, surfaceCount, colorSpace, options, imageSource);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1GradientMesh*, D2D_RECT_F*, int>)(lpVtbl[101]))((ID2D1DeviceContext6*)Unsafe.AsPointer(in this), gradientMesh, pBounds);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1GdiMetafile*, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[104]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), gdiMetafile, destinationRectangle, sourceRectangle);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1ImageSource*, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES*, ID2D1TransformedImageSource**, int>)(lpVtbl[105]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), imageSource, properties, transformedImageSource);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1SpriteBatch*, uint, uint, ID2D1Bitmap*, D2D1_BITMAP_INTERPOLATION_MODE, D2D1_SPRITE_OPTIONS, void>)(lpVtbl[107]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), spriteBatch, startIndex, spriteCount, bitmap, interpolationMode, spriteOptions);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, D2D1_DRAW_TEXT_OPTIONS, void>)(lpVtbl[110]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, options);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, DWRITE_GLYPH_IMAGE_FORMATS, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION, void>)(lpVtbl[111]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), glyphImageFormat, baselineOrigin, glyphRun, measuringMode, bitmapSnapOption);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, DWRITE_MEASURING_MODE, void>)(lpVtbl[112]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, measuringMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D_POINT_2F, IDWriteFontFace*, float, ushort, BOOL, D2D_MATRIX_3X2_F*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, D2D_MATRIX_3X2_F*, ID2D1CommandList**, int>)(lpVtbl[114]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), glyphOrigin, fontFace, fontEmSize, glyphIndex, isSideways, worldTransform, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, glyphTransform, glyphImage);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, IStream*, D2D_SIZE_F, ID2D1SvgDocument**, int>)(lpVtbl[115]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), inputXmlStream, viewportSize, svgDocument);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, DXGI_COLOR_SPACE_TYPE, ID2D1ColorContext1**, int>)(lpVtbl[117]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), colorSpace, colorContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, D2D1_SIMPLE_COLOR_PROFILE*, ID2D1ColorContext1**, int>)(lpVtbl[118]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), simpleProfile, colorContext);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext6*, ID2D1Image*, D2D1_BLEND_MODE, D2D_POINT_2F*, D2D_RECT_F*, D2D1_INTERPOLATION_MODE, void>)(lpVtbl[119]))((ID2D1DeviceContext6*)Unsafe.AsPointer(ref this), image, blendMode, targetOffset, imageRectangle, interpolationMode);
    }

    public interface Interface : ID2D1DeviceContext5.Interface
    {
        [VtblIndex(119)]
        void BlendImage(ID2D1Image* image, D2D1_BLEND_MODE blendMode, [NativeTypeName("const D2D1_POINT_2F *")] D2D_POINT_2F* targetOffset = null, [NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* imageRectangle = null, D2D1_INTERPOLATION_MODE interpolationMode = D2D1_INTERPOLATION_MODE_LINEAR);
    }
