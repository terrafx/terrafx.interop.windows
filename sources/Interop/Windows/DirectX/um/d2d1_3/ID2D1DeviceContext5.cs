...
public unsafe partial struct ID2D1DeviceContext5 : ID2D1DeviceContext5.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1DeviceContext5;
