...
/// <include file='ID2D1Device2.xml' path='doc/member[@name="ID2D1Device2"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1Device2);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1Device2*)Unsafe.AsPointer(in this), factory);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext**, int>)(lpVtbl[4]))((ID2D1Device2*)Unsafe.AsPointer(ref this), options, deviceContext);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, IWICImagingFactory*, IPrintDocumentPackageTarget*, D2D1_PRINT_CONTROL_PROPERTIES*, ID2D1PrintControl**, int>)(lpVtbl[5]))((ID2D1Device2*)Unsafe.AsPointer(ref this), wicFactory, documentTarget, printControlProperties, printControl);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, ulong, void>)(lpVtbl[6]))((ID2D1Device2*)Unsafe.AsPointer(ref this), maximumInBytes);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, ulong>)(lpVtbl[7]))((ID2D1Device2*)Unsafe.AsPointer(in this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, uint, void>)(lpVtbl[8]))((ID2D1Device2*)Unsafe.AsPointer(ref this), millisecondsSinceUse);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, D2D1_RENDERING_PRIORITY>)(lpVtbl[9]))((ID2D1Device2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, D2D1_RENDERING_PRIORITY, void>)(lpVtbl[10]))((ID2D1Device2*)Unsafe.AsPointer(ref this), renderingPriority);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext1**, int>)(lpVtbl[11]))((ID2D1Device2*)Unsafe.AsPointer(ref this), options, deviceContext1);
    }

    /// <include file='ID2D1Device2.xml' path='doc/member[@name="ID2D1Device2.CreateDeviceContext"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(12)]
    public HRESULT CreateDeviceContext(D2D1_DEVICE_CONTEXT_OPTIONS options, ID2D1DeviceContext2** deviceContext2)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext2**, int>)(lpVtbl[12]))((ID2D1Device2*)Unsafe.AsPointer(ref this), options, deviceContext2);
    }

    /// <include file='ID2D1Device2.xml' path='doc/member[@name="ID2D1Device2.FlushDeviceContexts"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(13)]
    public void FlushDeviceContexts(ID2D1Bitmap* bitmap)
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, ID2D1Bitmap*, void>)(lpVtbl[13]))((ID2D1Device2*)Unsafe.AsPointer(ref this), bitmap);
    }

    /// <include file='ID2D1Device2.xml' path='doc/member[@name="ID2D1Device2.GetDxgiDevice"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(14)]
    public HRESULT GetDxgiDevice(IDXGIDevice** dxgiDevice)
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1Device2*, IDXGIDevice**, int>)(lpVtbl[14]))((ID2D1Device2*)Unsafe.AsPointer(ref this), dxgiDevice);
    }
