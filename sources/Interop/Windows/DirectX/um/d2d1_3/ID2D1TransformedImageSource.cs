...
public unsafe partial struct ID2D1TransformedImageSource : ID2D1TransformedImageSource.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1TransformedImageSource;
