...
public unsafe partial struct ID2D1SvgPathData : ID2D1SvgPathData.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1SvgPathData;
