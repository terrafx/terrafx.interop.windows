...
public unsafe partial struct ID2D1SvgDocument : ID2D1SvgDocument.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1SvgDocument;
