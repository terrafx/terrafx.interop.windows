...
public unsafe partial struct ID2D1SvgPointCollection : ID2D1SvgPointCollection.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_ID2D1SvgPointCollection;
