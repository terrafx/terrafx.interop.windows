...
/// <include file='IXAudio2SubmixVoice.xml' path='doc/member[@name="IXAudio2SubmixVoice"]/*' />
...
public unsafe partial struct IXAudio2SubmixVoice : IXAudio2SubmixVoice.Interface
{
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IXAudio2SubmixVoice*, uint, BOOL*, void>)(lpVtbl[5]))((IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this), EffectIndex, pEnabled);
    }
