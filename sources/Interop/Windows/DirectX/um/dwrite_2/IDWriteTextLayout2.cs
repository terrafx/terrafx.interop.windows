...
// Ported from um/dwrite_2.h in the Windows SDK for Windows 10.0.28000.0
...
/// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2"]/*' />
...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_IDWriteTextLayout2);
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_TEXT_ALIGNMENT, int>)(lpVtbl[3]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), textAlignment);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_PARAGRAPH_ALIGNMENT, int>)(lpVtbl[4]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), paragraphAlignment);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_WORD_WRAPPING, int>)(lpVtbl[5]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), wordWrapping);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_READING_DIRECTION, int>)(lpVtbl[6]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), readingDirection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FLOW_DIRECTION, int>)(lpVtbl[7]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), flowDirection);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_TRIMMING*, IDWriteInlineObject*, int>)(lpVtbl[9]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), trimmingOptions, trimmingSign);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_LINE_SPACING_METHOD, float, float, int>)(lpVtbl[10]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), lineSpacingMethod, lineSpacing, baseline);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_TEXT_ALIGNMENT>)(lpVtbl[11]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_PARAGRAPH_ALIGNMENT>)(lpVtbl[12]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_WORD_WRAPPING>)(lpVtbl[13]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_READING_DIRECTION>)(lpVtbl[14]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FLOW_DIRECTION>)(lpVtbl[15]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_TRIMMING*, IDWriteInlineObject**, int>)(lpVtbl[17]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), trimmingOptions, trimmingSign);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_LINE_SPACING_METHOD*, float*, float*, int>)(lpVtbl[18]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), lineSpacingMethod, lineSpacing, baseline);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FONT_WEIGHT>)(lpVtbl[22]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FONT_STYLE>)(lpVtbl[23]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FONT_STRETCH>)(lpVtbl[24]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, IDWriteFontCollection*, DWRITE_TEXT_RANGE, int>)(lpVtbl[30]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), fontCollection, textRange);
    }

    /// <inheritdoc cref="IDWriteTextLayout.SetFontFamilyName" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(31)]
    public HRESULT SetFontFamilyName([NativeTypeName("const WCHAR *")] char* fontFamilyName, DWRITE_TEXT_RANGE textRange)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, char*, DWRITE_TEXT_RANGE, int>)(lpVtbl[31]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), fontFamilyName, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FONT_WEIGHT, DWRITE_TEXT_RANGE, int>)(lpVtbl[32]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), fontWeight, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FONT_STYLE, DWRITE_TEXT_RANGE, int>)(lpVtbl[33]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), fontStyle, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_FONT_STRETCH, DWRITE_TEXT_RANGE, int>)(lpVtbl[34]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), fontStretch, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, float, DWRITE_TEXT_RANGE, int>)(lpVtbl[35]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), fontSize, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, BOOL, DWRITE_TEXT_RANGE, int>)(lpVtbl[36]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), hasUnderline, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, BOOL, DWRITE_TEXT_RANGE, int>)(lpVtbl[37]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), hasStrikethrough, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, IUnknown*, DWRITE_TEXT_RANGE, int>)(lpVtbl[38]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), drawingEffect, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, IDWriteInlineObject*, DWRITE_TEXT_RANGE, int>)(lpVtbl[39]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), inlineObject, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, IDWriteTypography*, DWRITE_TEXT_RANGE, int>)(lpVtbl[40]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), typography, textRange);
    }

    /// <inheritdoc cref="IDWriteTextLayout.SetLocaleName" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(41)]
    public HRESULT SetLocaleName([NativeTypeName("const WCHAR *")] char* localeName, DWRITE_TEXT_RANGE textRange)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, char*, DWRITE_TEXT_RANGE, int>)(lpVtbl[41]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), localeName, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, IDWriteFontCollection**, DWRITE_TEXT_RANGE*, int>)(lpVtbl[44]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, fontCollection, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, uint*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[45]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, nameLength, textRange);
    }

    /// <inheritdoc cref="IDWriteTextLayout.GetFontFamilyName" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(46)]
    public HRESULT GetFontFamilyName([NativeTypeName("UINT32")] uint currentPosition, [NativeTypeName("WCHAR *")] char* fontFamilyName, [NativeTypeName("UINT32")] uint nameSize, DWRITE_TEXT_RANGE* textRange = null)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, char*, uint, DWRITE_TEXT_RANGE*, int>)(lpVtbl[46]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, fontFamilyName, nameSize, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, DWRITE_FONT_WEIGHT*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[47]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, fontWeight, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, DWRITE_FONT_STYLE*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[48]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, fontStyle, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, DWRITE_FONT_STRETCH*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[49]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, fontStretch, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, float*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[50]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, fontSize, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, BOOL*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[51]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, hasUnderline, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, BOOL*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[52]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, hasStrikethrough, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, IUnknown**, DWRITE_TEXT_RANGE*, int>)(lpVtbl[53]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, drawingEffect, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, IDWriteInlineObject**, DWRITE_TEXT_RANGE*, int>)(lpVtbl[54]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, inlineObject, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, IDWriteTypography**, DWRITE_TEXT_RANGE*, int>)(lpVtbl[55]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, typography, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, uint*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[56]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, nameLength, textRange);
    }

    /// <inheritdoc cref="IDWriteTextLayout.GetLocaleName" />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(57)]
    public HRESULT GetLocaleName([NativeTypeName("UINT32")] uint currentPosition, [NativeTypeName("WCHAR *")] char* localeName, [NativeTypeName("UINT32")] uint nameSize, DWRITE_TEXT_RANGE* textRange = null)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, char*, uint, DWRITE_TEXT_RANGE*, int>)(lpVtbl[57]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, localeName, nameSize, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_LINE_METRICS*, uint, uint*, int>)(lpVtbl[59]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), lineMetrics, maxLineCount, actualLineCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_TEXT_METRICS*, int>)(lpVtbl[60]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), textMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_OVERHANG_METRICS*, int>)(lpVtbl[61]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), overhangs);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_CLUSTER_METRICS*, uint, uint*, int>)(lpVtbl[62]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), clusterMetrics, maxClusterCount, actualClusterCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, float, float, BOOL*, BOOL*, DWRITE_HIT_TEST_METRICS*, int>)(lpVtbl[64]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), pointX, pointY, isTrailingHit, isInside, hitTestMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, BOOL, float*, float*, DWRITE_HIT_TEST_METRICS*, int>)(lpVtbl[65]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), textPosition, isTrailingHit, pointX, pointY, hitTestMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, uint, float, float, DWRITE_HIT_TEST_METRICS*, uint, uint*, int>)(lpVtbl[66]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), textPosition, textLength, originX, originY, hitTestMetrics, maxHitTestMetricsCount, actualHitTestMetricsCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, BOOL, DWRITE_TEXT_RANGE, int>)(lpVtbl[67]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), isPairKerningEnabled, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, BOOL*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[68]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, isPairKerningEnabled, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, float, float, float, DWRITE_TEXT_RANGE, int>)(lpVtbl[69]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), leadingSpacing, trailingSpacing, minimumAdvanceWidth, textRange);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, uint, float*, float*, float*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[70]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), currentPosition, leadingSpacing, trailingSpacing, minimumAdvanceWidth, textRange);
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.GetMetrics"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(71)]
    public HRESULT GetMetrics(DWRITE_TEXT_METRICS1* textMetrics)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_TEXT_METRICS1*, int>)(lpVtbl[71]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), textMetrics);
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.SetVerticalGlyphOrientation"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(72)]
    public HRESULT SetVerticalGlyphOrientation(DWRITE_VERTICAL_GLYPH_ORIENTATION glyphOrientation)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_VERTICAL_GLYPH_ORIENTATION, int>)(lpVtbl[72]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), glyphOrientation);
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.GetVerticalGlyphOrientation"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(73)]
    public DWRITE_VERTICAL_GLYPH_ORIENTATION GetVerticalGlyphOrientation()
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_VERTICAL_GLYPH_ORIENTATION>)(lpVtbl[73]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.SetLastLineWrapping"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(74)]
    public HRESULT SetLastLineWrapping(BOOL isLastLineWrappingEnabled)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, BOOL, int>)(lpVtbl[74]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), isLastLineWrappingEnabled);
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.GetLastLineWrapping"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(75)]
    public BOOL GetLastLineWrapping()
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, int>)(lpVtbl[75]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.SetOpticalAlignment"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(76)]
    public HRESULT SetOpticalAlignment(DWRITE_OPTICAL_ALIGNMENT opticalAlignment)
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_OPTICAL_ALIGNMENT, int>)(lpVtbl[76]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this), opticalAlignment);
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.GetOpticalAlignment"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(77)]
    public DWRITE_OPTICAL_ALIGNMENT GetOpticalAlignment()
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout2*, DWRITE_OPTICAL_ALIGNMENT>)(lpVtbl[77]))((IDWriteTextLayout2*)Unsafe.AsPointer(ref this));
    }

    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.SetFontFallback"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(78)]
    ...
    /// <include file='IDWriteTextLayout2.xml' path='doc/member[@name="IDWriteTextLayout2.GetFontFallback"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(79)]
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, DWRITE_TEXT_RANGE, int> SetUnderline;

        [NativeTypeName("HRESULT (BOOL, DWRITE_TEXT_RANGE) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, DWRITE_TEXT_RANGE, int> SetStrikethrough;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, BOOL*, DWRITE_TEXT_RANGE*, int> GetUnderline;

        [NativeTypeName("HRESULT (UINT32, BOOL *, DWRITE_TEXT_RANGE *) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, BOOL*, DWRITE_TEXT_RANGE*, int> GetStrikethrough;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, float, float, BOOL*, BOOL*, DWRITE_HIT_TEST_METRICS*, int> HitTestPoint;

        [NativeTypeName("HRESULT (UINT32, BOOL, FLOAT *, FLOAT *, DWRITE_HIT_TEST_METRICS *) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, BOOL, float*, float*, DWRITE_HIT_TEST_METRICS*, int> HitTestTextPosition;
        ...
        [NativeTypeName("HRESULT (BOOL, DWRITE_TEXT_RANGE) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, BOOL, DWRITE_TEXT_RANGE, int> SetPairKerning;

        [NativeTypeName("HRESULT (UINT32, BOOL *, DWRITE_TEXT_RANGE *) __attribute__((nothrow)) __attribute__((stdcall))")]
        public delegate* unmanaged[MemberFunction]<TSelf*, uint, BOOL*, DWRITE_TEXT_RANGE*, int> GetPairKerning;
