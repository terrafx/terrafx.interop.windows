...
public unsafe partial struct IDWriteFontFallback : IDWriteFontFallback.Interface, IHaveNativeGuid
{
    static ref readonly Guid IHaveNativeGuid.GUID => ref IID_IDWriteFontFallback;
