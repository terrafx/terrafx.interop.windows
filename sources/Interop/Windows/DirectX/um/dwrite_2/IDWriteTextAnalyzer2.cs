...
public unsafe partial struct IDWriteTextAnalyzer2 : IDWriteTextAnalyzer2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextAnalyzer2*, DWRITE_GLYPH_ORIENTATION_ANGLE, BOOL, DWRITE_MATRIX*, int>)(lpVtbl[13]))((IDWriteTextAnalyzer2*)Unsafe.AsPointer(ref this), glyphOrientationAngle, isSideways, transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextAnalyzer2*, char*, uint, IDWriteFontFace*, BOOL*, uint*, ushort*, int>)(lpVtbl[15]))((IDWriteTextAnalyzer2*)Unsafe.AsPointer(ref this), textString, textLength, fontFace, isTextSimple, textLengthRead, glyphIndices);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteTextAnalyzer2*, DWRITE_GLYPH_ORIENTATION_ANGLE, BOOL, float, float, DWRITE_MATRIX*, int>)(lpVtbl[19]))((IDWriteTextAnalyzer2*)Unsafe.AsPointer(ref this), glyphOrientationAngle, isSideways, originX, originY, transform);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, uint, IDWriteFontFace*, BOOL, BOOL, DWRITE_SCRIPT_ANALYSIS*, char*, IDWriteNumberSubstitution*, DWRITE_TYPOGRAPHIC_FEATURES**, uint*, uint, uint, ushort*, DWRITE_SHAPING_TEXT_PROPERTIES*, ushort*, DWRITE_SHAPING_GLYPH_PROPERTIES*, uint*, int> GetGlyphs;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, ushort*, DWRITE_SHAPING_TEXT_PROPERTIES*, uint, ushort*, DWRITE_SHAPING_GLYPH_PROPERTIES*, uint, IDWriteFontFace*, float, BOOL, BOOL, DWRITE_SCRIPT_ANALYSIS*, char*, DWRITE_TYPOGRAPHIC_FEATURES**, uint*, uint, float*, DWRITE_GLYPH_OFFSET*, int> GetGlyphPlacements;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, IDWriteFontFace*, DWRITE_BASELINE, BOOL, BOOL, DWRITE_SCRIPT_ANALYSIS, char*, int*, BOOL*, int> GetBaseline;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DWRITE_GLYPH_ORIENTATION_ANGLE, BOOL, DWRITE_MATRIX*, int> GetGlyphOrientationTransform;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, char*, uint, IDWriteFontFace*, BOOL*, uint*, ushort*, int> GetTextComplexity;
        ...
        public delegate* unmanaged[MemberFunction]<TSelf*, DWRITE_GLYPH_ORIENTATION_ANGLE, BOOL, float, float, DWRITE_MATRIX*, int> GetGlyphOrientationTransform1;
