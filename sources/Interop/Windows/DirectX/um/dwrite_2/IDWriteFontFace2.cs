...
public unsafe partial struct IDWriteFontFace2 : IDWriteFontFace2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, DWRITE_FONT_FACE_TYPE>)(lpVtbl[3]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, DWRITE_FONT_SIMULATIONS>)(lpVtbl[6]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, int>)(lpVtbl[7]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, DWRITE_FONT_METRICS*, void>)(lpVtbl[8]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), fontFaceMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, ushort*, uint, DWRITE_GLYPH_METRICS*, BOOL, int>)(lpVtbl[10]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), glyphIndices, glyphCount, glyphMetrics, isSideways);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, uint, void**, uint*, void**, BOOL*, int>)(lpVtbl[12]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), openTypeTableTag, tableData, tableSize, tableContext, exists);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, float, ushort*, float*, DWRITE_GLYPH_OFFSET*, uint, BOOL, BOOL, ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[14]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), emSize, glyphIndices, glyphAdvances, glyphOffsets, glyphCount, isSideways, isRightToLeft, geometrySink);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, float, float, DWRITE_MEASURING_MODE, IDWriteRenderingParams*, DWRITE_RENDERING_MODE*, int>)(lpVtbl[15]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, measuringMode, renderingParams, renderingMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, float, float, DWRITE_MATRIX*, DWRITE_FONT_METRICS*, int>)(lpVtbl[16]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, fontFaceMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, float, float, DWRITE_MATRIX*, BOOL, ushort*, uint, DWRITE_GLYPH_METRICS*, BOOL, int>)(lpVtbl[17]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, useGdiNatural, glyphIndices, glyphCount, glyphMetrics, isSideways);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, DWRITE_FONT_METRICS1*, void>)(lpVtbl[18]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), fontMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, float, float, DWRITE_MATRIX*, DWRITE_FONT_METRICS1*, int>)(lpVtbl[19]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, fontMetrics);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, DWRITE_CARET_METRICS*, void>)(lpVtbl[20]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), caretMetrics);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, uint, DWRITE_UNICODE_RANGE*, uint*, int>)(lpVtbl[21]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), maxRangeCount, unicodeRanges, actualRangeCount);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, int>)(lpVtbl[22]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, uint, ushort*, int*, BOOL, int>)(lpVtbl[23]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), glyphCount, glyphIndices, glyphAdvances, isSideways);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, float, float, DWRITE_MATRIX*, BOOL, BOOL, uint, ushort*, int*, int>)(lpVtbl[24]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, useGdiNatural, isSideways, glyphCount, glyphIndices, glyphAdvances);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, int>)(lpVtbl[26]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, float, float, float, DWRITE_MATRIX*, BOOL, DWRITE_OUTLINE_THRESHOLD, DWRITE_MEASURING_MODE, DWRITE_RENDERING_MODE*, int>)(lpVtbl[27]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), fontEmSize, dpiX, dpiY, transform, isSideways, outlineThreshold, measuringMode, renderingMode);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, int>)(lpVtbl[29]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, int>)(lpVtbl[30]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace2*, uint, uint, uint, DXGI_RGBA*, int>)(lpVtbl[33]))((IDWriteFontFace2*)Unsafe.AsPointer(ref this), colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
    }
