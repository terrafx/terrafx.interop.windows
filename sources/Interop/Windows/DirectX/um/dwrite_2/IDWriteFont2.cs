...
public unsafe partial struct IDWriteFont2 : IDWriteFont2.Interface
{
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, DWRITE_FONT_WEIGHT>)(lpVtbl[4]))((IDWriteFont2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, DWRITE_FONT_STRETCH>)(lpVtbl[5]))((IDWriteFont2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, DWRITE_FONT_STYLE>)(lpVtbl[6]))((IDWriteFont2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, int>)(lpVtbl[7]))((IDWriteFont2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, DWRITE_FONT_SIMULATIONS>)(lpVtbl[10]))((IDWriteFont2*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, DWRITE_FONT_METRICS*, void>)(lpVtbl[11]))((IDWriteFont2*)Unsafe.AsPointer(ref this), fontMetrics);
    }
    ...
    {
        ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, DWRITE_FONT_METRICS1*, void>)(lpVtbl[14]))((IDWriteFont2*)Unsafe.AsPointer(ref this), fontMetrics);
    }
    ...
    {
        ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, DWRITE_PANOSE*, void>)(lpVtbl[15]))((IDWriteFont2*)Unsafe.AsPointer(ref this), panose);
    }
    ...
    {
        return ((delegate* unmanaged[SuppressGCTransition]<IDWriteFont2*, int>)(lpVtbl[18]))((IDWriteFont2*)Unsafe.AsPointer(ref this));
    }
