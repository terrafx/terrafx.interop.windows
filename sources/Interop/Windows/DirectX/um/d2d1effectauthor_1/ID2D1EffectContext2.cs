...
{
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(in IID_ID2D1EffectContext2);
    ...
    {
        ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext2*, float*, float*, void>)(lpVtbl[3]))((ID2D1EffectContext2*)Unsafe.AsPointer(in this), dpiX, dpiY);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext2*, D3D_FEATURE_LEVEL*, uint, D3D_FEATURE_LEVEL*, int>)(lpVtbl[5]))((ID2D1EffectContext2*)Unsafe.AsPointer(in this), featureLevels, featureLevelsCount, maximumSupportedFeatureLevel);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext2*, POINT, ID2D1OffsetTransform**, int>)(lpVtbl[9]))((ID2D1EffectContext2*)Unsafe.AsPointer(ref this), offset, transform);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext2*, Guid*, int>)(lpVtbl[14]))((ID2D1EffectContext2*)Unsafe.AsPointer(ref this), shaderId);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext2*, D2D1_FEATURE, void*, uint, int>)(lpVtbl[22]))((ID2D1EffectContext2*)Unsafe.AsPointer(in this), feature, featureSupportData, featureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext2*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[23]))((ID2D1EffectContext2*)Unsafe.AsPointer(in this), bufferPrecision);
    }
