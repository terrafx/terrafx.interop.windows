...
public unsafe partial struct ID2D1EffectContext2 : ID2D1EffectContext2.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext2*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[23]))((ID2D1EffectContext2*)Unsafe.AsPointer(ref this), bufferPrecision);
    }
