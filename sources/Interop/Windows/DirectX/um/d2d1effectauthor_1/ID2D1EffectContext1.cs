...
public unsafe partial struct ID2D1EffectContext1 : ID2D1EffectContext1.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext1*, D2D1_FEATURE, void*, uint, int>)(lpVtbl[22]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), feature, featureSupportData, featureSupportDataSize);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext1*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[23]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), bufferPrecision);
    }
