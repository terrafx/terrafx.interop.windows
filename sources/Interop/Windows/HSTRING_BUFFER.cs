...
namespace TerraFX.Interop
{
    public unsafe partial struct HSTRING_BUFFER : IEquatable<HSTRING_BUFFER>
    {
        ...
        public static HSTRING_BUFFER INVALID_HANDLE_VALUE => new HSTRING_BUFFER(-1);
        ...
        public static implicit operator HANDLE(HSTRING_BUFFER value) => new HSTRING_BUFFER(value);
