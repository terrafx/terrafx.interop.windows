...
// Ported from um/gdipluspixelformats.h in the Windows SDK for Windows 10.0.19041.0
...
namespace TerraFX.Interop
{
    public static partial class Windows
    {
        ...
        public static int IsIndexedPixelFormat([NativeTypeName("Gdiplus::PixelFormat")] int pixfmt)
        {
            return ((pixfmt & 0x00010000) != 0) ? 1 : 0;
        }

        [return: NativeTypeName("BOOL")]
        public static int IsAlphaPixelFormat([NativeTypeName("Gdiplus::PixelFormat")] int pixfmt)
        {
            return ((pixfmt & 0x00040000) != 0) ? 1 : 0;
        }

        [return: NativeTypeName("BOOL")]
        public static int IsExtendedPixelFormat([NativeTypeName("Gdiplus::PixelFormat")] int pixfmt)
        {
            return ((pixfmt & 0x00100000) != 0) ? 1 : 0;
        }

        [return: NativeTypeName("BOOL")]
        public static int IsCanonicalPixelFormat([NativeTypeName("Gdiplus::PixelFormat")] int pixfmt)
        {
