...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        [DllImport("kernel32", ExactSpelling = true)]
        [return: NativeTypeName("BOOL")]
        public static extern int AllocateUserPhysicalPages2([NativeTypeName("HANDLE")] IntPtr ObjectHandle, [NativeTypeName("PULONG_PTR")] uint* NumberOfPages, [NativeTypeName("PULONG_PTR")] uint* PageArray, [NativeTypeName("PMEM_EXTENDED_PARAMETER")] MEM_EXTENDED_PARAMETER* ExtendedParameters, [NativeTypeName("ULONG")] uint ExtendedParameterCount);

        [DllImport("kernel32", ExactSpelling = true)]
        [return: NativeTypeName("HANDLE")]
        public static extern IntPtr OpenDedicatedMemoryPartition([NativeTypeName("HANDLE")] IntPtr Partition, [NativeTypeName("ULONG64")] ulong DedicatedMemoryTypeId, [NativeTypeName("ACCESS_MASK")] uint DesiredAccess, [NativeTypeName("BOOL")] int InheritHandle);

        [DllImport("kernel32", ExactSpelling = true)]
        [return: NativeTypeName("BOOL")]
        public static extern int QueryPartitionInformation([NativeTypeName("HANDLE")] IntPtr Partition, WIN32_MEMORY_PARTITION_INFORMATION_CLASS PartitionInformationClass, [NativeTypeName("PVOID")] void* PartitionInformation, [NativeTypeName("ULONG")] uint PartitionInformationLength);
