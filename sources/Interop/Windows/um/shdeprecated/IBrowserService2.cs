...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IBrowserService2
    {
        ...
        {
            return ((delegate* unmanaged<IBrowserService2*, IntPtr, BOOL, uint, nuint, nint, int>)(lpVtbl[68]))((IBrowserService2*)Unsafe.AsPointer(ref this), hwndBar, fBroadcast, uMsg, wParam, lParam);
        }
