...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IBrowserService2
    {
        ...
        {
            return ((delegate* unmanaged<IBrowserService2*, HWND, uint, nuint, nint, nint>)(lpVtbl[33]))((IBrowserService2*)Unsafe.AsPointer(ref this), hwnd, uMsg, wParam, lParam);
        }
        ...
        {
            return ((delegate* unmanaged<IBrowserService2*, HWND, BOOL, uint, nuint, nint, int>)(lpVtbl[68]))((IBrowserService2*)Unsafe.AsPointer(ref this), hwndBar, fBroadcast, uMsg, wParam, lParam);
        }
