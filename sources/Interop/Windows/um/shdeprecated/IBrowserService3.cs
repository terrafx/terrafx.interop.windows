...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IBrowserService3
    {
        ...
        {
            return ((delegate* unmanaged<IBrowserService3*, BASEBROWSERDATALH**, int>)(lpVtbl[48]))((IBrowserService3*)Unsafe.AsPointer(ref this), pbbd);
        }
        ...
        {
            return ((delegate* unmanaged<IBrowserService3*, BASEBROWSERDATALH*>)(lpVtbl[49]))((IBrowserService3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IBrowserService3*, tagFolderSetData*, int>)(lpVtbl[69]))((IBrowserService3*)Unsafe.AsPointer(ref this), pfsd);
        }
        ...
        {
            return ((delegate* unmanaged<IBrowserService3*, int, SToolbarItem*>)(lpVtbl[84]))((IBrowserService3*)Unsafe.AsPointer(ref this), itb);
        }
        ...
        {
            return ((delegate* unmanaged<IBrowserService3*, MSG*, uint, int, SToolbarItem**, IntPtr*, int>)(lpVtbl[88]))((IBrowserService3*)Unsafe.AsPointer(ref this), lpMsg, itbNext, citb, pptbi, phwnd);
        }
        ...
        {
            return ((delegate* unmanaged<IBrowserService3*, SToolbarItem*, IntPtr, MSG*, int>)(lpVtbl[91]))((IBrowserService3*)Unsafe.AsPointer(ref this), ptbi, hwnd, lpMsg);
        }
