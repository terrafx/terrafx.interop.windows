...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        public static extern BOOL EcEnumNextSubscription([NativeTypeName("EC_HANDLE")] IntPtr SubscriptionEnum, [NativeTypeName("DWORD")] uint SubscriptionNameBufferSize, [NativeTypeName("LPWSTR")] ushort* SubscriptionNameBuffer, [NativeTypeName("PDWORD")] uint* SubscriptionNameBufferUsed);
        ...
        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcSetSubscriptionProperty([NativeTypeName("EC_HANDLE")] IntPtr Subscription, EC_SUBSCRIPTION_PROPERTY_ID PropertyId, [NativeTypeName("DWORD")] uint Flags, [NativeTypeName("PEC_VARIANT")] EC_VARIANT* PropertyValue);

        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcGetSubscriptionProperty([NativeTypeName("EC_HANDLE")] IntPtr Subscription, EC_SUBSCRIPTION_PROPERTY_ID PropertyId, [NativeTypeName("DWORD")] uint Flags, [NativeTypeName("DWORD")] uint PropertyValueBufferSize, [NativeTypeName("PEC_VARIANT")] EC_VARIANT* PropertyValueBuffer, [NativeTypeName("PDWORD")] uint* PropertyValueBufferUsed);

        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcSaveSubscription([NativeTypeName("EC_HANDLE")] IntPtr Subscription, [NativeTypeName("DWORD")] uint Flags);
        ...
        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcGetObjectArraySize([NativeTypeName("EC_OBJECT_ARRAY_PROPERTY_HANDLE")] IntPtr ObjectArray, [NativeTypeName("PDWORD")] uint* ObjectArraySize);

        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcSetObjectArrayProperty([NativeTypeName("EC_OBJECT_ARRAY_PROPERTY_HANDLE")] IntPtr ObjectArray, EC_SUBSCRIPTION_PROPERTY_ID PropertyId, [NativeTypeName("DWORD")] uint ArrayIndex, [NativeTypeName("DWORD")] uint Flags, [NativeTypeName("PEC_VARIANT")] EC_VARIANT* PropertyValue);

        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcGetObjectArrayProperty([NativeTypeName("EC_OBJECT_ARRAY_PROPERTY_HANDLE")] IntPtr ObjectArray, EC_SUBSCRIPTION_PROPERTY_ID PropertyId, [NativeTypeName("DWORD")] uint ArrayIndex, [NativeTypeName("DWORD")] uint Flags, [NativeTypeName("DWORD")] uint PropertyValueBufferSize, [NativeTypeName("PEC_VARIANT")] EC_VARIANT* PropertyValueBuffer, [NativeTypeName("PDWORD")] uint* PropertyValueBufferUsed);

        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcInsertObjectArrayElement([NativeTypeName("EC_OBJECT_ARRAY_PROPERTY_HANDLE")] IntPtr ObjectArray, [NativeTypeName("DWORD")] uint ArrayIndex);

        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcRemoveObjectArrayElement([NativeTypeName("EC_OBJECT_ARRAY_PROPERTY_HANDLE")] IntPtr ObjectArray, [NativeTypeName("DWORD")] uint ArrayIndex);
        ...
        [DllImport("wecapi", ExactSpelling = true)]
        public static extern BOOL EcClose([NativeTypeName("EC_HANDLE")] IntPtr Object);
