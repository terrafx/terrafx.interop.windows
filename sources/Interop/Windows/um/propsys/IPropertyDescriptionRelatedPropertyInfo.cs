...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IPropertyDescriptionRelatedPropertyInfo
    {
        ...
        {
            return ((delegate* unmanaged<IPropertyDescriptionRelatedPropertyInfo*, int, ushort**, int>)(lpVtbl[17]))((IPropertyDescriptionRelatedPropertyInfo*)Unsafe.AsPointer(ref this), fDescending, ppszDescription);
        }
