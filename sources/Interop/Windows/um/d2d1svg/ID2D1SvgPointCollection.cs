...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1SvgPointCollection
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1SvgPointCollection*, D2D_POINT_2F*, uint, uint, int>)(lpVtbl[7]))((ID2D1SvgPointCollection*)Unsafe.AsPointer(ref this), points, pointsCount, startIndex);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1SvgPointCollection*, D2D_POINT_2F*, uint, uint, int>)(lpVtbl[8]))((ID2D1SvgPointCollection*)Unsafe.AsPointer(ref this), points, pointsCount, startIndex);
        }
