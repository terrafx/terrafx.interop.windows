...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IPSFactoryBuffer
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* stdcall<IPSFactoryBuffer*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<IPSFactoryBuffer*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<IPSFactoryBuffer*, uint> Release;

            [NativeTypeName("HRESULT (IUnknown *, const IID &, IRpcProxyBuffer **, void **) __attribute__((stdcall))")]
            public delegate* stdcall<IPSFactoryBuffer*, IUnknown*, Guid*, IRpcProxyBuffer**, void**, int> CreateProxy;

            [NativeTypeName("HRESULT (const IID &, IUnknown *, IRpcStubBuffer **) __attribute__((stdcall))")]
            public delegate* stdcall<IPSFactoryBuffer*, Guid*, IUnknown*, IRpcStubBuffer**, int> CreateStub;
        }
    }
}
