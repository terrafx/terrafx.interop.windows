...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IGlobalInterfaceTable
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IGlobalInterfaceTable*, Guid*, void**, int>)(lpVtbl[0]))((IGlobalInterfaceTable*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IGlobalInterfaceTable*, IUnknown*, Guid*, uint*, int>)(lpVtbl[3]))((IGlobalInterfaceTable*)Unsafe.AsPointer(ref this), pUnk, riid, pdwCookie);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IGlobalInterfaceTable*, uint, int>)(lpVtbl[4]))((IGlobalInterfaceTable*)Unsafe.AsPointer(ref this), dwCookie);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IGlobalInterfaceTable*, uint, Guid*, void**, int>)(lpVtbl[5]))((IGlobalInterfaceTable*)Unsafe.AsPointer(ref this), dwCookie, riid, ppv);
        }
    }
}
