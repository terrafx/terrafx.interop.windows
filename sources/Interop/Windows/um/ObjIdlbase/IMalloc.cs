...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IMalloc
    {
        ...
        public delegate void* _Alloc(IMalloc* pThis, [NativeTypeName("SIZE_T")] nuint cb);

        [UnmanagedFunctionPointer(CallingConvention.Winapi)]
        [return: NativeTypeName("void *")]
        public delegate void* _Realloc(IMalloc* pThis, [NativeTypeName("void *")] void* pv, [NativeTypeName("SIZE_T")] nuint cb);
        ...
        public delegate nuint _GetSize(IMalloc* pThis, [NativeTypeName("void *")] void* pv);
