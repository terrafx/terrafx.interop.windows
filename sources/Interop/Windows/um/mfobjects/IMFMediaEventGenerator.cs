...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IMFMediaEventGenerator
    {
        ...
        {
            return ((delegate* unmanaged<IMFMediaEventGenerator*, uint, Guid*, int, PROPVARIANT*, int>)(lpVtbl[6]))((IMFMediaEventGenerator*)Unsafe.AsPointer(ref this), met, guidExtendedType, hrStatus, pvValue);
        }
    }
}
