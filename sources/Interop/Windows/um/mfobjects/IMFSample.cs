...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IMFSample
    {
        ...
        {
            return ((delegate* unmanaged<IMFSample*, Guid*, PROPVARIANT*, int*, int>)(lpVtbl[5]))((IMFSample*)Unsafe.AsPointer(ref this), guidKey, Value, pbResult);
        }
        ...
        {
            return ((delegate* unmanaged<IMFSample*, IMFAttributes*, MF_ATTRIBUTES_MATCH_TYPE, int*, int>)(lpVtbl[6]))((IMFSample*)Unsafe.AsPointer(ref this), pTheirs, MatchType, pbResult);
        }
