...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IMFAttributes
    {
        ...
        {
            return ((delegate* unmanaged<IMFAttributes*, Guid*, PROPVARIANT*, int*, int>)(lpVtbl[5]))((IMFAttributes*)Unsafe.AsPointer(ref this), guidKey, Value, pbResult);
        }
        ...
        {
            return ((delegate* unmanaged<IMFAttributes*, IMFAttributes*, MF_ATTRIBUTES_MATCH_TYPE, int*, int>)(lpVtbl[6]))((IMFAttributes*)Unsafe.AsPointer(ref this), pTheirs, MatchType, pbResult);
        }
