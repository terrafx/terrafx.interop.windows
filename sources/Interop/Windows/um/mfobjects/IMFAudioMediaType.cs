...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IMFAudioMediaType
    {
        ...
        {
            return ((delegate* unmanaged<IMFAudioMediaType*, Guid*, PROPVARIANT*, int*, int>)(lpVtbl[5]))((IMFAudioMediaType*)Unsafe.AsPointer(ref this), guidKey, Value, pbResult);
        }
        ...
        {
            return ((delegate* unmanaged<IMFAudioMediaType*, IMFAttributes*, MF_ATTRIBUTES_MATCH_TYPE, int*, int>)(lpVtbl[6]))((IMFAudioMediaType*)Unsafe.AsPointer(ref this), pTheirs, MatchType, pbResult);
        }
        ...
        {
            return ((delegate* unmanaged<IMFAudioMediaType*, int*, int>)(lpVtbl[34]))((IMFAudioMediaType*)Unsafe.AsPointer(ref this), pfCompressed);
        }
