...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IMFVideoMediaType
    {
        ...
        {
            return ((delegate* unmanaged<IMFVideoMediaType*, Guid*, PROPVARIANT*, int*, int>)(lpVtbl[5]))((IMFVideoMediaType*)Unsafe.AsPointer(ref this), guidKey, Value, pbResult);
        }
        ...
        {
            return ((delegate* unmanaged<IMFVideoMediaType*, IMFAttributes*, MF_ATTRIBUTES_MATCH_TYPE, int*, int>)(lpVtbl[6]))((IMFVideoMediaType*)Unsafe.AsPointer(ref this), pTheirs, MatchType, pbResult);
        }
        ...
        {
            return ((delegate* unmanaged<IMFVideoMediaType*, int*, int>)(lpVtbl[34]))((IMFVideoMediaType*)Unsafe.AsPointer(ref this), pfCompressed);
        }
