...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IMFActivate
    {
        ...
        {
            return ((delegate* unmanaged<IMFActivate*, Guid*, PROPVARIANT*, int*, int>)(lpVtbl[5]))((IMFActivate*)Unsafe.AsPointer(ref this), guidKey, Value, pbResult);
        }
        ...
        {
            return ((delegate* unmanaged<IMFActivate*, IMFAttributes*, MF_ATTRIBUTES_MATCH_TYPE, int*, int>)(lpVtbl[6]))((IMFActivate*)Unsafe.AsPointer(ref this), pTheirs, MatchType, pbResult);
        }
