...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ICredentialProviderCredentialEvents2
    {
        ...
        {
            return ((delegate* unmanaged<ICredentialProviderCredentialEvents2*, ICredentialProviderCredential*, uint, int, ushort*, int>)(lpVtbl[6]))((ICredentialProviderCredentialEvents2*)Unsafe.AsPointer(ref this), pcpc, dwFieldID, bChecked, pszLabel);
        }
