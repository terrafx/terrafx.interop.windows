...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Heap32ListFirst([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPHEAPLIST32")] HEAPLIST32* lphl);

        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Heap32ListNext([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPHEAPLIST32")] HEAPLIST32* lphl);
        ...
        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Process32FirstW([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPPROCESSENTRY32W")] PROCESSENTRY32W* lppe);

        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Process32NextW([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPPROCESSENTRY32W")] PROCESSENTRY32W* lppe);

        [DllImport("kernel32", EntryPoint = "Process32First", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Process32FirstA([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPPROCESSENTRY32")] PROCESSENTRY32* lppe);

        [DllImport("kernel32", EntryPoint = "Process32Next", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Process32NextA([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPPROCESSENTRY32")] PROCESSENTRY32* lppe);

        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Thread32First([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPTHREADENTRY32")] THREADENTRY32* lpte);

        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Thread32Next([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPTHREADENTRY32")] THREADENTRY32* lpte);

        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Module32FirstW([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPMODULEENTRY32W")] MODULEENTRY32W* lpme);

        [DllImport("kernel32", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Module32NextW([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPMODULEENTRY32W")] MODULEENTRY32W* lpme);

        [DllImport("kernel32", EntryPoint = "Module32First", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Module32FirstA([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPMODULEENTRY32")] MODULEENTRY32* lpme);

        [DllImport("kernel32", EntryPoint = "Module32Next", ExactSpelling = true, SetLastError = true)]
        public static extern BOOL Module32NextA([NativeTypeName("HANDLE")] IntPtr hSnapshot, [NativeTypeName("LPMODULEENTRY32")] MODULEENTRY32* lpme);
        ...
        public static delegate*<IntPtr, PROCESSENTRY32W*, BOOL> Process32First => &Process32FirstW;

        [NativeTypeName("#define Process32Next Process32NextW")]
        public static delegate*<IntPtr, PROCESSENTRY32W*, BOOL> Process32Next => &Process32NextW;

        [NativeTypeName("#define Module32First Module32FirstW")]
        public static delegate*<IntPtr, MODULEENTRY32W*, BOOL> Module32First => &Module32FirstW;

        [NativeTypeName("#define Module32Next Module32NextW")]
        public static delegate*<IntPtr, MODULEENTRY32W*, BOOL> Module32Next => &Module32NextW;
    }
}
