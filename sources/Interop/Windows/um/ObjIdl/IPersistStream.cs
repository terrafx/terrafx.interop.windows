...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IPersistStream
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IPersistStream*, IStream*, int, int>)(lpVtbl[6]))((IPersistStream*)Unsafe.AsPointer(ref this), pStm, fClearDirty);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IPersistStream*, ULARGE_INTEGER*, int>)(lpVtbl[7]))((IPersistStream*)Unsafe.AsPointer(ref this), pcbSize);
        }
    }
}
