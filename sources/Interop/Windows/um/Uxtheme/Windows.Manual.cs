...
namespace TerraFX.Interop
{
    ...
    {
        public static int BufferedPaintMakeOpaque(IntPtr hBufferedPaint, RECT* prc) => BufferedPaintSetAlpha(hBufferedPaint, prc, 255);

        public static int SetWindowThemeNonClientAttributes(IntPtr hwnd, uint dwMask, uint dwAttributes)
        {
