...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("kernel32", EntryPoint = "CreateIoCompletionPort", ExactSpelling = true)]
        ...
        [DllImport("kernel32", EntryPoint = "GetQueuedCompletionStatus", ExactSpelling = true, SetLastError = true)]
        ...
        [DllImport("kernel32", EntryPoint = "GetQueuedCompletionStatusEx", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "PostQueuedCompletionStatus", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "DeviceIoControl", ExactSpelling = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "GetOverlappedResult", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "CancelIo", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        public static extern int CancelIo([NativeTypeName("HANDLE")] IntPtr hFile);

        [DllImport("kernel32", EntryPoint = "GetOverlappedResultEx", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "CancelSynchronousIo", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
