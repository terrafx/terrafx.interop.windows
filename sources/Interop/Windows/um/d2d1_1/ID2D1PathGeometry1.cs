...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1PathGeometry1
    {
        ...
        {
            return ((delegate* unmanaged<ID2D1PathGeometry1*, D2D_POINT_2F, D2D_MATRIX_3X2_F*, float, int*, int>)(lpVtbl[7]))((ID2D1PathGeometry1*)Unsafe.AsPointer(ref this), point, worldTransform, flatteningTolerance, contains);
        }
