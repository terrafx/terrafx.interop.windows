...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1PrintControl
    {
        ...
        {
            return ((delegate* stdcall<ID2D1PrintControl*, Guid*, void**, int>)(lpVtbl[0]))((ID2D1PrintControl*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint AddRef()
        {
            return ((delegate* stdcall<ID2D1PrintControl*, uint>)(lpVtbl[1]))((ID2D1PrintControl*)Unsafe.AsPointer(ref this));
        }
        ...
        public uint Release()
        {
            return ((delegate* stdcall<ID2D1PrintControl*, uint>)(lpVtbl[2]))((ID2D1PrintControl*)Unsafe.AsPointer(ref this));
        }
        ...
        public int Close()
        {
            return ((delegate* stdcall<ID2D1PrintControl*, int>)(lpVtbl[4]))((ID2D1PrintControl*)Unsafe.AsPointer(ref this));
        }
    }
}
