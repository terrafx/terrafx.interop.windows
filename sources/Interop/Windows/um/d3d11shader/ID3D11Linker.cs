...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11Linker
    {
        ...
        {
            return ((delegate* stdcall<ID3D11Linker*, Guid*, void**, int>)(lpVtbl[0]))((ID3D11Linker*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint AddRef()
        {
            return ((delegate* stdcall<ID3D11Linker*, uint>)(lpVtbl[1]))((ID3D11Linker*)Unsafe.AsPointer(ref this));
        }
        ...
        public uint Release()
        {
            return ((delegate* stdcall<ID3D11Linker*, uint>)(lpVtbl[2]))((ID3D11Linker*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Linker*, uint, uint, int>)(lpVtbl[5]))((ID3D11Linker*)Unsafe.AsPointer(ref this), uCBufferSlot, uCBufferEntry);
        }
    }
}
