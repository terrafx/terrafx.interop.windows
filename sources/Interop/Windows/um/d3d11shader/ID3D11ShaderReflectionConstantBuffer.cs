...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11ShaderReflectionConstantBuffer
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflectionConstantBuffer*, D3D11_SHADER_BUFFER_DESC*, int>)(lpVtbl[0]))((ID3D11ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), pDesc);
        }
