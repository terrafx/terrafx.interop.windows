...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11FunctionParameterReflection
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11FunctionParameterReflection*, D3D11_PARAMETER_DESC*, int>)(lpVtbl[0]))((ID3D11FunctionParameterReflection*)Unsafe.AsPointer(ref this), pDesc);
        }
    }
}
