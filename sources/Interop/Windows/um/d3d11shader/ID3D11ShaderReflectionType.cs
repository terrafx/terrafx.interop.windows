...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11ShaderReflectionType
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflectionType*, D3D11_SHADER_TYPE_DESC*, int>)(lpVtbl[0]))((ID3D11ShaderReflectionType*)Unsafe.AsPointer(ref this), pDesc);
        }
