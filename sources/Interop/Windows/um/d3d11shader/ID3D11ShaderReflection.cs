...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11ShaderReflection
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, D3D11_SHADER_DESC*, int>)(lpVtbl[3]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this), pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, uint, D3D11_SHADER_INPUT_BIND_DESC*, int>)(lpVtbl[6]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this), ResourceIndex, pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, uint, D3D11_SIGNATURE_PARAMETER_DESC*, int>)(lpVtbl[7]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this), ParameterIndex, pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, uint, D3D11_SIGNATURE_PARAMETER_DESC*, int>)(lpVtbl[8]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this), ParameterIndex, pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, uint, D3D11_SIGNATURE_PARAMETER_DESC*, int>)(lpVtbl[9]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this), ParameterIndex, pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, sbyte*, D3D11_SHADER_INPUT_BIND_DESC*, int>)(lpVtbl[11]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this), Name, pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, D3D_PRIMITIVE>)(lpVtbl[16]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderReflection*, int>)(lpVtbl[17]))((ID3D11ShaderReflection*)Unsafe.AsPointer(ref this));
        }
