...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID2D1Factory6
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _RegisterEffectFromString(ID2D1Factory6* This, [NativeTypeName("REFCLSID")] Guid* classId, [NativeTypeName("PCWSTR")] char* propertyXml, [Optional, NativeTypeName("D2D1_PROPERTY_BINDING[]")] D2D1_PROPERTY_BINDING* bindings, [NativeTypeName("UINT32")] uint bindingsCount, PD2D1_EFFECT_FACTORY effectFactory);
