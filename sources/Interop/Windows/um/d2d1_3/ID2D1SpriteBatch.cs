...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1SpriteBatch
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1SpriteBatch*, uint, uint, D2D_RECT_F*, D2D_RECT_U*, DXGI_RGBA*, D2D_MATRIX_3X2_F*, int>)(lpVtbl[6]))((ID2D1SpriteBatch*)Unsafe.AsPointer(ref this), startIndex, spriteCount, destinationRectangles, sourceRectangles, colors, transforms);
        }
