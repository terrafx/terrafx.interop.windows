...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1DeviceContext2
    {
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, Guid*, void**, int>)(lpVtbl[0]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }

        [return: NativeTypeName("ULONG")]
        public uint AddRef()
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, uint>)(lpVtbl[1]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("ULONG")]
        public uint Release()
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, uint>)(lpVtbl[2]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        public void GetFactory([NativeTypeName("ID2D1Factory **")] ID2D1Factory** factory)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), factory);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[4]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), size, srcData, pitch, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[5]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, Guid*, void*, D2D1_BITMAP_PROPERTIES*, ID2D1Bitmap**, int>)(lpVtbl[6]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), riid, data, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush**, int>)(lpVtbl[7]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, DXGI_RGBA*, D2D1_BRUSH_PROPERTIES*, ID2D1SolidColorBrush**, int>)(lpVtbl[8]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), color, brushProperties, solidColorBrush);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_GRADIENT_STOP*, uint, D2D1_GAMMA, D2D1_EXTEND_MODE, ID2D1GradientStopCollection**, int>)(lpVtbl[9]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode, gradientStopCollection);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1LinearGradientBrush**, int>)(lpVtbl[10]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), linearGradientBrushProperties, brushProperties, gradientStopCollection, linearGradientBrush);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1GradientStopCollection*, ID2D1RadialGradientBrush**, int>)(lpVtbl[11]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), radialGradientBrushProperties, brushProperties, gradientStopCollection, radialGradientBrush);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D_SIZE_F*, D2D_SIZE_U*, D2D1_PIXEL_FORMAT*, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, ID2D1BitmapRenderTarget**, int>)(lpVtbl[12]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), desiredSize, desiredPixelSize, desiredFormat, options, bitmapRenderTarget);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateLayer([NativeTypeName("const D2D1_SIZE_F *")] D2D_SIZE_F* size, [NativeTypeName("ID2D1Layer **")] ID2D1Layer** layer)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D_SIZE_F*, ID2D1Layer**, int>)(lpVtbl[13]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), size, layer);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateMesh([NativeTypeName("ID2D1Mesh **")] ID2D1Mesh** mesh)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Mesh**, int>)(lpVtbl[14]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), mesh);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_POINT_2F, D2D_POINT_2F, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[15]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), point0, point1, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_RECT_F*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
        }

        public void FillRectangle([NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* rect, [NativeTypeName("ID2D1Brush *")] ID2D1Brush* brush)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_RECT_F*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), rect, brush);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_ROUNDED_RECT*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[18]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), roundedRect, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_ROUNDED_RECT*, ID2D1Brush*, void>)(lpVtbl[19]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), roundedRect, brush);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_ELLIPSE*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[20]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), ellipse, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_ELLIPSE*, ID2D1Brush*, void>)(lpVtbl[21]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), ellipse, brush);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Geometry*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[22]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), geometry, brush, strokeWidth, strokeStyle);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Geometry*, ID2D1Brush*, ID2D1Brush*, void>)(lpVtbl[23]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), geometry, brush, opacityBrush);
        }

        public void FillMesh([NativeTypeName("ID2D1Mesh *")] ID2D1Mesh* mesh, [NativeTypeName("ID2D1Brush *")] ID2D1Brush* brush)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Mesh*, ID2D1Brush*, void>)(lpVtbl[24]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), mesh, brush);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Bitmap*, ID2D1Brush*, D2D1_OPACITY_MASK_CONTENT, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[25]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_BITMAP_INTERPOLATION_MODE, D2D_RECT_F*, void>)(lpVtbl[26]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ushort*, uint, IDWriteTextFormat*, D2D_RECT_F*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, DWRITE_MEASURING_MODE, void>)(lpVtbl[27]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutRect, defaultFillBrush, options, measuringMode);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_POINT_2F, IDWriteTextLayout*, ID2D1Brush*, D2D1_DRAW_TEXT_OPTIONS, void>)(lpVtbl[28]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, options);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[29]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, foregroundBrush, measuringMode);
        }

        public void SetTransform([NativeTypeName("const D2D1_MATRIX_3X2_F *")] D2D_MATRIX_3X2_F* transform)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[30]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), transform);
        }

        public void GetTransform([NativeTypeName("D2D1_MATRIX_3X2_F *")] D2D_MATRIX_3X2_F* transform)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[31]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), transform);
        }

        public void SetAntialiasMode(D2D1_ANTIALIAS_MODE antialiasMode)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[32]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), antialiasMode);
        }

        public D2D1_ANTIALIAS_MODE GetAntialiasMode()
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_ANTIALIAS_MODE>)(lpVtbl[33]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        public void SetTextAntialiasMode(D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_TEXT_ANTIALIAS_MODE, void>)(lpVtbl[34]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), textAntialiasMode);
        }

        public D2D1_TEXT_ANTIALIAS_MODE GetTextAntialiasMode()
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_TEXT_ANTIALIAS_MODE>)(lpVtbl[35]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        public void SetTextRenderingParams([NativeTypeName("IDWriteRenderingParams *")] IDWriteRenderingParams* textRenderingParams = null)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, IDWriteRenderingParams*, void>)(lpVtbl[36]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), textRenderingParams);
        }

        public void GetTextRenderingParams([NativeTypeName("IDWriteRenderingParams **")] IDWriteRenderingParams** textRenderingParams)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, IDWriteRenderingParams**, void>)(lpVtbl[37]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), textRenderingParams);
        }

        public void SetTags([NativeTypeName("D2D1_TAG")] ulong tag1, [NativeTypeName("D2D1_TAG")] ulong tag2)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ulong, ulong, void>)(lpVtbl[38]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), tag1, tag2);
        }

        public void GetTags([NativeTypeName("D2D1_TAG *")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG *")] ulong* tag2 = null)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ulong*, ulong*, void>)(lpVtbl[39]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), tag1, tag2);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_LAYER_PARAMETERS*, ID2D1Layer*, void>)(lpVtbl[40]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), layerParameters, layer);
        }

        public void PopLayer()
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, void>)(lpVtbl[41]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("HRESULT")]
        public int Flush([NativeTypeName("D2D1_TAG *")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG *")] ulong* tag2 = null)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ulong*, ulong*, int>)(lpVtbl[42]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), tag1, tag2);
        }

        public void SaveDrawingState([NativeTypeName("ID2D1DrawingStateBlock *")] ID2D1DrawingStateBlock* drawingStateBlock)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1DrawingStateBlock*, void>)(lpVtbl[43]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), drawingStateBlock);
        }

        public void RestoreDrawingState([NativeTypeName("ID2D1DrawingStateBlock *")] ID2D1DrawingStateBlock* drawingStateBlock)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1DrawingStateBlock*, void>)(lpVtbl[44]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), drawingStateBlock);
        }

        public void PushAxisAlignedClip([NativeTypeName("const D2D1_RECT_F *")] D2D_RECT_F* clipRect, D2D1_ANTIALIAS_MODE antialiasMode)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, void>)(lpVtbl[45]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
        }

        public void PopAxisAlignedClip()
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, void>)(lpVtbl[46]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        public void Clear([NativeTypeName("const D2D1_COLOR_F *")] DXGI_RGBA* clearColor = null)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, DXGI_RGBA*, void>)(lpVtbl[47]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), clearColor);
        }

        public void BeginDraw()
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, void>)(lpVtbl[48]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("HRESULT")]
        public int EndDraw([NativeTypeName("D2D1_TAG *")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG *")] ulong* tag2 = null)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ulong*, ulong*, int>)(lpVtbl[49]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), tag1, tag2);
        }

        public D2D1_PIXEL_FORMAT GetPixelFormat()
        {
            D2D1_PIXEL_FORMAT result;
            return *((delegate* stdcall<ID2D1DeviceContext2*, D2D1_PIXEL_FORMAT*, D2D1_PIXEL_FORMAT*>)(lpVtbl[50]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), &result);
        }

        public void SetDpi([NativeTypeName("FLOAT")] float dpiX, [NativeTypeName("FLOAT")] float dpiY)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, float, float, void>)(lpVtbl[51]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), dpiX, dpiY);
        }

        public void GetDpi([NativeTypeName("FLOAT *")] float* dpiX, [NativeTypeName("FLOAT *")] float* dpiY)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, float*, float*, void>)(lpVtbl[52]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), dpiX, dpiY);
        }
        ...
        {
            D2D_SIZE_F result;
            return *((delegate* stdcall<ID2D1DeviceContext2*, D2D_SIZE_F*, D2D_SIZE_F*>)(lpVtbl[53]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            D2D_SIZE_U result;
            return *((delegate* stdcall<ID2D1DeviceContext2*, D2D_SIZE_U*, D2D_SIZE_U*>)(lpVtbl[54]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), &result);
        }

        [return: NativeTypeName("UINT32")]
        public uint GetMaximumBitmapSize()
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, uint>)(lpVtbl[55]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_RENDER_TARGET_PROPERTIES*, int>)(lpVtbl[56]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), renderTargetProperties);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D_SIZE_U, void*, uint, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[57]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), size, sourceData, pitch, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, IWICBitmapSource*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[58]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_COLOR_SPACE, byte*, uint, ID2D1ColorContext**, int>)(lpVtbl[59]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), space, profile, profileSize, colorContext);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ushort*, ID2D1ColorContext**, int>)(lpVtbl[60]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), filename, colorContext);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, IWICColorContext*, ID2D1ColorContext**, int>)(lpVtbl[61]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), wicColorContext, colorContext);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, IDXGISurface*, D2D1_BITMAP_PROPERTIES1*, ID2D1Bitmap1**, int>)(lpVtbl[62]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), surface, bitmapProperties, bitmap);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateEffect([NativeTypeName("const IID &")] Guid* effectId, [NativeTypeName("ID2D1Effect **")] ID2D1Effect** effect)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, Guid*, ID2D1Effect**, int>)(lpVtbl[63]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), effectId, effect);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Image*, D2D1_IMAGE_BRUSH_PROPERTIES*, D2D1_BRUSH_PROPERTIES*, ID2D1ImageBrush**, int>)(lpVtbl[65]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), image, imageBrushProperties, brushProperties, imageBrush);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Bitmap*, D2D1_BITMAP_BRUSH_PROPERTIES1*, D2D1_BRUSH_PROPERTIES*, ID2D1BitmapBrush1**, int>)(lpVtbl[66]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateCommandList([NativeTypeName("ID2D1CommandList **")] ID2D1CommandList** commandList)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1CommandList**, int>)(lpVtbl[67]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), commandList);
        }

        [return: NativeTypeName("BOOL")]
        public int IsDxgiFormatSupported(DXGI_FORMAT format)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, DXGI_FORMAT, int>)(lpVtbl[68]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), format);
        }

        [return: NativeTypeName("BOOL")]
        public int IsBufferPrecisionSupported(D2D1_BUFFER_PRECISION bufferPrecision)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[69]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), bufferPrecision);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[70]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), image, localBounds);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Image*, D2D_RECT_F*, int>)(lpVtbl[71]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), image, worldBounds);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_RECT_F*, int>)(lpVtbl[72]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, measuringMode, bounds);
        }

        public void GetDevice([NativeTypeName("ID2D1Device **")] ID2D1Device** device)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Device**, void>)(lpVtbl[73]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), device);
        }

        public void SetTarget([NativeTypeName("ID2D1Image *")] ID2D1Image* image)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Image*, void>)(lpVtbl[74]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), image);
        }

        public void GetTarget([NativeTypeName("ID2D1Image **")] ID2D1Image** image)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Image**, void>)(lpVtbl[75]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), image);
        }

        public void SetRenderingControls([NativeTypeName("const D2D1_RENDERING_CONTROLS *")] D2D1_RENDERING_CONTROLS* renderingControls)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_RENDERING_CONTROLS*, void>)(lpVtbl[76]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), renderingControls);
        }

        public void GetRenderingControls([NativeTypeName("D2D1_RENDERING_CONTROLS *")] D2D1_RENDERING_CONTROLS* renderingControls)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_RENDERING_CONTROLS*, void>)(lpVtbl[77]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), renderingControls);
        }

        public void SetPrimitiveBlend(D2D1_PRIMITIVE_BLEND primitiveBlend)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_PRIMITIVE_BLEND, void>)(lpVtbl[78]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), primitiveBlend);
        }

        public D2D1_PRIMITIVE_BLEND GetPrimitiveBlend()
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_PRIMITIVE_BLEND>)(lpVtbl[79]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }

        public void SetUnitMode(D2D1_UNIT_MODE unitMode)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_UNIT_MODE, void>)(lpVtbl[80]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), unitMode);
        }

        public D2D1_UNIT_MODE GetUnitMode()
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_UNIT_MODE>)(lpVtbl[81]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, ID2D1Brush*, DWRITE_MEASURING_MODE, void>)(lpVtbl[82]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, foregroundBrush, measuringMode);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Image*, D2D_POINT_2F*, D2D_RECT_F*, D2D1_INTERPOLATION_MODE, D2D1_COMPOSITE_MODE, void>)(lpVtbl[83]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), image, targetOffset, imageRectangle, interpolationMode, compositeMode);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1GdiMetafile*, D2D_POINT_2F*, void>)(lpVtbl[84]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), gdiMetafile, targetOffset);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Bitmap*, D2D_RECT_F*, float, D2D1_INTERPOLATION_MODE, D2D_RECT_F*, D2D_MATRIX_4X4_F*, void>)(lpVtbl[85]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle, perspectiveTransform);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_LAYER_PARAMETERS1*, ID2D1Layer*, void>)(lpVtbl[86]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), layerParameters, layer);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Effect*, uint, D2D_RECT_F*, int>)(lpVtbl[87]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), effect, input, inputRectangle);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Effect*, uint*, int>)(lpVtbl[88]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), effect, rectangleCount);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Effect*, D2D_RECT_F*, uint, int>)(lpVtbl[89]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), effect, rectangles, rectanglesCount);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Effect*, D2D_RECT_F*, D2D1_EFFECT_INPUT_DESCRIPTION*, D2D_RECT_F*, uint, int>)(lpVtbl[90]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), renderEffect, renderImageRectangle, inputDescriptions, requiredInputRects, inputCount);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Bitmap*, ID2D1Brush*, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[91]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Geometry*, float, ID2D1GeometryRealization**, int>)(lpVtbl[92]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), geometry, flatteningTolerance, geometryRealization);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Geometry*, float, float, ID2D1StrokeStyle*, ID2D1GeometryRealization**, int>)(lpVtbl[93]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), geometry, flatteningTolerance, strokeWidth, strokeStyle, geometryRealization);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1GeometryRealization*, ID2D1Brush*, void>)(lpVtbl[94]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), geometryRealization, brush);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateInk([NativeTypeName("const D2D1_INK_POINT *")] D2D1_INK_POINT* startPoint, [NativeTypeName("ID2D1Ink **")] ID2D1Ink** ink)
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_INK_POINT*, ID2D1Ink**, int>)(lpVtbl[95]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), startPoint, ink);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_INK_STYLE_PROPERTIES*, ID2D1InkStyle**, int>)(lpVtbl[96]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), inkStyleProperties, inkStyle);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_GRADIENT_MESH_PATCH*, uint, ID2D1GradientMesh**, int>)(lpVtbl[97]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), patches, patchesCount, gradientMesh);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, IWICBitmapSource*, D2D1_IMAGE_SOURCE_LOADING_OPTIONS, D2D1_ALPHA_MODE, ID2D1ImageSourceFromWic**, int>)(lpVtbl[98]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), wicBitmapSource, loadingOptions, alphaMode, imageSource);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, D2D1_BUFFER_PRECISION, uint*, byte*, uint, uint*, ID2D1LookupTable3D**, int>)(lpVtbl[99]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), precision, extents, data, dataCount, strides, lookupTable);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, IDXGISurface**, uint, DXGI_COLOR_SPACE_TYPE, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS, ID2D1ImageSource**, int>)(lpVtbl[100]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), surfaces, surfaceCount, colorSpace, options, imageSource);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1GradientMesh*, D2D_RECT_F*, int>)(lpVtbl[101]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), gradientMesh, pBounds);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1Ink*, ID2D1Brush*, ID2D1InkStyle*, void>)(lpVtbl[102]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), ink, brush, inkStyle);
        }

        public void DrawGradientMesh([NativeTypeName("ID2D1GradientMesh *")] ID2D1GradientMesh* gradientMesh)
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1GradientMesh*, void>)(lpVtbl[103]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), gradientMesh);
        }
        ...
        {
            ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1GdiMetafile*, D2D_RECT_F*, D2D_RECT_F*, void>)(lpVtbl[104]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), gdiMetafile, destinationRectangle, sourceRectangle);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1DeviceContext2*, ID2D1ImageSource*, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES*, ID2D1TransformedImageSource**, int>)(lpVtbl[105]))((ID2D1DeviceContext2*)Unsafe.AsPointer(ref this), imageSource, properties, transformedImageSource);
        }
    }
}
