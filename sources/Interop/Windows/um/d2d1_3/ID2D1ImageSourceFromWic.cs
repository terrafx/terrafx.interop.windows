...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1ImageSourceFromWic
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1ImageSourceFromWic*, int*, int>)(lpVtbl[5]))((ID2D1ImageSourceFromWic*)Unsafe.AsPointer(ref this), resourcesDiscarded);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1ImageSourceFromWic*, D2D_RECT_U*, int>)(lpVtbl[6]))((ID2D1ImageSourceFromWic*)Unsafe.AsPointer(ref this), rectangleToFill);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1ImageSourceFromWic*, D2D_RECT_U*, int>)(lpVtbl[7]))((ID2D1ImageSourceFromWic*)Unsafe.AsPointer(ref this), rectangleToPreserve);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetSource([NativeTypeName("IWICBitmapSource **")] IWICBitmapSource** wicBitmapSource)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1ImageSourceFromWic*, IWICBitmapSource**, void>)(lpVtbl[8]))((ID2D1ImageSourceFromWic*)Unsafe.AsPointer(ref this), wicBitmapSource);
        }
    }
}
