...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1Factory7
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* stdcall<ID2D1Factory7*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, uint> Release;

            [NativeTypeName("HRESULT () __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, int> ReloadSystemMetrics;

            [NativeTypeName("void (FLOAT *, FLOAT *) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, float*, float*, void> GetDesktopDpi;

            [NativeTypeName("HRESULT (const D2D1_RECT_F *, ID2D1RectangleGeometry **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, D2D_RECT_F*, ID2D1RectangleGeometry**, int> CreateRectangleGeometry;

            [NativeTypeName("HRESULT (const D2D1_ROUNDED_RECT *, ID2D1RoundedRectangleGeometry **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, D2D1_ROUNDED_RECT*, ID2D1RoundedRectangleGeometry**, int> CreateRoundedRectangleGeometry;

            [NativeTypeName("HRESULT (const D2D1_ELLIPSE *, ID2D1EllipseGeometry **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, D2D1_ELLIPSE*, ID2D1EllipseGeometry**, int> CreateEllipseGeometry;
            ...
            public delegate* stdcall<ID2D1Factory7*, D2D1_FILL_MODE, ID2D1Geometry**, uint, ID2D1GeometryGroup**, int> CreateGeometryGroup;
            ...
            public delegate* stdcall<ID2D1Factory7*, ID2D1Geometry*, D2D_MATRIX_3X2_F*, ID2D1TransformedGeometry**, int> CreateTransformedGeometry;

            [NativeTypeName("HRESULT (ID2D1PathGeometry **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, ID2D1PathGeometry**, int> CreatePathGeometry;
            ...
            public delegate* stdcall<ID2D1Factory7*, D2D1_STROKE_STYLE_PROPERTIES*, float*, uint, ID2D1StrokeStyle**, int> CreateStrokeStyle;
            ...
            public delegate* stdcall<ID2D1Factory7*, D2D1_DRAWING_STATE_DESCRIPTION*, IDWriteRenderingParams*, ID2D1DrawingStateBlock**, int> CreateDrawingStateBlock;
            ...
            public delegate* stdcall<ID2D1Factory7*, IWICBitmap*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1RenderTarget**, int> CreateWicBitmapRenderTarget;
            ...
            public delegate* stdcall<ID2D1Factory7*, D2D1_RENDER_TARGET_PROPERTIES*, D2D1_HWND_RENDER_TARGET_PROPERTIES*, ID2D1HwndRenderTarget**, int> CreateHwndRenderTarget;
            ...
            public delegate* stdcall<ID2D1Factory7*, IDXGISurface*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1RenderTarget**, int> CreateDxgiSurfaceRenderTarget;
            ...
            public delegate* stdcall<ID2D1Factory7*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1DCRenderTarget**, int> CreateDCRenderTarget;

            [NativeTypeName("HRESULT (IDXGIDevice *, ID2D1Device **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IDXGIDevice*, ID2D1Device**, int> CreateDevice;
            ...
            public delegate* stdcall<ID2D1Factory7*, D2D1_STROKE_STYLE_PROPERTIES1*, float*, uint, ID2D1StrokeStyle1**, int> CreateStrokeStyle1;

            [NativeTypeName("HRESULT (ID2D1PathGeometry1 **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, ID2D1PathGeometry1**, int> CreatePathGeometry1;
            ...
            public delegate* stdcall<ID2D1Factory7*, D2D1_DRAWING_STATE_DESCRIPTION1*, IDWriteRenderingParams*, ID2D1DrawingStateBlock1**, int> CreateDrawingStateBlock1;

            [NativeTypeName("HRESULT (IStream *, ID2D1GdiMetafile **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IStream*, ID2D1GdiMetafile**, int> CreateGdiMetafile;
            ...
            public delegate* stdcall<ID2D1Factory7*, Guid*, IStream*, D2D1_PROPERTY_BINDING*, uint, delegate* stdcall<IUnknown**, int>, int> RegisterEffectFromStream;
            ...
            public delegate* stdcall<ID2D1Factory7*, Guid*, ushort*, D2D1_PROPERTY_BINDING*, uint, delegate* stdcall<IUnknown**, int>, int> RegisterEffectFromString;

            [NativeTypeName("HRESULT (const IID &) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, Guid*, int> UnregisterEffect;

            [NativeTypeName("HRESULT (CLSID *, UINT32, UINT32 *, UINT32 *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, Guid*, uint, uint*, uint*, int> GetRegisteredEffects;

            [NativeTypeName("HRESULT (const IID &, ID2D1Properties **) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, Guid*, ID2D1Properties**, int> GetEffectProperties;

            [NativeTypeName("HRESULT (IDXGIDevice *, ID2D1Device1 **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IDXGIDevice*, ID2D1Device1**, int> CreateDevice1;

            [NativeTypeName("HRESULT (IDXGIDevice *, ID2D1Device2 **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IDXGIDevice*, ID2D1Device2**, int> CreateDevice2;

            [NativeTypeName("HRESULT (IDXGIDevice *, ID2D1Device3 **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IDXGIDevice*, ID2D1Device3**, int> CreateDevice3;

            [NativeTypeName("HRESULT (IDXGIDevice *, ID2D1Device4 **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IDXGIDevice*, ID2D1Device4**, int> CreateDevice4;

            [NativeTypeName("HRESULT (IDXGIDevice *, ID2D1Device5 **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IDXGIDevice*, ID2D1Device5**, int> CreateDevice5;

            [NativeTypeName("HRESULT (IDXGIDevice *, ID2D1Device6 **) __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Factory7*, IDXGIDevice*, ID2D1Device6**, int> CreateDevice6;
        }
    }
}
