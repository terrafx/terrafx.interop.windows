...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1InkStyle
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID2D1InkStyle*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[4]))((ID2D1InkStyle*)Unsafe.AsPointer(ref this), transform);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetNibTransform([NativeTypeName("D2D1_MATRIX_3X2_F *")] D2D_MATRIX_3X2_F* transform)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1InkStyle*, D2D_MATRIX_3X2_F*, void>)(lpVtbl[5]))((ID2D1InkStyle*)Unsafe.AsPointer(ref this), transform);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetNibShape(D2D1_INK_NIB_SHAPE nibShape)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1InkStyle*, D2D1_INK_NIB_SHAPE, void>)(lpVtbl[6]))((ID2D1InkStyle*)Unsafe.AsPointer(ref this), nibShape);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public D2D1_INK_NIB_SHAPE GetNibShape()
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1InkStyle*, D2D1_INK_NIB_SHAPE>)(lpVtbl[7]))((ID2D1InkStyle*)Unsafe.AsPointer(ref this));
        }
    }
}
