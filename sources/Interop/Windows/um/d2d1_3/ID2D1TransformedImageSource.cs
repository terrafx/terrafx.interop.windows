...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1TransformedImageSource
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID2D1TransformedImageSource*, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES*, void>)(lpVtbl[5]))((ID2D1TransformedImageSource*)Unsafe.AsPointer(ref this), properties);
        }
    }
}
