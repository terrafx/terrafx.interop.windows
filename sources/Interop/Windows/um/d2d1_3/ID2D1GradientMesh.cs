...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1GradientMesh
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1GradientMesh*, uint, D2D1_GRADIENT_MESH_PATCH*, uint, int>)(lpVtbl[5]))((ID2D1GradientMesh*)Unsafe.AsPointer(ref this), startIndex, patches, patchesCount);
        }
    }
}
