...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1Ink
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Ink*, D2D1_INK_POINT*, void>)(lpVtbl[4]))((ID2D1Ink*)Unsafe.AsPointer(ref this), startPoint);
        }
        ...
        public D2D1_INK_POINT GetStartPoint()
        {
            ...
            return *((delegate* unmanaged[Stdcall]<ID2D1Ink*, D2D1_INK_POINT*, D2D1_INK_POINT*>)(lpVtbl[5]))((ID2D1Ink*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Ink*, D2D1_INK_BEZIER_SEGMENT*, uint, int>)(lpVtbl[6]))((ID2D1Ink*)Unsafe.AsPointer(ref this), segments, segmentsCount);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Ink*, uint, D2D1_INK_BEZIER_SEGMENT*, uint, int>)(lpVtbl[8]))((ID2D1Ink*)Unsafe.AsPointer(ref this), startSegment, segments, segmentsCount);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Ink*, D2D1_INK_BEZIER_SEGMENT*, int>)(lpVtbl[9]))((ID2D1Ink*)Unsafe.AsPointer(ref this), segment);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Ink*, uint, D2D1_INK_BEZIER_SEGMENT*, uint, int>)(lpVtbl[11]))((ID2D1Ink*)Unsafe.AsPointer(ref this), startSegment, segments, segmentsCount);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Ink*, ID2D1InkStyle*, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[12]))((ID2D1Ink*)Unsafe.AsPointer(ref this), inkStyle, worldTransform, flatteningTolerance, geometrySink);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Ink*, ID2D1InkStyle*, D2D_MATRIX_3X2_F*, D2D_RECT_F*, int>)(lpVtbl[13]))((ID2D1Ink*)Unsafe.AsPointer(ref this), inkStyle, worldTransform, bounds);
        }
    }
}
