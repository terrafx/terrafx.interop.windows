...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1GdiMetafile1
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1GdiMetafile1*, D2D_RECT_F*, int>)(lpVtbl[5]))((ID2D1GdiMetafile1*)Unsafe.AsPointer(ref this), bounds);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1GdiMetafile1*, D2D_RECT_F*, int>)(lpVtbl[7]))((ID2D1GdiMetafile1*)Unsafe.AsPointer(ref this), bounds);
        }
    }
}
