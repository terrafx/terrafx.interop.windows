...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1Device2
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device2*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext**, int>)(lpVtbl[4]))((ID2D1Device2*)Unsafe.AsPointer(ref this), options, deviceContext);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device2*, IWICImagingFactory*, IPrintDocumentPackageTarget*, D2D1_PRINT_CONTROL_PROPERTIES*, ID2D1PrintControl**, int>)(lpVtbl[5]))((ID2D1Device2*)Unsafe.AsPointer(ref this), wicFactory, documentTarget, printControlProperties, printControl);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetMaximumTextureMemory([NativeTypeName("UINT64")] ulong maximumInBytes)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Device2*, ulong, void>)(lpVtbl[6]))((ID2D1Device2*)Unsafe.AsPointer(ref this), maximumInBytes);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device2*, ulong>)(lpVtbl[7]))((ID2D1Device2*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void ClearResources([NativeTypeName("UINT32")] uint millisecondsSinceUse = 0)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Device2*, uint, void>)(lpVtbl[8]))((ID2D1Device2*)Unsafe.AsPointer(ref this), millisecondsSinceUse);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public D2D1_RENDERING_PRIORITY GetRenderingPriority()
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device2*, D2D1_RENDERING_PRIORITY>)(lpVtbl[9]))((ID2D1Device2*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetRenderingPriority(D2D1_RENDERING_PRIORITY renderingPriority)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Device2*, D2D1_RENDERING_PRIORITY, void>)(lpVtbl[10]))((ID2D1Device2*)Unsafe.AsPointer(ref this), renderingPriority);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device2*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext1**, int>)(lpVtbl[11]))((ID2D1Device2*)Unsafe.AsPointer(ref this), options, deviceContext1);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device2*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext2**, int>)(lpVtbl[12]))((ID2D1Device2*)Unsafe.AsPointer(ref this), options, deviceContext2);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void FlushDeviceContexts([NativeTypeName("ID2D1Bitmap *")] ID2D1Bitmap* bitmap)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Device2*, ID2D1Bitmap*, void>)(lpVtbl[13]))((ID2D1Device2*)Unsafe.AsPointer(ref this), bitmap);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device2*, IDXGIDevice**, int>)(lpVtbl[14]))((ID2D1Device2*)Unsafe.AsPointer(ref this), dxgiDevice);
        }
    }
}
