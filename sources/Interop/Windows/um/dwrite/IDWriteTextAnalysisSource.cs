...
namespace TerraFX.Interop
{
    ...
    public unsafe struct IDWriteTextAnalysisSource
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetTextAtPosition(IDWriteTextAnalysisSource* This, [NativeTypeName("UINT32")] uint textPosition, [NativeTypeName("WCHAR[]")] char** textString, [NativeTypeName("UINT32")] uint* textLength);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetTextBeforePosition(IDWriteTextAnalysisSource* This, [NativeTypeName("UINT32")] uint textPosition, [NativeTypeName("WCHAR[]")] char** textString, [NativeTypeName("UINT32")] uint* textLength);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetLocaleName(IDWriteTextAnalysisSource* This, [NativeTypeName("UINT32")] uint textPosition, [NativeTypeName("UINT32")] uint* textLength, [NativeTypeName("WCHAR[]")] char** localeName);
