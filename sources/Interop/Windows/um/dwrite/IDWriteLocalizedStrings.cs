...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteLocalizedStrings
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteLocalizedStrings*, ushort*, uint*, int*, int>)(lpVtbl[4]))((IDWriteLocalizedStrings*)Unsafe.AsPointer(ref this), localeName, index, exists);
        }
