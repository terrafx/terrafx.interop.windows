...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteTextLayout
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, int, DWRITE_TEXT_RANGE, int>)(lpVtbl[36]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), hasUnderline, textRange);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, int, DWRITE_TEXT_RANGE, int>)(lpVtbl[37]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), hasStrikethrough, textRange);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, uint, int*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[51]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), currentPosition, hasUnderline, textRange);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, uint, int*, DWRITE_TEXT_RANGE*, int>)(lpVtbl[52]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), currentPosition, hasStrikethrough, textRange);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, float, float, int*, int*, DWRITE_HIT_TEST_METRICS*, int>)(lpVtbl[64]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), pointX, pointY, isTrailingHit, isInside, hitTestMetrics);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, uint, int, float*, float*, DWRITE_HIT_TEST_METRICS*, int>)(lpVtbl[65]))((IDWriteTextLayout*)Unsafe.AsPointer(ref this), textPosition, isTrailingHit, pointX, pointY, hitTestMetrics);
        }
