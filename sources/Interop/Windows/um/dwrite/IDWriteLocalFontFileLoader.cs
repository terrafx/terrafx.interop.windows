...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteLocalFontFileLoader
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteLocalFontFileLoader*, void*, uint, FILETIME*, int>)(lpVtbl[6]))((IDWriteLocalFontFileLoader*)Unsafe.AsPointer(ref this), fontFileReferenceKey, fontFileReferenceKeySize, lastWriteTime);
        }
    }
}
