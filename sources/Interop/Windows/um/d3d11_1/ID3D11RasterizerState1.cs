...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11RasterizerState1
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11RasterizerState1*, D3D11_RASTERIZER_DESC*, void>)(lpVtbl[7]))((ID3D11RasterizerState1*)Unsafe.AsPointer(ref this), pDesc);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetDesc1([NativeTypeName("D3D11_RASTERIZER_DESC1 *")] D3D11_RASTERIZER_DESC1* pDesc)
        {
            ((delegate* unmanaged[Stdcall]<ID3D11RasterizerState1*, D3D11_RASTERIZER_DESC1*, void>)(lpVtbl[8]))((ID3D11RasterizerState1*)Unsafe.AsPointer(ref this), pDesc);
        }
    }
}
