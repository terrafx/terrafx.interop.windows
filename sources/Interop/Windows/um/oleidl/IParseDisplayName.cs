...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IParseDisplayName
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* stdcall<IParseDisplayName*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<IParseDisplayName*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<IParseDisplayName*, uint> Release;

            [NativeTypeName("HRESULT (IBindCtx *, LPOLESTR, ULONG *, IMoniker **) __attribute__((stdcall))")]
            public delegate* stdcall<IParseDisplayName*, IBindCtx*, ushort*, uint*, IMoniker**, int> ParseDisplayName;
        }
    }
}
