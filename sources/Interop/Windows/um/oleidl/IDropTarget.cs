...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDropTarget
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDropTarget*, Guid*, void**, int>)(lpVtbl[0]))((IDropTarget*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDropTarget*, IDataObject*, uint, POINTL, uint*, int>)(lpVtbl[3]))((IDropTarget*)Unsafe.AsPointer(ref this), pDataObj, grfKeyState, pt, pdwEffect);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDropTarget*, uint, POINTL, uint*, int>)(lpVtbl[4]))((IDropTarget*)Unsafe.AsPointer(ref this), grfKeyState, pt, pdwEffect);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDropTarget*, int>)(lpVtbl[5]))((IDropTarget*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDropTarget*, IDataObject*, uint, POINTL, uint*, int>)(lpVtbl[6]))((IDropTarget*)Unsafe.AsPointer(ref this), pDataObj, grfKeyState, pt, pdwEffect);
        }
    }
}
