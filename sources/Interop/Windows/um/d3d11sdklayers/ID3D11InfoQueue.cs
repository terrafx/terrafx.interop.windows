...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11InfoQueue
    {
        ...
        [VtblIndex(5)]
        [return: NativeTypeName("HRESULT")]
        public int GetMessage([NativeTypeName("UINT64")] ulong MessageIndex, D3D11_MESSAGE* pMessage, [NativeTypeName("SIZE_T *")] nuint* pMessageByteLength)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int AddStorageFilterEntries(D3D11_INFO_QUEUE_FILTER* pFilter)
        {
        ...
        [VtblIndex(13)]
        [return: NativeTypeName("HRESULT")]
        public int GetStorageFilter(D3D11_INFO_QUEUE_FILTER* pFilter, [NativeTypeName("SIZE_T *")] nuint* pFilterByteLength)
        {
        ...
        [VtblIndex(17)]
        [return: NativeTypeName("HRESULT")]
        public int PushStorageFilter(D3D11_INFO_QUEUE_FILTER* pFilter)
        {
        ...
        [VtblIndex(20)]
        [return: NativeTypeName("HRESULT")]
        public int AddRetrievalFilterEntries(D3D11_INFO_QUEUE_FILTER* pFilter)
        {
        ...
        [VtblIndex(21)]
        [return: NativeTypeName("HRESULT")]
        public int GetRetrievalFilter(D3D11_INFO_QUEUE_FILTER* pFilter, [NativeTypeName("SIZE_T *")] nuint* pFilterByteLength)
        {
        ...
        [VtblIndex(25)]
        [return: NativeTypeName("HRESULT")]
        public int PushRetrievalFilter(D3D11_INFO_QUEUE_FILTER* pFilter)
        {
        ...
        [VtblIndex(30)]
        [return: NativeTypeName("HRESULT")]
        public int SetBreakOnCategory(D3D11_MESSAGE_CATEGORY Category, BOOL bEnable)
        {
        ...
        [VtblIndex(31)]
        [return: NativeTypeName("HRESULT")]
        public int SetBreakOnSeverity(D3D11_MESSAGE_SEVERITY Severity, BOOL bEnable)
        {
        ...
        [VtblIndex(32)]
        [return: NativeTypeName("HRESULT")]
        public int SetBreakOnID(D3D11_MESSAGE_ID ID, BOOL bEnable)
        {
