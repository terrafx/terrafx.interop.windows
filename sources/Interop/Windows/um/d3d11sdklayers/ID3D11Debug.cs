...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11Debug
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11Debug*, IDXGISwapChain*, int>)(lpVtbl[7]))((ID3D11Debug*)Unsafe.AsPointer(ref this), pSwapChain);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11Debug*, IDXGISwapChain**, int>)(lpVtbl[8]))((ID3D11Debug*)Unsafe.AsPointer(ref this), ppSwapChain);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11Debug*, D3D11_RLDO_FLAGS, int>)(lpVtbl[10]))((ID3D11Debug*)Unsafe.AsPointer(ref this), Flags);
        }
