...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11VideoContext3
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int SubmitDecoderBuffers2(ID3D11VideoDecoder* pDecoder, [NativeTypeName("UINT")] uint NumBuffers, [NativeTypeName("const D3D11_VIDEO_DECODER_BUFFER_DESC2 *")] D3D11_VIDEO_DECODER_BUFFER_DESC2* pBufferDesc)
        {
