...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        public static extern Status GdipCreateEffect([NativeTypeName("const GUID")] Guid guid, [NativeTypeName("Gdiplus::CGpEffect **")] IntPtr* effect);

        [DllImport("GdiPlus", ExactSpelling = true)]
        [return: NativeTypeName("Gdiplus::Status")]
        public static extern Status GdipDeleteEffect([NativeTypeName("Gdiplus::CGpEffect *")] IntPtr effect);

        [DllImport("GdiPlus", ExactSpelling = true)]
        [return: NativeTypeName("Gdiplus::Status")]
        public static extern Status GdipGetEffectParameterSize([NativeTypeName("Gdiplus::CGpEffect *")] IntPtr effect, [NativeTypeName("UINT *")] uint* size);

        [DllImport("GdiPlus", ExactSpelling = true)]
        [return: NativeTypeName("Gdiplus::Status")]
        public static extern Status GdipSetEffectParameters([NativeTypeName("Gdiplus::CGpEffect *")] IntPtr effect, [NativeTypeName("const void *")] void* @params, [NativeTypeName("const UINT")] uint size);

        [DllImport("GdiPlus", ExactSpelling = true)]
        [return: NativeTypeName("Gdiplus::Status")]
        public static extern Status GdipGetEffectParameters([NativeTypeName("Gdiplus::CGpEffect *")] IntPtr effect, [NativeTypeName("UINT *")] uint* size, void* @params);
    }
}
