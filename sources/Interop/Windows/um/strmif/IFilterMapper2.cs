...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IFilterMapper2
    {
        ...
        {
            return ((delegate* stdcall<IFilterMapper2*, Guid*, void**, int>)(lpVtbl[0]))((IFilterMapper2*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }

        [return: NativeTypeName("ULONG")]
        public uint AddRef()
        {
            return ((delegate* stdcall<IFilterMapper2*, uint>)(lpVtbl[1]))((IFilterMapper2*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("ULONG")]
        public uint Release()
        {
            return ((delegate* stdcall<IFilterMapper2*, uint>)(lpVtbl[2]))((IFilterMapper2*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<IFilterMapper2*, Guid*, uint, ushort*, int>)(lpVtbl[3]))((IFilterMapper2*)Unsafe.AsPointer(ref this), clsidCategory, dwCategoryMerit, Description);
        }
        ...
        {
            return ((delegate* stdcall<IFilterMapper2*, Guid*, ushort*, Guid*, int>)(lpVtbl[4]))((IFilterMapper2*)Unsafe.AsPointer(ref this), pclsidCategory, szInstance, Filter);
        }
        ...
        {
            return ((delegate* stdcall<IFilterMapper2*, Guid*, ushort*, IMoniker**, Guid*, ushort*, REGFILTER2*, int>)(lpVtbl[5]))((IFilterMapper2*)Unsafe.AsPointer(ref this), clsidFilter, Name, ppMoniker, pclsidCategory, szInstance, prf2);
        }
