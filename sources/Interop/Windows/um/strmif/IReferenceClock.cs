...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IReferenceClock
    {
        ...
        {
            return ((delegate* unmanaged<IReferenceClock*, long, long, nuint, nuint*, int>)(lpVtbl[4]))((IReferenceClock*)Unsafe.AsPointer(ref this), baseTime, streamTime, hEvent, pdwAdviseCookie);
        }
        ...
        {
            return ((delegate* unmanaged<IReferenceClock*, long, long, nuint, nuint*, int>)(lpVtbl[5]))((IReferenceClock*)Unsafe.AsPointer(ref this), startTime, periodTime, hSemaphore, pdwAdviseCookie);
        }
