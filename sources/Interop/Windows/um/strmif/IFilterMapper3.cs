...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IFilterMapper3
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IFilterMapper3*, Guid*, void**, int>)(lpVtbl[0]))((IFilterMapper3*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged[Stdcall]<IFilterMapper3*, uint>)(lpVtbl[1]))((IFilterMapper3*)Unsafe.AsPointer(ref this));
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged[Stdcall]<IFilterMapper3*, uint>)(lpVtbl[2]))((IFilterMapper3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IFilterMapper3*, Guid*, uint, ushort*, int>)(lpVtbl[3]))((IFilterMapper3*)Unsafe.AsPointer(ref this), clsidCategory, dwCategoryMerit, Description);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IFilterMapper3*, Guid*, ushort*, Guid*, int>)(lpVtbl[4]))((IFilterMapper3*)Unsafe.AsPointer(ref this), pclsidCategory, szInstance, Filter);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IFilterMapper3*, Guid*, ushort*, IMoniker**, Guid*, ushort*, REGFILTER2*, int>)(lpVtbl[5]))((IFilterMapper3*)Unsafe.AsPointer(ref this), clsidFilter, Name, ppMoniker, pclsidCategory, szInstance, prf2);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IFilterMapper3*, ICreateDevEnum**, int>)(lpVtbl[7]))((IFilterMapper3*)Unsafe.AsPointer(ref this), ppEnum);
        }
    }
}
