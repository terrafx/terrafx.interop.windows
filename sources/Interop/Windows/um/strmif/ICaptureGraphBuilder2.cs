...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ICaptureGraphBuilder2
    {
        ...
        {
            return ((delegate* stdcall<ICaptureGraphBuilder2*, IUnknown*, PIN_DIRECTION, Guid*, Guid*, int, int, IPin**, int>)(lpVtbl[11]))((ICaptureGraphBuilder2*)Unsafe.AsPointer(ref this), pSource, pindir, pCategory, pType, fUnconnected, num, ppPin);
        }
    }
}
