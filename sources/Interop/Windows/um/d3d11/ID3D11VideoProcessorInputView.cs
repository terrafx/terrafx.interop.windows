...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11VideoProcessorInputView
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11VideoProcessorInputView*, D3D11_VIDEO_PROCESSOR_INPUT_VIEW_DESC*, void>)(lpVtbl[8]))((ID3D11VideoProcessorInputView*)Unsafe.AsPointer(ref this), pDesc);
        }
    }
}
