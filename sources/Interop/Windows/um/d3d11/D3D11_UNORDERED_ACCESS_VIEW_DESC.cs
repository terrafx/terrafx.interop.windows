...
namespace TerraFX.Interop
{
    public partial struct D3D11_UNORDERED_ACCESS_VIEW_DESC
    {
        ...
        public ref D3D11_TEX2D_UAV Texture2D => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Texture2D, 1));

        public ref D3D11_TEX2D_ARRAY_UAV Texture2DArray => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Texture2DArray, 1));
