...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11VideoProcessorOutputView
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11VideoProcessorOutputView*, D3D11_VIDEO_PROCESSOR_OUTPUT_VIEW_DESC*, void>)(lpVtbl[8]))((ID3D11VideoProcessorOutputView*)Unsafe.AsPointer(ref this), pDesc);
        }
    }
}
