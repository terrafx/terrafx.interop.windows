...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11Texture3D : ID3D11Texture3D.Interface
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* unmanaged<ID3D11Texture3D*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, uint> Release;

            [NativeTypeName("void (ID3D11Device **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, ID3D11Device**, void> GetDevice;

            [NativeTypeName("HRESULT (const GUID &, UINT *, void *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, Guid*, uint*, void*, int> GetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, UINT, const void *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, Guid*, uint, void*, int> SetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, const IUnknown *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, Guid*, IUnknown*, int> SetPrivateDataInterface;

            [NativeTypeName("void (D3D11_RESOURCE_DIMENSION *) __attribute__((stdcall))")]
            public new delegate* unmanaged<ID3D11Texture3D*, D3D11_RESOURCE_DIMENSION*, void> GetType;

            [NativeTypeName("void (UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, uint, void> SetEvictionPriority;

            [NativeTypeName("UINT () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, uint> GetEvictionPriority;

            [NativeTypeName("void (D3D11_TEXTURE3D_DESC *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11Texture3D*, D3D11_TEXTURE3D_DESC*, void> GetDesc;
        }
    }
}
