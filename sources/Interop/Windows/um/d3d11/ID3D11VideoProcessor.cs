...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11VideoProcessor
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11VideoProcessor*, D3D11_VIDEO_PROCESSOR_CONTENT_DESC*, void>)(lpVtbl[7]))((ID3D11VideoProcessor*)Unsafe.AsPointer(ref this), pDesc);
        }
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11VideoProcessor*, D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS*, void>)(lpVtbl[8]))((ID3D11VideoProcessor*)Unsafe.AsPointer(ref this), pCaps);
        }
    }
}
