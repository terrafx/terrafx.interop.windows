...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11ShaderResourceView
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* stdcall<ID3D11ShaderResourceView*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, uint> Release;

            [NativeTypeName("void (ID3D11Device **) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, ID3D11Device**, void> GetDevice;

            [NativeTypeName("HRESULT (const GUID &, UINT *, void *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, Guid*, uint*, void*, int> GetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, UINT, const void *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, Guid*, uint, void*, int> SetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, const IUnknown *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, Guid*, IUnknown*, int> SetPrivateDataInterface;

            [NativeTypeName("void (ID3D11Resource **) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, ID3D11Resource**, void> GetResource;

            [NativeTypeName("void (D3D11_SHADER_RESOURCE_VIEW_DESC *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11ShaderResourceView*, D3D11_SHADER_RESOURCE_VIEW_DESC*, void> GetDesc;
        }
    }
}
