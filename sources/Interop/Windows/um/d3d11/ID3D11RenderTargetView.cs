...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11RenderTargetView
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* stdcall<ID3D11RenderTargetView*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, uint> Release;

            [NativeTypeName("void (ID3D11Device **) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, ID3D11Device**, void> GetDevice;

            [NativeTypeName("HRESULT (const GUID &, UINT *, void *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, Guid*, uint*, void*, int> GetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, UINT, const void *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, Guid*, uint, void*, int> SetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, const IUnknown *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, Guid*, IUnknown*, int> SetPrivateDataInterface;

            [NativeTypeName("void (ID3D11Resource **) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, ID3D11Resource**, void> GetResource;

            [NativeTypeName("void (D3D11_RENDER_TARGET_VIEW_DESC *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11RenderTargetView*, D3D11_RENDER_TARGET_VIEW_DESC*, void> GetDesc;
        }
    }
}
