...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11UnorderedAccessView
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* stdcall<ID3D11UnorderedAccessView*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, uint> Release;

            [NativeTypeName("void (ID3D11Device **) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, ID3D11Device**, void> GetDevice;

            [NativeTypeName("HRESULT (const GUID &, UINT *, void *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, Guid*, uint*, void*, int> GetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, UINT, const void *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, Guid*, uint, void*, int> SetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, const IUnknown *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, Guid*, IUnknown*, int> SetPrivateDataInterface;

            [NativeTypeName("void (ID3D11Resource **) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, ID3D11Resource**, void> GetResource;

            [NativeTypeName("void (D3D11_UNORDERED_ACCESS_VIEW_DESC *) __attribute__((stdcall))")]
            public delegate* stdcall<ID3D11UnorderedAccessView*, D3D11_UNORDERED_ACCESS_VIEW_DESC*, void> GetDesc;
        }
    }
}
