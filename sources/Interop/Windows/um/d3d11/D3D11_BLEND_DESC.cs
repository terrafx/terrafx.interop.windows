...
namespace TerraFX.Interop
{
    public partial struct D3D11_BLEND_DESC
    {
        ...
        public partial struct _RenderTarget_e__FixedBuffer
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public unsafe Span<D3D11_RENDER_TARGET_BLEND_DESC> AsSpan()
            {
#if !NETSTANDARD2_0
                return MemoryMarshal.CreateSpan(ref e0, 8);
#else
                return new Span<D3D11_RENDER_TARGET_BLEND_DESC>((D3D11_RENDER_TARGET_BLEND_DESC*)Unsafe.AsPointer(ref this), 8);
#endif
            }
        }
    }
