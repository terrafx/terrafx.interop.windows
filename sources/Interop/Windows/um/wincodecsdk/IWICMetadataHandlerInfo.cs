...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWICMetadataHandlerInfo
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICMetadataHandlerInfo*, int*, int>)(lpVtbl[15]))((IWICMetadataHandlerInfo*)Unsafe.AsPointer(ref this), pfRequiresFullStream);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICMetadataHandlerInfo*, int*, int>)(lpVtbl[16]))((IWICMetadataHandlerInfo*)Unsafe.AsPointer(ref this), pfSupportsPadding);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICMetadataHandlerInfo*, int*, int>)(lpVtbl[17]))((IWICMetadataHandlerInfo*)Unsafe.AsPointer(ref this), pfFixedSize);
        }
    }
}
