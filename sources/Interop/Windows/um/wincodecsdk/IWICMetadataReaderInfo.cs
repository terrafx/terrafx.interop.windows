...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWICMetadataReaderInfo
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICMetadataReaderInfo*, int*, int>)(lpVtbl[15]))((IWICMetadataReaderInfo*)Unsafe.AsPointer(ref this), pfRequiresFullStream);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICMetadataReaderInfo*, int*, int>)(lpVtbl[16]))((IWICMetadataReaderInfo*)Unsafe.AsPointer(ref this), pfSupportsPadding);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICMetadataReaderInfo*, int*, int>)(lpVtbl[17]))((IWICMetadataReaderInfo*)Unsafe.AsPointer(ref this), pfFixedSize);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICMetadataReaderInfo*, Guid*, IStream*, int*, int>)(lpVtbl[19]))((IWICMetadataReaderInfo*)Unsafe.AsPointer(ref this), guidContainerFormat, pIStream, pfMatches);
        }
