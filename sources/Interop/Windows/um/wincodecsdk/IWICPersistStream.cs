...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWICPersistStream
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICPersistStream*, IStream*, int, int>)(lpVtbl[6]))((IWICPersistStream*)Unsafe.AsPointer(ref this), pStm, fClearDirty);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICPersistStream*, ULARGE_INTEGER*, int>)(lpVtbl[7]))((IWICPersistStream*)Unsafe.AsPointer(ref this), pcbSize);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICPersistStream*, IStream*, Guid*, uint, int>)(lpVtbl[8]))((IWICPersistStream*)Unsafe.AsPointer(ref this), pIStream, pguidPreferredVendor, dwPersistOptions);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICPersistStream*, IStream*, uint, int, int>)(lpVtbl[9]))((IWICPersistStream*)Unsafe.AsPointer(ref this), pIStream, dwPersistOptions, fClearDirty);
        }
    }
}
