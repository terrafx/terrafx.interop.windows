...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("ninput", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
...
#else
        public static extern int RegisterOutputCallbackInteractionContext([NativeTypeName("HINTERACTIONCONTEXT")] IntPtr interactionContext, [NativeTypeName("INTERACTION_CONTEXT_OUTPUT_CALLBACK")] delegate* unmanaged[Stdcall]<void*, INTERACTION_CONTEXT_OUTPUT*, void> outputCallback, [NativeTypeName("void *")] void* clientData);
#endif
...
#else
        public static extern int RegisterOutputCallbackInteractionContext2([NativeTypeName("HINTERACTIONCONTEXT")] IntPtr interactionContext, [NativeTypeName("INTERACTION_CONTEXT_OUTPUT_CALLBACK2")] delegate* unmanaged[Stdcall]<void*, INTERACTION_CONTEXT_OUTPUT2*, void> outputCallback, [NativeTypeName("void *")] void* clientData);
#endif
