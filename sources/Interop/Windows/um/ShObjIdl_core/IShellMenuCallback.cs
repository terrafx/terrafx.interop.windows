...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IShellMenuCallback
    {
        ...
        [VtblIndex(3)]
        [return: NativeTypeName("HRESULT")]
        public int CallbackSM([NativeTypeName("LPSMDATA")] SMDATA* psmd, [NativeTypeName("UINT")] uint uMsg, [NativeTypeName("WPARAM")] nuint wParam, [NativeTypeName("LPARAM")] nint lParam)
        {
