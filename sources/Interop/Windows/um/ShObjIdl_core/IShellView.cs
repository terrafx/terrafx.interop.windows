...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IShellView
    {
        ...
        {
            return ((delegate* unmanaged<IShellView*, int, int>)(lpVtbl[4]))((IShellView*)Unsafe.AsPointer(ref this), fEnterMode);
        }
        ...
        {
            return ((delegate* unmanaged<IShellView*, int, int>)(lpVtbl[6]))((IShellView*)Unsafe.AsPointer(ref this), fEnable);
        }
        ...
        {
            return ((delegate* unmanaged<IShellView*, uint, delegate* unmanaged<IntPtr, nint, int>, nint, int>)(lpVtbl[12]))((IShellView*)Unsafe.AsPointer(ref this), dwReserved, pfn, lparam);
        }
