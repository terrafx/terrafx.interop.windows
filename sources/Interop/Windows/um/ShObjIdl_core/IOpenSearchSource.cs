...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IOpenSearchSource
    {
        ...
        [VtblIndex(3)]
        [return: NativeTypeName("HRESULT")]
        public int GetResults([NativeTypeName("HWND")] IntPtr hwnd, [NativeTypeName("LPCWSTR")] ushort* pszQuery, [NativeTypeName("DWORD")] uint dwStartIndex, [NativeTypeName("DWORD")] uint dwCount, [NativeTypeName("const IID &")] Guid* riid, void** ppv)
        {
