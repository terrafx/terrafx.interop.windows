...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IPersistFolder3
    {
        ...
        [VtblIndex(6)]
        [return: NativeTypeName("HRESULT")]
        public int InitializeEx(IBindCtx* pbc, [NativeTypeName("LPCITEMIDLIST")] ITEMIDLIST* pidlRoot, [NativeTypeName("const PERSIST_FOLDER_TARGET_INFO *")] PERSIST_FOLDER_TARGET_INFO* ppfti)
        {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int GetFolderTargetInfo(PERSIST_FOLDER_TARGET_INFO* ppfti)
        {
