...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("Kernel32", EntryPoint = "CreatePrivateNamespaceW", ExactSpelling = true)]
        ...
        [DllImport("Kernel32", EntryPoint = "OpenPrivateNamespaceW", ExactSpelling = true)]
        [return: NativeTypeName("HANDLE")]
        ...
        [DllImport("Kernel32", EntryPoint = "ClosePrivateNamespace", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOLEAN")]
        public static extern byte ClosePrivateNamespace([NativeTypeName("HANDLE")] IntPtr Handle, [NativeTypeName("ULONG")] uint Flags);

        [DllImport("Kernel32", EntryPoint = "CreateBoundaryDescriptorW", ExactSpelling = true)]
        [return: NativeTypeName("HANDLE")]
        public static extern IntPtr CreateBoundaryDescriptorW([NativeTypeName("LPCWSTR")] ushort* Name, [NativeTypeName("ULONG")] uint Flags);

        [DllImport("Kernel32", EntryPoint = "AddSIDToBoundaryDescriptor", ExactSpelling = true, SetLastError = true)]
        ...
        [DllImport("Kernel32", EntryPoint = "DeleteBoundaryDescriptor", ExactSpelling = true)]
