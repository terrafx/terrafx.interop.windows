...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiGetSummaryInformationA(MSIHANDLE hDatabase, [NativeTypeName("LPCSTR")] sbyte* szDatabasePath, [NativeTypeName("UINT")] uint uiUpdateCount, MSIHANDLE* phSummaryInfo);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiGetSummaryInformationW(MSIHANDLE hDatabase, [NativeTypeName("LPCWSTR")] ushort* szDatabasePath, [NativeTypeName("UINT")] uint uiUpdateCount, MSIHANDLE* phSummaryInfo);
        ...
        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiSummaryInfoSetPropertyA(MSIHANDLE hSummaryInfo, [NativeTypeName("UINT")] uint uiProperty, [NativeTypeName("UINT")] uint uiDataType, [NativeTypeName("INT")] int iValue, FILETIME* pftValue, [NativeTypeName("LPCSTR")] sbyte* szValue);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiSummaryInfoSetPropertyW(MSIHANDLE hSummaryInfo, [NativeTypeName("UINT")] uint uiProperty, [NativeTypeName("UINT")] uint uiDataType, [NativeTypeName("INT")] int iValue, FILETIME* pftValue, [NativeTypeName("LPCWSTR")] ushort* szValue);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiSummaryInfoGetPropertyA(MSIHANDLE hSummaryInfo, [NativeTypeName("UINT")] uint uiProperty, [NativeTypeName("PUINT")] uint* puiDataType, [NativeTypeName("LPINT")] int* piValue, FILETIME* pftValue, [NativeTypeName("LPSTR")] sbyte* szValueBuf, [NativeTypeName("LPDWORD")] uint* pcchValueBuf);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiSummaryInfoGetPropertyW(MSIHANDLE hSummaryInfo, [NativeTypeName("UINT")] uint uiProperty, [NativeTypeName("PUINT")] uint* puiDataType, [NativeTypeName("LPINT")] int* piValue, FILETIME* pftValue, [NativeTypeName("LPWSTR")] ushort* szValueBuf, [NativeTypeName("LPDWORD")] uint* pcchValueBuf);
        ...
        [DllImport("msi", ExactSpelling = true)]
        public static extern MSIHANDLE MsiCreateRecord([NativeTypeName("UINT")] uint cParams);

        [DllImport("msi", ExactSpelling = true)]
        public static extern BOOL MsiRecordIsNull(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordDataSize(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordSetInteger(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, int iValue);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordSetStringA(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, [NativeTypeName("LPCSTR")] sbyte* szValue);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordSetStringW(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, [NativeTypeName("LPCWSTR")] ushort* szValue);

        [DllImport("msi", ExactSpelling = true)]
        public static extern int MsiRecordGetInteger(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordGetStringA(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, [NativeTypeName("LPSTR")] sbyte* szValueBuf, [NativeTypeName("LPDWORD")] uint* pcchValueBuf);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordGetStringW(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, [NativeTypeName("LPWSTR")] ushort* szValueBuf, [NativeTypeName("LPDWORD")] uint* pcchValueBuf);
        ...
        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordSetStreamA(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, [NativeTypeName("LPCSTR")] sbyte* szFilePath);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordSetStreamW(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, [NativeTypeName("LPCWSTR")] ushort* szFilePath);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiRecordReadStream(MSIHANDLE hRecord, [NativeTypeName("UINT")] uint iField, [NativeTypeName("char *")] sbyte* szDataBuf, [NativeTypeName("LPDWORD")] uint* pcbDataBuf);
        ...
        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiSequenceA(MSIHANDLE hInstall, [NativeTypeName("LPCSTR")] sbyte* szTable, [NativeTypeName("INT")] int iSequenceMode);

        [DllImport("msi", ExactSpelling = true)]
        [return: NativeTypeName("UINT")]
        public static extern uint MsiSequenceW(MSIHANDLE hInstall, [NativeTypeName("LPCWSTR")] ushort* szTable, [NativeTypeName("INT")] int iSequenceMode);
