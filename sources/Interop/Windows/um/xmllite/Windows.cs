...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        public static extern int CreateXmlReader([NativeTypeName("const IID &")] Guid* riid, [NativeTypeName("void **")] void** ppvObject, [NativeTypeName("IMalloc *")] IMalloc* pMalloc);

        [DllImport("xmllite", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int CreateXmlReaderInputWithEncodingCodePage([NativeTypeName("IUnknown *")] IUnknown* pInputStream, [NativeTypeName("IMalloc *")] IMalloc* pMalloc, [NativeTypeName("UINT")] uint nEncodingCodePage, [NativeTypeName("BOOL")] int fEncodingHint, [NativeTypeName("LPCWSTR")] ushort* pwszBaseUri, [NativeTypeName("IXmlReaderInput **")] IUnknown** ppInput);

        [DllImport("xmllite", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int CreateXmlReaderInputWithEncodingName([NativeTypeName("IUnknown *")] IUnknown* pInputStream, [NativeTypeName("IMalloc *")] IMalloc* pMalloc, [NativeTypeName("LPCWSTR")] ushort* pwszEncodingName, [NativeTypeName("BOOL")] int fEncodingHint, [NativeTypeName("LPCWSTR")] ushort* pwszBaseUri, [NativeTypeName("IXmlReaderInput **")] IUnknown** ppInput);
        ...
        [DllImport("xmllite", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int CreateXmlWriterOutputWithEncodingName([NativeTypeName("IUnknown *")] IUnknown* pOutputStream, [NativeTypeName("IMalloc *")] IMalloc* pMalloc, [NativeTypeName("LPCWSTR")] ushort* pwszEncodingName, [NativeTypeName("IXmlWriterOutput **")] IUnknown** ppOutput);
