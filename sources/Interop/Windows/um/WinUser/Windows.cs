...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        [DllImport("user32", EntryPoint = "GetMessageA", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("user32", EntryPoint = "GetClassInfoA", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("user32", EntryPoint = "TranslateAcceleratorA", ExactSpelling = true, SetLastError = true)]
