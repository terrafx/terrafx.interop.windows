...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11ShaderTraceFactory
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11ShaderTraceFactory*, IUnknown*, D3D11_SHADER_TRACE_DESC*, ID3D11ShaderTrace**, int>)(lpVtbl[3]))((ID3D11ShaderTraceFactory*)Unsafe.AsPointer(ref this), pShader, pTraceDesc, ppShaderTrace);
        }
    }
}
