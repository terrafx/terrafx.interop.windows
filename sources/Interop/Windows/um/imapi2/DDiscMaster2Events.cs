...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct DDiscMaster2Events
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int NotifyDeviceAdded(IDispatch* @object, [NativeTypeName("BSTR")] ushort* uniqueId)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int NotifyDeviceRemoved(IDispatch* @object, [NativeTypeName("BSTR")] ushort* uniqueId)
        {
