...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWriteEngine2
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int WriteSection([NativeTypeName("IStream *")] IStream* data, [NativeTypeName("LONG")] int startingBlockAddress, [NativeTypeName("LONG")] int numberOfBlocks)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int put_Recorder([NativeTypeName("IDiscRecorder2Ex *")] IDiscRecorder2Ex* value)
        {
