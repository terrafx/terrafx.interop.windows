...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDiscFormat2DataEventArgs
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int get_TotalTime([NativeTypeName("LONG *")] int* value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int get_CurrentAction([NativeTypeName("IMAPI_FORMAT2_DATA_WRITE_ACTION *")] IMAPI_FORMAT2_DATA_WRITE_ACTION* value)
        {
