...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IAppxManifestDriverConstraintsEnumerator
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetCurrent([NativeTypeName("IAppxManifestDriverConstraint **")] IAppxManifestDriverConstraint** driverConstraint)
        {
        ...
        {
            return ((delegate* unmanaged<IAppxManifestDriverConstraintsEnumerator*, int*, int>)(lpVtbl[4]))((IAppxManifestDriverConstraintsEnumerator*)Unsafe.AsPointer(ref this), hasCurrent);
        }
        ...
        {
            return ((delegate* unmanaged<IAppxManifestDriverConstraintsEnumerator*, int*, int>)(lpVtbl[5]))((IAppxManifestDriverConstraintsEnumerator*)Unsafe.AsPointer(ref this), hasNext);
        }
    }
}
