...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IAppxPackageWriter3
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int AddPayloadFiles([NativeTypeName("UINT32")] uint fileCount, [NativeTypeName("APPX_PACKAGE_WRITER_PAYLOAD_STREAM *")] APPX_PACKAGE_WRITER_PAYLOAD_STREAM* payloadFiles, [NativeTypeName("UINT64")] ulong memoryLimit)
        {
