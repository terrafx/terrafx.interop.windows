...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        [DllImport("advapi32", EntryPoint = "GetUserNameA", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        public static extern int GetUserNameA([NativeTypeName("LPSTR")] sbyte* lpBuffer, [NativeTypeName("LPDWORD")] uint* pcbBuffer);

        [DllImport("advapi32", EntryPoint = "GetUserNameW", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
