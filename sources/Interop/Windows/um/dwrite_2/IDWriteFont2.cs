...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFont2
    {
        ...
        {
            return ((delegate* unmanaged<IDWriteFont2*, DWRITE_INFORMATIONAL_STRING_ID, IDWriteLocalizedStrings**, int*, int>)(lpVtbl[9]))((IDWriteFont2*)Unsafe.AsPointer(ref this), informationalStringID, informationalStrings, exists);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFont2*, uint, int*, int>)(lpVtbl[12]))((IDWriteFont2*)Unsafe.AsPointer(ref this), unicodeValue, exists);
        }
