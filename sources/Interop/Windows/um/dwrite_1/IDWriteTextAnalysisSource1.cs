...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteTextAnalysisSource1
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextAnalysisSource1*, DWRITE_READING_DIRECTION>)(lpVtbl[5]))((IDWriteTextAnalysisSource1*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteTextAnalysisSource1*, uint, uint*, DWRITE_VERTICAL_GLYPH_ORIENTATION*, byte*, int>)(lpVtbl[8]))((IDWriteTextAnalysisSource1*)Unsafe.AsPointer(ref this), textPosition, textLength, glyphOrientation, bidiLevel);
        }
    }
}
