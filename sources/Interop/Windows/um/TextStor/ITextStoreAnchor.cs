...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ITextStoreAnchor
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int QueryInsert([NativeTypeName("IAnchor *")] IAnchor* paTestStart, [NativeTypeName("IAnchor *")] IAnchor* paTestEnd, [NativeTypeName("ULONG")] uint cch, [NativeTypeName("IAnchor **")] IAnchor** ppaResultStart, [NativeTypeName("IAnchor **")] IAnchor** ppaResultEnd)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetSelection([NativeTypeName("ULONG")] uint ulIndex, [NativeTypeName("ULONG")] uint ulCount, [NativeTypeName("TS_SELECTION_ANCHOR *")] TS_SELECTION_ANCHOR* pSelection, [NativeTypeName("ULONG *")] uint* pcFetched)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetText([NativeTypeName("DWORD")] uint dwFlags, [NativeTypeName("IAnchor *")] IAnchor* paStart, [NativeTypeName("IAnchor *")] IAnchor* paEnd, [NativeTypeName("WCHAR *")] ushort* pchText, [NativeTypeName("ULONG")] uint cchReq, [NativeTypeName("ULONG *")] uint* pcch, [NativeTypeName("BOOL")] int fUpdateAnchor)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int SetText([NativeTypeName("DWORD")] uint dwFlags, [NativeTypeName("IAnchor *")] IAnchor* paStart, [NativeTypeName("IAnchor *")] IAnchor* paEnd, [NativeTypeName("const WCHAR *")] ushort* pchText, [NativeTypeName("ULONG")] uint cch)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetFormattedText([NativeTypeName("IAnchor *")] IAnchor* paStart, [NativeTypeName("IAnchor *")] IAnchor* paEnd, [NativeTypeName("IDataObject **")] IDataObject** ppDataObject)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetEmbedded([NativeTypeName("DWORD")] uint dwFlags, [NativeTypeName("IAnchor *")] IAnchor* paPos, [NativeTypeName("const GUID &")] Guid* rguidService, [NativeTypeName("const IID &")] Guid* riid, [NativeTypeName("IUnknown **")] IUnknown** ppunk)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int InsertEmbedded([NativeTypeName("DWORD")] uint dwFlags, [NativeTypeName("IAnchor *")] IAnchor* paStart, [NativeTypeName("IAnchor *")] IAnchor* paEnd, [NativeTypeName("IDataObject *")] IDataObject* pDataObject)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int RequestAttrsAtPosition([NativeTypeName("IAnchor *")] IAnchor* paPos, [NativeTypeName("ULONG")] uint cFilterAttrs, [NativeTypeName("const TS_ATTRID *")] Guid* paFilterAttrs, [NativeTypeName("DWORD")] uint dwFlags)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int RequestAttrsTransitioningAtPosition([NativeTypeName("IAnchor *")] IAnchor* paPos, [NativeTypeName("ULONG")] uint cFilterAttrs, [NativeTypeName("const TS_ATTRID *")] Guid* paFilterAttrs, [NativeTypeName("DWORD")] uint dwFlags)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int FindNextAttrTransition([NativeTypeName("IAnchor *")] IAnchor* paStart, [NativeTypeName("IAnchor *")] IAnchor* paHalt, [NativeTypeName("ULONG")] uint cFilterAttrs, [NativeTypeName("const TS_ATTRID *")] Guid* paFilterAttrs, [NativeTypeName("DWORD")] uint dwFlags, [NativeTypeName("BOOL *")] int* pfFound, [NativeTypeName("LONG *")] int* plFoundOffset)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetStart([NativeTypeName("IAnchor **")] IAnchor** ppaStart)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetEnd([NativeTypeName("IAnchor **")] IAnchor** ppaEnd)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetTextExt([NativeTypeName("TsViewCookie")] uint vcView, [NativeTypeName("IAnchor *")] IAnchor* paStart, [NativeTypeName("IAnchor *")] IAnchor* paEnd, [NativeTypeName("RECT *")] RECT* prc, [NativeTypeName("BOOL *")] int* pfClipped)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int InsertTextAtSelection([NativeTypeName("DWORD")] uint dwFlags, [NativeTypeName("const WCHAR *")] ushort* pchText, [NativeTypeName("ULONG")] uint cch, [NativeTypeName("IAnchor **")] IAnchor** ppaStart, [NativeTypeName("IAnchor **")] IAnchor** ppaEnd)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int InsertEmbeddedAtSelection([NativeTypeName("DWORD")] uint dwFlags, [NativeTypeName("IDataObject *")] IDataObject* pDataObject, [NativeTypeName("IAnchor **")] IAnchor** ppaStart, [NativeTypeName("IAnchor **")] IAnchor** ppaEnd)
        {
