...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12Device8
    {
        ...
        {
            return ((delegate* unmanaged<ID3D12Device8*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, ushort*, IntPtr*, int>)(lpVtbl[31]))((ID3D12Device8*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device8*, IntPtr, Guid*, void**, int>)(lpVtbl[32]))((ID3D12Device8*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device8*, ushort*, uint, IntPtr*, int>)(lpVtbl[33]))((ID3D12Device8*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device8*, IntPtr, Guid*, void**, int>)(lpVtbl[49]))((ID3D12Device8*)Unsafe.AsPointer(ref this), hFileMapping, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device8*, D3D12_BACKGROUND_PROCESSING_MODE, D3D12_MEASUREMENTS_ACTION, IntPtr, BOOL*, int>)(lpVtbl[65]))((ID3D12Device8*)Unsafe.AsPointer(ref this), Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
        }
