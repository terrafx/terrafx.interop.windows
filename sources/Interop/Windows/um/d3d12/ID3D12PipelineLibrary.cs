...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12PipelineLibrary
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12PipelineLibrary*, ushort*, D3D12_GRAPHICS_PIPELINE_STATE_DESC*, Guid*, void**, int>)(lpVtbl[9]))((ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this), pName, pDesc, riid, ppPipelineState);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12PipelineLibrary*, ushort*, D3D12_COMPUTE_PIPELINE_STATE_DESC*, Guid*, void**, int>)(lpVtbl[10]))((ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this), pName, pDesc, riid, ppPipelineState);
        }
