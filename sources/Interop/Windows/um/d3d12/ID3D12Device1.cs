...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12Device1
    {
        ...
        {
            return ((delegate* unmanaged<ID3D12Device1*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, ushort*, IntPtr*, int>)(lpVtbl[31]))((ID3D12Device1*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device1*, IntPtr, Guid*, void**, int>)(lpVtbl[32]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device1*, ushort*, uint, IntPtr*, int>)(lpVtbl[33]))((ID3D12Device1*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device1*, int, int>)(lpVtbl[40]))((ID3D12Device1*)Unsafe.AsPointer(ref this), Enable);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device1*, ID3D12Fence**, ulong*, uint, D3D12_MULTIPLE_FENCE_WAIT_FLAGS, IntPtr, int>)(lpVtbl[45]))((ID3D12Device1*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
        }
