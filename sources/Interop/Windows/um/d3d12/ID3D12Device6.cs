...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12Device6
    {
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, ushort*, IntPtr*, int>)(lpVtbl[31]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, IntPtr, Guid*, void**, int>)(lpVtbl[32]))((ID3D12Device6*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, ushort*, uint, IntPtr*, int>)(lpVtbl[33]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, ID3D12Fence**, ulong*, uint, D3D12_MULTIPLE_FENCE_WAIT_FLAGS, IntPtr, int>)(lpVtbl[45]))((ID3D12Device6*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, IntPtr, Guid*, void**, int>)(lpVtbl[49]))((ID3D12Device6*)Unsafe.AsPointer(ref this), hFileMapping, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, D3D12_BACKGROUND_PROCESSING_MODE, D3D12_MEASUREMENTS_ACTION, IntPtr, BOOL*, int>)(lpVtbl[65]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
        }
    }
}
