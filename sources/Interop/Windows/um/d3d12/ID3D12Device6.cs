...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12Device6
    {
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, int, int>)(lpVtbl[40]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Enable);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device6*, D3D12_BACKGROUND_PROCESSING_MODE, D3D12_MEASUREMENTS_ACTION, IntPtr, int*, int>)(lpVtbl[65]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
        }
    }
}
