...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12Device
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12Device*, ID3D12DeviceChild*, SECURITY_ATTRIBUTES*, uint, ushort*, IntPtr*, int>)(lpVtbl[31]))((ID3D12Device*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12Device*, int, int>)(lpVtbl[40]))((ID3D12Device*)Unsafe.AsPointer(ref this), Enable);
        }
