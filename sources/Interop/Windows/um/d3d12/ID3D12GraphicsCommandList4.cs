...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12GraphicsCommandList4
    {
        ...
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint AddRef()
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint>)(lpVtbl[1]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this));
        }
        ...
        public uint Release()
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint>)(lpVtbl[2]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
        }
        ...
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
        }
        ...
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), guid, pData);
        }
        ...
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, ushort*, int>)(lpVtbl[6]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), Name);
        }
        ...
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, Guid*, void**, int>)(lpVtbl[7]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), riid, ppvDevice);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new D3D12_COMMAND_LIST_TYPE GetType()
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_COMMAND_LIST_TYPE>)(lpVtbl[8]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this));
        }
        ...
        public int Close()
        {
            return ((delegate* stdcall<ID3D12GraphicsCommandList4*, int>)(lpVtbl[9]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, uint, uint, void>)(lpVtbl[12]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), VertexCountPerInstance, InstanceCount, StartVertexLocation, StartInstanceLocation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, uint, int, uint, void>)(lpVtbl[13]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), IndexCountPerInstance, InstanceCount, StartIndexLocation, BaseVertexLocation, StartInstanceLocation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, uint, void>)(lpVtbl[14]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), ThreadGroupCountX, ThreadGroupCountY, ThreadGroupCountZ);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, ulong, ID3D12Resource*, ulong, ulong, void>)(lpVtbl[15]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDstBuffer, DstOffset, pSrcBuffer, SrcOffset, NumBytes);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_TEXTURE_COPY_LOCATION*, uint, uint, uint, D3D12_TEXTURE_COPY_LOCATION*, D3D12_BOX*, void>)(lpVtbl[16]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDst, DstX, DstY, DstZ, pSrc, pSrcBox);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, ID3D12Resource*, void>)(lpVtbl[17]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDstResource, pSrcResource);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, uint, ID3D12Resource*, uint, DXGI_FORMAT, void>)(lpVtbl[19]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDstResource, DstSubresource, pSrcResource, SrcSubresource, Format);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void IASetPrimitiveTopology([NativeTypeName("D3D12_PRIMITIVE_TOPOLOGY")] D3D_PRIMITIVE_TOPOLOGY PrimitiveTopology)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D_PRIMITIVE_TOPOLOGY, void>)(lpVtbl[20]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), PrimitiveTopology);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, D3D12_VIEWPORT*, void>)(lpVtbl[21]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), NumViewports, pViewports);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RSSetScissorRects([NativeTypeName("UINT")] uint NumRects, [NativeTypeName("const D3D12_RECT *")] RECT* pRects)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, RECT*, void>)(lpVtbl[22]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), NumRects, pRects);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void OMSetBlendFactor([NativeTypeName("const FLOAT [4]")] float* BlendFactor)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, float*, void>)(lpVtbl[23]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), BlendFactor);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void OMSetStencilRef([NativeTypeName("UINT")] uint StencilRef)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, void>)(lpVtbl[24]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), StencilRef);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetPipelineState([NativeTypeName("ID3D12PipelineState *")] ID3D12PipelineState* pPipelineState)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12PipelineState*, void>)(lpVtbl[25]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pPipelineState);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, D3D12_RESOURCE_BARRIER*, void>)(lpVtbl[26]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), NumBarriers, pBarriers);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, ID3D12DescriptorHeap**, void>)(lpVtbl[28]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), NumDescriptorHeaps, ppDescriptorHeaps);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetComputeRootSignature([NativeTypeName("ID3D12RootSignature *")] ID3D12RootSignature* pRootSignature)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12RootSignature*, void>)(lpVtbl[29]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pRootSignature);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, D3D12_GPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[31]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BaseDescriptor);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, D3D12_GPU_DESCRIPTOR_HANDLE, void>)(lpVtbl[32]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BaseDescriptor);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, uint, void>)(lpVtbl[33]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, SrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, uint, void>)(lpVtbl[34]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, SrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, void*, uint, void>)(lpVtbl[35]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, Num32BitValuesToSet, pSrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, void*, uint, void>)(lpVtbl[36]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, Num32BitValuesToSet, pSrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, ulong, void>)(lpVtbl[37]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, ulong, void>)(lpVtbl[38]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, ulong, void>)(lpVtbl[39]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, ulong, void>)(lpVtbl[40]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, ulong, void>)(lpVtbl[41]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, ulong, void>)(lpVtbl[42]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void IASetIndexBuffer([NativeTypeName("const D3D12_INDEX_BUFFER_VIEW *")] D3D12_INDEX_BUFFER_VIEW* pView)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_INDEX_BUFFER_VIEW*, void>)(lpVtbl[43]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pView);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, D3D12_VERTEX_BUFFER_VIEW*, void>)(lpVtbl[44]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), StartSlot, NumViews, pViews);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, D3D12_STREAM_OUTPUT_BUFFER_VIEW*, void>)(lpVtbl[45]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), StartSlot, NumViews, pViews);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, D3D12_CPU_DESCRIPTOR_HANDLE*, int, D3D12_CPU_DESCRIPTOR_HANDLE*, void>)(lpVtbl[46]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), NumRenderTargetDescriptors, pRenderTargetDescriptors, RTsSingleHandleToDescriptorRange, pDepthStencilDescriptor);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_CLEAR_FLAGS, float, byte, uint, RECT*, void>)(lpVtbl[47]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), DepthStencilView, ClearFlags, Depth, Stencil, NumRects, pRects);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_CPU_DESCRIPTOR_HANDLE, float*, uint, RECT*, void>)(lpVtbl[48]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), RenderTargetView, ColorRGBA, NumRects, pRects);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_GPU_DESCRIPTOR_HANDLE, D3D12_CPU_DESCRIPTOR_HANDLE, ID3D12Resource*, uint*, uint, RECT*, void>)(lpVtbl[49]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), ViewGPUHandleInCurrentHeap, ViewCPUHandle, pResource, Values, NumRects, pRects);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_GPU_DESCRIPTOR_HANDLE, D3D12_CPU_DESCRIPTOR_HANDLE, ID3D12Resource*, float*, uint, RECT*, void>)(lpVtbl[50]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), ViewGPUHandleInCurrentHeap, ViewCPUHandle, pResource, Values, NumRects, pRects);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, D3D12_DISCARD_REGION*, void>)(lpVtbl[51]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pResource, pRegion);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, void>)(lpVtbl[52]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pQueryHeap, Type, Index);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, uint, void>)(lpVtbl[53]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pQueryHeap, Type, Index);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, ulong, D3D12_PREDICATION_OP, void>)(lpVtbl[55]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pBuffer, AlignedBufferOffset, Operation);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, void*, uint, void>)(lpVtbl[56]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, void*, uint, void>)(lpVtbl[57]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void EndEvent()
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, void>)(lpVtbl[58]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12CommandSignature*, uint, ID3D12Resource*, ulong, ID3D12Resource*, ulong, void>)(lpVtbl[59]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pCommandSignature, MaxCommandCount, pArgumentBuffer, ArgumentBufferOffset, pCountBuffer, CountBufferOffset);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, ulong, ID3D12Resource*, ulong, uint, ID3D12Resource**, D3D12_SUBRESOURCE_RANGE_UINT64*, void>)(lpVtbl[60]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDstBuffer, DstOffset, pSrcBuffer, SrcOffset, Dependencies, ppDependentResources, pDependentSubresourceRanges);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, ulong, ID3D12Resource*, ulong, uint, ID3D12Resource**, D3D12_SUBRESOURCE_RANGE_UINT64*, void>)(lpVtbl[61]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDstBuffer, DstOffset, pSrcBuffer, SrcOffset, Dependencies, ppDependentResources, pDependentSubresourceRanges);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void OMSetDepthBounds([NativeTypeName("FLOAT")] float Min, [NativeTypeName("FLOAT")] float Max)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, float, float, void>)(lpVtbl[62]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), Min, Max);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, uint, D3D12_SAMPLE_POSITION*, void>)(lpVtbl[63]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), NumSamplesPerPixel, NumPixels, pSamplePositions);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12Resource*, uint, uint, uint, ID3D12Resource*, uint, RECT*, DXGI_FORMAT, D3D12_RESOLVE_MODE, void>)(lpVtbl[64]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDstResource, DstSubresource, DstX, DstY, pSrcResource, SrcSubresource, pSrcRect, Format, ResolveMode);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetViewInstanceMask([NativeTypeName("UINT")] uint Mask)
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, void>)(lpVtbl[65]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), Mask);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, uint, D3D12_WRITEBUFFERIMMEDIATE_PARAMETER*, D3D12_WRITEBUFFERIMMEDIATE_MODE*, void>)(lpVtbl[66]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), Count, pParams, pModes);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, void>)(lpVtbl[69]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, ID3D12MetaCommand*, void*, nuint, void>)(lpVtbl[70]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pMetaCommand, pInitializationParametersData, InitializationParametersDataSizeInBytes);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC*, uint, D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC*, void>)(lpVtbl[72]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDesc, NumPostbuildInfoDescs, pPostbuildInfoDescs);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC*, uint, ulong*, void>)(lpVtbl[73]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDesc, NumSourceAccelerationStructures, pSourceAccelerationStructureData);
        }
        ...
        {
            ((delegate* stdcall<ID3D12GraphicsCommandList4*, D3D12_DISPATCH_RAYS_DESC*, void>)(lpVtbl[76]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), pDesc);
        }
    }
}
