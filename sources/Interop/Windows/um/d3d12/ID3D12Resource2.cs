...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12Resource2
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12Resource2*, uint, D3D12_RANGE*, void**, int>)(lpVtbl[8]))((ID3D12Resource2*)Unsafe.AsPointer(ref this), Subresource, pReadRange, ppData);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Unmap([NativeTypeName("UINT")] uint Subresource, [NativeTypeName("const D3D12_RANGE *")] D3D12_RANGE* pWrittenRange)
        {
            ((delegate* unmanaged[Stdcall]<ID3D12Resource2*, uint, D3D12_RANGE*, void>)(lpVtbl[9]))((ID3D12Resource2*)Unsafe.AsPointer(ref this), Subresource, pWrittenRange);
        }
        ...
        public D3D12_RESOURCE_DESC GetDesc()
        {
            ...
            return *((delegate* unmanaged[Stdcall]<ID3D12Resource2*, D3D12_RESOURCE_DESC*, D3D12_RESOURCE_DESC*>)(lpVtbl[10]))((ID3D12Resource2*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12Resource2*, uint, D3D12_BOX*, void*, uint, uint, int>)(lpVtbl[12]))((ID3D12Resource2*)Unsafe.AsPointer(ref this), DstSubresource, pDstBox, pSrcData, SrcRowPitch, SrcDepthPitch);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12Resource2*, void*, uint, uint, uint, D3D12_BOX*, int>)(lpVtbl[13]))((ID3D12Resource2*)Unsafe.AsPointer(ref this), pDstData, DstRowPitch, DstDepthPitch, SrcSubresource, pSrcBox);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12Resource2*, D3D12_HEAP_PROPERTIES*, D3D12_HEAP_FLAGS*, int>)(lpVtbl[14]))((ID3D12Resource2*)Unsafe.AsPointer(ref this), pHeapProperties, pHeapFlags);
        }
        ...
        public D3D12_RESOURCE_DESC1 GetDesc1()
        {
            ...
            return *((delegate* unmanaged[Stdcall]<ID3D12Resource2*, D3D12_RESOURCE_DESC1*, D3D12_RESOURCE_DESC1*>)(lpVtbl[16]))((ID3D12Resource2*)Unsafe.AsPointer(ref this), &result);
        }
    }
}
