...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12GraphicsCommandList
    {
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList*, uint, D3D12_CPU_DESCRIPTOR_HANDLE*, int, D3D12_CPU_DESCRIPTOR_HANDLE*, void>)(lpVtbl[46]))((ID3D12GraphicsCommandList*)Unsafe.AsPointer(ref this), NumRenderTargetDescriptors, pRenderTargetDescriptors, RTsSingleHandleToDescriptorRange, pDepthStencilDescriptor);
        }
