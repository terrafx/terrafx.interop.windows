...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12ProtectedResourceSession
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12ProtectedResourceSession*, D3D12_PROTECTED_SESSION_STATUS>)(lpVtbl[9]))((ID3D12ProtectedResourceSession*)Unsafe.AsPointer(ref this));
        }
        ...
        public D3D12_PROTECTED_RESOURCE_SESSION_DESC GetDesc()
        {
            ...
            return *((delegate* unmanaged[Stdcall]<ID3D12ProtectedResourceSession*, D3D12_PROTECTED_RESOURCE_SESSION_DESC*, D3D12_PROTECTED_RESOURCE_SESSION_DESC*>)(lpVtbl[10]))((ID3D12ProtectedResourceSession*)Unsafe.AsPointer(ref this), &result);
        }
    }
}
