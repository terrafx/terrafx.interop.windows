...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12GraphicsCommandList5
    {
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList5*, D3D12_COMMAND_LIST_TYPE>)(lpVtbl[8]))((ID3D12GraphicsCommandList5*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList5*, uint, D3D12_CPU_DESCRIPTOR_HANDLE*, int, D3D12_CPU_DESCRIPTOR_HANDLE*, void>)(lpVtbl[46]))((ID3D12GraphicsCommandList5*)Unsafe.AsPointer(ref this), NumRenderTargetDescriptors, pRenderTargetDescriptors, RTsSingleHandleToDescriptorRange, pDepthStencilDescriptor);
        }
