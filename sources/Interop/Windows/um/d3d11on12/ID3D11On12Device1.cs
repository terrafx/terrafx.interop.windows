...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11On12Device1
    {
        ...
        {
            return ((delegate* stdcall<ID3D11On12Device1*, Guid*, void**, int>)(lpVtbl[0]))((ID3D11On12Device1*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }

        [return: NativeTypeName("ULONG")]
        public uint AddRef()
        {
            return ((delegate* stdcall<ID3D11On12Device1*, uint>)(lpVtbl[1]))((ID3D11On12Device1*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("ULONG")]
        public uint Release()
        {
            return ((delegate* stdcall<ID3D11On12Device1*, uint>)(lpVtbl[2]))((ID3D11On12Device1*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* stdcall<ID3D11On12Device1*, ID3D11Resource**, uint, void>)(lpVtbl[4]))((ID3D11On12Device1*)Unsafe.AsPointer(ref this), ppResources, NumResources);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11On12Device1*, Guid*, void**, int>)(lpVtbl[6]))((ID3D11On12Device1*)Unsafe.AsPointer(ref this), riid, ppvDevice);
        }
    }
}
