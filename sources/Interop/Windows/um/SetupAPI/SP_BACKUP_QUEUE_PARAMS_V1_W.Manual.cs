...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct SP_BACKUP_QUEUE_PARAMS_V1_W
    {
        public static uint SizeOf
        {
            get
            {
                if (sizeof(nint) == 4)
                {
                    return (uint)(sizeof(SP_BACKUP_QUEUE_PARAMS32_V1_W));
                }
                else
                {
                    return (uint)(sizeof(SP_BACKUP_QUEUE_PARAMS64_V1_W));
                }
            }
        }

        [FieldOffset(0)]
        public SP_BACKUP_QUEUE_PARAMS32_V1_W _value32;
