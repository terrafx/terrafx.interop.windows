...
namespace TerraFX.Interop
{
    public unsafe partial struct ENCLAVE_INIT_INFO_VBS_BASIC
    {
        ...
        public unsafe ref IntPtr SignatureInfoHandle
        {
...
#else
                return ref ((_Anonymous_e__Union*)Unsafe.AsPointer(ref Anonymous))->SignatureInfoHandle;
#endif
            }
        }

        public unsafe ref ulong Unused
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
...
#else
                return ref ((_Anonymous_e__Union*)Unsafe.AsPointer(ref Anonymous))->Unused;
#endif
            }
        }
