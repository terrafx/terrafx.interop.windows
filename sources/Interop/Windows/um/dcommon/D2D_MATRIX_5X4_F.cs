...
namespace TerraFX.Interop
{
    public unsafe partial struct D2D_MATRIX_5X4_F
    {
        ...
        public ref float _51 => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous._51, 1));

        public ref float _52 => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous._52, 1));

        public ref float _53 => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous._53, 1));

        public ref float _54 => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous._54, 1));

        public Span<float> m => MemoryMarshal.CreateSpan(ref Anonymous.m[0], 5);
