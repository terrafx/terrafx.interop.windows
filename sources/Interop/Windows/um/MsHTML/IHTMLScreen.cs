...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLScreen
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int put_bufferDepth([NativeTypeName("long")] int v)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int put_updateInterval([NativeTypeName("long")] int v)
        {
        ...
        [VtblIndex(13)]
        [return: NativeTypeName("HRESULT")]
        public int get_updateInterval([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(16)]
        [return: NativeTypeName("HRESULT")]
        public int get_fontSmoothingEnabled([NativeTypeName("VARIANT_BOOL *")] short* p)
        {
