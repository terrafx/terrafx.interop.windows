...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLDatabinding
    {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int put_dataSrc([NativeTypeName("BSTR")] ushort* v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_dataSrc([NativeTypeName("BSTR *")] ushort** p)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int put_dataFormatAs([NativeTypeName("BSTR")] ushort* v)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int get_dataFormatAs([NativeTypeName("BSTR *")] ushort** p)
        {
