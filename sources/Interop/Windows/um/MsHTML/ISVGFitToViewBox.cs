...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGFitToViewBox
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int get_viewBox(ISVGAnimatedRect** p)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int putref_preserveAspectRatio(ISVGAnimatedPreserveAspectRatio* v)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_preserveAspectRatio(ISVGAnimatedPreserveAspectRatio** p)
        {
