...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGAnimatedTransformList
    {
        public void** lpVtbl;
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int putref_baseVal(ISVGTransformList* v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_baseVal(ISVGTransformList** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int putref_animVal(ISVGTransformList* v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_animVal(ISVGTransformList** p)
        {
