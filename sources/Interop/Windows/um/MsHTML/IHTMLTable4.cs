...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLTable4
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int putref_tHead(IHTMLTableSection* v)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int putref_tFoot(IHTMLTableSection* v)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int putref_caption(IHTMLTableCaption* v)
        {
        ...
        [VtblIndex(15)]
        [return: NativeTypeName("HRESULT")]
        public int createTBody(IHTMLTableSection** tbody)
        {
