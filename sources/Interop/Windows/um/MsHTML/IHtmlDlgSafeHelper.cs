...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHtmlDlgSafeHelper
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int choosecolordlg(VARIANT initColor, VARIANT* rgbColor)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int getCharset([NativeTypeName("BSTR")] ushort* fontName, VARIANT* charset)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_Fonts(IDispatch** p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_BlockFormats(IDispatch** p)
        {
