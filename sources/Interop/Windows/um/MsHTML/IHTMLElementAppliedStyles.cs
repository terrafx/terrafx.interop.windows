...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLElementAppliedStyles
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int msGetRulesApplied(IRulesAppliedCollection** ppRulesAppliedCollection)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int msGetRulesAppliedWithAncestor(VARIANT varContext, IRulesAppliedCollection** ppRulesAppliedCollection)
        {
