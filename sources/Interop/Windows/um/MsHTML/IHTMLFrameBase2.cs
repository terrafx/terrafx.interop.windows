...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLFrameBase2
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int get_contentWindow(IHTMLWindow2** p)
        {
        ...
        [VtblIndex(13)]
        [return: NativeTypeName("HRESULT")]
        public int put_allowTransparency([NativeTypeName("VARIANT_BOOL")] short v)
        {
        ...
        [VtblIndex(14)]
        [return: NativeTypeName("HRESULT")]
        public int get_allowTransparency([NativeTypeName("VARIANT_BOOL *")] short* p)
        {
