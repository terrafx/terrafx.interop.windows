...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGAnimatedPreserveAspectRatio
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int putref_baseVal(ISVGPreserveAspectRatio* v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_baseVal(ISVGPreserveAspectRatio** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int putref_animVal(ISVGPreserveAspectRatio* v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_animVal(ISVGPreserveAspectRatio** p)
        {
