...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLPopup
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int show([NativeTypeName("long")] int x, [NativeTypeName("long")] int y, [NativeTypeName("long")] int w, [NativeTypeName("long")] int h, VARIANT* pElement)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_document(IHTMLDocument** p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_isOpen([NativeTypeName("VARIANT_BOOL *")] short* p)
        {
