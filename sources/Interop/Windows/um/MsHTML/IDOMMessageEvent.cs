...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDOMMessageEvent
    {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_source(IHTMLWindow2** p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int initMessageEvent([NativeTypeName("BSTR")] ushort* eventType, [NativeTypeName("VARIANT_BOOL")] short canBubble, [NativeTypeName("VARIANT_BOOL")] short cancelable, [NativeTypeName("BSTR")] ushort* data, [NativeTypeName("BSTR")] ushort* origin, [NativeTypeName("BSTR")] ushort* lastEventId, IHTMLWindow2* source)
        {
