...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDOMWheelEvent
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int get_deltaX([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_deltaY([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_deltaZ([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_deltaMode([NativeTypeName("ULONG *")] uint* p)
        {
