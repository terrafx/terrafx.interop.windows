...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLMSMediaElement
    {
        public void** lpVtbl;
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int put_msPlayToDisabled([NativeTypeName("VARIANT_BOOL")] short v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_msPlayToDisabled([NativeTypeName("VARIANT_BOOL *")] short* p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int put_msPlayToPrimary([NativeTypeName("VARIANT_BOOL")] short v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_msPlayToPrimary([NativeTypeName("VARIANT_BOOL *")] short* p)
        {
