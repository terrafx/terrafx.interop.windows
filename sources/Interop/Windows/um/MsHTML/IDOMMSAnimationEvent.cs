...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDOMMSAnimationEvent
    {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int initMSAnimationEvent([NativeTypeName("BSTR")] ushort* eventType, [NativeTypeName("VARIANT_BOOL")] short canBubble, [NativeTypeName("VARIANT_BOOL")] short cancelable, [NativeTypeName("BSTR")] ushort* animationName, float elapsedTime)
        {
