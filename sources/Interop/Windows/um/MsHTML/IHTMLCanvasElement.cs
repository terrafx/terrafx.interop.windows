...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLCanvasElement
    {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int getContext([NativeTypeName("BSTR")] ushort* contextId, ICanvasRenderingContext2D** ppContext)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int toDataURL([NativeTypeName("BSTR")] ushort* type, VARIANT jpegquality, [NativeTypeName("BSTR *")] ushort** pUrl)
        {
