...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDOMCompositionEvent
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int initCompositionEvent([NativeTypeName("BSTR")] ushort* eventType, [NativeTypeName("VARIANT_BOOL")] short canBubble, [NativeTypeName("VARIANT_BOOL")] short cancelable, IHTMLWindow2* viewArg, [NativeTypeName("BSTR")] ushort* data, [NativeTypeName("BSTR")] ushort* locale)
        {
