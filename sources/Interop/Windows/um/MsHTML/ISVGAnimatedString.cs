...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGAnimatedString
    {
        public void** lpVtbl;
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int put_baseVal([NativeTypeName("BSTR")] ushort* v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_baseVal([NativeTypeName("BSTR *")] ushort** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_animVal([NativeTypeName("BSTR *")] ushort** p)
        {
