...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLDOMConstructor
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int get_constructor(IDispatch** p)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int LookupGetter([NativeTypeName("BSTR")] ushort* propname, VARIANT* ppDispHandler)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int LookupSetter([NativeTypeName("BSTR")] ushort* propname, VARIANT* ppDispHandler)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int DefineGetter([NativeTypeName("BSTR")] ushort* propname, VARIANT* pdispHandler)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int DefineSetter([NativeTypeName("BSTR")] ushort* propname, VARIANT* pdispHandler)
        {
