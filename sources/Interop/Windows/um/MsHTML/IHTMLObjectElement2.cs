...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLObjectElement2
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int namedRecordset([NativeTypeName("BSTR")] ushort* dataMember, VARIANT* hierarchy, IDispatch** ppRecordset)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int put_classid([NativeTypeName("BSTR")] ushort* v)
        {
