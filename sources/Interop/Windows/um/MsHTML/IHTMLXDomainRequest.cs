...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLXDomainRequest
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int put_timeout([NativeTypeName("long")] int v)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_timeout([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_contentType([NativeTypeName("BSTR *")] ushort** p)
        {
        ...
        [VtblIndex(15)]
        [return: NativeTypeName("HRESULT")]
        public int put_ontimeout(VARIANT v)
        {
        ...
        [VtblIndex(16)]
        [return: NativeTypeName("HRESULT")]
        public int get_ontimeout(VARIANT* p)
        {
        ...
        [VtblIndex(20)]
        [return: NativeTypeName("HRESULT")]
        public int open([NativeTypeName("BSTR")] ushort* bstrMethod, [NativeTypeName("BSTR")] ushort* bstrUrl)
        {
