...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IOmHistory
    {
        public void** lpVtbl;
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int back(VARIANT* pvargdistance)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int forward(VARIANT* pvargdistance)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int go(VARIANT* pvargdistance)
        {
