...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGAnimatedNumberList
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int putref_baseVal(ISVGNumberList* v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_baseVal(ISVGNumberList** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int putref_animVal(ISVGNumberList* v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_animVal(ISVGNumberList** p)
        {
