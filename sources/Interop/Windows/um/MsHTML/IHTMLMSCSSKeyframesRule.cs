...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLMSCSSKeyframesRule
    {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int appendRule([NativeTypeName("BSTR")] ushort* bstrRule)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int deleteRule([NativeTypeName("BSTR")] ushort* bstrKey)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int findRule([NativeTypeName("BSTR")] ushort* bstrKey, IHTMLMSCSSKeyframeRule** ppMSKeyframeRule)
        {
