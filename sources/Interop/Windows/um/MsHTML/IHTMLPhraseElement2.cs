...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLPhraseElement2
    {
        public void** lpVtbl;
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int put_dateTime([NativeTypeName("BSTR")] ushort* v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_dateTime([NativeTypeName("BSTR *")] ushort** p)
        {
