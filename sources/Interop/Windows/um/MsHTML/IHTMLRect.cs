...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLRect
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int put_left([NativeTypeName("long")] int v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_left([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int put_top([NativeTypeName("long")] int v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_top([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int put_right([NativeTypeName("long")] int v)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int get_right([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(13)]
        [return: NativeTypeName("HRESULT")]
        public int put_bottom([NativeTypeName("long")] int v)
        {
        ...
        [VtblIndex(14)]
        [return: NativeTypeName("HRESULT")]
        public int get_bottom([NativeTypeName("long *")] int* p)
        {
