...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLSubmitData
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int appendNameValuePair([NativeTypeName("BSTR")] ushort* name = null, [NativeTypeName("BSTR")] ushort* value = null)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int appendNameFilePair([NativeTypeName("BSTR")] ushort* name = null, [NativeTypeName("BSTR")] ushort* filename = null)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int appendItemSeparator()
        {
