...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IElementNamespaceTable
    {
        ...
        [VtblIndex(3)]
        [return: NativeTypeName("HRESULT")]
        public int AddNamespace([NativeTypeName("BSTR")] ushort* bstrNamespace, [NativeTypeName("BSTR")] ushort* bstrUrn, [NativeTypeName("LONG")] int lFlags, VARIANT* pvarFactory)
        {
