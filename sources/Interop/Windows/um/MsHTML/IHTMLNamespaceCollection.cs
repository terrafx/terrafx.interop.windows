...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLNamespaceCollection
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int item(VARIANT index, IDispatch** ppNamespace)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int add([NativeTypeName("BSTR")] ushort* bstrNamespace, [NativeTypeName("BSTR")] ushort* bstrUrn, VARIANT implementationUrl, IDispatch** ppNamespace)
        {
