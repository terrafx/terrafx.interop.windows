...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLPerformanceNavigation
    {
        public void** lpVtbl;
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int get_type([NativeTypeName("ULONG *")] uint* p)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_redirectCount([NativeTypeName("ULONG *")] uint* p)
        {
