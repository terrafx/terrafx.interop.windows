...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDOMProgressEvent
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int get_lengthComputable([NativeTypeName("VARIANT_BOOL *")] short* p)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_loaded([NativeTypeName("ULONGLONG *")] ulong* p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_total([NativeTypeName("ULONGLONG *")] ulong* p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int initProgressEvent([NativeTypeName("BSTR")] ushort* eventType, [NativeTypeName("VARIANT_BOOL")] short canBubble, [NativeTypeName("VARIANT_BOOL")] short cancelable, [NativeTypeName("VARIANT_BOOL")] short lengthComputableArg, [NativeTypeName("ULONGLONG")] ulong loadedArg, [NativeTypeName("ULONGLONG")] ulong totalArg)
        {
