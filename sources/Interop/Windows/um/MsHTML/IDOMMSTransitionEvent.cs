...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDOMMSTransitionEvent
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_elapsedTime(float* p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int initMSTransitionEvent([NativeTypeName("BSTR")] ushort* eventType, [NativeTypeName("VARIANT_BOOL")] short canBubble, [NativeTypeName("VARIANT_BOOL")] short cancelable, [NativeTypeName("BSTR")] ushort* propertyName, float elapsedTime)
        {
