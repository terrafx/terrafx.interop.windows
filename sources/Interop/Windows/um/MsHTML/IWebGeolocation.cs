...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWebGeolocation
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int getCurrentPosition(IDispatch* successCallback, IDispatch* errorCallback = null, IDispatch* options = null)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int watchPosition(IDispatch* successCallback, IDispatch* errorCallback, IDispatch* options, [NativeTypeName("long *")] int* watchId)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int clearWatch([NativeTypeName("long")] int watchId)
        {
