...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDocumentTraversal
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int createNodeIterator(IDispatch* pRootNode, [NativeTypeName("long")] int ulWhatToShow, VARIANT* pFilter, [NativeTypeName("VARIANT_BOOL")] short fEntityReferenceExpansion, IDOMNodeIterator** ppNodeIterator)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int createTreeWalker(IDispatch* pRootNode, [NativeTypeName("long")] int ulWhatToShow, VARIANT* pFilter, [NativeTypeName("VARIANT_BOOL")] short fEntityReferenceExpansion, IDOMTreeWalker** ppTreeWalker)
        {
