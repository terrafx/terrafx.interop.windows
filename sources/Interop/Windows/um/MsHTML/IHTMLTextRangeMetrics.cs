...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLTextRangeMetrics
    {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_boundingTop([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_boundingLeft([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int get_boundingWidth([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int get_boundingHeight([NativeTypeName("long *")] int* p)
        {
