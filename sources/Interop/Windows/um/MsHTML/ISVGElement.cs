...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGElement
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int put_xmlbase([NativeTypeName("BSTR")] ushort* v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_xmlbase([NativeTypeName("BSTR *")] ushort** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int putref_ownerSVGElement(ISVGSVGElement* v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_ownerSVGElement(ISVGSVGElement** p)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int putref_viewportElement(ISVGElement* v)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int get_viewportElement(ISVGElement** p)
        {
        ...
        [VtblIndex(13)]
        [return: NativeTypeName("HRESULT")]
        public int putref_focusable(ISVGAnimatedEnumeration* v)
        {
        ...
        [VtblIndex(14)]
        [return: NativeTypeName("HRESULT")]
        public int get_focusable(ISVGAnimatedEnumeration** p)
        {
