...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IRulesApplied
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_inlineStyles(IHTMLStyle** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int get_appliedRules(IHTMLStyleSheetRulesAppliedCollection** p)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int propertyIsInline([NativeTypeName("BSTR")] ushort* name, [NativeTypeName("VARIANT_BOOL *")] short* p)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int propertyIsInheritable([NativeTypeName("BSTR")] ushort* name, [NativeTypeName("VARIANT_BOOL *")] short* p)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int hasInheritableProperty([NativeTypeName("VARIANT_BOOL *")] short* p)
        {
