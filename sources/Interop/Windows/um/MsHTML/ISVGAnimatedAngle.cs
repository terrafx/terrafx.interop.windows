...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGAnimatedAngle
    {
        public void** lpVtbl;
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int putref_baseVal(ISVGAngle* v)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_baseVal(ISVGAngle** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int putref_animVal(ISVGAngle* v)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int get_animVal(ISVGAngle** p)
        {
