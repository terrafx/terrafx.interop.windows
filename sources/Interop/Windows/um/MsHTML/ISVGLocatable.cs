...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISVGLocatable
    {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int get_nearestViewportElement(ISVGElement** p)
        {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_farthestViewportElement(ISVGElement** p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int getBBox(ISVGRect** ppResult)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int getCTM(ISVGMatrix** ppResult)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int getScreenCTM(ISVGMatrix** ppResult)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int getTransformToElement(ISVGElement* pElement, ISVGMatrix** ppResult)
        {
