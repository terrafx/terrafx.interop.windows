...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IHTMLStorage
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_remainingSpace([NativeTypeName("long *")] int* p)
        {
        ...
        [VtblIndex(9)]
        [return: NativeTypeName("HRESULT")]
        public int key([NativeTypeName("long")] int lIndex, [NativeTypeName("BSTR *")] ushort** __MIDL__IHTMLStorage0000)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int getItem([NativeTypeName("BSTR")] ushort* bstrKey, VARIANT* __MIDL__IHTMLStorage0001)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int removeItem([NativeTypeName("BSTR")] ushort* bstrKey)
        {
