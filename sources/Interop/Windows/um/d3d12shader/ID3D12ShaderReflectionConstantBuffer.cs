...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12ShaderReflectionConstantBuffer
    {
        ...
        {
            return ((delegate* stdcall<ID3D12ShaderReflectionConstantBuffer*, sbyte*, ID3D12ShaderReflectionVariable*>)(lpVtbl[2]))((ID3D12ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), Name);
        }
    }
}
