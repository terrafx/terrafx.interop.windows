...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12FunctionReflection
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12FunctionReflection*, D3D12_FUNCTION_DESC*, int>)(lpVtbl[0]))((ID3D12FunctionReflection*)Unsafe.AsPointer(ref this), pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12FunctionReflection*, uint, D3D12_SHADER_INPUT_BIND_DESC*, int>)(lpVtbl[3]))((ID3D12FunctionReflection*)Unsafe.AsPointer(ref this), ResourceIndex, pDesc);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D12FunctionReflection*, sbyte*, D3D12_SHADER_INPUT_BIND_DESC*, int>)(lpVtbl[5]))((ID3D12FunctionReflection*)Unsafe.AsPointer(ref this), Name, pDesc);
        }
