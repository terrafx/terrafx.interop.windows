...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISoftwareBitmapNativeFactory
    {
        ...
        [VtblIndex(6)]
        [return: NativeTypeName("HRESULT")]
        public int CreateFromWICBitmap(IWICBitmap* data, BOOL forceReadOnly, [NativeTypeName("const IID &")] Guid* riid, [NativeTypeName("LPVOID *")] void** ppv)
        {
        ...
        [VtblIndex(7)]
        [return: NativeTypeName("HRESULT")]
        public int CreateFromMF2DBuffer2(IMF2DBuffer2* data, [NativeTypeName("const GUID &")] Guid* subtype, [NativeTypeName("UINT32")] uint width, [NativeTypeName("UINT32")] uint height, BOOL forceReadOnly, [NativeTypeName("const MFVideoArea *")] MFVideoArea* minDisplayAperture, [NativeTypeName("const IID &")] Guid* riid, [NativeTypeName("LPVOID *")] void** ppv)
        {
