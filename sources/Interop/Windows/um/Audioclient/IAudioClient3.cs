...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IAudioClient3
    {
        ...
        {
            return ((delegate* stdcall<IAudioClient3*, Guid*, void**, int>)(lpVtbl[0]))((IAudioClient3*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }

        [return: NativeTypeName("ULONG")]
        public uint AddRef()
        {
            return ((delegate* stdcall<IAudioClient3*, uint>)(lpVtbl[1]))((IAudioClient3*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("ULONG")]
        public uint Release()
        {
            return ((delegate* stdcall<IAudioClient3*, uint>)(lpVtbl[2]))((IAudioClient3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<IAudioClient3*, AUDCLNT_SHAREMODE, uint, long, long, WAVEFORMATEX*, Guid*, int>)(lpVtbl[3]))((IAudioClient3*)Unsafe.AsPointer(ref this), ShareMode, StreamFlags, hnsBufferDuration, hnsPeriodicity, pFormat, AudioSessionGuid);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetBufferSize([NativeTypeName("UINT32 *")] uint* pNumBufferFrames)
        {
            return ((delegate* stdcall<IAudioClient3*, uint*, int>)(lpVtbl[4]))((IAudioClient3*)Unsafe.AsPointer(ref this), pNumBufferFrames);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetStreamLatency([NativeTypeName("REFERENCE_TIME *")] long* phnsLatency)
        {
            return ((delegate* stdcall<IAudioClient3*, long*, int>)(lpVtbl[5]))((IAudioClient3*)Unsafe.AsPointer(ref this), phnsLatency);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetCurrentPadding([NativeTypeName("UINT32 *")] uint* pNumPaddingFrames)
        {
            return ((delegate* stdcall<IAudioClient3*, uint*, int>)(lpVtbl[6]))((IAudioClient3*)Unsafe.AsPointer(ref this), pNumPaddingFrames);
        }
        ...
        {
            return ((delegate* stdcall<IAudioClient3*, AUDCLNT_SHAREMODE, WAVEFORMATEX*, WAVEFORMATEX**, int>)(lpVtbl[7]))((IAudioClient3*)Unsafe.AsPointer(ref this), ShareMode, pFormat, ppClosestMatch);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetMixFormat([NativeTypeName("WAVEFORMATEX **")] WAVEFORMATEX** ppDeviceFormat)
        {
            return ((delegate* stdcall<IAudioClient3*, WAVEFORMATEX**, int>)(lpVtbl[8]))((IAudioClient3*)Unsafe.AsPointer(ref this), ppDeviceFormat);
        }
        ...
        {
            return ((delegate* stdcall<IAudioClient3*, long*, long*, int>)(lpVtbl[9]))((IAudioClient3*)Unsafe.AsPointer(ref this), phnsDefaultDevicePeriod, phnsMinimumDevicePeriod);
        }

        [return: NativeTypeName("HRESULT")]
        public int Start()
        {
            return ((delegate* stdcall<IAudioClient3*, int>)(lpVtbl[10]))((IAudioClient3*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("HRESULT")]
        public int Stop()
        {
            return ((delegate* stdcall<IAudioClient3*, int>)(lpVtbl[11]))((IAudioClient3*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("HRESULT")]
        public int Reset()
        {
            return ((delegate* stdcall<IAudioClient3*, int>)(lpVtbl[12]))((IAudioClient3*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("HRESULT")]
        public int SetEventHandle([NativeTypeName("HANDLE")] IntPtr eventHandle)
        {
            return ((delegate* stdcall<IAudioClient3*, IntPtr, int>)(lpVtbl[13]))((IAudioClient3*)Unsafe.AsPointer(ref this), eventHandle);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetService([NativeTypeName("const IID &")] Guid* riid, [NativeTypeName("void **")] void** ppv)
        {
            return ((delegate* stdcall<IAudioClient3*, Guid*, void**, int>)(lpVtbl[14]))((IAudioClient3*)Unsafe.AsPointer(ref this), riid, ppv);
        }

        [return: NativeTypeName("HRESULT")]
        public int IsOffloadCapable(AUDIO_STREAM_CATEGORY Category, [NativeTypeName("BOOL *")] int* pbOffloadCapable)
        {
            return ((delegate* stdcall<IAudioClient3*, AUDIO_STREAM_CATEGORY, int*, int>)(lpVtbl[15]))((IAudioClient3*)Unsafe.AsPointer(ref this), Category, pbOffloadCapable);
        }

        [return: NativeTypeName("HRESULT")]
        public int SetClientProperties([NativeTypeName("const AudioClientProperties *")] AudioClientProperties* pProperties)
        {
            return ((delegate* stdcall<IAudioClient3*, AudioClientProperties*, int>)(lpVtbl[16]))((IAudioClient3*)Unsafe.AsPointer(ref this), pProperties);
        }
        ...
        {
            return ((delegate* stdcall<IAudioClient3*, WAVEFORMATEX*, int, long*, long*, int>)(lpVtbl[17]))((IAudioClient3*)Unsafe.AsPointer(ref this), pFormat, bEventDriven, phnsMinBufferDuration, phnsMaxBufferDuration);
        }
