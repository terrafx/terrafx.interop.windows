...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("wintrust", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        ...
        [DllImport("wintrust", CallingConvention = CallingConvention.StdCall, ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
