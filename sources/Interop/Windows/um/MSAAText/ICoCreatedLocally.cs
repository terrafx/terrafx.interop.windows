...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ICoCreatedLocally
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int LocalInit([NativeTypeName("IUnknown *")] IUnknown* punkLocalObject, [NativeTypeName("const IID &")] Guid* riidParam, [NativeTypeName("IUnknown *")] IUnknown* punkParam, VARIANT varParam)
        {
