...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISimpleFrameSite
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ISimpleFrameSite*, Guid*, void**, int>)(lpVtbl[0]))((ISimpleFrameSite*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ISimpleFrameSite*, IntPtr, uint, nuint, nint, nint*, uint*, int>)(lpVtbl[3]))((ISimpleFrameSite*)Unsafe.AsPointer(ref this), hWnd, msg, wp, lp, plResult, pdwCookie);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ISimpleFrameSite*, IntPtr, uint, nuint, nint, nint*, uint, int>)(lpVtbl[4]))((ISimpleFrameSite*)Unsafe.AsPointer(ref this), hWnd, msg, wp, lp, plResult, dwCookie);
        }
    }
}
