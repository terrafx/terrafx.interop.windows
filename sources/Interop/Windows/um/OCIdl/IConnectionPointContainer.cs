...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IConnectionPointContainer
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IConnectionPointContainer*, Guid*, void**, int>)(lpVtbl[0]))((IConnectionPointContainer*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IConnectionPointContainer*, IEnumConnectionPoints**, int>)(lpVtbl[3]))((IConnectionPointContainer*)Unsafe.AsPointer(ref this), ppEnum);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IConnectionPointContainer*, Guid*, IConnectionPoint**, int>)(lpVtbl[4]))((IConnectionPointContainer*)Unsafe.AsPointer(ref this), riid, ppCP);
        }
    }
}
