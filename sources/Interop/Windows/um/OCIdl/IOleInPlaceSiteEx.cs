...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IOleInPlaceSiteEx
    {
        ...
        {
            return ((delegate* stdcall<IOleInPlaceSiteEx*, IOleInPlaceFrame**, IOleInPlaceUIWindow**, RECT*, RECT*, OIFI*, int>)(lpVtbl[8]))((IOleInPlaceSiteEx*)Unsafe.AsPointer(ref this), ppFrame, ppDoc, lprcPosRect, lprcClipRect, lpFrameInfo);
        }
