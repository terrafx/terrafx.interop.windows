...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
...
#else
        public static extern uint QueueUserAPC([NativeTypeName("PAPCFUNC")] delegate* unmanaged[Stdcall]<nuint, void> pfnAPC, [NativeTypeName("HANDLE")] IntPtr hThread, [NativeTypeName("ULONG_PTR")] nuint dwData);
#endif
...
#else
        public static extern IntPtr CreateRemoteThreadEx([NativeTypeName("HANDLE")] IntPtr hProcess, [NativeTypeName("LPSECURITY_ATTRIBUTES")] SECURITY_ATTRIBUTES* lpThreadAttributes, [NativeTypeName("SIZE_T")] nuint dwStackSize, [NativeTypeName("LPTHREAD_START_ROUTINE")] delegate* unmanaged[Stdcall]<void*, uint> lpStartAddress, [NativeTypeName("LPVOID")] void* lpParameter, [NativeTypeName("DWORD")] uint dwCreationFlags, [NativeTypeName("LPPROC_THREAD_ATTRIBUTE_LIST")] IntPtr lpAttributeList, [NativeTypeName("LPDWORD")] uint* lpThreadId);
#endif
        ...
        [DllImport("ntdll", CallingConvention = CallingConvention.StdCall, ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
