...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFontFace4
    {
        ...
        {
            return ((delegate* unmanaged<IDWriteFontFace4*, DWRITE_GLYPH_IMAGE_FORMATS>)(lpVtbl[49]))((IDWriteFontFace4*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontFace4*, ushort, uint, uint, DWRITE_GLYPH_IMAGE_FORMATS*, int>)(lpVtbl[50]))((IDWriteFontFace4*)Unsafe.AsPointer(ref this), glyphId, pixelsPerEmFirst, pixelsPerEmLast, glyphImageFormats);
        }
