...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFontCollection1
    {
        ...
        {
            return ((delegate* unmanaged<IDWriteFontCollection1*, ushort*, uint*, int*, int>)(lpVtbl[5]))((IDWriteFontCollection1*)Unsafe.AsPointer(ref this), familyName, index, exists);
        }
