...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFactory4
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, IDWriteFontCollection**, int, int>)(lpVtbl[3]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, ushort*, FILETIME*, IDWriteFontFile**, int>)(lpVtbl[7]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, fontFile);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, DWRITE_FONT_FACE_TYPE, uint, IDWriteFontFile**, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFace**, int>)(lpVtbl[9]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), fontFaceType, numberOfFiles, fontFiles, faceIndex, fontFaceSimulationFlags, fontFace);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE, IDWriteRenderingParams**, int>)(lpVtbl[12]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), gamma, enhancedContrast, clearTypeLevel, pixelGeometry, renderingMode, renderingParams);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, ushort*, uint, IDWriteTextFormat*, float, float, float, DWRITE_MATRIX*, int, IDWriteTextLayout**, int>)(lpVtbl[19]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutWidth, layoutHeight, pixelsPerDip, transform, useGdiNatural, textLayout);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, DWRITE_NUMBER_SUBSTITUTION_METHOD, ushort*, int, IDWriteNumberSubstitution**, int>)(lpVtbl[22]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), substitutionMethod, localeName, ignoreUserOverride, numberSubstitution);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, IDWriteFontCollection**, int, int>)(lpVtbl[24]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, ushort*, FILETIME*, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFaceReference**, int>)(lpVtbl[33]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, faceIndex, fontSimulations, fontFaceReference);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, IDWriteFontFile*, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFaceReference**, int>)(lpVtbl[34]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), fontFile, faceIndex, fontSimulations, fontFaceReference);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, int, IDWriteFontCollection1**, int, int>)(lpVtbl[38]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), includeDownloadableFonts, fontCollection, checkForUpdates);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, D2D_POINT_2F, DWRITE_GLYPH_RUN*, DWRITE_GLYPH_RUN_DESCRIPTION*, DWRITE_GLYPH_IMAGE_FORMATS, DWRITE_MEASURING_MODE, DWRITE_MATRIX*, uint, IDWriteColorGlyphRunEnumerator1**, int>)(lpVtbl[40]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, desiredGlyphImageFormats, measuringMode, worldAndDpiTransform, colorPaletteIndex, colorLayers);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, DWRITE_GLYPH_RUN*, DWRITE_MEASURING_MODE, D2D_POINT_2F, DWRITE_MATRIX*, D2D_POINT_2F*, int>)(lpVtbl[41]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), glyphRun, measuringMode, baselineOrigin, worldAndDpiTransform, glyphOrigins);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFactory4*, DWRITE_GLYPH_RUN*, D2D_POINT_2F, D2D_POINT_2F*, int>)(lpVtbl[42]))((IDWriteFactory4*)Unsafe.AsPointer(ref this), glyphRun, baselineOrigin, glyphOrigins);
        }
    }
}
