...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFactory3
    {
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, Guid*, void**, int>)(lpVtbl[0]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }

        [return: NativeTypeName("ULONG")]
        public uint AddRef()
        {
            return ((delegate* stdcall<IDWriteFactory3*, uint>)(lpVtbl[1]))((IDWriteFactory3*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("ULONG")]
        public uint Release()
        {
            return ((delegate* stdcall<IDWriteFactory3*, uint>)(lpVtbl[2]))((IDWriteFactory3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontCollection**, int, int>)(lpVtbl[3]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontCollectionLoader*, void*, uint, IDWriteFontCollection**, int>)(lpVtbl[4]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), collectionLoader, collectionKey, collectionKeySize, fontCollection);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontCollectionLoader*, int>)(lpVtbl[5]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontCollectionLoader);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontCollectionLoader*, int>)(lpVtbl[6]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontCollectionLoader);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, ushort*, FILETIME*, IDWriteFontFile**, int>)(lpVtbl[7]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, fontFile);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, void*, uint, IDWriteFontFileLoader*, IDWriteFontFile**, int>)(lpVtbl[8]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFileReferenceKey, fontFileReferenceKeySize, fontFileLoader, fontFile);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, DWRITE_FONT_FACE_TYPE, uint, IDWriteFontFile**, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFace**, int>)(lpVtbl[9]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFaceType, numberOfFiles, fontFiles, faceIndex, fontFaceSimulationFlags, fontFace);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateRenderingParams([NativeTypeName("IDWriteRenderingParams **")] IDWriteRenderingParams** renderingParams)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteRenderingParams**, int>)(lpVtbl[10]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), renderingParams);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IntPtr, IDWriteRenderingParams**, int>)(lpVtbl[11]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), monitor, renderingParams);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE, IDWriteRenderingParams**, int>)(lpVtbl[12]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), gamma, enhancedContrast, clearTypeLevel, pixelGeometry, renderingMode, renderingParams);
        }

        [return: NativeTypeName("HRESULT")]
        public int RegisterFontFileLoader([NativeTypeName("IDWriteFontFileLoader *")] IDWriteFontFileLoader* fontFileLoader)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontFileLoader*, int>)(lpVtbl[13]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFileLoader);
        }

        [return: NativeTypeName("HRESULT")]
        public int UnregisterFontFileLoader([NativeTypeName("IDWriteFontFileLoader *")] IDWriteFontFileLoader* fontFileLoader)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontFileLoader*, int>)(lpVtbl[14]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFileLoader);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, ushort*, IDWriteFontCollection*, DWRITE_FONT_WEIGHT, DWRITE_FONT_STYLE, DWRITE_FONT_STRETCH, float, ushort*, IDWriteTextFormat**, int>)(lpVtbl[15]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFamilyName, fontCollection, fontWeight, fontStyle, fontStretch, fontSize, localeName, textFormat);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateTypography([NativeTypeName("IDWriteTypography **")] IDWriteTypography** typography)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteTypography**, int>)(lpVtbl[16]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), typography);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetGdiInterop([NativeTypeName("IDWriteGdiInterop **")] IDWriteGdiInterop** gdiInterop)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteGdiInterop**, int>)(lpVtbl[17]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), gdiInterop);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, ushort*, uint, IDWriteTextFormat*, float, float, IDWriteTextLayout**, int>)(lpVtbl[18]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, maxWidth, maxHeight, textLayout);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, ushort*, uint, IDWriteTextFormat*, float, float, float, DWRITE_MATRIX*, int, IDWriteTextLayout**, int>)(lpVtbl[19]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutWidth, layoutHeight, pixelsPerDip, transform, useGdiNatural, textLayout);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteTextFormat*, IDWriteInlineObject**, int>)(lpVtbl[20]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), textFormat, trimmingSign);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateTextAnalyzer([NativeTypeName("IDWriteTextAnalyzer **")] IDWriteTextAnalyzer** textAnalyzer)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteTextAnalyzer**, int>)(lpVtbl[21]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), textAnalyzer);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, DWRITE_NUMBER_SUBSTITUTION_METHOD, ushort*, int, IDWriteNumberSubstitution**, int>)(lpVtbl[22]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), substitutionMethod, localeName, ignoreUserOverride, numberSubstitution);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontCollection**, int, int>)(lpVtbl[24]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, float, float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE, IDWriteRenderingParams1**, int>)(lpVtbl[25]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), gamma, enhancedContrast, enhancedContrastGrayscale, clearTypeLevel, pixelGeometry, renderingMode, renderingParams);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetSystemFontFallback([NativeTypeName("IDWriteFontFallback **")] IDWriteFontFallback** fontFallback)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontFallback**, int>)(lpVtbl[26]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFallback);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontFallbackBuilder**, int>)(lpVtbl[27]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFallbackBuilder);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, ushort*, FILETIME*, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFaceReference**, int>)(lpVtbl[33]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, faceIndex, fontSimulations, fontFaceReference);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontFile*, uint, DWRITE_FONT_SIMULATIONS, IDWriteFontFaceReference**, int>)(lpVtbl[34]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontFile, faceIndex, fontSimulations, fontFaceReference);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetSystemFontSet([NativeTypeName("IDWriteFontSet **")] IDWriteFontSet** fontSet)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontSet**, int>)(lpVtbl[35]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontSet);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateFontSetBuilder([NativeTypeName("IDWriteFontSetBuilder **")] IDWriteFontSetBuilder** fontSetBuilder)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontSetBuilder**, int>)(lpVtbl[36]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontSetBuilder);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontSet*, IDWriteFontCollection1**, int>)(lpVtbl[37]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontSet, fontCollection);
        }
        ...
        {
            return ((delegate* stdcall<IDWriteFactory3*, int, IDWriteFontCollection1**, int, int>)(lpVtbl[38]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), includeDownloadableFonts, fontCollection, checkForUpdates);
        }

        [return: NativeTypeName("HRESULT")]
        public int GetFontDownloadQueue([NativeTypeName("IDWriteFontDownloadQueue **")] IDWriteFontDownloadQueue** fontDownloadQueue)
        {
            return ((delegate* stdcall<IDWriteFactory3*, IDWriteFontDownloadQueue**, int>)(lpVtbl[39]))((IDWriteFactory3*)Unsafe.AsPointer(ref this), fontDownloadQueue);
        }
    }
}
