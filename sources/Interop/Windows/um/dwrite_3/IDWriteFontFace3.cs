...
namespace TerraFX.Interop
{
    ...
    public unsafe struct IDWriteFontFace3
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _AreCharactersLocal(IDWriteFontFace3* This, [NativeTypeName("WCHAR[]")] char* characters, [NativeTypeName("UINT32")] uint characterCount, [NativeTypeName("BOOL")] int enqueueIfNotLocal, [NativeTypeName("BOOL")] int* isLocal);
