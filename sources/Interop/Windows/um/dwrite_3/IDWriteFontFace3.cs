...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFontFace3
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_FONT_FACE_TYPE>)(lpVtbl[3]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_FONT_SIMULATIONS>)(lpVtbl[6]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, int>)(lpVtbl[7]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetMetrics([NativeTypeName("DWRITE_FONT_METRICS *")] DWRITE_FONT_METRICS* fontFaceMetrics)
        {
            ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_FONT_METRICS*, void>)(lpVtbl[8]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), fontFaceMetrics);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, ushort*, uint, DWRITE_GLYPH_METRICS*, int, int>)(lpVtbl[10]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), glyphIndices, glyphCount, glyphMetrics, isSideways);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, uint, void**, uint*, void**, int*, int>)(lpVtbl[12]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), openTypeTableTag, tableData, tableSize, tableContext, exists);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, float, ushort*, float*, DWRITE_GLYPH_OFFSET*, uint, int, int, ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[14]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), emSize, glyphIndices, glyphAdvances, glyphOffsets, glyphCount, isSideways, isRightToLeft, geometrySink);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, float, float, DWRITE_MEASURING_MODE, IDWriteRenderingParams*, DWRITE_RENDERING_MODE*, int>)(lpVtbl[15]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, measuringMode, renderingParams, renderingMode);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, float, float, DWRITE_MATRIX*, DWRITE_FONT_METRICS*, int>)(lpVtbl[16]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, fontFaceMetrics);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, float, float, DWRITE_MATRIX*, int, ushort*, uint, DWRITE_GLYPH_METRICS*, int, int>)(lpVtbl[17]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, useGdiNatural, glyphIndices, glyphCount, glyphMetrics, isSideways);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetMetrics([NativeTypeName("DWRITE_FONT_METRICS1 *")] DWRITE_FONT_METRICS1* fontMetrics)
        {
            ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_FONT_METRICS1*, void>)(lpVtbl[18]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), fontMetrics);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, float, float, DWRITE_MATRIX*, DWRITE_FONT_METRICS1*, int>)(lpVtbl[19]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, fontMetrics);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetCaretMetrics([NativeTypeName("DWRITE_CARET_METRICS *")] DWRITE_CARET_METRICS* caretMetrics)
        {
            ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_CARET_METRICS*, void>)(lpVtbl[20]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), caretMetrics);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, uint, DWRITE_UNICODE_RANGE*, uint*, int>)(lpVtbl[21]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), maxRangeCount, unicodeRanges, actualRangeCount);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, int>)(lpVtbl[22]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, uint, ushort*, int*, int, int>)(lpVtbl[23]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), glyphCount, glyphIndices, glyphAdvances, isSideways);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, float, float, DWRITE_MATRIX*, int, int, uint, ushort*, int*, int>)(lpVtbl[24]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, useGdiNatural, isSideways, glyphCount, glyphIndices, glyphAdvances);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, int>)(lpVtbl[26]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, float, float, float, DWRITE_MATRIX*, int, DWRITE_OUTLINE_THRESHOLD, DWRITE_MEASURING_MODE, DWRITE_RENDERING_MODE*, int>)(lpVtbl[27]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), fontEmSize, dpiX, dpiY, transform, isSideways, outlineThreshold, measuringMode, renderingMode);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, int>)(lpVtbl[29]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, int>)(lpVtbl[30]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, uint, uint, uint, DXGI_RGBA*, int>)(lpVtbl[33]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
        }
        ...
        {
            ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_PANOSE*, void>)(lpVtbl[36]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), panose);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DWRITE_FONT_WEIGHT GetWeight()
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_FONT_WEIGHT>)(lpVtbl[37]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DWRITE_FONT_STRETCH GetStretch()
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_FONT_STRETCH>)(lpVtbl[38]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DWRITE_FONT_STYLE GetStyle()
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_FONT_STYLE>)(lpVtbl[39]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, DWRITE_INFORMATIONAL_STRING_ID, IDWriteLocalizedStrings**, int*, int>)(lpVtbl[42]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), informationalStringID, informationalStrings, exists);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, uint, int>)(lpVtbl[43]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), unicodeValue);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, uint, int>)(lpVtbl[45]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), unicodeValue);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, ushort, int>)(lpVtbl[46]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), glyphId);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, ushort*, uint, int, int*, int>)(lpVtbl[47]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), characters, characterCount, enqueueIfNotLocal, isLocal);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, ushort*, uint, int, int*, int>)(lpVtbl[48]))((IDWriteFontFace3*)Unsafe.AsPointer(ref this), glyphIndices, glyphCount, enqueueIfNotLocal, isLocal);
        }
    }
}
