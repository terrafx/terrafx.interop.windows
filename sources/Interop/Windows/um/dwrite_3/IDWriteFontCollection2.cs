...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFontCollection2
    {
        ...
        {
            return ((delegate* unmanaged<IDWriteFontCollection2*, ushort*, uint*, int*, int>)(lpVtbl[5]))((IDWriteFontCollection2*)Unsafe.AsPointer(ref this), familyName, index, exists);
        }
