...
namespace TerraFX.Interop
{
    ...
    public unsafe struct IDWriteFactory5
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateFontSetBuilder1(
            [In] IDWriteFactory5* This,
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateInMemoryFontFileLoader(
            [In] IDWriteFactory5* This,
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateHttpFontFileLoader(
            [In] IDWriteFactory5* This,
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate DWRITE_CONTAINER_TYPE _AnalyzeContainerType(
            [In] IDWriteFactory5* This,
            [In] void* fileData,
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _UnpackFontFile(
            [In] IDWriteFactory5* This,
        ...
        )
        {
            fixed (IDWriteFactory5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CreateFontSetBuilder1>(lpVtbl->CreateFontSetBuilder1)(
                    This,
                    fontSetBuilder
                );
            }
        ...
        )
        {
            fixed (IDWriteFactory5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CreateInMemoryFontFileLoader>(lpVtbl->CreateInMemoryFontFileLoader)(
                    This,
                    newLoader
                );
            }
        ...
        )
        {
            fixed (IDWriteFactory5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CreateHttpFontFileLoader>(lpVtbl->CreateHttpFontFileLoader)(
                    This,
                    referrerUrl,
                    extraHeaders,
                    newLoader
        ...
        )
        {
            fixed (IDWriteFactory5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_AnalyzeContainerType>(lpVtbl->AnalyzeContainerType)(
                    This,
                    fileData,
                    fileDataSize
                );
        ...
        )
        {
            fixed (IDWriteFactory5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_UnpackFontFile>(lpVtbl->UnpackFontFile)(
                    This,
                    containerType,
                    fileData,
                    fileDataSize,
