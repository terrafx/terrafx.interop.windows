...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteFontSet2
    {
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, uint, DWRITE_FONT_PROPERTY_ID, int*, IDWriteLocalizedStrings**, int>)(lpVtbl[7]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), listIndex, propertyId, exists, values);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, DWRITE_FONT_PROPERTY_ID, IDWriteStringList**, int>)(lpVtbl[9]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), propertyID, values);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, DWRITE_FONT_PROPERTY*, uint, IDWriteFontSet**, int>)(lpVtbl[11]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), properties, propertyCount, filteredSet);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, ushort*, DWRITE_FONT_WEIGHT, DWRITE_FONT_STRETCH, DWRITE_FONT_STYLE, IDWriteFontSet**, int>)(lpVtbl[12]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), familyName, fontWeight, fontStretch, fontStyle, filteredSet);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, DWRITE_FONT_PROPERTY*, uint, int, IDWriteFontSet1**, int>)(lpVtbl[15]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), properties, propertyCount, selectAnyProperty, filteredFontSet);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, uint*, uint, IDWriteFontSet1**, int>)(lpVtbl[17]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), indices, indexCount, filteredFontSet);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, DWRITE_FONT_PROPERTY*, uint, int, uint*, uint, uint*, int>)(lpVtbl[18]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), properties, propertyCount, selectAnyProperty, indices, maxIndexCount, actualIndexCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, DWRITE_FONT_AXIS_RANGE*, uint, int, uint*, uint, uint*, int>)(lpVtbl[19]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontAxisRanges, fontAxisRangeCount, selectAnyRange, indices, maxIndexCount, actualIndexCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, DWRITE_FONT_AXIS_RANGE*, uint, uint*, int>)(lpVtbl[20]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDWriteFontSet2*, uint, DWRITE_FONT_AXIS_RANGE*, uint, uint*, int>)(lpVtbl[21]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), listIndex, fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
        }
