...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1DrawInfo
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID2D1DrawInfo*, int, void>)(lpVtbl[5]))((ID2D1DrawInfo*)Unsafe.AsPointer(ref this), isCached);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1DrawInfo*, ID2D1VertexBuffer*, D2D1_VERTEX_OPTIONS, D2D1_BLEND_DESCRIPTION*, D2D1_VERTEX_RANGE*, Guid*, int>)(lpVtbl[11]))((ID2D1DrawInfo*)Unsafe.AsPointer(ref this), vertexBuffer, vertexOptions, blendDescription, vertexRange, vertexShader);
        }
    }
}
