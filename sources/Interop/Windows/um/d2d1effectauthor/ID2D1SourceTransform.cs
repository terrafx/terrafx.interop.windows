...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1SourceTransform
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1SourceTransform*, ID2D1Bitmap1*, RECT*, D2D_POINT_2U, int>)(lpVtbl[8]))((ID2D1SourceTransform*)Unsafe.AsPointer(ref this), target, drawRect, targetOrigin);
        }
    }
}
