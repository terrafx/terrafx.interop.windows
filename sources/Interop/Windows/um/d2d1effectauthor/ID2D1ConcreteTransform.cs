...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1ConcreteTransform
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1ConcreteTransform*, D2D1_BUFFER_PRECISION, D2D1_CHANNEL_DEPTH, int>)(lpVtbl[4]))((ID2D1ConcreteTransform*)Unsafe.AsPointer(ref this), bufferPrecision, channelDepth);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetCached([NativeTypeName("BOOL")] int isCached)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1ConcreteTransform*, int, void>)(lpVtbl[5]))((ID2D1ConcreteTransform*)Unsafe.AsPointer(ref this), isCached);
        }
    }
}
