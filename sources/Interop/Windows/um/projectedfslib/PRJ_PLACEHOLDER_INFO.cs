...
namespace TerraFX.Interop
{
    public unsafe partial struct PRJ_PLACEHOLDER_INFO
    {
        ...
        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/um/projectedfslib.h:212:5)")]
        public _EaInformation_e__Struct EaInformation;

        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/um/projectedfslib.h:218:5)")]
        public _SecurityInformation_e__Struct SecurityInformation;

        [NativeTypeName("struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/um/projectedfslib.h:224:5)")]
