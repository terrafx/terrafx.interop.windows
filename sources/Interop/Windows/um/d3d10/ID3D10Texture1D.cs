...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D10Texture1D
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int Map([NativeTypeName("UINT")] uint Subresource, D3D10_MAP MapType, [NativeTypeName("UINT")] uint MapFlags, [NativeTypeName("void **")] void** ppData)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetDesc([NativeTypeName("D3D10_TEXTURE1D_DESC *")] D3D10_TEXTURE1D_DESC* pDesc)
        {
