...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISpeechRecognizerStatus
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int get_AudioStatus(ISpeechAudioStatus** AudioStatus)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int get_CurrentStreamPosition(VARIANT* pCurrentStreamPos)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int get_SupportedLanguages(VARIANT* SupportedLanguages)
        {
