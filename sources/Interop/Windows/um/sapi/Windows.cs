...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        public static SPSTATEHANDLE SPRULETRANS_TEXTBUFFER => (nint)(-1);

        [NativeTypeName("#define SPRULETRANS_WILDCARD (SPSTATEHANDLE)(-2)")]
        public static SPSTATEHANDLE SPRULETRANS_WILDCARD => (nint)(-2);

        [NativeTypeName("#define SPRULETRANS_DICTATION (SPSTATEHANDLE)(-3)")]
        public static SPSTATEHANDLE SPRULETRANS_DICTATION => (nint)(-3);
