...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D10EffectShaderVariable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetShaderDesc([NativeTypeName("UINT")] uint ShaderIndex, [NativeTypeName("D3D10_EFFECT_SHADER_DESC *")] D3D10_EFFECT_SHADER_DESC* pDesc)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetPixelShader([NativeTypeName("UINT")] uint ShaderIndex, [NativeTypeName("ID3D10PixelShader **")] ID3D10PixelShader** ppPS)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetInputSignatureElementDesc([NativeTypeName("UINT")] uint ShaderIndex, [NativeTypeName("UINT")] uint Element, [NativeTypeName("D3D10_SIGNATURE_PARAMETER_DESC *")] D3D10_SIGNATURE_PARAMETER_DESC* pDesc)
        {
