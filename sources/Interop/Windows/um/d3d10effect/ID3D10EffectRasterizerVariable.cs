...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D10EffectRasterizerVariable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [VtblIndex(25)]
        public HRESULT GetRasterizerState([NativeTypeName("UINT")] uint Index, ID3D10RasterizerState** ppRasterizerState)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [VtblIndex(26)]
        public HRESULT GetBackingStore([NativeTypeName("UINT")] uint Index, D3D10_RASTERIZER_DESC* pRasterizerDesc)
        {
