...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D10EffectRasterizerVariable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetRasterizerState([NativeTypeName("UINT")] uint Index, [NativeTypeName("ID3D10RasterizerState **")] ID3D10RasterizerState** ppRasterizerState)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetBackingStore([NativeTypeName("UINT")] uint Index, [NativeTypeName("D3D10_RASTERIZER_DESC *")] D3D10_RASTERIZER_DESC* pRasterizerDesc)
        {
