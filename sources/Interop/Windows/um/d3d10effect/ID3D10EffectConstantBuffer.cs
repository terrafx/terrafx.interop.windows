...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D10EffectConstantBuffer
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int SetConstantBuffer([NativeTypeName("ID3D10Buffer *")] ID3D10Buffer* pConstantBuffer)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int SetTextureBuffer([NativeTypeName("ID3D10ShaderResourceView *")] ID3D10ShaderResourceView* pTextureBuffer)
        {
