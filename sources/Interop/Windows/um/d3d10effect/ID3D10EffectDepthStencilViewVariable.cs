...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D10EffectDepthStencilViewVariable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int SetDepthStencilArray([NativeTypeName("ID3D10DepthStencilView **")] ID3D10DepthStencilView** ppResources, [NativeTypeName("UINT")] uint Offset, [NativeTypeName("UINT")] uint Count)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetDepthStencilArray([NativeTypeName("ID3D10DepthStencilView **")] ID3D10DepthStencilView** ppResources, [NativeTypeName("UINT")] uint Offset, [NativeTypeName("UINT")] uint Count)
        {
