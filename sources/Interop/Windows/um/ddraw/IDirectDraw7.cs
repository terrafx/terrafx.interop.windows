...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDirectDraw7
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, Guid*, void**, int>)(lpVtbl[0]))((IDirectDraw7*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, uint, IDirectDrawClipper**, IUnknown*, int>)(lpVtbl[4]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1, param2);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, uint, PALETTEENTRY*, IDirectDrawPalette**, IUnknown*, int>)(lpVtbl[5]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, DDSURFACEDESC2*, IDirectDrawSurface7**, IUnknown*, int>)(lpVtbl[6]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1, param2);
        }
...
#else
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, uint, DDSURFACEDESC2*, void*, delegate* unmanaged[Stdcall]<DDSURFACEDESC2*, void*, int>, int>)(lpVtbl[8]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
#endif
        }
...
#else
        public int EnumSurfaces([NativeTypeName("DWORD")] uint param0, [NativeTypeName("LPDDSURFACEDESC2")] DDSURFACEDESC2* param1, [NativeTypeName("LPVOID")] void* param2, [NativeTypeName("LPDDENUMSURFACESCALLBACK7")] delegate* unmanaged[Stdcall]<IDirectDrawSurface7*, DDSURFACEDESC2*, void*, int> param3)
#endif
        {
#if !NETSTANDARD2_0
...
#else
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, uint, DDSURFACEDESC2*, void*, delegate* unmanaged[Stdcall]<IDirectDrawSurface7*, DDSURFACEDESC2*, void*, int>, int>)(lpVtbl[9]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1, param2, param3);
#endif
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, DDCAPS_DX7*, DDCAPS_DX7*, int>)(lpVtbl[11]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, DDSURFACEDESC2*, int>)(lpVtbl[12]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, Guid*, int>)(lpVtbl[18]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, uint, IntPtr, int>)(lpVtbl[22]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, DDSCAPS2*, uint*, uint*, int>)(lpVtbl[23]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1, param2);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, DDDEVICEIDENTIFIER2*, uint, int>)(lpVtbl[27]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDirectDraw7*, SIZE*, uint, uint, int>)(lpVtbl[28]))((IDirectDraw7*)Unsafe.AsPointer(ref this), param0, param1, param2);
        }
