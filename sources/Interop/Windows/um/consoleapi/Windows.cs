...
#else
        public static extern int SetConsoleCtrlHandler([NativeTypeName("PHANDLER_ROUTINE")] delegate* unmanaged[Stdcall]<uint, int> HandlerRoutine, [NativeTypeName("BOOL")] int Add);
#endif
