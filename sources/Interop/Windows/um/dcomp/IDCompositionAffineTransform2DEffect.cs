...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionAffineTransform2DEffect
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionAffineTransform2DEffect*, D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE, int>)(lpVtbl[4]))((IDCompositionAffineTransform2DEffect*)Unsafe.AsPointer(ref this), interpolationMode);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionAffineTransform2DEffect*, D2D1_BORDER_MODE, int>)(lpVtbl[5]))((IDCompositionAffineTransform2DEffect*)Unsafe.AsPointer(ref this), borderMode);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionAffineTransform2DEffect*, D2D_MATRIX_3X2_F*, int>)(lpVtbl[6]))((IDCompositionAffineTransform2DEffect*)Unsafe.AsPointer(ref this), transformMatrix);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionAffineTransform2DEffect*, int, int, float, int>)(lpVtbl[7]))((IDCompositionAffineTransform2DEffect*)Unsafe.AsPointer(ref this), row, column, value);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionAffineTransform2DEffect*, int, int, IDCompositionAnimation*, int>)(lpVtbl[8]))((IDCompositionAffineTransform2DEffect*)Unsafe.AsPointer(ref this), row, column, animation);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionAffineTransform2DEffect*, float, int>)(lpVtbl[9]))((IDCompositionAffineTransform2DEffect*)Unsafe.AsPointer(ref this), sharpness);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionAffineTransform2DEffect*, IDCompositionAnimation*, int>)(lpVtbl[10]))((IDCompositionAffineTransform2DEffect*)Unsafe.AsPointer(ref this), animation);
        }
    }
}
