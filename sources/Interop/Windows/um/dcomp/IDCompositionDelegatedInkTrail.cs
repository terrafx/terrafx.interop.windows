...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionDelegatedInkTrail
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int AddTrailPoints([NativeTypeName("const DCompositionInkTrailPoint *")] DCompositionInkTrailPoint* inkPoints, [NativeTypeName("UINT")] uint inkPointsCount, [NativeTypeName("UINT *")] uint* generationId)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int AddTrailPointsWithPrediction([NativeTypeName("const DCompositionInkTrailPoint *")] DCompositionInkTrailPoint* inkPoints, [NativeTypeName("UINT")] uint inkPointsCount, [NativeTypeName("const DCompositionInkTrailPoint *")] DCompositionInkTrailPoint* predictedInkPoints, [NativeTypeName("UINT")] uint predictedInkPointsCount, [NativeTypeName("UINT *")] uint* generationId)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int RemoveTrailPoints([NativeTypeName("UINT")] uint generationId)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int StartNewTrail([NativeTypeName("const D2D1_COLOR_F &")] DXGI_RGBA* color)
        {
