...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionDesktopDevice
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDesktopDevice*, DCOMPOSITION_FRAME_STATISTICS*, int>)(lpVtbl[5]))((IDCompositionDesktopDevice*)Unsafe.AsPointer(ref this), statistics);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDesktopDevice*, uint, uint, DXGI_FORMAT, DXGI_ALPHA_MODE, IDCompositionSurface**, int>)(lpVtbl[8]))((IDCompositionDesktopDevice*)Unsafe.AsPointer(ref this), width, height, pixelFormat, alphaMode, surface);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDesktopDevice*, uint, uint, DXGI_FORMAT, DXGI_ALPHA_MODE, IDCompositionVirtualSurface**, int>)(lpVtbl[9]))((IDCompositionDesktopDevice*)Unsafe.AsPointer(ref this), initialWidth, initialHeight, pixelFormat, alphaMode, virtualSurface);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDesktopDevice*, IntPtr, int, IDCompositionTarget**, int>)(lpVtbl[24]))((IDCompositionDesktopDevice*)Unsafe.AsPointer(ref this), hwnd, topmost, target);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDesktopDevice*, IntPtr, IUnknown**, int>)(lpVtbl[25]))((IDCompositionDesktopDevice*)Unsafe.AsPointer(ref this), handle, surface);
        }
