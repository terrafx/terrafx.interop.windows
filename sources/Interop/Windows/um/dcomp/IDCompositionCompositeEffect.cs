...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionCompositeEffect
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionCompositeEffect*, D2D1_COMPOSITE_MODE, int>)(lpVtbl[4]))((IDCompositionCompositeEffect*)Unsafe.AsPointer(ref this), mode);
        }
    }
}
