...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionMatrixTransform3D
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, D2D_MATRIX_4X4_F*, int>)(lpVtbl[3]))((IDCompositionMatrixTransform3D*)Unsafe.AsPointer(ref this), matrix);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, int, int, float, int>)(lpVtbl[4]))((IDCompositionMatrixTransform3D*)Unsafe.AsPointer(ref this), row, column, value);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, int, int, IDCompositionAnimation*, int>)(lpVtbl[5]))((IDCompositionMatrixTransform3D*)Unsafe.AsPointer(ref this), row, column, animation);
        }
    }
}
