...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionSurface
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionSurface*, RECT*, Guid*, void**, POINT*, int>)(lpVtbl[3]))((IDCompositionSurface*)Unsafe.AsPointer(ref this), updateRect, iid, updateObject, updateOffset);
        }
