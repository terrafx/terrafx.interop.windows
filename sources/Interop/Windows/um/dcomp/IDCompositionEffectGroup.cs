...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionEffectGroup
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionEffectGroup*, float, int>)(lpVtbl[3]))((IDCompositionEffectGroup*)Unsafe.AsPointer(ref this), opacity);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionEffectGroup*, IDCompositionAnimation*, int>)(lpVtbl[4]))((IDCompositionEffectGroup*)Unsafe.AsPointer(ref this), animation);
        }
