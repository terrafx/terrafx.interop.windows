...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionGaussianBlurEffect
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionGaussianBlurEffect*, float, int>)(lpVtbl[4]))((IDCompositionGaussianBlurEffect*)Unsafe.AsPointer(ref this), amount);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionGaussianBlurEffect*, IDCompositionAnimation*, int>)(lpVtbl[5]))((IDCompositionGaussianBlurEffect*)Unsafe.AsPointer(ref this), animation);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionGaussianBlurEffect*, D2D1_BORDER_MODE, int>)(lpVtbl[6]))((IDCompositionGaussianBlurEffect*)Unsafe.AsPointer(ref this), mode);
        }
    }
}
