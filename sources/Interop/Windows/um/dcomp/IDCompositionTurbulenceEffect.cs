...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionTurbulenceEffect
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionTurbulenceEffect*, D2D_VECTOR_2F*, int>)(lpVtbl[4]))((IDCompositionTurbulenceEffect*)Unsafe.AsPointer(ref this), offset);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionTurbulenceEffect*, D2D_VECTOR_2F*, int>)(lpVtbl[5]))((IDCompositionTurbulenceEffect*)Unsafe.AsPointer(ref this), frequency);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionTurbulenceEffect*, D2D_VECTOR_2F*, int>)(lpVtbl[6]))((IDCompositionTurbulenceEffect*)Unsafe.AsPointer(ref this), size);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionTurbulenceEffect*, D2D1_TURBULENCE_NOISE, int>)(lpVtbl[9]))((IDCompositionTurbulenceEffect*)Unsafe.AsPointer(ref this), noise);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionTurbulenceEffect*, int, int>)(lpVtbl[10]))((IDCompositionTurbulenceEffect*)Unsafe.AsPointer(ref this), stitchable);
        }
    }
}
