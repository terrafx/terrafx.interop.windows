...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionDevice
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDevice*, DCOMPOSITION_FRAME_STATISTICS*, int>)(lpVtbl[5]))((IDCompositionDevice*)Unsafe.AsPointer(ref this), statistics);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDevice*, IntPtr, int, IDCompositionTarget**, int>)(lpVtbl[6]))((IDCompositionDevice*)Unsafe.AsPointer(ref this), hwnd, topmost, target);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDevice*, uint, uint, DXGI_FORMAT, DXGI_ALPHA_MODE, IDCompositionSurface**, int>)(lpVtbl[8]))((IDCompositionDevice*)Unsafe.AsPointer(ref this), width, height, pixelFormat, alphaMode, surface);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDevice*, uint, uint, DXGI_FORMAT, DXGI_ALPHA_MODE, IDCompositionVirtualSurface**, int>)(lpVtbl[9]))((IDCompositionDevice*)Unsafe.AsPointer(ref this), initialWidth, initialHeight, pixelFormat, alphaMode, virtualSurface);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDevice*, IntPtr, IUnknown**, int>)(lpVtbl[10]))((IDCompositionDevice*)Unsafe.AsPointer(ref this), handle, surface);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionDevice*, int*, int>)(lpVtbl[26]))((IDCompositionDevice*)Unsafe.AsPointer(ref this), pfValid);
        }
    }
}
