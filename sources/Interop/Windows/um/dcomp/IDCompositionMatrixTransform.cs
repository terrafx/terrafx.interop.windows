...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDCompositionMatrixTransform
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform*, D2D_MATRIX_3X2_F*, int>)(lpVtbl[3]))((IDCompositionMatrixTransform*)Unsafe.AsPointer(ref this), matrix);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform*, int, int, float, int>)(lpVtbl[4]))((IDCompositionMatrixTransform*)Unsafe.AsPointer(ref this), row, column, value);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform*, int, int, IDCompositionAnimation*, int>)(lpVtbl[5]))((IDCompositionMatrixTransform*)Unsafe.AsPointer(ref this), row, column, animation);
        }
    }
}
