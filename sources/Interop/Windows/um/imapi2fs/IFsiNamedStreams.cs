...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IFsiNamedStreams
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int get_Item([NativeTypeName("LONG")] int index, [NativeTypeName("IFsiFileItem2 **")] IFsiFileItem2** item)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int get_EnumNamedStreams([NativeTypeName("IEnumFsiItems **")] IEnumFsiItems** NewEnum)
        {
