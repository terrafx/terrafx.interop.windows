...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IProgressItems
    {
        ...
        [VtblIndex(8)]
        [return: NativeTypeName("HRESULT")]
        public int get_Item([NativeTypeName("long")] int Index, IProgressItem** item)
        {
        ...
        [VtblIndex(10)]
        [return: NativeTypeName("HRESULT")]
        public int ProgressItemFromBlock([NativeTypeName("ULONG")] uint block, IProgressItem** item)
        {
        ...
        [VtblIndex(11)]
        [return: NativeTypeName("HRESULT")]
        public int ProgressItemFromDescription([NativeTypeName("BSTR")] ushort* description, IProgressItem** item)
        {
        ...
        [VtblIndex(12)]
        [return: NativeTypeName("HRESULT")]
        public int get_EnumProgressItems(IEnumProgressItems** NewEnum)
        {
