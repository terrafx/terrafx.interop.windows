...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct DFileSystemImageEvents
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int Update([NativeTypeName("IDispatch *")] IDispatch* @object, [NativeTypeName("BSTR")] ushort* currentFile, [NativeTypeName("LONG")] int copiedSectors, [NativeTypeName("LONG")] int totalSectors)
        {
