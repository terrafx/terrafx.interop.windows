...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11Fence
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID3D11Fence*, SECURITY_ATTRIBUTES*, uint, ushort*, IntPtr*, int>)(lpVtbl[7]))((ID3D11Fence*)Unsafe.AsPointer(ref this), pAttributes, dwAccess, lpName, pHandle);
        }
