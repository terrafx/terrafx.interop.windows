...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11RasterizerState2
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11RasterizerState2*, D3D11_RASTERIZER_DESC*, void>)(lpVtbl[7]))((ID3D11RasterizerState2*)Unsafe.AsPointer(ref this), pDesc);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetDesc1([NativeTypeName("D3D11_RASTERIZER_DESC1 *")] D3D11_RASTERIZER_DESC1* pDesc)
        {
            ((delegate* unmanaged[Stdcall]<ID3D11RasterizerState2*, D3D11_RASTERIZER_DESC1*, void>)(lpVtbl[8]))((ID3D11RasterizerState2*)Unsafe.AsPointer(ref this), pDesc);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetDesc2([NativeTypeName("D3D11_RASTERIZER_DESC2 *")] D3D11_RASTERIZER_DESC2* pDesc)
        {
            ((delegate* unmanaged[Stdcall]<ID3D11RasterizerState2*, D3D11_RASTERIZER_DESC2*, void>)(lpVtbl[9]))((ID3D11RasterizerState2*)Unsafe.AsPointer(ref this), pDesc);
        }
    }
}
