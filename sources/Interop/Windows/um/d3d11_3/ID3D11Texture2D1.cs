...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11Texture2D1
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11Texture2D1*, D3D11_RESOURCE_DIMENSION*, void>)(lpVtbl[7]))((ID3D11Texture2D1*)Unsafe.AsPointer(ref this), pResourceDimension);
        }
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11Texture2D1*, D3D11_TEXTURE2D_DESC*, void>)(lpVtbl[10]))((ID3D11Texture2D1*)Unsafe.AsPointer(ref this), pDesc);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetDesc1([NativeTypeName("D3D11_TEXTURE2D_DESC1 *")] D3D11_TEXTURE2D_DESC1* pDesc)
        {
            ((delegate* unmanaged[Stdcall]<ID3D11Texture2D1*, D3D11_TEXTURE2D_DESC1*, void>)(lpVtbl[11]))((ID3D11Texture2D1*)Unsafe.AsPointer(ref this), pDesc);
        }
    }
}
