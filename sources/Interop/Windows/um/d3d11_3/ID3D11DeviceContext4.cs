...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11DeviceContext4
    {
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext4*, ID3D11Predicate*, int, void>)(lpVtbl[30]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), pPredicate, PredicateValue);
        }
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext4*, ID3D11CommandList*, int, void>)(lpVtbl[58]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), pCommandList, RestoreContextState);
        }
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext4*, ID3D11Predicate**, int*, void>)(lpVtbl[86]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), ppPredicate, pPredicateValue);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D11DeviceContext4*, int, ID3D11CommandList**, int>)(lpVtbl[114]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), RestoreDeferredContextState, ppCommandList);
        }
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext4*, D3D11_CONTEXT_TYPE, IntPtr, void>)(lpVtbl[144]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), ContextType, hEvent);
        }
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext4*, int, void>)(lpVtbl[145]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), HwProtectionEnable);
        }
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext4*, int*, void>)(lpVtbl[146]))((ID3D11DeviceContext4*)Unsafe.AsPointer(ref this), pHwProtectionEnable);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [VtblIndex(147)]
        [return: NativeTypeName("HRESULT")]
        public int Signal(ID3D11Fence* pFence, [NativeTypeName("UINT64")] ulong Value)
        {
        ...
        [VtblIndex(148)]
        [return: NativeTypeName("HRESULT")]
        public int Wait(ID3D11Fence* pFence, [NativeTypeName("UINT64")] ulong Value)
        {
