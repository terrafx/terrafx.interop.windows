...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11RenderTargetView1
    {
        ...
        {
            ((delegate* unmanaged[Stdcall]<ID3D11RenderTargetView1*, D3D11_RENDER_TARGET_VIEW_DESC*, void>)(lpVtbl[8]))((ID3D11RenderTargetView1*)Unsafe.AsPointer(ref this), pDesc);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetDesc1([NativeTypeName("D3D11_RENDER_TARGET_VIEW_DESC1 *")] D3D11_RENDER_TARGET_VIEW_DESC1* pDesc1)
        {
            ((delegate* unmanaged[Stdcall]<ID3D11RenderTargetView1*, D3D11_RENDER_TARGET_VIEW_DESC1*, void>)(lpVtbl[9]))((ID3D11RenderTargetView1*)Unsafe.AsPointer(ref this), pDesc1);
        }
    }
}
