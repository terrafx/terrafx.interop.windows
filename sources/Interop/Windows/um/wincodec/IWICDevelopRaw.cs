...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWICDevelopRaw
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICDevelopRaw*, WICRect*, uint, uint, byte*, int>)(lpVtbl[7]))((IWICDevelopRaw*)Unsafe.AsPointer(ref this), prc, cbStride, cbBufferSize, pbBuffer);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICDevelopRaw*, IPropertyBag2**, int>)(lpVtbl[13]))((IWICDevelopRaw*)Unsafe.AsPointer(ref this), ppCurrentParameterSet);
        }
