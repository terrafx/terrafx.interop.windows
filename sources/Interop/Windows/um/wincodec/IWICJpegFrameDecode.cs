...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWICJpegFrameDecode
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICJpegFrameDecode*, int*, int>)(lpVtbl[3]))((IWICJpegFrameDecode*)Unsafe.AsPointer(ref this), pfIndexingSupported);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICJpegFrameDecode*, uint, uint, DXGI_JPEG_AC_HUFFMAN_TABLE*, int>)(lpVtbl[6]))((IWICJpegFrameDecode*)Unsafe.AsPointer(ref this), scanIndex, tableIndex, pAcHuffmanTable);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICJpegFrameDecode*, uint, uint, DXGI_JPEG_DC_HUFFMAN_TABLE*, int>)(lpVtbl[7]))((IWICJpegFrameDecode*)Unsafe.AsPointer(ref this), scanIndex, tableIndex, pDcHuffmanTable);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<IWICJpegFrameDecode*, uint, uint, DXGI_JPEG_QUANTIZATION_TABLE*, int>)(lpVtbl[8]))((IWICJpegFrameDecode*)Unsafe.AsPointer(ref this), scanIndex, tableIndex, pQuantizationTable);
        }
