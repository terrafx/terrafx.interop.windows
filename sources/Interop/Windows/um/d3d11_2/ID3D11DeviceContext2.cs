...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11DeviceContext2
    {
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Predicate*, int, void>)(lpVtbl[30]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), pPredicate, PredicateValue);
        }
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext2*, ID3D11CommandList*, int, void>)(lpVtbl[58]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), pCommandList, RestoreContextState);
        }
        ...
        {
            ((delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Predicate**, int*, void>)(lpVtbl[86]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), ppPredicate, pPredicateValue);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D11DeviceContext2*, int, ID3D11CommandList**, int>)(lpVtbl[114]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), RestoreDeferredContextState, ppCommandList);
        }
