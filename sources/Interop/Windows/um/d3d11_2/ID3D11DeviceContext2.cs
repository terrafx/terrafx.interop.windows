...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11DeviceContext2 : ID3D11DeviceContext2.Interface
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* unmanaged<ID3D11DeviceContext2*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint> Release;

            [NativeTypeName("void (ID3D11Device **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Device**, void> GetDevice;

            [NativeTypeName("HRESULT (const GUID &, UINT *, void *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, Guid*, uint*, void*, int> GetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, UINT, const void *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, Guid*, uint, void*, int> SetPrivateData;

            [NativeTypeName("HRESULT (const GUID &, const IUnknown *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, Guid*, IUnknown*, int> SetPrivateDataInterface;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> VSSetConstantBuffers;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> PSSetShaderResources;

            [NativeTypeName("void (ID3D11PixelShader *, ID3D11ClassInstance *const *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11PixelShader*, ID3D11ClassInstance**, uint, void> PSSetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> PSSetSamplers;

            [NativeTypeName("void (ID3D11VertexShader *, ID3D11ClassInstance *const *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11VertexShader*, ID3D11ClassInstance**, uint, void> VSSetShader;

            [NativeTypeName("void (UINT, UINT, INT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, int, void> DrawIndexed;

            [NativeTypeName("void (UINT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, void> Draw;

            [NativeTypeName("HRESULT (ID3D11Resource *, UINT, D3D11_MAP, UINT, D3D11_MAPPED_SUBRESOURCE *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, D3D11_MAP, uint, D3D11_MAPPED_SUBRESOURCE*, int> Map;

            [NativeTypeName("void (ID3D11Resource *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, void> Unmap;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> PSSetConstantBuffers;

            [NativeTypeName("void (ID3D11InputLayout *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11InputLayout*, void> IASetInputLayout;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *, const UINT *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> IASetVertexBuffers;

            [NativeTypeName("void (ID3D11Buffer *, DXGI_FORMAT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Buffer*, DXGI_FORMAT, uint, void> IASetIndexBuffer;

            [NativeTypeName("void (UINT, UINT, UINT, INT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, uint, int, uint, void> DrawIndexedInstanced;

            [NativeTypeName("void (UINT, UINT, UINT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, uint, uint, void> DrawInstanced;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> GSSetConstantBuffers;

            [NativeTypeName("void (ID3D11GeometryShader *, ID3D11ClassInstance *const *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11GeometryShader*, ID3D11ClassInstance**, uint, void> GSSetShader;

            [NativeTypeName("void (D3D11_PRIMITIVE_TOPOLOGY) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, D3D_PRIMITIVE_TOPOLOGY, void> IASetPrimitiveTopology;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> VSSetShaderResources;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> VSSetSamplers;

            [NativeTypeName("void (ID3D11Asynchronous *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Asynchronous*, void> Begin;

            [NativeTypeName("void (ID3D11Asynchronous *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Asynchronous*, void> End;

            [NativeTypeName("HRESULT (ID3D11Asynchronous *, void *, UINT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Asynchronous*, void*, uint, uint, int> GetData;

            [NativeTypeName("void (ID3D11Predicate *, BOOL) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Predicate*, BOOL, void> SetPredication;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> GSSetShaderResources;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> GSSetSamplers;

            [NativeTypeName("void (UINT, ID3D11RenderTargetView *const *, ID3D11DepthStencilView *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, ID3D11RenderTargetView**, ID3D11DepthStencilView*, void> OMSetRenderTargets;
            ...
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, ID3D11RenderTargetView**, ID3D11DepthStencilView*, uint, uint, ID3D11UnorderedAccessView**, uint*, void> OMSetRenderTargetsAndUnorderedAccessViews;

            [NativeTypeName("void (ID3D11BlendState *, const FLOAT *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11BlendState*, float*, uint, void> OMSetBlendState;

            [NativeTypeName("void (ID3D11DepthStencilState *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11DepthStencilState*, uint, void> OMSetDepthStencilState;

            [NativeTypeName("void (UINT, ID3D11Buffer *const *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, ID3D11Buffer**, uint*, void> SOSetTargets;

            [NativeTypeName("void () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, void> DrawAuto;

            [NativeTypeName("void (ID3D11Buffer *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Buffer*, uint, void> DrawIndexedInstancedIndirect;

            [NativeTypeName("void (ID3D11Buffer *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Buffer*, uint, void> DrawInstancedIndirect;

            [NativeTypeName("void (UINT, UINT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, uint, void> Dispatch;

            [NativeTypeName("void (ID3D11Buffer *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Buffer*, uint, void> DispatchIndirect;

            [NativeTypeName("void (ID3D11RasterizerState *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11RasterizerState*, void> RSSetState;

            [NativeTypeName("void (UINT, const D3D11_VIEWPORT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, D3D11_VIEWPORT*, void> RSSetViewports;

            [NativeTypeName("void (UINT, const D3D11_RECT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, RECT*, void> RSSetScissorRects;

            [NativeTypeName("void (ID3D11Resource *, UINT, UINT, UINT, UINT, ID3D11Resource *, UINT, const D3D11_BOX *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, uint, uint, uint, ID3D11Resource*, uint, D3D11_BOX*, void> CopySubresourceRegion;

            [NativeTypeName("void (ID3D11Resource *, ID3D11Resource *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, ID3D11Resource*, void> CopyResource;

            [NativeTypeName("void (ID3D11Resource *, UINT, const D3D11_BOX *, const void *, UINT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, D3D11_BOX*, void*, uint, uint, void> UpdateSubresource;

            [NativeTypeName("void (ID3D11Buffer *, UINT, ID3D11UnorderedAccessView *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Buffer*, uint, ID3D11UnorderedAccessView*, void> CopyStructureCount;

            [NativeTypeName("void (ID3D11RenderTargetView *, const FLOAT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11RenderTargetView*, float*, void> ClearRenderTargetView;

            [NativeTypeName("void (ID3D11UnorderedAccessView *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11UnorderedAccessView*, uint*, void> ClearUnorderedAccessViewUint;

            [NativeTypeName("void (ID3D11UnorderedAccessView *, const FLOAT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11UnorderedAccessView*, float*, void> ClearUnorderedAccessViewFloat;

            [NativeTypeName("void (ID3D11DepthStencilView *, UINT, FLOAT, UINT8) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11DepthStencilView*, uint, float, byte, void> ClearDepthStencilView;

            [NativeTypeName("void (ID3D11ShaderResourceView *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11ShaderResourceView*, void> GenerateMips;

            [NativeTypeName("void (ID3D11Resource *, FLOAT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, float, void> SetResourceMinLOD;

            [NativeTypeName("FLOAT (ID3D11Resource *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, float> GetResourceMinLOD;

            [NativeTypeName("void (ID3D11Resource *, UINT, ID3D11Resource *, UINT, DXGI_FORMAT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, ID3D11Resource*, uint, DXGI_FORMAT, void> ResolveSubresource;

            [NativeTypeName("void (ID3D11CommandList *, BOOL) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11CommandList*, BOOL, void> ExecuteCommandList;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> HSSetShaderResources;

            [NativeTypeName("void (ID3D11HullShader *, ID3D11ClassInstance *const *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11HullShader*, ID3D11ClassInstance**, uint, void> HSSetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> HSSetSamplers;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> HSSetConstantBuffers;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> DSSetShaderResources;

            [NativeTypeName("void (ID3D11DomainShader *, ID3D11ClassInstance *const *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11DomainShader*, ID3D11ClassInstance**, uint, void> DSSetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> DSSetSamplers;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> DSSetConstantBuffers;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> CSSetShaderResources;

            [NativeTypeName("void (UINT, UINT, ID3D11UnorderedAccessView *const *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11UnorderedAccessView**, uint*, void> CSSetUnorderedAccessViews;

            [NativeTypeName("void (ID3D11ComputeShader *, ID3D11ClassInstance *const *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11ComputeShader*, ID3D11ClassInstance**, uint, void> CSSetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> CSSetSamplers;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> CSSetConstantBuffers;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> VSGetConstantBuffers;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> PSGetShaderResources;

            [NativeTypeName("void (ID3D11PixelShader **, ID3D11ClassInstance **, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11PixelShader**, ID3D11ClassInstance**, uint*, void> PSGetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> PSGetSamplers;

            [NativeTypeName("void (ID3D11VertexShader **, ID3D11ClassInstance **, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11VertexShader**, ID3D11ClassInstance**, uint*, void> VSGetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> PSGetConstantBuffers;

            [NativeTypeName("void (ID3D11InputLayout **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11InputLayout**, void> IAGetInputLayout;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **, UINT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> IAGetVertexBuffers;

            [NativeTypeName("void (ID3D11Buffer **, DXGI_FORMAT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Buffer**, DXGI_FORMAT*, uint*, void> IAGetIndexBuffer;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> GSGetConstantBuffers;

            [NativeTypeName("void (ID3D11GeometryShader **, ID3D11ClassInstance **, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11GeometryShader**, ID3D11ClassInstance**, uint*, void> GSGetShader;

            [NativeTypeName("void (D3D11_PRIMITIVE_TOPOLOGY *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, D3D_PRIMITIVE_TOPOLOGY*, void> IAGetPrimitiveTopology;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> VSGetShaderResources;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> VSGetSamplers;

            [NativeTypeName("void (ID3D11Predicate **, BOOL *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Predicate**, BOOL*, void> GetPredication;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> GSGetShaderResources;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> GSGetSamplers;

            [NativeTypeName("void (UINT, ID3D11RenderTargetView **, ID3D11DepthStencilView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, ID3D11RenderTargetView**, ID3D11DepthStencilView**, void> OMGetRenderTargets;
            ...
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, ID3D11RenderTargetView**, ID3D11DepthStencilView**, uint, uint, ID3D11UnorderedAccessView**, void> OMGetRenderTargetsAndUnorderedAccessViews;

            [NativeTypeName("void (ID3D11BlendState **, FLOAT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11BlendState**, float*, uint*, void> OMGetBlendState;

            [NativeTypeName("void (ID3D11DepthStencilState **, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11DepthStencilState**, uint*, void> OMGetDepthStencilState;

            [NativeTypeName("void (UINT, ID3D11Buffer **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, ID3D11Buffer**, void> SOGetTargets;

            [NativeTypeName("void (ID3D11RasterizerState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11RasterizerState**, void> RSGetState;

            [NativeTypeName("void (UINT *, D3D11_VIEWPORT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint*, D3D11_VIEWPORT*, void> RSGetViewports;

            [NativeTypeName("void (UINT *, D3D11_RECT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint*, RECT*, void> RSGetScissorRects;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> HSGetShaderResources;

            [NativeTypeName("void (ID3D11HullShader **, ID3D11ClassInstance **, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11HullShader**, ID3D11ClassInstance**, uint*, void> HSGetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> HSGetSamplers;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> HSGetConstantBuffers;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> DSGetShaderResources;

            [NativeTypeName("void (ID3D11DomainShader **, ID3D11ClassInstance **, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11DomainShader**, ID3D11ClassInstance**, uint*, void> DSGetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> DSGetSamplers;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> DSGetConstantBuffers;

            [NativeTypeName("void (UINT, UINT, ID3D11ShaderResourceView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11ShaderResourceView**, void> CSGetShaderResources;

            [NativeTypeName("void (UINT, UINT, ID3D11UnorderedAccessView **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11UnorderedAccessView**, void> CSGetUnorderedAccessViews;

            [NativeTypeName("void (ID3D11ComputeShader **, ID3D11ClassInstance **, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11ComputeShader**, ID3D11ClassInstance**, uint*, void> CSGetShader;

            [NativeTypeName("void (UINT, UINT, ID3D11SamplerState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11SamplerState**, void> CSGetSamplers;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, void> CSGetConstantBuffers;

            [NativeTypeName("void () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, void> ClearState;

            [NativeTypeName("void () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, void> Flush;

            [NativeTypeName("D3D11_DEVICE_CONTEXT_TYPE () __attribute__((stdcall))")]
            public new delegate* unmanaged<ID3D11DeviceContext2*, D3D11_DEVICE_CONTEXT_TYPE> GetType;

            [NativeTypeName("UINT () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint> GetContextFlags;

            [NativeTypeName("HRESULT (BOOL, ID3D11CommandList **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, BOOL, ID3D11CommandList**, int> FinishCommandList;

            [NativeTypeName("void (ID3D11Resource *, UINT, UINT, UINT, UINT, ID3D11Resource *, UINT, const D3D11_BOX *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, uint, uint, uint, ID3D11Resource*, uint, D3D11_BOX*, uint, void> CopySubresourceRegion1;

            [NativeTypeName("void (ID3D11Resource *, UINT, const D3D11_BOX *, const void *, UINT, UINT, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, D3D11_BOX*, void*, uint, uint, uint, void> UpdateSubresource1;

            [NativeTypeName("void (ID3D11Resource *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, void> DiscardResource;

            [NativeTypeName("void (ID3D11View *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11View*, void> DiscardView;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *, const UINT *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> VSSetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *, const UINT *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> HSSetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *, const UINT *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> DSSetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *, const UINT *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> GSSetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *, const UINT *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> PSSetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer *const *, const UINT *, const UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> CSSetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **, UINT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> VSGetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **, UINT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> HSGetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **, UINT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> DSGetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **, UINT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> GSGetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **, UINT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> PSGetConstantBuffers1;

            [NativeTypeName("void (UINT, UINT, ID3D11Buffer **, UINT *, UINT *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, uint, uint, ID3D11Buffer**, uint*, uint*, void> CSGetConstantBuffers1;

            [NativeTypeName("void (ID3DDeviceContextState *, ID3DDeviceContextState **) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3DDeviceContextState*, ID3DDeviceContextState**, void> SwapDeviceContextState;

            [NativeTypeName("void (ID3D11View *, const FLOAT *, const D3D11_RECT *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11View*, float*, RECT*, uint, void> ClearView;

            [NativeTypeName("void (ID3D11View *, const D3D11_RECT *, UINT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11View*, RECT*, uint, void> DiscardView1;
            ...
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, uint, D3D11_TILED_RESOURCE_COORDINATE*, D3D11_TILE_REGION_SIZE*, ID3D11Buffer*, uint, uint*, uint*, uint*, uint, int> UpdateTileMappings;
            ...
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, D3D11_TILED_RESOURCE_COORDINATE*, ID3D11Resource*, D3D11_TILED_RESOURCE_COORDINATE*, D3D11_TILE_REGION_SIZE*, uint, int> CopyTileMappings;
            ...
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, D3D11_TILED_RESOURCE_COORDINATE*, D3D11_TILE_REGION_SIZE*, ID3D11Buffer*, ulong, uint, void> CopyTiles;
            ...
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Resource*, D3D11_TILED_RESOURCE_COORDINATE*, D3D11_TILE_REGION_SIZE*, void*, uint, void> UpdateTiles;

            [NativeTypeName("HRESULT (ID3D11Buffer *, UINT64) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11Buffer*, ulong, int> ResizeTilePool;

            [NativeTypeName("void (ID3D11DeviceChild *, ID3D11DeviceChild *) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ID3D11DeviceChild*, ID3D11DeviceChild*, void> TiledResourceBarrier;

            [NativeTypeName("BOOL () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, int> IsAnnotationEnabled;

            [NativeTypeName("void (LPCWSTR, INT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ushort*, int, void> SetMarkerInt;

            [NativeTypeName("void (LPCWSTR, INT) __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, ushort*, int, void> BeginEventInt;

            [NativeTypeName("void () __attribute__((stdcall))")]
            public delegate* unmanaged<ID3D11DeviceContext2*, void> EndEvent;
        }
    }
}
