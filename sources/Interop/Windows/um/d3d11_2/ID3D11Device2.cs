...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D11Device2
    {
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, Guid*, void**, int>)(lpVtbl[0]))((ID3D11Device2*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint AddRef()
        {
            return ((delegate* stdcall<ID3D11Device2*, uint>)(lpVtbl[1]))((ID3D11Device2*)Unsafe.AsPointer(ref this));
        }
        ...
        public uint Release()
        {
            return ((delegate* stdcall<ID3D11Device2*, uint>)(lpVtbl[2]))((ID3D11Device2*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_BUFFER_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Buffer**, int>)(lpVtbl[3]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppBuffer);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_TEXTURE1D_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture1D**, int>)(lpVtbl[4]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppTexture1D);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_TEXTURE2D_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture2D**, int>)(lpVtbl[5]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppTexture2D);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_TEXTURE3D_DESC*, D3D11_SUBRESOURCE_DATA*, ID3D11Texture3D**, int>)(lpVtbl[6]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pDesc, pInitialData, ppTexture3D);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, ID3D11Resource*, D3D11_SHADER_RESOURCE_VIEW_DESC*, ID3D11ShaderResourceView**, int>)(lpVtbl[7]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pResource, pDesc, ppSRView);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, ID3D11Resource*, D3D11_UNORDERED_ACCESS_VIEW_DESC*, ID3D11UnorderedAccessView**, int>)(lpVtbl[8]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pResource, pDesc, ppUAView);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, ID3D11Resource*, D3D11_RENDER_TARGET_VIEW_DESC*, ID3D11RenderTargetView**, int>)(lpVtbl[9]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pResource, pDesc, ppRTView);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, ID3D11Resource*, D3D11_DEPTH_STENCIL_VIEW_DESC*, ID3D11DepthStencilView**, int>)(lpVtbl[10]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pResource, pDesc, ppDepthStencilView);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_INPUT_ELEMENT_DESC*, uint, void*, nuint, ID3D11InputLayout**, int>)(lpVtbl[11]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pInputElementDescs, NumElements, pShaderBytecodeWithInputSignature, BytecodeLength, ppInputLayout);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, void*, nuint, ID3D11ClassLinkage*, ID3D11GeometryShader**, int>)(lpVtbl[13]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pShaderBytecode, BytecodeLength, pClassLinkage, ppGeometryShader);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, void*, nuint, ID3D11ClassLinkage*, ID3D11PixelShader**, int>)(lpVtbl[15]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pShaderBytecode, BytecodeLength, pClassLinkage, ppPixelShader);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, void*, nuint, ID3D11ClassLinkage*, ID3D11HullShader**, int>)(lpVtbl[16]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pShaderBytecode, BytecodeLength, pClassLinkage, ppHullShader);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, void*, nuint, ID3D11ClassLinkage*, ID3D11DomainShader**, int>)(lpVtbl[17]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pShaderBytecode, BytecodeLength, pClassLinkage, ppDomainShader);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, void*, nuint, ID3D11ClassLinkage*, ID3D11ComputeShader**, int>)(lpVtbl[18]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pShaderBytecode, BytecodeLength, pClassLinkage, ppComputeShader);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, ID3D11ClassLinkage**, int>)(lpVtbl[19]))((ID3D11Device2*)Unsafe.AsPointer(ref this), ppLinkage);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_BLEND_DESC*, ID3D11BlendState**, int>)(lpVtbl[20]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pBlendStateDesc, ppBlendState);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_DEPTH_STENCIL_DESC*, ID3D11DepthStencilState**, int>)(lpVtbl[21]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pDepthStencilDesc, ppDepthStencilState);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_RASTERIZER_DESC*, ID3D11RasterizerState**, int>)(lpVtbl[22]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pRasterizerDesc, ppRasterizerState);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_SAMPLER_DESC*, ID3D11SamplerState**, int>)(lpVtbl[23]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pSamplerDesc, ppSamplerState);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_QUERY_DESC*, ID3D11Query**, int>)(lpVtbl[24]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pQueryDesc, ppQuery);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_QUERY_DESC*, ID3D11Predicate**, int>)(lpVtbl[25]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pPredicateDesc, ppPredicate);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_COUNTER_DESC*, ID3D11Counter**, int>)(lpVtbl[26]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pCounterDesc, ppCounter);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, uint, ID3D11DeviceContext**, int>)(lpVtbl[27]))((ID3D11Device2*)Unsafe.AsPointer(ref this), ContextFlags, ppDeferredContext);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, IntPtr, Guid*, void**, int>)(lpVtbl[28]))((ID3D11Device2*)Unsafe.AsPointer(ref this), hResource, ReturnedInterface, ppResource);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, DXGI_FORMAT, uint*, int>)(lpVtbl[29]))((ID3D11Device2*)Unsafe.AsPointer(ref this), Format, pFormatSupport);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, DXGI_FORMAT, uint, uint*, int>)(lpVtbl[30]))((ID3D11Device2*)Unsafe.AsPointer(ref this), Format, SampleCount, pNumQualityLevels);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void CheckCounterInfo([NativeTypeName("D3D11_COUNTER_INFO *")] D3D11_COUNTER_INFO* pCounterInfo)
        {
            ((delegate* stdcall<ID3D11Device2*, D3D11_COUNTER_INFO*, void>)(lpVtbl[31]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pCounterInfo);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_COUNTER_DESC*, D3D11_COUNTER_TYPE*, uint*, sbyte*, uint*, sbyte*, uint*, sbyte*, uint*, int>)(lpVtbl[32]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pDesc, pType, pActiveCounters, szName, pNameLength, szUnits, pUnitsLength, szDescription, pDescriptionLength);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_FEATURE, void*, uint, int>)(lpVtbl[33]))((ID3D11Device2*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, Guid*, uint*, void*, int>)(lpVtbl[34]))((ID3D11Device2*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, Guid*, uint, void*, int>)(lpVtbl[35]))((ID3D11Device2*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, Guid*, IUnknown*, int>)(lpVtbl[36]))((ID3D11Device2*)Unsafe.AsPointer(ref this), guid, pData);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public D3D_FEATURE_LEVEL GetFeatureLevel()
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D_FEATURE_LEVEL>)(lpVtbl[37]))((ID3D11Device2*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, uint>)(lpVtbl[38]))((ID3D11Device2*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, int>)(lpVtbl[39]))((ID3D11Device2*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetImmediateContext([NativeTypeName("ID3D11DeviceContext **")] ID3D11DeviceContext** ppImmediateContext)
        {
            ((delegate* stdcall<ID3D11Device2*, ID3D11DeviceContext**, void>)(lpVtbl[40]))((ID3D11Device2*)Unsafe.AsPointer(ref this), ppImmediateContext);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, uint, int>)(lpVtbl[41]))((ID3D11Device2*)Unsafe.AsPointer(ref this), RaiseFlags);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, uint>)(lpVtbl[42]))((ID3D11Device2*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetImmediateContext1([NativeTypeName("ID3D11DeviceContext1 **")] ID3D11DeviceContext1** ppImmediateContext)
        {
            ((delegate* stdcall<ID3D11Device2*, ID3D11DeviceContext1**, void>)(lpVtbl[43]))((ID3D11Device2*)Unsafe.AsPointer(ref this), ppImmediateContext);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, uint, ID3D11DeviceContext1**, int>)(lpVtbl[44]))((ID3D11Device2*)Unsafe.AsPointer(ref this), ContextFlags, ppDeferredContext);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_BLEND_DESC1*, ID3D11BlendState1**, int>)(lpVtbl[45]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pBlendStateDesc, ppBlendState);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, D3D11_RASTERIZER_DESC1*, ID3D11RasterizerState1**, int>)(lpVtbl[46]))((ID3D11Device2*)Unsafe.AsPointer(ref this), pRasterizerDesc, ppRasterizerState);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, uint, D3D_FEATURE_LEVEL*, uint, uint, Guid*, D3D_FEATURE_LEVEL*, ID3DDeviceContextState**, int>)(lpVtbl[47]))((ID3D11Device2*)Unsafe.AsPointer(ref this), Flags, pFeatureLevels, FeatureLevels, SDKVersion, EmulatedInterface, pChosenFeatureLevel, ppContextState);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, IntPtr, Guid*, void**, int>)(lpVtbl[48]))((ID3D11Device2*)Unsafe.AsPointer(ref this), hResource, returnedInterface, ppResource);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, ushort*, uint, Guid*, void**, int>)(lpVtbl[49]))((ID3D11Device2*)Unsafe.AsPointer(ref this), lpName, dwDesiredAccess, returnedInterface, ppResource);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetImmediateContext2([NativeTypeName("ID3D11DeviceContext2 **")] ID3D11DeviceContext2** ppImmediateContext)
        {
            ((delegate* stdcall<ID3D11Device2*, ID3D11DeviceContext2**, void>)(lpVtbl[50]))((ID3D11Device2*)Unsafe.AsPointer(ref this), ppImmediateContext);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, uint, ID3D11DeviceContext2**, int>)(lpVtbl[51]))((ID3D11Device2*)Unsafe.AsPointer(ref this), ContextFlags, ppDeferredContext);
        }
        ...
        {
            return ((delegate* stdcall<ID3D11Device2*, DXGI_FORMAT, uint, uint, uint*, int>)(lpVtbl[53]))((ID3D11Device2*)Unsafe.AsPointer(ref this), Format, SampleCount, Flags, pNumQualityLevels);
        }
    }
}
