...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ITfLangBarEventSink
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [VtblIndex(6)]
        public HRESULT OnModalInput([NativeTypeName("DWORD")] uint dwThreadId, [NativeTypeName("UINT")] uint uMsg, [NativeTypeName("WPARAM")] nuint wParam, [NativeTypeName("LPARAM")] nint lParam)
        {
