...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("kernel32", EntryPoint = "HeapCreate", ExactSpelling = true, SetLastError = true)]
        ...
        [DllImport("kernel32", EntryPoint = "HeapDestroy", ExactSpelling = true, SetLastError = true)]
        ...
        [DllImport("kernel32", EntryPoint = "HeapReAlloc", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("LPVOID")]
        ...
        [DllImport("kernel32", EntryPoint = "HeapSize", ExactSpelling = true, SetLastError = true)]
        ...
        [DllImport("kernel32", EntryPoint = "HeapCompact", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("SIZE_T")]
        public static extern nuint HeapCompact([NativeTypeName("HANDLE")] IntPtr hHeap, [NativeTypeName("DWORD")] uint dwFlags);

        [DllImport("kernel32", EntryPoint = "HeapSetInformation", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "HeapValidate", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "HeapSummary", ExactSpelling = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "GetProcessHeaps", ExactSpelling = true, SetLastError = true)]
        ...
        [DllImport("kernel32", EntryPoint = "HeapLock", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        public static extern int HeapLock([NativeTypeName("HANDLE")] IntPtr hHeap);

        [DllImport("kernel32", EntryPoint = "HeapUnlock", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        public static extern int HeapUnlock([NativeTypeName("HANDLE")] IntPtr hHeap);

        [DllImport("kernel32", EntryPoint = "HeapWalk", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
        ...
        [DllImport("kernel32", EntryPoint = "HeapQueryInformation", ExactSpelling = true, SetLastError = true)]
        [return: NativeTypeName("BOOL")]
