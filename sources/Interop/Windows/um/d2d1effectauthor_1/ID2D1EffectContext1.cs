...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1EffectContext1
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, D3D_FEATURE_LEVEL*, uint, D3D_FEATURE_LEVEL*, int>)(lpVtbl[5]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), featureLevels, featureLevelsCount, maximumSupportedFeatureLevel);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, uint, D2D1_BLEND_DESCRIPTION*, ID2D1BlendTransform**, int>)(lpVtbl[7]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), numInputs, blendDescription, transform);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, D2D1_EXTEND_MODE, D2D1_EXTEND_MODE, ID2D1BorderTransform**, int>)(lpVtbl[8]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), extendModeX, extendModeY, transform);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, POINT, ID2D1OffsetTransform**, int>)(lpVtbl[9]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), offset, transform);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, Guid*, int>)(lpVtbl[14]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), shaderId);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, Guid*, D2D1_RESOURCE_TEXTURE_PROPERTIES*, byte*, uint*, uint, ID2D1ResourceTexture**, int>)(lpVtbl[15]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), resourceId, resourceTextureProperties, data, strides, dataSize, resourceTexture);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, D2D1_VERTEX_BUFFER_PROPERTIES*, Guid*, D2D1_CUSTOM_VERTEX_BUFFER_PROPERTIES*, ID2D1VertexBuffer**, int>)(lpVtbl[17]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), vertexBufferProperties, resourceId, customVertexBufferProperties, buffer);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, D2D1_COLOR_SPACE, byte*, uint, ID2D1ColorContext**, int>)(lpVtbl[19]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), space, profile, profileSize, colorContext);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, IWICColorContext*, ID2D1ColorContext**, int>)(lpVtbl[21]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), wicColorContext, colorContext);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, D2D1_FEATURE, void*, uint, int>)(lpVtbl[22]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), feature, featureSupportData, featureSupportDataSize);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, D2D1_BUFFER_PRECISION, int>)(lpVtbl[23]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), bufferPrecision);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1EffectContext1*, D2D1_BUFFER_PRECISION, uint*, byte*, uint, uint*, ID2D1LookupTable3D**, int>)(lpVtbl[24]))((ID2D1EffectContext1*)Unsafe.AsPointer(ref this), precision, extents, data, dataCount, strides, lookupTable);
        }
    }
}
