...
namespace TerraFX.Interop
{
    public static unsafe partial class Windows
    {
        ...
        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DDisassemble([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] nuint SrcDataSize, [NativeTypeName("UINT")] uint Flags, [NativeTypeName("LPCSTR")] sbyte* szComments, ID3DBlob** ppDisassembly);
        ...
        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DCreateFunctionLinkingGraph([NativeTypeName("UINT")] uint uFlags, [NativeTypeName("struct ID3D11FunctionLinkingGraph **")] ID3D11FunctionLinkingGraph** ppFunctionLinkingGraph);

        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DGetTraceInstructionOffsets([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] nuint SrcDataSize, [NativeTypeName("UINT")] uint Flags, [NativeTypeName("SIZE_T")] nuint StartInstIndex, [NativeTypeName("SIZE_T")] nuint NumInsts, [NativeTypeName("SIZE_T *")] nuint* pOffsets, [NativeTypeName("SIZE_T *")] nuint* pTotalInsts);
        ...
        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DStripShader([NativeTypeName("LPCVOID")] void* pShaderBytecode, [NativeTypeName("SIZE_T")] nuint BytecodeLength, [NativeTypeName("UINT")] uint uStripFlags, ID3DBlob** ppStrippedBlob);

        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DGetBlobPart([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] nuint SrcDataSize, D3D_BLOB_PART Part, [NativeTypeName("UINT")] uint Flags, ID3DBlob** ppPart);

        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DSetBlobPart([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] nuint SrcDataSize, D3D_BLOB_PART Part, [NativeTypeName("UINT")] uint Flags, [NativeTypeName("LPCVOID")] void* pPart, [NativeTypeName("SIZE_T")] nuint PartSize, ID3DBlob** ppNewShader);

        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DCreateBlob([NativeTypeName("SIZE_T")] nuint Size, ID3DBlob** ppBlob);

        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DCompressShaders([NativeTypeName("UINT")] uint uNumShaders, D3D_SHADER_DATA* pShaderData, [NativeTypeName("UINT")] uint uFlags, ID3DBlob** ppCompressedData);

        [DllImport("d3dcompiler_47", ExactSpelling = true)]
        public static extern HRESULT D3DDecompressShaders([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] nuint SrcDataSize, [NativeTypeName("UINT")] uint uNumShaders, [NativeTypeName("UINT")] uint uStartIndex, [NativeTypeName("UINT *")] uint* pIndices, [NativeTypeName("UINT")] uint uFlags, ID3DBlob** ppShaders, [NativeTypeName("UINT *")] uint* pTotalShaders);
