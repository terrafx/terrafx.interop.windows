...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1Factory2
    {
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, Guid*, void**, int>)(lpVtbl[0]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }

        [return: NativeTypeName("ULONG")]
        public uint AddRef()
        {
            return ((delegate* stdcall<ID2D1Factory2*, uint>)(lpVtbl[1]))((ID2D1Factory2*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("ULONG")]
        public uint Release()
        {
            return ((delegate* stdcall<ID2D1Factory2*, uint>)(lpVtbl[2]))((ID2D1Factory2*)Unsafe.AsPointer(ref this));
        }

        [return: NativeTypeName("HRESULT")]
        public int ReloadSystemMetrics()
        {
            return ((delegate* stdcall<ID2D1Factory2*, int>)(lpVtbl[3]))((ID2D1Factory2*)Unsafe.AsPointer(ref this));
        }

        public void GetDesktopDpi([NativeTypeName("FLOAT *")] float* dpiX, [NativeTypeName("FLOAT *")] float* dpiY)
        {
            ((delegate* stdcall<ID2D1Factory2*, float*, float*, void>)(lpVtbl[4]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), dpiX, dpiY);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D_RECT_F*, ID2D1RectangleGeometry**, int>)(lpVtbl[5]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), rectangle, rectangleGeometry);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_ROUNDED_RECT*, ID2D1RoundedRectangleGeometry**, int>)(lpVtbl[6]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), roundedRectangle, roundedRectangleGeometry);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_ELLIPSE*, ID2D1EllipseGeometry**, int>)(lpVtbl[7]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), ellipse, ellipseGeometry);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_FILL_MODE, ID2D1Geometry**, uint, ID2D1GeometryGroup**, int>)(lpVtbl[8]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), fillMode, geometries, geometriesCount, geometryGroup);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, ID2D1Geometry*, D2D_MATRIX_3X2_F*, ID2D1TransformedGeometry**, int>)(lpVtbl[9]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), sourceGeometry, transform, transformedGeometry);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreatePathGeometry([NativeTypeName("ID2D1PathGeometry **")] ID2D1PathGeometry** pathGeometry)
        {
            return ((delegate* stdcall<ID2D1Factory2*, ID2D1PathGeometry**, int>)(lpVtbl[10]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), pathGeometry);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_STROKE_STYLE_PROPERTIES*, float*, uint, ID2D1StrokeStyle**, int>)(lpVtbl[11]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), strokeStyleProperties, dashes, dashesCount, strokeStyle);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_DRAWING_STATE_DESCRIPTION*, IDWriteRenderingParams*, ID2D1DrawingStateBlock**, int>)(lpVtbl[12]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), drawingStateDescription, textRenderingParams, drawingStateBlock);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, IWICBitmap*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1RenderTarget**, int>)(lpVtbl[13]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), target, renderTargetProperties, renderTarget);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_RENDER_TARGET_PROPERTIES*, D2D1_HWND_RENDER_TARGET_PROPERTIES*, ID2D1HwndRenderTarget**, int>)(lpVtbl[14]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), renderTargetProperties, hwndRenderTargetProperties, hwndRenderTarget);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, IDXGISurface*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1RenderTarget**, int>)(lpVtbl[15]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), dxgiSurface, renderTargetProperties, renderTarget);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_RENDER_TARGET_PROPERTIES*, ID2D1DCRenderTarget**, int>)(lpVtbl[16]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), renderTargetProperties, dcRenderTarget);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, IDXGIDevice*, ID2D1Device**, int>)(lpVtbl[17]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), dxgiDevice, d2dDevice);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_STROKE_STYLE_PROPERTIES1*, float*, uint, ID2D1StrokeStyle1**, int>)(lpVtbl[18]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), strokeStyleProperties, dashes, dashesCount, strokeStyle);
        }

        [return: NativeTypeName("HRESULT")]
        public int CreatePathGeometry([NativeTypeName("ID2D1PathGeometry1 **")] ID2D1PathGeometry1** pathGeometry)
        {
            return ((delegate* stdcall<ID2D1Factory2*, ID2D1PathGeometry1**, int>)(lpVtbl[19]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), pathGeometry);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, D2D1_DRAWING_STATE_DESCRIPTION1*, IDWriteRenderingParams*, ID2D1DrawingStateBlock1**, int>)(lpVtbl[20]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), drawingStateDescription, textRenderingParams, drawingStateBlock);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, IStream*, ID2D1GdiMetafile**, int>)(lpVtbl[21]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), metafileStream, metafile);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, Guid*, IStream*, D2D1_PROPERTY_BINDING*, uint, delegate* stdcall<IUnknown**, int>, int>)(lpVtbl[22]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), classId, propertyXml, bindings, bindingsCount, effectFactory);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, Guid*, ushort*, D2D1_PROPERTY_BINDING*, uint, delegate* stdcall<IUnknown**, int>, int>)(lpVtbl[23]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), classId, propertyXml, bindings, bindingsCount, effectFactory);
        }

        [return: NativeTypeName("HRESULT")]
        public int UnregisterEffect([NativeTypeName("const IID &")] Guid* classId)
        {
            return ((delegate* stdcall<ID2D1Factory2*, Guid*, int>)(lpVtbl[24]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), classId);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, Guid*, uint, uint*, uint*, int>)(lpVtbl[25]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), effects, effectsCount, effectsReturned, effectsRegistered);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, Guid*, ID2D1Properties**, int>)(lpVtbl[26]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), effectId, properties);
        }
        ...
        {
            return ((delegate* stdcall<ID2D1Factory2*, IDXGIDevice*, ID2D1Device1**, int>)(lpVtbl[27]))((ID2D1Factory2*)Unsafe.AsPointer(ref this), dxgiDevice, d2dDevice1);
        }
    }
}
