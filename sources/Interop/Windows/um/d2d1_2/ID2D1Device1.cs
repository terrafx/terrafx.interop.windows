...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1Device1
    {
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device1*, IWICImagingFactory*, IPrintDocumentPackageTarget*, D2D1_PRINT_CONTROL_PROPERTIES*, ID2D1PrintControl**, int>)(lpVtbl[5]))((ID2D1Device1*)Unsafe.AsPointer(ref this), wicFactory, documentTarget, printControlProperties, printControl);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetMaximumTextureMemory([NativeTypeName("UINT64")] ulong maximumInBytes)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Device1*, ulong, void>)(lpVtbl[6]))((ID2D1Device1*)Unsafe.AsPointer(ref this), maximumInBytes);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device1*, ulong>)(lpVtbl[7]))((ID2D1Device1*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void ClearResources([NativeTypeName("UINT32")] uint millisecondsSinceUse = 0)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Device1*, uint, void>)(lpVtbl[8]))((ID2D1Device1*)Unsafe.AsPointer(ref this), millisecondsSinceUse);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public D2D1_RENDERING_PRIORITY GetRenderingPriority()
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device1*, D2D1_RENDERING_PRIORITY>)(lpVtbl[9]))((ID2D1Device1*)Unsafe.AsPointer(ref this));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetRenderingPriority(D2D1_RENDERING_PRIORITY renderingPriority)
        {
            ((delegate* unmanaged[Stdcall]<ID2D1Device1*, D2D1_RENDERING_PRIORITY, void>)(lpVtbl[10]))((ID2D1Device1*)Unsafe.AsPointer(ref this), renderingPriority);
        }
        ...
        {
            return ((delegate* unmanaged[Stdcall]<ID2D1Device1*, D2D1_DEVICE_CONTEXT_OPTIONS, ID2D1DeviceContext1**, int>)(lpVtbl[11]))((ID2D1Device1*)Unsafe.AsPointer(ref this), options, deviceContext1);
        }
    }
}
