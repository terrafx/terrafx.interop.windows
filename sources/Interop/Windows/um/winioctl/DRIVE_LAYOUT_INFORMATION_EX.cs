...
namespace TerraFX.Interop
{
    public partial struct DRIVE_LAYOUT_INFORMATION_EX
    {
        ...
        public ref DRIVE_LAYOUT_INFORMATION_MBR Mbr => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Mbr, 1));

        public ref DRIVE_LAYOUT_INFORMATION_GPT Gpt => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Gpt, 1));
        ...
        public partial struct _PartitionEntry_e__FixedBuffer
        {
            ...
            public ref PARTITION_INFORMATION_EX this[int index] => ref AsSpan(int.MaxValue)[index];
