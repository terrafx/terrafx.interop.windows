...
namespace TerraFX.Interop
{
    public partial struct STORAGE_DEVICE_TIERING_DESCRIPTOR
    {
        ...
        public partial struct _Tiers_e__FixedBuffer
        {
            ...
            public unsafe ref STORAGE_TIER this[int index]
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public unsafe Span<STORAGE_TIER> AsSpan(int length)
            {
#if !NETSTANDARD2_0
                return MemoryMarshal.CreateSpan(ref e0, length);
#else
                return new Span<STORAGE_TIER>((STORAGE_TIER*)Unsafe.AsPointer(ref this), length);
#endif
            }
        }
    }
