...
namespace TerraFX.Interop
{
    ...
    public partial struct STORAGE_SPEC_VERSION
    {
        ...
        public ref _Anonymous_e__Struct._MinorVersion_e__Union MinorVersion => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.MinorVersion, 1));

        public ref ushort MajorVersion => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.MajorVersion, 1));
        ...
        public partial struct _Anonymous_e__Struct
        {
            ...
            public partial struct _MinorVersion_e__Union
            {
                ...
                public ref byte SubMinor => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.SubMinor, 1));

                public ref byte Minor => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Minor, 1));
