...
{
    public partial struct _SCM_BUS_RUNTIME_FW_ACTIVATION_INFO
    {
        ...
        [NativeTypeName("SCM_BUS_FIRMWARE_ACTIVATION_STATE")]
        public _SCM_BUS_FIRMWARE_ACTIVATION_STATE FirmwareActivationState;
