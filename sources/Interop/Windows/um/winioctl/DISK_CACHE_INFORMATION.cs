...
namespace TerraFX.Interop
{
    public partial struct DISK_CACHE_INFORMATION
    {
        ...
        public ref _Anonymous_e__Union._ScalarPrefetch_e__Struct ScalarPrefetch => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.ScalarPrefetch, 1));

        public ref _Anonymous_e__Union._BlockPrefetch_e__Struct BlockPrefetch => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.BlockPrefetch, 1));
