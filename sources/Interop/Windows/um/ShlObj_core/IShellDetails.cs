...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IShellDetails
    {
        ...
        [VtblIndex(3)]
        [return: NativeTypeName("HRESULT")]
        public int GetDetailsOf([NativeTypeName("LPCITEMIDLIST")] ITEMIDLIST* pidl, [NativeTypeName("UINT")] uint iColumn, SHELLDETAILS* pDetails)
        {
        ...
        [VtblIndex(4)]
        [return: NativeTypeName("HRESULT")]
        public int ColumnClick([NativeTypeName("UINT")] uint iColumn)
        {
