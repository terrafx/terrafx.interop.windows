...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID2D1HwndRenderTarget
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_WINDOW_STATE _CheckWindowState(
            [In] ID2D1HwndRenderTarget* This
        );
        ...
        public delegate int _Resize(
            [In] ID2D1HwndRenderTarget* This,
            [In, NativeTypeName("D2D1_SIZE_U")] D2D_SIZE_U* pixelSize
        );

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HWND")]
        public delegate IntPtr _GetHwnd(
            [In] ID2D1HwndRenderTarget* This
        );
        ...
        public D2D1_WINDOW_STATE CheckWindowState()
        {
            fixed (ID2D1HwndRenderTarget* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CheckWindowState>(lpVtbl->CheckWindowState)(
                    This
                );
            }
        }
