...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID2D1HwndRenderTarget
    {
        ...
        public delegate int _QueryInterface(ID2D1HwndRenderTarget* This, [NativeTypeName("REFIID")] Guid* riid, void** ppvObject);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _AddRef(ID2D1HwndRenderTarget* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _Release(ID2D1HwndRenderTarget* This);

        /// <summary>Retrieve the factory associated with this resource.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetFactory(ID2D1HwndRenderTarget* This, ID2D1Factory** factory);

        /// <summary>Create a D2D bitmap by copying from memory, or create uninitialized.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmap(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_SIZE_U")] D2D_SIZE_U size, [Optional] void* srcData, [NativeTypeName("UINT32")] uint pitch, D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);

        /// <summary>Create a D2D bitmap by copying a WIC bitmap.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmapFromWicBitmap(ID2D1HwndRenderTarget* This, IWICBitmapSource* wicBitmapSource, [Optional] D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSharedBitmap(ID2D1HwndRenderTarget* This, [NativeTypeName("REFIID")] Guid* riid, void* data, [Optional] D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);

        /// <summary>Creates a bitmap brush. The bitmap is scaled, rotated, skewed or tiled to fill or pen a geometry.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmapBrush(ID2D1HwndRenderTarget* This, [Optional] ID2D1Bitmap* bitmap, [Optional] D2D1_BITMAP_BRUSH_PROPERTIES* bitmapBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1BitmapBrush** bitmapBrush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSolidColorBrush(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_COLOR_F")] DXGI_RGBA* color, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1SolidColorBrush** solidColorBrush);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateGradientStopCollection(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_GRADIENT_STOP[]")] D2D1_GRADIENT_STOP* gradientStops, [NativeTypeName("UINT32")] uint gradientStopsCount, D2D1_GAMMA colorInterpolationGamma, D2D1_EXTEND_MODE extendMode, ID2D1GradientStopCollection** gradientStopCollection);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateLinearGradientBrush(ID2D1HwndRenderTarget* This, D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES* linearGradientBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1GradientStopCollection* gradientStopCollection, ID2D1LinearGradientBrush** linearGradientBrush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateRadialGradientBrush(ID2D1HwndRenderTarget* This, D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES* radialGradientBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1GradientStopCollection* gradientStopCollection, ID2D1RadialGradientBrush** radialGradientBrush);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateLayer(ID2D1HwndRenderTarget* This, [Optional, NativeTypeName("D2D1_SIZE_F")] D2D_SIZE_F* size, ID2D1Layer** layer);

        /// <summary>Create a D2D mesh.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateMesh(ID2D1HwndRenderTarget* This, ID2D1Mesh** mesh);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawLine(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F point0, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F point1, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawRectangle(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* rect, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillRectangle(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* rect, ID2D1Brush* brush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawRoundedRectangle(ID2D1HwndRenderTarget* This, D2D1_ROUNDED_RECT* roundedRect, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillRoundedRectangle(ID2D1HwndRenderTarget* This, D2D1_ROUNDED_RECT* roundedRect, ID2D1Brush* brush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawEllipse(ID2D1HwndRenderTarget* This, D2D1_ELLIPSE* ellipse, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillEllipse(ID2D1HwndRenderTarget* This, D2D1_ELLIPSE* ellipse, ID2D1Brush* brush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGeometry(ID2D1HwndRenderTarget* This, ID2D1Geometry* geometry, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillGeometry(ID2D1HwndRenderTarget* This, ID2D1Geometry* geometry, ID2D1Brush* brush, ID2D1Brush* opacityBrush = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillMesh(ID2D1HwndRenderTarget* This, ID2D1Mesh* mesh, ID2D1Brush* brush);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawTextLayout(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F origin, IDWriteTextLayout* textLayout, ID2D1Brush* defaultFillBrush, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGlyphRun(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, ID2D1Brush* foregroundBrush, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTransform(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetTransform(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetAntialiasMode(ID2D1HwndRenderTarget* This, D2D1_ANTIALIAS_MODE antialiasMode);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_ANTIALIAS_MODE _GetAntialiasMode(ID2D1HwndRenderTarget* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTextAntialiasMode(ID2D1HwndRenderTarget* This, D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_TEXT_ANTIALIAS_MODE _GetTextAntialiasMode(ID2D1HwndRenderTarget* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTextRenderingParams(ID2D1HwndRenderTarget* This, IDWriteRenderingParams* textRenderingParams = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetTextRenderingParams(ID2D1HwndRenderTarget* This, IDWriteRenderingParams** textRenderingParams);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTags(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_TAG")] ulong tag1, [NativeTypeName("D2D1_TAG")] ulong tag2);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetTags(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_TAG")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG")] ulong* tag2 = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PushLayer(ID2D1HwndRenderTarget* This, D2D1_LAYER_PARAMETERS* layerParameters, ID2D1Layer* layer = null);

        /// <summary>Ends a layer that was defined with particular layer resources.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PopLayer(ID2D1HwndRenderTarget* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _Flush(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_TAG")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG")] ulong* tag2 = null);

        /// <summary>Gets the current drawing state and saves it into the supplied IDrawingStatckBlock.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SaveDrawingState(ID2D1HwndRenderTarget* This, ID2D1DrawingStateBlock* drawingStateBlock);

        /// <summary>Copies the state stored in the block interface.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _RestoreDrawingState(ID2D1HwndRenderTarget* This, ID2D1DrawingStateBlock* drawingStateBlock);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PushAxisAlignedClip(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* clipRect, D2D1_ANTIALIAS_MODE antialiasMode);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PopAxisAlignedClip(ID2D1HwndRenderTarget* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _Clear(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_COLOR_F")] DXGI_RGBA* clearColor = null);

        /// <summary>Start drawing on this render target. Draw calls can only be issued between a BeginDraw and EndDraw call.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _BeginDraw(ID2D1HwndRenderTarget* This);

        /// <summary>Ends drawing on the render target, error results can be retrieved at this time, or when calling flush.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _EndDraw(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_TAG")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG")] ulong* tag2 = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_PIXEL_FORMAT* _GetPixelFormat(ID2D1HwndRenderTarget* This, D2D1_PIXEL_FORMAT* _result);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetDpi(ID2D1HwndRenderTarget* This, [NativeTypeName("FLOAT")] float dpiX, [NativeTypeName("FLOAT")] float dpiY);

        /// <summary>Return the current DPI from the target.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetDpi(ID2D1HwndRenderTarget* This, [NativeTypeName("FLOAT")] float* dpiX, [NativeTypeName("FLOAT")] float* dpiY);

        /// <summary>Returns the size of the render target in DIPs.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("D2D1_SIZE_F")]
        public delegate D2D_SIZE_F* _GetSize(ID2D1HwndRenderTarget* This, D2D_SIZE_F* _result);

        /// <summary>Returns the size of the render target in pixels.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("D2D1_SIZE_U")]
        public delegate D2D_SIZE_U* _GetPixelSize(ID2D1HwndRenderTarget* This, D2D_SIZE_U* _result);
        ...
        public delegate uint _GetMaximumBitmapSize(ID2D1HwndRenderTarget* This);
        ...
        public delegate int _IsSupported(ID2D1HwndRenderTarget* This, D2D1_RENDER_TARGET_PROPERTIES* renderTargetProperties);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_WINDOW_STATE _CheckWindowState(ID2D1HwndRenderTarget* This);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _Resize(ID2D1HwndRenderTarget* This, [NativeTypeName("D2D1_SIZE_U")] D2D_SIZE_U* pixelSize);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HWND")]
        public delegate IntPtr _GetHwnd(ID2D1HwndRenderTarget* This);
        ...
        public D2D1_WINDOW_STATE CheckWindowState()
        {
            fixed (ID2D1HwndRenderTarget* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CheckWindowState>(lpVtbl->CheckWindowState)(This);
            }
        }

        [return: NativeTypeName("HRESULT")]
        public int Resize([NativeTypeName("D2D1_SIZE_U")] D2D_SIZE_U* pixelSize)
        {
            fixed (ID2D1HwndRenderTarget* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_Resize>(lpVtbl->Resize)(This, pixelSize);
            }
        }
        ...
        public IntPtr GetHwnd()
        {
            fixed (ID2D1HwndRenderTarget* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_GetHwnd>(lpVtbl->GetHwnd)(This);
            }
        }
