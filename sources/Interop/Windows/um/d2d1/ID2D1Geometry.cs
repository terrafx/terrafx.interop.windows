...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1Geometry
    {
        ...
        {
            return ((delegate* unmanaged<ID2D1Geometry*, D2D_POINT_2F, float, ID2D1StrokeStyle*, D2D_MATRIX_3X2_F*, float, int*, int>)(lpVtbl[6]))((ID2D1Geometry*)Unsafe.AsPointer(ref this), point, strokeWidth, strokeStyle, worldTransform, flatteningTolerance, contains);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1Geometry*, D2D_POINT_2F, D2D_MATRIX_3X2_F*, float, int*, int>)(lpVtbl[7]))((ID2D1Geometry*)Unsafe.AsPointer(ref this), point, worldTransform, flatteningTolerance, contains);
        }
