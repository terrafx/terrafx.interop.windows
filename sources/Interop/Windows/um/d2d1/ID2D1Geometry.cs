...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1Geometry
    {
        ...
        public partial struct Vtbl
        {
            ...
            public delegate* stdcall<ID2D1Geometry*, Guid*, void**, int> QueryInterface;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Geometry*, uint> AddRef;

            [NativeTypeName("ULONG () __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Geometry*, uint> Release;

            [NativeTypeName("void (ID2D1Factory **) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Geometry*, ID2D1Factory**, void> GetFactory;

            [NativeTypeName("HRESULT (const D2D1_MATRIX_3X2_F *, D2D1_RECT_F *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Geometry*, D2D_MATRIX_3X2_F*, D2D_RECT_F*, int> GetBounds;
            ...
            public delegate* stdcall<ID2D1Geometry*, float, ID2D1StrokeStyle*, D2D_MATRIX_3X2_F*, float, D2D_RECT_F*, int> GetWidenedBounds;
            ...
            public delegate* stdcall<ID2D1Geometry*, D2D_POINT_2F, float, ID2D1StrokeStyle*, D2D_MATRIX_3X2_F*, float, int*, int> StrokeContainsPoint;
            ...
            public delegate* stdcall<ID2D1Geometry*, D2D_POINT_2F, D2D_MATRIX_3X2_F*, float, int*, int> FillContainsPoint;
            ...
            public delegate* stdcall<ID2D1Geometry*, ID2D1Geometry*, D2D_MATRIX_3X2_F*, float, D2D1_GEOMETRY_RELATION*, int> CompareWithGeometry;
            ...
            public delegate* stdcall<ID2D1Geometry*, D2D1_GEOMETRY_SIMPLIFICATION_OPTION, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> Simplify;
            ...
            public delegate* stdcall<ID2D1Geometry*, D2D_MATRIX_3X2_F*, float, ID2D1TessellationSink*, int> Tessellate;
            ...
            public delegate* stdcall<ID2D1Geometry*, ID2D1Geometry*, D2D1_COMBINE_MODE, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> CombineWithGeometry;
            ...
            public delegate* stdcall<ID2D1Geometry*, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> Outline;

            [NativeTypeName("HRESULT (const D2D1_MATRIX_3X2_F *, FLOAT, FLOAT *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Geometry*, D2D_MATRIX_3X2_F*, float, float*, int> ComputeArea;

            [NativeTypeName("HRESULT (const D2D1_MATRIX_3X2_F *, FLOAT, FLOAT *) const __attribute__((nothrow)) __attribute__((stdcall))")]
            public delegate* stdcall<ID2D1Geometry*, D2D_MATRIX_3X2_F*, float, float*, int> ComputeLength;
            ...
            public delegate* stdcall<ID2D1Geometry*, float, D2D_MATRIX_3X2_F*, float, D2D_POINT_2F*, D2D_POINT_2F*, int> ComputePointAtLength;
            ...
            public delegate* stdcall<ID2D1Geometry*, float, ID2D1StrokeStyle*, D2D_MATRIX_3X2_F*, float, ID2D1SimplifiedGeometrySink*, int> Widen;
        }
    }
}
