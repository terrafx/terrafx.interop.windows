...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1RoundedRectangleGeometry
    {
        ...
        {
            return ((delegate* unmanaged<ID2D1RoundedRectangleGeometry*, D2D_POINT_2F, D2D_MATRIX_3X2_F*, float, BOOL*, int>)(lpVtbl[7]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), point, worldTransform, flatteningTolerance, contains);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1RoundedRectangleGeometry*, D2D_MATRIX_3X2_F*, float, ID2D1TessellationSink*, int>)(lpVtbl[10]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), worldTransform, flatteningTolerance, tessellationSink);
        }
        ...
        {
            return ((delegate* unmanaged<ID2D1RoundedRectangleGeometry*, D2D_MATRIX_3X2_F*, float, float*, int>)(lpVtbl[14]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), worldTransform, flatteningTolerance, length);
        }
