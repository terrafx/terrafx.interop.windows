...
namespace TerraFX.Interop
{
    public partial struct VIDEOINFOHEADER2
    {
        ...
        public unsafe ref uint dwControlFlags
        {
...
#else
                return ref ((_Anonymous_e__Union*)Unsafe.AsPointer(ref Anonymous))->dwControlFlags;
#endif
            }
        }

        public unsafe ref uint dwReserved1
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
...
#else
                return ref ((_Anonymous_e__Union*)Unsafe.AsPointer(ref Anonymous))->dwReserved1;
#endif
            }
        }
