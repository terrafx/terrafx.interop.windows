...
namespace TerraFX.Interop
{
    public unsafe partial struct AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE : IEquatable<AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE>
    {
        ...
        public static AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE INVALID_HANDLE_VALUE => new AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE(-1);
        ...
        public static implicit operator byte(AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE value) => (byte)(value.Value);
        ...
        public static implicit operator short(AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE value) => (short)(value.Value);
        ...
        public static implicit operator int(AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE value) => (int)(value.Value);
        ...
        public static implicit operator sbyte(AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE value) => (sbyte)(value.Value);
        ...
        public static implicit operator ushort(AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE value) => (ushort)(value.Value);
        ...
        public static implicit operator uint(AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE value) => (uint)(value.Value);
