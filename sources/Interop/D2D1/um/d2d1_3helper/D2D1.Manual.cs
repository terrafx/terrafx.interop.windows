...
// Ported from um/d2d1_3helper.h in the Windows SDK for Windows 10.0.18362.0
...
namespace TerraFX.Interop
{
    public static unsafe partial class D2D1
    {
        ...
        public static D2D1_INK_BEZIER_SEGMENT InkBezierSegment([NativeTypeName("const D2D1_INK_POINT &")] in D2D1_INK_POINT point1, [NativeTypeName("const D2D1_INK_POINT &")] in D2D1_INK_POINT point2, [NativeTypeName("const D2D1_INK_POINT &")] in D2D1_INK_POINT point3)
        {
        ...
        public static D2D1_INK_STYLE_PROPERTIES InkStyleProperties(D2D1_INK_NIB_SHAPE nibShape, [NativeTypeName("const D2D1_MATRIX_3X2_F &")] in D2D_MATRIX_3X2_F nibTransform)
        {
        ...
        public static D2D1_SIMPLE_COLOR_PROFILE SimpleColorProfile([NativeTypeName("const D2D1_POINT_2F &")] in D2D_POINT_2F redPrimary, [NativeTypeName("const D2D1_POINT_2F &")] in D2D_POINT_2F greenPrimary, [NativeTypeName("const D2D1_POINT_2F &")] in D2D_POINT_2F bluePrimary, [NativeTypeName("const D2D1_GAMMA1")] D2D1_GAMMA1 gamma, [NativeTypeName("const D2D1_POINT_2F &")] in D2D_POINT_2F whitePointXZ)
        {
