...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID2D1EffectContext
    {
        ...
        public delegate int _QueryInterface(ID2D1EffectContext* This, [NativeTypeName("REFIID")] Guid* riid, void** ppvObject);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _AddRef(ID2D1EffectContext* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _Release(ID2D1EffectContext* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetDpi(ID2D1EffectContext* This, [NativeTypeName("FLOAT")] float* dpiX, [NativeTypeName("FLOAT")] float* dpiY);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateEffect(ID2D1EffectContext* This, [NativeTypeName("REFCLSID")] Guid* effectId, ID2D1Effect** effect);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetMaximumSupportedFeatureLevel(ID2D1EffectContext* This, [NativeTypeName("D3D_FEATURE_LEVEL[]")] D3D_FEATURE_LEVEL* featureLevels, [NativeTypeName("UINT32")] uint featureLevelsCount, D3D_FEATURE_LEVEL* maximumSupportedFeatureLevel);

        /// <summary>Create a transform node from the passed in effect.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateTransformNodeFromEffect(ID2D1EffectContext* This, ID2D1Effect* effect, ID2D1TransformNode** transformNode);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBlendTransform(ID2D1EffectContext* This, [NativeTypeName("UINT32")] uint numInputs, D2D1_BLEND_DESCRIPTION* blendDescription, ID2D1BlendTransform** transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBorderTransform(ID2D1EffectContext* This, D2D1_EXTEND_MODE extendModeX, D2D1_EXTEND_MODE extendModeY, ID2D1BorderTransform** transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateOffsetTransform(ID2D1EffectContext* This, [NativeTypeName("D2D1_POINT_2L")] POINT offset, ID2D1OffsetTransform** transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBoundsAdjustmentTransform(ID2D1EffectContext* This, [NativeTypeName("D2D1_RECT_L")] RECT* outputRectangle, ID2D1BoundsAdjustmentTransform** transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _LoadPixelShader(ID2D1EffectContext* This, [NativeTypeName("REFGUID")] Guid* shaderId, [NativeTypeName("BYTE[]")] byte* shaderBuffer, [NativeTypeName("UINT32")] uint shaderBufferCount);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _LoadVertexShader(ID2D1EffectContext* This, [NativeTypeName("REFGUID")] Guid* resourceId, [NativeTypeName("BYTE[]")] byte* shaderBuffer, [NativeTypeName("UINT32")] uint shaderBufferCount);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _LoadComputeShader(ID2D1EffectContext* This, [NativeTypeName("REFGUID")] Guid* resourceId, [NativeTypeName("BYTE[]")]  byte* shaderBuffer, [NativeTypeName("UINT32")] uint shaderBufferCount);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("BOOL")]
        public delegate int _IsShaderLoaded(ID2D1EffectContext* This, [NativeTypeName("REFGUID")] Guid* shaderId);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateResourceTexture(ID2D1EffectContext* This, [Optional, NativeTypeName("GUID")] Guid* resourceId, D2D1_RESOURCE_TEXTURE_PROPERTIES* resourceTextureProperties, [Optional, NativeTypeName("BYTE[]")] byte* data, [Optional, NativeTypeName("UINT32[]")] uint* strides, [NativeTypeName("UINT32")] uint dataSize, ID2D1ResourceTexture** resourceTexture);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _FindResourceTexture(ID2D1EffectContext* This, [NativeTypeName("GUID")] Guid* resourceId, ID2D1ResourceTexture** resourceTexture);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateVertexBuffer(ID2D1EffectContext* This, D2D1_VERTEX_BUFFER_PROPERTIES* vertexBufferProperties, [Optional, NativeTypeName("GUID")] Guid* resourceId, [Optional] D2D1_CUSTOM_VERTEX_BUFFER_PROPERTIES* customVertexBufferProperties, ID2D1VertexBuffer** buffer);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _FindVertexBuffer(ID2D1EffectContext* This, [NativeTypeName("GUID")] Guid* resourceId, ID2D1VertexBuffer** buffer);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContext(ID2D1EffectContext* This, D2D1_COLOR_SPACE space, [Optional, NativeTypeName("BYTE[]")] byte* profile, [NativeTypeName("UINT32")] uint profileSize, ID2D1ColorContext** colorContext);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContextFromFilename(ID2D1EffectContext* This, [NativeTypeName("PCWSTR")] ushort* filename, ID2D1ColorContext** colorContext);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContextFromWicColorContext(ID2D1EffectContext* This, IWICColorContext* wicColorContext, ID2D1ColorContext** colorContext);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CheckFeatureSupport(ID2D1EffectContext* This, D2D1_FEATURE feature, void* featureSupportData, [NativeTypeName("UINT32")] uint featureSupportDataSize);

        /// <summary>Indicates whether the buffer precision is supported by D2D.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("BOOL")]
        public delegate int _IsBufferPrecisionSupported(ID2D1EffectContext* This, D2D1_BUFFER_PRECISION bufferPrecision);
