...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID2D1DrawingStateBlock
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTextRenderingParams(ID2D1DrawingStateBlock* pThis, [NativeTypeName("IDWriteRenderingParams *")] IDWriteRenderingParams* textRenderingParams);
