...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID2D1Factory3
    {
        ...
        public delegate int _QueryInterface(ID2D1Factory3* This, [NativeTypeName("REFIID")] Guid* riid, void** ppvObject);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _AddRef(ID2D1Factory3* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _Release(ID2D1Factory3* This);

        /// <summary>Cause the factory to refresh any system metrics that it might have been snapped on factory creation.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _ReloadSystemMetrics(ID2D1Factory3* This);

        /// <summary>Retrieves the current desktop DPI. To refresh this, call ReloadSystemMetrics.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetDesktopDpi(ID2D1Factory3* This, [NativeTypeName("FLOAT")] float* dpiX, [NativeTypeName("FLOAT")] float* dpiY);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateRectangleGeometry(ID2D1Factory3* This, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* rectangle, ID2D1RectangleGeometry** rectangleGeometry);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateRoundedRectangleGeometry(ID2D1Factory3* This, D2D1_ROUNDED_RECT* roundedRectangle, ID2D1RoundedRectangleGeometry** roundedRectangleGeometry);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateEllipseGeometry(ID2D1Factory3* This, D2D1_ELLIPSE* ellipse, ID2D1EllipseGeometry** ellipseGeometry);

        /// <summary>Create a geometry which holds other geometries.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateGeometryGroup(ID2D1Factory3* This, D2D1_FILL_MODE fillMode, [NativeTypeName("ID2D1Geometry*[]")] ID2D1Geometry** geometries, [NativeTypeName("UINT32")] uint geometriesCount, ID2D1GeometryGroup** geometryGroup);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateTransformedGeometry(ID2D1Factory3* This, ID2D1Geometry* sourceGeometry, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* transform, ID2D1TransformedGeometry** transformedGeometry);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreatePathGeometry(ID2D1Factory3* This, ID2D1PathGeometry** pathGeometry);

        /// <summary>Allows a non-default stroke style to be specified for a given geometry at draw time.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateStrokeStyle(ID2D1Factory3* This, D2D1_STROKE_STYLE_PROPERTIES* strokeStyleProperties, [Optional, NativeTypeName("FLOAT[]")] float* dashes, [NativeTypeName("UINT32")] uint dashesCount, ID2D1StrokeStyle** strokeStyle);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDrawingStateBlock(ID2D1Factory3* This, [Optional] D2D1_DRAWING_STATE_DESCRIPTION* drawingStateDescription, [Optional] IDWriteRenderingParams* textRenderingParams, ID2D1DrawingStateBlock** drawingStateBlock);

        /// <summary>Creates a render target which is a source of bitmaps.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateWicBitmapRenderTarget(ID2D1Factory3* This, IWICBitmap* target, D2D1_RENDER_TARGET_PROPERTIES* renderTargetProperties, ID2D1RenderTarget** renderTarget);

        /// <summary>Creates a render target that appears on the display.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateHwndRenderTarget(ID2D1Factory3* This, D2D1_RENDER_TARGET_PROPERTIES* renderTargetProperties, D2D1_HWND_RENDER_TARGET_PROPERTIES* hwndRenderTargetProperties, ID2D1HwndRenderTarget** hwndRenderTarget);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDxgiSurfaceRenderTarget(ID2D1Factory3* This, IDXGISurface* dxgiSurface, D2D1_RENDER_TARGET_PROPERTIES* renderTargetProperties, ID2D1RenderTarget** renderTarget);

        /// <summary>Creates a render target that draws to a GDI device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDCRenderTarget(ID2D1Factory3* This, D2D1_RENDER_TARGET_PROPERTIES* renderTargetProperties, ID2D1DCRenderTarget** dcRenderTarget);

        /// <summary>This creates a new Direct2D device from the given IDXGIDevice.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDevice(ID2D1Factory3* This, IDXGIDevice* dxgiDevice, ID2D1Device** d2dDevice);

        /// <summary>This creates a stroke style with the ability to preserve stroke width in various ways.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateStrokeStyle1(ID2D1Factory3* This, D2D1_STROKE_STYLE_PROPERTIES1* strokeStyleProperties, [Optional, NativeTypeName("FLOAT[]")] float* dashes, [NativeTypeName("UINT32")] uint dashesCount, ID2D1StrokeStyle1** strokeStyle);

        /// <summary>Creates a path geometry with new operational methods.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreatePathGeometry1(ID2D1Factory3* This, ID2D1PathGeometry1** pathGeometry);

        /// <summary>Creates a new drawing state block, this can be used in subsequent SaveDrawingState and RestoreDrawingState operations on the render target.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDrawingStateBlock1(ID2D1Factory3* This, [Optional] D2D1_DRAWING_STATE_DESCRIPTION1* drawingStateDescription, [Optional] IDWriteRenderingParams* textRenderingParams, ID2D1DrawingStateBlock1** drawingStateBlock);

        /// <summary>Creates a new GDI metafile.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateGdiMetafile(ID2D1Factory3* This, IStream* metafileStream, ID2D1GdiMetafile** metafile);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _RegisterEffectFromStream(ID2D1Factory3* This, [NativeTypeName("REFCLSID")] Guid* classId, IStream* propertyXml, [Optional] D2D1_PROPERTY_BINDING* bindings, [NativeTypeName("UINT32")] uint bindingsCount, PD2D1_EFFECT_FACTORY effectFactory);

        /// <summary>This globally registers the given effect. The effect can later be instantiated by using the registered class id. The effect registration is reference counted.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _RegisterEffectFromString(ID2D1Factory3* This, [NativeTypeName("REFCLSID")] Guid* classId, [NativeTypeName("PCWSTR")] ushort* propertyXml, [Optional, NativeTypeName("D2D1_PROPERTY_BINDING[]")] D2D1_PROPERTY_BINDING* bindings, [NativeTypeName("UINT32")] uint bindingsCount, PD2D1_EFFECT_FACTORY effectFactory);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _UnregisterEffect(ID2D1Factory3* This, [NativeTypeName("REFCLSID")] Guid* classId);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetRegisteredEffects(ID2D1Factory3* This, [Optional, NativeTypeName("CLSID[]")] Guid* effects, [NativeTypeName("UINT32")] uint effectsCount, [NativeTypeName("UINT32")] uint* effectsReturned = null, [NativeTypeName("UINT32")] uint* effectsRegistered = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetEffectProperties(ID2D1Factory3* This, [NativeTypeName("REFCLSID")] Guid* effectId, ID2D1Properties** properties);

        /// <summary>This creates a new Direct2D device from the given IDXGIDevice.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDevice1(ID2D1Factory3* This, IDXGIDevice* dxgiDevice, ID2D1Device1** d2dDevice1);

        /// <summary>This creates a new Direct2D device from the given IDXGIDevice.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDevice2(ID2D1Factory3* This, IDXGIDevice* dxgiDevice, ID2D1Device2** d2dDevice2);
