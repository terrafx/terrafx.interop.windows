...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID2D1DeviceContext5
    {
        ...
        public delegate int _QueryInterface(ID2D1DeviceContext5* This, [NativeTypeName("REFIID")] Guid* riid, void** ppvObject);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _AddRef(ID2D1DeviceContext5* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _Release(ID2D1DeviceContext5* This);

        /// <summary>Retrieve the factory associated with this resource.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetFactory(ID2D1DeviceContext5* This, ID2D1Factory** factory);

        /// <summary>Create a D2D bitmap by copying from memory, or create uninitialized.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmap(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_SIZE_U")] D2D_SIZE_U size, [Optional] void* srcData, [NativeTypeName("UINT32")] uint pitch, D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);

        /// <summary>Create a D2D bitmap by copying a WIC bitmap.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmapFromWicBitmap(ID2D1DeviceContext5* This, IWICBitmapSource* wicBitmapSource, [Optional] D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSharedBitmap(ID2D1DeviceContext5* This, [NativeTypeName("REFIID")] Guid* riid, void* data, [Optional] D2D1_BITMAP_PROPERTIES* bitmapProperties, ID2D1Bitmap** bitmap);

        /// <summary>Creates a bitmap brush. The bitmap is scaled, rotated, skewed or tiled to fill or pen a geometry.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmapBrush(ID2D1DeviceContext5* This, [Optional] ID2D1Bitmap* bitmap, [Optional] D2D1_BITMAP_BRUSH_PROPERTIES* bitmapBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1BitmapBrush** bitmapBrush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSolidColorBrush(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_COLOR_F")] DXGI_RGBA* color, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1SolidColorBrush** solidColorBrush);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateGradientStopCollection(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_GRADIENT_STOP[]")] D2D1_GRADIENT_STOP* gradientStops, [NativeTypeName("UINT32")] uint gradientStopsCount, D2D1_GAMMA colorInterpolationGamma, D2D1_EXTEND_MODE extendMode, ID2D1GradientStopCollection** gradientStopCollection);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateLinearGradientBrush(ID2D1DeviceContext5* This, D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES* linearGradientBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1GradientStopCollection* gradientStopCollection, ID2D1LinearGradientBrush** linearGradientBrush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateRadialGradientBrush(ID2D1DeviceContext5* This, D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES* radialGradientBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1GradientStopCollection* gradientStopCollection, ID2D1RadialGradientBrush** radialGradientBrush);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateLayer(ID2D1DeviceContext5* This, [Optional, NativeTypeName("D2D1_SIZE_F")] D2D_SIZE_F* size, ID2D1Layer** layer);

        /// <summary>Create a D2D mesh.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateMesh(ID2D1DeviceContext5* This, ID2D1Mesh** mesh);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawLine(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F point0, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F point1, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawRectangle(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* rect, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillRectangle(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* rect, ID2D1Brush* brush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawRoundedRectangle(ID2D1DeviceContext5* This, D2D1_ROUNDED_RECT* roundedRect, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillRoundedRectangle(ID2D1DeviceContext5* This, D2D1_ROUNDED_RECT* roundedRect, ID2D1Brush* brush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawEllipse(ID2D1DeviceContext5* This, D2D1_ELLIPSE* ellipse, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillEllipse(ID2D1DeviceContext5* This, D2D1_ELLIPSE* ellipse, ID2D1Brush* brush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGeometry(ID2D1DeviceContext5* This, ID2D1Geometry* geometry, ID2D1Brush* brush, [NativeTypeName("FLOAT")] float strokeWidth = 1.0f, ID2D1StrokeStyle* strokeStyle = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillGeometry(ID2D1DeviceContext5* This, ID2D1Geometry* geometry, ID2D1Brush* brush, ID2D1Brush* opacityBrush = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillMesh(ID2D1DeviceContext5* This, ID2D1Mesh* mesh, ID2D1Brush* brush);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawTextLayout(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F origin, IDWriteTextLayout* textLayout, ID2D1Brush* defaultFillBrush, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGlyphRun(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, ID2D1Brush* foregroundBrush, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTransform(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetTransform(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* transform);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetAntialiasMode(ID2D1DeviceContext5* This, D2D1_ANTIALIAS_MODE antialiasMode);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_ANTIALIAS_MODE _GetAntialiasMode(ID2D1DeviceContext5* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTextAntialiasMode(ID2D1DeviceContext5* This, D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_TEXT_ANTIALIAS_MODE _GetTextAntialiasMode(ID2D1DeviceContext5* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTextRenderingParams(ID2D1DeviceContext5* This, IDWriteRenderingParams* textRenderingParams = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetTextRenderingParams(ID2D1DeviceContext5* This, IDWriteRenderingParams** textRenderingParams);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTags(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_TAG")] ulong tag1, [NativeTypeName("D2D1_TAG")] ulong tag2);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetTags(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_TAG")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG")] ulong* tag2 = null);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PushLayer(ID2D1DeviceContext5* This, D2D1_LAYER_PARAMETERS* layerParameters, ID2D1Layer* layer = null);

        /// <summary>Ends a layer that was defined with particular layer resources.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PopLayer(ID2D1DeviceContext5* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _Flush(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_TAG")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG")] ulong* tag2 = null);

        /// <summary>Gets the current drawing state and saves it into the supplied IDrawingStatckBlock.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SaveDrawingState(ID2D1DeviceContext5* This, ID2D1DrawingStateBlock* drawingStateBlock);

        /// <summary>Copies the state stored in the block interface.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _RestoreDrawingState(ID2D1DeviceContext5* This, ID2D1DrawingStateBlock* drawingStateBlock);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PushAxisAlignedClip(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* clipRect, D2D1_ANTIALIAS_MODE antialiasMode);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PopAxisAlignedClip(ID2D1DeviceContext5* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _Clear(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_COLOR_F")] DXGI_RGBA* clearColor = null);

        /// <summary>Start drawing on this render target. Draw calls can only be issued between a BeginDraw and EndDraw call.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _BeginDraw(ID2D1DeviceContext5* This);

        /// <summary>Ends drawing on the render target, error results can be retrieved at this time, or when calling flush.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _EndDraw(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_TAG")] ulong* tag1 = null, [NativeTypeName("D2D1_TAG")] ulong* tag2 = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_PIXEL_FORMAT* _GetPixelFormat(ID2D1DeviceContext5* This, D2D1_PIXEL_FORMAT* _result);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetDpi(ID2D1DeviceContext5* This, [NativeTypeName("FLOAT")] float dpiX, [NativeTypeName("FLOAT")] float dpiY);

        /// <summary>Return the current DPI from the target.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetDpi(ID2D1DeviceContext5* This, [NativeTypeName("FLOAT")] float* dpiX, [NativeTypeName("FLOAT")] float* dpiY);

        /// <summary>Returns the size of the render target in DIPs.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("D2D1_SIZE_F")]
        public delegate D2D_SIZE_F* _GetSize(ID2D1DeviceContext5* This, D2D_SIZE_F* _result);

        /// <summary>Returns the size of the render target in pixels.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("D2D1_SIZE_U")]
        public delegate D2D_SIZE_U* _GetPixelSize(ID2D1DeviceContext5* This, D2D_SIZE_U* _result);
        ...
        public delegate uint _GetMaximumBitmapSize(ID2D1DeviceContext5* This);
        ...
        public delegate int _IsSupported(ID2D1DeviceContext5* This, D2D1_RENDER_TARGET_PROPERTIES* renderTargetProperties);

        /// <summary>Creates a bitmap with extended bitmap properties, potentially from a block of memory.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmap1(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_SIZE_U")] D2D_SIZE_U size, [Optional] void* sourceData, [NativeTypeName("UINT32")] uint pitch, D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap);

        /// <summary>Create a D2D bitmap by copying a WIC bitmap.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmapFromWicBitmap1(ID2D1DeviceContext5* This, IWICBitmapSource* wicBitmapSource, [Optional] D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContext(ID2D1DeviceContext5* This, D2D1_COLOR_SPACE space, [NativeTypeName("BYTE[]")] byte* profile, [NativeTypeName("UINT32")] uint profileSize, ID2D1ColorContext** colorContext);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContextFromFilename(ID2D1DeviceContext5* This, [NativeTypeName("PCWSTR")] char* filename, ID2D1ColorContext** colorContext);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContextFromWicColorContext(ID2D1DeviceContext5* This, IWICColorContext* wicColorContext, ID2D1ColorContext** colorContext);

        /// <summary>Creates a bitmap from a DXGI surface with a set of extended properties.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmapFromDxgiSurface(ID2D1DeviceContext5* This, IDXGISurface* surface, [Optional] D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateEffect(ID2D1DeviceContext5* This, [NativeTypeName("REFCLSID")] Guid* effectId, ID2D1Effect** effect);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateImageBrush(ID2D1DeviceContext5* This, [Optional] ID2D1Image* image, D2D1_IMAGE_BRUSH_PROPERTIES* imageBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1ImageBrush** imageBrush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateBitmapBrush1(ID2D1DeviceContext5* This, [Optional] ID2D1Bitmap* bitmap, [Optional] D2D1_BITMAP_BRUSH_PROPERTIES1* bitmapBrushProperties, [Optional] D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1BitmapBrush1** bitmapBrush);

        /// <summary>Creates a new command list.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateCommandList(ID2D1DeviceContext5* This, ID2D1CommandList** commandList);

        /// <summary>Indicates whether the format is supported by D2D.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("BOOL")]
        public delegate int _IsDxgiFormatSupported(ID2D1DeviceContext5* This, DXGI_FORMAT format);

        /// <summary>Indicates whether the buffer precision is supported by D2D.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("BOOL")]
        public delegate int _IsBufferPrecisionSupported(ID2D1DeviceContext5* This, D2D1_BUFFER_PRECISION bufferPrecision);

        /// <summary>This retrieves the local-space bounds in DIPs of the current image using the device context DPI.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetImageLocalBounds(ID2D1DeviceContext5* This, ID2D1Image* image, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* localBounds);

        /// <summary>This retrieves the world-space bounds in DIPs of the current image using the device context DPI.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetImageWorldBounds(ID2D1DeviceContext5* This, ID2D1Image* image, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* worldBounds);

        /// <summary>Retrieves the world-space bounds in DIPs of the glyph run using the device context DPI.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetGlyphRunWorldBounds(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, DWRITE_MEASURING_MODE measuringMode, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* bounds);

        /// <summary>Retrieves the device associated with this device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetDevice(ID2D1DeviceContext5* This, ID2D1Device** device);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetTarget(ID2D1DeviceContext5* This, ID2D1Image* image = null);

        /// <summary>Gets the target that this device context is currently pointing to.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetTarget(ID2D1DeviceContext5* This, ID2D1Image** image);

        /// <summary>Sets tuning parameters for internal rendering inside the device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetRenderingControls(ID2D1DeviceContext5* This, D2D1_RENDERING_CONTROLS* renderingControls);

        /// <summary>This retrieves the rendering controls currently selected into the device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetRenderingControls(ID2D1DeviceContext5* This, D2D1_RENDERING_CONTROLS* renderingControls);

        /// <summary>Changes the primitive blending mode for all of the rendering operations.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetPrimitiveBlend(ID2D1DeviceContext5* This, D2D1_PRIMITIVE_BLEND primitiveBlend);

        /// <summary>Returns the primitive blend currently selected into the device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_PRIMITIVE_BLEND _GetPrimitiveBlend(ID2D1DeviceContext5* This);

        /// <summary>Changes the units used for all of the rendering operations.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _SetUnitMode(ID2D1DeviceContext5* This, D2D1_UNIT_MODE unitMode);

        /// <summary>Returns the unit mode currently set on the device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D2D1_UNIT_MODE _GetUnitMode(ID2D1DeviceContext5* This);

        /// <summary>Draws the glyph run with an extended description to describe the glyphs.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGlyphRun1(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, [Optional] DWRITE_GLYPH_RUN_DESCRIPTION* glyphRunDescription, ID2D1Brush* foregroundBrush, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawImage(ID2D1DeviceContext5* This, ID2D1Image* image, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F* targetOffset = null, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* imageRectangle = null, D2D1_INTERPOLATION_MODE interpolationMode = D2D1_INTERPOLATION_MODE_LINEAR, D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER);

        /// <summary>Draw a metafile to the device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGdiMetafile(ID2D1DeviceContext5* This, ID2D1GdiMetafile* gdiMetafile, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F* targetOffset = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawBitmap1(ID2D1DeviceContext5* This, ID2D1Bitmap* bitmap, [Optional, NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* destinationRectangle, [NativeTypeName("FLOAT")] float opacity, D2D1_INTERPOLATION_MODE interpolationMode, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* sourceRectangle = null, [NativeTypeName("D2D1_MATRIX_4X4_F")] D2D_MATRIX_4X4_F* perspectiveTransform = null);

        /// <summary>Push a layer on the device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _PushLayer1(ID2D1DeviceContext5* This, D2D1_LAYER_PARAMETERS1* layerParameters, ID2D1Layer* layer = null);

        /// <summary>This indicates that a portion of an effect's input is invalid. This method can be called many times.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _InvalidateEffectInputRectangle(ID2D1DeviceContext5* This, ID2D1Effect* effect, [NativeTypeName("UINT32")] uint input, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* inputRectangle);

        /// <summary>Gets the number of invalid ouptut rectangles that have accumulated at the effect.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetEffectInvalidRectangleCount(ID2D1DeviceContext5* This, ID2D1Effect* effect, [NativeTypeName("UINT32")] uint* rectangleCount);

        /// <summary>Gets the invalid rectangles that are at the output of the effect.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetEffectInvalidRectangles(ID2D1DeviceContext5* This, ID2D1Effect* effect, [NativeTypeName("D2D1_RECT_F[]")] D2D_RECT_F* rectangles, [NativeTypeName("UINT32")] uint rectanglesCount);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetEffectRequiredInputRectangles(ID2D1DeviceContext5* This, ID2D1Effect* renderEffect, [Optional, NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* renderImageRectangle, D2D1_EFFECT_INPUT_DESCRIPTION* inputDescriptions, [NativeTypeName("D2D1_RECT_F[]")] D2D_RECT_F* requiredInputRects, [NativeTypeName("UINT32")] uint inputCount);

        /// <summary>Fill using the alpha channel of the supplied opacity mask bitmap. The brush opacity will be modulated by the mask. The render target antialiasing mode must be set to aliased.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _FillOpacityMask1(ID2D1DeviceContext5* This, ID2D1Bitmap* opacityMask, ID2D1Brush* brush, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* destinationRectangle = null, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* sourceRectangle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateFilledGeometryRealization(ID2D1DeviceContext5* This, ID2D1Geometry* geometry, [NativeTypeName("FLOAT")] float flatteningTolerance, ID2D1GeometryRealization** geometryRealization);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateStrokedGeometryRealization(ID2D1DeviceContext5* This, ID2D1Geometry* geometry, [NativeTypeName("FLOAT")] float flatteningTolerance, [NativeTypeName("FLOAT")] float strokeWidth, [Optional] ID2D1StrokeStyle* strokeStyle, ID2D1GeometryRealization** geometryRealization);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGeometryRealization(ID2D1DeviceContext5* This, ID2D1GeometryRealization* geometryRealization, ID2D1Brush* brush);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateInk(ID2D1DeviceContext5* This, D2D1_INK_POINT* startPoint, ID2D1Ink** ink);

        /// <summary>Creates a new ink style.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateInkStyle(ID2D1DeviceContext5* This, [Optional] D2D1_INK_STYLE_PROPERTIES* inkStyleProperties, ID2D1InkStyle** inkStyle);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateGradientMesh(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_GRADIENT_MESH_PATCH[]")] D2D1_GRADIENT_MESH_PATCH* patches, [NativeTypeName("UINT32")] uint patchesCount, ID2D1GradientMesh** gradientMesh);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateImageSourceFromWic(ID2D1DeviceContext5* This, IWICBitmapSource* wicBitmapSource, D2D1_IMAGE_SOURCE_LOADING_OPTIONS loadingOptions, D2D1_ALPHA_MODE alphaMode, ID2D1ImageSourceFromWic** imageSource);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateLookupTable3D(ID2D1DeviceContext5* This, D2D1_BUFFER_PRECISION precision, [NativeTypeName("UINT32[]")] uint* extents, [NativeTypeName("BYTE[]")] byte* data, [NativeTypeName("UINT32")] uint dataCount, [NativeTypeName("UINT32[]")] uint* strides, ID2D1LookupTable3D** lookupTable);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateImageSourceFromDxgi(ID2D1DeviceContext5* This, [NativeTypeName("IDXGISurface*[]")] IDXGISurface** surfaces, [NativeTypeName("UINT32")] uint surfaceCount, DXGI_COLOR_SPACE_TYPE colorSpace, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options, ID2D1ImageSource** imageSource);

        /// <summary>Retrieves the world-space bounds in DIPs of the gradient mesh using the device context DPI.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetGradientMeshWorldBounds(ID2D1DeviceContext5* This, ID2D1GradientMesh* gradientMesh, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* pBounds);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawInk(ID2D1DeviceContext5* This, ID2D1Ink* ink, ID2D1Brush* brush, ID2D1InkStyle* inkStyle = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGradientMesh(ID2D1DeviceContext5* This, ID2D1GradientMesh* gradientMesh);

        /// <summary>Draw a metafile to the device context.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawGdiMetafile1(ID2D1DeviceContext5* This, ID2D1GdiMetafile* gdiMetafile, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* destinationRectangle = null, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* sourceRectangle = null);

        /// <summary>Creates an image source which shares resources with an original.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateTransformedImageSource(ID2D1DeviceContext5* This, ID2D1ImageSource* imageSource, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES* properties, ID2D1TransformedImageSource** transformedImageSource);

        /// <summary>Creates a new sprite batch.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSpriteBatch(ID2D1DeviceContext5* This, ID2D1SpriteBatch** spriteBatch);

        /// <summary>Draws sprites in a sprite batch.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawSpriteBatch(ID2D1DeviceContext5* This, ID2D1SpriteBatch* spriteBatch, [NativeTypeName("UINT32")] uint startIndex, [NativeTypeName("UINT32")] uint spriteCount, ID2D1Bitmap* bitmap, D2D1_BITMAP_INTERPOLATION_MODE interpolationMode = D2D1_BITMAP_INTERPOLATION_MODE_LINEAR, D2D1_SPRITE_OPTIONS spriteOptions = D2D1_SPRITE_OPTIONS_NONE);

        /// <summary>Creates an SVG glyph style object.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSvgGlyphStyle(ID2D1DeviceContext5* This, ID2D1SvgGlyphStyle** svgGlyphStyle);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawText1(ID2D1DeviceContext5* This, [NativeTypeName("WCHAR[]")] char* @string, [NativeTypeName("UINT32")] uint stringLength, IDWriteTextFormat* textFormat, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* layoutRect, ID2D1Brush* defaultFillBrush = null, ID2D1SvgGlyphStyle* svgGlyphStyle = null, [NativeTypeName("UINT32")] uint colorPaletteIndex = 0, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_ENABLE_COLOR_FONT, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL);
        ...
        /// <param name="options">The specified text options. If D2D1_DRAW_TEXT_OPTIONS_CLIP is used, the text is clipped to the layout bounds. These bounds are derived from the origin and the layout bounds of the corresponding IDWriteTextLayout object.</param>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawTextLayout1(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F origin, IDWriteTextLayout* textLayout, ID2D1Brush* defaultFillBrush = null, ID2D1SvgGlyphStyle* svgGlyphStyle = null, [NativeTypeName("UINT32")] uint colorPaletteIndex = 0, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_ENABLE_COLOR_FONT);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawColorBitmapGlyphRun(ID2D1DeviceContext5* This, DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmapSnapOption = D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION_DEFAULT);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawSvgGlyphRun(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, ID2D1Brush* defaultFillBrush = null, ID2D1SvgGlyphStyle* svgGlyphStyle = null, [NativeTypeName("UINT32")] uint colorPaletteIndex = 0, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetSvgGlyphImage(ID2D1DeviceContext5* This, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F glyphOrigin, IDWriteFontFace* fontFace, [NativeTypeName("FLOAT")] float fontEmSize, [NativeTypeName("UINT16")] ushort glyphIndex, [NativeTypeName("BOOL")] int isSideways, [Optional, NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* worldTransform, [Optional] ID2D1Brush* defaultFillBrush, [Optional] ID2D1SvgGlyphStyle* svgGlyphStyle, [NativeTypeName("UINT32")] uint colorPaletteIndex, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* glyphTransform, ID2D1CommandList** glyphImage);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSvgDocument(ID2D1DeviceContext5* This, [Optional] IStream* inputXmlStream, [NativeTypeName("D2D1_SIZE_F")] D2D_SIZE_F viewportSize, ID2D1SvgDocument** svgDocument);

        /// <summary>Draw an SVG document.</summary>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _DrawSvgDocument(ID2D1DeviceContext5* This, ID2D1SvgDocument* svgDocument);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContextFromDxgiColorSpace(ID2D1DeviceContext5* This, DXGI_COLOR_SPACE_TYPE colorSpace, ID2D1ColorContext1** colorContext);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContextFromSimpleColorProfile(ID2D1DeviceContext5* This, D2D1_SIMPLE_COLOR_PROFILE* simpleProfile, ID2D1ColorContext1** colorContext);
        ...
        public int CreateSvgGlyphStyle(ID2D1SvgGlyphStyle** svgGlyphStyle)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CreateSvgGlyphStyle>(lpVtbl->CreateSvgGlyphStyle)(This, svgGlyphStyle);
            }
        }

        public void DrawText1([NativeTypeName("WCHAR[]")] char* @string, [NativeTypeName("UINT32")] uint stringLength, IDWriteTextFormat* textFormat, [NativeTypeName("D2D1_RECT_F")] D2D_RECT_F* layoutRect, ID2D1Brush* defaultFillBrush = null, ID2D1SvgGlyphStyle* svgGlyphStyle = null, [NativeTypeName("UINT32")] uint colorPaletteIndex = 0, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_ENABLE_COLOR_FONT, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                Marshal.GetDelegateForFunctionPointer<_DrawText1>(lpVtbl->DrawText1)(This, @string, stringLength, textFormat, layoutRect, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, options, measuringMode);
            }
        }

        public void DrawTextLayout1([NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F origin, IDWriteTextLayout* textLayout, ID2D1Brush* defaultFillBrush = null, ID2D1SvgGlyphStyle* svgGlyphStyle = null, [NativeTypeName("UINT32")] uint colorPaletteIndex = 0, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_ENABLE_COLOR_FONT)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                Marshal.GetDelegateForFunctionPointer<_DrawTextLayout1>(lpVtbl->DrawTextLayout1)(This, origin, textLayout, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, options);
            }
        }
        ...
        public void DrawColorBitmapGlyphRun(DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmapSnapOption = D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION_DEFAULT)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                Marshal.GetDelegateForFunctionPointer<_DrawColorBitmapGlyphRun>(lpVtbl->DrawColorBitmapGlyphRun)(This, glyphImageFormat, baselineOrigin, glyphRun, measuringMode, bitmapSnapOption);
            }
        }

        public void DrawSvgGlyphRun([NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, ID2D1Brush* defaultFillBrush = null, ID2D1SvgGlyphStyle* svgGlyphStyle = null, [NativeTypeName("UINT32")] uint colorPaletteIndex = 0, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                Marshal.GetDelegateForFunctionPointer<_DrawSvgGlyphRun>(lpVtbl->DrawSvgGlyphRun)(This, baselineOrigin, glyphRun, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, measuringMode);
            }
        }
        ...
        public int GetColorBitmapGlyphImage(DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, [NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F glyphOrigin, IDWriteFontFace* fontFace, [NativeTypeName("FLOAT")] float fontEmSize, [NativeTypeName("UINT16")] ushort glyphIndex, [NativeTypeName("BOOL")] int isSideways, [Optional, NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* worldTransform, [NativeTypeName("FLOAT")] float dpiX, [NativeTypeName("FLOAT")] float dpiY, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* glyphTransform, ID2D1Image** glyphImage)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_GetColorBitmapGlyphImage>(lpVtbl->GetColorBitmapGlyphImage)(This, glyphImageFormat, glyphOrigin, fontFace, fontEmSize, glyphIndex, isSideways, worldTransform, dpiX, dpiY, glyphTransform, glyphImage);
            }
        }
        ...
        public int GetSvgGlyphImage([NativeTypeName("D2D1_POINT_2F")] D2D_POINT_2F glyphOrigin, IDWriteFontFace* fontFace, [NativeTypeName("FLOAT")] float fontEmSize, [NativeTypeName("UINT16")] ushort glyphIndex, [NativeTypeName("BOOL")] int isSideways, [Optional, NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* worldTransform, [Optional] ID2D1Brush* defaultFillBrush, [Optional] ID2D1SvgGlyphStyle* svgGlyphStyle, [NativeTypeName("UINT32")] uint colorPaletteIndex, [NativeTypeName("D2D1_MATRIX_3X2_F")] D2D_MATRIX_3X2_F* glyphTransform, ID2D1CommandList** glyphImage)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_GetSvgGlyphImage>(lpVtbl->GetSvgGlyphImage)(This, glyphOrigin, fontFace, fontEmSize, glyphIndex, isSideways, worldTransform, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, glyphTransform, glyphImage);
            }
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateSvgDocument([Optional] IStream* inputXmlStream, [NativeTypeName("D2D1_SIZE_F")] D2D_SIZE_F viewportSize, ID2D1SvgDocument** svgDocument)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CreateSvgDocument>(lpVtbl->CreateSvgDocument)(This, inputXmlStream, viewportSize, svgDocument);
            }
        }
        ...
        public void DrawSvgDocument(ID2D1SvgDocument* svgDocument)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                Marshal.GetDelegateForFunctionPointer<_DrawSvgDocument>(lpVtbl->DrawSvgDocument)(This, svgDocument);
            }
        }
        ...
        public int CreateColorContextFromDxgiColorSpace(DXGI_COLOR_SPACE_TYPE colorSpace, ID2D1ColorContext1** colorContext)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CreateColorContextFromDxgiColorSpace>(lpVtbl->CreateColorContextFromDxgiColorSpace)(This, colorSpace, colorContext);
            }
        }

        [return: NativeTypeName("HRESULT")]
        public int CreateColorContextFromSimpleColorProfile(D2D1_SIMPLE_COLOR_PROFILE* simpleProfile, ID2D1ColorContext1** colorContext)
        {
            fixed (ID2D1DeviceContext5* This = &this)
            {
                return Marshal.GetDelegateForFunctionPointer<_CreateColorContextFromSimpleColorProfile>(lpVtbl->CreateColorContextFromSimpleColorProfile)(This, simpleProfile, colorContext);
            }
        }
