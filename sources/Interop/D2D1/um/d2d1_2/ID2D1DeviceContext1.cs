...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID2D1DeviceContext1
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateColorContextFromFilename(ID2D1DeviceContext1* This, [NativeTypeName("PCWSTR")] ushort* filename, ID2D1ColorContext** colorContext);
