...
namespace TerraFX.Interop
{
    public static unsafe partial class D3DCompiler
    {
        ...
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DPreprocess([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, [NativeTypeName("LPCSTR")] sbyte* pSourceName, [NativeTypeName("const D3D_SHADER_MACRO *")] D3D_SHADER_MACRO* pDefines, [NativeTypeName("ID3DInclude *")] ID3DInclude* pInclude, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppCodeText, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppErrorMsgs);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DGetDebugInfo", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DGetDebugInfo([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppDebugInfo);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DReflect", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DReflect([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, [NativeTypeName("const IID &")] Guid* pInterface, [NativeTypeName("void **")] void** ppReflector);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DReflectLibrary", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DReflectLibrary([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, [NativeTypeName("const IID &")] Guid* riid, [NativeTypeName("LPVOID *")] void** ppReflector);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DDisassemble", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DDisassemble([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, [NativeTypeName("UINT")] uint Flags, [NativeTypeName("LPCSTR")] sbyte* szComments, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppDisassembly);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DDisassembleRegion", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DDisassembleRegion([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, [NativeTypeName("UINT")] uint Flags, [NativeTypeName("LPCSTR")] sbyte* szComments, [NativeTypeName("SIZE_T")] UIntPtr StartByteOffset, [NativeTypeName("SIZE_T")] UIntPtr NumInsts, [NativeTypeName("SIZE_T *")] UIntPtr* pFinishByteOffset, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppDisassembly);
        ...
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DGetInputAndOutputSignatureBlob([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppSignatureBlob);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DStripShader", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DStripShader([NativeTypeName("LPCVOID")] void* pShaderBytecode, [NativeTypeName("SIZE_T")] UIntPtr BytecodeLength, [NativeTypeName("UINT")] uint uStripFlags, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppStrippedBlob);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DGetBlobPart", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DGetBlobPart([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, D3D_BLOB_PART Part, [NativeTypeName("UINT")] uint Flags, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppPart);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DSetBlobPart", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DSetBlobPart([NativeTypeName("LPCVOID")] void* pSrcData, [NativeTypeName("SIZE_T")] UIntPtr SrcDataSize, D3D_BLOB_PART Part, [NativeTypeName("UINT")] uint Flags, [NativeTypeName("LPCVOID")] void* pPart, [NativeTypeName("SIZE_T")] UIntPtr PartSize, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppNewShader);

        [DllImport(LibraryPath, CallingConvention = CallingConvention.Winapi, EntryPoint = "D3DCreateBlob", ExactSpelling = true)]
        [return: NativeTypeName("HRESULT")]
        public static extern int D3DCreateBlob([NativeTypeName("SIZE_T")] UIntPtr Size, [NativeTypeName("ID3DBlob **")] ID3DBlob** ppBlob);
