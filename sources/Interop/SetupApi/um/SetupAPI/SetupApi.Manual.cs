...
namespace TerraFX.Interop
{
    public static unsafe partial class SetupApi
    {
        ...
        public const int SP_MAX_MACHINENAME_LENGTH = Windows.MAX_PATH + 3;
        ...
        public const uint ERROR_EXPECTED_SECTION_NAME = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0;

        public const uint ERROR_BAD_SECTION_NAME_LINE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 1;

        public const uint ERROR_SECTION_NAME_TOO_LONG = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 2;

        public const uint ERROR_GENERAL_SYNTAX = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 3;

        public const uint ERROR_WRONG_INF_STYLE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x100;

        public const uint ERROR_SECTION_NOT_FOUND = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x101;

        public const uint ERROR_LINE_NOT_FOUND = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x102;

        public const uint ERROR_NO_BACKUP = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x103;

        public const uint ERROR_NO_ASSOCIATED_CLASS = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x200;

        public const uint ERROR_CLASS_MISMATCH = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x201;

        public const uint ERROR_DUPLICATE_FOUND = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x202;

        public const uint ERROR_NO_DRIVER_SELECTED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x203;

        public const uint ERROR_KEY_DOES_NOT_EXIST = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x204;

        public const uint ERROR_INVALID_DEVINST_NAME = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x205;

        public const uint ERROR_INVALID_CLASS = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x206;

        public const uint ERROR_DEVINST_ALREADY_EXISTS = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x207;

        public const uint ERROR_DEVINFO_NOT_REGISTERED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x208;

        public const uint ERROR_INVALID_REG_PROPERTY = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x209;

        public const uint ERROR_NO_INF = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x20A;

        public const uint ERROR_NO_SUCH_DEVINST = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x20B;

        public const uint ERROR_CANT_LOAD_CLASS_ICON = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x20C;

        public const uint ERROR_INVALID_CLASS_INSTALLER = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x20D;

        public const uint ERROR_DI_DO_DEFAULT = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x20E;

        public const uint ERROR_DI_NOFILECOPY = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x20F;

        public const uint ERROR_INVALID_HWPROFILE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x210;

        public const uint ERROR_NO_DEVICE_SELECTED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x211;

        public const uint ERROR_DEVINFO_LIST_LOCKED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x212;

        public const uint ERROR_DEVINFO_DATA_LOCKED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x213;

        public const uint ERROR_DI_BAD_PATH = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x214;

        public const uint ERROR_NO_CLASSINSTALL_PARAMS = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x215;

        public const uint ERROR_FILEQUEUE_LOCKED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x216;

        public const uint ERROR_BAD_SERVICE_INSTALLSECT = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x217;

        public const uint ERROR_NO_CLASS_DRIVER_LIST = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x218;

        public const uint ERROR_NO_ASSOCIATED_SERVICE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x219;

        public const uint ERROR_NO_DEFAULT_DEVICE_INTERFACE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x21A;

        public const uint ERROR_DEVICE_INTERFACE_ACTIVE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x21B;

        public const uint ERROR_DEVICE_INTERFACE_REMOVED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x21C;

        public const uint ERROR_BAD_INTERFACE_INSTALLSECT = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x21D;

        public const uint ERROR_NO_SUCH_INTERFACE_CLASS = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x21E;

        public const uint ERROR_INVALID_REFERENCE_STRING = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x21F;

        public const uint ERROR_INVALID_MACHINENAME = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x220;

        public const uint ERROR_REMOTE_COMM_FAILURE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x221;

        public const uint ERROR_MACHINE_UNAVAILABLE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x222;

        public const uint ERROR_NO_CONFIGMGR_SERVICES = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x223;

        public const uint ERROR_INVALID_PROPPAGE_PROVIDER = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x224;

        public const uint ERROR_NO_SUCH_DEVICE_INTERFACE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x225;

        public const uint ERROR_DI_POSTPROCESSING_REQUIRED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x226;

        public const uint ERROR_INVALID_COINSTALLER = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x227;

        public const uint ERROR_NO_COMPAT_DRIVERS = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x228;

        public const uint ERROR_NO_DEVICE_ICON = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x229;

        public const uint ERROR_INVALID_INF_LOGCONFIG = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x22A;

        public const uint ERROR_DI_DONT_INSTALL = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x22B;

        public const uint ERROR_INVALID_FILTER_DRIVER = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x22C;

        public const uint ERROR_NON_WINDOWS_NT_DRIVER = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x22D;

        public const uint ERROR_NON_WINDOWS_DRIVER = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x22E;

        public const uint ERROR_NO_CATALOG_FOR_OEM_INF = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x22F;

        public const uint ERROR_DEVINSTALL_QUEUE_NONNATIVE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x230;

        public const uint ERROR_NOT_DISABLEABLE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x231;

        public const uint ERROR_CANT_REMOVE_DEVINST = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x232;

        public const uint ERROR_INVALID_TARGET = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x233;

        public const uint ERROR_DRIVER_NONNATIVE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x234;

        public const uint ERROR_IN_WOW64 = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x235;

        public const uint ERROR_SET_SYSTEM_RESTORE_POINT = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x236;

        public const uint ERROR_SCE_DISABLED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x238;

        public const uint ERROR_UNKNOWN_EXCEPTION = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x239;

        public const uint ERROR_PNP_REGISTRY_ERROR = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x23A;

        public const uint ERROR_REMOTE_REQUEST_UNSUPPORTED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x23B;

        public const uint ERROR_NOT_AN_INSTALLED_OEM_INF = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x23C;

        public const uint ERROR_INF_IN_USE_BY_DEVICES = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x23D;

        public const uint ERROR_DI_FUNCTION_OBSOLETE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x23E;

        public const uint ERROR_NO_AUTHENTICODE_CATALOG = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x23F;

        public const uint ERROR_AUTHENTICODE_DISALLOWED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x240;

        public const uint ERROR_AUTHENTICODE_TRUSTED_PUBLISHER = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x241;

        public const uint ERROR_AUTHENTICODE_TRUST_NOT_ESTABLISHED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x242;

        public const uint ERROR_AUTHENTICODE_PUBLISHER_NOT_TRUSTED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x243;

        public const uint ERROR_SIGNATURE_OSATTRIBUTE_MISMATCH = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x244;

        public const uint ERROR_ONLY_VALIDATE_VIA_AUTHENTICODE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x245;

        public const uint ERROR_DEVICE_INSTALLER_NOT_READY = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x246;

        public const uint ERROR_DRIVER_STORE_ADD_FAILED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x247;

        public const uint ERROR_DEVICE_INSTALL_BLOCKED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x248;

        public const uint ERROR_DRIVER_INSTALL_BLOCKED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x249;

        public const uint ERROR_WRONG_INF_TYPE = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x24A;

        public const uint ERROR_FILE_HASH_NOT_IN_CATALOG = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x24B;

        public const uint ERROR_DRIVER_STORE_DELETE_FAILED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x24C;

        public const uint ERROR_UNRECOVERABLE_STACK_OVERFLOW = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x300;
        ...
        public const uint ERROR_NOT_INSTALLED = Windows.APPLICATION_ERROR_MASK | Windows.ERROR_SEVERITY_ERROR | 0x1000;
