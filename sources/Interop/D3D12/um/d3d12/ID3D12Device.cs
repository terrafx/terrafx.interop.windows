...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ID3D12Device
    {
        ...
        public delegate int _QueryInterface(ID3D12Device* This, [NativeTypeName("REFIID")] Guid* riid, void** ppvObject);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _AddRef(ID3D12Device* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("ULONG")]
        public delegate uint _Release(ID3D12Device* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetPrivateData(ID3D12Device* This, [NativeTypeName("REFGUID")] Guid* guid, [NativeTypeName("UINT")] uint* pDataSize, void* pData = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _SetPrivateData(ID3D12Device* This, [NativeTypeName("REFGUID")] Guid* guid, [NativeTypeName("UINT")] uint DataSize, void* pData = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _SetPrivateDataInterface(ID3D12Device* This, [NativeTypeName("REFGUID")] Guid* guid, IUnknown* pData = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _SetName(ID3D12Device* This, [NativeTypeName("LPCWSTR")] ushort* Name);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("UINT")]
        public delegate uint _GetNodeCount(ID3D12Device* This);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateCommandQueue(ID3D12Device* This, D3D12_COMMAND_QUEUE_DESC* pDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppCommandQueue);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateCommandAllocator(ID3D12Device* This, D3D12_COMMAND_LIST_TYPE Type, [NativeTypeName("REFIID")] Guid* riid, void** ppCommandAllocator);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateGraphicsPipelineState(ID3D12Device* This, D3D12_GRAPHICS_PIPELINE_STATE_DESC* pDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppPipelineState);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateComputePipelineState(ID3D12Device* This, D3D12_COMPUTE_PIPELINE_STATE_DESC* pDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppPipelineState);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateCommandList(ID3D12Device* This, [NativeTypeName("UINT")] uint NodeMask, D3D12_COMMAND_LIST_TYPE Type, ID3D12CommandAllocator* pCommandAllocator, [Optional] ID3D12PipelineState* pInitialState, [NativeTypeName("REFIID")] Guid* riid, void** ppCommandList);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CheckFeatureSupport(ID3D12Device* This, D3D12_FEATURE Feature, void* pFeatureSupportData, [NativeTypeName("UINT")] uint FeatureSupportDataSize);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateDescriptorHeap(ID3D12Device* This, D3D12_DESCRIPTOR_HEAP_DESC* pDescriptorHeapDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppvHeap);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("UINT")]
        public delegate uint _GetDescriptorHandleIncrementSize(ID3D12Device* This, D3D12_DESCRIPTOR_HEAP_TYPE DescriptorHeapType);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateRootSignature(ID3D12Device* This, [NativeTypeName("UINT")] uint NodeMask, void* pBlobWithRootSignature, [NativeTypeName("SIZE_T")] UIntPtr blobLengthInBytes, [NativeTypeName("REFIID")] Guid* riid, void** ppvRootSignature);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CreateConstantBufferView(ID3D12Device* This, [Optional] D3D12_CONSTANT_BUFFER_VIEW_DESC* pDesc, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CreateShaderResourceView(ID3D12Device* This, [Optional] ID3D12Resource* pResource, [Optional] D3D12_SHADER_RESOURCE_VIEW_DESC* pDesc, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CreateUnorderedAccessView(ID3D12Device* This, [Optional] ID3D12Resource* pResource, [Optional] ID3D12Resource* pCounterResource, [Optional] D3D12_UNORDERED_ACCESS_VIEW_DESC* pDesc, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CreateRenderTargetView(ID3D12Device* This, [Optional] ID3D12Resource* pResource, [Optional] D3D12_RENDER_TARGET_VIEW_DESC* pDesc, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CreateDepthStencilView(ID3D12Device* This, [Optional] ID3D12Resource* pResource, [Optional] D3D12_DEPTH_STENCIL_VIEW_DESC* pDesc, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CreateSampler(ID3D12Device* This, D3D12_SAMPLER_DESC* pDesc, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CopyDescriptors(ID3D12Device* This, [NativeTypeName("UINT")] uint NumDestDescriptorRanges, [NativeTypeName("D3D12_CPU_DESCRIPTOR_HANDLE[]")] D3D12_CPU_DESCRIPTOR_HANDLE* pDestDescriptorRangeStarts, [Optional, NativeTypeName("UINT[]")] uint* pDestDescriptorRangeSizes, [NativeTypeName("UINT")] uint NumSrcDescriptorRanges, [NativeTypeName("D3D12_CPU_DESCRIPTOR_HANDLE[]")] D3D12_CPU_DESCRIPTOR_HANDLE* pSrcDescriptorRangeStarts, [Optional, NativeTypeName("UINT[]")] uint* pSrcDescriptorRangeSizes, D3D12_DESCRIPTOR_HEAP_TYPE DescriptorHeapsType);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _CopyDescriptorsSimple(ID3D12Device* This, [NativeTypeName("UINT")] uint NumDescriptors, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptorRangeStart, D3D12_CPU_DESCRIPTOR_HANDLE SrcDescriptorRangeStart, D3D12_DESCRIPTOR_HEAP_TYPE DescriptorHeapsType);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D3D12_RESOURCE_ALLOCATION_INFO* _GetResourceAllocationInfo(ID3D12Device* This, D3D12_RESOURCE_ALLOCATION_INFO* _result, [NativeTypeName("UINT")] uint visibleMask, [NativeTypeName("UINT")] uint numResourceDescs, D3D12_RESOURCE_DESC* pResourceDescs);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate D3D12_HEAP_PROPERTIES* _GetCustomHeapProperties(ID3D12Device* This, D3D12_HEAP_PROPERTIES* _result, [NativeTypeName("UINT")] uint NodeMask, D3D12_HEAP_TYPE heapType);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateCommittedResource(ID3D12Device* This, D3D12_HEAP_PROPERTIES* pHeapProperties, D3D12_HEAP_FLAGS HeapFlags, D3D12_RESOURCE_DESC* pDesc, D3D12_RESOURCE_STATES InitialResourceState, [Optional] D3D12_CLEAR_VALUE* pOptimizedClearValue, [NativeTypeName("REFIID")] Guid* riidResource, void** ppvResource = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateHeap(ID3D12Device* This, D3D12_HEAP_DESC* pDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppvHeap = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreatePlacedResource(ID3D12Device* This, ID3D12Heap* pHeap, [NativeTypeName("UINT64")] ulong HeapOffset, D3D12_RESOURCE_DESC* pDesc, D3D12_RESOURCE_STATES InitialState, [Optional] D3D12_CLEAR_VALUE* pOptimizedClearValue, [NativeTypeName("REFIID")] Guid* riid, void** ppvResource = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateReservedResource(ID3D12Device* This, D3D12_RESOURCE_DESC* pDesc, D3D12_RESOURCE_STATES InitialState, [Optional] D3D12_CLEAR_VALUE* pOptimizedClearValue, [NativeTypeName("REFIID")] Guid* riid, void** ppvResource = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateSharedHandle(ID3D12Device* This, ID3D12DeviceChild* pObject, [Optional] SECURITY_ATTRIBUTES* pAttributes, [NativeTypeName("DWORD")] uint Access, [Optional, NativeTypeName("LPCWSTR")] ushort* Name, [NativeTypeName("HANDLE")] IntPtr* pHandle);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _OpenSharedHandle(ID3D12Device* This, [NativeTypeName("HANDLE")] IntPtr NTHandle, [NativeTypeName("REFIID")] Guid* riid, void** ppvObj = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _OpenSharedHandleByName(ID3D12Device* This, [NativeTypeName("LPCWSTR")] ushort* Name, [NativeTypeName("DWORD")] uint Access, [NativeTypeName("HANDLE")] IntPtr* pNTHandle);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _MakeResident(ID3D12Device* This, [NativeTypeName("UINT")] uint NumObjects, [NativeTypeName("ID3D12Pageable*[]")] ID3D12Pageable** ppObjects);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _Evict(ID3D12Device* This, [NativeTypeName("UINT")] uint NumObjects, [NativeTypeName("ID3D12Pageable*[]")] ID3D12Pageable** ppObjects);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateFence(ID3D12Device* This, [NativeTypeName("UINT64")] ulong InitialValue, D3D12_FENCE_FLAGS Flags, [NativeTypeName("REFIID")] Guid* riid, void** ppFence);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetDeviceRemovedReason(ID3D12Device* This
);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetCopyableFootprints(ID3D12Device* This, D3D12_RESOURCE_DESC* pResourceDesc, [NativeTypeName("UINT")] uint FirstSubresource, [NativeTypeName("UINT")] uint NumSubresources, [NativeTypeName("UINT64")] ulong BaseOffset, [NativeTypeName("D3D12_PLACED_SUBRESOURCE_FOOTPRINT[]")] D3D12_PLACED_SUBRESOURCE_FOOTPRINT* pLayouts = null, [NativeTypeName("UINT[]")] uint* pNumRows = null, [NativeTypeName("UINT64[]")] ulong* pRowSizeInBytes = null, [NativeTypeName("UINT64")] ulong* pTotalBytes = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateQueryHeap(ID3D12Device* This, D3D12_QUERY_HEAP_DESC* pDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppvHeap = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _SetStablePowerState(ID3D12Device* This, [NativeTypeName("BOOL")] int Enable);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateCommandSignature(ID3D12Device* This, D3D12_COMMAND_SIGNATURE_DESC* pDesc, [Optional] ID3D12RootSignature* pRootSignature, [NativeTypeName("REFIID")] Guid* riid, void** ppvCommandSignature = null);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate void _GetResourceTiling(ID3D12Device* This, ID3D12Resource* pTiledResource, [Optional, NativeTypeName("UINT")] uint* pNumTilesForEntireResource, [Optional] D3D12_PACKED_MIP_INFO* pPackedMipDesc, [Optional] D3D12_TILE_SHAPE* pStandardTileShapeForNonPackedMips, [Optional, NativeTypeName("UINT")] uint* pNumSubresourceTilings, [NativeTypeName("UINT")] uint FirstSubresourceTilingToGet, D3D12_SUBRESOURCE_TILING* pSubresourceTilingsForNonPackedMips);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate LUID* _GetAdapterLuid(ID3D12Device* This, LUID* _result);
