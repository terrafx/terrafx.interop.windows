...
namespace TerraFX.Interop
{
    ...
    public unsafe struct ID3D12PipelineLibrary
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _SetName(ID3D12PipelineLibrary* This, [NativeTypeName("LPCWSTR")] ushort* Name);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _StorePipeline(ID3D12PipelineLibrary* This, [Optional, NativeTypeName("LPCWSTR")] ushort* pName, ID3D12PipelineState* pPipeline);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _LoadGraphicsPipeline(ID3D12PipelineLibrary* This, [NativeTypeName("LPCWSTR")] ushort* pName, D3D12_GRAPHICS_PIPELINE_STATE_DESC* pDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppPipelineState);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _LoadComputePipeline(ID3D12PipelineLibrary* This, [NativeTypeName("LPCWSTR")] ushort* pName, D3D12_COMPUTE_PIPELINE_STATE_DESC* pDesc, [NativeTypeName("REFIID")] Guid* riid, void** ppPipelineState);
