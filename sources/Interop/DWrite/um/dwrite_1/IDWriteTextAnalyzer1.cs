...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDWriteTextAnalyzer1
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _GetTextComplexity(IDWriteTextAnalyzer1* This, [NativeTypeName("WCHAR[]")] ushort* textString, [NativeTypeName("UINT32")] uint textLength, IDWriteFontFace* fontFace, [NativeTypeName("BOOL")] int* isTextSimple, [NativeTypeName("UINT32")] uint* textLengthRead, [NativeTypeName("UINT16")] ushort* glyphIndices = null);
