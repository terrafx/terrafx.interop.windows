...
namespace TerraFX.Interop
{
    ...
    public unsafe struct IDWriteFactory5
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateFontFileReference(IDWriteFactory5* This, [NativeTypeName("WCHAR[]")] ushort* filePath, [Optional] FILETIME* lastWriteTime, IDWriteFontFile** fontFile);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateTextLayout(IDWriteFactory5* This, [NativeTypeName("WCHAR[]")] ushort* @string, [NativeTypeName("UINT32")] uint stringLength, IDWriteTextFormat* textFormat, [NativeTypeName("FLOAT")] float maxWidth, [NativeTypeName("FLOAT")] float maxHeight, IDWriteTextLayout** textLayout);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateNumberSubstitution(IDWriteFactory5* This, DWRITE_NUMBER_SUBSTITUTION_METHOD substitutionMethod, [NativeTypeName("WCHAR[]")] ushort* localeName, [NativeTypeName("BOOL")] int ignoreUserOverride, IDWriteNumberSubstitution** numberSubstitution);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateFontFaceReference(IDWriteFactory5* This, [NativeTypeName("WCHAR[]")] ushort* filePath, [Optional] FILETIME* lastWriteTime, [NativeTypeName("UINT32")] uint faceIndex, DWRITE_FONT_SIMULATIONS fontSimulations, IDWriteFontFaceReference** fontFaceReference);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        [return: NativeTypeName("HRESULT")]
        public delegate int _CreateHttpFontFileLoader(IDWriteFactory5* This, [Optional, NativeTypeName("WCHAR[]")] ushort* referrerUrl, [Optional, NativeTypeName("WCHAR[]")] ushort* extraHeaders, IDWriteRemoteFontFileLoader** newLoader);
        ...
        [return: NativeTypeName("HRESULT")]
        public int CreateHttpFontFileLoader([Optional, NativeTypeName("WCHAR[]")] ushort* referrerUrl, [Optional, NativeTypeName("WCHAR[]")] ushort* extraHeaders, IDWriteRemoteFontFileLoader** newLoader)
        {
            fixed (IDWriteFactory5* This = &this)
            {
