...
{
    /// <summary>The DWRITE_OVERHANG_METRICS public partial structure holds how much any visible pixels (in DIPs) overshoot each side of the layout or inline objects.</summary>
