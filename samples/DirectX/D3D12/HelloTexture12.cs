...
using static TerraFX.Interop.Windows.D3D12_COMPARISON_FUNC;
using static TerraFX.Interop.Windows.D3D12_DESCRIPTOR_HEAP_FLAGS;
using static TerraFX.Interop.Windows.D3D12_DESCRIPTOR_HEAP_TYPE;
using static TerraFX.Interop.Windows.D3D12_DESCRIPTOR_RANGE_FLAGS;
using static TerraFX.Interop.Windows.D3D12_DESCRIPTOR_RANGE_TYPE;
...
using static TerraFX.Interop.Windows.D3D12_SRV_DIMENSION;
using static TerraFX.Interop.Windows.D3D12_STATIC_BORDER_COLOR;
using static TerraFX.Interop.Windows.D3D12_TEXTURE_ADDRESS_MODE;
